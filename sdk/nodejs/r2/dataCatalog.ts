...
export class DataCatalog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:r2/dataCatalog:DataCatalog';
     ...
     */
    declare public /*out*/ readonly maintenanceConfig: pulumi.Output<outputs.r2.DataCatalogMaintenanceConfig>;
    /**
    ...
    constructor(name: string, argsOrState?: DataCatalogArgs | DataCatalogState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/r2DataCatalog:R2DataCatalog" }] };
...
export interface DataCatalogState {
     ...
     * Configures maintenance for the catalog.
     */
    maintenanceConfig?: pulumi.Input<inputs.r2.DataCatalogMaintenanceConfig | undefined>;
    /**
     * Specifies the catalog name (generated from account and bucket name).
     */
