...
export class AiSearchNamespace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:index/aiSearchNamespace:AiSearchNamespace';

    /**
     * Returns true if the given object is an instance of AiSearchNamespace.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AiSearchNamespace {
    ...
    constructor(name: string, argsOrState?: AiSearchNamespaceArgs | AiSearchNamespaceState, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AiSearchNamespaceState | undefined;
