...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "cloudflare:authenticatedOriginPullsHostname/certificate:Certificate":
...
pulumi.runtime.registerResourceModule("cloudflare", "authenticatedOriginPullsHostname/certificate", _module)
