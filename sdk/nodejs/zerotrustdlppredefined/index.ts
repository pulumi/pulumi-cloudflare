...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "cloudflare:zeroTrustDlpPredefined/entry:Entry":
                return new Entry(name, <any>undefined, { urn })
            case "cloudflare:zeroTrustDlpPredefined/profile:Profile":
...
pulumi.runtime.registerResourceModule("cloudflare", "zeroTrustDlpPredefined/entry", _module)
pulumi.runtime.registerResourceModule("cloudflare", "zeroTrustDlpPredefined/profile", _module)
