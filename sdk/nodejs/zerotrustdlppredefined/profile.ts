...
export class Profile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustDlpPredefined/profile:Profile';
     ...
     */
    declare public readonly entries: pulumi.Output<outputs.zeroTrustDlpPredefined.ProfileEntry[]>;
    /**
    ...
    constructor(name: string, argsOrState?: ProfileArgs | ProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustDlpPredefinedProfile:ZeroTrustDlpPredefinedProfile" }, { type: "cloudflare:index/dlpPredefinedProfile:DlpPredefinedProfile" }] };
...
export interface ProfileState {
     ...
     * @deprecated This attribute is deprecated. Use enabledEntries instead.
     */
    entries?: pulumi.Input<pulumi.Input<inputs.zeroTrustDlpPredefined.ProfileEntry>[] | undefined>;
    /**
     * The name of the predefined profile.
     */
