...
export function getMap(args: GetMapArgs, opts?: pulumi.InvokeOptions): Promise<GetMapResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:address/map:getMap", {
...
export interface GetMapResult {
     ...
     */
    readonly ips: outputs.address.GetMapIp[];
    /**
     * Zones and Accounts which will be assigned IPs on this Address Map. A zone membership will take priority over an account membership.
     */
    readonly memberships: outputs.address.GetMapMembership[];
...
export function getMapOutput(args: GetMapOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMapResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:address/map:getMap", {
        "accountId": args.accountId,
        "addressMapId": args.addressMapId,
    }, opts);
}
