...
export class Map extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:address/map:Map';
     ...
     */
    declare public readonly memberships: pulumi.Output<outputs.address.MapMembership[] | undefined>;
    ...
    constructor(name: string, argsOrState?: MapArgs | MapState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/addressMap:AddressMap" }] };
...
export interface MapState {
     ...
     * Zones and Accounts which will be assigned IPs on this Address Map. A zone membership will take priority over an account membership.
     */
    memberships?: pulumi.Input<pulumi.Input<inputs.address.MapMembership>[] | undefined>;
