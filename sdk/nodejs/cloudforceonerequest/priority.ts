...
export class Priority extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:cloudforceOneRequest/priority:Priority';
    ...
    constructor(name: string, argsOrState?: PriorityArgs | PriorityState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/cloudforceOneRequestPriority:CloudforceOneRequestPriority" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(Priority.__pulumiType, name, resourceInputs, opts);
    }
}
