 ...
 *
 * const exampleCloudforceOneRequest = new cloudflare.cloudforceonerequest.CloudforceOneRequest("example_cloudforce_one_request", {
...
export class CloudforceOneRequest extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:cloudforceOneRequest/cloudforceOneRequest:CloudforceOneRequest';
    ...
    constructor(name: string, argsOrState?: CloudforceOneRequestArgs | CloudforceOneRequestState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/cloudforceOneRequest:CloudforceOneRequest" }] };
