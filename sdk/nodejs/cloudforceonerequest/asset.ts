...
export class Asset extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:cloudforceOneRequest/asset:Asset';
    ...
    constructor(name: string, argsOrState?: AssetArgs | AssetState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/cloudforceOneRequestAsset:CloudforceOneRequestAsset" }] };
