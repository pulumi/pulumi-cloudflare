...
export function getCloudforceOneRequest(args?: GetCloudforceOneRequestArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudforceOneRequestResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:cloudforceOneRequest/cloudforceOneRequest:getCloudforceOneRequest", {
...
export interface GetCloudforceOneRequestArgs {
     ...
     */
    accountId?: string;
    filter?: inputs.cloudforceOneRequest.GetCloudforceOneRequestFilter;
    /**
     * UUID.
     */
    requestId?: string;
...
export interface GetCloudforceOneRequestResult {
    ...
    readonly filter?: outputs.cloudforceOneRequest.GetCloudforceOneRequestFilter;
    /**
     * UUID.
     */
    readonly id: string;
...
export function getCloudforceOneRequestOutput(args?: GetCloudforceOneRequestOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudforceOneRequestResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:cloudforceOneRequest/cloudforceOneRequest:getCloudforceOneRequest", {
        "accountId": args.accountId,
        "filter": args.filter,
        "requestId": args.requestId,
    }, opts);
...
export interface GetCloudforceOneRequestOutputArgs {
    ...
    filter?: pulumi.Input<inputs.cloudforceOneRequest.GetCloudforceOneRequestFilterArgs | undefined>;
    /**
     * UUID.
     */
