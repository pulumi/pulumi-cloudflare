...
export class LoadBalancerMonitor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:loadBalancerMonitor/loadBalancerMonitor:LoadBalancerMonitor';
    ...
    constructor(name: string, argsOrState?: LoadBalancerMonitorArgs | LoadBalancerMonitorState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/loadBalancerMonitor:LoadBalancerMonitor" }] };
