...
export class Dns extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:emailRouting/dns:Dns';
    ...
    declare public /*out*/ readonly errors: pulumi.Output<outputs.emailRouting.DnsError[]>;
    declare public /*out*/ readonly messages: pulumi.Output<outputs.emailRouting.DnsMessage[]>;
    /**
    ...
    declare public /*out*/ readonly result: pulumi.Output<outputs.emailRouting.DnsResult>;
    declare public /*out*/ readonly resultInfo: pulumi.Output<outputs.emailRouting.DnsResultInfo>;
    /**
    ...
    constructor(name: string, argsOrState?: DnsArgs | DnsState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/emailRoutingDns:EmailRoutingDns" }] };
...
export interface DnsState {
    ...
    errors?: pulumi.Input<pulumi.Input<inputs.emailRouting.DnsError>[] | undefined>;
    messages?: pulumi.Input<pulumi.Input<inputs.emailRouting.DnsMessage>[] | undefined>;
    /**
     * The date and time the settings have been modified.
     */
    ...
    result?: pulumi.Input<inputs.emailRouting.DnsResult | undefined>;
    resultInfo?: pulumi.Input<inputs.emailRouting.DnsResultInfo | undefined>;
    /**
     * Flag to check if the user skipped the configuration wizard.
     */
