...
export class Watermark extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:stream/watermark:Watermark';
    ...
    constructor(name: string, argsOrState?: WatermarkArgs | WatermarkState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/streamWatermark:StreamWatermark" }] };
