...
export function getStream(args: GetStreamArgs, opts?: pulumi.InvokeOptions): Promise<GetStreamResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:stream/stream:getStream", {
...
export interface GetStreamResult {
    ...
    readonly input: outputs.stream.GetStreamInput;
    /**
    ...
    readonly playback: outputs.stream.GetStreamPlayback;
    /**
     ...
     */
    readonly publicDetails: outputs.stream.GetStreamPublicDetails;
    /**
     ...
     */
    readonly status: outputs.stream.GetStreamStatus;
    /**
    ...
    readonly watermark: outputs.stream.GetStreamWatermark;
}
/**
 * Accepted Permissions
 *
...
export function getStreamOutput(args: GetStreamOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetStreamResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:stream/stream:getStream", {
        "accountId": args.accountId,
        "identifier": args.identifier,
    }, opts);
}
