 ...
 *
 * const exampleStream = new cloudflare.stream.Stream("example_stream", {accountId: "023e105f4ecef8ad9ca31a8372d0c353"});
 * ```
 *
 * ## Import
 *
...
export class Stream extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:stream/stream:Stream';
    ...
    declare public /*out*/ readonly input: pulumi.Output<outputs.stream.StreamInput>;
    /**
    ...
    declare public /*out*/ readonly playback: pulumi.Output<outputs.stream.StreamPlayback>;
    /**
     ...
     */
    declare public readonly publicDetails: pulumi.Output<outputs.stream.StreamPublicDetails | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.stream.StreamStatus>;
    /**
    ...
    declare public /*out*/ readonly watermark: pulumi.Output<outputs.stream.StreamWatermark>;
    ...
    constructor(name: string, argsOrState?: StreamArgs | StreamState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/stream:Stream" }] };
...
export interface StreamState {
    ...
    input?: pulumi.Input<inputs.stream.StreamInput | undefined>;
    /**
     * The live input ID used to upload a video with Stream Live.
     */
    ...
    playback?: pulumi.Input<inputs.stream.StreamPlayback | undefined>;
    /**
     * The video's preview page URI. This field is omitted until encoding is complete.
     */
     ...
     * Public details for the video including title, share link, channel link, and logo.
     */
    publicDetails?: pulumi.Input<inputs.stream.StreamPublicDetails | undefined>;
    /**
     * Indicates whether the video is playable. The field is empty if the video is not ready for viewing or the live stream is still in progress.
     */
     ...
     * Specifies a detailed status for a video. If the `state` is `inprogress` or `error`, the `step` field returns `encoding` or `manifest`. If the `state` is `inprogress`, `pctComplete` returns a number between 0 and 100 to indicate the approximate percent of completion. If the `state` is `error`, `errorReasonCode` and `errorReasonText` provide additional details.
     */
    status?: pulumi.Input<inputs.stream.StreamStatus | undefined>;
    /**
     * The media item's thumbnail URI. This field is omitted until encoding is complete.
     */
    ...
    watermark?: pulumi.Input<inputs.stream.StreamWatermark | undefined>;
}
