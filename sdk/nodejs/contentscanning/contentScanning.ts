 ...
 *
 * const exampleContentScanning = new cloudflare.contentscanning.ContentScanning("example_content_scanning", {
...
export class ContentScanning extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:contentScanning/contentScanning:ContentScanning';
    ...
    constructor(name: string, argsOrState?: ContentScanningArgs | ContentScanningState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/contentScanning:ContentScanning" }] };
