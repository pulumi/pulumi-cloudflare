...
export class MtlsCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:mtlsCertificate/mtlsCertificate:MtlsCertificate';
    ...
    constructor(name: string, argsOrState?: MtlsCertificateArgs | MtlsCertificateState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/mtlsCertificate:MtlsCertificate" }] };
