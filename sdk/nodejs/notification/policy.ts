...
export class Policy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:notification/policy:Policy';
     ...
     */
    declare public readonly filters: pulumi.Output<outputs.notification.PolicyFilters | undefined>;
    /**
     * List of IDs that will be used when dispatching a notification. IDs for email type will be the email address.
     */
    declare public readonly mechanisms: pulumi.Output<outputs.notification.PolicyMechanisms>;
    ...
    constructor(name: string, argsOrState?: PolicyArgs | PolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/notificationPolicy:NotificationPolicy" }] };
...
export interface PolicyState {
     ...
     * Optional filters that allow you to be alerted only on a subset of events for that alert type based on some criteria. This is only available for select alert types. See alert type documentation for more details.
     */
    filters?: pulumi.Input<inputs.notification.PolicyFilters | undefined>;
    /**
     * List of IDs that will be used when dispatching a notification. IDs for email type will be the email address.
     */
    mechanisms?: pulumi.Input<inputs.notification.PolicyMechanisms | undefined>;
...
export interface PolicyArgs {
     ...
     * List of IDs that will be used when dispatching a notification. IDs for email type will be the email address.
     */
    mechanisms: pulumi.Input<inputs.notification.PolicyMechanisms>;
    /**
     * Name of the policy.
     */
