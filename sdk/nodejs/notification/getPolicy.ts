...
export function getPolicy(args: GetPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:notification/policy:getPolicy", {
...
export interface GetPolicyResult {
     ...
     */
    readonly filters: outputs.notification.GetPolicyFilters;
    /**
     * The unique identifier of a notification policy
     */
    readonly id: string;
     ...
     */
    readonly mechanisms: outputs.notification.GetPolicyMechanisms;
...
export function getPolicyOutput(args: GetPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPolicyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:notification/policy:getPolicy", {
        "accountId": args.accountId,
        "policyId": args.policyId,
    }, opts);
}
