...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "cloudflare:pages/domain:Domain":
                return new Domain(name, <any>undefined, { urn })
            case "cloudflare:pages/project:Project":
...
pulumi.runtime.registerResourceModule("cloudflare", "pages/domain", _module)
pulumi.runtime.registerResourceModule("cloudflare", "pages/project", _module)
