...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "cloudflare:zeroTrustAccessShortLived/certificate:Certificate":
...
pulumi.runtime.registerResourceModule("cloudflare", "zeroTrustAccessShortLived/certificate", _module)
