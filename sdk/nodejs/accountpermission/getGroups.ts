...
export function getGroups(args?: GetGroupsArgs, opts?: pulumi.InvokeOptions): Promise<GetGroupsResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:accountPermission/groups:getGroups", {
...
export interface GetGroupsResult {
     ...
     */
    readonly results: outputs.accountPermission.GetGroupsResult[];
}
/**
 * Accepted Permissions
 *
...
export function getGroupsOutput(args?: GetGroupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGroupsResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:accountPermission/groups:getGroups", {
        "accountId": args.accountId,
        "id": args.id,
        "label": args.label,
        "maxItems": args.maxItems,
