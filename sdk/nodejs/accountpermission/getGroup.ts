...
export function getGroup(args: GetGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetGroupResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:accountPermission/group:getGroup", {
...
export interface GetGroupResult {
     ...
     */
    readonly meta: outputs.accountPermission.GetGroupMeta;
    /**
...
export function getGroupOutput(args: GetGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:accountPermission/group:getGroup", {
        "accountId": args.accountId,
        "permissionGroupId": args.permissionGroupId,
    }, opts);
}
