...
export class ZeroTrustDeviceDeploymentGroups extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustDeviceDeploymentGroups/zeroTrustDeviceDeploymentGroups:ZeroTrustDeviceDeploymentGroups';
     ...
     */
    declare public readonly versionConfigs: pulumi.Output<outputs.zeroTrustDeviceDeploymentGroups.ZeroTrustDeviceDeploymentGroupsVersionConfig[]>;
    ...
    constructor(name: string, argsOrState?: ZeroTrustDeviceDeploymentGroupsArgs | ZeroTrustDeviceDeploymentGroupsState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustDeviceDeploymentGroups:ZeroTrustDeviceDeploymentGroups" }] };
...
export interface ZeroTrustDeviceDeploymentGroupsState {
     ...
     * Contains at least one version configuration.
     */
    versionConfigs?: pulumi.Input<pulumi.Input<inputs.zeroTrustDeviceDeploymentGroups.ZeroTrustDeviceDeploymentGroupsVersionConfig>[] | undefined>;
}
...
export interface ZeroTrustDeviceDeploymentGroupsArgs {
     ...
     * Contains at least one version configuration.
     */
    versionConfigs: pulumi.Input<pulumi.Input<inputs.zeroTrustDeviceDeploymentGroups.ZeroTrustDeviceDeploymentGroupsVersionConfig>[]>;
}
