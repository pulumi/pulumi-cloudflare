...
export class Provider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustAccessIdentity/provider:Provider';
     ...
     */
    declare public readonly config: pulumi.Output<outputs.zeroTrustAccessIdentity.ProviderConfig>;
    /**
     ...
     */
    declare public /*out*/ readonly samlCertificateSet: pulumi.Output<outputs.zeroTrustAccessIdentity.ProviderSamlCertificateSet>;
    /**
     ...
     */
    declare public readonly scimConfig: pulumi.Output<outputs.zeroTrustAccessIdentity.ProviderScimConfig>;
    /**
    ...
    constructor(name: string, argsOrState?: ProviderArgs | ProviderState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustAccessIdentityProvider:ZeroTrustAccessIdentityProvider" }, { type: "cloudflare:index/accessIdentityProvider:AccessIdentityProvider" }] };
...
export interface ProviderState {
     ...
     * The configuration parameters for the identity provider. To view the required parameters for a specific provider, refer to our [developer documentation](https://developers.cloudflare.com/cloudflare-one/identity/idp-integration/).
     */
    config?: pulumi.Input<inputs.zeroTrustAccessIdentity.ProviderConfig | undefined>;
    /**
     * The name of the identity provider, shown to users on the login page.
     */
     ...
     * Only present for SAML identity providers with a certificate set assigned.
     */
    samlCertificateSet?: pulumi.Input<inputs.zeroTrustAccessIdentity.ProviderSamlCertificateSet | undefined>;
    /**
     * The UID of the SAML encryption certificate set assigned to this Identity Provider.
     * Only present for SAML identity providers with encryption configured.
     * Create a certificate set via POST to `/identity_providers/{id}/saml_certificate`.
     ...
     * The configuration settings for enabling a System for Cross-Domain Identity Management (SCIM) with the identity provider.
     */
    scimConfig?: pulumi.Input<inputs.zeroTrustAccessIdentity.ProviderScimConfig | undefined>;
    /**
     * The type of identity provider. To determine the value for a specific provider, refer to our [developer documentation](https://developers.cloudflare.com/cloudflare-one/identity/idp-integration/).
     * Available values: "onetimepin", "azureAD", "saml", "centrify", "facebook", "github", "google-apps", "google", "linkedin", "oidc", "okta", "onelogin", "pingone", "yandex", "cloudflare".
     */
...
export interface ProviderArgs {
     ...
     * The configuration parameters for the identity provider. To view the required parameters for a specific provider, refer to our [developer documentation](https://developers.cloudflare.com/cloudflare-one/identity/idp-integration/).
     */
    config: pulumi.Input<inputs.zeroTrustAccessIdentity.ProviderConfig>;
    /**
     * The name of the identity provider, shown to users on the login page.
     */
