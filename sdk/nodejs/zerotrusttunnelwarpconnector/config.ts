...
export class Config extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustTunnelWarpConnector/config:Config';
     ...
     */
    declare public readonly config: pulumi.Output<outputs.zeroTrustTunnelWarpConnector.ConfigConfig | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ConfigArgs | ConfigState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustTunnelWarpConnectorConfig:ZeroTrustTunnelWarpConnectorConfig" }] };
...
export interface ConfigState {
     ...
     * Provider-specific configuration. Required shape depends on ha_mode. For `aws`, must contain `fnrId`. For `local`, must contain `vips`. For `none` and `disabled`, must be empty or omitted.
     */
    config?: pulumi.Input<inputs.zeroTrustTunnelWarpConnector.ConfigConfig | undefined>;
    /**
     * Monotonically increasing configuration version, incremented on each PUT.
     */
