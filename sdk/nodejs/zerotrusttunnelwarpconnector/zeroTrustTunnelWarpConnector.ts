 ...
 *
 * const exampleZeroTrustTunnelWarpConnector = new cloudflare.zerotrusttunnelwarpconnector.ZeroTrustTunnelWarpConnector("example_zero_trust_tunnel_warp_connector", {
...
export class ZeroTrustTunnelWarpConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustTunnelWarpConnector/zeroTrustTunnelWarpConnector:ZeroTrustTunnelWarpConnector';
     ...
     */
    declare public /*out*/ readonly connections: pulumi.Output<outputs.zeroTrustTunnelWarpConnector.ZeroTrustTunnelWarpConnectorConnection[]>;
    /**
    ...
    constructor(name: string, argsOrState?: ZeroTrustTunnelWarpConnectorArgs | ZeroTrustTunnelWarpConnectorState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustTunnelWarpConnector:ZeroTrustTunnelWarpConnector" }] };
...
export interface ZeroTrustTunnelWarpConnectorState {
     ...
     * @deprecated This field will start returning an empty array. To fetch the connections of a given tunnel, please use the dedicated endpoint `/accounts/{account_id}/{tunnel_type}/{tunnel_id}/connections`
     */
    connections?: pulumi.Input<pulumi.Input<inputs.zeroTrustTunnelWarpConnector.ZeroTrustTunnelWarpConnectorConnection>[] | undefined>;
    /**
     * Timestamp of when the tunnel established at least one connection to Cloudflare's edge. If `null`, the tunnel is inactive.
     */
