...
export class Flag extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:flagship/flag:Flag';
     ...
     */
    declare public readonly rules: pulumi.Output<outputs.flagship.FlagRule[]>;
    /**
    ...
    constructor(name: string, argsOrState?: FlagArgs | FlagState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/flagshipFlag:FlagshipFlag" }] };
...
export interface FlagState {
     ...
     * Targeting rules evaluated in ascending `priority`; the first matching rule wins. An empty array means the flag always serves `defaultVariation`.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.flagship.FlagRule>[] | undefined>;
    /**
     * Value type of the flag's variations. Inferred from the variation values on write, so it may be omitted in requests.
     * Available values: "boolean", "string", "number", "json".
     */
...
export interface FlagArgs {
     ...
     * Targeting rules evaluated in ascending `priority`; the first matching rule wins. An empty array means the flag always serves `defaultVariation`.
     */
    rules: pulumi.Input<pulumi.Input<inputs.flagship.FlagRule>[]>;
    /**
     * Value type of the flag's variations. Inferred from the variation values on write, so it may be omitted in requests.
     * Available values: "boolean", "string", "number", "json".
     */
