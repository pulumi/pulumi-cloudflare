...
export class Config extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustTunnelCloudflared/config:Config';
     ...
     */
    declare public readonly config: pulumi.Output<outputs.zeroTrustTunnelCloudflared.ConfigConfig>;
    ...
    constructor(name: string, argsOrState?: ConfigArgs | ConfigState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustTunnelCloudflaredConfig:ZeroTrustTunnelCloudflaredConfig" }, { type: "cloudflare:index/tunnelConfig:TunnelConfig" }] };
...
export interface ConfigState {
     ...
     * The tunnel configuration and ingress rules.
     */
    config?: pulumi.Input<inputs.zeroTrustTunnelCloudflared.ConfigConfig | undefined>;
