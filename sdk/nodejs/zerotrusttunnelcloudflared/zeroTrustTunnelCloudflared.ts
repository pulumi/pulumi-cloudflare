...
export class ZeroTrustTunnelCloudflared extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustTunnelCloudflared/zeroTrustTunnelCloudflared:ZeroTrustTunnelCloudflared';
     ...
     */
    declare public readonly configSrc: pulumi.Output<string>;
    /**
     ...
     */
    declare public /*out*/ readonly connections: pulumi.Output<outputs.zeroTrustTunnelCloudflared.ZeroTrustTunnelCloudflaredConnection[]>;
    /**
    ...
    constructor(name: string, argsOrState?: ZeroTrustTunnelCloudflaredArgs | ZeroTrustTunnelCloudflaredState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustTunnelCloudflared:ZeroTrustTunnelCloudflared" }, { type: "cloudflare:index/tunnel:Tunnel" }] };
...
export interface ZeroTrustTunnelCloudflaredState {
     ...
     * @deprecated This field will start returning an empty array. To fetch the connections of a given tunnel, please use the dedicated endpoint `/accounts/{account_id}/{tunnel_type}/{tunnel_id}/connections`
     */
    connections?: pulumi.Input<pulumi.Input<inputs.zeroTrustTunnelCloudflared.ZeroTrustTunnelCloudflaredConnection>[] | undefined>;
    /**
     * Timestamp of when the tunnel established at least one connection to Cloudflare's edge. If `null`, the tunnel is inactive.
     */
