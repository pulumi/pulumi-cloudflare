...
export class Hostname extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:regional/hostname:Hostname';
    ...
    constructor(name: string, argsOrState?: HostnameArgs | HostnameState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/regionalHostname:RegionalHostname" }] };
