...
export class TieredCache extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:regional/tieredCache:TieredCache';
    ...
    constructor(name: string, argsOrState?: TieredCacheArgs | TieredCacheState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/regionalTieredCache:RegionalTieredCache" }] };
