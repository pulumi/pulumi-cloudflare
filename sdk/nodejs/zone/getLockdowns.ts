 ...
 * ```
 */
export function getLockdowns(args?: GetLockdownsArgs, opts?: pulumi.InvokeOptions): Promise<GetLockdownsResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("cloudflare:zone/lockdowns:getLockdowns", {
 ...
 */
export interface GetLockdownsArgs {
    /**
 ...
 */
export interface GetLockdownsResult {
    /**
     * The timestamp of when the rule was created.
     */
     ...
     */
    readonly results: outputs.zone.GetLockdownsResult[];
    /**
     * A single URI to search for in the list of URLs of existing rules.
     */
 ...
 * ```
 */
export function getLockdownsOutput(args?: GetLockdownsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLockdownsResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:zone/lockdowns:getLockdowns", {
        "createdOn": args.createdOn,
        "description": args.description,
        "descriptionSearch": args.descriptionSearch,
        "ip": args.ip,
 ...
 * A collection of arguments for invoking getLockdowns.
 */
export interface GetLockdownsOutputArgs {
    /**
     * The timestamp of when the rule was created.
     */
