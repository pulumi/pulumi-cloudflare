 ...
 *
 * const exampleZone = new cloudflare.zone.Zone("example_zone", {
 *     account: {
 ...
 *
 * ```sh
 * $ pulumi import cloudflare:zone/zone:Zone example '<zone_id>'
 * ```
 */
export class Zone extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zone/zone:Zone';
    ...
    declare public readonly account: pulumi.Output<outputs.zone.ZoneAccount>;
    /**
     ...
     */
    declare public /*out*/ readonly meta: pulumi.Output<outputs.zone.ZoneMeta>;
    /**
     ...
     */
    declare public /*out*/ readonly owner: pulumi.Output<outputs.zone.ZoneOwner>;
    /**
...
see [Zone Plans](https://developers.cloudflare.com/api/resources/zones/subresources/plans/).
     */
    declare public /*out*/ readonly plan: pulumi.Output<outputs.zone.ZonePlan>;
    /**
     ...
     */
    declare public /*out*/ readonly tenant: pulumi.Output<outputs.zone.ZoneTenant>;
    /**
     * The immediate parent organizational unit that this zone belongs to (such as under a tenant or sub-organization).
     */
    declare public /*out*/ readonly tenantUnit: pulumi.Output<outputs.zone.ZoneTenantUnit>;
    /**
    ...
    constructor(name: string, argsOrState?: ZoneArgs | ZoneState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zone:Zone" }] };
...
export interface ZoneState {
    account?: pulumi.Input<inputs.zone.ZoneAccount | undefined>;
    /**
     * The last time proof of ownership was detected and the zone was made
     * active.
     */
     ...
     * Metadata about the zone.
     */
    meta?: pulumi.Input<inputs.zone.ZoneMeta | undefined>;
    /**
     * When the zone was last modified.
     */
     ...
     * The owner of the zone.
     */
    owner?: pulumi.Input<inputs.zone.ZoneOwner | undefined>;
    /**
     * Indicates whether the zone is only using Cloudflare DNS services. A
     * true value means the zone will not receive security or performance
     * benefits.
...
see [Zone Plans](https://developers.cloudflare.com/api/resources/zones/subresources/plans/).
     */
    plan?: pulumi.Input<inputs.zone.ZonePlan | undefined>;
    /**
     * The zone status on Cloudflare.
     * Available values: "initializing", "pending", "active", "moved".
     */
     ...
     * The root organizational unit that this zone belongs to (such as a tenant or organization).
     */
    tenant?: pulumi.Input<inputs.zone.ZoneTenant | undefined>;
    /**
     * The immediate parent organizational unit that this zone belongs to (such as under a tenant or sub-organization).
     */
    tenantUnit?: pulumi.Input<inputs.zone.ZoneTenantUnit | undefined>;
    /**
     * A full zone implies that DNS is hosted with Cloudflare. A partial zone is
     * typically a partner-hosted zone or a CNAME setup.
     * Available values: "full", "partial", "secondary", "internal".
...
export interface ZoneArgs {
    account: pulumi.Input<inputs.zone.ZoneAccount>;
    /**
     * The domain name. Per [RFC 1035](https://datatracker.ietf.org/doc/html/rfc1035#section-2.3.4) the overall zone name can be up to 253 characters, with each segment ("label") not exceeding 63 characters.
     */
