 ...
 *
 * const exampleZoneDnsSettings = new cloudflare.zone.DnsSettings("example_zone_dns_settings", {
...
export class DnsSettings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zone/dnsSettings:DnsSettings';
     ...
     */
    declare public readonly internalDns: pulumi.Output<outputs.zone.DnsSettingsInternalDns | undefined>;
    /**
     ...
     */
    declare public readonly nameservers: pulumi.Output<outputs.zone.DnsSettingsNameservers | undefined>;
    /**
     ...
     */
    declare public readonly soa: pulumi.Output<outputs.zone.DnsSettingsSoa | undefined>;
    /**
     * Identifier.
     */
    ...
    constructor(name: string, argsOrState?: DnsSettingsArgs | DnsSettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zoneDnsSettings:ZoneDnsSettings" }] };
...
export interface DnsSettingsState {
     ...
     * Settings for this internal zone.
     */
    internalDns?: pulumi.Input<inputs.zone.DnsSettingsInternalDns | undefined>;
    /**
     * Whether to enable multi-provider DNS, which causes Cloudflare to activate the zone even when non-Cloudflare NS records exist, and to respect NS records at the zone apex during outbound zone transfers.
     */
     ...
     * Settings determining the nameservers through which the zone should be available.
     */
    nameservers?: pulumi.Input<inputs.zone.DnsSettingsNameservers | undefined>;
    /**
     * The time to live (TTL) of the zone's nameserver (NS) records.
     */
     ...
     * Components of the zone's SOA record.
     */
    soa?: pulumi.Input<inputs.zone.DnsSettingsSoa | undefined>;
    /**
     * Identifier.
     */
