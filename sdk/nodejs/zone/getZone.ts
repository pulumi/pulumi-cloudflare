...
export function getZone(args?: GetZoneArgs, opts?: pulumi.InvokeOptions): Promise<GetZoneResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:zone/zone:getZone", {
        "filter": args.filter,
        "zoneId": args.zoneId,
    }, opts);
}
...
export interface GetZoneArgs {
    filter?: inputs.zone.GetZoneFilter;
    zoneId?: string;
}
...
export interface GetZoneResult {
    readonly account: outputs.zone.GetZoneAccount;
    readonly activatedOn: string;
    readonly cnameSuffix: string;
    readonly createdOn: string;
    readonly developmentMode: number;
    readonly filter?: outputs.zone.GetZoneFilter;
    readonly id: string;
    readonly meta: outputs.zone.GetZoneMeta;
    ...
    readonly owner: outputs.zone.GetZoneOwner;
...
see [Zone Plans](https://developers.cloudflare.com/api/resources/zones/subresources/plans/).
     */
    readonly plan: outputs.zone.GetZonePlan;
    readonly status: string;
    readonly tenant: outputs.zone.GetZoneTenant;
    readonly tenantUnit: outputs.zone.GetZoneTenantUnit;
...
export function getZoneOutput(args?: GetZoneOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetZoneResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:zone/zone:getZone", {
        "filter": args.filter,
        "zoneId": args.zoneId,
    }, opts);
}
...
export interface GetZoneOutputArgs {
    filter?: pulumi.Input<inputs.zone.GetZoneFilterArgs | undefined>;
