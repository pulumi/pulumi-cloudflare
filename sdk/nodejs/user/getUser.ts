...
export function getUser(opts?: pulumi.InvokeOptions): Promise<GetUserResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:user/user:getUser", {
    }, opts);
}
...
export interface GetUserResult {
    ...
    readonly organizations: outputs.user.GetUserOrganization[];
    /**
...
export function getUserOutput(opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUserResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:user/user:getUser", {
    }, opts);
}
