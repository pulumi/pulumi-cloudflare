 ...
 *
 * const exampleUser = new cloudflare.user.User("example_user", {
 *     country: "US",
 *     firstName: "John",
 *     lastName: "Appleseed",
...
export class User extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:user/user:User';
    ...
    declare public /*out*/ readonly organizations: pulumi.Output<outputs.user.UserOrganization[]>;
    /**
    ...
    constructor(name: string, argsOrState?: UserArgs | UserState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/user:User" }] };
...
export interface UserState {
    ...
    organizations?: pulumi.Input<pulumi.Input<inputs.user.UserOrganization>[] | undefined>;
    /**
     * Indicates whether user has been suspended
     */
