...
export function getRoutes(args?: GetRoutesArgs, opts?: pulumi.InvokeOptions): Promise<GetRoutesResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:zeroTrustNetworkHostname/routes:getRoutes", {
...
export interface GetRoutesResult {
     ...
     */
    readonly results: outputs.zeroTrustNetworkHostname.GetRoutesResult[];
    /**
     * If set, only list hostname routes that point to a specific tunnel.
     */
...
export function getRoutesOutput(args?: GetRoutesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRoutesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:zeroTrustNetworkHostname/routes:getRoutes", {
        "accountId": args.accountId,
        "comment": args.comment,
        "existedAt": args.existedAt,
        "hostname": args.hostname,
