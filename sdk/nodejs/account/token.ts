...
export class Token extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:account/token:Token';
    ...
    declare public readonly condition: pulumi.Output<outputs.account.TokenCondition | undefined>;
    /**
     ...
     */
    declare public readonly policies: pulumi.Output<outputs.account.TokenPolicy[]>;
    /**
     * Status of the token.
    ...
    constructor(name: string, argsOrState?: TokenArgs | TokenState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/accountToken:AccountToken" }] };
...
export interface TokenState {
    ...
    condition?: pulumi.Input<inputs.account.TokenCondition | undefined>;
    /**
     * The expiration time on or after which the JWT MUST NOT be accepted for processing.
     */
     ...
     * Set of access policies assigned to the token.
     */
    policies?: pulumi.Input<pulumi.Input<inputs.account.TokenPolicy>[] | undefined>;
    /**
     * Status of the token.
     * Available values: "active", "disabled", "expired".
     */
...
export interface TokenArgs {
     ...
     * Set of access policies assigned to the token.
     */
    policies: pulumi.Input<pulumi.Input<inputs.account.TokenPolicy>[]>;
    /**
     * Status of the token.
     * Available values: "active", "disabled", "expired".
     */
