...
export class Member extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:account/member:Member';
     ...
     */
    declare public readonly policies: pulumi.Output<outputs.account.MemberPolicy[]>;
    /**
     ...
     */
    declare public /*out*/ readonly user: pulumi.Output<outputs.account.MemberUser>;
    ...
    constructor(name: string, argsOrState?: MemberArgs | MemberState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/accountMember:AccountMember" }] };
...
export interface MemberState {
     ...
     * Array of policies associated with this member.
     */
    policies?: pulumi.Input<pulumi.Input<inputs.account.MemberPolicy>[] | undefined>;
    /**
     * Set of roles associated with this member.
     */
     ...
     * Details of the user associated to the membership.
     */
    user?: pulumi.Input<inputs.account.MemberUser | undefined>;
}
