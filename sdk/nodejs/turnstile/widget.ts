...
export class Widget extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:turnstile/widget:Widget';
    ...
    constructor(name: string, argsOrState?: WidgetArgs | WidgetState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/turnstileWidget:TurnstileWidget" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        const secretOpts = { additionalSecretOutputs: ["secret"] };
        opts = pulumi.mergeOptions(opts, secretOpts);
        super(Widget.__pulumiType, name, resourceInputs, opts);
    }
}
