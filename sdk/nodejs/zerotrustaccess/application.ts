...
export class Application extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustAccess/application:Application';
    ...
    declare public readonly corsHeaders: pulumi.Output<outputs.zeroTrustAccess.ApplicationCorsHeaders | undefined>;
    /**
     ...
     */
    declare public readonly destinations: pulumi.Output<outputs.zeroTrustAccess.ApplicationDestination[]>;
    /**
     ...
     */
    declare public readonly footerLinks: pulumi.Output<outputs.zeroTrustAccess.ApplicationFooterLink[] | undefined>;
    /**
     ...
     */
    declare public readonly landingPageDesign: pulumi.Output<outputs.zeroTrustAccess.ApplicationLandingPageDesign | undefined>;
    /**
     ...
     */
    declare public readonly mfaConfig: pulumi.Output<outputs.zeroTrustAccess.ApplicationMfaConfig | undefined>;
    /**
     ...
     */
    declare public readonly oauthConfiguration: pulumi.Output<outputs.zeroTrustAccess.ApplicationOauthConfiguration | undefined>;
    /**
     ...
     */
    declare public readonly policies: pulumi.Output<outputs.zeroTrustAccess.ApplicationPolicy[] | undefined>;
    /**
    ...
    declare public readonly saasApp: pulumi.Output<outputs.zeroTrustAccess.ApplicationSaasApp | undefined>;
    /**
     ...
     */
    declare public readonly scimConfig: pulumi.Output<outputs.zeroTrustAccess.ApplicationScimConfig | undefined>;
    /**
    ...
    declare public readonly targetCriterias: pulumi.Output<outputs.zeroTrustAccess.ApplicationTargetCriteria[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ApplicationArgs | ApplicationState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustAccessApplication:ZeroTrustAccessApplication" }, { type: "cloudflare:index/accessApplication:AccessApplication" }] };
...
export interface ApplicationState {
    ...
    corsHeaders?: pulumi.Input<inputs.zeroTrustAccess.ApplicationCorsHeaders | undefined>;
    /**
     * The custom error message shown to a user when they are denied access to the application.
     */
     ...
     * List of destinations secured by Access. This supersedes `selfHostedDomains` to allow for more flexibility in defining different types of domains. If `destinations` are provided, then `selfHostedDomains` will be ignored.
     */
    destinations?: pulumi.Input<pulumi.Input<inputs.zeroTrustAccess.ApplicationDestination>[] | undefined>;
    /**
     * The primary hostname and path secured by Access. This domain will be displayed if the app is visible in the App Launcher.
     */
     ...
     * The links in the App Launcher footer.
     */
    footerLinks?: pulumi.Input<pulumi.Input<inputs.zeroTrustAccess.ApplicationFooterLink>[] | undefined>;
    /**
     * The background color of the App Launcher header.
     */
     ...
     * The design of the App Launcher landing page shown to users when they log in.
     */
    landingPageDesign?: pulumi.Input<inputs.zeroTrustAccess.ApplicationLandingPageDesign | undefined>;
    /**
     * The image URL for the logo shown in the App Launcher dashboard.
     */
     ...
     * Configures multi-factor authentication (MFA) settings for the application. Only valid for self*hosted, ssh, vnc, and rdp application types.
     */
    mfaConfig?: pulumi.Input<inputs.zeroTrustAccess.ApplicationMfaConfig | undefined>;
    /**
     * The name of the application.
     */
     ...
     * Optional configuration for managing an OAuth authorization flow controlled by Access. When set, Access will act as the OAuth authorization server for this application. This feature is currently in beta.
     */
    oauthConfiguration?: pulumi.Input<inputs.zeroTrustAccess.ApplicationOauthConfiguration | undefined>;
    /**
     * Allows options preflight requests to bypass Access authentication and go directly to the origin. Cannot turn on if corsHeaders is set.
     */
     ...
     * The policies that Access applies to the application, in ascending order of precedence. Items can reference existing policies or create new policies exclusive to the application.
     */
    policies?: pulumi.Input<pulumi.Input<inputs.zeroTrustAccess.ApplicationPolicy>[] | undefined>;
    /**
     * Allows matching Access Service Tokens passed HTTP in a single header with this name.
     * This works as an alternative to the (CF-Access-Client-Id, CF-Access-Client-Secret) pair of headers.
     * The header value will be interpreted as a json object similar to:
    ...
    saasApp?: pulumi.Input<inputs.zeroTrustAccess.ApplicationSaasApp | undefined>;
    /**
     * Sets the SameSite cookie setting, which provides increased security against CSRF attacks.
     */
     ...
     * Configuration for provisioning to this application via SCIM. This is currently in closed beta.
     */
    scimConfig?: pulumi.Input<inputs.zeroTrustAccess.ApplicationScimConfig | undefined>;
    /**
     * List of public domains that Access will secure. This field is deprecated in favor of `destinations` and will be supported until **November 21, 2025.** If `destinations` are provided, then `selfHostedDomains` will be ignored.
     *
     * @deprecated This attribute is deprecated.
    ...
    targetCriterias?: pulumi.Input<pulumi.Input<inputs.zeroTrustAccess.ApplicationTargetCriteria>[] | undefined>;
    /**
     * The application type.
     * Available values: "self*hosted", "saas", "ssh", "vnc", "app*launcher", "warp", "biso", "bookmark", "dash*sso", "infrastructure", "rdp", "mcp", "mcp*portal", "proxyEndpoint".
     */
