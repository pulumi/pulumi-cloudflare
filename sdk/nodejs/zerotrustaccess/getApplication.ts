...
export function getApplication(args?: GetApplicationArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:zeroTrustAccess/application:getApplication", {
...
export interface GetApplicationArgs {
     ...
     */
    appId?: string;
    filter?: inputs.zeroTrustAccess.GetApplicationFilter;
    /**
...
export interface GetApplicationResult {
    ...
    readonly corsHeaders: outputs.zeroTrustAccess.GetApplicationCorsHeaders;
    /**
     ...
     */
    readonly destinations: outputs.zeroTrustAccess.GetApplicationDestination[];
    /**
    ...
    readonly filter?: outputs.zeroTrustAccess.GetApplicationFilter;
    /**
     * The links in the App Launcher footer.
     */
    readonly footerLinks: outputs.zeroTrustAccess.GetApplicationFooterLink[];
    /**
     ...
     */
    readonly landingPageDesign: outputs.zeroTrustAccess.GetApplicationLandingPageDesign;
    /**
     ...
     */
    readonly mfaConfig: outputs.zeroTrustAccess.GetApplicationMfaConfig;
    /**
    ...
    readonly policies: outputs.zeroTrustAccess.GetApplicationPolicy[];
    /**
    ...
    readonly saasApp: outputs.zeroTrustAccess.GetApplicationSaasApp;
    /**
     ...
     */
    readonly scimConfig: outputs.zeroTrustAccess.GetApplicationScimConfig;
    /**
    ...
    readonly targetCriterias: outputs.zeroTrustAccess.GetApplicationTargetCriteria[];
    /**
...
export function getApplicationOutput(args?: GetApplicationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApplicationResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:zeroTrustAccess/application:getApplication", {
        "accountId": args.accountId,
        "appId": args.appId,
        "filter": args.filter,
        "zoneId": args.zoneId,
...
export interface GetApplicationOutputArgs {
    ...
    filter?: pulumi.Input<inputs.zeroTrustAccess.GetApplicationFilterArgs | undefined>;
    /**
     * The Zone ID to use for this endpoint. Mutually exclusive with the Account ID.
     */
