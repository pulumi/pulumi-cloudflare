...
export class Config extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:tokenValidation/config:Config';
     ...
     */
    declare public readonly credentials: pulumi.Output<outputs.tokenValidation.ConfigCredentials>;
    ...
    constructor(name: string, argsOrState?: ConfigArgs | ConfigState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/tokenValidationConfig:TokenValidationConfig" }] };
...
export interface ConfigState {
     ...
     * Request payload for create and PUT credentials operations. Provided keys define the complete stored key set. Key identities (`{alg,kid}`) must be unique.
     */
    credentials?: pulumi.Input<inputs.tokenValidation.ConfigCredentials | undefined>;
...
export interface ConfigArgs {
     ...
     * Request payload for create and PUT credentials operations. Provided keys define the complete stored key set. Key identities (`{alg,kid}`) must be unique.
     */
    credentials: pulumi.Input<inputs.tokenValidation.ConfigCredentials>;
