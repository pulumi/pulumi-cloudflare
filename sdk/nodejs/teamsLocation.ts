...
export class TeamsLocation extends pulumi.CustomResource {
     ...
     */
    declare public readonly endpoints: pulumi.Output<outputs.TeamsLocationEndpoints | undefined>;
    /**
     ...
     */
    declare public readonly networks: pulumi.Output<outputs.TeamsLocationNetwork[]>;
