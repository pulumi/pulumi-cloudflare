 ...
 *
 * const examplePipeline = new cloudflare.pipeline.Pipeline("example_pipeline", {
...
export class Pipeline extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:pipeline/pipeline:Pipeline';
     ...
     */
    declare public /*out*/ readonly tables: pulumi.Output<outputs.pipeline.PipelineTable[]>;
    ...
    constructor(name: string, argsOrState?: PipelineArgs | PipelineState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/pipeline:Pipeline" }] };
...
export interface PipelineState {
     ...
     * List of streams and sinks used by this pipeline.
     */
    tables?: pulumi.Input<pulumi.Input<inputs.pipeline.PipelineTable>[] | undefined>;
}
