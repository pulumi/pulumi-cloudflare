...
export function getZeroTrustDeviceCustomProfile(args: GetZeroTrustDeviceCustomProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetZeroTrustDeviceCustomProfileResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:zeroTrustDeviceCustomProfile/zeroTrustDeviceCustomProfile:getZeroTrustDeviceCustomProfile", {
...
export interface GetZeroTrustDeviceCustomProfileResult {
     ...
     */
    readonly dnsSearchSuffixes: outputs.zeroTrustDeviceCustomProfile.GetZeroTrustDeviceCustomProfileDnsSearchSuffix[];
    /**
     ...
     */
    readonly excludes: outputs.zeroTrustDeviceCustomProfile.GetZeroTrustDeviceCustomProfileExclude[];
    readonly fallbackDomains: outputs.zeroTrustDeviceCustomProfile.GetZeroTrustDeviceCustomProfileFallbackDomain[];
     ...
     */
    readonly includes: outputs.zeroTrustDeviceCustomProfile.GetZeroTrustDeviceCustomProfileInclude[];
    /**
    ...
    readonly serviceModeV2: outputs.zeroTrustDeviceCustomProfile.GetZeroTrustDeviceCustomProfileServiceModeV2;
    /**
    ...
    readonly targetTests: outputs.zeroTrustDeviceCustomProfile.GetZeroTrustDeviceCustomProfileTargetTest[];
    /**
     ...
     */
    readonly virtualNetworks: outputs.zeroTrustDeviceCustomProfile.GetZeroTrustDeviceCustomProfileVirtualNetworks;
}
/**
 * ## Example Usage
 *
...
export function getZeroTrustDeviceCustomProfileOutput(args: GetZeroTrustDeviceCustomProfileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetZeroTrustDeviceCustomProfileResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:zeroTrustDeviceCustomProfile/zeroTrustDeviceCustomProfile:getZeroTrustDeviceCustomProfile", {
        "accountId": args.accountId,
        "policyId": args.policyId,
    }, opts);
}
