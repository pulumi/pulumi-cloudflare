...
export function getHostnames(args?: GetHostnamesArgs, opts?: pulumi.InvokeOptions): Promise<GetHostnamesResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:custom/hostnames:getHostnames", {
...
export interface GetHostnamesArgs {
     ...
     */
    direction?: string;
    hostname?: inputs.custom.GetHostnamesHostname;
    /**
...
export interface GetHostnamesResult {
    ...
    readonly hostname?: outputs.custom.GetHostnamesHostname;
    /**
     * Filter by the hostname's activation status.
     * Available values: "active", "pending", "active*redeploying", "moved", "pending*deletion", "deleted", "pending*blocked", "pending*migration", "pending*provisioned", "test*pending", "test*active", "test*active*apex", "test*blocked", "testFailed", "provisioned", "blocked".
     */
     ...
     */
    readonly results: outputs.custom.GetHostnamesResult[];
    /**
     * Whether to filter hostnames based on if they have SSL enabled.
     * Available values: 0, 1.
     */
...
export function getHostnamesOutput(args?: GetHostnamesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHostnamesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:custom/hostnames:getHostnames", {
        "certificateAuthority": args.certificateAuthority,
        "customOriginServer": args.customOriginServer,
        "direction": args.direction,
        "hostname": args.hostname,
...
export interface GetHostnamesOutputArgs {
    ...
    hostname?: pulumi.Input<inputs.custom.GetHostnamesHostnameArgs | undefined>;
    /**
     * Filter by the hostname's activation status.
     * Available values: "active", "pending", "active*redeploying", "moved", "pending*deletion", "deleted", "pending*blocked", "pending*migration", "pending*provisioned", "test*pending", "test*active", "test*active*apex", "test*blocked", "testFailed", "provisioned", "blocked".
     */
