...
export class Csr extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:custom/csr:Csr';
    ...
    constructor(name: string, argsOrState?: CsrArgs | CsrState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/customCsr:CustomCsr" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(Csr.__pulumiType, name, resourceInputs, opts);
    }
}
