...
export class Ssl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:custom/ssl:Ssl';
     ...
     */
    declare public readonly geoRestrictions: pulumi.Output<outputs.custom.SslGeoRestrictions | undefined>;
    declare public /*out*/ readonly hosts: pulumi.Output<string[]>;
    /**
     * The certificate authority that issued the certificate.
     */
    declare public /*out*/ readonly issuer: pulumi.Output<string>;
    declare public /*out*/ readonly keylessServer: pulumi.Output<outputs.custom.SslKeylessServer>;
    /**
    ...
    constructor(name: string, argsOrState?: SslArgs | SslState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/customSsl:CustomSsl" }] };
...
export interface SslState {
     ...
     * Specify the region where your private key can be held locally for optimal TLS performance. HTTPS connections to any excluded data center will still be fully encrypted, but will incur some latency while Keyless SSL is used to complete the handshake with the nearest allowed data center. Options allow distribution to only to U.S. data centers, only to E.U. data centers, or only to highest security data centers. Default distribution is to all Cloudflare datacenters, for optimal performance.
     */
    geoRestrictions?: pulumi.Input<inputs.custom.SslGeoRestrictions | undefined>;
    hosts?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * The certificate authority that issued the certificate.
     */
    issuer?: pulumi.Input<string | undefined>;
    keylessServer?: pulumi.Input<inputs.custom.SslKeylessServer | undefined>;
    /**
     * When the certificate was last modified.
     */
