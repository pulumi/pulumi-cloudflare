...
export class Page extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustAccessCustom/page:Page';
    ...
    constructor(name: string, argsOrState?: PageArgs | PageState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustAccessCustomPage:ZeroTrustAccessCustomPage" }, { type: "cloudflare:index/accessCustomPage:AccessCustomPage" }] };
