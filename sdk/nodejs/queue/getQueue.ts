...
export function getQueue(args: GetQueueArgs, opts?: pulumi.InvokeOptions): Promise<GetQueueResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:queue/queue:getQueue", {
...
export interface GetQueueResult {
    ...
    readonly consumers: outputs.queue.GetQueueConsumer[];
    ...
    readonly producers: outputs.queue.GetQueueProducer[];
    ...
    readonly settings: outputs.queue.GetQueueSettings;
}
/**
 * Accepted Permissions
 *
...
export function getQueueOutput(args: GetQueueOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetQueueResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:queue/queue:getQueue", {
        "accountId": args.accountId,
        "queueId": args.queueId,
    }, opts);
}
