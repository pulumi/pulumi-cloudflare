...
export function getList(args?: GetListArgs, opts?: pulumi.InvokeOptions): Promise<GetListResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:pageShieldScripts/list:getList", {
...
export interface GetListResult {
    ...
    readonly results: outputs.pageShieldScripts.GetListResult[];
...
export function getListOutput(args?: GetListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:pageShieldScripts/list:getList", {
        "direction": args.direction,
        "excludeCdnCgi": args.excludeCdnCgi,
        "excludeDuplicates": args.excludeDuplicates,
        "excludeUrls": args.excludeUrls,
