...
export function getRule(args: GetRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetRuleResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:magicNetworkMonitoring/rule:getRule", {
...
export function getRuleOutput(args: GetRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:magicNetworkMonitoring/rule:getRule", {
        "accountId": args.accountId,
        "ruleId": args.ruleId,
    }, opts);
}
