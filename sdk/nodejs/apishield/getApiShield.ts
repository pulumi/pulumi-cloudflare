...
export function getApiShield(args?: GetApiShieldArgs, opts?: pulumi.InvokeOptions): Promise<GetApiShieldResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:apiShield/apiShield:getApiShield", {
...
export interface GetApiShieldResult {
    readonly authIdCharacteristics: outputs.apiShield.GetApiShieldAuthIdCharacteristic[];
    /**
     * Identifier.
     */
    readonly id: string;
...
export function getApiShieldOutput(args?: GetApiShieldOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApiShieldResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:apiShield/apiShield:getApiShield", {
        "normalize": args.normalize,
        "zoneId": args.zoneId,
    }, opts);
}
