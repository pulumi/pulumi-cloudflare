...
export class Client extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:oauth/client:Client';
     ...
     */
    declare public /*out*/ readonly clientUriVerification: pulumi.Output<outputs.oauth.ClientClientUriVerification>;
    /**
    ...
    constructor(name: string, argsOrState?: ClientArgs | ClientState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/oauthClient:OauthClient" }] };
...
export interface ClientState {
     ...
     * Client URI domain control verification state.
     */
    clientUriVerification?: pulumi.Input<inputs.oauth.ClientClientUriVerification | undefined>;
    /**
     * Timestamp when the OAuth client was created.
     */
