 ...
 * ```
 */
export function getWorkersForPlatformsScriptSecret(args: GetWorkersForPlatformsScriptSecretArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkersForPlatformsScriptSecretResult> {
 ...
 * ```
 */
export function getWorkersForPlatformsScriptSecretOutput(args: GetWorkersForPlatformsScriptSecretOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkersForPlatformsScriptSecretResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
