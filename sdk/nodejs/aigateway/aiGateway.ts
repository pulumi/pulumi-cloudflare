 ...
 *
 * const exampleAiGateway = new cloudflare.aigateway.AiGateway("example_ai_gateway", {
...
export class AiGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:aiGateway/aiGateway:AiGateway';
    ...
    declare public readonly dlp: pulumi.Output<outputs.aiGateway.AiGatewayDlp | undefined>;
    declare public readonly guardrails: pulumi.Output<outputs.aiGateway.AiGatewayGuardrails | undefined>;
    ...
    declare public readonly otels: pulumi.Output<outputs.aiGateway.AiGatewayOtel[]>;
    ...
    declare public readonly spendLimits: pulumi.Output<outputs.aiGateway.AiGatewaySpendLimits>;
    declare public readonly storeId: pulumi.Output<string | undefined>;
    declare public readonly stripe: pulumi.Output<outputs.aiGateway.AiGatewayStripe | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AiGatewayArgs | AiGatewayState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/aiGateway:AiGateway" }] };
...
export interface AiGatewayState {
    ...
    dlp?: pulumi.Input<inputs.aiGateway.AiGatewayDlp | undefined>;
    guardrails?: pulumi.Input<inputs.aiGateway.AiGatewayGuardrails | undefined>;
    ...
    otels?: pulumi.Input<pulumi.Input<inputs.aiGateway.AiGatewayOtel>[] | undefined>;
    ...
    spendLimits?: pulumi.Input<inputs.aiGateway.AiGatewaySpendLimits | undefined>;
    storeId?: pulumi.Input<string | undefined>;
    stripe?: pulumi.Input<inputs.aiGateway.AiGatewayStripe | undefined>;
    /**
     * Controls how Workers AI inference calls routed through this gateway are billed. Only 'postpaid' is currently supported.
     * Available values: "postpaid".
     */
