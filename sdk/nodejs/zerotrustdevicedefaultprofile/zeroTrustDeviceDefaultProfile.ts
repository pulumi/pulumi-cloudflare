...
export class ZeroTrustDeviceDefaultProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile';
     ...
     */
    declare public readonly dnsSearchSuffixes: pulumi.Output<outputs.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileDnsSearchSuffix[]>;
    /**
     * Whether the policy will be applied to matching devices.
     */
     ...
     */
    declare public readonly excludes: pulumi.Output<outputs.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileExclude[]>;
    declare public /*out*/ readonly fallbackDomains: pulumi.Output<outputs.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileFallbackDomain[]>;
     ...
     */
    declare public readonly globalAcceleration: pulumi.Output<outputs.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileGlobalAcceleration | undefined>;
    /**
     * List of routes included in the WARP client's tunnel. Both 'exclude' and 'include' cannot be set in the same request.
     */
    declare public readonly includes: pulumi.Output<outputs.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileInclude[]>;
    /**
    ...
    declare public readonly serviceModeV2: pulumi.Output<outputs.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileServiceModeV2>;
    /**
     ...
     */
    declare public readonly virtualNetworks: pulumi.Output<outputs.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileVirtualNetworks | undefined>;
    ...
    constructor(name: string, argsOrState?: ZeroTrustDeviceDefaultProfileArgs | ZeroTrustDeviceDefaultProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile" }] };
...
export interface ZeroTrustDeviceDefaultProfileState {
     ...
     * List of DNS search suffixes to apply to clients. Suffixes are evaluated in order. Use an empty array to clear.
     */
    dnsSearchSuffixes?: pulumi.Input<pulumi.Input<inputs.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileDnsSearchSuffix>[] | undefined>;
    /**
     * Whether the policy will be applied to matching devices.
     */
     ...
     * List of routes excluded in the WARP client's tunnel. Both 'exclude' and 'include' cannot be set in the same request.
     */
    excludes?: pulumi.Input<pulumi.Input<inputs.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileExclude>[] | undefined>;
    fallbackDomains?: pulumi.Input<pulumi.Input<inputs.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileFallbackDomain>[] | undefined>;
    gatewayUniqueId?: pulumi.Input<string | undefined>;
    /**
     * Global Acceleration settings for China. When configured, WARP clients connect to the Global Accelerator addresses instead of the default ones. Please contact your account representative to enable this feature on your account. See https://developers.cloudflare.com/china-network/concepts/global-acceleration/.
     */
    globalAcceleration?: pulumi.Input<inputs.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileGlobalAcceleration | undefined>;
    /**
     * List of routes included in the WARP client's tunnel. Both 'exclude' and 'include' cannot be set in the same request.
     */
    includes?: pulumi.Input<pulumi.Input<inputs.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileInclude>[] | undefined>;
    /**
     * The amount of time in minutes a user is allowed access to their LAN. A value of 0 will allow LAN access until the next WARP reconnection, such as a reboot or a laptop waking from sleep. Note that this field is omitted from the response if null or unset.
     */
    ...
    serviceModeV2?: pulumi.Input<inputs.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileServiceModeV2 | undefined>;
    /**
     * The URL to launch when the Send Feedback button is clicked.
     */
     ...
     * Virtual network access settings for the device.
     */
    virtualNetworks?: pulumi.Input<inputs.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileVirtualNetworks | undefined>;
}
