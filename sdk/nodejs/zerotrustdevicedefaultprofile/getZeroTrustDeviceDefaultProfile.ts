 ...
 *
 * const exampleZeroTrustDeviceDefaultProfile = cloudflare.zerotrustdevicedefaultprofile.getZeroTrustDeviceDefaultProfile({
...
export function getZeroTrustDeviceDefaultProfile(args?: GetZeroTrustDeviceDefaultProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetZeroTrustDeviceDefaultProfileResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:getZeroTrustDeviceDefaultProfile", {
...
export interface GetZeroTrustDeviceDefaultProfileResult {
     ...
     */
    readonly dnsSearchSuffixes: outputs.zeroTrustDeviceDefaultProfile.GetZeroTrustDeviceDefaultProfileDnsSearchSuffix[];
    /**
     * Whether the policy will be applied to matching devices.
     */
     ...
     */
    readonly excludes: outputs.zeroTrustDeviceDefaultProfile.GetZeroTrustDeviceDefaultProfileExclude[];
    readonly fallbackDomains: outputs.zeroTrustDeviceDefaultProfile.GetZeroTrustDeviceDefaultProfileFallbackDomain[];
     ...
     */
    readonly includes: outputs.zeroTrustDeviceDefaultProfile.GetZeroTrustDeviceDefaultProfileInclude[];
    ...
    readonly serviceModeV2: outputs.zeroTrustDeviceDefaultProfile.GetZeroTrustDeviceDefaultProfileServiceModeV2;
    /**
     ...
     */
    readonly virtualNetworks: outputs.zeroTrustDeviceDefaultProfile.GetZeroTrustDeviceDefaultProfileVirtualNetworks;
}
/**
 * ## Example Usage
 *
...
export function getZeroTrustDeviceDefaultProfileOutput(args?: GetZeroTrustDeviceDefaultProfileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetZeroTrustDeviceDefaultProfileResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:getZeroTrustDeviceDefaultProfile", {
        "accountId": args.accountId,
    }, opts);
}
