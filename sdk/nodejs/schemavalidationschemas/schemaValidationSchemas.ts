...
export class SchemaValidationSchemas extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:schemaValidationSchemas/schemaValidationSchemas:SchemaValidationSchemas';
    ...
    constructor(name: string, argsOrState?: SchemaValidationSchemasArgs | SchemaValidationSchemasState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/schemaValidationSchemas:SchemaValidationSchemas" }] };
