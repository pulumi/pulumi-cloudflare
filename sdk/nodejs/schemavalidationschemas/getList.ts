...
export function getList(args?: GetListArgs, opts?: pulumi.InvokeOptions): Promise<GetListResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:schemaValidationSchemas/list:getList", {
...
export interface GetListResult {
     ...
     */
    readonly results: outputs.schemaValidationSchemas.GetListResult[];
    /**
     * Filter for enabled schemas
     */
...
export function getListOutput(args?: GetListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:schemaValidationSchemas/list:getList", {
        "maxItems": args.maxItems,
        "omitSource": args.omitSource,
        "validationEnabled": args.validationEnabled,
        "zoneId": args.zoneId,
