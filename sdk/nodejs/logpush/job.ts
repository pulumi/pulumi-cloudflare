...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:logpush/job:Job';
     ...
     */
    declare public readonly maxUploadIntervalSeconds: pulumi.Output<number>;
    /**
     ...
     */
    declare public readonly maxUploadRecords: pulumi.Output<number>;
    /**
     ...
     */
    declare public readonly outputOptions: pulumi.Output<outputs.logpush.JobOutputOptions | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: JobArgs | JobState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/logpushJob:LogpushJob" }] };
...
export interface JobState {
     ...
     * The structured replacement for `logpullOptions`. When including this field, the `logpullOption` field will be ignored.
     */
    outputOptions?: pulumi.Input<inputs.logpush.JobOutputOptions | undefined>;
    /**
     * Ownership challenge token to prove destination ownership.
     */
