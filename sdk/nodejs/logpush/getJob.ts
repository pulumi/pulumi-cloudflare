...
export function getJob(args: GetJobArgs, opts?: pulumi.InvokeOptions): Promise<GetJobResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:logpush/job:getJob", {
...
export interface GetJobResult {
     ...
     */
    readonly outputOptions: outputs.logpush.GetJobOutputOptions;
    /**
     * The Zone ID to use for this endpoint. Mutually exclusive with the Account ID.
     */
...
export function getJobOutput(args: GetJobOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetJobResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:logpush/job:getJob", {
        "accountId": args.accountId,
        "jobId": args.jobId,
        "zoneId": args.zoneId,
    }, opts);
