...
export function getShare(args: GetShareArgs, opts?: pulumi.InvokeOptions): Promise<GetShareResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:share/share:getShare", {
...
export interface GetShareArgs {
     ...
     */
    accountId: string;
    filter?: inputs.share.GetShareFilter;
    /**
...
export interface GetShareResult {
    ...
    readonly filter?: outputs.share.GetShareFilter;
    /**
     * Share identifier tag.
     */
    readonly id: string;
     ...
     */
    readonly resources: outputs.share.GetShareResource[];
    /**
     * Share identifier tag.
     */
...
export function getShareOutput(args: GetShareOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetShareResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:share/share:getShare", {
        "accountId": args.accountId,
        "filter": args.filter,
        "includeRecipientCounts": args.includeRecipientCounts,
        "includeResources": args.includeResources,
...
export interface GetShareOutputArgs {
    ...
    filter?: pulumi.Input<inputs.share.GetShareFilterArgs | undefined>;
    /**
     * Include recipient counts in the response.
     */
