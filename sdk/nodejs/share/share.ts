 ...
 *
 * const exampleShare = new cloudflare.share.Share("example_share", {
...
export class Share extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:share/share:Share';
    ...
    declare public readonly recipients: pulumi.Output<outputs.share.ShareRecipient[]>;
    declare public readonly resources: pulumi.Output<outputs.share.ShareResource[]>;
    /**
    ...
    constructor(name: string, argsOrState?: ShareArgs | ShareState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/share:Share" }] };
...
export interface ShareState {
    ...
    recipients?: pulumi.Input<pulumi.Input<inputs.share.ShareRecipient>[] | undefined>;
    resources?: pulumi.Input<pulumi.Input<inputs.share.ShareResource>[] | undefined>;
    /**
     * Available values: "active", "deleting", "deleted".
     */
...
export interface ShareArgs {
    ...
    recipients: pulumi.Input<pulumi.Input<inputs.share.ShareRecipient>[]>;
    resources: pulumi.Input<pulumi.Input<inputs.share.ShareResource>[]>;
}
