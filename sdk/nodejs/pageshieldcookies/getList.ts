...
export function getList(args?: GetListArgs, opts?: pulumi.InvokeOptions): Promise<GetListResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:pageShieldCookies/list:getList", {
...
export interface GetListResult {
    ...
    readonly results: outputs.pageShieldCookies.GetListResult[];
...
export function getListOutput(args?: GetListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:pageShieldCookies/list:getList", {
        "direction": args.direction,
        "domain": args.domain,
        "export": args.export,
        "hosts": args.hosts,
