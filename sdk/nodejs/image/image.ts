 ...
 *
 * const exampleImage = new cloudflare.image.Image("example_image", {
...
export class Image extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:image/image:Image';
    ...
    constructor(name: string, argsOrState?: ImageArgs | ImageState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/image:Image" }] };
