...
export class Snippets extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SnippetsState, opts?: pulumi.CustomResourceOptions): Snippets {
        pulumi.log.warn("Snippets is deprecated: cloudflare:index/snippets:Snippets has been deprecated in favor of cloudflare:snippets/snippets:Snippets")
     ...
     */
    declare public readonly metadata: pulumi.Output<outputs.SnippetsMetadata>;
    /**
