 ...
 *
 * const exampleAuthenticatedOriginPulls = new cloudflare.authenticatedoriginpulls.AuthenticatedOriginPulls("example_authenticated_origin_pulls", {
...
export class AuthenticatedOriginPulls extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:authenticatedOriginPulls/authenticatedOriginPulls:AuthenticatedOriginPulls';
    ...
    declare public readonly configs: pulumi.Output<outputs.authenticatedOriginPulls.AuthenticatedOriginPullsConfig[]>;
    /**
    ...
    constructor(name: string, argsOrState?: AuthenticatedOriginPullsArgs | AuthenticatedOriginPullsState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/authenticatedOriginPulls:AuthenticatedOriginPulls" }] };
...
export interface AuthenticatedOriginPullsState {
    ...
    configs?: pulumi.Input<pulumi.Input<inputs.authenticatedOriginPulls.AuthenticatedOriginPullsConfig>[] | undefined>;
    /**
     * The time when the certificate was created.
     */
...
export interface AuthenticatedOriginPullsArgs {
    configs: pulumi.Input<pulumi.Input<inputs.authenticatedOriginPulls.AuthenticatedOriginPullsConfig>[]>;
    /**
     * Identifier.
     */
