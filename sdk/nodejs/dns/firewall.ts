...
export class Firewall extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:dns/firewall:Firewall';
     ...
     */
    declare public readonly attackMitigation: pulumi.Output<outputs.dns.FirewallAttackMitigation>;
    /**
    ...
    constructor(name: string, argsOrState?: FirewallArgs | FirewallState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/dnsFirewall:DnsFirewall" }] };
...
export interface FirewallState {
     ...
     * Attack mitigation settings
     */
    attackMitigation?: pulumi.Input<inputs.dns.FirewallAttackMitigation | undefined>;
    /**
     * Whether to refuse to answer queries for the ANY type
     */
