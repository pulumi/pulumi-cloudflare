...
export class Record extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:dns/record:Record';
     ...
     */
    declare public readonly data: pulumi.Output<outputs.dns.RecordData | undefined>;
    /**
     ...
     */
    declare public readonly settings: pulumi.Output<outputs.dns.RecordSettings>;
    /**
    ...
    constructor(name: string, argsOrState?: RecordArgs | RecordState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/record:Record" }, { type: "cloudflare:index/dnsRecord:DnsRecord" }] };
...
export interface RecordState {
     ...
     * Components of a MX record.
     */
    data?: pulumi.Input<inputs.dns.RecordData | undefined>;
    /**
     * Extra Cloudflare-specific information about the record.
     */
     ...
     * Settings for the DNS record.
     */
    settings?: pulumi.Input<inputs.dns.RecordSettings | undefined>;
    /**
     * Custom tags for the DNS record. This field has no effect on DNS responses.
     */
