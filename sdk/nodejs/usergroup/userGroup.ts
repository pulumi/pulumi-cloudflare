 ...
 *
 * const exampleUserGroup = new cloudflare.usergroup.UserGroup("example_user_group", {
...
export class UserGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:userGroup/userGroup:UserGroup';
     ...
     */
    declare public readonly policies: pulumi.Output<outputs.userGroup.UserGroupPolicy[] | undefined>;
    ...
    constructor(name: string, argsOrState?: UserGroupArgs | UserGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/userGroup:UserGroup" }] };
...
export interface UserGroupState {
     ...
     * Policies attached to the User group
     */
    policies?: pulumi.Input<pulumi.Input<inputs.userGroup.UserGroupPolicy>[] | undefined>;
}
