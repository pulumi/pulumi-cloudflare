...
export class ZeroTrustDevicePostureRule extends pulumi.CustomResource {
     ...
     */
    declare public readonly input: pulumi.Output<outputs.ZeroTrustDevicePostureRuleInput | undefined>;
    /**
     * The conditions that the client must match to run the rule.
     */
    declare public readonly matches: pulumi.Output<outputs.ZeroTrustDevicePostureRuleMatch[] | undefined>;
    /**
