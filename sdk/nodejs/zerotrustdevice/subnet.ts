...
export class Subnet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustDevice/subnet:Subnet';
     ...
     */
    declare public /*out*/ readonly capacity: pulumi.Output<outputs.zeroTrustDevice.SubnetCapacity>;
    /**
    ...
    constructor(name: string, argsOrState?: SubnetArgs | SubnetState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustDeviceSubnet:ZeroTrustDeviceSubnet" }] };
...
export interface SubnetState {
     ...
     * IP capacity information for the subnet.
     */
    capacity?: pulumi.Input<inputs.zeroTrustDevice.SubnetCapacity | undefined>;
    /**
     * An optional description of the subnet.
     */
