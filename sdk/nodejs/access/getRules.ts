...
export function getRules(args?: GetRulesArgs, opts?: pulumi.InvokeOptions): Promise<GetRulesResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:access/rules:getRules", {
...
export interface GetRulesArgs {
     ...
     */
    accountId?: string;
    configuration?: inputs.access.GetRulesConfiguration;
    /**
...
export interface GetRulesResult {
    ...
    readonly configuration?: outputs.access.GetRulesConfiguration;
    /**
     * Defines the direction used to sort returned rules.
     * Available values: "asc", "desc".
     */
     ...
     */
    readonly results: outputs.access.GetRulesResult[];
    /**
     * The Zone ID to use for this endpoint. Mutually exclusive with the Account ID.
     */
...
export function getRulesOutput(args?: GetRulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRulesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:access/rules:getRules", {
        "accountId": args.accountId,
        "configuration": args.configuration,
        "direction": args.direction,
        "match": args.match,
...
export interface GetRulesOutputArgs {
    ...
    configuration?: pulumi.Input<inputs.access.GetRulesConfigurationArgs | undefined>;
    /**
     * Defines the direction used to sort returned rules.
     * Available values: "asc", "desc".
     */
