...
export class Rule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:access/rule:Rule';
     ...
     */
    declare public readonly configuration: pulumi.Output<outputs.access.RuleConfiguration>;
    /**
     ...
     */
    declare public /*out*/ readonly scope: pulumi.Output<outputs.access.RuleScope>;
    /**
    ...
    constructor(name: string, argsOrState?: RuleArgs | RuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/accessRule:AccessRule" }] };
...
export interface RuleState {
     ...
     * The rule configuration.
     */
    configuration?: pulumi.Input<inputs.access.RuleConfiguration | undefined>;
    /**
     * The timestamp of when the rule was created.
     */
     ...
     * All zones owned by the user will have the rule applied.
     */
    scope?: pulumi.Input<inputs.access.RuleScope | undefined>;
    /**
     * The Zone ID to use for this endpoint. Mutually exclusive with the Account ID.
     */
...
export interface RuleArgs {
     ...
     * The rule configuration.
     */
    configuration: pulumi.Input<inputs.access.RuleConfiguration>;
    /**
     * The action to apply to a matched request.
     * Available values: "block", "challenge", "whitelist", "js*challenge", "managed*challenge".
     */
