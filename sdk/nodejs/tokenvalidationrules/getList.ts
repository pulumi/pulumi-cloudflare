...
export function getList(args?: GetListArgs, opts?: pulumi.InvokeOptions): Promise<GetListResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:tokenValidationRules/list:getList", {
        "action": args.action,
...
export interface GetListResult {
     ...
     */
    readonly results: outputs.tokenValidationRules.GetListResult[];
    /**
     * Select rules with these IDs.
     */
...
export function getListOutput(args?: GetListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:tokenValidationRules/list:getList", {
        "action": args.action,
        "enabled": args.enabled,
        "host": args.host,
        "hostname": args.hostname,
