...
export function getTokens(args?: GetTokensArgs, opts?: pulumi.InvokeOptions): Promise<GetTokensResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:aiSearch/tokens:getTokens", {
...
export interface GetTokensResult {
     ...
     */
    readonly results: outputs.aiSearch.GetTokensResult[];
    /**
     * Filter tokens whose name contains this string (case-insensitive).
     */
...
export function getTokensOutput(args?: GetTokensOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTokensResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:aiSearch/tokens:getTokens", {
        "accountId": args.accountId,
        "maxItems": args.maxItems,
        "search": args.search,
    }, opts);
