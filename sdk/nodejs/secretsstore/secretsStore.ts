...
export class SecretsStore extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:secretsStore/secretsStore:SecretsStore';
    ...
    constructor(name: string, argsOrState?: SecretsStoreArgs | SecretsStoreState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/secretsStore:SecretsStore" }] };
