...
export class Registry extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:emailSecurityImpersonation/registry:Registry';
    ...
    constructor(name: string, argsOrState?: RegistryArgs | RegistryState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/emailSecurityImpersonationRegistry:EmailSecurityImpersonationRegistry" }] };
