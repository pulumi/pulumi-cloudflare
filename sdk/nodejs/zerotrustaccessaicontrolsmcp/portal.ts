...
export class Portal extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustAccessAiControlsMcp/portal:Portal';
    ...
    declare public readonly servers: pulumi.Output<outputs.zeroTrustAccessAiControlsMcp.PortalServer[]>;
    /**
     * portal id
     */
    ...
    constructor(name: string, argsOrState?: PortalArgs | PortalState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustAccessAiControlsMcpPortal:ZeroTrustAccessAiControlsMcpPortal" }] };
...
export interface PortalState {
    ...
    servers?: pulumi.Input<pulumi.Input<inputs.zeroTrustAccessAiControlsMcp.PortalServer>[] | undefined>;
    /**
     * portal id
     */
