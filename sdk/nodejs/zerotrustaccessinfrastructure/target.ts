...
export class Target extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustAccessInfrastructure/target:Target';
     ...
     */
    declare public readonly ip: pulumi.Output<outputs.zeroTrustAccessInfrastructure.TargetIp>;
    /**
    ...
    constructor(name: string, argsOrState?: TargetArgs | TargetState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustAccessInfrastructureTarget:ZeroTrustAccessInfrastructureTarget" }] };
...
export interface TargetState {
     ...
     * The IPv4/IPv6 address that identifies where to reach a target
     */
    ip?: pulumi.Input<inputs.zeroTrustAccessInfrastructure.TargetIp | undefined>;
    /**
     * Date and time at which the target was modified
     */
...
export interface TargetArgs {
     ...
     * The IPv4/IPv6 address that identifies where to reach a target
     */
    ip: pulumi.Input<inputs.zeroTrustAccessInfrastructure.TargetIp>;
}
