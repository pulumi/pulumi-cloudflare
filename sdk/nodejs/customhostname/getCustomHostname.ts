...
export function getCustomHostname(args?: GetCustomHostnameArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomHostnameResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:customHostname/customHostname:getCustomHostname", {
...
export interface GetCustomHostnameArgs {
    ...
    filter?: inputs.customHostname.GetCustomHostnameFilter;
    /**
     * Identifier.
     */
    zoneId?: string;
...
export interface GetCustomHostnameResult {
    ...
    readonly filter?: outputs.customHostname.GetCustomHostnameFilter;
    /**
     ...
     */
    readonly ownershipVerification: outputs.customHostname.GetCustomHostnameOwnershipVerification;
    /**
     * This presents the token to be served by the given http url to activate a hostname.
     */
    readonly ownershipVerificationHttp: outputs.customHostname.GetCustomHostnameOwnershipVerificationHttp;
    readonly ssl: outputs.customHostname.GetCustomHostnameSsl;
    /**
...
export function getCustomHostnameOutput(args?: GetCustomHostnameOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCustomHostnameResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:customHostname/customHostname:getCustomHostname", {
        "customHostnameId": args.customHostnameId,
        "filter": args.filter,
        "zoneId": args.zoneId,
    }, opts);
...
export interface GetCustomHostnameOutputArgs {
    ...
    filter?: pulumi.Input<inputs.customHostname.GetCustomHostnameFilterArgs | undefined>;
    /**
     * Identifier.
     */
