...
export class CustomHostname extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:customHostname/customHostname:CustomHostname';
     ...
     */
    declare public /*out*/ readonly ownershipVerification: pulumi.Output<outputs.customHostname.CustomHostnameOwnershipVerification>;
    /**
     * This presents the token to be served by the given http url to activate a hostname.
     */
    declare public /*out*/ readonly ownershipVerificationHttp: pulumi.Output<outputs.customHostname.CustomHostnameOwnershipVerificationHttp>;
    /**
     * SSL properties used when creating the custom hostname.
     */
    declare public readonly ssl: pulumi.Output<outputs.customHostname.CustomHostnameSsl | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CustomHostnameArgs | CustomHostnameState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/customHostname:CustomHostname" }] };
...
export interface CustomHostnameState {
     ...
     * This is a record which can be placed to activate a hostname.
     */
    ownershipVerification?: pulumi.Input<inputs.customHostname.CustomHostnameOwnershipVerification | undefined>;
    /**
     * This presents the token to be served by the given http url to activate a hostname.
     */
    ownershipVerificationHttp?: pulumi.Input<inputs.customHostname.CustomHostnameOwnershipVerificationHttp | undefined>;
    /**
     * SSL properties used when creating the custom hostname.
     */
    ssl?: pulumi.Input<inputs.customHostname.CustomHostnameSsl | undefined>;
    /**
     * Status of the hostname's activation.
     * Available values: "active", "pending", "active*redeploying", "moved", "pending*deletion", "deleted", "pending*blocked", "pending*migration", "pending*provisioned", "test*pending", "test*active", "test*active*apex", "test*blocked", "testFailed", "provisioned", "blocked".
     */
