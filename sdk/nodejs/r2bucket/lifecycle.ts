...
export class Lifecycle extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:r2Bucket/lifecycle:Lifecycle';
    ...
    declare public readonly rules: pulumi.Output<outputs.r2Bucket.LifecycleRule[] | undefined>;
    ...
    constructor(name: string, argsOrState?: LifecycleArgs | LifecycleState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/r2BucketLifecycle:R2BucketLifecycle" }] };
...
export interface LifecycleState {
    ...
    rules?: pulumi.Input<pulumi.Input<inputs.r2Bucket.LifecycleRule>[] | undefined>;
}
