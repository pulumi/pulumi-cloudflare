 ...
 *
 * const exampleWorker = new cloudflare.worker.Worker("example_worker", {
 ...
 *
 * ```sh
 * $ pulumi import cloudflare:worker/worker:Worker example '<account_id>/<worker_id>'
 * ```
 */
export class Worker extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:worker/worker:Worker';
     ...
     */
    declare public readonly observability: pulumi.Output<outputs.worker.WorkerObservability>;
    /**
     * Other resources that reference the Worker and depend on it existing.
     */
    declare public /*out*/ readonly references: pulumi.Output<outputs.worker.WorkerReferences>;
    /**
     * Subdomain settings for the Worker.
     */
    declare public readonly subdomain: pulumi.Output<outputs.worker.WorkerSubdomain>;
    /**
     ...
     */
    declare public readonly tailConsumers: pulumi.Output<outputs.worker.WorkerTailConsumer[]>;
    /**
    ...
    constructor(name: string, argsOrState?: WorkerArgs | WorkerState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/worker:Worker" }] };
...
export interface WorkerState {
     ...
     * Observability settings for the Worker.
     */
    observability?: pulumi.Input<inputs.worker.WorkerObservability | undefined>;
    /**
     * Other resources that reference the Worker and depend on it existing.
     */
    references?: pulumi.Input<inputs.worker.WorkerReferences | undefined>;
    /**
     * Subdomain settings for the Worker.
     */
    subdomain?: pulumi.Input<inputs.worker.WorkerSubdomain | undefined>;
    /**
     * Tags associated with the Worker.
     */
     ...
     * Other Workers that should consume logs from the Worker.
     */
    tailConsumers?: pulumi.Input<pulumi.Input<inputs.worker.WorkerTailConsumer>[] | undefined>;
    /**
     * When the Worker was most recently updated.
     */
