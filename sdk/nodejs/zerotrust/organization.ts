...
export class Organization extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrust/organization:Organization';
    ...
    declare public readonly customPages: pulumi.Output<outputs.zeroTrust.OrganizationCustomPages | undefined>;
    /**
    ...
    declare public readonly loginDesign: pulumi.Output<outputs.zeroTrust.OrganizationLoginDesign | undefined>;
    /**
     * Configures multi-factor authentication (MFA) settings for an organization.
     */
    declare public readonly mfaConfig: pulumi.Output<outputs.zeroTrust.OrganizationMfaConfig | undefined>;
    /**
     ...
     */
    declare public readonly mfaSshPivKeyRequirements: pulumi.Output<outputs.zeroTrust.OrganizationMfaSshPivKeyRequirements | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: OrganizationArgs | OrganizationState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustOrganization:ZeroTrustOrganization" }, { type: "cloudflare:index/accessOrganization:AccessOrganization" }] };
...
export interface OrganizationState {
    ...
    customPages?: pulumi.Input<inputs.zeroTrust.OrganizationCustomPages | undefined>;
    /**
     * Determines whether to deny all requests to Cloudflare-protected resources that lack an associated Access application. If enabled, you must explicitly configure an Access application and policy to allow traffic to your Cloudflare-protected resources. For domains you want to be public across all subdomains, add the domain to the `denyUnmatchedRequestsExemptedZoneNames` array.
     */
    ...
    loginDesign?: pulumi.Input<inputs.zeroTrust.OrganizationLoginDesign | undefined>;
    /**
     * Configures multi-factor authentication (MFA) settings for an organization.
     */
    mfaConfig?: pulumi.Input<inputs.zeroTrust.OrganizationMfaConfig | undefined>;
    /**
     * Indicates if this organization can enforce multi-factor authentication (MFA) requirements at the application and policy level.
     */
     ...
     * Configures SSH PIV key requirements for MFA using hardware security keys.
     */
    mfaSshPivKeyRequirements?: pulumi.Input<inputs.zeroTrust.OrganizationMfaSshPivKeyRequirements | undefined>;
    /**
     * The name of your Zero Trust organization.
     */
