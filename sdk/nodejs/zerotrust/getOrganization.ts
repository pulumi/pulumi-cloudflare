...
export function getOrganization(args?: GetOrganizationArgs, opts?: pulumi.InvokeOptions): Promise<GetOrganizationResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:zeroTrust/organization:getOrganization", {
...
export interface GetOrganizationResult {
    ...
    readonly customPages: outputs.zeroTrust.GetOrganizationCustomPages;
    /**
    ...
    readonly loginDesign: outputs.zeroTrust.GetOrganizationLoginDesign;
    /**
     * Configures multi-factor authentication (MFA) settings for an organization.
     */
    readonly mfaConfig: outputs.zeroTrust.GetOrganizationMfaConfig;
    /**
     ...
     */
    readonly mfaSshPivKeyRequirements: outputs.zeroTrust.GetOrganizationMfaSshPivKeyRequirements;
    /**
...
export function getOrganizationOutput(args?: GetOrganizationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrganizationResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:zeroTrust/organization:getOrganization", {
        "accountId": args.accountId,
        "zoneId": args.zoneId,
    }, opts);
}
