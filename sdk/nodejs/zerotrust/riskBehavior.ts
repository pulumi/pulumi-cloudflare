...
export class RiskBehavior extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrust/riskBehavior:RiskBehavior';
    ...
    declare public readonly behaviors: pulumi.Output<{[key: string]: outputs.zeroTrust.RiskBehaviorBehaviors}>;
    ...
    constructor(name: string, argsOrState?: RiskBehaviorArgs | RiskBehaviorState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustRiskBehavior:ZeroTrustRiskBehavior" }, { type: "cloudflare:index/riskBehavior:RiskBehavior" }] };
...
export interface RiskBehaviorState {
    ...
    behaviors?: pulumi.Input<{[key: string]: pulumi.Input<inputs.zeroTrust.RiskBehaviorBehaviors>} | undefined>;
}
...
export interface RiskBehaviorArgs {
    ...
    behaviors: pulumi.Input<{[key: string]: pulumi.Input<inputs.zeroTrust.RiskBehaviorBehaviors>}>;
}
