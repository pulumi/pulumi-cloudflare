...
export class SnippetRules extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:snippetRules/snippetRules:SnippetRules';
     ...
     * Lists snippet rules.
     */
    declare public readonly rules: pulumi.Output<outputs.snippetRules.SnippetRulesRule[]>;
    /**
    ...
    constructor(name: string, argsOrState?: SnippetRulesArgs | SnippetRulesState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/snippetRules:SnippetRules" }] };
...
export interface SnippetRulesState {
     ...
     * Lists snippet rules.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.snippetRules.SnippetRulesRule>[] | undefined>;
    /**
     * Use this field to specify the unique ID of the zone.
     */
...
export interface SnippetRulesArgs {
     ...
     * Lists snippet rules.
     */
    rules: pulumi.Input<pulumi.Input<inputs.snippetRules.SnippetRulesRule>[]>;
    /**
     * Use this field to specify the unique ID of the zone.
     */
