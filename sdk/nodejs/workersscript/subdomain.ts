...
export class Subdomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:workersScript/subdomain:Subdomain';
    ...
    constructor(name: string, argsOrState?: SubdomainArgs | SubdomainState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/workersScriptSubdomain:WorkersScriptSubdomain" }] };
