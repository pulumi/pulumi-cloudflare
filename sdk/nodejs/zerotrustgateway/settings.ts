...
export class Settings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustGateway/settings:Settings';
     ...
     */
    declare public readonly settings: pulumi.Output<outputs.zeroTrustGateway.SettingsSettings | undefined>;
    ...
    constructor(name: string, argsOrState?: SettingsArgs | SettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustGatewaySettings:ZeroTrustGatewaySettings" }, { type: "cloudflare:index/teamsAccount:TeamsAccount" }] };
...
export interface SettingsState {
     ...
     * Specify account settings.
     */
    settings?: pulumi.Input<inputs.zeroTrustGateway.SettingsSettings | undefined>;
