...
export function getPolicy(args: GetPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:zeroTrustGateway/policy:getPolicy", {
...
export interface GetPolicyResult {
     ...
     */
    readonly expiration: outputs.zeroTrustGateway.GetPolicyExpiration;
    /**
     ...
     */
    readonly ruleSettings: outputs.zeroTrustGateway.GetPolicyRuleSettings;
    /**
     * Defines the schedule for activating DNS policies. Settable only for `dns` and `dnsResolver` rules.
     */
    readonly schedule: outputs.zeroTrustGateway.GetPolicySchedule;
    /**
...
export function getPolicyOutput(args: GetPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPolicyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:zeroTrustGateway/policy:getPolicy", {
        "accountId": args.accountId,
        "ruleId": args.ruleId,
    }, opts);
}
