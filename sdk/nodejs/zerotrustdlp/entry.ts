 ...
 *
 * const exampleZeroTrustDlpEntry = new cloudflare.zerotrustdlp.Entry("example_zero_trust_dlp_entry", {
...
export class Entry extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustDlp/entry:Entry';
    ...
    declare public /*out*/ readonly confidence: pulumi.Output<outputs.zeroTrustDlp.EntryConfidence>;
    declare public /*out*/ readonly createdAt: pulumi.Output<string>;
    declare public readonly description: pulumi.Output<string | undefined>;
    declare public readonly enabled: pulumi.Output<boolean>;
    declare public readonly name: pulumi.Output<string>;
    declare public readonly pattern: pulumi.Output<outputs.zeroTrustDlp.EntryPattern>;
    declare public readonly profileId: pulumi.Output<string | undefined>;
    declare public /*out*/ readonly profiles: pulumi.Output<outputs.zeroTrustDlp.EntryProfile[]>;
     ...
     */
    declare public /*out*/ readonly variant: pulumi.Output<outputs.zeroTrustDlp.EntryVariant>;
    ...
    constructor(name: string, argsOrState?: EntryArgs | EntryState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustDlpEntry:ZeroTrustDlpEntry" }] };
...
export interface EntryState {
    ...
    confidence?: pulumi.Input<inputs.zeroTrustDlp.EntryConfidence | undefined>;
    createdAt?: pulumi.Input<string | undefined>;
    description?: pulumi.Input<string | undefined>;
    enabled?: pulumi.Input<boolean | undefined>;
    name?: pulumi.Input<string | undefined>;
    pattern?: pulumi.Input<inputs.zeroTrustDlp.EntryPattern | undefined>;
    profileId?: pulumi.Input<string | undefined>;
    profiles?: pulumi.Input<pulumi.Input<inputs.zeroTrustDlp.EntryProfile>[] | undefined>;
     ...
     * A Predefined AI prompt classification topic entry.
     */
    variant?: pulumi.Input<inputs.zeroTrustDlp.EntryVariant | undefined>;
...
export interface EntryArgs {
    ...
    pattern: pulumi.Input<inputs.zeroTrustDlp.EntryPattern>;
    profileId?: pulumi.Input<string | undefined>;
    /**
     * Available values: "custom", "predefined", "integration".
     */
