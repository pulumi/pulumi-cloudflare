...
export class GreTunnel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:magicWan/greTunnel:GreTunnel';
    ...
    declare public readonly bgp: pulumi.Output<outputs.magicWan.GreTunnelBgp | undefined>;
    declare public /*out*/ readonly bgpStatus: pulumi.Output<outputs.magicWan.GreTunnelBgpStatus>;
    /**
    ...
    declare public readonly healthCheck: pulumi.Output<outputs.magicWan.GreTunnelHealthCheck>;
    /**
    ...
    constructor(name: string, argsOrState?: GreTunnelArgs | GreTunnelState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/magicWanGreTunnel:MagicWanGreTunnel" }] };
...
export interface GreTunnelState {
    ...
    bgp?: pulumi.Input<inputs.magicWan.GreTunnelBgp | undefined>;
    bgpStatus?: pulumi.Input<inputs.magicWan.GreTunnelBgpStatus | undefined>;
    /**
     * The IP address assigned to the Cloudflare side of the GRE tunnel.
     */
    ...
    healthCheck?: pulumi.Input<inputs.magicWan.GreTunnelHealthCheck | undefined>;
    /**
     * A 31-bit prefix (/31 in CIDR notation) supporting two hosts, one for each side of the tunnel. Select the subnet from the following private IP space: 10.0.0.0–10.255.255.255, 172.16.0.0–172.31.255.255, 192.168.0.0–192.168.255.255.
     */
