...
export class StaticRoute extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:magicWan/staticRoute:StaticRoute';
     ...
     */
    declare public readonly scope: pulumi.Output<outputs.magicWan.StaticRouteScope | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: StaticRouteArgs | StaticRouteState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/staticRoute:StaticRoute" }, { type: "cloudflare:index/magicWanStaticRoute:MagicWanStaticRoute" }] };
...
export interface StaticRouteState {
     ...
     * Used only for ECMP routes.
     */
    scope?: pulumi.Input<inputs.magicWan.StaticRouteScope | undefined>;
    /**
     * Optional weight of the ECMP scope - if provided.
     */
