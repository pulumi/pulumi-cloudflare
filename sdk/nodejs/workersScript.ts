...
export class WorkersScript extends pulumi.CustomResource {
     ...
     */
    public readonly limits!: pulumi.Output<outputs.WorkersScriptLimits | undefined>;
    /**
     ...
     */
    public /*out*/ readonly namedHandlers!: pulumi.Output<outputs.WorkersScriptNamedHandler[]>;
    /**
