 ...
 *
 * const exampleMagicTransitSite = new cloudflare.magictransitsite.MagicTransitSite("example_magic_transit_site", {
...
export class MagicTransitSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:magicTransitSite/magicTransitSite:MagicTransitSite';
     ...
     */
    declare public readonly location: pulumi.Output<outputs.magicTransitSite.MagicTransitSiteLocation | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: MagicTransitSiteArgs | MagicTransitSiteState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/magicTransitSite:MagicTransitSite" }] };
...
export interface MagicTransitSiteState {
     ...
     * Location of site in latitude and longitude.
     */
    location?: pulumi.Input<inputs.magicTransitSite.MagicTransitSiteLocation | undefined>;
    /**
     * The name of the site.
     */
