...
export function getList(args?: GetListArgs, opts?: pulumi.InvokeOptions): Promise<GetListResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:zeroTrustDeviceManagedNetworks/list:getList", {
...
export interface GetListResult {
     ...
     */
    readonly results: outputs.zeroTrustDeviceManagedNetworks.GetListResult[];
}
/**
 * ## Example Usage
 *
...
export function getListOutput(args?: GetListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:zeroTrustDeviceManagedNetworks/list:getList", {
        "accountId": args.accountId,
        "maxItems": args.maxItems,
    }, opts);
}
