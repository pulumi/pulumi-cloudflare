 ...
 *
 * const exampleWaitingRoomSettings = new cloudflare.waitingroom.Settings("example_waiting_room_settings", {
...
export class Settings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:waitingRoom/settings:Settings';
    ...
    constructor(name: string, argsOrState?: SettingsArgs | SettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/waitingRoomSettings:WaitingRoomSettings" }] };
