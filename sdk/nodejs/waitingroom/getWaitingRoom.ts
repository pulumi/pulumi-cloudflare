...
export function getWaitingRoom(args: GetWaitingRoomArgs, opts?: pulumi.InvokeOptions): Promise<GetWaitingRoomResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:waitingRoom/waitingRoom:getWaitingRoom", {
...
export interface GetWaitingRoomResult {
     ...
     */
    readonly additionalRoutes: outputs.waitingRoom.GetWaitingRoomAdditionalRoute[];
    /**
     * Configures cookie attributes for the waiting room cookie. This encrypted cookie stores a user's status in the waiting room, such as queue position.
     */
    readonly cookieAttributes: outputs.waitingRoom.GetWaitingRoomCookieAttributes;
    /**
...
export function getWaitingRoomOutput(args: GetWaitingRoomOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWaitingRoomResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:waitingRoom/waitingRoom:getWaitingRoom", {
        "waitingRoomId": args.waitingRoomId,
        "zoneId": args.zoneId,
    }, opts);
}
