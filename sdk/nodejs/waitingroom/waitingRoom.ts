...
export class WaitingRoom extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:waitingRoom/waitingRoom:WaitingRoom';
     ...
     */
    declare public readonly additionalRoutes: pulumi.Output<outputs.waitingRoom.WaitingRoomAdditionalRoute[]>;
    /**
     * Configures cookie attributes for the waiting room cookie. This encrypted cookie stores a user's status in the waiting room, such as queue position.
     */
    declare public readonly cookieAttributes: pulumi.Output<outputs.waitingRoom.WaitingRoomCookieAttributes>;
    /**
     ...
     */
    declare public readonly customPageHtml: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly defaultTemplateLanguage: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly disableSessionRenewal: pulumi.Output<boolean>;
    /**
     * A list of enabled origin commands.
     */
    declare public readonly enabledOriginCommands: pulumi.Output<string[]>;
    /**
     ...
     *     }
     */
    declare public readonly jsonResponseEnabled: pulumi.Output<boolean>;
     ...
     */
    declare public readonly newUsersPerMinute: pulumi.Output<number>;
    /**
     * An ISO 8601 timestamp that marks when the next event will begin queueing.
     */
    declare public /*out*/ readonly nextEventPrequeueStartTime: pulumi.Output<string>;
    /**
     * An ISO 8601 timestamp that marks when the next event will start.
     */
    declare public /*out*/ readonly nextEventStartTime: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly queueAll: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly queueingMethod: pulumi.Output<string>;
    /**
     * HTTP status code returned to a user while in the queue.
     * Available values: 200, 202, 429.
     */
    declare public readonly queueingStatusCode: pulumi.Output<number>;
    /**
     ...
     */
    declare public readonly totalActiveUsers: pulumi.Output<number>;
    /**
     ...
     */
    declare public readonly turnstileAction: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly turnstileMode: pulumi.Output<string>;
    /**
     * Identifier.
     */
    ...
    constructor(name: string, argsOrState?: WaitingRoomArgs | WaitingRoomState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/waitingRoom:WaitingRoom" }] };
...
export interface WaitingRoomState {
     ...
     * Only available for the Waiting Room Advanced subscription. Additional hostname and path combinations to which this waiting room will be applied. There is an implied wildcard at the end of the path. The hostname and path combination must be unique to this and all other waiting rooms.
     */
    additionalRoutes?: pulumi.Input<pulumi.Input<inputs.waitingRoom.WaitingRoomAdditionalRoute>[] | undefined>;
    /**
     * Configures cookie attributes for the waiting room cookie. This encrypted cookie stores a user's status in the waiting room, such as queue position.
     */
    cookieAttributes?: pulumi.Input<inputs.waitingRoom.WaitingRoomCookieAttributes | undefined>;
    /**
     * Appends a '_' + a custom suffix to the end of Cloudflare Waiting Room's cookie name(_*cf*waitingroom). If `cookieSuffix` is "abcd", the cookie name will be `__cf_waitingroom_abcd`. This field is required if using `additionalRoutes`.
     */
