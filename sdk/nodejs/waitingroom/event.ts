 ...
 *
 * const exampleWaitingRoomEvent = new cloudflare.waitingroom.Event("example_waiting_room_event", {
...
export class Event extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:waitingRoom/event:Event';
    ...
    constructor(name: string, argsOrState?: EventArgs | EventState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/waitingRoomEvent:WaitingRoomEvent" }] };
