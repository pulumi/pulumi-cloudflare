...
export function getCertificates(args: GetCertificatesArgs, opts?: pulumi.InvokeOptions): Promise<GetCertificatesResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:originCa/certificates:getCertificates", {
        "limit": args.limit,
...
export interface GetCertificatesResult {
     ...
     */
    readonly results: outputs.originCa.GetCertificatesResult[];
    /**
     * Identifier.
     */
...
export function getCertificatesOutput(args: GetCertificatesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCertificatesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:originCa/certificates:getCertificates", {
        "limit": args.limit,
        "maxItems": args.maxItems,
        "offset": args.offset,
        "zoneId": args.zoneId,
