...
export class SchemaValidationOperationSettings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:schemaValidationOperationSettings/schemaValidationOperationSettings:SchemaValidationOperationSettings';
    ...
    constructor(name: string, argsOrState?: SchemaValidationOperationSettingsArgs | SchemaValidationOperationSettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/schemaValidationOperationSettings:SchemaValidationOperationSettings" }] };
