 ...
 *
 * const exampleWebAnalyticsSite = new cloudflare.webanalytics.Site("example_web_analytics_site", {
...
export class Site extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:webAnalytics/site:Site';
     ...
     * A list of rules.
     */
    declare public /*out*/ readonly rules: pulumi.Output<outputs.webAnalytics.SiteRule[]>;
    declare public /*out*/ readonly ruleset: pulumi.Output<outputs.webAnalytics.SiteRuleset>;
    /**
    ...
    constructor(name: string, argsOrState?: SiteArgs | SiteState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/webAnalyticsSite:WebAnalyticsSite" }] };
...
export interface SiteState {
     ...
     * A list of rules.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.webAnalytics.SiteRule>[] | undefined>;
    ruleset?: pulumi.Input<inputs.webAnalytics.SiteRuleset | undefined>;
    /**
     * The Web Analytics site identifier.
     */
