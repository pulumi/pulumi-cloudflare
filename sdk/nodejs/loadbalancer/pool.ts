...
export class Pool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:loadBalancer/pool:Pool';
     ...
     */
    declare public readonly loadShedding: pulumi.Output<outputs.loadBalancer.PoolLoadShedding>;
    /**
     ...
     */
    declare public readonly notificationFilter: pulumi.Output<outputs.loadBalancer.PoolNotificationFilter>;
    /**
     * Configures origin steering for the pool. Controls how origins are selected for new sessions and traffic without session affinity.
     */
    declare public readonly originSteering: pulumi.Output<outputs.loadBalancer.PoolOriginSteering>;
    /**
     * The list of origins within this pool. Traffic directed at this pool is balanced across all currently healthy origins, provided the pool itself is healthy.
     */
    declare public readonly origins: pulumi.Output<outputs.loadBalancer.PoolOrigin[]>;
    ...
    constructor(name: string, argsOrState?: PoolArgs | PoolState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/loadBalancerPool:LoadBalancerPool" }] };
...
export interface PoolState {
     ...
     * Configures load shedding policies and percentages for the pool.
     */
    loadShedding?: pulumi.Input<inputs.loadBalancer.PoolLoadShedding | undefined>;
    /**
     * The longitude of the data center containing the origins used in this pool in decimal degrees. If this is set, latitude must also be set.
     */
     ...
     * Filter pool and origin health notifications by resource type or health status. Use null to reset.
     */
    notificationFilter?: pulumi.Input<inputs.loadBalancer.PoolNotificationFilter | undefined>;
    /**
     * Configures origin steering for the pool. Controls how origins are selected for new sessions and traffic without session affinity.
     */
    originSteering?: pulumi.Input<inputs.loadBalancer.PoolOriginSteering | undefined>;
    /**
     * The list of origins within this pool. Traffic directed at this pool is balanced across all currently healthy origins, provided the pool itself is healthy.
     */
    origins?: pulumi.Input<pulumi.Input<inputs.loadBalancer.PoolOrigin>[] | undefined>;
}
...
export interface PoolArgs {
     ...
     * The list of origins within this pool. Traffic directed at this pool is balanced across all currently healthy origins, provided the pool itself is healthy.
     */
    origins: pulumi.Input<pulumi.Input<inputs.loadBalancer.PoolOrigin>[]>;
}
