...
export function getLoadBalancer(args: GetLoadBalancerArgs, opts?: pulumi.InvokeOptions): Promise<GetLoadBalancerResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:loadBalancer/loadBalancer:getLoadBalancer", {
...
export interface GetLoadBalancerResult {
     ...
     */
    readonly adaptiveRouting: outputs.loadBalancer.GetLoadBalancerAdaptiveRouting;
    /**
     ...
     */
    readonly locationStrategy: outputs.loadBalancer.GetLoadBalancerLocationStrategy;
     ...
     */
    readonly randomSteering: outputs.loadBalancer.GetLoadBalancerRandomSteering;
    /**
     * A mapping of region codes to a list of pool IDs (ordered by their failover priority) for the given region. Any regions not explicitly defined will fall back to using default_pools.
     */
     ...
     */
    readonly rules: outputs.loadBalancer.GetLoadBalancerRule[];
    /**
     ...
     */
    readonly sessionAffinityAttributes: outputs.loadBalancer.GetLoadBalancerSessionAffinityAttributes;
    /**
...
export function getLoadBalancerOutput(args: GetLoadBalancerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLoadBalancerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:loadBalancer/loadBalancer:getLoadBalancer", {
        "loadBalancerId": args.loadBalancerId,
        "popPools": args.popPools,
        "regionPools": args.regionPools,
        "zoneId": args.zoneId,
