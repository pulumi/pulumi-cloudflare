...
export class ZeroTrustDlpSensitivityLevel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustDlpSensitivityLevel/zeroTrustDlpSensitivityLevel:ZeroTrustDlpSensitivityLevel';
    ...
    constructor(name: string, argsOrState?: ZeroTrustDlpSensitivityLevelArgs | ZeroTrustDlpSensitivityLevelState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustDlpSensitivityLevel:ZeroTrustDlpSensitivityLevel" }] };
