...
export class Test extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustDex/test:Test';
     ...
     */
    declare public readonly data: pulumi.Output<outputs.zeroTrustDex.TestData>;
    /**
     ...
     */
    declare public readonly targetPolicies: pulumi.Output<outputs.zeroTrustDex.TestTargetPolicy[]>;
    ...
    constructor(name: string, argsOrState?: TestArgs | TestState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustDexTest:ZeroTrustDexTest" }] };
...
export interface TestState {
     ...
     * The configuration object which contains the details for the WARP client to conduct the test.
     */
    data?: pulumi.Input<inputs.zeroTrustDex.TestData | undefined>;
    /**
     * Additional details about the test.
     */
     ...
     * DEX rules targeted by this test
     */
    targetPolicies?: pulumi.Input<pulumi.Input<inputs.zeroTrustDex.TestTargetPolicy>[] | undefined>;
...
export interface TestArgs {
     ...
     * The configuration object which contains the details for the WARP client to conduct the test.
     */
    data: pulumi.Input<inputs.zeroTrustDex.TestData>;
    /**
     * Additional details about the test.
     */
    description?: pulumi.Input<string | undefined>;
