...
export class Database extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:d1/database:Database';
     ...
     */
    declare public readonly readReplication: pulumi.Output<outputs.d1.DatabaseReadReplication | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: DatabaseArgs | DatabaseState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/d1Database:D1Database" }] };
...
export interface DatabaseState {
     ...
     * Configuration for D1 read replication.
     */
    readReplication?: pulumi.Input<inputs.d1.DatabaseReadReplication | undefined>;
    /**
     * D1 database identifier (UUID).
     */
