...
export class Category extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustDlpDataTag/category:Category';
    ...
    declare public /*out*/ readonly tags: pulumi.Output<outputs.zeroTrustDlpDataTag.CategoryTag[]>;
    ...
    constructor(name: string, argsOrState?: CategoryArgs | CategoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustDlpDataTagCategory:ZeroTrustDlpDataTagCategory" }] };
...
export interface CategoryState {
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.zeroTrustDlpDataTag.CategoryTag>[] | undefined>;
