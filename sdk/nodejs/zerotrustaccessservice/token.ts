...
export class Token extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:zeroTrustAccessService/token:Token';
    ...
    constructor(name: string, argsOrState?: TokenArgs | TokenState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/zeroTrustAccessServiceToken:ZeroTrustAccessServiceToken" }, { type: "cloudflare:index/accessServiceToken:AccessServiceToken" }] };
