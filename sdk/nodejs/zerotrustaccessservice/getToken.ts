...
export function getToken(args?: GetTokenArgs, opts?: pulumi.InvokeOptions): Promise<GetTokenResult> {
    ...
    return pulumi.runtime.invoke("cloudflare:zeroTrustAccessService/token:getToken", {
...
export interface GetTokenArgs {
     ...
     */
    accountId?: string;
    filter?: inputs.zeroTrustAccessService.GetTokenFilter;
    /**
     * UUID.
     */
...
export interface GetTokenResult {
    ...
    readonly filter?: outputs.zeroTrustAccessService.GetTokenFilter;
    /**
     * UUID.
     */
    readonly id: string;
...
export function getTokenOutput(args?: GetTokenOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTokenResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:zeroTrustAccessService/token:getToken", {
        "accountId": args.accountId,
        "filter": args.filter,
        "serviceTokenId": args.serviceTokenId,
        "zoneId": args.zoneId,
...
export interface GetTokenOutputArgs {
    ...
    filter?: pulumi.Input<inputs.zeroTrustAccessService.GetTokenFilterArgs | undefined>;
    /**
     * UUID.
     */
