...
export class Peer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:dnsZoneTransfers/peer:Peer';
    ...
    constructor(name: string, argsOrState?: PeerArgs | PeerState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "cloudflare:index/dnsZoneTransfersPeer:DnsZoneTransfersPeer" }] };
