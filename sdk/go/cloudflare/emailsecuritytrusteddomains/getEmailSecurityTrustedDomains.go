...
//			_, err := emailsecuritytrusteddomains.GetEmailSecurityTrustedDomains(ctx, &emailsecuritytrusteddomains.GetEmailSecurityTrustedDomainsArgs{
...
func LookupEmailSecurityTrustedDomains(ctx *pulumi.Context, args *LookupEmailSecurityTrustedDomainsArgs, opts ...pulumi.InvokeOption) (*LookupEmailSecurityTrustedDomainsResult, error) {
	...
	err := ctx.Invoke("cloudflare:emailSecurityTrustedDomains/emailSecurityTrustedDomains:getEmailSecurityTrustedDomains", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupEmailSecurityTrustedDomainsOutput(ctx *pulumi.Context, args LookupEmailSecurityTrustedDomainsOutputArgs, opts ...pulumi.InvokeOption) LookupEmailSecurityTrustedDomainsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEmailSecurityTrustedDomainsResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:emailSecurityTrustedDomains/emailSecurityTrustedDomains:getEmailSecurityTrustedDomains", args, LookupEmailSecurityTrustedDomainsResultOutput{}, options).(LookupEmailSecurityTrustedDomainsResultOutput), nil
