...
// Identifier.
func (o LookupRegionalTieredCacheResultOutput) ZoneId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupRegionalTieredCacheResult) *string { return v.ZoneId }).(pulumi.StringPtrOutput)
}
