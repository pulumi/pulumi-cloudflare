...
func NewZeroTrustTunnelCloudflared(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/zeroTrustTunnelCloudflared:ZeroTrustTunnelCloudflared"),
		},
		{
	...
	err := ctx.RegisterResource("cloudflare:zeroTrustTunnelCloudflared/zeroTrustTunnelCloudflared:ZeroTrustTunnelCloudflared", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetZeroTrustTunnelCloudflared(ctx *pulumi.Context,
	...
	var resource ZeroTrustTunnelCloudflared
	err := ctx.ReadResource("cloudflare:zeroTrustTunnelCloudflared/zeroTrustTunnelCloudflared:ZeroTrustTunnelCloudflared", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
