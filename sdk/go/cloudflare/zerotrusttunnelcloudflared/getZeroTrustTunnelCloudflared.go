...
//			_, err := zerotrusttunnelcloudflared.GetZeroTrustTunnelCloudflared(ctx, &zerotrusttunnelcloudflared.GetZeroTrustTunnelCloudflaredArgs{
...
func LookupZeroTrustTunnelCloudflared(ctx *pulumi.Context, args *LookupZeroTrustTunnelCloudflaredArgs, opts ...pulumi.InvokeOption) (*LookupZeroTrustTunnelCloudflaredResult, error) {
	...
	err := ctx.Invoke("cloudflare:zeroTrustTunnelCloudflared/zeroTrustTunnelCloudflared:getZeroTrustTunnelCloudflared", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupZeroTrustTunnelCloudflaredOutput(ctx *pulumi.Context, args LookupZeroTrustTunnelCloudflaredOutputArgs, opts ...pulumi.InvokeOption) LookupZeroTrustTunnelCloudflaredResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupZeroTrustTunnelCloudflaredResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:zeroTrustTunnelCloudflared/zeroTrustTunnelCloudflared:getZeroTrustTunnelCloudflared", args, LookupZeroTrustTunnelCloudflaredResultOutput{}, options).(LookupZeroTrustTunnelCloudflaredResultOutput), nil
...
// Cloudflare account ID
func (o LookupZeroTrustTunnelCloudflaredResultOutput) AccountId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupZeroTrustTunnelCloudflaredResult) *string { return v.AccountId }).(pulumi.StringPtrOutput)
}
...
// Indicates if this is a locally or remotely configured tunnel. If `local`, manage the tunnel using a YAML file on the origin machine. If `cloudflare`, manage the tunnel on the Zero Trust dashboard.
// Available values: "local", "cloudflare".
func (o LookupZeroTrustTunnelCloudflaredResultOutput) ConfigSrc() pulumi.StringOutput {
	return o.ApplyT(func(v LookupZeroTrustTunnelCloudflaredResult) string { return v.ConfigSrc }).(pulumi.StringOutput)
}
