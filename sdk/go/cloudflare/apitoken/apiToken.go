...
func NewApiToken(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/apiToken:ApiToken"),
		},
	})
	...
	err := ctx.RegisterResource("cloudflare:apiToken/apiToken:ApiToken", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiToken(ctx *pulumi.Context,
	...
	var resource ApiToken
	err := ctx.ReadResource("cloudflare:apiToken/apiToken:ApiToken", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
