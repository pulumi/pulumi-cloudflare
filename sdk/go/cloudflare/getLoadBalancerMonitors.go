...
// Identifier.
func (o LookupLoadBalancerMonitorsResultOutput) AccountId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupLoadBalancerMonitorsResult) *string { return v.AccountId }).(pulumi.StringPtrOutput)
}
