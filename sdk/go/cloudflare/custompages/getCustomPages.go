...
//			_, err := custompages.GetCustomPages(ctx, &custompages.GetCustomPagesArgs{
...
func LookupCustomPages(ctx *pulumi.Context, args *LookupCustomPagesArgs, opts ...pulumi.InvokeOption) (*LookupCustomPagesResult, error) {
	...
	err := ctx.Invoke("cloudflare:customPages/customPages:getCustomPages", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCustomPagesOutput(ctx *pulumi.Context, args LookupCustomPagesOutputArgs, opts ...pulumi.InvokeOption) LookupCustomPagesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCustomPagesResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:customPages/customPages:getCustomPages", args, LookupCustomPagesResultOutput{}, options).(LookupCustomPagesResultOutput), nil
