...
func NewCustomPages(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/customPages:CustomPages"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource CustomPages
	err := ctx.RegisterResource("cloudflare:customPages/customPages:CustomPages", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomPages(ctx *pulumi.Context,
	...
	var resource CustomPages
	err := ctx.ReadResource("cloudflare:customPages/customPages:CustomPages", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
