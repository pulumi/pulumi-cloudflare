...
func NewSetting(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/zoneSetting:ZoneSetting"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Setting
	err := ctx.RegisterResource("cloudflare:zone/setting:Setting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSetting(ctx *pulumi.Context,
	...
	var resource Setting
	err := ctx.ReadResource("cloudflare:zone/setting:Setting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Whether or not this setting can be modified for this zone (based on your Cloudflare plan level).
func (o SettingOutput) Editable() pulumi.BoolOutput {
	return o.ApplyT(func(v *Setting) pulumi.BoolOutput { return v.Editable }).(pulumi.BoolOutput)
}
...
// last time this setting was modified.
func (o SettingOutput) ModifiedOn() pulumi.StringOutput {
	return o.ApplyT(func(v *Setting) pulumi.StringOutput { return v.ModifiedOn }).(pulumi.StringOutput)
}

// Setting name
func (o SettingOutput) SettingId() pulumi.StringOutput {
	return o.ApplyT(func(v *Setting) pulumi.StringOutput { return v.SettingId }).(pulumi.StringOutput)
}

// Value of the zone setting.
// Notes: The interval (in seconds) from when development mode expires (positive integer) or last expired (negative integer) for the domain. If development mode has never been enabled, this value is false.
func (o SettingOutput) TimeRemaining() pulumi.Float64Output {
	return o.ApplyT(func(v *Setting) pulumi.Float64Output { return v.TimeRemaining }).(pulumi.Float64Output)
}

// Current value of the zone setting.
func (o SettingOutput) Value() pulumi.AnyOutput {
	return o.ApplyT(func(v *Setting) pulumi.AnyOutput { return v.Value }).(pulumi.AnyOutput)
}

// Identifier
func (o SettingOutput) ZoneId() pulumi.StringOutput {
	return o.ApplyT(func(v *Setting) pulumi.StringOutput { return v.ZoneId }).(pulumi.StringOutput)
}
