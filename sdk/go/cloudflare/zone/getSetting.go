...
//			_, err := zone.LookupSetting(ctx, &zone.LookupSettingArgs{
...
func LookupSetting(ctx *pulumi.Context, args *LookupSettingArgs, opts ...pulumi.InvokeOption) (*LookupSettingResult, error) {
	...
	err := ctx.Invoke("cloudflare:zone/setting:getSetting", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSettingOutput(ctx *pulumi.Context, args LookupSettingOutputArgs, opts ...pulumi.InvokeOption) LookupSettingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSettingResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:zone/setting:getSetting", args, LookupSettingResultOutput{}, options).(LookupSettingResultOutput), nil
...
// Whether or not this setting can be modified for this zone (based on your Cloudflare plan level).
func (o LookupSettingResultOutput) Editable() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupSettingResult) bool { return v.Editable }).(pulumi.BoolOutput)
}

// ssl-recommender enrollment setting.
func (o LookupSettingResultOutput) Enabled() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupSettingResult) bool { return v.Enabled }).(pulumi.BoolOutput)
}
...
// last time this setting was modified.
func (o LookupSettingResultOutput) ModifiedOn() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSettingResult) string { return v.ModifiedOn }).(pulumi.StringOutput)
}

// Setting name
func (o LookupSettingResultOutput) SettingId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSettingResult) string { return v.SettingId }).(pulumi.StringOutput)
}

// Value of the zone setting.
// Notes: The interval (in seconds) from when development mode expires (positive integer) or last expired (negative integer) for the domain. If development mode has never been enabled, this value is false.
func (o LookupSettingResultOutput) TimeRemaining() pulumi.Float64Output {
	return o.ApplyT(func(v LookupSettingResult) float64 { return v.TimeRemaining }).(pulumi.Float64Output)
}
...
// Identifier
func (o LookupSettingResultOutput) ZoneId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSettingResult) *string { return v.ZoneId }).(pulumi.StringPtrOutput)
}
