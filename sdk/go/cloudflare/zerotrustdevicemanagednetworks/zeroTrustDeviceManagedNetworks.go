...
func NewZeroTrustDeviceManagedNetworks(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/zeroTrustDeviceManagedNetworks:ZeroTrustDeviceManagedNetworks"),
		},
		{
	...
	err := ctx.RegisterResource("cloudflare:zeroTrustDeviceManagedNetworks/zeroTrustDeviceManagedNetworks:ZeroTrustDeviceManagedNetworks", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetZeroTrustDeviceManagedNetworks(ctx *pulumi.Context,
	...
	var resource ZeroTrustDeviceManagedNetworks
	err := ctx.ReadResource("cloudflare:zeroTrustDeviceManagedNetworks/zeroTrustDeviceManagedNetworks:ZeroTrustDeviceManagedNetworks", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
