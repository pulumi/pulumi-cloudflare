...
//			_, err := image.LookupImage(ctx, &image.LookupImageArgs{
...
func LookupImage(ctx *pulumi.Context, args *LookupImageArgs, opts ...pulumi.InvokeOption) (*LookupImageResult, error) {
	...
	err := ctx.Invoke("cloudflare:image/image:getImage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupImageOutput(ctx *pulumi.Context, args LookupImageOutputArgs, opts ...pulumi.InvokeOption) LookupImageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupImageResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:image/image:getImage", args, LookupImageResultOutput{}, options).(LookupImageResultOutput), nil
