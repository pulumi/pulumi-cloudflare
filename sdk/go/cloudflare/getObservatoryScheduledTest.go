...
// Identifier.
func (o LookupObservatoryScheduledTestResultOutput) ZoneId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupObservatoryScheduledTestResult) *string { return v.ZoneId }).(pulumi.StringPtrOutput)
}
