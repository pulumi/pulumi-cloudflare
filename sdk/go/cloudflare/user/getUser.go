...
//			_, err := user.LookupUser(ctx, map[string]interface{}{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func LookupUser(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*LookupUserResult, error) {
	...
	err := ctx.Invoke("cloudflare:user/user:getUser", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupUserOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) LookupUserResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (LookupUserResultOutput, error) {
		...
		return ctx.InvokeOutput("cloudflare:user/user:getUser", nil, LookupUserResultOutput{}, options).(LookupUserResultOutput), nil
