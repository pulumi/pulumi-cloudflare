...
func NewCustomHostname(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/customHostname:CustomHostname"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource CustomHostname
	err := ctx.RegisterResource("cloudflare:customHostname/customHostname:CustomHostname", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomHostname(ctx *pulumi.Context,
	...
	var resource CustomHostname
	err := ctx.ReadResource("cloudflare:customHostname/customHostname:CustomHostname", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
