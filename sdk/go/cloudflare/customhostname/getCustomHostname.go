...
//			_, err := customhostname.GetCustomHostname(ctx, &customhostname.GetCustomHostnameArgs{
...
func LookupCustomHostname(ctx *pulumi.Context, args *LookupCustomHostnameArgs, opts ...pulumi.InvokeOption) (*LookupCustomHostnameResult, error) {
	...
	err := ctx.Invoke("cloudflare:customHostname/customHostname:getCustomHostname", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCustomHostnameOutput(ctx *pulumi.Context, args LookupCustomHostnameOutputArgs, opts ...pulumi.InvokeOption) LookupCustomHostnameResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCustomHostnameResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:customHostname/customHostname:getCustomHostname", args, LookupCustomHostnameResultOutput{}, options).(LookupCustomHostnameResultOutput), nil
