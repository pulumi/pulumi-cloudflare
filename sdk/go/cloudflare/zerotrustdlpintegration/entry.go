...
//
// ```sh
// $ pulumi import cloudflare:zeroTrustDlpIntegration/entry:Entry example '<account_id>/<entry_id>'
// ```
type Entry struct {
...
func NewEntry(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/zeroTrustDlpIntegrationEntry:ZeroTrustDlpIntegrationEntry"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Entry
	err := ctx.RegisterResource("cloudflare:zeroTrustDlpIntegration/entry:Entry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntry(ctx *pulumi.Context,
	...
	var resource Entry
	err := ctx.ReadResource("cloudflare:zeroTrustDlpIntegration/entry:Entry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
