...
func NewRiskBehavior(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/zeroTrustRiskBehavior:ZeroTrustRiskBehavior"),
		},
		{
	...
	err := ctx.RegisterResource("cloudflare:zeroTrust/riskBehavior:RiskBehavior", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRiskBehavior(ctx *pulumi.Context,
	...
	var resource RiskBehavior
	err := ctx.ReadResource("cloudflare:zeroTrust/riskBehavior:RiskBehavior", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
