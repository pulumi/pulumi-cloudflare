...
func LookupZoneDnssecOutput(ctx *pulumi.Context, args LookupZoneDnssecOutputArgs, opts ...pulumi.InvokeOption) LookupZoneDnssecResultOutput {
	...
	return ctx.InvokeOutput("cloudflare:index/getZoneDnssec:getZoneDnssec", args, LookupZoneDnssecResultOutput{}, options).(LookupZoneDnssecResultOutput)
}
...
func (o LookupZoneDnssecResultOutput) DnssecUseNsec3() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupZoneDnssecResult) bool { return v.DnssecUseNsec3 }).(pulumi.BoolOutput)
}
...
// Identifier.
func (o LookupZoneDnssecResultOutput) ZoneId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupZoneDnssecResult) *string { return v.ZoneId }).(pulumi.StringPtrOutput)
}
