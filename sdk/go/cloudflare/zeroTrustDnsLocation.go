...
type ZeroTrustDnsLocation struct {
	...
	Endpoints ZeroTrustDnsLocationEndpointsOutput `pulumi:"endpoints"`
...
// The identifier of the pair of IPv4 addresses assigned to this location. When creating a location, if this field is absent or set with null, the pair of shared IPv4 addresses (0e4a32c6-6fb8-4858-9296-98f51631e8e6) is auto-assigned. When updating a location, if the field is absent or set with null, the pre-assigned pair remains unchanged.
func (o ZeroTrustDnsLocationOutput) DnsDestinationIpsId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ZeroTrustDnsLocation) pulumi.StringPtrOutput { return v.DnsDestinationIpsId }).(pulumi.StringPtrOutput)
}
...
// The destination endpoints configured for this location. When updating a location, if this field is absent or set with null, the endpoints configuration remains unchanged.
func (o ZeroTrustDnsLocationOutput) Endpoints() ZeroTrustDnsLocationEndpointsOutput {
	return o.ApplyT(func(v *ZeroTrustDnsLocation) ZeroTrustDnsLocationEndpointsOutput { return v.Endpoints }).(ZeroTrustDnsLocationEndpointsOutput)
}
