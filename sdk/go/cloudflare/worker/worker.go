...
func NewWorker(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/worker:Worker"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Worker
	err := ctx.RegisterResource("cloudflare:worker/worker:Worker", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorker(ctx *pulumi.Context,
	...
	var resource Worker
	err := ctx.ReadResource("cloudflare:worker/worker:Worker", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
