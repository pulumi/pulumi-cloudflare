...
type Share struct {
	...
	Recipients     ShareRecipientArrayOutput `pulumi:"recipients"`
	Resources      ShareResourceArrayOutput  `pulumi:"resources"`
...
func NewShare(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/share:Share"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Share
	err := ctx.RegisterResource("cloudflare:share/share:Share", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetShare(ctx *pulumi.Context,
	...
	var resource Share
	err := ctx.ReadResource("cloudflare:share/share:Share", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type shareState struct {
	...
	Recipients     []ShareRecipient `pulumi:"recipients"`
	Resources      []ShareResource  `pulumi:"resources"`
	// Available values: "active", "deleting", "deleted".
...
type ShareState struct {
	...
	Recipients     ShareRecipientArrayInput
	Resources      ShareResourceArrayInput
	// Available values: "active", "deleting", "deleted".
...
func (o ShareOutput) Recipients() ShareRecipientArrayOutput {
	return o.ApplyT(func(v *Share) ShareRecipientArrayOutput { return v.Recipients }).(ShareRecipientArrayOutput)
}

func (o ShareOutput) Resources() ShareResourceArrayOutput {
	return o.ApplyT(func(v *Share) ShareResourceArrayOutput { return v.Resources }).(ShareResourceArrayOutput)
}
