...
func LookupShare(ctx *pulumi.Context, args *LookupShareArgs, opts ...pulumi.InvokeOption) (*LookupShareResult, error) {
	...
	err := ctx.Invoke("cloudflare:share/share:getShare", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupShareResult struct {
	...
	Resources []GetShareResource `pulumi:"resources"`
	// Share identifier tag.
	ShareId *string `pulumi:"shareId"`
...
func LookupShareOutput(ctx *pulumi.Context, args LookupShareOutputArgs, opts ...pulumi.InvokeOption) LookupShareResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupShareResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:share/share:getShare", args, LookupShareResultOutput{}, options).(LookupShareResultOutput), nil
...
// A list of resources that are part of the share. This field is only included when requested via the 'include_resources' parameter.
func (o LookupShareResultOutput) Resources() GetShareResourceArrayOutput {
	return o.ApplyT(func(v LookupShareResult) []GetShareResource { return v.Resources }).(GetShareResourceArrayOutput)
}
