...
func (o IpsecTunnelOutput) HealthCheckDirection() pulumi.StringOutput {
	return o.ApplyT(func(v *IpsecTunnel) pulumi.StringOutput { return v.HealthCheckDirection }).(pulumi.StringOutput)
}
...
func (o IpsecTunnelOutput) HealthCheckRate() pulumi.StringOutput {
	return o.ApplyT(func(v *IpsecTunnel) pulumi.StringOutput { return v.HealthCheckRate }).(pulumi.StringOutput)
}
...
func (o IpsecTunnelOutput) ReplayProtection() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *IpsecTunnel) pulumi.BoolPtrOutput { return v.ReplayProtection }).(pulumi.BoolPtrOutput)
}
