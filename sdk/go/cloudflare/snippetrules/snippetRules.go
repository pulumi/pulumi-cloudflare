...
func NewSnippetRules(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/snippetRules:SnippetRules"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource SnippetRules
	err := ctx.RegisterResource("cloudflare:snippetRules/snippetRules:SnippetRules", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnippetRules(ctx *pulumi.Context,
	...
	var resource SnippetRules
	err := ctx.ReadResource("cloudflare:snippetRules/snippetRules:SnippetRules", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
