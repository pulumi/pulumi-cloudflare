...
func NewApiShieldSchema(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/apiShieldSchema:ApiShieldSchema"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource ApiShieldSchema
	err := ctx.RegisterResource("cloudflare:apiShieldSchema/apiShieldSchema:ApiShieldSchema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiShieldSchema(ctx *pulumi.Context,
	...
	var resource ApiShieldSchema
	err := ctx.ReadResource("cloudflare:apiShieldSchema/apiShieldSchema:ApiShieldSchema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
