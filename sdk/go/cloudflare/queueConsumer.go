...
// Name of a Worker
func (o QueueConsumerOutput) ScriptName() pulumi.StringOutput {
	return o.ApplyT(func(v *QueueConsumer) pulumi.StringOutput { return v.ScriptName }).(pulumi.StringOutput)
}
