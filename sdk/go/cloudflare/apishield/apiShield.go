...
//			_, err := apishield.NewApiShield(ctx, "example_api_shield", &apishield.ApiShieldArgs{
//				ZoneId: pulumi.String("023e105f4ecef8ad9ca31a8372d0c353"),
//				AuthIdCharacteristics: apishield.ApiShieldAuthIdCharacteristicArray{
//					&apishield.ApiShieldAuthIdCharacteristicArgs{
...
func NewApiShield(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/apiShield:ApiShield"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource ApiShield
	err := ctx.RegisterResource("cloudflare:apiShield/apiShield:ApiShield", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiShield(ctx *pulumi.Context,
	...
	var resource ApiShield
	err := ctx.ReadResource("cloudflare:apiShield/apiShield:ApiShield", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
