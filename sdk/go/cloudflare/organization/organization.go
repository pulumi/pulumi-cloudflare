...
type Organization struct {
	...
	Profile    OrganizationProfilePtrOutput `pulumi:"profile"`
}
...
func NewOrganization(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/organization:Organization"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Organization
	err := ctx.RegisterResource("cloudflare:organization/organization:Organization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganization(ctx *pulumi.Context,
	...
	var resource Organization
	err := ctx.ReadResource("cloudflare:organization/organization:Organization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type organizationState struct {
	...
	Profile    *OrganizationProfile `pulumi:"profile"`
}
...
type OrganizationState struct {
	...
	Profile    OrganizationProfilePtrInput
}
...
func (o OrganizationOutput) Profile() OrganizationProfilePtrOutput {
	return o.ApplyT(func(v *Organization) OrganizationProfilePtrOutput { return v.Profile }).(OrganizationProfilePtrOutput)
}
