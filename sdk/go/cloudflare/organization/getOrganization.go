...
func LookupOrganization(ctx *pulumi.Context, args *LookupOrganizationArgs, opts ...pulumi.InvokeOption) (*LookupOrganizationResult, error) {
	...
	err := ctx.Invoke("cloudflare:organization/organization:getOrganization", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupOrganizationResult struct {
	...
	Profile        GetOrganizationProfile `pulumi:"profile"`
}
...
func LookupOrganizationOutput(ctx *pulumi.Context, args LookupOrganizationOutputArgs, opts ...pulumi.InvokeOption) LookupOrganizationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupOrganizationResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:organization/organization:getOrganization", args, LookupOrganizationResultOutput{}, options).(LookupOrganizationResultOutput), nil
...
func (o LookupOrganizationResultOutput) Profile() GetOrganizationProfileOutput {
	return o.ApplyT(func(v LookupOrganizationResult) GetOrganizationProfile { return v.Profile }).(GetOrganizationProfileOutput)
}
