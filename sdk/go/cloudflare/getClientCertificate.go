...
func LookupClientCertificateOutput(ctx *pulumi.Context, args LookupClientCertificateOutputArgs, opts ...pulumi.InvokeOption) LookupClientCertificateResultOutput {
	...
	return ctx.InvokeOutput("cloudflare:index/getClientCertificate:getClientCertificate", args, LookupClientCertificateResultOutput{}, options).(LookupClientCertificateResultOutput)
}
