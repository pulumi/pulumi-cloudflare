...
// Identifier.
func (o WorkersForPlatformsNamespaceOutput) AccountId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WorkersForPlatformsNamespace) pulumi.StringPtrOutput { return v.AccountId }).(pulumi.StringPtrOutput)
}
