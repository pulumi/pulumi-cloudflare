...
//			_, err := snippet.LookupSnippet(ctx, &snippet.LookupSnippetArgs{
...
func LookupSnippet(ctx *pulumi.Context, args *LookupSnippetArgs, opts ...pulumi.InvokeOption) (*LookupSnippetResult, error) {
	...
	err := ctx.Invoke("cloudflare:snippet/snippet:getSnippet", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSnippetOutput(ctx *pulumi.Context, args LookupSnippetOutputArgs, opts ...pulumi.InvokeOption) LookupSnippetResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSnippetResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:snippet/snippet:getSnippet", args, LookupSnippetResultOutput{}, options).(LookupSnippetResultOutput), nil
...
// Use this field to specify the unique ID of the zone.
func (o LookupSnippetResultOutput) ZoneId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSnippetResult) *string { return v.ZoneId }).(pulumi.StringPtrOutput)
}
