...
func NewSnippet(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/snippet:Snippet"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Snippet
	err := ctx.RegisterResource("cloudflare:snippet/snippet:Snippet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnippet(ctx *pulumi.Context,
	...
	var resource Snippet
	err := ctx.ReadResource("cloudflare:snippet/snippet:Snippet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
