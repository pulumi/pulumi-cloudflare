...
func NewMagicTransitSite(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/magicTransitSite:MagicTransitSite"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource MagicTransitSite
	err := ctx.RegisterResource("cloudflare:magicTransitSite/magicTransitSite:MagicTransitSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMagicTransitSite(ctx *pulumi.Context,
	...
	var resource MagicTransitSite
	err := ctx.ReadResource("cloudflare:magicTransitSite/magicTransitSite:MagicTransitSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
