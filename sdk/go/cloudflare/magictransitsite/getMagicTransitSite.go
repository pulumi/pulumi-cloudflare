...
func LookupMagicTransitSite(ctx *pulumi.Context, args *LookupMagicTransitSiteArgs, opts ...pulumi.InvokeOption) (*LookupMagicTransitSiteResult, error) {
	...
	err := ctx.Invoke("cloudflare:magicTransitSite/magicTransitSite:getMagicTransitSite", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMagicTransitSiteOutput(ctx *pulumi.Context, args LookupMagicTransitSiteOutputArgs, opts ...pulumi.InvokeOption) LookupMagicTransitSiteResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMagicTransitSiteResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:magicTransitSite/magicTransitSite:getMagicTransitSite", args, LookupMagicTransitSiteResultOutput{}, options).(LookupMagicTransitSiteResultOutput), nil
...
// Identifier
func (o LookupMagicTransitSiteResultOutput) AccountId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupMagicTransitSiteResult) *string { return v.AccountId }).(pulumi.StringPtrOutput)
}
