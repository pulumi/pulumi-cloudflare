...
//			_, err := loadbalancermonitor.GetLoadBalancerMonitor(ctx, &loadbalancermonitor.GetLoadBalancerMonitorArgs{
...
func LookupLoadBalancerMonitor(ctx *pulumi.Context, args *LookupLoadBalancerMonitorArgs, opts ...pulumi.InvokeOption) (*LookupLoadBalancerMonitorResult, error) {
	...
	err := ctx.Invoke("cloudflare:loadBalancerMonitor/loadBalancerMonitor:getLoadBalancerMonitor", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupLoadBalancerMonitorOutput(ctx *pulumi.Context, args LookupLoadBalancerMonitorOutputArgs, opts ...pulumi.InvokeOption) LookupLoadBalancerMonitorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupLoadBalancerMonitorResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:loadBalancerMonitor/loadBalancerMonitor:getLoadBalancerMonitor", args, LookupLoadBalancerMonitorResultOutput{}, options).(LookupLoadBalancerMonitorResultOutput), nil
