...
func NewWaitingRoom(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/waitingRoom:WaitingRoom"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource WaitingRoom
	err := ctx.RegisterResource("cloudflare:waitingRoom/waitingRoom:WaitingRoom", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWaitingRoom(ctx *pulumi.Context,
	...
	var resource WaitingRoom
	err := ctx.ReadResource("cloudflare:waitingRoom/waitingRoom:WaitingRoom", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
