...
//			_, err := waitingroom.GetWaitingRoom(ctx, &waitingroom.GetWaitingRoomArgs{
...
func LookupWaitingRoom(ctx *pulumi.Context, args *LookupWaitingRoomArgs, opts ...pulumi.InvokeOption) (*LookupWaitingRoomResult, error) {
	...
	err := ctx.Invoke("cloudflare:waitingRoom/waitingRoom:getWaitingRoom", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWaitingRoomOutput(ctx *pulumi.Context, args LookupWaitingRoomOutputArgs, opts ...pulumi.InvokeOption) LookupWaitingRoomResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWaitingRoomResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:waitingRoom/waitingRoom:getWaitingRoom", args, LookupWaitingRoomResultOutput{}, options).(LookupWaitingRoomResultOutput), nil
...
// Identifier.
func (o LookupWaitingRoomResultOutput) ZoneId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupWaitingRoomResult) *string { return v.ZoneId }).(pulumi.StringPtrOutput)
}
