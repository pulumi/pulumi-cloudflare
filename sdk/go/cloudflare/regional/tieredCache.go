...
func NewTieredCache(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/regionalTieredCache:RegionalTieredCache"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource TieredCache
	err := ctx.RegisterResource("cloudflare:regional/tieredCache:TieredCache", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTieredCache(ctx *pulumi.Context,
	...
	var resource TieredCache
	err := ctx.ReadResource("cloudflare:regional/tieredCache:TieredCache", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
