...
//			_, err := regional.LookupTieredCache(ctx, &regional.LookupTieredCacheArgs{
...
func LookupTieredCache(ctx *pulumi.Context, args *LookupTieredCacheArgs, opts ...pulumi.InvokeOption) (*LookupTieredCacheResult, error) {
	...
	err := ctx.Invoke("cloudflare:regional/tieredCache:getTieredCache", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupTieredCacheOutput(ctx *pulumi.Context, args LookupTieredCacheOutputArgs, opts ...pulumi.InvokeOption) LookupTieredCacheResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTieredCacheResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:regional/tieredCache:getTieredCache", args, LookupTieredCacheResultOutput{}, options).(LookupTieredCacheResultOutput), nil
