...
//
// ```sh
// $ pulumi import cloudflare:zeroTrustDlpPredefined/entry:Entry example '<account_id>/<entry_id>'
// ```
type Entry struct {
...
func NewEntry(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/zeroTrustDlpPredefinedEntry:ZeroTrustDlpPredefinedEntry"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Entry
	err := ctx.RegisterResource("cloudflare:zeroTrustDlpPredefined/entry:Entry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntry(ctx *pulumi.Context,
	...
	var resource Entry
	err := ctx.ReadResource("cloudflare:zeroTrustDlpPredefined/entry:Entry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// This field is not used as the owning profile.
// For predefined entries it is already set to a predefined profile.
func (o EntryOutput) ProfileId() pulumi.StringOutput {
	return o.ApplyT(func(v *Entry) pulumi.StringOutput { return v.ProfileId }).(pulumi.StringOutput)
}
