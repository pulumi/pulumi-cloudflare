...
//			_, err := zerotrustdevicedefaultprofile.NewZeroTrustDeviceDefaultProfile(ctx, "example_zero_trust_device_default_profile", &zerotrustdevicedefaultprofile.ZeroTrustDeviceDefaultProfileArgs{
...
//				Excludes: zerotrustdevicedefaultprofile.ZeroTrustDeviceDefaultProfileExcludeArray{
//					&zerotrustdevicedefaultprofile.ZeroTrustDeviceDefaultProfileExcludeArgs{
...
//				Includes: zerotrustdevicedefaultprofile.ZeroTrustDeviceDefaultProfileIncludeArray{
//					&zerotrustdevicedefaultprofile.ZeroTrustDeviceDefaultProfileIncludeArgs{
//						Address:     pulumi.String("192.0.2.0/24"),
...
//				ServiceModeV2: &zerotrustdevicedefaultprofile.ZeroTrustDeviceDefaultProfileServiceModeV2Args{
...
type ZeroTrustDeviceDefaultProfile struct {
	...
	GlobalAcceleration ZeroTrustDeviceDefaultProfileGlobalAccelerationPtrOutput `pulumi:"globalAcceleration"`
...
func NewZeroTrustDeviceDefaultProfile(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource ZeroTrustDeviceDefaultProfile
	err := ctx.RegisterResource("cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetZeroTrustDeviceDefaultProfile(ctx *pulumi.Context,
	...
	var resource ZeroTrustDeviceDefaultProfile
	err := ctx.ReadResource("cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type zeroTrustDeviceDefaultProfileState struct {
	...
	// Global Acceleration settings for China. When configured, WARP clients connect to the Global Accelerator addresses instead of the default ones. Please contact your account representative to enable this feature on your account. See https://developers.cloudflare.com/china-network/concepts/global-acceleration/.
	GlobalAcceleration *ZeroTrustDeviceDefaultProfileGlobalAcceleration `pulumi:"globalAcceleration"`
	// List of routes included in the WARP client's tunnel. Both 'exclude' and 'include' cannot be set in the same request.
...
type ZeroTrustDeviceDefaultProfileState struct {
	...
	// Global Acceleration settings for China. When configured, WARP clients connect to the Global Accelerator addresses instead of the default ones. Please contact your account representative to enable this feature on your account. See https://developers.cloudflare.com/china-network/concepts/global-acceleration/.
	GlobalAcceleration ZeroTrustDeviceDefaultProfileGlobalAccelerationPtrInput
	// List of routes included in the WARP client's tunnel. Both 'exclude' and 'include' cannot be set in the same request.
...
// Global Acceleration settings for China. When configured, WARP clients connect to the Global Accelerator addresses instead of the default ones. Please contact your account representative to enable this feature on your account. See https://developers.cloudflare.com/china-network/concepts/global-acceleration/.
func (o ZeroTrustDeviceDefaultProfileOutput) GlobalAcceleration() ZeroTrustDeviceDefaultProfileGlobalAccelerationPtrOutput {
	return o.ApplyT(func(v *ZeroTrustDeviceDefaultProfile) ZeroTrustDeviceDefaultProfileGlobalAccelerationPtrOutput {
