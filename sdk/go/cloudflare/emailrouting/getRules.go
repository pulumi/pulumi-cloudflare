...
func LookupRules(ctx *pulumi.Context, args *LookupRulesArgs, opts ...pulumi.InvokeOption) (*LookupRulesResult, error) {
	...
	err := ctx.Invoke("cloudflare:emailRouting/rules:getRules", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupRulesOutput(ctx *pulumi.Context, args LookupRulesOutputArgs, opts ...pulumi.InvokeOption) LookupRulesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRulesResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:emailRouting/rules:getRules", args, LookupRulesResultOutput{}, options).(LookupRulesResultOutput), nil
...
// Filter by enabled routing rules.
func (o LookupRulesResultOutput) Enabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRulesResult) *bool { return v.Enabled }).(pulumi.BoolPtrOutput)
}
