...
func GetJob(ctx *pulumi.Context, args *GetJobArgs, opts ...pulumi.InvokeOption) (*GetJobResult, error) {
	...
	var rv GetJobResult
	err := ctx.Invoke("cloudflare:logpushDataset/job:getJob", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetJobResult struct {
	...
	OutputOptions GetJobOutputOptions `pulumi:"outputOptions"`
	// The Zone ID to use for this endpoint. Mutually exclusive with the Account ID.
	ZoneId *string `pulumi:"zoneId"`
}
...
func GetJobOutput(ctx *pulumi.Context, args GetJobOutputArgs, opts ...pulumi.InvokeOption) GetJobResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetJobResultOutput, error) {
			args := v.(GetJobArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("cloudflare:logpushDataset/job:getJob", args, GetJobResultOutput{}, options).(GetJobResultOutput), nil
		}).(GetJobResultOutput)
}
...
// The Account ID to use for this endpoint. Mutually exclusive with the Zone ID.
func (o GetJobResultOutput) AccountId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetJobResult) *string { return v.AccountId }).(pulumi.StringPtrOutput)
}

// Name of the dataset. A list of supported datasets can be found on the [Developer Docs](https://developers.cloudflare.com/logs/reference/log-fields/).
// Available values: "access*requests", "audit*logs", "audit*logs*v2", "biso*user*actions", "casb*findings", "device*posture*results", "dex*application*tests", "dex*device*state*events", "dlp*forensic*copies", "dns*firewall*logs", "dns*logs", "email*security*alerts", "email*security*post*delivery*events", "firewall*events", "gateway*dns", "gateway*http", "gateway*network", "http*requests", "ipsec*logs", "magic*ids*detections", "mcp*portal*logs", "mnm*flow*logs", "nel*reports", "network*analytics*logs", "page*shield*events", "sinkhole*http*logs", "spectrum*events", "ssh*logs", "turnstile*events", "warp*config*changes", "warp*toggle*changes", "websocket*analytics", "workers*trace*events", "zaraz*events", "zero*trust*network*sessions".
func (o GetJobResultOutput) Dataset() pulumi.StringOutput {
	return o.ApplyT(func(v GetJobResult) string { return v.Dataset }).(pulumi.StringOutput)
}

// Name of the dataset. A list of supported datasets can be found on the [Developer Docs](https://developers.cloudflare.com/logs/reference/log-fields/).
// Available values: "access*requests", "audit*logs", "audit*logs*v2", "biso*user*actions", "casb*findings", "device*posture*results", "dex*application*tests", "dex*device*state*events", "dlp*forensic*copies", "dns*firewall*logs", "dns*logs", "email*security*alerts", "email*security*post*delivery*events", "firewall*events", "gateway*dns", "gateway*http", "gateway*network", "http*requests", "ipsec*logs", "magic*ids*detections", "mcp*portal*logs", "mnm*flow*logs", "nel*reports", "network*analytics*logs", "page*shield*events", "sinkhole*http*logs", "spectrum*events", "ssh*logs", "turnstile*events", "warp*config*changes", "warp*toggle*changes", "websocket*analytics", "workers*trace*events", "zaraz*events", "zero*trust*network*sessions".
func (o GetJobResultOutput) DatasetId() pulumi.StringOutput {
	return o.ApplyT(func(v GetJobResult) string { return v.DatasetId }).(pulumi.StringOutput)
}

// Uniquely identifies a resource (such as an s3 bucket) where data. will be pushed. Additional configuration parameters supported by the destination may be included.
func (o GetJobResultOutput) DestinationConf() pulumi.StringOutput {
	return o.ApplyT(func(v GetJobResult) string { return v.DestinationConf }).(pulumi.StringOutput)
}

// Flag that indicates if the job is enabled.
func (o GetJobResultOutput) Enabled() pulumi.BoolOutput {
	return o.ApplyT(func(v GetJobResult) bool { return v.Enabled }).(pulumi.BoolOutput)
}

// If not null, the job is currently failing. Failures are usually. repetitive (example: no permissions to write to destination bucket). Only the last failure is recorded. On successful execution of a job the error*message and last*error are set to null.
func (o GetJobResultOutput) ErrorMessage() pulumi.StringOutput {
	return o.ApplyT(func(v GetJobResult) string { return v.ErrorMessage }).(pulumi.StringOutput)
}
...
//
// Deprecated: This attribute is deprecated.
func (o GetJobResultOutput) Frequency() pulumi.StringOutput {
	return o.ApplyT(func(v GetJobResult) string { return v.Frequency }).(pulumi.StringOutput)
}

// Unique id of the job.
func (o GetJobResultOutput) Id() pulumi.IntOutput {
	return o.ApplyT(func(v GetJobResult) int { return v.Id }).(pulumi.IntOutput)
}
...
// Records the last time for which logs have been successfully pushed. If the last successful push was for logs range 2018-07-23T10:00:00Z to 2018-07-23T10:01:00Z then the value of this field will be 2018-07-23T10:01:00Z. If the job has never run or has just been enabled and hasn't run yet then the field will be empty.
func (o GetJobResultOutput) LastComplete() pulumi.StringOutput {
	return o.ApplyT(func(v GetJobResult) string { return v.LastComplete }).(pulumi.StringOutput)
}

// Records the last time the job failed. If not null, the job is currently. failing. If null, the job has either never failed or has run successfully at least once since last failure. See also the errorMessage field.
func (o GetJobResultOutput) LastError() pulumi.StringOutput {
	return o.ApplyT(func(v GetJobResult) string { return v.LastError }).(pulumi.StringOutput)
}

// This field is deprecated. Use `outputOptions` instead. Configuration string. It specifies things like requested fields and timestamp formats. If migrating from the logpull api, copy the url (full url or just the query string) of your call here, and logpush will keep on making this call for you, setting start and end times appropriately.
//
// Deprecated: This attribute is deprecated.
func (o GetJobResultOutput) LogpullOptions() pulumi.StringOutput {
	return o.ApplyT(func(v GetJobResult) string { return v.LogpullOptions }).(pulumi.StringOutput)
}

// The maximum uncompressed file size of a batch of logs. This setting value must be between `5 MB` and `1 GB`, or `0` to disable it. Note that you cannot set a minimum file size; this means that log files may be much smaller than this batch size.
func (o GetJobResultOutput) MaxUploadBytes() pulumi.IntOutput {
	return o.ApplyT(func(v GetJobResult) int { return v.MaxUploadBytes }).(pulumi.IntOutput)
}

// The maximum interval in seconds for log batches. This setting must be between 30 and 300 seconds (5 minutes), or `0` to disable it. Note that you cannot specify a minimum interval for log batches; this means that log files may be sent in shorter intervals than this.
func (o GetJobResultOutput) MaxUploadIntervalSeconds() pulumi.IntOutput {
	return o.ApplyT(func(v GetJobResult) int { return v.MaxUploadIntervalSeconds }).(pulumi.IntOutput)
}

// The maximum number of log lines per batch. This setting must be between 1000 and 1,000,000 lines, or `0` to disable it. Note that you cannot specify a minimum number of log lines per batch; this means that log files may contain many fewer lines than this.
func (o GetJobResultOutput) MaxUploadRecords() pulumi.IntOutput {
	return o.ApplyT(func(v GetJobResult) int { return v.MaxUploadRecords }).(pulumi.IntOutput)
}

// Optional human readable job name. Not unique. Cloudflare suggests. that you set this to a meaningful string, like the domain name, to make it easier to identify your job.
func (o GetJobResultOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v GetJobResult) string { return v.Name }).(pulumi.StringOutput)
}

// The structured replacement for `logpullOptions`. When including this field, the `logpullOption` field will be ignored.
func (o GetJobResultOutput) OutputOptions() GetJobOutputOptionsOutput {
	return o.ApplyT(func(v GetJobResult) GetJobOutputOptions { return v.OutputOptions }).(GetJobOutputOptionsOutput)
}

// The Zone ID to use for this endpoint. Mutually exclusive with the Account ID.
func (o GetJobResultOutput) ZoneId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetJobResult) *string { return v.ZoneId }).(pulumi.StringPtrOutput)
}
