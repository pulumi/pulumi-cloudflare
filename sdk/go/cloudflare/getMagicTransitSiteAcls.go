...
// Identifier
func (o LookupMagicTransitSiteAclsResultOutput) AccountId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupMagicTransitSiteAclsResult) *string { return v.AccountId }).(pulumi.StringPtrOutput)
}
