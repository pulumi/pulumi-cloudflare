...
func NewLeakedCredentialCheck(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/leakedCredentialCheck:LeakedCredentialCheck"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource LeakedCredentialCheck
	err := ctx.RegisterResource("cloudflare:leakedCredentialCheck/leakedCredentialCheck:LeakedCredentialCheck", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLeakedCredentialCheck(ctx *pulumi.Context,
	...
	var resource LeakedCredentialCheck
	err := ctx.ReadResource("cloudflare:leakedCredentialCheck/leakedCredentialCheck:LeakedCredentialCheck", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
