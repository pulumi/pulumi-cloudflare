...
//			_, err := leakedcredentialcheck.GetLeakedCredentialCheck(ctx, &leakedcredentialcheck.GetLeakedCredentialCheckArgs{
...
func LookupLeakedCredentialCheck(ctx *pulumi.Context, args *LookupLeakedCredentialCheckArgs, opts ...pulumi.InvokeOption) (*LookupLeakedCredentialCheckResult, error) {
	...
	err := ctx.Invoke("cloudflare:leakedCredentialCheck/leakedCredentialCheck:getLeakedCredentialCheck", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupLeakedCredentialCheckOutput(ctx *pulumi.Context, args LookupLeakedCredentialCheckOutputArgs, opts ...pulumi.InvokeOption) LookupLeakedCredentialCheckResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupLeakedCredentialCheckResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:leakedCredentialCheck/leakedCredentialCheck:getLeakedCredentialCheck", args, LookupLeakedCredentialCheckResultOutput{}, options).(LookupLeakedCredentialCheckResultOutput), nil
