...
//			_, err := magicwan.NewStaticRoute(ctx, "example_magic_wan_static_route", &magicwan.StaticRouteArgs{
...
//				Scope: &magicwan.StaticRouteScopeArgs{
...
func NewStaticRoute(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("cloudflare:index/magicWanStaticRoute:MagicWanStaticRoute"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource StaticRoute
	err := ctx.RegisterResource("cloudflare:magicWan/staticRoute:StaticRoute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticRoute(ctx *pulumi.Context,
	...
	var resource StaticRoute
	err := ctx.ReadResource("cloudflare:magicWan/staticRoute:StaticRoute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
