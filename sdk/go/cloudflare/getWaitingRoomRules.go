...
// Identifier.
func (o LookupWaitingRoomRulesResultOutput) ZoneId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupWaitingRoomRulesResult) *string { return v.ZoneId }).(pulumi.StringPtrOutput)
}
