...
//			_, err := pipeline.NewPipeline(ctx, "example_pipeline", &pipeline.PipelineArgs{
...
//
// ```sh
// $ pulumi import cloudflare:pipeline/pipeline:Pipeline example '<account_id>/<pipeline_id>'
// ```
...
func NewPipeline(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/pipeline:Pipeline"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Pipeline
	err := ctx.RegisterResource("cloudflare:pipeline/pipeline:Pipeline", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPipeline(ctx *pulumi.Context,
	...
	var resource Pipeline
	err := ctx.ReadResource("cloudflare:pipeline/pipeline:Pipeline", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
