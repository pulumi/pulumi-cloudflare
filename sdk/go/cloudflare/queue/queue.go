...
type Queue struct {
	...
	Consumers           QueueConsumerArrayOutput `pulumi:"consumers"`
...
func NewQueue(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/queue:Queue"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Queue
	err := ctx.RegisterResource("cloudflare:queue/queue:Queue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueue(ctx *pulumi.Context,
	...
	var resource Queue
	err := ctx.ReadResource("cloudflare:queue/queue:Queue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type queueState struct {
	...
	Consumers           []QueueConsumer `pulumi:"consumers"`
...
type QueueState struct {
	...
	Consumers           QueueConsumerArrayInput
...
func (o QueueOutput) Consumers() QueueConsumerArrayOutput {
	return o.ApplyT(func(v *Queue) QueueConsumerArrayOutput { return v.Consumers }).(QueueConsumerArrayOutput)
}
