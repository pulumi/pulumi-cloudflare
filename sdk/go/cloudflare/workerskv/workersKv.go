...
//			_, err := workerskv.NewWorkersKv(ctx, "example_workers_kv", &workerskv.WorkersKvArgs{
...
func NewWorkersKv(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/workersKv:WorkersKv"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource WorkersKv
	err := ctx.RegisterResource("cloudflare:workersKv/workersKv:WorkersKv", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkersKv(ctx *pulumi.Context,
	...
	var resource WorkersKv
	err := ctx.ReadResource("cloudflare:workersKv/workersKv:WorkersKv", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
