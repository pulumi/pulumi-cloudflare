...
//			_, err := workerskv.GetWorkersKv(ctx, &workerskv.GetWorkersKvArgs{
...
func LookupWorkersKv(ctx *pulumi.Context, args *LookupWorkersKvArgs, opts ...pulumi.InvokeOption) (*LookupWorkersKvResult, error) {
	...
	err := ctx.Invoke("cloudflare:workersKv/workersKv:getWorkersKv", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupWorkersKvOutput(ctx *pulumi.Context, args LookupWorkersKvOutputArgs, opts ...pulumi.InvokeOption) LookupWorkersKvResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupWorkersKvResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:workersKv/workersKv:getWorkersKv", args, LookupWorkersKvResultOutput{}, options).(LookupWorkersKvResultOutput), nil
