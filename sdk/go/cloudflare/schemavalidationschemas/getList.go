...
func LookupList(ctx *pulumi.Context, args *LookupListArgs, opts ...pulumi.InvokeOption) (*LookupListResult, error) {
	...
	err := ctx.Invoke("cloudflare:schemaValidationSchemas/list:getList", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupListOutput(ctx *pulumi.Context, args LookupListOutputArgs, opts ...pulumi.InvokeOption) LookupListResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupListResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:schemaValidationSchemas/list:getList", args, LookupListResultOutput{}, options).(LookupListResultOutput), nil
...
// Omit the source-files of schemas and only retrieve their meta-data.
func (o LookupListResultOutput) OmitSource() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupListResult) bool { return v.OmitSource }).(pulumi.BoolOutput)
}
...
// Filter for enabled schemas
func (o LookupListResultOutput) ValidationEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupListResult) *bool { return v.ValidationEnabled }).(pulumi.BoolPtrOutput)
}
