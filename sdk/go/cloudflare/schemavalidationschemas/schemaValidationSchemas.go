...
func NewSchemaValidationSchemas(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/schemaValidationSchemas:SchemaValidationSchemas"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource SchemaValidationSchemas
	err := ctx.RegisterResource("cloudflare:schemaValidationSchemas/schemaValidationSchemas:SchemaValidationSchemas", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSchemaValidationSchemas(ctx *pulumi.Context,
	...
	var resource SchemaValidationSchemas
	err := ctx.ReadResource("cloudflare:schemaValidationSchemas/schemaValidationSchemas:SchemaValidationSchemas", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
