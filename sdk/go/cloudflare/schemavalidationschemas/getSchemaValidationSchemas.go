...
func LookupSchemaValidationSchemas(ctx *pulumi.Context, args *LookupSchemaValidationSchemasArgs, opts ...pulumi.InvokeOption) (*LookupSchemaValidationSchemasResult, error) {
	...
	err := ctx.Invoke("cloudflare:schemaValidationSchemas/schemaValidationSchemas:getSchemaValidationSchemas", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSchemaValidationSchemasOutput(ctx *pulumi.Context, args LookupSchemaValidationSchemasOutputArgs, opts ...pulumi.InvokeOption) LookupSchemaValidationSchemasResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSchemaValidationSchemasResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:schemaValidationSchemas/schemaValidationSchemas:getSchemaValidationSchemas", args, LookupSchemaValidationSchemasResultOutput{}, options).(LookupSchemaValidationSchemasResultOutput), nil
...
// Identifier.
func (o LookupSchemaValidationSchemasResultOutput) ZoneId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSchemaValidationSchemasResult) *string { return v.ZoneId }).(pulumi.StringPtrOutput)
}
