...
func NewApiShieldOperation(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/apiShieldOperation:ApiShieldOperation"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource ApiShieldOperation
	err := ctx.RegisterResource("cloudflare:apiShieldOperation/apiShieldOperation:ApiShieldOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiShieldOperation(ctx *pulumi.Context,
	...
	var resource ApiShieldOperation
	err := ctx.ReadResource("cloudflare:apiShieldOperation/apiShieldOperation:ApiShieldOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
