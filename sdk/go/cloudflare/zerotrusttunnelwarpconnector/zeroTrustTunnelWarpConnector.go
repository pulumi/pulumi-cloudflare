...
//			_, err := zerotrusttunnelwarpconnector.NewZeroTrustTunnelWarpConnector(ctx, "example_zero_trust_tunnel_warp_connector", &zerotrusttunnelwarpconnector.ZeroTrustTunnelWarpConnectorArgs{
...
func NewZeroTrustTunnelWarpConnector(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/zeroTrustTunnelWarpConnector:ZeroTrustTunnelWarpConnector"),
		},
	})
	...
	err := ctx.RegisterResource("cloudflare:zeroTrustTunnelWarpConnector/zeroTrustTunnelWarpConnector:ZeroTrustTunnelWarpConnector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetZeroTrustTunnelWarpConnector(ctx *pulumi.Context,
	...
	var resource ZeroTrustTunnelWarpConnector
	err := ctx.ReadResource("cloudflare:zeroTrustTunnelWarpConnector/zeroTrustTunnelWarpConnector:ZeroTrustTunnelWarpConnector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
