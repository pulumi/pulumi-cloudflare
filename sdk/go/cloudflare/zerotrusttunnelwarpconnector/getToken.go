...
func GetToken(ctx *pulumi.Context, args *GetTokenArgs, opts ...pulumi.InvokeOption) (*GetTokenResult, error) {
	...
	err := ctx.Invoke("cloudflare:zeroTrustTunnelWarpConnector/token:getToken", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetTokenOutput(ctx *pulumi.Context, args GetTokenOutputArgs, opts ...pulumi.InvokeOption) GetTokenResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetTokenResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:zeroTrustTunnelWarpConnector/token:getToken", args, GetTokenResultOutput{}, options).(GetTokenResultOutput), nil
