...
//			_, err := zerotrusttunnelwarpconnector.GetZeroTrustTunnelWarpConnector(ctx, &zerotrusttunnelwarpconnector.GetZeroTrustTunnelWarpConnectorArgs{
...
func LookupZeroTrustTunnelWarpConnector(ctx *pulumi.Context, args *LookupZeroTrustTunnelWarpConnectorArgs, opts ...pulumi.InvokeOption) (*LookupZeroTrustTunnelWarpConnectorResult, error) {
	...
	err := ctx.Invoke("cloudflare:zeroTrustTunnelWarpConnector/zeroTrustTunnelWarpConnector:getZeroTrustTunnelWarpConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupZeroTrustTunnelWarpConnectorOutput(ctx *pulumi.Context, args LookupZeroTrustTunnelWarpConnectorOutputArgs, opts ...pulumi.InvokeOption) LookupZeroTrustTunnelWarpConnectorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupZeroTrustTunnelWarpConnectorResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:zeroTrustTunnelWarpConnector/zeroTrustTunnelWarpConnector:getZeroTrustTunnelWarpConnector", args, LookupZeroTrustTunnelWarpConnectorResultOutput{}, options).(LookupZeroTrustTunnelWarpConnectorResultOutput), nil
