...
//			_, err := account.LookupAccount(ctx, &account.LookupAccountArgs{
...
func LookupAccount(ctx *pulumi.Context, args *LookupAccountArgs, opts ...pulumi.InvokeOption) (*LookupAccountResult, error) {
	...
	err := ctx.Invoke("cloudflare:account/account:getAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAccountOutput(ctx *pulumi.Context, args LookupAccountOutputArgs, opts ...pulumi.InvokeOption) LookupAccountResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAccountResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:account/account:getAccount", args, LookupAccountResultOutput{}, options).(LookupAccountResultOutput), nil
