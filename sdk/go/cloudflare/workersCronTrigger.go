...
// Identifier.
func (o WorkersCronTriggerOutput) AccountId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *WorkersCronTrigger) pulumi.StringPtrOutput { return v.AccountId }).(pulumi.StringPtrOutput)
}
