...
func NewNotificationPolicyWebhooks(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/notificationPolicyWebhooks:NotificationPolicyWebhooks"),
		},
	})
	...
	err := ctx.RegisterResource("cloudflare:notificationPolicyWebhooks/notificationPolicyWebhooks:NotificationPolicyWebhooks", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationPolicyWebhooks(ctx *pulumi.Context,
	...
	var resource NotificationPolicyWebhooks
	err := ctx.ReadResource("cloudflare:notificationPolicyWebhooks/notificationPolicyWebhooks:NotificationPolicyWebhooks", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
