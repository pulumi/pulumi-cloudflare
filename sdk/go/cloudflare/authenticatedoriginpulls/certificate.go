...
//
// ```sh
// $ pulumi import cloudflare:authenticatedOriginPulls/certificate:Certificate example '<zone_id>/<certificate_id>'
// ```
...
func NewCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/authenticatedOriginPullsCertificate:AuthenticatedOriginPullsCertificate"),
		},
	})
	...
	err := ctx.RegisterResource("cloudflare:authenticatedOriginPulls/certificate:Certificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificate(ctx *pulumi.Context,
	...
	var resource Certificate
	err := ctx.ReadResource("cloudflare:authenticatedOriginPulls/certificate:Certificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Indicates whether zone-level authenticated origin pulls is enabled.
func (o CertificateOutput) Enabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *Certificate) pulumi.BoolOutput { return v.Enabled }).(pulumi.BoolOutput)
}
