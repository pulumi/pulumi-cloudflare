...
//			_, err := authenticatedoriginpulls.GetAuthenticatedOriginPulls(ctx, &authenticatedoriginpulls.GetAuthenticatedOriginPullsArgs{
...
func LookupAuthenticatedOriginPulls(ctx *pulumi.Context, args *LookupAuthenticatedOriginPullsArgs, opts ...pulumi.InvokeOption) (*LookupAuthenticatedOriginPullsResult, error) {
	...
	err := ctx.Invoke("cloudflare:authenticatedOriginPulls/authenticatedOriginPulls:getAuthenticatedOriginPulls", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupAuthenticatedOriginPullsOutput(ctx *pulumi.Context, args LookupAuthenticatedOriginPullsOutputArgs, opts ...pulumi.InvokeOption) LookupAuthenticatedOriginPullsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAuthenticatedOriginPullsResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:authenticatedOriginPulls/authenticatedOriginPulls:getAuthenticatedOriginPulls", args, LookupAuthenticatedOriginPullsResultOutput{}, options).(LookupAuthenticatedOriginPullsResultOutput), nil
