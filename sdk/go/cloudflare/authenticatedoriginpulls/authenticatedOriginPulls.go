...
func NewAuthenticatedOriginPulls(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/authenticatedOriginPulls:AuthenticatedOriginPulls"),
		},
	})
	...
	err := ctx.RegisterResource("cloudflare:authenticatedOriginPulls/authenticatedOriginPulls:AuthenticatedOriginPulls", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthenticatedOriginPulls(ctx *pulumi.Context,
	...
	var resource AuthenticatedOriginPulls
	err := ctx.ReadResource("cloudflare:authenticatedOriginPulls/authenticatedOriginPulls:AuthenticatedOriginPulls", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
