...
//			_, err := mtlscertificate.NewMtlsCertificate(ctx, "example_mtls_certificate", &mtlscertificate.MtlsCertificateArgs{
...
func NewMtlsCertificate(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/mtlsCertificate:MtlsCertificate"),
		},
	})
	...
	err := ctx.RegisterResource("cloudflare:mtlsCertificate/mtlsCertificate:MtlsCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMtlsCertificate(ctx *pulumi.Context,
	...
	var resource MtlsCertificate
	err := ctx.ReadResource("cloudflare:mtlsCertificate/mtlsCertificate:MtlsCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
