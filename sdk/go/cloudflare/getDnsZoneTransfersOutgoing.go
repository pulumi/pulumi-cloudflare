...
func (o LookupDnsZoneTransfersOutgoingResultOutput) ZoneId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupDnsZoneTransfersOutgoingResult) *string { return v.ZoneId }).(pulumi.StringPtrOutput)
}
