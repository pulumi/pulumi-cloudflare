...
func NewTokenValidationRules(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/tokenValidationRules:TokenValidationRules"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource TokenValidationRules
	err := ctx.RegisterResource("cloudflare:tokenValidationRules/tokenValidationRules:TokenValidationRules", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTokenValidationRules(ctx *pulumi.Context,
	...
	var resource TokenValidationRules
	err := ctx.ReadResource("cloudflare:tokenValidationRules/tokenValidationRules:TokenValidationRules", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
