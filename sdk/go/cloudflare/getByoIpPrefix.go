...
// Identifier of a Cloudflare account.
func (o LookupByoIpPrefixResultOutput) AccountId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupByoIpPrefixResult) *string { return v.AccountId }).(pulumi.StringPtrOutput)
}
