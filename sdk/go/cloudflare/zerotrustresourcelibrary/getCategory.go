...
func GetCategory(ctx *pulumi.Context, args *GetCategoryArgs, opts ...pulumi.InvokeOption) (*GetCategoryResult, error) {
	...
	err := ctx.Invoke("cloudflare:zeroTrustResourceLibrary/category:getCategory", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetCategoryOutput(ctx *pulumi.Context, args GetCategoryOutputArgs, opts ...pulumi.InvokeOption) GetCategoryResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetCategoryResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:zeroTrustResourceLibrary/category:getCategory", args, GetCategoryResultOutput{}, options).(GetCategoryResultOutput), nil
...
func (o GetCategoryResultOutput) AccountId() pulumi.StringOutput {
	return o.ApplyT(func(v GetCategoryResult) string { return v.AccountId }).(pulumi.StringOutput)
}

// Returns the category creation time.
func (o GetCategoryResultOutput) CreatedAt() pulumi.StringOutput {
	return o.ApplyT(func(v GetCategoryResult) string { return v.CreatedAt }).(pulumi.StringOutput)
}
