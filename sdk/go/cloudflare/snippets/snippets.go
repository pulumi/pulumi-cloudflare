...
func NewSnippets(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/snippets:Snippets"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Snippets
	err := ctx.RegisterResource("cloudflare:snippets/snippets:Snippets", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnippets(ctx *pulumi.Context,
	...
	var resource Snippets
	err := ctx.ReadResource("cloudflare:snippets/snippets:Snippets", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
