...
// Account ID.
func (o LookupR2BucketCorsResultOutput) AccountId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupR2BucketCorsResult) *string { return v.AccountId }).(pulumi.StringPtrOutput)
}
