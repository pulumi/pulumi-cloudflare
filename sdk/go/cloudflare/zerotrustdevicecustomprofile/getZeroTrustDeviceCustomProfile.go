...
//			_, err := zerotrustdevicecustomprofile.GetZeroTrustDeviceCustomProfile(ctx, &zerotrustdevicecustomprofile.GetZeroTrustDeviceCustomProfileArgs{
...
func LookupZeroTrustDeviceCustomProfile(ctx *pulumi.Context, args *LookupZeroTrustDeviceCustomProfileArgs, opts ...pulumi.InvokeOption) (*LookupZeroTrustDeviceCustomProfileResult, error) {
	...
	err := ctx.Invoke("cloudflare:zeroTrustDeviceCustomProfile/zeroTrustDeviceCustomProfile:getZeroTrustDeviceCustomProfile", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupZeroTrustDeviceCustomProfileOutput(ctx *pulumi.Context, args LookupZeroTrustDeviceCustomProfileOutputArgs, opts ...pulumi.InvokeOption) LookupZeroTrustDeviceCustomProfileResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupZeroTrustDeviceCustomProfileResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:zeroTrustDeviceCustomProfile/zeroTrustDeviceCustomProfile:getZeroTrustDeviceCustomProfile", args, LookupZeroTrustDeviceCustomProfileResultOutput{}, options).(LookupZeroTrustDeviceCustomProfileResultOutput), nil
