...
// Identifier.
func (o LookupEmailRoutingCatchAllResultOutput) ZoneId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupEmailRoutingCatchAllResult) *string { return v.ZoneId }).(pulumi.StringPtrOutput)
}
