...
// A Resource identifier.
func (o LookupQueuesResultOutput) AccountId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupQueuesResult) *string { return v.AccountId }).(pulumi.StringPtrOutput)
}
