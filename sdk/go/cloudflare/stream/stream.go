...
//			_, err := stream.NewStream(ctx, "example_stream", &stream.StreamArgs{
...
type Stream struct {
	...
	Watermark StreamWatermarkOutput `pulumi:"watermark"`
}
...
func NewStream(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/stream:Stream"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Stream
	err := ctx.RegisterResource("cloudflare:stream/stream:Stream", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStream(ctx *pulumi.Context,
	...
	var resource Stream
	err := ctx.ReadResource("cloudflare:stream/stream:Stream", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type streamState struct {
	...
	Watermark *StreamWatermark `pulumi:"watermark"`
}
...
type StreamState struct {
	...
	Watermark StreamWatermarkPtrInput
}
...
func (o StreamOutput) Watermark() StreamWatermarkOutput {
	return o.ApplyT(func(v *Stream) StreamWatermarkOutput { return v.Watermark }).(StreamWatermarkOutput)
}
