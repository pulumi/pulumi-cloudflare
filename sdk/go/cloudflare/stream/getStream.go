...
//			_, err := stream.LookupStream(ctx, &stream.LookupStreamArgs{
...
func LookupStream(ctx *pulumi.Context, args *LookupStreamArgs, opts ...pulumi.InvokeOption) (*LookupStreamResult, error) {
	...
	err := ctx.Invoke("cloudflare:stream/stream:getStream", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupStreamResult struct {
	...
	Watermark GetStreamWatermark `pulumi:"watermark"`
}
...
func LookupStreamOutput(ctx *pulumi.Context, args LookupStreamOutputArgs, opts ...pulumi.InvokeOption) LookupStreamResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStreamResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:stream/stream:getStream", args, LookupStreamResultOutput{}, options).(LookupStreamResultOutput), nil
...
func (o LookupStreamResultOutput) Watermark() GetStreamWatermarkOutput {
	return o.ApplyT(func(v LookupStreamResult) GetStreamWatermark { return v.Watermark }).(GetStreamWatermarkOutput)
}
