...
func LookupList(ctx *pulumi.Context, args *LookupListArgs, opts ...pulumi.InvokeOption) (*LookupListResult, error) {
	...
	err := ctx.Invoke("cloudflare:pageShieldScripts/list:getList", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupListOutput(ctx *pulumi.Context, args LookupListOutputArgs, opts ...pulumi.InvokeOption) LookupListResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupListResultOutput, error) {
			...
			return ctx.InvokeOutput("cloudflare:pageShieldScripts/list:getList", args, LookupListResultOutput{}, options).(LookupListResultOutput), nil
...
// When true, excludes scripts seen in a `/cdn-cgi` path from the returned scripts. The default value is true.
func (o LookupListResultOutput) ExcludeCdnCgi() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupListResult) bool { return v.ExcludeCdnCgi }).(pulumi.BoolOutput)
}

// When true, excludes duplicate scripts. We consider a script duplicate of another if their javascript
// content matches and they share the same url host and zone hostname. In such case, we return the most
// recent script for the URL host and zone hostname combination.
func (o LookupListResultOutput) ExcludeDuplicates() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupListResult) bool { return v.ExcludeDuplicates }).(pulumi.BoolOutput)
}
