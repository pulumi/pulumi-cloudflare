...
func NewContentScanning(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/contentScanning:ContentScanning"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource ContentScanning
	err := ctx.RegisterResource("cloudflare:contentScanning/contentScanning:ContentScanning", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentScanning(ctx *pulumi.Context,
	...
	var resource ContentScanning
	err := ctx.ReadResource("cloudflare:contentScanning/contentScanning:ContentScanning", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
