...
func NewWorkersScript(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/workersScript:WorkersScript"),
		},
		{
	...
	err := ctx.RegisterResource("cloudflare:workersScript/workersScript:WorkersScript", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkersScript(ctx *pulumi.Context,
	...
	var resource WorkersScript
	err := ctx.ReadResource("cloudflare:workersScript/workersScript:WorkersScript", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Annotations for the version created by this upload.
func (o WorkersScriptOutput) Annotations() WorkersScriptAnnotationsOutput {
	return o.ApplyT(func(v *WorkersScript) WorkersScriptAnnotationsOutput { return v.Annotations }).(WorkersScriptAnnotationsOutput)
}
