...
//
// ```sh
// $ pulumi import cloudflare:userGroup/userGroup:UserGroup example '<account_id>/<user_group_id>'
// ```
...
func NewUserGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("cloudflare:index/userGroup:UserGroup"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource UserGroup
	err := ctx.RegisterResource("cloudflare:userGroup/userGroup:UserGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserGroup(ctx *pulumi.Context,
	...
	var resource UserGroup
	err := ctx.ReadResource("cloudflare:userGroup/userGroup:UserGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
