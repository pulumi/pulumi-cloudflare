...
// Account ID.
func (o LookupR2BucketLifecycleResultOutput) AccountId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupR2BucketLifecycleResult) *string { return v.AccountId }).(pulumi.StringPtrOutput)
}
