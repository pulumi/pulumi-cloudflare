...
namespace Pulumi.Cloudflare.Modules.PageShieldCookies
{
    public static class GetPageShieldCookies
    {
        ...
        public static Task<GetPageShieldCookiesResult> InvokeAsync(GetPageShieldCookiesArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPageShieldCookiesResult>("cloudflare:pageShieldCookies/pageShieldCookies:getPageShieldCookies", args ?? new GetPageShieldCookiesArgs(), options.WithDefaults());
        ...
        public static Output<GetPageShieldCookiesResult> Invoke(GetPageShieldCookiesInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPageShieldCookiesResult>("cloudflare:pageShieldCookies/pageShieldCookies:getPageShieldCookies", args ?? new GetPageShieldCookiesInvokeArgs(), options.WithDefaults());
