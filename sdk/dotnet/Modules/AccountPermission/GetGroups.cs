...
namespace Pulumi.Cloudflare.Modules.AccountPermission
{
    public static class GetGroups
    {
        ...
        public static Task<GetGroupsResult> InvokeAsync(GetGroupsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGroupsResult>("cloudflare:accountPermission/groups:getGroups", args ?? new GetGroupsArgs(), options.WithDefaults());
        ...
        public static Output<GetGroupsResult> Invoke(GetGroupsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGroupsResult>("cloudflare:accountPermission/groups:getGroups", args ?? new GetGroupsInvokeArgs(), options.WithDefaults());
