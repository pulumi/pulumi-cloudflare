...
namespace Pulumi.Cloudflare.Modules.Logpush
{
    public static class GetJob
    {
        ...
        public static Task<GetJobResult> InvokeAsync(GetJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobResult>("cloudflare:logpush/job:getJob", args ?? new GetJobArgs(), options.WithDefaults());
        ...
        public static Output<GetJobResult> Invoke(GetJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetJobResult>("cloudflare:logpush/job:getJob", args ?? new GetJobInvokeArgs(), options.WithDefaults());
