...
namespace Pulumi.Cloudflare.Modules.Logpush.Outputs
{

    [OutputType]
    public sealed class GetJobsResultResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetJobsResultOutputOptionsResult OutputOptions;

        [OutputConstructor]
        private GetJobsResultResult(
            string dataset,
            ...
            Outputs.GetJobsResultOutputOptionsResult outputOptions)
        {
            Dataset = dataset;
