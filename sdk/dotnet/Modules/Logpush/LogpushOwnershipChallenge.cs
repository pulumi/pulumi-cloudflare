...
namespace Pulumi.Cloudflare.Modules.Logpush
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:logpush/ownershipChallenge:OwnershipChallenge")]
    public partial class LogpushOwnershipChallenge : global::Pulumi.CustomResource
    {
        ...
        public LogpushOwnershipChallenge(string name, LogpushOwnershipChallengeArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:logpush/ownershipChallenge:OwnershipChallenge", name, args ?? new LogpushOwnershipChallengeArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private LogpushOwnershipChallenge(string name, Input<string> id, LogpushOwnershipChallengeState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:logpush/ownershipChallenge:OwnershipChallenge", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/logpushOwnershipChallenge:LogpushOwnershipChallenge" },
                },
