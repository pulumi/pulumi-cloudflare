...
namespace Pulumi.Cloudflare.Modules.Web3
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:web3/hostname:Hostname")]
    public partial class Web3Hostname : global::Pulumi.CustomResource
    {
        ...
        public Web3Hostname(string name, Web3HostnameArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:web3/hostname:Hostname", name, args ?? new Web3HostnameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Web3Hostname(string name, Input<string> id, Web3HostnameState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:web3/hostname:Hostname", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/web3Hostname:Web3Hostname" },
                },
            };
