...
namespace Pulumi.Cloudflare.Modules.AuthenticatedOriginPullsHostname
{
    public static class GetCertificates
    {
        ...
        public static Task<GetCertificatesResult> InvokeAsync(GetCertificatesArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCertificatesResult>("cloudflare:authenticatedOriginPullsHostname/certificates:getCertificates", args ?? new GetCertificatesArgs(), options.WithDefaults());
        ...
        public static Output<GetCertificatesResult> Invoke(GetCertificatesInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCertificatesResult>("cloudflare:authenticatedOriginPullsHostname/certificates:getCertificates", args ?? new GetCertificatesInvokeArgs(), options.WithDefaults());
