...
namespace Pulumi.Cloudflare.Modules.ZeroTrustAccessShortLived
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zeroTrustAccessShortLived/certificate:Certificate")]
    public partial class ZeroTrustAccessShortLivedCertificate : global::Pulumi.CustomResource
    {
        ...
        public ZeroTrustAccessShortLivedCertificate(string name, ZeroTrustAccessShortLivedCertificateArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustAccessShortLived/certificate:Certificate", name, args ?? new ZeroTrustAccessShortLivedCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZeroTrustAccessShortLivedCertificate(string name, Input<string> id, ZeroTrustAccessShortLivedCertificateState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustAccessShortLived/certificate:Certificate", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zeroTrustAccessShortLivedCertificate:ZeroTrustAccessShortLivedCertificate" },
