...
namespace Pulumi.Cloudflare.Modules.MagicNetworkMonitoring
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:magicNetworkMonitoring/configuration:Configuration")]
    public partial class MagicNetworkMonitoringConfiguration : global::Pulumi.CustomResource
    {
        ...
        [Output("warpDevices")]
        public Output<ImmutableArray<Outputs.ConfigurationWarpDevice>> WarpDevices { get; private set; } = null!;
        ...
        public MagicNetworkMonitoringConfiguration(string name, MagicNetworkMonitoringConfigurationArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:magicNetworkMonitoring/configuration:Configuration", name, args ?? new MagicNetworkMonitoringConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private MagicNetworkMonitoringConfiguration(string name, Input<string> id, MagicNetworkMonitoringConfigurationState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:magicNetworkMonitoring/configuration:Configuration", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/magicNetworkMonitoringConfiguration:MagicNetworkMonitoringConfiguration" },
                },
            };
    ...
    public sealed class MagicNetworkMonitoringConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("warpDevices")]
        private InputList<Inputs.ConfigurationWarpDeviceArgs>? _warpDevices;
        public InputList<Inputs.ConfigurationWarpDeviceArgs> WarpDevices
        {
            get => _warpDevices ?? (_warpDevices = new InputList<Inputs.ConfigurationWarpDeviceArgs>());
    ...
    public sealed class MagicNetworkMonitoringConfigurationState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("warpDevices")]
        private InputList<Inputs.ConfigurationWarpDeviceGetArgs>? _warpDevices;
        public InputList<Inputs.ConfigurationWarpDeviceGetArgs> WarpDevices
        {
            get => _warpDevices ?? (_warpDevices = new InputList<Inputs.ConfigurationWarpDeviceGetArgs>());
            set => _warpDevices = value;
        }
