...
namespace Pulumi.Cloudflare.Modules.MagicTransit
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:magicTransit/connector:Connector")]
    public partial class MagicTransitConnector : global::Pulumi.CustomResource
    {
        ...
        [Output("device")]
        public Output<Outputs.ConnectorDevice> Device { get; private set; } = null!;
        ...
        public MagicTransitConnector(string name, MagicTransitConnectorArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:magicTransit/connector:Connector", name, args ?? new MagicTransitConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private MagicTransitConnector(string name, Input<string> id, MagicTransitConnectorState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:magicTransit/connector:Connector", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/magicTransitConnector:MagicTransitConnector" },
                },
    ...
    public sealed class MagicTransitConnectorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ConnectorDeviceArgs> Device { get; set; } = null!;
    ...
    public sealed class MagicTransitConnectorState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("device")]
        public Input<Inputs.ConnectorDeviceGetArgs>? Device { get; set; }
