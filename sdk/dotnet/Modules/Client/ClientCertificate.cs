...
namespace Pulumi.Cloudflare.Modules.Client
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:client/certificate:Certificate")]
    public partial class ClientCertificate : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.CertificateCertificateAuthority> CertificateAuthority { get; private set; } = null!;
        ...
        public ClientCertificate(string name, ClientCertificateArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:client/certificate:Certificate", name, args ?? new ClientCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ClientCertificate(string name, Input<string> id, ClientCertificateState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:client/certificate:Certificate", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/clientCertificate:ClientCertificate" },
                },
            };
    ...
    public sealed class ClientCertificateState : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.CertificateCertificateAuthorityGetArgs>? CertificateAuthority { get; set; }
