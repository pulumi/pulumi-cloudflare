...
namespace Pulumi.Cloudflare.Modules.Snippets
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:snippets/snippets:Snippets")]
    public partial class Snippets : global::Pulumi.CustomResource
    {
        ...
        public Snippets(string name, SnippetsArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:snippets/snippets:Snippets", name, args ?? new SnippetsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snippets(string name, Input<string> id, SnippetsState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:snippets/snippets:Snippets", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/snippets:Snippets" },
                },
            };
