...
namespace Pulumi.Cloudflare.Modules.Image
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:image/variant:Variant")]
    public partial class ImageVariant : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("options")]
        public Output<Outputs.VariantOptions> Options { get; private set; } = null!;

        [Output("variant")]
        public Output<Outputs.VariantVariant> Variant { get; private set; } = null!;
        ...
        public ImageVariant(string name, ImageVariantArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:image/variant:Variant", name, args ?? new ImageVariantArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImageVariant(string name, Input<string> id, ImageVariantState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:image/variant:Variant", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/imageVariant:ImageVariant" },
                },
            };
    ...
    public sealed class ImageVariantArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VariantOptionsArgs> Options { get; set; } = null!;
    ...
    public sealed class ImageVariantState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("options")]
        public Input<Inputs.VariantOptionsGetArgs>? Options { get; set; }

        [Input("variant")]
        public Input<Inputs.VariantVariantGetArgs>? Variant { get; set; }
