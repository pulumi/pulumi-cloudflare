...
namespace Pulumi.Cloudflare.Modules.Firewall
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:firewall/rule:Rule")]
    public partial class FirewallRule : global::Pulumi.CustomResource
    {
        ...
        [Output("filter")]
        public Output<Outputs.RuleFilter> Filter { get; private set; } = null!;
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:firewall/rule:Rule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, FirewallRuleState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:firewall/rule:Rule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/firewallRule:FirewallRule" },
                },
            };
    ...
    public sealed class FirewallRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RuleFilterArgs> Filter { get; set; } = null!;
    ...
    public sealed class FirewallRuleState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("action")]
        public Input<Inputs.RuleActionGetArgs>? Action { get; set; }
        ...
        [Input("filter")]
        public Input<Inputs.RuleFilterGetArgs>? Filter { get; set; }
