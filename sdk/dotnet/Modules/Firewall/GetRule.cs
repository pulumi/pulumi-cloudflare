...
namespace Pulumi.Cloudflare.Modules.Firewall
{
    public static class GetRule
    {
        ...
        public static Task<GetRuleResult> InvokeAsync(GetRuleArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRuleResult>("cloudflare:firewall/rule:getRule", args ?? new GetRuleArgs(), options.WithDefaults());
        ...
        public static Output<GetRuleResult> Invoke(GetRuleInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRuleResult>("cloudflare:firewall/rule:getRule", args ?? new GetRuleInvokeArgs(), options.WithDefaults());
