...
namespace Pulumi.Cloudflare.Modules.Firewall.Inputs
{

    public sealed class RuleActionGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("response")]
        public Input<Inputs.RuleActionResponseGetArgs>? Response { get; set; }
        ...
        public RuleActionGetArgs()
        {
        }
        public static new RuleActionGetArgs Empty => new RuleActionGetArgs();
    }
}
