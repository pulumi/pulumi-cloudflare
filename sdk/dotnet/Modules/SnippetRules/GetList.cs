...
namespace Pulumi.Cloudflare.Modules.SnippetRules
{
    public static class GetList
    {
        public static Task<GetListResult> InvokeAsync(GetListArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetListResult>("cloudflare:snippetRules/list:getList", args ?? new GetListArgs(), options.WithDefaults());

        public static Output<GetListResult> Invoke(GetListInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetListResult>("cloudflare:snippetRules/list:getList", args ?? new GetListInvokeArgs(), options.WithDefaults());
