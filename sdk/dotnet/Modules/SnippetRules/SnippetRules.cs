...
namespace Pulumi.Cloudflare.Modules.SnippetRules
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:snippetRules/snippetRules:SnippetRules")]
    public partial class SnippetRules : global::Pulumi.CustomResource
    {
        ...
        public SnippetRules(string name, SnippetRulesArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:snippetRules/snippetRules:SnippetRules", name, args ?? new SnippetRulesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SnippetRules(string name, Input<string> id, SnippetRulesState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:snippetRules/snippetRules:SnippetRules", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/snippetRules:SnippetRules" },
                },
            };
