...
namespace Pulumi.Cloudflare.Modules.Workers
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:workers/deployment:Deployment")]
    public partial class WorkersDeployment : global::Pulumi.CustomResource
    {
        ...
        [Output("annotations")]
        public Output<Outputs.DeploymentAnnotations> Annotations { get; private set; } = null!;
        ...
        [Output("versions")]
        public Output<ImmutableArray<Outputs.DeploymentVersion>> Versions { get; private set; } = null!;
        ...
        public WorkersDeployment(string name, WorkersDeploymentArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:workers/deployment:Deployment", name, args ?? new WorkersDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private WorkersDeployment(string name, Input<string> id, WorkersDeploymentState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:workers/deployment:Deployment", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/workersDeployment:WorkersDeployment" },
                },
            };
    ...
    public sealed class WorkersDeploymentArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("annotations")]
        public Input<Inputs.DeploymentAnnotationsArgs>? Annotations { get; set; }
        ...
        private InputList<Inputs.DeploymentVersionArgs>? _versions;
        public InputList<Inputs.DeploymentVersionArgs> Versions
        {
            get => _versions ?? (_versions = new InputList<Inputs.DeploymentVersionArgs>());
            set => _versions = value;
        }
    ...
    public sealed class WorkersDeploymentState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("annotations")]
        public Input<Inputs.DeploymentAnnotationsGetArgs>? Annotations { get; set; }
        ...
        [Input("versions")]
        private InputList<Inputs.DeploymentVersionGetArgs>? _versions;
        public InputList<Inputs.DeploymentVersionGetArgs> Versions
        {
            get => _versions ?? (_versions = new InputList<Inputs.DeploymentVersionGetArgs>());
            set => _versions = value;
        }
