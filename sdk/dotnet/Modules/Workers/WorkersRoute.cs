...
namespace Pulumi.Cloudflare.Modules.Workers
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:workers/route:Route")]
    public partial class WorkersRoute : global::Pulumi.CustomResource
    {
        ...
        public WorkersRoute(string name, WorkersRouteArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:workers/route:Route", name, args ?? new WorkersRouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkersRoute(string name, Input<string> id, WorkersRouteState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:workers/route:Route", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/workersRoute:WorkersRoute" },
                },
            };
