...
namespace Pulumi.Cloudflare.Modules.Workers
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:workers/cronTrigger:CronTrigger")]
    public partial class WorkersCronTrigger : global::Pulumi.CustomResource
    {
        ...
        [Output("schedules")]
        public Output<ImmutableArray<Outputs.CronTriggerSchedule>> Schedules { get; private set; } = null!;
        ...
        public WorkersCronTrigger(string name, WorkersCronTriggerArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:workers/cronTrigger:CronTrigger", name, args ?? new WorkersCronTriggerArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private WorkersCronTrigger(string name, Input<string> id, WorkersCronTriggerState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:workers/cronTrigger:CronTrigger", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/workersCronTrigger:WorkersCronTrigger" },
    ...
    public sealed class WorkersCronTriggerArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.CronTriggerScheduleArgs>? _schedules;
        public InputList<Inputs.CronTriggerScheduleArgs> Schedules
        {
            get => _schedules ?? (_schedules = new InputList<Inputs.CronTriggerScheduleArgs>());
    ...
    public sealed class WorkersCronTriggerState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("schedules")]
        private InputList<Inputs.CronTriggerScheduleGetArgs>? _schedules;
        public InputList<Inputs.CronTriggerScheduleGetArgs> Schedules
        {
            get => _schedules ?? (_schedules = new InputList<Inputs.CronTriggerScheduleGetArgs>());
            set => _schedules = value;
        }
