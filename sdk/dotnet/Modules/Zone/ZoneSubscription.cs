...
namespace Pulumi.Cloudflare.Modules.Zone
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zone/subscription:Subscription")]
    public partial class ZoneSubscription : global::Pulumi.CustomResource
    {
        ...
        public ZoneSubscription(string name, ZoneSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zone/subscription:Subscription", name, args ?? new ZoneSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ZoneSubscription(string name, Input<string> id, ZoneSubscriptionState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zone/subscription:Subscription", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zoneSubscription:ZoneSubscription" },
                },
            };
