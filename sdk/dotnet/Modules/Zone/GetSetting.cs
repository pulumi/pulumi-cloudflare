...
namespace Pulumi.Cloudflare.Modules.Zone
{
    public static class GetSetting
    {
        ...
        public static Task<GetSettingResult> InvokeAsync(GetSettingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSettingResult>("cloudflare:zone/setting:getSetting", args ?? new GetSettingArgs(), options.WithDefaults());
        ...
        public static Output<GetSettingResult> Invoke(GetSettingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSettingResult>("cloudflare:zone/setting:getSetting", args ?? new GetSettingInvokeArgs(), options.WithDefaults());
