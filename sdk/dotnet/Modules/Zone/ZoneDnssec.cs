...
namespace Pulumi.Cloudflare.Modules.Zone
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zone/dnssec:Dnssec")]
    public partial class ZoneDnssec : global::Pulumi.CustomResource
    {
        ...
        public ZoneDnssec(string name, ZoneDnssecArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zone/dnssec:Dnssec", name, args ?? new ZoneDnssecArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ZoneDnssec(string name, Input<string> id, ZoneDnssecState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zone/dnssec:Dnssec", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zoneDnssec:ZoneDnssec" },
                },
            };
