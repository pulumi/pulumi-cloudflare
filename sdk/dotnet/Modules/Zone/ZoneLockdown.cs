...
namespace Pulumi.Cloudflare.Modules.Zone
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zone/lockdown:Lockdown")]
    public partial class ZoneLockdown : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.LockdownConfiguration>> Configurations { get; private set; } = null!;
        ...
        public ZoneLockdown(string name, ZoneLockdownArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zone/lockdown:Lockdown", name, args ?? new ZoneLockdownArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ZoneLockdown(string name, Input<string> id, ZoneLockdownState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zone/lockdown:Lockdown", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zoneLockdown:ZoneLockdown" },
                },
            };
    ...
    public sealed class ZoneLockdownArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.LockdownConfigurationArgs>? _configurations;

        /// <summary>
        /// A list of IP addresses or CIDR ranges that will be allowed to access the URLs specified in the Zone Lockdown rule. You can include any number of `Ip` or `IpRange` configurations.
        /// </summary>
        public InputList<Inputs.LockdownConfigurationArgs> Configurations
        {
            get => _configurations ?? (_configurations = new InputList<Inputs.LockdownConfigurationArgs>());
    ...
    public sealed class ZoneLockdownState : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.LockdownConfigurationGetArgs>? _configurations;

        /// <summary>
        /// A list of IP addresses or CIDR ranges that will be allowed to access the URLs specified in the Zone Lockdown rule. You can include any number of `Ip` or `IpRange` configurations.
        /// </summary>
        public InputList<Inputs.LockdownConfigurationGetArgs> Configurations
        {
            get => _configurations ?? (_configurations = new InputList<Inputs.LockdownConfigurationGetArgs>());
            set => _configurations = value;
        }
