...
namespace Pulumi.Cloudflare.Modules.Zone
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zone/setting:Setting")]
    public partial class ZoneSetting : global::Pulumi.CustomResource
    {
        ...
        public ZoneSetting(string name, ZoneSettingArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zone/setting:Setting", name, args ?? new ZoneSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ZoneSetting(string name, Input<string> id, ZoneSettingState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zone/setting:Setting", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zoneSetting:ZoneSetting" },
                },
            };
