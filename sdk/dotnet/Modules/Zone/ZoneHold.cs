...
namespace Pulumi.Cloudflare.Modules.Zone
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zone/hold:Hold")]
    public partial class ZoneHold : global::Pulumi.CustomResource
    {
        ...
        public ZoneHold(string name, ZoneHoldArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zone/hold:Hold", name, args ?? new ZoneHoldArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ZoneHold(string name, Input<string> id, ZoneHoldState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zone/hold:Hold", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zoneHold:ZoneHold" },
                },
            };
