...
namespace Pulumi.Cloudflare.Modules.ApiToken
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:apiToken/apiToken:ApiToken")]
    public partial class ApiToken : global::Pulumi.CustomResource
    {
        ...
        public ApiToken(string name, ApiTokenArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:apiToken/apiToken:ApiToken", name, args ?? new ApiTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiToken(string name, Input<string> id, ApiTokenState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:apiToken/apiToken:ApiToken", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/apiToken:ApiToken" },
                },
