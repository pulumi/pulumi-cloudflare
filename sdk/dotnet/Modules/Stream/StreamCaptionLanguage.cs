...
namespace Pulumi.Cloudflare.Modules.Stream
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:stream/captionLanguage:CaptionLanguage")]
    public partial class StreamCaptionLanguage : global::Pulumi.CustomResource
    {
        ...
        public StreamCaptionLanguage(string name, StreamCaptionLanguageArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:stream/captionLanguage:CaptionLanguage", name, args ?? new StreamCaptionLanguageArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private StreamCaptionLanguage(string name, Input<string> id, StreamCaptionLanguageState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:stream/captionLanguage:CaptionLanguage", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/streamCaptionLanguage:StreamCaptionLanguage" },
                },
            };
