...
namespace Pulumi.Cloudflare.Modules.Stream
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:stream/audioTrack:AudioTrack")]
    public partial class StreamAudioTrack : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("audios")]
        public Output<ImmutableArray<Outputs.AudioTrackAudio>> Audios { get; private set; } = null!;
        ...
        public StreamAudioTrack(string name, StreamAudioTrackArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:stream/audioTrack:AudioTrack", name, args ?? new StreamAudioTrackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamAudioTrack(string name, Input<string> id, StreamAudioTrackState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:stream/audioTrack:AudioTrack", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/streamAudioTrack:StreamAudioTrack" },
                },
            };
    ...
    public sealed class StreamAudioTrackState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("audios")]
        private InputList<Inputs.AudioTrackAudioGetArgs>? _audios;

        /// <summary>
        /// Array of audio tracks for the video.
        /// </summary>
        public InputList<Inputs.AudioTrackAudioGetArgs> Audios
        {
            get => _audios ?? (_audios = new InputList<Inputs.AudioTrackAudioGetArgs>());
            set => _audios = value;
        }
