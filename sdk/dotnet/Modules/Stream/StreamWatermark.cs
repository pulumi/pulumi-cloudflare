...
namespace Pulumi.Cloudflare.Modules.Stream
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:stream/watermark:Watermark")]
    public partial class StreamWatermark : global::Pulumi.CustomResource
    {
        ...
        public StreamWatermark(string name, StreamWatermarkArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:stream/watermark:Watermark", name, args ?? new StreamWatermarkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamWatermark(string name, Input<string> id, StreamWatermarkState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:stream/watermark:Watermark", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/streamWatermark:StreamWatermark" },
                },
            };
