...
namespace Pulumi.Cloudflare.Modules.Stream
{
    public static class GetStream
    {
        ...
        /// {
        ///     var exampleStream = Cloudflare.Modules.Stream.GetStream.Invoke(new()
        ///     {
        ...
        public static Task<GetStreamResult> InvokeAsync(GetStreamArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStreamResult>("cloudflare:stream/stream:getStream", args ?? new GetStreamArgs(), options.WithDefaults());
        ...
        public static Output<GetStreamResult> Invoke(GetStreamInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStreamResult>("cloudflare:stream/stream:getStream", args ?? new GetStreamInvokeArgs(), options.WithDefaults());
