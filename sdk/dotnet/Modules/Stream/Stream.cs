...
namespace Pulumi.Cloudflare.Modules.Stream
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:stream/stream:Stream")]
    public partial class Stream : global::Pulumi.CustomResource
    {
        ...
        public Stream(string name, StreamArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:stream/stream:Stream", name, args ?? new StreamArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Stream(string name, Input<string> id, StreamState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:stream/stream:Stream", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/stream:Stream" },
                },
            };
