...
namespace Pulumi.Cloudflare.Modules.Stream
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:stream/key:Key")]
    public partial class StreamKey : global::Pulumi.CustomResource
    {
        ...
        public StreamKey(string name, StreamKeyArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:stream/key:Key", name, args ?? new StreamKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamKey(string name, Input<string> id, StreamKeyState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:stream/key:Key", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/streamKey:StreamKey" },
                },
