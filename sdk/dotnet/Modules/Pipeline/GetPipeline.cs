...
namespace Pulumi.Cloudflare.Modules.Pipeline
{
    public static class GetPipeline
    {
        ...
        public static Task<GetPipelineResult> InvokeAsync(GetPipelineArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPipelineResult>("cloudflare:pipeline/pipeline:getPipeline", args ?? new GetPipelineArgs(), options.WithDefaults());
        ...
        public static Output<GetPipelineResult> Invoke(GetPipelineInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPipelineResult>("cloudflare:pipeline/pipeline:getPipeline", args ?? new GetPipelineInvokeArgs(), options.WithDefaults());
