...
namespace Pulumi.Cloudflare.Modules.ApiShieldDiscovery
{
    ...
    /// {
    ///     var exampleApiShieldDiscoveryOperation = new Cloudflare.Modules.ApiShieldDiscovery.ApiShieldDiscoveryOperation("example_api_shield_discovery_operation", new()
    ///     {
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:apiShieldDiscovery/operation:Operation")]
    public partial class ApiShieldDiscoveryOperation : global::Pulumi.CustomResource
    {
        ...
        public ApiShieldDiscoveryOperation(string name, ApiShieldDiscoveryOperationArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:apiShieldDiscovery/operation:Operation", name, args ?? new ApiShieldDiscoveryOperationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ApiShieldDiscoveryOperation(string name, Input<string> id, ApiShieldDiscoveryOperationState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:apiShieldDiscovery/operation:Operation", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/apiShieldDiscoveryOperation:ApiShieldDiscoveryOperation" },
                },
            };
