...
namespace Pulumi.Cloudflare.Modules.LoadBalancer.Inputs
{
    ...
    public sealed class PoolOriginGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("header")]
        public Input<Inputs.PoolOriginHeaderGetArgs>? Header { get; set; }
        ...
        public PoolOriginGetArgs()
        {
        }
        public static new PoolOriginGetArgs Empty => new PoolOriginGetArgs();
    }
}
