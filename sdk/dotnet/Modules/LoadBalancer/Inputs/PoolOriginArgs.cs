...
namespace Pulumi.Cloudflare.Modules.LoadBalancer.Inputs
{
    ...
    public sealed class PoolOriginArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("header")]
        public Input<Inputs.PoolOriginHeaderArgs>? Header { get; set; }
        ...
        public PoolOriginArgs()
        {
        }
        public static new PoolOriginArgs Empty => new PoolOriginArgs();
    }
}
