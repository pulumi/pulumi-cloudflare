...
namespace Pulumi.Cloudflare.Modules.LoadBalancer.Outputs
{
    ...
    [OutputType]
    public sealed class GetPoolOriginResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetPoolOriginHeaderResult Header;
        /// <summary>
        ...
        private GetPoolOriginResult(
            ...
            Outputs.GetPoolOriginHeaderResult header,
