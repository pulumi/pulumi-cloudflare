...
namespace Pulumi.Cloudflare.Modules.LoadBalancer
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:loadBalancer/pool:Pool")]
    public partial class LoadBalancerPool : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("loadShedding")]
        public Output<Outputs.PoolLoadShedding> LoadShedding { get; private set; } = null!;
        ...
        public Output<Outputs.PoolNotificationFilter> NotificationFilter { get; private set; } = null!;

        /// <summary>
        /// Configures origin steering for the pool. Controls how origins are selected for new sessions and traffic without session affinity.
        /// </summary>
        [Output("originSteering")]
        public Output<Outputs.PoolOriginSteering> OriginSteering { get; private set; } = null!;

        /// <summary>
        /// The list of origins within this pool. Traffic directed at this pool is balanced across all currently healthy origins, provided the pool itself is healthy.
        /// </summary>
        [Output("origins")]
        public Output<ImmutableArray<Outputs.PoolOrigin>> Origins { get; private set; } = null!;
        ...
        public LoadBalancerPool(string name, LoadBalancerPoolArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:loadBalancer/pool:Pool", name, args ?? new LoadBalancerPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancerPool(string name, Input<string> id, LoadBalancerPoolState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:loadBalancer/pool:Pool", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/loadBalancerPool:LoadBalancerPool" },
                },
            };
    ...
    public sealed class LoadBalancerPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("loadShedding")]
        public Input<Inputs.PoolLoadSheddingArgs>? LoadShedding { get; set; }
        ...
        public Input<Inputs.PoolNotificationFilterArgs>? NotificationFilter { get; set; }

        /// <summary>
        /// Configures origin steering for the pool. Controls how origins are selected for new sessions and traffic without session affinity.
        /// </summary>
        [Input("originSteering")]
        public Input<Inputs.PoolOriginSteeringArgs>? OriginSteering { get; set; }

        [Input("origins", required: true)]
        private InputList<Inputs.PoolOriginArgs>? _origins;

        /// <summary>
        /// The list of origins within this pool. Traffic directed at this pool is balanced across all currently healthy origins, provided the pool itself is healthy.
        /// </summary>
        public InputList<Inputs.PoolOriginArgs> Origins
        {
            get => _origins ?? (_origins = new InputList<Inputs.PoolOriginArgs>());
            set => _origins = value;
        }
    ...
    public sealed class LoadBalancerPoolState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("loadShedding")]
        public Input<Inputs.PoolLoadSheddingGetArgs>? LoadShedding { get; set; }
        ...
        /// </summary>
        [Input("notificationFilter")]
        public Input<Inputs.PoolNotificationFilterGetArgs>? NotificationFilter { get; set; }

        /// <summary>
        /// Configures origin steering for the pool. Controls how origins are selected for new sessions and traffic without session affinity.
        /// </summary>
        [Input("originSteering")]
        public Input<Inputs.PoolOriginSteeringGetArgs>? OriginSteering { get; set; }

        [Input("origins")]
        private InputList<Inputs.PoolOriginGetArgs>? _origins;

        /// <summary>
        /// The list of origins within this pool. Traffic directed at this pool is balanced across all currently healthy origins, provided the pool itself is healthy.
        /// </summary>
        public InputList<Inputs.PoolOriginGetArgs> Origins
        {
            get => _origins ?? (_origins = new InputList<Inputs.PoolOriginGetArgs>());
            set => _origins = value;
        }
