...
namespace Pulumi.Cloudflare.Modules.R2Bucket
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:r2Bucket/eventNotification:EventNotification")]
    public partial class R2BucketEventNotification : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("rules")]
        public Output<ImmutableArray<Outputs.EventNotificationRule>> Rules { get; private set; } = null!;
        ...
        public R2BucketEventNotification(string name, R2BucketEventNotificationArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:r2Bucket/eventNotification:EventNotification", name, args ?? new R2BucketEventNotificationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private R2BucketEventNotification(string name, Input<string> id, R2BucketEventNotificationState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:r2Bucket/eventNotification:EventNotification", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/r2BucketEventNotification:R2BucketEventNotification" },
                },
            };
    ...
    public sealed class R2BucketEventNotificationArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.EventNotificationRuleArgs>? _rules;

        /// <summary>
        /// Array of rules to drive notifications.
        /// </summary>
        public InputList<Inputs.EventNotificationRuleArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.EventNotificationRuleArgs>());
            set => _rules = value;
        }
    ...
    public sealed class R2BucketEventNotificationState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("rules")]
        private InputList<Inputs.EventNotificationRuleGetArgs>? _rules;

        /// <summary>
        /// Array of rules to drive notifications.
        /// </summary>
        public InputList<Inputs.EventNotificationRuleGetArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.EventNotificationRuleGetArgs>());
            set => _rules = value;
        }
