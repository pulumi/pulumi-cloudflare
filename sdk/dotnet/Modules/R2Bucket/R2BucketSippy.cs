...
namespace Pulumi.Cloudflare.Modules.R2Bucket
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:r2Bucket/sippy:Sippy")]
    public partial class R2BucketSippy : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("destination")]
        public Output<Outputs.SippyDestination?> Destination { get; private set; } = null!;
        ...
        /// </summary>
        [Output("source")]
        public Output<Outputs.SippySource?> Source { get; private set; } = null!;
        ...
        public R2BucketSippy(string name, R2BucketSippyArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:r2Bucket/sippy:Sippy", name, args ?? new R2BucketSippyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private R2BucketSippy(string name, Input<string> id, R2BucketSippyState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:r2Bucket/sippy:Sippy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/r2BucketSippy:R2BucketSippy" },
                },
            };
    ...
    public sealed class R2BucketSippyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("destination")]
        public Input<Inputs.SippyDestinationArgs>? Destination { get; set; }
        ...
        /// </summary>
        [Input("source")]
        public Input<Inputs.SippySourceArgs>? Source { get; set; }
    ...
    public sealed class R2BucketSippyState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("destination")]
        public Input<Inputs.SippyDestinationGetArgs>? Destination { get; set; }
        ...
        /// </summary>
        [Input("source")]
        public Input<Inputs.SippySourceGetArgs>? Source { get; set; }
