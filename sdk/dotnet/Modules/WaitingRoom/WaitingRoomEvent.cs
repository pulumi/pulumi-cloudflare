...
namespace Pulumi.Cloudflare.Modules.WaitingRoom
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:waitingRoom/event:Event")]
    public partial class WaitingRoomEvent : global::Pulumi.CustomResource
    {
        ...
        public WaitingRoomEvent(string name, WaitingRoomEventArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:waitingRoom/event:Event", name, args ?? new WaitingRoomEventArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WaitingRoomEvent(string name, Input<string> id, WaitingRoomEventState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:waitingRoom/event:Event", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/waitingRoomEvent:WaitingRoomEvent" },
                },
            };
