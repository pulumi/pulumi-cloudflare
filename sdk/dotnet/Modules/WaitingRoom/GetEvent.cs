...
namespace Pulumi.Cloudflare.Modules.WaitingRoom
{
    public static class GetEvent
    {
        ...
        public static Task<GetEventResult> InvokeAsync(GetEventArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEventResult>("cloudflare:waitingRoom/event:getEvent", args ?? new GetEventArgs(), options.WithDefaults());
        ...
        public static Output<GetEventResult> Invoke(GetEventInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEventResult>("cloudflare:waitingRoom/event:getEvent", args ?? new GetEventInvokeArgs(), options.WithDefaults());
