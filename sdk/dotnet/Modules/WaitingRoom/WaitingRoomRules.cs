...
namespace Pulumi.Cloudflare.Modules.WaitingRoom
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:waitingRoom/rules:Rules")]
    public partial class WaitingRoomRules : global::Pulumi.CustomResource
    {
        ...
        public WaitingRoomRules(string name, WaitingRoomRulesArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:waitingRoom/rules:Rules", name, args ?? new WaitingRoomRulesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WaitingRoomRules(string name, Input<string> id, WaitingRoomRulesState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:waitingRoom/rules:Rules", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/waitingRoomRules:WaitingRoomRules" },
                },
            };
