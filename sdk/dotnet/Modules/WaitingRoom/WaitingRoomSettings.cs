...
namespace Pulumi.Cloudflare.Modules.WaitingRoom
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:waitingRoom/settings:Settings")]
    public partial class WaitingRoomSettings : global::Pulumi.CustomResource
    {
        ...
        public WaitingRoomSettings(string name, WaitingRoomSettingsArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:waitingRoom/settings:Settings", name, args ?? new WaitingRoomSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private WaitingRoomSettings(string name, Input<string> id, WaitingRoomSettingsState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:waitingRoom/settings:Settings", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/waitingRoomSettings:WaitingRoomSettings" },
                },
            };
