...
namespace Pulumi.Cloudflare.Modules.ZeroTrustDlp
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:zeroTrustDlp/dataset:Dataset")]
    public partial class ZeroTrustDlpDataset : global::Pulumi.CustomResource
    {
        ...
        [Output("columns")]
        public Output<ImmutableArray<Outputs.DatasetColumn>> Columns { get; private set; } = null!;

        [Output("createdAt")]
        public Output<string> CreatedAt { get; private set; } = null!;

        [Output("dataset")]
        public Output<Outputs.DatasetDataset> Dataset { get; private set; } = null!;
        ...
        [Output("uploads")]
        public Output<ImmutableArray<Outputs.DatasetUpload>> Uploads { get; private set; } = null!;
        ...
        public ZeroTrustDlpDataset(string name, ZeroTrustDlpDatasetArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustDlp/dataset:Dataset", name, args ?? new ZeroTrustDlpDatasetArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZeroTrustDlpDataset(string name, Input<string> id, ZeroTrustDlpDatasetState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustDlp/dataset:Dataset", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zeroTrustDlpDataset:ZeroTrustDlpDataset" },
                },
            };
    ...
    public sealed class ZeroTrustDlpDatasetState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("columns")]
        private InputList<Inputs.DatasetColumnGetArgs>? _columns;
        public InputList<Inputs.DatasetColumnGetArgs> Columns
        {
            get => _columns ?? (_columns = new InputList<Inputs.DatasetColumnGetArgs>());
            set => _columns = value;
        }
        ...
        [Input("dataset")]
        public Input<Inputs.DatasetDatasetGetArgs>? Dataset { get; set; }
        ...
        [Input("uploads")]
        private InputList<Inputs.DatasetUploadGetArgs>? _uploads;
        public InputList<Inputs.DatasetUploadGetArgs> Uploads
        {
            get => _uploads ?? (_uploads = new InputList<Inputs.DatasetUploadGetArgs>());
            set => _uploads = value;
        }
