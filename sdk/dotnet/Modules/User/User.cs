...
namespace Pulumi.Cloudflare.Modules.User
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:user/user:User")]
    public partial class User : global::Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs? args = null, CustomResourceOptions? options = null)
            : base("cloudflare:user/user:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, UserState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:user/user:User", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/user:User" },
                },
            };
