...
namespace Pulumi.Cloudflare.Modules.User
{
    public static class GetUser
    {
        ...
        public static Task<GetUserResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUserResult>("cloudflare:user/user:getUser", InvokeArgs.Empty, options.WithDefaults());
        ...
        public static Output<GetUserResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUserResult>("cloudflare:user/user:getUser", InvokeArgs.Empty, options.WithDefaults());
