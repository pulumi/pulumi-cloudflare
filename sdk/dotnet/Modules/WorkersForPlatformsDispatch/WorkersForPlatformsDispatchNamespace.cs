...
namespace Pulumi.Cloudflare.Modules.WorkersForPlatformsDispatch
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:workersForPlatformsDispatch/namespace:Namespace")]
    public partial class WorkersForPlatformsDispatchNamespace : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("trustedWorkers")]
        public Output<bool> TrustedWorkers { get; private set; } = null!;
        ...
        public WorkersForPlatformsDispatchNamespace(string name, WorkersForPlatformsDispatchNamespaceArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:workersForPlatformsDispatch/namespace:Namespace", name, args ?? new WorkersForPlatformsDispatchNamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private WorkersForPlatformsDispatchNamespace(string name, Input<string> id, WorkersForPlatformsDispatchNamespaceState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:workersForPlatformsDispatch/namespace:Namespace", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "cloudflare:index/workersForPlatformsDispatchNamespace:WorkersForPlatformsDispatchNamespace" },
                },
            };
    ...
    public sealed class WorkersForPlatformsDispatchNamespaceState : global::Pulumi.ResourceArgs
    {
        ...
        /// Whether the Workers in the namespace are executed in a "trusted" manner. When a Worker is trusted, it has access to the shared caches for the zone in the Cache API, and has access to the `request.cf` object on incoming Requests. When a Worker is untrusted, caches are not shared across the zone, and `request.cf` is undefined. By default, Workers in a namespace are "untrusted".
        /// </summary>
        [Input("trustedWorkers")]
        public Input<bool>? TrustedWorkers { get; set; }
