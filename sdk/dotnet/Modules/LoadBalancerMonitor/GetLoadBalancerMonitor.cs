...
namespace Pulumi.Cloudflare.Modules.LoadBalancerMonitor
{
    public static class GetLoadBalancerMonitor
    {
        ...
        public static Task<GetLoadBalancerMonitorResult> InvokeAsync(GetLoadBalancerMonitorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLoadBalancerMonitorResult>("cloudflare:loadBalancerMonitor/loadBalancerMonitor:getLoadBalancerMonitor", args ?? new GetLoadBalancerMonitorArgs(), options.WithDefaults());
        ...
        public static Output<GetLoadBalancerMonitorResult> Invoke(GetLoadBalancerMonitorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLoadBalancerMonitorResult>("cloudflare:loadBalancerMonitor/loadBalancerMonitor:getLoadBalancerMonitor", args ?? new GetLoadBalancerMonitorInvokeArgs(), options.WithDefaults());
