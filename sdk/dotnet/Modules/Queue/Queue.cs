...
namespace Pulumi.Cloudflare.Modules.Queue
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:queue/queue:Queue")]
    public partial class Queue : global::Pulumi.CustomResource
    {
        ...
        public Queue(string name, QueueArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:queue/queue:Queue", name, args ?? new QueueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Queue(string name, Input<string> id, QueueState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:queue/queue:Queue", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/queue:Queue" },
                },
            };
