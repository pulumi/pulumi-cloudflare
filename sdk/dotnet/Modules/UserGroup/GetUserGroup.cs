...
namespace Pulumi.Cloudflare.Modules.UserGroup
{
    public static class GetUserGroup
    {
        ...
        public static Task<GetUserGroupResult> InvokeAsync(GetUserGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUserGroupResult>("cloudflare:userGroup/userGroup:getUserGroup", args ?? new GetUserGroupArgs(), options.WithDefaults());
        ...
        public static Output<GetUserGroupResult> Invoke(GetUserGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUserGroupResult>("cloudflare:userGroup/userGroup:getUserGroup", args ?? new GetUserGroupInvokeArgs(), options.WithDefaults());
