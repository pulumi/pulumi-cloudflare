...
namespace Pulumi.Cloudflare.Modules.UserGroup
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:userGroup/userGroup:UserGroup")]
    public partial class UserGroup : global::Pulumi.CustomResource
    {
        ...
        public UserGroup(string name, UserGroupArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:userGroup/userGroup:UserGroup", name, args ?? new UserGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserGroup(string name, Input<string> id, UserGroupState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:userGroup/userGroup:UserGroup", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/userGroup:UserGroup" },
                },
            };
