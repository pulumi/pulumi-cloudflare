...
namespace Pulumi.Cloudflare.Modules.ZeroTrustDeviceDeploymentGroups.Outputs
{

    [OutputType]
    public sealed class GetListResultResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetListResultVersionConfigResult> VersionConfigs;

        [OutputConstructor]
        private GetListResultResult(
            string createdAt,
            ...
            ImmutableArray<Outputs.GetListResultVersionConfigResult> versionConfigs)
        {
            CreatedAt = createdAt;
            Id = id;
            Name = name;
