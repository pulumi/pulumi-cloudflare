...
namespace Pulumi.Cloudflare.Modules.Certificate
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:certificate/pack:Pack")]
    public partial class CertificatePack : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("certificates")]
        public Output<ImmutableArray<Outputs.PackCertificate>> Certificates { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.PackDcvDelegationRecord>> DcvDelegationRecords { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.PackValidationError>> ValidationErrors { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.PackValidationRecord>> ValidationRecords { get; private set; } = null!;
        ...
        public CertificatePack(string name, CertificatePackArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:certificate/pack:Pack", name, args ?? new CertificatePackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CertificatePack(string name, Input<string> id, CertificatePackState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:certificate/pack:Pack", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/certificatePack:CertificatePack" },
                },
            };
    ...
    public sealed class CertificatePackState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("certificates")]
        private InputList<Inputs.PackCertificateGetArgs>? _certificates;

        /// <summary>
        /// Array of certificates in this pack.
        /// </summary>
        public InputList<Inputs.PackCertificateGetArgs> Certificates
        {
            get => _certificates ?? (_certificates = new InputList<Inputs.PackCertificateGetArgs>());
        ...
        private InputList<Inputs.PackDcvDelegationRecordGetArgs>? _dcvDelegationRecords;

        /// <summary>
        /// DCV Delegation records for domain validation.
        /// </summary>
        public InputList<Inputs.PackDcvDelegationRecordGetArgs> DcvDelegationRecords
        {
            get => _dcvDelegationRecords ?? (_dcvDelegationRecords = new InputList<Inputs.PackDcvDelegationRecordGetArgs>());
        ...
        private InputList<Inputs.PackValidationErrorGetArgs>? _validationErrors;

        /// <summary>
        /// Domain validation errors that have been received by the certificate authority (CA).
        /// </summary>
        public InputList<Inputs.PackValidationErrorGetArgs> ValidationErrors
        {
            get => _validationErrors ?? (_validationErrors = new InputList<Inputs.PackValidationErrorGetArgs>());
        ...
        private InputList<Inputs.PackValidationRecordGetArgs>? _validationRecords;

        /// <summary>
        /// Certificates' validation records.
        /// </summary>
        public InputList<Inputs.PackValidationRecordGetArgs> ValidationRecords
        {
            get => _validationRecords ?? (_validationRecords = new InputList<Inputs.PackValidationRecordGetArgs>());
