...
namespace Pulumi.Cloudflare.Modules.Access
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:access/rule:Rule")]
    public partial class AccessRule : global::Pulumi.CustomResource
    {
        ...
        public AccessRule(string name, AccessRuleArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:access/rule:Rule", name, args ?? new AccessRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessRule(string name, Input<string> id, AccessRuleState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:access/rule:Rule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/accessRule:AccessRule" },
                },
            };
