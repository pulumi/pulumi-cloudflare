...
namespace Pulumi.Cloudflare.Modules.ZeroTrustGateway.Inputs
{
    ...
    public sealed class PolicyRuleSettingsArgs : global::Pulumi.ResourceArgs
    {
        [Input("addHeaders")]
        ...
        /// </summary>
        [Input("auditSsh")]
        public Input<Inputs.PolicyRuleSettingsAuditSshArgs>? AuditSsh { get; set; }

        /// <summary>
        /// Configure browser isolation behavior. Settable only for `Http` rules with the action set to `Isolate`.
        /// </summary>
        [Input("bisoAdminControls")]
        public Input<Inputs.PolicyRuleSettingsBisoAdminControlsArgs>? BisoAdminControls { get; set; }
        ...
        /// </summary>
        [Input("blockPage")]
        public Input<Inputs.PolicyRuleSettingsBlockPageArgs>? BlockPage { get; set; }
        ...
        /// </summary>
        [Input("checkSession")]
        public Input<Inputs.PolicyRuleSettingsCheckSessionArgs>? CheckSession { get; set; }
        ...
        /// </summary>
        [Input("dnsResolvers")]
        public Input<Inputs.PolicyRuleSettingsDnsResolversArgs>? DnsResolvers { get; set; }
        ...
        /// </summary>
        [Input("egress")]
        public Input<Inputs.PolicyRuleSettingsEgressArgs>? Egress { get; set; }

        /// <summary>
        /// Configure whether a copy of the HTTP request will be sent to storage when the rule matches.
        /// </summary>
        [Input("forensicCopy")]
        public Input<Inputs.PolicyRuleSettingsForensicCopyArgs>? ForensicCopy { get; set; }
        ...
        /// </summary>
        [Input("l4override")]
        public Input<Inputs.PolicyRuleSettingsL4overrideArgs>? L4override { get; set; }
        ...
        public Input<Inputs.PolicyRuleSettingsNotificationSettingsArgs>? NotificationSettings { get; set; }
        ...
        /// </summary>
        [Input("payloadLog")]
        public Input<Inputs.PolicyRuleSettingsPayloadLogArgs>? PayloadLog { get; set; }

        /// <summary>
        /// Configure settings that apply to quarantine rules. Settable only for `Http` rules.
        /// </summary>
        [Input("quarantine")]
        public Input<Inputs.PolicyRuleSettingsQuarantineArgs>? Quarantine { get; set; }

        /// <summary>
        /// Apply settings to redirect rules. Settable only for `Http` rules with the action set to `Redirect`.
        /// </summary>
        [Input("redirect")]
        public Input<Inputs.PolicyRuleSettingsRedirectArgs>? Redirect { get; set; }
        ...
        public Input<Inputs.PolicyRuleSettingsResolveDnsInternallyArgs>? ResolveDnsInternally { get; set; }
        ...
        /// </summary>
        [Input("untrustedCert")]
        public Input<Inputs.PolicyRuleSettingsUntrustedCertArgs>? UntrustedCert { get; set; }

        public PolicyRuleSettingsArgs()
        {
        }
        public static new PolicyRuleSettingsArgs Empty => new PolicyRuleSettingsArgs();
    }
}
