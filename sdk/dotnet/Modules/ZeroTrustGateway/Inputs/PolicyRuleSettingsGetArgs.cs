...
namespace Pulumi.Cloudflare.Modules.ZeroTrustGateway.Inputs
{
    ...
    public sealed class PolicyRuleSettingsGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("addHeaders")]
        ...
        /// </summary>
        [Input("auditSsh")]
        public Input<Inputs.PolicyRuleSettingsAuditSshGetArgs>? AuditSsh { get; set; }

        /// <summary>
        /// Configure browser isolation behavior. Settable only for `Http` rules with the action set to `Isolate`.
        /// </summary>
        [Input("bisoAdminControls")]
        public Input<Inputs.PolicyRuleSettingsBisoAdminControlsGetArgs>? BisoAdminControls { get; set; }
        ...
        /// </summary>
        [Input("blockPage")]
        public Input<Inputs.PolicyRuleSettingsBlockPageGetArgs>? BlockPage { get; set; }
        ...
        /// </summary>
        [Input("checkSession")]
        public Input<Inputs.PolicyRuleSettingsCheckSessionGetArgs>? CheckSession { get; set; }
        ...
        /// </summary>
        [Input("dnsResolvers")]
        public Input<Inputs.PolicyRuleSettingsDnsResolversGetArgs>? DnsResolvers { get; set; }
        ...
        /// </summary>
        [Input("egress")]
        public Input<Inputs.PolicyRuleSettingsEgressGetArgs>? Egress { get; set; }

        /// <summary>
        /// Configure whether a copy of the HTTP request will be sent to storage when the rule matches.
        /// </summary>
        [Input("forensicCopy")]
        public Input<Inputs.PolicyRuleSettingsForensicCopyGetArgs>? ForensicCopy { get; set; }
        ...
        /// </summary>
        [Input("l4override")]
        public Input<Inputs.PolicyRuleSettingsL4overrideGetArgs>? L4override { get; set; }
        ...
        public Input<Inputs.PolicyRuleSettingsNotificationSettingsGetArgs>? NotificationSettings { get; set; }
        ...
        /// </summary>
        [Input("payloadLog")]
        public Input<Inputs.PolicyRuleSettingsPayloadLogGetArgs>? PayloadLog { get; set; }

        /// <summary>
        /// Configure settings that apply to quarantine rules. Settable only for `Http` rules.
        /// </summary>
        [Input("quarantine")]
        public Input<Inputs.PolicyRuleSettingsQuarantineGetArgs>? Quarantine { get; set; }

        /// <summary>
        /// Apply settings to redirect rules. Settable only for `Http` rules with the action set to `Redirect`.
        /// </summary>
        [Input("redirect")]
        public Input<Inputs.PolicyRuleSettingsRedirectGetArgs>? Redirect { get; set; }
        ...
        public Input<Inputs.PolicyRuleSettingsResolveDnsInternallyGetArgs>? ResolveDnsInternally { get; set; }
        ...
        /// </summary>
        [Input("untrustedCert")]
        public Input<Inputs.PolicyRuleSettingsUntrustedCertGetArgs>? UntrustedCert { get; set; }

        public PolicyRuleSettingsGetArgs()
        {
        }
        public static new PolicyRuleSettingsGetArgs Empty => new PolicyRuleSettingsGetArgs();
    }
}
