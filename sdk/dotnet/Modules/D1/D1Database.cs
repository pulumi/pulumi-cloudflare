...
namespace Pulumi.Cloudflare.Modules.D1
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:d1/database:Database")]
    public partial class D1Database : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.DatabaseReadReplication?> ReadReplication { get; private set; } = null!;
        ...
        public D1Database(string name, D1DatabaseArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:d1/database:Database", name, args ?? new D1DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private D1Database(string name, Input<string> id, D1DatabaseState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:d1/database:Database", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/d1Database:D1Database" },
                },
            };
    ...
    public sealed class D1DatabaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DatabaseReadReplicationArgs>? ReadReplication { get; set; }
    ...
    public sealed class D1DatabaseState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("readReplication")]
        public Input<Inputs.DatabaseReadReplicationGetArgs>? ReadReplication { get; set; }
