...
namespace Pulumi.Cloudflare.Modules.EmailSecurityImpersonation
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:emailSecurityImpersonation/registry:Registry")]
    public partial class EmailSecurityImpersonationRegistry : global::Pulumi.CustomResource
    {
        ...
        public EmailSecurityImpersonationRegistry(string name, EmailSecurityImpersonationRegistryArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:emailSecurityImpersonation/registry:Registry", name, args ?? new EmailSecurityImpersonationRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private EmailSecurityImpersonationRegistry(string name, Input<string> id, EmailSecurityImpersonationRegistryState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:emailSecurityImpersonation/registry:Registry", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/emailSecurityImpersonationRegistry:EmailSecurityImpersonationRegistry" },
                },
            };
