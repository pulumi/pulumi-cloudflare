...
namespace Pulumi.Cloudflare.Modules.AiGateway
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:aiGateway/aiGateway:AiGateway")]
    public partial class AiGateway : global::Pulumi.CustomResource
    {
        ...
        public AiGateway(string name, AiGatewayArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:aiGateway/aiGateway:AiGateway", name, args ?? new AiGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AiGateway(string name, Input<string> id, AiGatewayState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:aiGateway/aiGateway:AiGateway", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/aiGateway:AiGateway" },
                },
            };
