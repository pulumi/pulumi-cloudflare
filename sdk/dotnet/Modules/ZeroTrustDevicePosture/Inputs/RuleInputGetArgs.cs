...
namespace Pulumi.Cloudflare.Modules.ZeroTrustDevicePosture.Inputs
{
    ...
    public sealed class RuleInputGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("locations")]
        public Input<Inputs.RuleInputLocationsGetArgs>? Locations { get; set; }
        ...
        public RuleInputGetArgs()
        {
        }
        public static new RuleInputGetArgs Empty => new RuleInputGetArgs();
    }
}
