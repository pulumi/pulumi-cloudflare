...
namespace Pulumi.Cloudflare.Modules.ZeroTrustDevice
{
    public static class GetSettings
    {
        ...
        public static Task<GetSettingsResult> InvokeAsync(GetSettingsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSettingsResult>("cloudflare:zeroTrustDevice/settings:getSettings", args ?? new GetSettingsArgs(), options.WithDefaults());
        ...
        public static Output<GetSettingsResult> Invoke(GetSettingsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSettingsResult>("cloudflare:zeroTrustDevice/settings:getSettings", args ?? new GetSettingsInvokeArgs(), options.WithDefaults());
