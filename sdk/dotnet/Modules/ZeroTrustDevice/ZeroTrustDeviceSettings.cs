...
namespace Pulumi.Cloudflare.Modules.ZeroTrustDevice
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:zeroTrustDevice/settings:Settings")]
    public partial class ZeroTrustDeviceSettings : global::Pulumi.CustomResource
    {
        ...
        public ZeroTrustDeviceSettings(string name, ZeroTrustDeviceSettingsArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustDevice/settings:Settings", name, args ?? new ZeroTrustDeviceSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZeroTrustDeviceSettings(string name, Input<string> id, ZeroTrustDeviceSettingsState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustDevice/settings:Settings", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zeroTrustDeviceSettings:ZeroTrustDeviceSettings" },
                },
            };
