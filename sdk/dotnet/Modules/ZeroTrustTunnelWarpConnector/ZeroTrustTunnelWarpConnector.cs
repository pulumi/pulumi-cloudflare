...
namespace Pulumi.Cloudflare.Modules.ZeroTrustTunnelWarpConnector
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zeroTrustTunnelWarpConnector/zeroTrustTunnelWarpConnector:ZeroTrustTunnelWarpConnector")]
    public partial class ZeroTrustTunnelWarpConnector : global::Pulumi.CustomResource
    {
        ...
        public ZeroTrustTunnelWarpConnector(string name, ZeroTrustTunnelWarpConnectorArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustTunnelWarpConnector/zeroTrustTunnelWarpConnector:ZeroTrustTunnelWarpConnector", name, args ?? new ZeroTrustTunnelWarpConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZeroTrustTunnelWarpConnector(string name, Input<string> id, ZeroTrustTunnelWarpConnectorState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustTunnelWarpConnector/zeroTrustTunnelWarpConnector:ZeroTrustTunnelWarpConnector", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zeroTrustTunnelWarpConnector:ZeroTrustTunnelWarpConnector" },
                },
