...
namespace Pulumi.Cloudflare.Modules.ZeroTrust
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zeroTrust/list:List")]
    public partial class ZeroTrustList : global::Pulumi.CustomResource
    {
        ...
        public ZeroTrustList(string name, ZeroTrustListArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrust/list:List", name, args ?? new ZeroTrustListArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ZeroTrustList(string name, Input<string> id, ZeroTrustListState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrust/list:List", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zeroTrustList:ZeroTrustList" },
