...
namespace Pulumi.Cloudflare.Modules.SchemaValidationOperationSettings
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:schemaValidationOperationSettings/schemaValidationOperationSettings:SchemaValidationOperationSettings")]
    public partial class SchemaValidationOperationSettings : global::Pulumi.CustomResource
    {
        ...
        public SchemaValidationOperationSettings(string name, SchemaValidationOperationSettingsArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:schemaValidationOperationSettings/schemaValidationOperationSettings:SchemaValidationOperationSettings", name, args ?? new SchemaValidationOperationSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private SchemaValidationOperationSettings(string name, Input<string> id, SchemaValidationOperationSettingsState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:schemaValidationOperationSettings/schemaValidationOperationSettings:SchemaValidationOperationSettings", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/schemaValidationOperationSettings:SchemaValidationOperationSettings" },
                },
            };
