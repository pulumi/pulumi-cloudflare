...
namespace Pulumi.Cloudflare.Modules.CallsSfu
{
    public static class GetApps
    {
        ...
        public static Task<GetAppsResult> InvokeAsync(GetAppsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppsResult>("cloudflare:callsSfu/apps:getApps", args ?? new GetAppsArgs(), options.WithDefaults());
        ...
        public static Output<GetAppsResult> Invoke(GetAppsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAppsResult>("cloudflare:callsSfu/apps:getApps", args ?? new GetAppsInvokeArgs(), options.WithDefaults());
