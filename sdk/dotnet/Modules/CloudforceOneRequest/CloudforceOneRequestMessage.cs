...
namespace Pulumi.Cloudflare.Modules.CloudforceOneRequest
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:cloudforceOneRequest/message:Message")]
    public partial class CloudforceOneRequestMessage : global::Pulumi.CustomResource
    {
        ...
        public CloudforceOneRequestMessage(string name, CloudforceOneRequestMessageArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:cloudforceOneRequest/message:Message", name, args ?? new CloudforceOneRequestMessageArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private CloudforceOneRequestMessage(string name, Input<string> id, CloudforceOneRequestMessageState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:cloudforceOneRequest/message:Message", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/cloudforceOneRequestMessage:CloudforceOneRequestMessage" },
                },
            };
