...
namespace Pulumi.Cloudflare.Modules.R2
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:r2/managedDomain:ManagedDomain")]
    public partial class R2ManagedDomain : global::Pulumi.CustomResource
    {
        ...
        public R2ManagedDomain(string name, R2ManagedDomainArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:r2/managedDomain:ManagedDomain", name, args ?? new R2ManagedDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private R2ManagedDomain(string name, Input<string> id, R2ManagedDomainState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:r2/managedDomain:ManagedDomain", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/r2ManagedDomain:R2ManagedDomain" },
                },
            };
