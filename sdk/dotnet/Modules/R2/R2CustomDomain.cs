...
namespace Pulumi.Cloudflare.Modules.R2
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:r2/customDomain:CustomDomain")]
    public partial class R2CustomDomain : global::Pulumi.CustomResource
    {
        ...
        [Output("status")]
        public Output<Outputs.CustomDomainStatus> Status { get; private set; } = null!;
        ...
        public R2CustomDomain(string name, R2CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:r2/customDomain:CustomDomain", name, args ?? new R2CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private R2CustomDomain(string name, Input<string> id, R2CustomDomainState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:r2/customDomain:CustomDomain", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/r2CustomDomain:R2CustomDomain" },
                },
            };
    ...
    public sealed class R2CustomDomainState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("status")]
        public Input<Inputs.CustomDomainStatusGetArgs>? Status { get; set; }
