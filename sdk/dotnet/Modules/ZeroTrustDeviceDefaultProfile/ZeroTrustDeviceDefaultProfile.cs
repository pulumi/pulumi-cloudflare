...
namespace Pulumi.Cloudflare.Modules.ZeroTrustDeviceDefaultProfile
{
    ...
    /// {
    ///     var exampleZeroTrustDeviceDefaultProfile = new Cloudflare.Modules.ZeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfile("example_zero_trust_device_default_profile", new()
    ///     {
    ...
    ///         Excludes = new[]
    ///         {
    ///             new Cloudflare.Modules.ZeroTrustDeviceDefaultProfile.Inputs.ZeroTrustDeviceDefaultProfileExcludeArgs
    ///             {
    ...
    ///         Includes = new[]
    ///         {
    ///             new Cloudflare.Modules.ZeroTrustDeviceDefaultProfile.Inputs.ZeroTrustDeviceDefaultProfileIncludeArgs
    ///             {
    ///                 Address = "192.0.2.0/24",
    ...
    ///         ServiceModeV2 = new Cloudflare.Modules.ZeroTrustDeviceDefaultProfile.Inputs.ZeroTrustDeviceDefaultProfileServiceModeV2Args
    ///         {
    ///             Mode = "proxy",
    ///             Port = 3000,
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile example '&lt;account_id&gt;'
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile")]
    public partial class ZeroTrustDeviceDefaultProfile : global::Pulumi.CustomResource
    {
        ...
        public ZeroTrustDeviceDefaultProfile(string name, ZeroTrustDeviceDefaultProfileArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile", name, args ?? new ZeroTrustDeviceDefaultProfileArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZeroTrustDeviceDefaultProfile(string name, Input<string> id, ZeroTrustDeviceDefaultProfileState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile" },
                },
            };
