...
namespace Pulumi.Cloudflare.Modules.CallsTurn
{
    public static class GetApp
    {
        ...
        public static Task<GetAppResult> InvokeAsync(GetAppArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppResult>("cloudflare:callsTurn/app:getApp", args ?? new GetAppArgs(), options.WithDefaults());
        ...
        public static Output<GetAppResult> Invoke(GetAppInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAppResult>("cloudflare:callsTurn/app:getApp", args ?? new GetAppInvokeArgs(), options.WithDefaults());
