...
namespace Pulumi.Cloudflare.Modules.NotificationPolicyWebhooks
{
    public static class GetNotificationPolicyWebhooks
    {
        ...
        public static Task<GetNotificationPolicyWebhooksResult> InvokeAsync(GetNotificationPolicyWebhooksArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNotificationPolicyWebhooksResult>("cloudflare:notificationPolicyWebhooks/notificationPolicyWebhooks:getNotificationPolicyWebhooks", args ?? new GetNotificationPolicyWebhooksArgs(), options.WithDefaults());
        ...
        public static Output<GetNotificationPolicyWebhooksResult> Invoke(GetNotificationPolicyWebhooksInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNotificationPolicyWebhooksResult>("cloudflare:notificationPolicyWebhooks/notificationPolicyWebhooks:getNotificationPolicyWebhooks", args ?? new GetNotificationPolicyWebhooksInvokeArgs(), options.WithDefaults());
