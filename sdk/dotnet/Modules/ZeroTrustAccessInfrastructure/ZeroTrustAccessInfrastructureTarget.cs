...
namespace Pulumi.Cloudflare.Modules.ZeroTrustAccessInfrastructure
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zeroTrustAccessInfrastructure/target:Target")]
    public partial class ZeroTrustAccessInfrastructureTarget : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("ip")]
        public Output<Outputs.TargetIp> Ip { get; private set; } = null!;
        ...
        public ZeroTrustAccessInfrastructureTarget(string name, ZeroTrustAccessInfrastructureTargetArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustAccessInfrastructure/target:Target", name, args ?? new ZeroTrustAccessInfrastructureTargetArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZeroTrustAccessInfrastructureTarget(string name, Input<string> id, ZeroTrustAccessInfrastructureTargetState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustAccessInfrastructure/target:Target", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zeroTrustAccessInfrastructureTarget:ZeroTrustAccessInfrastructureTarget" },
                },
            };
    ...
    public sealed class ZeroTrustAccessInfrastructureTargetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.TargetIpArgs> Ip { get; set; } = null!;
    ...
    public sealed class ZeroTrustAccessInfrastructureTargetState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("ip")]
        public Input<Inputs.TargetIpGetArgs>? Ip { get; set; }
