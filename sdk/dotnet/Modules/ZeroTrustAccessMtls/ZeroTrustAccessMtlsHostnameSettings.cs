...
namespace Pulumi.Cloudflare.Modules.ZeroTrustAccessMtls
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:zeroTrustAccessMtls/hostnameSettings:HostnameSettings")]
    public partial class ZeroTrustAccessMtlsHostnameSettings : global::Pulumi.CustomResource
    {
        ...
        [Output("settings")]
        public Output<ImmutableArray<Outputs.HostnameSettingsSetting>> Settings { get; private set; } = null!;
        ...
        public ZeroTrustAccessMtlsHostnameSettings(string name, ZeroTrustAccessMtlsHostnameSettingsArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustAccessMtls/hostnameSettings:HostnameSettings", name, args ?? new ZeroTrustAccessMtlsHostnameSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZeroTrustAccessMtlsHostnameSettings(string name, Input<string> id, ZeroTrustAccessMtlsHostnameSettingsState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustAccessMtls/hostnameSettings:HostnameSettings", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zeroTrustAccessMtlsHostnameSettings:ZeroTrustAccessMtlsHostnameSettings" },
    ...
    public sealed class ZeroTrustAccessMtlsHostnameSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.HostnameSettingsSettingArgs>? _settings;
        public InputList<Inputs.HostnameSettingsSettingArgs> Settings
        {
            get => _settings ?? (_settings = new InputList<Inputs.HostnameSettingsSettingArgs>());
            set => _settings = value;
        }
    ...
    public sealed class ZeroTrustAccessMtlsHostnameSettingsState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("settings")]
        private InputList<Inputs.HostnameSettingsSettingGetArgs>? _settings;
        public InputList<Inputs.HostnameSettingsSettingGetArgs> Settings
        {
            get => _settings ?? (_settings = new InputList<Inputs.HostnameSettingsSettingGetArgs>());
            set => _settings = value;
        }
