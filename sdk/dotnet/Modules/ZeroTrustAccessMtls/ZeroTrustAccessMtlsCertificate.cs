...
namespace Pulumi.Cloudflare.Modules.ZeroTrustAccessMtls
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zeroTrustAccessMtls/certificate:Certificate")]
    public partial class ZeroTrustAccessMtlsCertificate : global::Pulumi.CustomResource
    {
        ...
        public ZeroTrustAccessMtlsCertificate(string name, ZeroTrustAccessMtlsCertificateArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustAccessMtls/certificate:Certificate", name, args ?? new ZeroTrustAccessMtlsCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZeroTrustAccessMtlsCertificate(string name, Input<string> id, ZeroTrustAccessMtlsCertificateState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustAccessMtls/certificate:Certificate", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zeroTrustAccessMtlsCertificate:ZeroTrustAccessMtlsCertificate" },
