...
namespace Pulumi.Cloudflare.Modules.MagicTransitSite
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:magicTransitSite/magicTransitSite:MagicTransitSite")]
    public partial class MagicTransitSite : global::Pulumi.CustomResource
    {
        ...
        public MagicTransitSite(string name, MagicTransitSiteArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:magicTransitSite/magicTransitSite:MagicTransitSite", name, args ?? new MagicTransitSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MagicTransitSite(string name, Input<string> id, MagicTransitSiteState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:magicTransitSite/magicTransitSite:MagicTransitSite", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/magicTransitSite:MagicTransitSite" },
                },
            };
