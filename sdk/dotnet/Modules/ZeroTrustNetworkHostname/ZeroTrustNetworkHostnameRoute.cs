...
namespace Pulumi.Cloudflare.Modules.ZeroTrustNetworkHostname
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zeroTrustNetworkHostname/route:Route")]
    public partial class ZeroTrustNetworkHostnameRoute : global::Pulumi.CustomResource
    {
        ...
        public ZeroTrustNetworkHostnameRoute(string name, ZeroTrustNetworkHostnameRouteArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustNetworkHostname/route:Route", name, args ?? new ZeroTrustNetworkHostnameRouteArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZeroTrustNetworkHostnameRoute(string name, Input<string> id, ZeroTrustNetworkHostnameRouteState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustNetworkHostname/route:Route", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zeroTrustNetworkHostnameRoute:ZeroTrustNetworkHostnameRoute" },
                },
            };
