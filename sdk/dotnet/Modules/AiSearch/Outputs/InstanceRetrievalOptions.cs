...
namespace Pulumi.Cloudflare.Modules.AiSearch.Outputs
{
    ...
    [OutputType]
    public sealed class InstanceRetrievalOptions
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.InstanceRetrievalOptionsBoostBy> BoostBies;
        /// <summary>
        ...
        private InstanceRetrievalOptions(
            ImmutableArray<Outputs.InstanceRetrievalOptionsBoostBy> boostBies,
