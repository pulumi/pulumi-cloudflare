...
namespace Pulumi.Cloudflare.Modules.AiSearch.Outputs
{
    ...
    [OutputType]
    public sealed class GetInstanceRetrievalOptionsResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetInstanceRetrievalOptionsBoostByResult> BoostBies;
        /// <summary>
        ...
        [OutputConstructor]
        private GetInstanceRetrievalOptionsResult(
            ImmutableArray<Outputs.GetInstanceRetrievalOptionsBoostByResult> boostBies,
