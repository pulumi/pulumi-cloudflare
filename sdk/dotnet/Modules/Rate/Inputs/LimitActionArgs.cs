...
namespace Pulumi.Cloudflare.Modules.Rate.Inputs
{
    ...
    public sealed class LimitActionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("response")]
        public Input<Inputs.LimitActionResponseArgs>? Response { get; set; }
        ...
        public LimitActionArgs()
        {
        }
        public static new LimitActionArgs Empty => new LimitActionArgs();
    }
}
