...
namespace Pulumi.Cloudflare.Modules.Rate.Inputs
{
    ...
    public sealed class LimitActionGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("response")]
        public Input<Inputs.LimitActionResponseGetArgs>? Response { get; set; }
        ...
        public LimitActionGetArgs()
        {
        }
        public static new LimitActionGetArgs Empty => new LimitActionGetArgs();
    }
}
