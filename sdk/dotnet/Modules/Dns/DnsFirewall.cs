...
namespace Pulumi.Cloudflare.Modules.Dns
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:dns/firewall:Firewall")]
    public partial class DnsFirewall : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.FirewallAttackMitigation> AttackMitigation { get; private set; } = null!;
        ...
        public DnsFirewall(string name, DnsFirewallArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:dns/firewall:Firewall", name, args ?? new DnsFirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsFirewall(string name, Input<string> id, DnsFirewallState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:dns/firewall:Firewall", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/dnsFirewall:DnsFirewall" },
                },
            };
    ...
    public sealed class DnsFirewallArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.FirewallAttackMitigationArgs>? AttackMitigation { get; set; }
    ...
    public sealed class DnsFirewallState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("attackMitigation")]
        public Input<Inputs.FirewallAttackMitigationGetArgs>? AttackMitigation { get; set; }
