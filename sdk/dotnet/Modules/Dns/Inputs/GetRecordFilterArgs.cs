...
namespace Pulumi.Cloudflare.Modules.Dns.Inputs
{
    ...
    public sealed class GetRecordFilterInputArgs : global::Pulumi.ResourceArgs
    {
        [Input("comment")]
        public Input<Inputs.GetRecordFilterCommentInputArgs>? Comment { get; set; }

        [Input("content")]
        public Input<Inputs.GetRecordFilterContentInputArgs>? Content { get; set; }
        ...
        [Input("name")]
        public Input<Inputs.GetRecordFilterNameInputArgs>? Name { get; set; }
        ...
        [Input("tag")]
        public Input<Inputs.GetRecordFilterTagInputArgs>? Tag { get; set; }
        ...
        public GetRecordFilterInputArgs()
        {
        }
        public static new GetRecordFilterInputArgs Empty => new GetRecordFilterInputArgs();
    }
}
