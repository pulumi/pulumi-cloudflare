...
namespace Pulumi.Cloudflare.Modules.ZeroTrustTunnelCloudflared
{
    ...
    /// {
    ///     var exampleZeroTrustTunnelCloudflaredRoute = new Cloudflare.Modules.ZeroTrustTunnelCloudflared.ZeroTrustTunnelCloudflaredRoute("example_zero_trust_tunnel_cloudflared_route", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zeroTrustTunnelCloudflared/route:Route")]
    public partial class ZeroTrustTunnelCloudflaredRoute : global::Pulumi.CustomResource
    {
        ...
        public ZeroTrustTunnelCloudflaredRoute(string name, ZeroTrustTunnelCloudflaredRouteArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustTunnelCloudflared/route:Route", name, args ?? new ZeroTrustTunnelCloudflaredRouteArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZeroTrustTunnelCloudflaredRoute(string name, Input<string> id, ZeroTrustTunnelCloudflaredRouteState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustTunnelCloudflared/route:Route", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zeroTrustTunnelCloudflaredRoute:ZeroTrustTunnelCloudflaredRoute" },
