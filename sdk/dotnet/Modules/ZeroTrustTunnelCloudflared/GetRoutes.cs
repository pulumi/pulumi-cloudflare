...
namespace Pulumi.Cloudflare.Modules.ZeroTrustTunnelCloudflared
{
    public static class GetRoutes
    {
        ...
        public static Task<GetRoutesResult> InvokeAsync(GetRoutesArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRoutesResult>("cloudflare:zeroTrustTunnelCloudflared/routes:getRoutes", args ?? new GetRoutesArgs(), options.WithDefaults());
        ...
        public static Output<GetRoutesResult> Invoke(GetRoutesInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRoutesResult>("cloudflare:zeroTrustTunnelCloudflared/routes:getRoutes", args ?? new GetRoutesInvokeArgs(), options.WithDefaults());
