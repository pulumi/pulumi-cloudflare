...
namespace Pulumi.Cloudflare.Modules.Registrar
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:registrar/domain:Domain")]
    public partial class RegistrarDomain : global::Pulumi.CustomResource
    {
        ...
        public RegistrarDomain(string name, RegistrarDomainArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:registrar/domain:Domain", name, args ?? new RegistrarDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrarDomain(string name, Input<string> id, RegistrarDomainState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:registrar/domain:Domain", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/registrarDomain:RegistrarDomain" },
                },
            };
