...
namespace Pulumi.Cloudflare.Modules.LeakedCredentialCheck
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:leakedCredentialCheck/leakedCredentialCheck:LeakedCredentialCheck")]
    public partial class LeakedCredentialCheck : global::Pulumi.CustomResource
    {
        ...
        public LeakedCredentialCheck(string name, LeakedCredentialCheckArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:leakedCredentialCheck/leakedCredentialCheck:LeakedCredentialCheck", name, args ?? new LeakedCredentialCheckArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private LeakedCredentialCheck(string name, Input<string> id, LeakedCredentialCheckState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:leakedCredentialCheck/leakedCredentialCheck:LeakedCredentialCheck", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/leakedCredentialCheck:LeakedCredentialCheck" },
                },
            };
