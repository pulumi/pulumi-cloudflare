...
namespace Pulumi.Cloudflare.Modules.LeakedCredentialCheck
{
    public static class GetRules
    {
        ...
        public static Task<GetRulesResult> InvokeAsync(GetRulesArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRulesResult>("cloudflare:leakedCredentialCheck/rules:getRules", args ?? new GetRulesArgs(), options.WithDefaults());
        ...
        public static Output<GetRulesResult> Invoke(GetRulesInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRulesResult>("cloudflare:leakedCredentialCheck/rules:getRules", args ?? new GetRulesInvokeArgs(), options.WithDefaults());
