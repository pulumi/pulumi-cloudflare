...
namespace Pulumi.Cloudflare.Modules.Turnstile
{
    ...
    /// {
    ///     var exampleTurnstileWidget = new Cloudflare.Modules.Turnstile.TurnstileWidget("example_turnstile_widget", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:turnstile/widget:Widget")]
    public partial class TurnstileWidget : global::Pulumi.CustomResource
    {
        ...
        public TurnstileWidget(string name, TurnstileWidgetArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:turnstile/widget:Widget", name, args ?? new TurnstileWidgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TurnstileWidget(string name, Input<string> id, TurnstileWidgetState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:turnstile/widget:Widget", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/turnstileWidget:TurnstileWidget" },
                },
