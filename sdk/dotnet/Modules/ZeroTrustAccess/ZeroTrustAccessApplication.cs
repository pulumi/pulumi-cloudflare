...
namespace Pulumi.Cloudflare.Modules.ZeroTrustAccess
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zeroTrustAccess/application:Application")]
    public partial class ZeroTrustAccessApplication : global::Pulumi.CustomResource
    {
        ...
        [Output("corsHeaders")]
        public Output<Outputs.ApplicationCorsHeaders?> CorsHeaders { get; private set; } = null!;
        ...
        /// </summary>
        [Output("destinations")]
        public Output<ImmutableArray<Outputs.ApplicationDestination>> Destinations { get; private set; } = null!;
        ...
        /// </summary>
        [Output("footerLinks")]
        public Output<ImmutableArray<Outputs.ApplicationFooterLink>> FooterLinks { get; private set; } = null!;
        ...
        public Output<Outputs.ApplicationLandingPageDesign?> LandingPageDesign { get; private set; } = null!;
        ...
        /// </summary>
        [Output("mfaConfig")]
        public Output<Outputs.ApplicationMfaConfig?> MfaConfig { get; private set; } = null!;
        ...
        public Output<Outputs.ApplicationOauthConfiguration?> OauthConfiguration { get; private set; } = null!;
        ...
        /// </summary>
        [Output("policies")]
        public Output<ImmutableArray<Outputs.ApplicationPolicy>> Policies { get; private set; } = null!;
        ...
        [Output("saasApp")]
        public Output<Outputs.ApplicationSaasApp?> SaasApp { get; private set; } = null!;
        ...
        /// </summary>
        [Output("scimConfig")]
        public Output<Outputs.ApplicationScimConfig?> ScimConfig { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.ApplicationTargetCriteria>> TargetCriterias { get; private set; } = null!;
        ...
        public ZeroTrustAccessApplication(string name, ZeroTrustAccessApplicationArgs? args = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustAccess/application:Application", name, args ?? new ZeroTrustAccessApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZeroTrustAccessApplication(string name, Input<string> id, ZeroTrustAccessApplicationState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustAccess/application:Application", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zeroTrustAccessApplication:ZeroTrustAccessApplication" },
    ...
    public sealed class ZeroTrustAccessApplicationArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("corsHeaders")]
        public Input<Inputs.ApplicationCorsHeadersArgs>? CorsHeaders { get; set; }
        ...
        [Input("destinations")]
        private InputList<Inputs.ApplicationDestinationArgs>? _destinations;

        /// <summary>
        /// List of destinations secured by Access. This supersedes `SelfHostedDomains` to allow for more flexibility in defining different types of domains. If `Destinations` are provided, then `SelfHostedDomains` will be ignored.
        /// </summary>
        public InputList<Inputs.ApplicationDestinationArgs> Destinations
        {
            get => _destinations ?? (_destinations = new InputList<Inputs.ApplicationDestinationArgs>());
        ...
        [Input("footerLinks")]
        private InputList<Inputs.ApplicationFooterLinkArgs>? _footerLinks;

        /// <summary>
        /// The links in the App Launcher footer.
        /// </summary>
        public InputList<Inputs.ApplicationFooterLinkArgs> FooterLinks
        {
            get => _footerLinks ?? (_footerLinks = new InputList<Inputs.ApplicationFooterLinkArgs>());
        ...
        public Input<Inputs.ApplicationLandingPageDesignArgs>? LandingPageDesign { get; set; }
        ...
        /// </summary>
        [Input("mfaConfig")]
        public Input<Inputs.ApplicationMfaConfigArgs>? MfaConfig { get; set; }
        ...
        public Input<Inputs.ApplicationOauthConfigurationArgs>? OauthConfiguration { get; set; }
        ...
        [Input("saasApp")]
        public Input<Inputs.ApplicationSaasAppArgs>? SaasApp { get; set; }
        ...
        /// </summary>
        [Input("scimConfig")]
        public Input<Inputs.ApplicationScimConfigArgs>? ScimConfig { get; set; }
        ...
        private InputList<Inputs.ApplicationTargetCriteriaArgs>? _targetCriterias;
        public InputList<Inputs.ApplicationTargetCriteriaArgs> TargetCriterias
        {
            get => _targetCriterias ?? (_targetCriterias = new InputList<Inputs.ApplicationTargetCriteriaArgs>());
    ...
    public sealed class ZeroTrustAccessApplicationState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("corsHeaders")]
        public Input<Inputs.ApplicationCorsHeadersGetArgs>? CorsHeaders { get; set; }
        ...
        [Input("destinations")]
        private InputList<Inputs.ApplicationDestinationGetArgs>? _destinations;

        /// <summary>
        /// List of destinations secured by Access. This supersedes `SelfHostedDomains` to allow for more flexibility in defining different types of domains. If `Destinations` are provided, then `SelfHostedDomains` will be ignored.
        /// </summary>
        public InputList<Inputs.ApplicationDestinationGetArgs> Destinations
        {
            get => _destinations ?? (_destinations = new InputList<Inputs.ApplicationDestinationGetArgs>());
            set => _destinations = value;
        }
        ...
        [Input("footerLinks")]
        private InputList<Inputs.ApplicationFooterLinkGetArgs>? _footerLinks;

        /// <summary>
        /// The links in the App Launcher footer.
        /// </summary>
        public InputList<Inputs.ApplicationFooterLinkGetArgs> FooterLinks
        {
            get => _footerLinks ?? (_footerLinks = new InputList<Inputs.ApplicationFooterLinkGetArgs>());
            set => _footerLinks = value;
        }
        ...
        /// </summary>
        [Input("landingPageDesign")]
        public Input<Inputs.ApplicationLandingPageDesignGetArgs>? LandingPageDesign { get; set; }
        ...
        /// </summary>
        [Input("mfaConfig")]
        public Input<Inputs.ApplicationMfaConfigGetArgs>? MfaConfig { get; set; }
        ...
        /// </summary>
        [Input("oauthConfiguration")]
        public Input<Inputs.ApplicationOauthConfigurationGetArgs>? OauthConfiguration { get; set; }
        ...
        [Input("policies")]
        private InputList<Inputs.ApplicationPolicyGetArgs>? _policies;

        /// <summary>
        /// The policies that Access applies to the application, in ascending order of precedence. Items can reference existing policies or create new policies exclusive to the application.
        /// </summary>
        public InputList<Inputs.ApplicationPolicyGetArgs> Policies
        {
            get => _policies ?? (_policies = new InputList<Inputs.ApplicationPolicyGetArgs>());
            set => _policies = value;
        }
        ...
        [Input("saasApp")]
        public Input<Inputs.ApplicationSaasAppGetArgs>? SaasApp { get; set; }
        ...
        /// </summary>
        [Input("scimConfig")]
        public Input<Inputs.ApplicationScimConfigGetArgs>? ScimConfig { get; set; }
        ...
        [Input("targetCriterias")]
        private InputList<Inputs.ApplicationTargetCriteriaGetArgs>? _targetCriterias;
        public InputList<Inputs.ApplicationTargetCriteriaGetArgs> TargetCriterias
        {
            get => _targetCriterias ?? (_targetCriterias = new InputList<Inputs.ApplicationTargetCriteriaGetArgs>());
            set => _targetCriterias = value;
        }
