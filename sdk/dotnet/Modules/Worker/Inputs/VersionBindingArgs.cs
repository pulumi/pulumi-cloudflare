...
namespace Pulumi.Cloudflare.Modules.Worker.Inputs
{
    ...
    public sealed class VersionBindingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("outbound")]
        public Input<Inputs.VersionBindingOutboundArgs>? Outbound { get; set; }
        ...
        /// </summary>
        [Input("simple")]
        public Input<Inputs.VersionBindingSimpleArgs>? Simple { get; set; }
        ...
        public VersionBindingArgs()
        {
        }
        public static new VersionBindingArgs Empty => new VersionBindingArgs();
    }
}
