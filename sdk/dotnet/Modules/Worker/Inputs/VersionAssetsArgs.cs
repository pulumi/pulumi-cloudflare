...
namespace Pulumi.Cloudflare.Modules.Worker.Inputs
{
    ...
    public sealed class VersionAssetsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("config")]
        public Input<Inputs.VersionAssetsConfigArgs>? Config { get; set; }
        ...
        public VersionAssetsArgs()
        {
        }
        public static new VersionAssetsArgs Empty => new VersionAssetsArgs();
    }
}
