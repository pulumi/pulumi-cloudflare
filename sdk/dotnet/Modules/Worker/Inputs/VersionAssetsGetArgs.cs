...
namespace Pulumi.Cloudflare.Modules.Worker.Inputs
{
    ...
    public sealed class VersionAssetsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("config")]
        public Input<Inputs.VersionAssetsConfigGetArgs>? Config { get; set; }
        ...
        public VersionAssetsGetArgs()
        {
        }
        public static new VersionAssetsGetArgs Empty => new VersionAssetsGetArgs();
    }
}
