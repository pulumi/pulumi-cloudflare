...
namespace Pulumi.Cloudflare.Modules.Worker
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:worker/worker:Worker")]
    public partial class Worker : global::Pulumi.CustomResource
    {
        ...
        public Worker(string name, WorkerArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:worker/worker:Worker", name, args ?? new WorkerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Worker(string name, Input<string> id, WorkerState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:worker/worker:Worker", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/worker:Worker" },
                },
            };
