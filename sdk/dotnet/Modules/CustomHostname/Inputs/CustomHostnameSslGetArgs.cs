...
namespace Pulumi.Cloudflare.Modules.CustomHostname.Inputs
{
    ...
    public sealed class CustomHostnameSslGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Inputs.CustomHostnameSslCustomCertBundleGetArgs> CustomCertBundles
        {
            get => _customCertBundles ?? (_customCertBundles = new InputList<Inputs.CustomHostnameSslCustomCertBundleGetArgs>());
