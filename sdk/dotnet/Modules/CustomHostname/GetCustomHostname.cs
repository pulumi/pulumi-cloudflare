...
namespace Pulumi.Cloudflare.Modules.CustomHostname
{
    public static class GetCustomHostname
    {
        ...
        public static Task<GetCustomHostnameResult> InvokeAsync(GetCustomHostnameArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCustomHostnameResult>("cloudflare:customHostname/customHostname:getCustomHostname", args ?? new GetCustomHostnameArgs(), options.WithDefaults());
        ...
        public static Output<GetCustomHostnameResult> Invoke(GetCustomHostnameInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCustomHostnameResult>("cloudflare:customHostname/customHostname:getCustomHostname", args ?? new GetCustomHostnameInvokeArgs(), options.WithDefaults());
