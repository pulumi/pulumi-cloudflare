...
namespace Pulumi.Cloudflare.Modules.List
{
    public static class GetList
    {
        ...
        public static Task<GetListResult> InvokeAsync(GetListArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetListResult>("cloudflare:list/list:getList", args ?? new GetListArgs(), options.WithDefaults());
        ...
        public static Output<GetListResult> Invoke(GetListInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetListResult>("cloudflare:list/list:getList", args ?? new GetListInvokeArgs(), options.WithDefaults());
