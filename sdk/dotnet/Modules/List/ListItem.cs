...
namespace Pulumi.Cloudflare.Modules.List
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:list/item:Item")]
    public partial class ListItem : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("hostname")]
        public Output<Outputs.ItemHostname?> Hostname { get; private set; } = null!;
        ...
        /// </summary>
        [Output("redirect")]
        public Output<Outputs.ItemRedirect?> Redirect { get; private set; } = null!;
        ...
        public ListItem(string name, ListItemArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:list/item:Item", name, args ?? new ListItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ListItem(string name, Input<string> id, ListItemState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:list/item:Item", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/listItem:ListItem" },
                },
            };
    ...
    public sealed class ListItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("hostname")]
        public Input<Inputs.ItemHostnameArgs>? Hostname { get; set; }
        ...
        /// </summary>
        [Input("redirect")]
        public Input<Inputs.ItemRedirectArgs>? Redirect { get; set; }
    ...
    public sealed class ListItemState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("hostname")]
        public Input<Inputs.ItemHostnameGetArgs>? Hostname { get; set; }
        ...
        /// </summary>
        [Input("redirect")]
        public Input<Inputs.ItemRedirectGetArgs>? Redirect { get; set; }
