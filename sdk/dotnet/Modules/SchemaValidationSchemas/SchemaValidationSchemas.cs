...
namespace Pulumi.Cloudflare.Modules.SchemaValidationSchemas
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:schemaValidationSchemas/schemaValidationSchemas:SchemaValidationSchemas")]
    public partial class SchemaValidationSchemas : global::Pulumi.CustomResource
    {
        ...
        public SchemaValidationSchemas(string name, SchemaValidationSchemasArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:schemaValidationSchemas/schemaValidationSchemas:SchemaValidationSchemas", name, args ?? new SchemaValidationSchemasArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private SchemaValidationSchemas(string name, Input<string> id, SchemaValidationSchemasState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:schemaValidationSchemas/schemaValidationSchemas:SchemaValidationSchemas", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/schemaValidationSchemas:SchemaValidationSchemas" },
                },
            };
