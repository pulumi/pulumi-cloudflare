...
namespace Pulumi.Cloudflare.Modules.ApiShield
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:apiShield/apiShield:ApiShield")]
    public partial class ApiShield : global::Pulumi.CustomResource
    {
        ...
        public ApiShield(string name, ApiShieldArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:apiShield/apiShield:ApiShield", name, args ?? new ApiShieldArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiShield(string name, Input<string> id, ApiShieldState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:apiShield/apiShield:ApiShield", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/apiShield:ApiShield" },
                },
            };
