...
namespace Pulumi.Cloudflare.Modules.ZeroTrustGatewayProxy
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zeroTrustGatewayProxy/endpoint:Endpoint")]
    public partial class ZeroTrustGatewayProxyEndpoint : global::Pulumi.CustomResource
    {
        ...
        public ZeroTrustGatewayProxyEndpoint(string name, ZeroTrustGatewayProxyEndpointArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustGatewayProxy/endpoint:Endpoint", name, args ?? new ZeroTrustGatewayProxyEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZeroTrustGatewayProxyEndpoint(string name, Input<string> id, ZeroTrustGatewayProxyEndpointState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustGatewayProxy/endpoint:Endpoint", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zeroTrustGatewayProxyEndpoint:ZeroTrustGatewayProxyEndpoint" },
