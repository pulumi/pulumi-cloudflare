...
namespace Pulumi.Cloudflare.Modules.DnsZoneTransfers
{
    ...
    /// {
    ///     var exampleDnsZoneTransfersTsig = new Cloudflare.Modules.DnsZoneTransfers.DnsZoneTransfersTsig("example_dns_zone_transfers_tsig", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:dnsZoneTransfers/tsig:Tsig")]
    public partial class DnsZoneTransfersTsig : global::Pulumi.CustomResource
    {
        ...
        public DnsZoneTransfersTsig(string name, DnsZoneTransfersTsigArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:dnsZoneTransfers/tsig:Tsig", name, args ?? new DnsZoneTransfersTsigArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private DnsZoneTransfersTsig(string name, Input<string> id, DnsZoneTransfersTsigState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:dnsZoneTransfers/tsig:Tsig", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/dnsZoneTransfersTsig:DnsZoneTransfersTsig" },
                },
