...
namespace Pulumi.Cloudflare.Modules.DnsZoneTransfers
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:dnsZoneTransfers/incoming:Incoming")]
    public partial class DnsZoneTransfersIncoming : global::Pulumi.CustomResource
    {
        ...
        public DnsZoneTransfersIncoming(string name, DnsZoneTransfersIncomingArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:dnsZoneTransfers/incoming:Incoming", name, args ?? new DnsZoneTransfersIncomingArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private DnsZoneTransfersIncoming(string name, Input<string> id, DnsZoneTransfersIncomingState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:dnsZoneTransfers/incoming:Incoming", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/dnsZoneTransfersIncoming:DnsZoneTransfersIncoming" },
                },
            };
