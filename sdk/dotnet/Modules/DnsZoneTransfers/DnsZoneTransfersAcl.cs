...
namespace Pulumi.Cloudflare.Modules.DnsZoneTransfers
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:dnsZoneTransfers/acl:Acl")]
    public partial class DnsZoneTransfersAcl : global::Pulumi.CustomResource
    {
        ...
        public DnsZoneTransfersAcl(string name, DnsZoneTransfersAclArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:dnsZoneTransfers/acl:Acl", name, args ?? new DnsZoneTransfersAclArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private DnsZoneTransfersAcl(string name, Input<string> id, DnsZoneTransfersAclState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:dnsZoneTransfers/acl:Acl", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/dnsZoneTransfersAcl:DnsZoneTransfersAcl" },
                },
            };
