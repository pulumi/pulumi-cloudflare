...
namespace Pulumi.Cloudflare.Modules.Flagship
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:flagship/flag:Flag")]
    public partial class FlagshipFlag : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("rules")]
        public Output<ImmutableArray<Outputs.FlagRule>> Rules { get; private set; } = null!;
        ...
        public FlagshipFlag(string name, FlagshipFlagArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:flagship/flag:Flag", name, args ?? new FlagshipFlagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FlagshipFlag(string name, Input<string> id, FlagshipFlagState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:flagship/flag:Flag", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/flagshipFlag:FlagshipFlag" },
                },
            };
    ...
    public sealed class FlagshipFlagArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.FlagRuleArgs>? _rules;

        /// <summary>
        /// Targeting rules evaluated in ascending `Priority`; the first matching rule wins. An empty array means the flag always serves `DefaultVariation`.
        /// </summary>
        public InputList<Inputs.FlagRuleArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.FlagRuleArgs>());
            set => _rules = value;
        }
    ...
    public sealed class FlagshipFlagState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("rules")]
        private InputList<Inputs.FlagRuleGetArgs>? _rules;

        /// <summary>
        /// Targeting rules evaluated in ascending `Priority`; the first matching rule wins. An empty array means the flag always serves `DefaultVariation`.
        /// </summary>
        public InputList<Inputs.FlagRuleGetArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.FlagRuleGetArgs>());
            set => _rules = value;
        }
