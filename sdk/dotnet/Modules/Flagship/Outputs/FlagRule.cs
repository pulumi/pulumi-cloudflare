...
namespace Pulumi.Cloudflare.Modules.Flagship.Outputs
{
    ...
    public sealed class FlagRule
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.FlagRuleCondition> Conditions;
        /// <summary>
        /// Evaluation order; lower numbers are evaluated first. Must be unique across the flag's rules.
        /// </summary>
        public readonly int Priority;
        public readonly Outputs.FlagRuleRollout? Rollout;
        /// <summary>
        ...
        [OutputConstructor]
        private FlagRule(
            ImmutableArray<Outputs.FlagRuleCondition> conditions,

            int priority,

            Outputs.FlagRuleRollout? rollout,
