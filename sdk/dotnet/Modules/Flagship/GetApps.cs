...
namespace Pulumi.Cloudflare.Modules.Flagship
{
    public static class GetApps
    {
        ...
        public static Task<GetAppsResult> InvokeAsync(GetAppsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppsResult>("cloudflare:flagship/apps:getApps", args ?? new GetAppsArgs(), options.WithDefaults());
        ...
        public static Output<GetAppsResult> Invoke(GetAppsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAppsResult>("cloudflare:flagship/apps:getApps", args ?? new GetAppsInvokeArgs(), options.WithDefaults());
