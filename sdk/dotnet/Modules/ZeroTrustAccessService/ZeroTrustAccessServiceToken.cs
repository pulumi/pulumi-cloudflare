...
namespace Pulumi.Cloudflare.Modules.ZeroTrustAccessService
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zeroTrustAccessService/token:Token")]
    public partial class ZeroTrustAccessServiceToken : global::Pulumi.CustomResource
    {
        ...
        public ZeroTrustAccessServiceToken(string name, ZeroTrustAccessServiceTokenArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustAccessService/token:Token", name, args ?? new ZeroTrustAccessServiceTokenArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZeroTrustAccessServiceToken(string name, Input<string> id, ZeroTrustAccessServiceTokenState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustAccessService/token:Token", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zeroTrustAccessServiceToken:ZeroTrustAccessServiceToken" },
