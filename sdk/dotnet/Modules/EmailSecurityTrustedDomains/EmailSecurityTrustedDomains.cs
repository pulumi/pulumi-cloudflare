...
namespace Pulumi.Cloudflare.Modules.EmailSecurityTrustedDomains
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:emailSecurityTrustedDomains/emailSecurityTrustedDomains:EmailSecurityTrustedDomains")]
    public partial class EmailSecurityTrustedDomains : global::Pulumi.CustomResource
    {
        ...
        public EmailSecurityTrustedDomains(string name, EmailSecurityTrustedDomainsArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:emailSecurityTrustedDomains/emailSecurityTrustedDomains:EmailSecurityTrustedDomains", name, args ?? new EmailSecurityTrustedDomainsArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private EmailSecurityTrustedDomains(string name, Input<string> id, EmailSecurityTrustedDomainsState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:emailSecurityTrustedDomains/emailSecurityTrustedDomains:EmailSecurityTrustedDomains", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/emailSecurityTrustedDomains:EmailSecurityTrustedDomains" },
                },
            };
