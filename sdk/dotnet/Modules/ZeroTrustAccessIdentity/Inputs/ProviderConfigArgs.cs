...
namespace Pulumi.Cloudflare.Modules.ZeroTrustAccessIdentity.Inputs
{
    ...
    public sealed class ProviderConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.ProviderConfigHeaderAttributeArgs>? _headerAttributes;

        /// <summary>
        /// Add a list of attribute names that will be returned in the response header from the Access callback.
        /// </summary>
        public InputList<Inputs.ProviderConfigHeaderAttributeArgs> HeaderAttributes
        {
            get => _headerAttributes ?? (_headerAttributes = new InputList<Inputs.ProviderConfigHeaderAttributeArgs>());
