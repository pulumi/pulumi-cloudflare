...
namespace Pulumi.Cloudflare.Modules.ZeroTrustDeviceManagedNetworks
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zeroTrustDeviceManagedNetworks/zeroTrustDeviceManagedNetworks:ZeroTrustDeviceManagedNetworks")]
    public partial class ZeroTrustDeviceManagedNetworks : global::Pulumi.CustomResource
    {
        ...
        public ZeroTrustDeviceManagedNetworks(string name, ZeroTrustDeviceManagedNetworksArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustDeviceManagedNetworks/zeroTrustDeviceManagedNetworks:ZeroTrustDeviceManagedNetworks", name, args ?? new ZeroTrustDeviceManagedNetworksArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZeroTrustDeviceManagedNetworks(string name, Input<string> id, ZeroTrustDeviceManagedNetworksState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zeroTrustDeviceManagedNetworks/zeroTrustDeviceManagedNetworks:ZeroTrustDeviceManagedNetworks", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zeroTrustDeviceManagedNetworks:ZeroTrustDeviceManagedNetworks" },
