...
namespace Pulumi.Cloudflare.Modules.WebAnalytics
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:webAnalytics/rule:Rule")]
    public partial class WebAnalyticsRule : global::Pulumi.CustomResource
    {
        ...
        public WebAnalyticsRule(string name, WebAnalyticsRuleArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:webAnalytics/rule:Rule", name, args ?? new WebAnalyticsRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAnalyticsRule(string name, Input<string> id, WebAnalyticsRuleState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:webAnalytics/rule:Rule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/webAnalyticsRule:WebAnalyticsRule" },
                },
            };
