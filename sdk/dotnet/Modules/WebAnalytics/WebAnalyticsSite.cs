...
namespace Pulumi.Cloudflare.Modules.WebAnalytics
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:webAnalytics/site:Site")]
    public partial class WebAnalyticsSite : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("rules")]
        public Output<ImmutableArray<Outputs.SiteRule>> Rules { get; private set; } = null!;

        [Output("ruleset")]
        public Output<Outputs.SiteRuleset> Ruleset { get; private set; } = null!;
        ...
        public WebAnalyticsSite(string name, WebAnalyticsSiteArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:webAnalytics/site:Site", name, args ?? new WebAnalyticsSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAnalyticsSite(string name, Input<string> id, WebAnalyticsSiteState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:webAnalytics/site:Site", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/webAnalyticsSite:WebAnalyticsSite" },
                },
            };
    ...
    public sealed class WebAnalyticsSiteState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("rules")]
        private InputList<Inputs.SiteRuleGetArgs>? _rules;

        /// <summary>
        /// A list of rules.
        /// </summary>
        public InputList<Inputs.SiteRuleGetArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.SiteRuleGetArgs>());
            set => _rules = value;
        }

        [Input("ruleset")]
        public Input<Inputs.SiteRulesetGetArgs>? Ruleset { get; set; }
