...
namespace Pulumi.Cloudflare.Modules.ApiShieldSchema
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:apiShieldSchema/validationSettings:ValidationSettings")]
    public partial class ApiShieldSchemaValidationSettings : global::Pulumi.CustomResource
    {
        ...
        public ApiShieldSchemaValidationSettings(string name, ApiShieldSchemaValidationSettingsArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:apiShieldSchema/validationSettings:ValidationSettings", name, args ?? new ApiShieldSchemaValidationSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ApiShieldSchemaValidationSettings(string name, Input<string> id, ApiShieldSchemaValidationSettingsState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:apiShieldSchema/validationSettings:ValidationSettings", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/apiShieldSchemaValidationSettings:ApiShieldSchemaValidationSettings" },
                },
            };
