...
namespace Pulumi.Cloudflare.Modules.ApiShieldSchema
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:apiShieldSchema/apiShieldSchema:ApiShieldSchema")]
    public partial class ApiShieldSchema : global::Pulumi.CustomResource
    {
        ...
        public ApiShieldSchema(string name, ApiShieldSchemaArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:apiShieldSchema/apiShieldSchema:ApiShieldSchema", name, args ?? new ApiShieldSchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiShieldSchema(string name, Input<string> id, ApiShieldSchemaState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:apiShieldSchema/apiShieldSchema:ApiShieldSchema", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/apiShieldSchema:ApiShieldSchema" },
                },
            };
