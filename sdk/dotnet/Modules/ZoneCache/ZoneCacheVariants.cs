...
namespace Pulumi.Cloudflare.Modules.ZoneCache
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:zoneCache/variants:Variants")]
    public partial class ZoneCacheVariants : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("value")]
        public Output<Outputs.VariantsValue> Value { get; private set; } = null!;
        ...
        public ZoneCacheVariants(string name, ZoneCacheVariantsArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:zoneCache/variants:Variants", name, args ?? new ZoneCacheVariantsArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZoneCacheVariants(string name, Input<string> id, ZoneCacheVariantsState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:zoneCache/variants:Variants", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/zoneCacheVariants:ZoneCacheVariants" },
                },
            };
    ...
    public sealed class ZoneCacheVariantsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VariantsValueArgs> Value { get; set; } = null!;
    ...
    public sealed class ZoneCacheVariantsState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("value")]
        public Input<Inputs.VariantsValueGetArgs>? Value { get; set; }
