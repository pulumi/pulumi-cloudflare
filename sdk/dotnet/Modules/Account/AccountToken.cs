...
namespace Pulumi.Cloudflare.Modules.Account
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:account/token:Token")]
    public partial class AccountToken : global::Pulumi.CustomResource
    {
        ...
        [Output("condition")]
        public Output<Outputs.TokenCondition?> Condition { get; private set; } = null!;
        ...
        /// </summary>
        [Output("policies")]
        public Output<ImmutableArray<Outputs.TokenPolicy>> Policies { get; private set; } = null!;
        ...
        public AccountToken(string name, AccountTokenArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:account/token:Token", name, args ?? new AccountTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccountToken(string name, Input<string> id, AccountTokenState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:account/token:Token", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/accountToken:AccountToken" },
                },
    ...
    public sealed class AccountTokenArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("condition")]
        public Input<Inputs.TokenConditionArgs>? Condition { get; set; }
        ...
        private InputList<Inputs.TokenPolicyArgs>? _policies;

        /// <summary>
        /// Set of access policies assigned to the token.
        /// </summary>
        public InputList<Inputs.TokenPolicyArgs> Policies
        {
            get => _policies ?? (_policies = new InputList<Inputs.TokenPolicyArgs>());
            set => _policies = value;
        }
    ...
    public sealed class AccountTokenState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("condition")]
        public Input<Inputs.TokenConditionGetArgs>? Condition { get; set; }
        ...
        [Input("policies")]
        private InputList<Inputs.TokenPolicyGetArgs>? _policies;

        /// <summary>
        /// Set of access policies assigned to the token.
        /// </summary>
        public InputList<Inputs.TokenPolicyGetArgs> Policies
        {
            get => _policies ?? (_policies = new InputList<Inputs.TokenPolicyGetArgs>());
            set => _policies = value;
        }
