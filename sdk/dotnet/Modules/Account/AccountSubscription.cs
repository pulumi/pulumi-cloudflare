...
namespace Pulumi.Cloudflare.Modules.Account
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:account/subscription:Subscription")]
    public partial class AccountSubscription : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("ratePlan")]
        public Output<Outputs.SubscriptionRatePlan> RatePlan { get; private set; } = null!;
        ...
        public AccountSubscription(string name, AccountSubscriptionArgs? args = null, CustomResourceOptions? options = null)
            : base("cloudflare:account/subscription:Subscription", name, args ?? new AccountSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AccountSubscription(string name, Input<string> id, AccountSubscriptionState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:account/subscription:Subscription", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/accountSubscription:AccountSubscription" },
                },
            };
    ...
    public sealed class AccountSubscriptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("ratePlan")]
        public Input<Inputs.SubscriptionRatePlanArgs>? RatePlan { get; set; }
    ...
    public sealed class AccountSubscriptionState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("ratePlan")]
        public Input<Inputs.SubscriptionRatePlanGetArgs>? RatePlan { get; set; }
