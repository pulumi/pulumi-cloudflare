...
namespace Pulumi.Cloudflare.Modules.Account
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:account/dnsSettings:DnsSettings")]
    public partial class AccountDnsSettings : global::Pulumi.CustomResource
    {
        ...
        public AccountDnsSettings(string name, AccountDnsSettingsArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:account/dnsSettings:DnsSettings", name, args ?? new AccountDnsSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AccountDnsSettings(string name, Input<string> id, AccountDnsSettingsState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:account/dnsSettings:DnsSettings", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/accountDnsSettings:AccountDnsSettings" },
                },
            };
