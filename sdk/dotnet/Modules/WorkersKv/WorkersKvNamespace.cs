...
namespace Pulumi.Cloudflare.Modules.WorkersKv
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:workersKv/namespace:Namespace")]
    public partial class WorkersKvNamespace : global::Pulumi.CustomResource
    {
        ...
        public WorkersKvNamespace(string name, WorkersKvNamespaceArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:workersKv/namespace:Namespace", name, args ?? new WorkersKvNamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private WorkersKvNamespace(string name, Input<string> id, WorkersKvNamespaceState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:workersKv/namespace:Namespace", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/workersKvNamespace:WorkersKvNamespace" },
                },
            };
