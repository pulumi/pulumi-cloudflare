...
namespace Pulumi.Cloudflare.Modules.WorkersKv
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:workersKv/workersKv:WorkersKv")]
    public partial class WorkersKv : global::Pulumi.CustomResource
    {
        ...
        public WorkersKv(string name, WorkersKvArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:workersKv/workersKv:WorkersKv", name, args ?? new WorkersKvArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkersKv(string name, Input<string> id, WorkersKvState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:workersKv/workersKv:WorkersKv", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/workersKv:WorkersKv" },
                },
            };
