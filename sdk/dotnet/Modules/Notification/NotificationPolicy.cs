...
namespace Pulumi.Cloudflare.Modules.Notification
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:notification/policy:Policy")]
    public partial class NotificationPolicy : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("filters")]
        public Output<Outputs.PolicyFilters?> Filters { get; private set; } = null!;

        /// <summary>
        /// List of IDs that will be used when dispatching a notification. IDs for email type will be the email address.
        /// </summary>
        [Output("mechanisms")]
        public Output<Outputs.PolicyMechanisms> Mechanisms { get; private set; } = null!;
        ...
        public NotificationPolicy(string name, NotificationPolicyArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:notification/policy:Policy", name, args ?? new NotificationPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private NotificationPolicy(string name, Input<string> id, NotificationPolicyState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:notification/policy:Policy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/notificationPolicy:NotificationPolicy" },
                },
            };
    ...
    public sealed class NotificationPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("filters")]
        public Input<Inputs.PolicyFiltersArgs>? Filters { get; set; }

        /// <summary>
        /// List of IDs that will be used when dispatching a notification. IDs for email type will be the email address.
        /// </summary>
        [Input("mechanisms", required: true)]
        public Input<Inputs.PolicyMechanismsArgs> Mechanisms { get; set; } = null!;
    ...
    public sealed class NotificationPolicyState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("filters")]
        public Input<Inputs.PolicyFiltersGetArgs>? Filters { get; set; }

        /// <summary>
        /// List of IDs that will be used when dispatching a notification. IDs for email type will be the email address.
        /// </summary>
        [Input("mechanisms")]
        public Input<Inputs.PolicyMechanismsGetArgs>? Mechanisms { get; set; }
