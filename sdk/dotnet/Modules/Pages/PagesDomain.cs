...
namespace Pulumi.Cloudflare.Modules.Pages
{
    ...
    /// {
    ///     var examplePagesDomain = new Cloudflare.Modules.Pages.PagesDomain("example_pages_domain", new()
    ///     {
    ...
    public partial class PagesDomain : global::Pulumi.CustomResource
    {
        ...
        public PagesDomain(string name, PagesDomainArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:pages/domain:Domain", name, args ?? new PagesDomainArgs(), MakeResourceOptions(options, ""))
        {
        }
