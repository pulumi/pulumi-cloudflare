...
namespace Pulumi.Cloudflare.Modules.Snippet
{
    public static class GetSnippet
    {
        ...
        public static Task<GetSnippetResult> InvokeAsync(GetSnippetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSnippetResult>("cloudflare:snippet/snippet:getSnippet", args ?? new GetSnippetArgs(), options.WithDefaults());
        ...
        public static Output<GetSnippetResult> Invoke(GetSnippetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSnippetResult>("cloudflare:snippet/snippet:getSnippet", args ?? new GetSnippetInvokeArgs(), options.WithDefaults());
