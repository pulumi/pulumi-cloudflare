...
namespace Pulumi.Cloudflare.Modules.Snippet
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:snippet/snippet:Snippet")]
    public partial class Snippet : global::Pulumi.CustomResource
    {
        ...
        public Snippet(string name, SnippetArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:snippet/snippet:Snippet", name, args ?? new SnippetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snippet(string name, Input<string> id, SnippetState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:snippet/snippet:Snippet", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/snippet:Snippet" },
                },
            };
