...
namespace Pulumi.Cloudflare.Modules.UserAgentBlocking
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:userAgentBlocking/rule:Rule")]
    public partial class UserAgentBlockingRule : global::Pulumi.CustomResource
    {
        [Output("configuration")]
        public Output<Outputs.RuleConfiguration> Configuration { get; private set; } = null!;
        ...
        public UserAgentBlockingRule(string name, UserAgentBlockingRuleArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:userAgentBlocking/rule:Rule", name, args ?? new UserAgentBlockingRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private UserAgentBlockingRule(string name, Input<string> id, UserAgentBlockingRuleState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:userAgentBlocking/rule:Rule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/userAgentBlockingRule:UserAgentBlockingRule" },
                },
            };
    ...
    public sealed class UserAgentBlockingRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RuleConfigurationArgs> Configuration { get; set; } = null!;
    ...
    {
        [Input("configuration")]
        public Input<Inputs.RuleConfigurationGetArgs>? Configuration { get; set; }
