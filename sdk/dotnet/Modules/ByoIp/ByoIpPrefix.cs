...
namespace Pulumi.Cloudflare.Modules.ByoIp
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:byoIp/prefix:Prefix")]
    public partial class ByoIpPrefix : global::Pulumi.CustomResource
    {
        ...
        public ByoIpPrefix(string name, ByoIpPrefixArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:byoIp/prefix:Prefix", name, args ?? new ByoIpPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ByoIpPrefix(string name, Input<string> id, ByoIpPrefixState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:byoIp/prefix:Prefix", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/byoIpPrefix:ByoIpPrefix" },
                },
            };
