...
namespace Pulumi.Cloudflare.Modules.CustomPages
{
    public static class GetCustomPages
    {
        ...
        public static Task<GetCustomPagesResult> InvokeAsync(GetCustomPagesArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCustomPagesResult>("cloudflare:customPages/customPages:getCustomPages", args ?? new GetCustomPagesArgs(), options.WithDefaults());
        ...
        public static Output<GetCustomPagesResult> Invoke(GetCustomPagesInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCustomPagesResult>("cloudflare:customPages/customPages:getCustomPages", args ?? new GetCustomPagesInvokeArgs(), options.WithDefaults());
