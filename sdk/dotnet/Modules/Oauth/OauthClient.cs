...
namespace Pulumi.Cloudflare.Modules.Oauth
{
    ...
    /// </summary>
    [CloudflareResourceType("cloudflare:oauth/client:Client")]
    public partial class OauthClient : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.ClientClientUriVerification> ClientUriVerification { get; private set; } = null!;
        ...
        public OauthClient(string name, OauthClientArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:oauth/client:Client", name, args ?? new OauthClientArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OauthClient(string name, Input<string> id, OauthClientState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:oauth/client:Client", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/oauthClient:OauthClient" },
                },
    ...
    public sealed class OauthClientState : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ClientClientUriVerificationGetArgs>? ClientUriVerification { get; set; }
