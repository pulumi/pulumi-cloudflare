...
namespace Pulumi.Cloudflare.Modules.Custom
{
    ...
    /// ```
    /// </summary>
    [CloudflareResourceType("cloudflare:custom/ssl:Ssl")]
    public partial class CustomSsl : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.SslGeoRestrictions?> GeoRestrictions { get; private set; } = null!;
        ...
        public Output<Outputs.SslKeylessServer> KeylessServer { get; private set; } = null!;
        ...
        public CustomSsl(string name, CustomSslArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:custom/ssl:Ssl", name, args ?? new CustomSslArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomSsl(string name, Input<string> id, CustomSslState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:custom/ssl:Ssl", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "cloudflare:index/customSsl:CustomSsl" },
                },
    ...
    public sealed class CustomSslArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SslGeoRestrictionsArgs>? GeoRestrictions { get; set; }
    ...
    public sealed class CustomSslState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("geoRestrictions")]
        public Input<Inputs.SslGeoRestrictionsGetArgs>? GeoRestrictions { get; set; }
        ...
        [Input("keylessServer")]
        public Input<Inputs.SslKeylessServerGetArgs>? KeylessServer { get; set; }
