...
namespace Pulumi.Cloudflare.Inputs
{
    ...
    public sealed class WorkerScriptPlacementGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("targets")]
        private InputList<Inputs.WorkerScriptPlacementTargetGetArgs>? _targets;

        /// <summary>
        /// Array of placement targets (currently limited to single target).
        /// </summary>
        public InputList<Inputs.WorkerScriptPlacementTargetGetArgs> Targets
        {
            get => _targets ?? (_targets = new InputList<Inputs.WorkerScriptPlacementTargetGetArgs>());
            set => _targets = value;
        }
