...
namespace Pulumi.Cloudflare.Inputs
{
    ...
    public sealed class ZeroTrustAccessApplicationPolicyRequireArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ZeroTrustAccessApplicationPolicyRequireLinkedAppTokenArgs>? LinkedAppToken { get; set; }

        [Input("loginMethod")]
        public Input<Inputs.ZeroTrustAccessApplicationPolicyRequireLoginMethodArgs>? LoginMethod { get; set; }

        [Input("oidc")]
        public Input<Inputs.ZeroTrustAccessApplicationPolicyRequireOidcArgs>? Oidc { get; set; }
