...
namespace Pulumi.Cloudflare.Inputs
{
    ...
    public sealed class AccessApplicationScimConfigGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("mappings")]
        private InputList<Inputs.AccessApplicationScimConfigMappingGetArgs>? _mappings;

        /// <summary>
        /// A list of mappings to apply to SCIM resources before provisioning them in this application. These can transform or filter the resources to be provisioned.
        /// </summary>
        public InputList<Inputs.AccessApplicationScimConfigMappingGetArgs> Mappings
        {
            get => _mappings ?? (_mappings = new InputList<Inputs.AccessApplicationScimConfigMappingGetArgs>());
            set => _mappings = value;
        }
        ...
        public AccessApplicationScimConfigGetArgs()
        {
        }
        public static new AccessApplicationScimConfigGetArgs Empty => new AccessApplicationScimConfigGetArgs();
    }
}
