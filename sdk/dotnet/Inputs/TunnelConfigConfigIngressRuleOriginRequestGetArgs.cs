...
namespace Pulumi.Cloudflare.Inputs
{
    ...
    public sealed class TunnelConfigConfigIngressRuleOriginRequestGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("access")]
        public Input<Inputs.TunnelConfigConfigIngressRuleOriginRequestAccessGetArgs>? Access { get; set; }
        ...
        [Input("ipRules")]
        private InputList<Inputs.TunnelConfigConfigIngressRuleOriginRequestIpRuleGetArgs>? _ipRules;
        public InputList<Inputs.TunnelConfigConfigIngressRuleOriginRequestIpRuleGetArgs> IpRules
        {
            get => _ipRules ?? (_ipRules = new InputList<Inputs.TunnelConfigConfigIngressRuleOriginRequestIpRuleGetArgs>());
            set => _ipRules = value;
        }
        ...
        public TunnelConfigConfigIngressRuleOriginRequestGetArgs()
        {
        }
        public static new TunnelConfigConfigIngressRuleOriginRequestGetArgs Empty => new TunnelConfigConfigIngressRuleOriginRequestGetArgs();
    }
}
