...
{
    [Obsolete(@"cloudflare:index/getSpectrumApplication:getSpectrumApplication has been deprecated in favor of cloudflare:spectrum/application:getApplication")]
