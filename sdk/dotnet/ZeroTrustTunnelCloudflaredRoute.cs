...
namespace Pulumi.Cloudflare
{
    ...
    /// ```
    /// </summary>
    [Obsolete(@"cloudflare:index/zeroTrustTunnelCloudflaredRoute:ZeroTrustTunnelCloudflaredRoute has been deprecated in favor of cloudflare:zeroTrustTunnelCloudflared/route:Route")]
