...
namespace Pulumi.Cloudflare
{
    public static class GetWafPackages
    {
        ...
        public static Output<GetWafPackagesResult> Invoke(GetWafPackagesInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWafPackagesResult>("cloudflare:index/getWafPackages:getWafPackages", args ?? new GetWafPackagesInvokeArgs(), options.WithVersion());
    }
