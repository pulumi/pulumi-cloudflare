...
namespace Pulumi.Cloudflare
{
    ...
    public partial class AccessKeysConfiguration : global::Pulumi.CustomResource
    {
        ...
        public AccessKeysConfiguration(string name, AccessKeysConfigurationArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:index/accessKeysConfiguration:AccessKeysConfiguration", name, args ?? new AccessKeysConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessKeysConfiguration(string name, Input<string> id, AccessKeysConfigurationState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:index/accessKeysConfiguration:AccessKeysConfiguration", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AccessKeysConfiguration Get(string name, Input<string> id, AccessKeysConfigurationState? state = null, CustomResourceOptions? options = null)
        {
