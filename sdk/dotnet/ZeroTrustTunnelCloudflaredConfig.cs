...
namespace Pulumi.Cloudflare
{
    ...
    public partial class ZeroTrustTunnelCloudflaredConfig : global::Pulumi.CustomResource
    {
        ...
        public ZeroTrustTunnelCloudflaredConfig(string name, ZeroTrustTunnelCloudflaredConfigArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:index/zeroTrustTunnelCloudflaredConfig:ZeroTrustTunnelCloudflaredConfig", name, args ?? new ZeroTrustTunnelCloudflaredConfigArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ZeroTrustTunnelCloudflaredConfig(string name, Input<string> id, ZeroTrustTunnelCloudflaredConfigState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:index/zeroTrustTunnelCloudflaredConfig:ZeroTrustTunnelCloudflaredConfig", name, state, MakeResourceOptions(options, id))
        {
        }
