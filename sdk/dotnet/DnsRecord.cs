...
namespace Pulumi.Cloudflare
{
    ...
    public partial class DnsRecord : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("settings")]
        public Output<Outputs.DnsRecordSettings> Settings { get; private set; } = null!;
        ...
        public DnsRecord(string name, DnsRecordArgs args, CustomResourceOptions? options = null)
            : base("cloudflare:index/dnsRecord:DnsRecord", name, args ?? new DnsRecordArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsRecord(string name, Input<string> id, DnsRecordState? state = null, CustomResourceOptions? options = null)
            : base("cloudflare:index/dnsRecord:DnsRecord", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DnsRecordArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("settings")]
        public Input<Inputs.DnsRecordSettingsArgs>? Settings { get; set; }
    ...
    public sealed class DnsRecordState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("settings")]
        public Input<Inputs.DnsRecordSettingsGetArgs>? Settings { get; set; }
