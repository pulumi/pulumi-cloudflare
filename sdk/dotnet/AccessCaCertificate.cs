...
namespace Pulumi.Cloudflare
{
    ...
    /// ```
    /// </summary>
    [Obsolete(@"cloudflare.index/accesscacertificate.AccessCaCertificate has been deprecated in favor of cloudflare.index/zerotrustaccessshortlivedcertificate.ZeroTrustAccessShortLivedCertificate")]
