...
import com.pulumi.cloudflare.outputs.MagicWanIpsecTunnelIpsecTunnelHealthCheckTarget;
...
public final class MagicWanIpsecTunnelIpsecTunnelHealthCheck {
     ...
     * 
     */
    public Optional<MagicWanIpsecTunnelIpsecTunnelHealthCheckTarget> target() {
    ...
    public static Builder builder(MagicWanIpsecTunnelIpsecTunnelHealthCheck defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(MagicWanIpsecTunnelIpsecTunnelHealthCheck defaults) {
        ...
        @CustomType.Setter
        public Builder target(@Nullable MagicWanIpsecTunnelIpsecTunnelHealthCheckTarget target) {
        ...
        public MagicWanIpsecTunnelIpsecTunnelHealthCheck build() {
            final var _resultValue = new MagicWanIpsecTunnelIpsecTunnelHealthCheck();
