    ...
    public static final class Builder {
        ...
        public AccessGroupRequireSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("AccessGroupRequireSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("AccessGroupRequireSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("AccessGroupRequireSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
