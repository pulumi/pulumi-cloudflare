...
import com.pulumi.cloudflare.outputs.GetZeroTrustGatewayPoliciesResult;
...
public final class GetZeroTrustGatewayPoliciesInvokeResult {
    ...
    public static Builder builder(GetZeroTrustGatewayPoliciesInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder accountId(String accountId) {
            if (accountId == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustGatewayPoliciesInvokeResult", "accountId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustGatewayPoliciesInvokeResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder results(List<GetZeroTrustGatewayPoliciesResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustGatewayPoliciesInvokeResult", "results");
            }
