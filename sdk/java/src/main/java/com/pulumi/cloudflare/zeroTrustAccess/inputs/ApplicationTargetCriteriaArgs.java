...
public final class ApplicationTargetCriteriaArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationTargetCriteriaArgs Empty = new ApplicationTargetCriteriaArgs();
    ...
    private ApplicationTargetCriteriaArgs() {}

    private ApplicationTargetCriteriaArgs(ApplicationTargetCriteriaArgs $) {
        this.port = $.port;
    ...
    public static Builder builder(ApplicationTargetCriteriaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationTargetCriteriaArgs();
        }

        public Builder(ApplicationTargetCriteriaArgs defaults) {
            $ = new ApplicationTargetCriteriaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApplicationTargetCriteriaArgs build() {
            if ($.port == null) {
                throw new MissingRequiredPropertyException("ApplicationTargetCriteriaArgs", "port");
            }
            if ($.protocol == null) {
                throw new MissingRequiredPropertyException("ApplicationTargetCriteriaArgs", "protocol");
            }
            if ($.targetAttributes == null) {
                throw new MissingRequiredPropertyException("ApplicationTargetCriteriaArgs", "targetAttributes");
            }
            return $;
        }
    }
