...
public final class GetPagesDomainsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetPagesDomainsArgs() {}

    private GetPagesDomainsArgs(GetPagesDomainsArgs $) {
    ...
    public static Builder builder(GetPagesDomainsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPagesDomainsArgs();
        }

        public Builder(GetPagesDomainsArgs defaults) {
            $ = new GetPagesDomainsArgs(Objects.requireNonNull(defaults));
        }
