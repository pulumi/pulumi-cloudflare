...
public final class PagesProjectCanonicalDeploymentSourceConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final PagesProjectCanonicalDeploymentSourceConfigArgs Empty = new PagesProjectCanonicalDeploymentSourceConfigArgs();
    ...
    private PagesProjectCanonicalDeploymentSourceConfigArgs() {}

    private PagesProjectCanonicalDeploymentSourceConfigArgs(PagesProjectCanonicalDeploymentSourceConfigArgs $) {
    ...
    public static Builder builder(PagesProjectCanonicalDeploymentSourceConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PagesProjectCanonicalDeploymentSourceConfigArgs();
        }

        public Builder(PagesProjectCanonicalDeploymentSourceConfigArgs defaults) {
            $ = new PagesProjectCanonicalDeploymentSourceConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PagesProjectCanonicalDeploymentSourceConfigArgs build() {
            return $;
        }
    }
