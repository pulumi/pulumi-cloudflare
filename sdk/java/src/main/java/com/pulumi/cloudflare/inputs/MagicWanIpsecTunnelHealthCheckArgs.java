...
public final class MagicWanIpsecTunnelHealthCheckArgs extends com.pulumi.resources.ResourceArgs {

    public static final MagicWanIpsecTunnelHealthCheckArgs Empty = new MagicWanIpsecTunnelHealthCheckArgs();
     ...
     */
    @Import(name="target")
    private @Nullable Output<MagicWanIpsecTunnelHealthCheckTargetArgs> target;

    /**
     * @return The destination address in a request type health check. After the healthcheck is decapsulated at the customer end of the tunnel, the ICMP echo will be forwarded to this address. This field defaults to `customer_gre_endpoint address`. This field is ignored for bidirectional healthchecks as the interface*address (not assigned to the Cloudflare side of the tunnel) is used as the target. Must be in object form if the x-magic-new-hc-target header is set to true and string form if x-magic-new-hc-target is absent or set to false.
     * 
     */
    public Optional<Output<MagicWanIpsecTunnelHealthCheckTargetArgs>> target() {
    ...
    private MagicWanIpsecTunnelHealthCheckArgs() {}

    private MagicWanIpsecTunnelHealthCheckArgs(MagicWanIpsecTunnelHealthCheckArgs $) {
    ...
    public static Builder builder(MagicWanIpsecTunnelHealthCheckArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagicWanIpsecTunnelHealthCheckArgs();
        }

        public Builder(MagicWanIpsecTunnelHealthCheckArgs defaults) {
            $ = new MagicWanIpsecTunnelHealthCheckArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder target(@Nullable Output<MagicWanIpsecTunnelHealthCheckTargetArgs> target) {
            $.target = target;
            return this;
        }
         ...
         * 
         */
        public Builder target(MagicWanIpsecTunnelHealthCheckTargetArgs target) {
        ...
        public MagicWanIpsecTunnelHealthCheckArgs build() {
            return $;
        }
    }
