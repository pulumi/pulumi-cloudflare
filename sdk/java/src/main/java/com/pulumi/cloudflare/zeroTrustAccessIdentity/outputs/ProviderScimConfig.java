...
@CustomType
public final class ProviderScimConfig {
    /**
    ...
    public static Builder builder(ProviderScimConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean userDeprovision;
        public Builder() {}
        public Builder(ProviderScimConfig defaults) {
        ...
        public ProviderScimConfig build() {
            final var _resultValue = new ProviderScimConfig();
