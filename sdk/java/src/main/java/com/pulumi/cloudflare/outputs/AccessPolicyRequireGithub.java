...
public final class AccessPolicyRequireGithub {
    ...
    public static Builder builder(AccessPolicyRequireGithub defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> teams;
        public Builder() {}
        public Builder(AccessPolicyRequireGithub defaults) {
        ...
        public AccessPolicyRequireGithub build() {
            final var _resultValue = new AccessPolicyRequireGithub();
