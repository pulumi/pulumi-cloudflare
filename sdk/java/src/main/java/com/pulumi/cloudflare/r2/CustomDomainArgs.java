...
public final class CustomDomainArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public CustomDomainArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("CustomDomainArgs", "accountId");
            }
            if ($.bucketName == null) {
                throw new MissingRequiredPropertyException("CustomDomainArgs", "bucketName");
            }
            if ($.domain == null) {
                throw new MissingRequiredPropertyException("CustomDomainArgs", "domain");
            }
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("CustomDomainArgs", "enabled");
            }
            if ($.zoneId == null) {
                throw new MissingRequiredPropertyException("CustomDomainArgs", "zoneId");
            }
            return $;
        }
    }
