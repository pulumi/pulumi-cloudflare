...
public final class ProjectBuildConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectBuildConfigArgs Empty = new ProjectBuildConfigArgs();
    ...
    private ProjectBuildConfigArgs() {}

    private ProjectBuildConfigArgs(ProjectBuildConfigArgs $) {
    ...
    public static Builder builder(ProjectBuildConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectBuildConfigArgs();
        }

        public Builder(ProjectBuildConfigArgs defaults) {
            $ = new ProjectBuildConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProjectBuildConfigArgs build() {
            return $;
        }
    }
