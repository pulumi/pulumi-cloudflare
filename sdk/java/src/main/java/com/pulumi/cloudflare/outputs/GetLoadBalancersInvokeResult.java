...
import com.pulumi.cloudflare.outputs.GetLoadBalancersResult;
...
public final class GetLoadBalancersInvokeResult {
    ...
    public static Builder builder(GetLoadBalancersInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder results(List<GetLoadBalancersResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancersInvokeResult", "results");
            }
            this.results = results;
            return this;
        }
        public Builder results(GetLoadBalancersResult... results) {
