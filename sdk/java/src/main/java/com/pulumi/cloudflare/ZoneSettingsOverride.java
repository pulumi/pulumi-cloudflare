...
public class ZoneSettingsOverride extends com.pulumi.resources.CustomResource {
     ...
     */
    public ZoneSettingsOverride(java.lang.String name) {
     ...
     */
    public ZoneSettingsOverride(java.lang.String name, ZoneSettingsOverrideArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ZoneSettingsOverride(java.lang.String name, ZoneSettingsOverrideArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:index/zoneSettingsOverride:ZoneSettingsOverride", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ZoneSettingsOverride(java.lang.String name, Output<java.lang.String> id, @Nullable ZoneSettingsOverrideState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:index/zoneSettingsOverride:ZoneSettingsOverride", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ZoneSettingsOverride get(java.lang.String name, Output<java.lang.String> id, @Nullable ZoneSettingsOverrideState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
