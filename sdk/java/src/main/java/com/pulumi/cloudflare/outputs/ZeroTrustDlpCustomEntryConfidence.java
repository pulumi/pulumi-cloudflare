...
@CustomType
public final class ZeroTrustDlpCustomEntryConfidence {
    /**
    ...
    private ZeroTrustDlpCustomEntryConfidence() {}
    /**
     * @return Indicates whether this entry has AI remote service validation.
     * 
     */
    ...
    public static Builder builder(ZeroTrustDlpCustomEntryConfidence defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean available;
        public Builder() {}
        public Builder(ZeroTrustDlpCustomEntryConfidence defaults) {
        ...
        public ZeroTrustDlpCustomEntryConfidence build() {
            final var _resultValue = new ZeroTrustDlpCustomEntryConfidence();
