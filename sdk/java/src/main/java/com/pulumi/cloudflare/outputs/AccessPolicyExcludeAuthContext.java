...
@CustomType
public final class AccessPolicyExcludeAuthContext {
    /**
    ...
    private AccessPolicyExcludeAuthContext() {}
    /**
     * @return The ACID of the Authentication Context.
     * 
     */
    ...
    public static Builder builder(AccessPolicyExcludeAuthContext defaults) {
    ...
    public static final class Builder {
        ...
        private String identityProviderId;
        public Builder() {}
        public Builder(AccessPolicyExcludeAuthContext defaults) {
        ...
        public AccessPolicyExcludeAuthContext build() {
            final var _resultValue = new AccessPolicyExcludeAuthContext();
