...
import com.pulumi.cloudflare.stream.inputs.KeyState;
 ...
 * 
 */
@ResourceType(type="cloudflare:stream/key:Key")
public class Key extends com.pulumi.resources.CustomResource {
    ...
    public Key(java.lang.String name, KeyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:stream/key:Key", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Key(java.lang.String name, Output<java.lang.String> id, @Nullable KeyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:stream/key:Key", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/streamKey:StreamKey").build())
            ))
