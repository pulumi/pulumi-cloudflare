...
public final class ApplicationPolicyConnectionRulesSshArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationPolicyConnectionRulesSshArgs Empty = new ApplicationPolicyConnectionRulesSshArgs();
    ...
    private ApplicationPolicyConnectionRulesSshArgs() {}

    private ApplicationPolicyConnectionRulesSshArgs(ApplicationPolicyConnectionRulesSshArgs $) {
    ...
    public static Builder builder(ApplicationPolicyConnectionRulesSshArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationPolicyConnectionRulesSshArgs();
        }

        public Builder(ApplicationPolicyConnectionRulesSshArgs defaults) {
            $ = new ApplicationPolicyConnectionRulesSshArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApplicationPolicyConnectionRulesSshArgs build() {
            if ($.usernames == null) {
                throw new MissingRequiredPropertyException("ApplicationPolicyConnectionRulesSshArgs", "usernames");
            }
            return $;
        }
    }
