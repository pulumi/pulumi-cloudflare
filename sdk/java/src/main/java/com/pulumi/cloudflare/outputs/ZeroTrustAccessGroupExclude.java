...
import com.pulumi.cloudflare.outputs.ZeroTrustAccessGroupExcludeAzure;
import com.pulumi.cloudflare.outputs.ZeroTrustAccessGroupExcludeExternalEvaluation;
import com.pulumi.cloudflare.outputs.ZeroTrustAccessGroupExcludeGithub;
...
public final class ZeroTrustAccessGroupExclude {
    ...
    private @Nullable List<ZeroTrustAccessGroupExcludeAuthContext> authContexts;
    /**
     ...
     * 
     */
    private @Nullable List<ZeroTrustAccessGroupExcludeAzure> azures;
    /**
     ...
     * 
     */
    private @Nullable List<ZeroTrustAccessGroupExcludeExternalEvaluation> externalEvaluations;
    /**
     ...
     * 
     */
    private @Nullable List<ZeroTrustAccessGroupExcludeGithub> githubs;
    /**
     ...
     * 
     */
    private @Nullable List<ZeroTrustAccessGroupExcludeGsuite> gsuites;
    /**
     ...
     * 
     */
    private @Nullable List<ZeroTrustAccessGroupExcludeOkta> oktas;
    /**
     * @return Matches a SAML group. Requires a SAML identity provider.
     * 
     */
    private @Nullable List<ZeroTrustAccessGroupExcludeSaml> samls;
    /**
    ...
    public List<ZeroTrustAccessGroupExcludeAuthContext> authContexts() {
     ...
     * 
     */
    public List<ZeroTrustAccessGroupExcludeAzure> azures() {
     ...
     * 
     */
    public List<ZeroTrustAccessGroupExcludeExternalEvaluation> externalEvaluations() {
     ...
     * 
     */
    public List<ZeroTrustAccessGroupExcludeGithub> githubs() {
     ...
     * 
     */
    public List<ZeroTrustAccessGroupExcludeGsuite> gsuites() {
     ...
     * 
     */
    public List<ZeroTrustAccessGroupExcludeOkta> oktas() {
     ...
     * 
     */
    public List<ZeroTrustAccessGroupExcludeSaml> samls() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder authContexts(@Nullable List<ZeroTrustAccessGroupExcludeAuthContext> authContexts) {

            this.authContexts = authContexts;
            return this;
        }
        public Builder authContexts(ZeroTrustAccessGroupExcludeAuthContext... authContexts) {
        ...
        @CustomType.Setter
        public Builder azures(@Nullable List<ZeroTrustAccessGroupExcludeAzure> azures) {

            this.azures = azures;
            return this;
        }
        public Builder azures(ZeroTrustAccessGroupExcludeAzure... azures) {
        ...
        @CustomType.Setter
        public Builder externalEvaluations(@Nullable List<ZeroTrustAccessGroupExcludeExternalEvaluation> externalEvaluations) {

            this.externalEvaluations = externalEvaluations;
            return this;
        }
        public Builder externalEvaluations(ZeroTrustAccessGroupExcludeExternalEvaluation... externalEvaluations) {
        ...
        @CustomType.Setter
        public Builder githubs(@Nullable List<ZeroTrustAccessGroupExcludeGithub> githubs) {

            this.githubs = githubs;
            return this;
        }
        public Builder githubs(ZeroTrustAccessGroupExcludeGithub... githubs) {
        ...
        @CustomType.Setter
        public Builder gsuites(@Nullable List<ZeroTrustAccessGroupExcludeGsuite> gsuites) {

            this.gsuites = gsuites;
            return this;
        }
        public Builder gsuites(ZeroTrustAccessGroupExcludeGsuite... gsuites) {
        ...
        @CustomType.Setter
        public Builder oktas(@Nullable List<ZeroTrustAccessGroupExcludeOkta> oktas) {

            this.oktas = oktas;
            return this;
        }
        public Builder oktas(ZeroTrustAccessGroupExcludeOkta... oktas) {
            return oktas(List.of(oktas));
        }
        @CustomType.Setter
        public Builder samls(@Nullable List<ZeroTrustAccessGroupExcludeSaml> samls) {

            this.samls = samls;
            return this;
        }
        public Builder samls(ZeroTrustAccessGroupExcludeSaml... samls) {
