...
public final class ZeroTrustAccessGroupIncludeExternalEvaluation {
    ...
    public static Builder builder(ZeroTrustAccessGroupIncludeExternalEvaluation defaults) {
    ...
    public static final class Builder {
        ...
        private String keysUrl;
        public Builder() {}
        public Builder(ZeroTrustAccessGroupIncludeExternalEvaluation defaults) {
        ...
        public Builder evaluateUrl(String evaluateUrl) {
            if (evaluateUrl == null) {
              throw new MissingRequiredPropertyException("ZeroTrustAccessGroupIncludeExternalEvaluation", "evaluateUrl");
            }
        ...
        public Builder keysUrl(String keysUrl) {
            if (keysUrl == null) {
              throw new MissingRequiredPropertyException("ZeroTrustAccessGroupIncludeExternalEvaluation", "keysUrl");
            }
            this.keysUrl = keysUrl;
            return this;
        }
        public ZeroTrustAccessGroupIncludeExternalEvaluation build() {
            final var _resultValue = new ZeroTrustAccessGroupIncludeExternalEvaluation();
