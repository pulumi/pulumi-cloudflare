...
import com.pulumi.cloudflare.rate.outputs.GetLimitActionResponse;
...
@CustomType
public final class GetLimitAction {
    /**
     ...
     * 
     */
    private GetLimitActionResponse response;
    /**
     ...
     * 
     */
    public GetLimitActionResponse response() {
    ...
    public static Builder builder(GetLimitAction defaults) {
    ...
    public static final class Builder {
        ...
        private Double timeout;
        public Builder() {}
        public Builder(GetLimitAction defaults) {
        ...
        public Builder mode(String mode) {
            if (mode == null) {
              throw new MissingRequiredPropertyException("GetLimitAction", "mode");
            }
            this.mode = mode;
            return this;
        }
        @CustomType.Setter
        public Builder response(GetLimitActionResponse response) {
            if (response == null) {
              throw new MissingRequiredPropertyException("GetLimitAction", "response");
            }
        ...
        public Builder timeout(Double timeout) {
            if (timeout == null) {
              throw new MissingRequiredPropertyException("GetLimitAction", "timeout");
            }
            this.timeout = timeout;
            return this;
        }
        public GetLimitAction build() {
            final var _resultValue = new GetLimitAction();
