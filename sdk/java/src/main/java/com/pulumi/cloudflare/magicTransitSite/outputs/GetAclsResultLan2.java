...
@CustomType
public final class GetAclsResultLan2 {
    /**
    ...
    public static Builder builder(GetAclsResultLan2 defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> subnets;
        public Builder() {}
        public Builder(GetAclsResultLan2 defaults) {
        ...
        public Builder lanId(String lanId) {
            if (lanId == null) {
              throw new MissingRequiredPropertyException("GetAclsResultLan2", "lanId");
            }
            this.lanId = lanId;
            return this;
        }
        ...
        public Builder lanName(String lanName) {
            if (lanName == null) {
              throw new MissingRequiredPropertyException("GetAclsResultLan2", "lanName");
            }
        ...
        public Builder portRanges(List<String> portRanges) {
            if (portRanges == null) {
              throw new MissingRequiredPropertyException("GetAclsResultLan2", "portRanges");
            }
        ...
        public Builder ports(List<Integer> ports) {
            if (ports == null) {
              throw new MissingRequiredPropertyException("GetAclsResultLan2", "ports");
            }
            this.ports = ports;
            return this;
        }
        ...
        public Builder subnets(List<String> subnets) {
            if (subnets == null) {
              throw new MissingRequiredPropertyException("GetAclsResultLan2", "subnets");
            }
        ...
        public GetAclsResultLan2 build() {
            final var _resultValue = new GetAclsResultLan2();
