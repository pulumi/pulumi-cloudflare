...
public final class PolicyIncludeSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyIncludeSamlArgs Empty = new PolicyIncludeSamlArgs();
    ...
    private PolicyIncludeSamlArgs() {}

    private PolicyIncludeSamlArgs(PolicyIncludeSamlArgs $) {
    ...
    public static Builder builder(PolicyIncludeSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyIncludeSamlArgs();
        }

        public Builder(PolicyIncludeSamlArgs defaults) {
            $ = new PolicyIncludeSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyIncludeSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("PolicyIncludeSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("PolicyIncludeSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("PolicyIncludeSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
