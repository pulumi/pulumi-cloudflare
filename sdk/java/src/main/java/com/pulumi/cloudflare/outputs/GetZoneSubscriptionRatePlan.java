...
@CustomType
public final class GetZoneSubscriptionRatePlan {
    /**
    ...
    private GetZoneSubscriptionRatePlan() {}
    /**
     * @return The currency applied to the rate plan subscription.
     * 
     */
    ...
    public static Builder builder(GetZoneSubscriptionRatePlan defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> sets;
        public Builder() {}
        public Builder(GetZoneSubscriptionRatePlan defaults) {
        ...
        public Builder currency(String currency) {
            if (currency == null) {
              throw new MissingRequiredPropertyException("GetZoneSubscriptionRatePlan", "currency");
            }
        ...
        public Builder externallyManaged(Boolean externallyManaged) {
            if (externallyManaged == null) {
              throw new MissingRequiredPropertyException("GetZoneSubscriptionRatePlan", "externallyManaged");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetZoneSubscriptionRatePlan", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isContract(Boolean isContract) {
            if (isContract == null) {
              throw new MissingRequiredPropertyException("GetZoneSubscriptionRatePlan", "isContract");
            }
        ...
        public Builder publicName(String publicName) {
            if (publicName == null) {
              throw new MissingRequiredPropertyException("GetZoneSubscriptionRatePlan", "publicName");
            }
        ...
        public Builder scope(String scope) {
            if (scope == null) {
              throw new MissingRequiredPropertyException("GetZoneSubscriptionRatePlan", "scope");
            }
            this.scope = scope;
            return this;
        }
        ...
        public Builder sets(List<String> sets) {
            if (sets == null) {
              throw new MissingRequiredPropertyException("GetZoneSubscriptionRatePlan", "sets");
            }
            this.sets = sets;
            return this;
        }
        ...
        public GetZoneSubscriptionRatePlan build() {
            final var _resultValue = new GetZoneSubscriptionRatePlan();
