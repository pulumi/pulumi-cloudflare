...
public final class DeploymentState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<DeploymentVersionArgs>> versions;

    public Optional<Output<List<DeploymentVersionArgs>>> versions() {
    ...
    public static final class Builder {
        ...
        public Builder versions(@Nullable Output<List<DeploymentVersionArgs>> versions) {
            $.versions = versions;
            return this;
        }
