...
public final class IpsecTunnelHealthCheckArgs extends com.pulumi.resources.ResourceArgs {

    public static final IpsecTunnelHealthCheckArgs Empty = new IpsecTunnelHealthCheckArgs();
     ...
     */
    @Import(name="target")
    private @Nullable Output<IpsecTunnelHealthCheckTargetArgs> target;

    /**
     * @return The destination address in a request type health check. After the healthcheck is decapsulated at the customer end of the tunnel, the ICMP echo will be forwarded to this address. This field defaults to `customerGreEndpoint address`. This field is ignored for bidirectional healthchecks as the interface*address (not assigned to the Cloudflare side of the tunnel) is used as the target. Must be in object form if the x-magic-new-hc-target header is set to true and string form if x-magic-new-hc-target is absent or set to false.
     * 
     */
    public Optional<Output<IpsecTunnelHealthCheckTargetArgs>> target() {
    ...
    private IpsecTunnelHealthCheckArgs() {}

    private IpsecTunnelHealthCheckArgs(IpsecTunnelHealthCheckArgs $) {
    ...
    public static Builder builder(IpsecTunnelHealthCheckArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IpsecTunnelHealthCheckArgs();
        }

        public Builder(IpsecTunnelHealthCheckArgs defaults) {
            $ = new IpsecTunnelHealthCheckArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder target(@Nullable Output<IpsecTunnelHealthCheckTargetArgs> target) {
            $.target = target;
            return this;
        }
         ...
         * 
         */
        public Builder target(IpsecTunnelHealthCheckTargetArgs target) {
        ...
        public IpsecTunnelHealthCheckArgs build() {
            return $;
        }
    }
