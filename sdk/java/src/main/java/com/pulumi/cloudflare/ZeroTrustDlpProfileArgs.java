...
public final class ZeroTrustDlpProfileArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZeroTrustDlpProfileArgs Empty = new ZeroTrustDlpProfileArgs();
    ...
    private Output<List<ZeroTrustDlpProfileEntryArgs>> entries;

    /**
     * @return List of entries to apply to the profile.
     * 
     */
    public Output<List<ZeroTrustDlpProfileEntryArgs>> entries() {
        return this.entries;
    }
    ...
    private ZeroTrustDlpProfileArgs() {}

    private ZeroTrustDlpProfileArgs(ZeroTrustDlpProfileArgs $) {
    ...
    public static Builder builder(ZeroTrustDlpProfileArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustDlpProfileArgs();
        }

        public Builder(ZeroTrustDlpProfileArgs defaults) {
            $ = new ZeroTrustDlpProfileArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder entries(Output<List<ZeroTrustDlpProfileEntryArgs>> entries) {
            $.entries = entries;
            return this;
        }
        ...
        public ZeroTrustDlpProfileArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("ZeroTrustDlpProfileArgs", "accountId");
            }
            if ($.allowedMatchCount == null) {
                throw new MissingRequiredPropertyException("ZeroTrustDlpProfileArgs", "allowedMatchCount");
            }
            if ($.entries == null) {
                throw new MissingRequiredPropertyException("ZeroTrustDlpProfileArgs", "entries");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ZeroTrustDlpProfileArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ZeroTrustDlpProfileArgs", "type");
            }
            return $;
        }
    }
