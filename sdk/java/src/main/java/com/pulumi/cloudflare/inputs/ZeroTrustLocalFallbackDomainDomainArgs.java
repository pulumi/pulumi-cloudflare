...
public final class ZeroTrustLocalFallbackDomainDomainArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZeroTrustLocalFallbackDomainDomainArgs Empty = new ZeroTrustLocalFallbackDomainDomainArgs();
    ...
    private ZeroTrustLocalFallbackDomainDomainArgs(ZeroTrustLocalFallbackDomainDomainArgs $) {
    ...
    public static Builder builder(ZeroTrustLocalFallbackDomainDomainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustLocalFallbackDomainDomainArgs();
        }

        public Builder(ZeroTrustLocalFallbackDomainDomainArgs defaults) {
            $ = new ZeroTrustLocalFallbackDomainDomainArgs(Objects.requireNonNull(defaults));
        }
