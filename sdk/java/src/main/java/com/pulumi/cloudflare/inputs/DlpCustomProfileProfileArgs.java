...
import com.pulumi.cloudflare.inputs.DlpCustomProfileProfileContextAwarenessArgs;
import com.pulumi.cloudflare.inputs.DlpCustomProfileProfileEntryArgs;
import com.pulumi.cloudflare.inputs.DlpCustomProfileProfileSharedEntryArgs;
...
public final class DlpCustomProfileProfileArgs extends com.pulumi.resources.ResourceArgs {

    public static final DlpCustomProfileProfileArgs Empty = new DlpCustomProfileProfileArgs();
    ...
    private @Nullable Output<DlpCustomProfileProfileContextAwarenessArgs> contextAwareness;

    /**
     * @return Scan the context of predefined entries to only return matches surrounded by keywords.
     * 
     */
    public Optional<Output<DlpCustomProfileProfileContextAwarenessArgs>> contextAwareness() {
    ...
    private Output<List<DlpCustomProfileProfileEntryArgs>> entries;

    public Output<List<DlpCustomProfileProfileEntryArgs>> entries() {
        return this.entries;
    }
    ...
    private @Nullable Output<List<DlpCustomProfileProfileSharedEntryArgs>> sharedEntries;

    /**
     * @return Entries from other profiles (e.g. pre-defined Cloudflare profiles, or your Microsoft Information Protection profiles).
     * 
     */
    public Optional<Output<List<DlpCustomProfileProfileSharedEntryArgs>>> sharedEntries() {
        return Optional.ofNullable(this.sharedEntries);
    }

    private DlpCustomProfileProfileArgs() {}

    private DlpCustomProfileProfileArgs(DlpCustomProfileProfileArgs $) {
    ...
    public static Builder builder(DlpCustomProfileProfileArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DlpCustomProfileProfileArgs();
        }

        public Builder(DlpCustomProfileProfileArgs defaults) {
            $ = new DlpCustomProfileProfileArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder contextAwareness(@Nullable Output<DlpCustomProfileProfileContextAwarenessArgs> contextAwareness) {
         ...
         * 
         */
        public Builder contextAwareness(DlpCustomProfileProfileContextAwarenessArgs contextAwareness) {
        ...
        public Builder entries(Output<List<DlpCustomProfileProfileEntryArgs>> entries) {
            $.entries = entries;
            return this;
        }

        public Builder entries(List<DlpCustomProfileProfileEntryArgs> entries) {
            return entries(Output.of(entries));
        }

        public Builder entries(DlpCustomProfileProfileEntryArgs... entries) {
         ...
         * 
         */
        public Builder sharedEntries(@Nullable Output<List<DlpCustomProfileProfileSharedEntryArgs>> sharedEntries) {
         ...
         * 
         */
        public Builder sharedEntries(List<DlpCustomProfileProfileSharedEntryArgs> sharedEntries) {
         ...
         * 
         */
        public Builder sharedEntries(DlpCustomProfileProfileSharedEntryArgs... sharedEntries) {
            return sharedEntries(List.of(sharedEntries));
        }

        public DlpCustomProfileProfileArgs build() {
            if ($.entries == null) {
                throw new MissingRequiredPropertyException("DlpCustomProfileProfileArgs", "entries");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DlpCustomProfileProfileArgs", "name");
            }
            return $;
        }
    }
