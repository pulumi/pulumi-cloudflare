...
public final class ZeroTrustAccessKeyConfigurationState extends com.pulumi.resources.ResourceArgs {

    public static final ZeroTrustAccessKeyConfigurationState Empty = new ZeroTrustAccessKeyConfigurationState();
    ...
    private ZeroTrustAccessKeyConfigurationState() {}

    private ZeroTrustAccessKeyConfigurationState(ZeroTrustAccessKeyConfigurationState $) {
    ...
    public static Builder builder(ZeroTrustAccessKeyConfigurationState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustAccessKeyConfigurationState();
        }

        public Builder(ZeroTrustAccessKeyConfigurationState defaults) {
            $ = new ZeroTrustAccessKeyConfigurationState(Objects.requireNonNull(defaults));
        }
        ...
        public ZeroTrustAccessKeyConfigurationState build() {
            return $;
        }
    }
