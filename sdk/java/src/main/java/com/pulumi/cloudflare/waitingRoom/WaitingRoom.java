...
import com.pulumi.cloudflare.waitingRoom.inputs.WaitingRoomState;
import com.pulumi.cloudflare.waitingRoom.outputs.WaitingRoomAdditionalRoute;
import com.pulumi.cloudflare.waitingRoom.outputs.WaitingRoomCookieAttributes;
 ...
 * 
 * ```sh
 * $ pulumi import cloudflare:waitingRoom/waitingRoom:WaitingRoom example &#39;&lt;zone_id&gt;/&lt;waiting_room_id&gt;&#39;
 * ```
 * 
 */
@ResourceType(type="cloudflare:waitingRoom/waitingRoom:WaitingRoom")
public class WaitingRoom extends com.pulumi.resources.CustomResource {
    ...
    public WaitingRoom(java.lang.String name, WaitingRoomArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:waitingRoom/waitingRoom:WaitingRoom", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private WaitingRoom(java.lang.String name, Output<java.lang.String> id, @Nullable WaitingRoomState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:waitingRoom/waitingRoom:WaitingRoom", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/waitingRoom:WaitingRoom").build())
            ))
            .build();
