...
import com.pulumi.cloudflare.keyless.outputs.GetCertificateTunnel;
...
public final class GetCertificateResult {
     ...
     * 
     */
    private GetCertificateTunnel tunnel;
    /**
     * @return Identifier.
     * 
     */
     ...
     * 
     */
    public GetCertificateTunnel tunnel() {
        return this.tunnel;
    }
    /**
     * @return Identifier.
    ...
    public static final class Builder {
        ...
        public Builder createdOn(String createdOn) {
            if (createdOn == null) {
              throw new MissingRequiredPropertyException("GetCertificateResult", "createdOn");
            }
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetCertificateResult", "enabled");
            }
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("GetCertificateResult", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder keylessCertificateId(String keylessCertificateId) {
            if (keylessCertificateId == null) {
              throw new MissingRequiredPropertyException("GetCertificateResult", "keylessCertificateId");
            }
        ...
        public Builder modifiedOn(String modifiedOn) {
            if (modifiedOn == null) {
              throw new MissingRequiredPropertyException("GetCertificateResult", "modifiedOn");
            }
        ...
        public Builder permissions(List<String> permissions) {
            if (permissions == null) {
              throw new MissingRequiredPropertyException("GetCertificateResult", "permissions");
            }
        ...
        public Builder port(Double port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetCertificateResult", "port");
            }
            this.port = port;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder tunnel(GetCertificateTunnel tunnel) {
            if (tunnel == null) {
              throw new MissingRequiredPropertyException("GetCertificateResult", "tunnel");
            }
            this.tunnel = tunnel;
            return this;
        }
