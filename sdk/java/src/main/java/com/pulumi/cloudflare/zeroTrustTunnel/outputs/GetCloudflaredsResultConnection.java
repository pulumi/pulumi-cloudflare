...
@CustomType
public final class GetCloudflaredsResultConnection {
    /**
    ...
    private GetCloudflaredsResultConnection() {}
    /**
     * @return UUID of the Cloudflare Tunnel connector.
     * 
     */
    ...
    public static Builder builder(GetCloudflaredsResultConnection defaults) {
    ...
    public static final class Builder {
        ...
        private String uuid;
        public Builder() {}
        public Builder(GetCloudflaredsResultConnection defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResultConnection", "clientId");
            }
        ...
        public Builder clientVersion(String clientVersion) {
            if (clientVersion == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResultConnection", "clientVersion");
            }
        ...
        public Builder coloName(String coloName) {
            if (coloName == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResultConnection", "coloName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResultConnection", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isPendingReconnect(Boolean isPendingReconnect) {
            if (isPendingReconnect == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResultConnection", "isPendingReconnect");
            }
        ...
        public Builder openedAt(String openedAt) {
            if (openedAt == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResultConnection", "openedAt");
            }
        ...
        public Builder originIp(String originIp) {
            if (originIp == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResultConnection", "originIp");
            }
        ...
        public Builder uuid(String uuid) {
            if (uuid == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResultConnection", "uuid");
            }
            this.uuid = uuid;
            return this;
        }
        public GetCloudflaredsResultConnection build() {
            final var _resultValue = new GetCloudflaredsResultConnection();
