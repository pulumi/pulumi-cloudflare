...
public final class PolicyRequireSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyRequireSamlArgs Empty = new PolicyRequireSamlArgs();
    ...
    private PolicyRequireSamlArgs() {}

    private PolicyRequireSamlArgs(PolicyRequireSamlArgs $) {
    ...
    public static Builder builder(PolicyRequireSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyRequireSamlArgs();
        }

        public Builder(PolicyRequireSamlArgs defaults) {
            $ = new PolicyRequireSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyRequireSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("PolicyRequireSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("PolicyRequireSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("PolicyRequireSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
