...
@CustomType
public final class LimitMatchResponse {
    /**
    ...
    public static Builder builder(LimitMatchResponse defaults) {
    ...
    public static final class Builder {
        private @Nullable Boolean originTraffic;
        public Builder() {}
        public Builder(LimitMatchResponse defaults) {
        ...
        public LimitMatchResponse build() {
            final var _resultValue = new LimitMatchResponse();
