...
public final class GetTargetsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetTargetsArgs Empty = new GetTargetsArgs();
    ...
    private GetTargetsArgs() {}

    private GetTargetsArgs(GetTargetsArgs $) {
    ...
    public static Builder builder(GetTargetsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetTargetsArgs defaults) {
            $ = new GetTargetsArgs(Objects.requireNonNull(defaults));
        }
