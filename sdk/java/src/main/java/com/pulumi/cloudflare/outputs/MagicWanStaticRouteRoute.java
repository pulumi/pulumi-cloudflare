...
import com.pulumi.cloudflare.outputs.MagicWanStaticRouteRouteScope;
...
@CustomType
public final class MagicWanStaticRouteRoute {
    /**
     ...
     * 
     */
    private @Nullable MagicWanStaticRouteRouteScope scope;
    /**
    ...
    private MagicWanStaticRouteRoute() {}
    /**
     * @return When the route was created.
     * 
     */
     ...
     * 
     */
    public Optional<MagicWanStaticRouteRouteScope> scope() {
    ...
    public static Builder builder(MagicWanStaticRouteRoute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer weight;
        public Builder() {}
        public Builder(MagicWanStaticRouteRoute defaults) {
        ...
        @CustomType.Setter
        public Builder scope(@Nullable MagicWanStaticRouteRouteScope scope) {
        ...
        public MagicWanStaticRouteRoute build() {
            final var _resultValue = new MagicWanStaticRouteRoute();
