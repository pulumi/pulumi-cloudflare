...
@CustomType
public final class PagesProjectDeploymentConfigsProductionR2Buckets {
    /**
    ...
    public static Builder builder(PagesProjectDeploymentConfigsProductionR2Buckets defaults) {
    ...
    public static final class Builder {
        ...
        public PagesProjectDeploymentConfigsProductionR2Buckets build() {
            final var _resultValue = new PagesProjectDeploymentConfigsProductionR2Buckets();
