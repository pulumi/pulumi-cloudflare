...
import com.pulumi.cloudflare.r2.outputs.GetCustomDomainStatus;
...
public final class GetCustomDomainResult {
    ...
    private GetCustomDomainStatus status;
    /**
    ...
    public GetCustomDomainStatus status() {
        return this.status;
    }
    /**
     * @return Zone ID of the custom domain resides in.
    ...
    public static final class Builder {
        ...
        public Builder accountId(String accountId) {
            if (accountId == null) {
              throw new MissingRequiredPropertyException("GetCustomDomainResult", "accountId");
            }
        ...
        public Builder bucketName(String bucketName) {
            if (bucketName == null) {
              throw new MissingRequiredPropertyException("GetCustomDomainResult", "bucketName");
            }
        ...
        public Builder ciphers(List<String> ciphers) {
            if (ciphers == null) {
              throw new MissingRequiredPropertyException("GetCustomDomainResult", "ciphers");
            }
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetCustomDomainResult", "enabled");
            }
        ...
        public Builder minTls(String minTls) {
            if (minTls == null) {
              throw new MissingRequiredPropertyException("GetCustomDomainResult", "minTls");
            }
            this.minTls = minTls;
            return this;
        }
        @CustomType.Setter
        public Builder status(GetCustomDomainStatus status) {
            if (status == null) {
        ...
        public Builder zoneId(String zoneId) {
            if (zoneId == null) {
              throw new MissingRequiredPropertyException("GetCustomDomainResult", "zoneId");
            }
            this.zoneId = zoneId;
            return this;
        }
        ...
        public Builder zoneName(String zoneName) {
            if (zoneName == null) {
              throw new MissingRequiredPropertyException("GetCustomDomainResult", "zoneName");
            }
