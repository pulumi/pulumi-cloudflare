...
public final class GetRelayFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRelayFilterArgs Empty = new GetRelayFilterArgs();
    ...
    private GetRelayFilterArgs() {}

    private GetRelayFilterArgs(GetRelayFilterArgs $) {
        this.asc = $.asc;
    ...
    public static Builder builder(GetRelayFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRelayFilterArgs();
        }

        public Builder(GetRelayFilterArgs defaults) {
            $ = new GetRelayFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRelayFilterArgs build() {
            if ($.asc == null) {
                throw new MissingRequiredPropertyException("GetRelayFilterArgs", "asc");
            }
            return $;
        }
    }
