...
public final class DatasetDatasetColumnArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatasetDatasetColumnArgs Empty = new DatasetDatasetColumnArgs();
    ...
    private DatasetDatasetColumnArgs() {}

    private DatasetDatasetColumnArgs(DatasetDatasetColumnArgs $) {
    ...
    public static Builder builder(DatasetDatasetColumnArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatasetDatasetColumnArgs();
        }

        public Builder(DatasetDatasetColumnArgs defaults) {
            $ = new DatasetDatasetColumnArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DatasetDatasetColumnArgs build() {
            return $;
        }
    }
