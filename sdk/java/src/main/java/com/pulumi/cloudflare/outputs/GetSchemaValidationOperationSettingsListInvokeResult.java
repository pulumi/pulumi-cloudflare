...
import com.pulumi.cloudflare.outputs.GetSchemaValidationOperationSettingsListResult;
...
public final class GetSchemaValidationOperationSettingsListInvokeResult {
    ...
    public static Builder builder(GetSchemaValidationOperationSettingsListInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder results(List<GetSchemaValidationOperationSettingsListResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetSchemaValidationOperationSettingsListInvokeResult", "results");
            }
            this.results = results;
            return this;
        }
        public Builder results(GetSchemaValidationOperationSettingsListResult... results) {
