...
public final class GetAccountApiTokenPermissionGroupsListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetAccountApiTokenPermissionGroupsListArgs Empty = new GetAccountApiTokenPermissionGroupsListArgs();
    ...
    public static Builder builder(GetAccountApiTokenPermissionGroupsListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAccountApiTokenPermissionGroupsListArgs();
        }

        public Builder(GetAccountApiTokenPermissionGroupsListArgs defaults) {
            $ = new GetAccountApiTokenPermissionGroupsListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAccountApiTokenPermissionGroupsListArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetAccountApiTokenPermissionGroupsListArgs", "accountId");
            }
            return $;
        }
    }
