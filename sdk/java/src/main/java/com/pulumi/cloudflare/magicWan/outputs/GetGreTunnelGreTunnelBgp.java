...
@CustomType
public final class GetGreTunnelGreTunnelBgp {
    /**
    ...
    private GetGreTunnelGreTunnelBgp() {}
    /**
     * @return ASN used on the customer end of the BGP session
     * 
     */
    ...
    public static Builder builder(GetGreTunnelGreTunnelBgp defaults) {
    ...
    public static final class Builder {
        ...
        private String md5Key;
        public Builder() {}
        public Builder(GetGreTunnelGreTunnelBgp defaults) {
        ...
        public Builder customerAsn(Integer customerAsn) {
            if (customerAsn == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnelBgp", "customerAsn");
            }
        ...
        public Builder extraPrefixes(List<String> extraPrefixes) {
            if (extraPrefixes == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnelBgp", "extraPrefixes");
            }
        ...
        public Builder md5Key(String md5Key) {
            if (md5Key == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnelBgp", "md5Key");
            }
            this.md5Key = md5Key;
            return this;
        }
        public GetGreTunnelGreTunnelBgp build() {
            final var _resultValue = new GetGreTunnelGreTunnelBgp();
