...
public final class WorkersScriptFilesArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkersScriptFilesArgs Empty = new WorkersScriptFilesArgs();
    ...
    private WorkersScriptFilesArgs() {}

    private WorkersScriptFilesArgs(WorkersScriptFilesArgs $) {
    ...
    public static Builder builder(WorkersScriptFilesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkersScriptFilesArgs();
        }

        public Builder(WorkersScriptFilesArgs defaults) {
            $ = new WorkersScriptFilesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WorkersScriptFilesArgs build() {
            if ($.contentType == null) {
                throw new MissingRequiredPropertyException("WorkersScriptFilesArgs", "contentType");
            }
            return $;
        }
    }
