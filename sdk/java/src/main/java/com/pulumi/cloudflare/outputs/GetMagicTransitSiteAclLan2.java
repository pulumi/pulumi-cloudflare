...
@CustomType
public final class GetMagicTransitSiteAclLan2 {
    /**
    ...
    private GetMagicTransitSiteAclLan2() {}
    /**
     * @return The identifier for the LAN you want to create an ACL policy with.
     * 
     */
    ...
    public static Builder builder(GetMagicTransitSiteAclLan2 defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> subnets;
        public Builder() {}
        public Builder(GetMagicTransitSiteAclLan2 defaults) {
        ...
        public Builder lanId(String lanId) {
            if (lanId == null) {
              throw new MissingRequiredPropertyException("GetMagicTransitSiteAclLan2", "lanId");
            }
            this.lanId = lanId;
            return this;
        }
        ...
        public Builder lanName(String lanName) {
            if (lanName == null) {
              throw new MissingRequiredPropertyException("GetMagicTransitSiteAclLan2", "lanName");
            }
        ...
        public Builder portRanges(List<String> portRanges) {
            if (portRanges == null) {
              throw new MissingRequiredPropertyException("GetMagicTransitSiteAclLan2", "portRanges");
            }
        ...
        public Builder ports(List<Integer> ports) {
            if (ports == null) {
              throw new MissingRequiredPropertyException("GetMagicTransitSiteAclLan2", "ports");
            }
            this.ports = ports;
            return this;
        }
        ...
        public Builder subnets(List<String> subnets) {
            if (subnets == null) {
              throw new MissingRequiredPropertyException("GetMagicTransitSiteAclLan2", "subnets");
            }
        ...
        public GetMagicTransitSiteAclLan2 build() {
            final var _resultValue = new GetMagicTransitSiteAclLan2();
