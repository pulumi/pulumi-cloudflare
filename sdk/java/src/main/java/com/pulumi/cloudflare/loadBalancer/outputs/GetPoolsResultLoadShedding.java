...
@CustomType
public final class GetPoolsResultLoadShedding {
    /**
    ...
    private GetPoolsResultLoadShedding() {}
    /**
     * @return The percent of traffic to shed from the pool, according to the default policy. Applies to new sessions and traffic without session affinity.
     * 
     */
    ...
    public static Builder builder(GetPoolsResultLoadShedding defaults) {
    ...
    public static final class Builder {
        ...
        private String sessionPolicy;
        public Builder() {}
        public Builder(GetPoolsResultLoadShedding defaults) {
        ...
        public Builder defaultPercent(Double defaultPercent) {
            if (defaultPercent == null) {
              throw new MissingRequiredPropertyException("GetPoolsResultLoadShedding", "defaultPercent");
            }
        ...
        public Builder defaultPolicy(String defaultPolicy) {
            if (defaultPolicy == null) {
              throw new MissingRequiredPropertyException("GetPoolsResultLoadShedding", "defaultPolicy");
            }
        ...
        public Builder sessionPercent(Double sessionPercent) {
            if (sessionPercent == null) {
              throw new MissingRequiredPropertyException("GetPoolsResultLoadShedding", "sessionPercent");
            }
        ...
        public Builder sessionPolicy(String sessionPolicy) {
            if (sessionPolicy == null) {
              throw new MissingRequiredPropertyException("GetPoolsResultLoadShedding", "sessionPolicy");
            }
            this.sessionPolicy = sessionPolicy;
            return this;
        }
        public GetPoolsResultLoadShedding build() {
            final var _resultValue = new GetPoolsResultLoadShedding();
