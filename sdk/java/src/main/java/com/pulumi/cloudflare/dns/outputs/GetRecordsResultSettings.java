...
@CustomType
public final class GetRecordsResultSettings {
    /**
    ...
    private GetRecordsResultSettings() {}
    /**
     * @return If enabled, causes the CNAME record to be resolved externally and the resulting address records (e.g., A and AAAA) to be returned instead of the CNAME record itself. This setting is unavailable for proxied records, since they are always flattened.
     * 
     */
    ...
    public static Builder builder(GetRecordsResultSettings defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean ipv6Only;
        public Builder() {}
        public Builder(GetRecordsResultSettings defaults) {
        ...
        public Builder flattenCname(Boolean flattenCname) {
            if (flattenCname == null) {
              throw new MissingRequiredPropertyException("GetRecordsResultSettings", "flattenCname");
            }
        ...
        public Builder ipv4Only(Boolean ipv4Only) {
            if (ipv4Only == null) {
              throw new MissingRequiredPropertyException("GetRecordsResultSettings", "ipv4Only");
            }
        ...
        public Builder ipv6Only(Boolean ipv6Only) {
            if (ipv6Only == null) {
              throw new MissingRequiredPropertyException("GetRecordsResultSettings", "ipv6Only");
            }
            this.ipv6Only = ipv6Only;
            return this;
        }
        public GetRecordsResultSettings build() {
            final var _resultValue = new GetRecordsResultSettings();
