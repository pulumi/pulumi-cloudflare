...
public final class GetZonesResultMeta {
    ...
    public static Builder builder(GetZonesResultMeta defaults) {
    ...
    public static final class Builder {
        ...
        private Integer step;
        public Builder() {}
        public Builder(GetZonesResultMeta defaults) {
        ...
        public Builder cdnOnly(Boolean cdnOnly) {
            if (cdnOnly == null) {
              throw new MissingRequiredPropertyException("GetZonesResultMeta", "cdnOnly");
            }
        ...
        public Builder customCertificateQuota(Integer customCertificateQuota) {
            if (customCertificateQuota == null) {
              throw new MissingRequiredPropertyException("GetZonesResultMeta", "customCertificateQuota");
            }
        ...
        public Builder dnsOnly(Boolean dnsOnly) {
            if (dnsOnly == null) {
              throw new MissingRequiredPropertyException("GetZonesResultMeta", "dnsOnly");
            }
        ...
        public Builder foundationDns(Boolean foundationDns) {
            if (foundationDns == null) {
              throw new MissingRequiredPropertyException("GetZonesResultMeta", "foundationDns");
            }
        ...
        public Builder pageRuleQuota(Integer pageRuleQuota) {
            if (pageRuleQuota == null) {
              throw new MissingRequiredPropertyException("GetZonesResultMeta", "pageRuleQuota");
            }
        ...
        public Builder phishingDetected(Boolean phishingDetected) {
            if (phishingDetected == null) {
              throw new MissingRequiredPropertyException("GetZonesResultMeta", "phishingDetected");
            }
        ...
        public Builder step(Integer step) {
            if (step == null) {
              throw new MissingRequiredPropertyException("GetZonesResultMeta", "step");
            }
            this.step = step;
            return this;
        }
        public GetZonesResultMeta build() {
            final var _resultValue = new GetZonesResultMeta();
