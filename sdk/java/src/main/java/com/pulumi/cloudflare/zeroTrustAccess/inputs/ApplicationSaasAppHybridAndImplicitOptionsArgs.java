...
public final class ApplicationSaasAppHybridAndImplicitOptionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationSaasAppHybridAndImplicitOptionsArgs Empty = new ApplicationSaasAppHybridAndImplicitOptionsArgs();
    ...
    private ApplicationSaasAppHybridAndImplicitOptionsArgs() {}

    private ApplicationSaasAppHybridAndImplicitOptionsArgs(ApplicationSaasAppHybridAndImplicitOptionsArgs $) {
    ...
    public static Builder builder(ApplicationSaasAppHybridAndImplicitOptionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationSaasAppHybridAndImplicitOptionsArgs();
        }

        public Builder(ApplicationSaasAppHybridAndImplicitOptionsArgs defaults) {
            $ = new ApplicationSaasAppHybridAndImplicitOptionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApplicationSaasAppHybridAndImplicitOptionsArgs build() {
            return $;
        }
    }
