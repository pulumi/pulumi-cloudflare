...
public final class AccessPolicyIncludeAzure {
    ...
    public static Builder builder(AccessPolicyIncludeAzure defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> ids;
        public Builder() {}
        public Builder(AccessPolicyIncludeAzure defaults) {
        ...
        public AccessPolicyIncludeAzure build() {
            final var _resultValue = new AccessPolicyIncludeAzure();
