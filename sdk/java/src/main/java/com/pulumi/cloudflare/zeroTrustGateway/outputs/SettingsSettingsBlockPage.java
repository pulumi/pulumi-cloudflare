...
@CustomType
public final class SettingsSettingsBlockPage {
    /**
    ...
    private SettingsSettingsBlockPage() {}
    /**
     * @return Specify the block page background color in `#rrggbb` format when the mode is customized*block*page.
     * 
     */
    ...
    public static Builder builder(SettingsSettingsBlockPage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer version;
        public Builder() {}
        public Builder(SettingsSettingsBlockPage defaults) {
        ...
        public SettingsSettingsBlockPage build() {
            final var _resultValue = new SettingsSettingsBlockPage();
