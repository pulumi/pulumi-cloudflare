...
import com.pulumi.cloudflare.zeroTrustDevicePosture.inputs.RuleInputLocationsArgs;
...
public final class RuleInputArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuleInputArgs Empty = new RuleInputArgs();
    ...
    private @Nullable Output<RuleInputLocationsArgs> locations;

    public Optional<Output<RuleInputLocationsArgs>> locations() {
    ...
    private RuleInputArgs() {}

    private RuleInputArgs(RuleInputArgs $) {
    ...
    public static Builder builder(RuleInputArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RuleInputArgs defaults) {
            $ = new RuleInputArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder locations(@Nullable Output<RuleInputLocationsArgs> locations) {
            $.locations = locations;
            return this;
        }

        public Builder locations(RuleInputLocationsArgs locations) {
