...
public final class AccessPolicyExcludeGithub {
    ...
    public static Builder builder(AccessPolicyExcludeGithub defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> teams;
        public Builder() {}
        public Builder(AccessPolicyExcludeGithub defaults) {
        ...
        public AccessPolicyExcludeGithub build() {
            final var _resultValue = new AccessPolicyExcludeGithub();
