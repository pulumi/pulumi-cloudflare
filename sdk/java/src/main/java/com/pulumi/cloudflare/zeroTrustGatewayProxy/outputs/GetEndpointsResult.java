...
public final class GetEndpointsResult {
    ...
    public static final class Builder {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetEndpointsResult", "createdAt");
            }
        ...
        public Builder ips(List<String> ips) {
            if (ips == null) {
              throw new MissingRequiredPropertyException("GetEndpointsResult", "ips");
            }
            this.ips = ips;
            return this;
        }
        ...
        public Builder kind(String kind) {
            if (kind == null) {
              throw new MissingRequiredPropertyException("GetEndpointsResult", "kind");
            }
            this.kind = kind;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetEndpointsResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder subdomain(String subdomain) {
            if (subdomain == null) {
              throw new MissingRequiredPropertyException("GetEndpointsResult", "subdomain");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetEndpointsResult", "updatedAt");
            }
