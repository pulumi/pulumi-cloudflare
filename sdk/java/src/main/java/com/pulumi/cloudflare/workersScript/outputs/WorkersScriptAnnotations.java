...
@CustomType
public final class WorkersScriptAnnotations {
    /**
    ...
    public static Builder builder(WorkersScriptAnnotations defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String workersTriggeredBy;
        public Builder() {}
        public Builder(WorkersScriptAnnotations defaults) {
        ...
        public WorkersScriptAnnotations build() {
            final var _resultValue = new WorkersScriptAnnotations();
