...
@CustomType
public final class GetConfigCaching {
    /**
    ...
    public static Builder builder(GetConfigCaching defaults) {
    ...
    public static final class Builder {
        ...
        private Integer staleWhileRevalidate;
        public Builder() {}
        public Builder(GetConfigCaching defaults) {
        ...
        public Builder disabled(Boolean disabled) {
            if (disabled == null) {
              throw new MissingRequiredPropertyException("GetConfigCaching", "disabled");
            }
        ...
        public Builder maxAge(Integer maxAge) {
            if (maxAge == null) {
              throw new MissingRequiredPropertyException("GetConfigCaching", "maxAge");
            }
            this.maxAge = maxAge;
            return this;
        }
        ...
        public Builder staleWhileRevalidate(Integer staleWhileRevalidate) {
            if (staleWhileRevalidate == null) {
              throw new MissingRequiredPropertyException("GetConfigCaching", "staleWhileRevalidate");
            }
            this.staleWhileRevalidate = staleWhileRevalidate;
            return this;
        }
        public GetConfigCaching build() {
            final var _resultValue = new GetConfigCaching();
