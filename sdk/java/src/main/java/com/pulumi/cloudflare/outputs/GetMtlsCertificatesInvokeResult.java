...
import com.pulumi.cloudflare.outputs.GetMtlsCertificatesResult;
...
public final class GetMtlsCertificatesInvokeResult {
     ...
     * 
     */
    public List<GetMtlsCertificatesResult> results() {
        return this.results;
    }
    ...
    public static Builder builder(GetMtlsCertificatesInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder results(List<GetMtlsCertificatesResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetMtlsCertificatesInvokeResult", "results");
            }
            this.results = results;
            return this;
        }
        public Builder results(GetMtlsCertificatesResult... results) {
