...
public final class PagesProjectCanonicalDeploymentDeploymentTriggerMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final PagesProjectCanonicalDeploymentDeploymentTriggerMetadataArgs Empty = new PagesProjectCanonicalDeploymentDeploymentTriggerMetadataArgs();
    ...
    private PagesProjectCanonicalDeploymentDeploymentTriggerMetadataArgs() {}
    ...
    public static Builder builder(PagesProjectCanonicalDeploymentDeploymentTriggerMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PagesProjectCanonicalDeploymentDeploymentTriggerMetadataArgs();
        }

        public Builder(PagesProjectCanonicalDeploymentDeploymentTriggerMetadataArgs defaults) {
            $ = new PagesProjectCanonicalDeploymentDeploymentTriggerMetadataArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PagesProjectCanonicalDeploymentDeploymentTriggerMetadataArgs build() {
            return $;
        }
    }
