...
public final class PolicyRuleSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyRuleSettingsArgs Empty = new PolicyRuleSettingsArgs();
    ...
    private @Nullable Output<PolicyRuleSettingsAuditSshArgs> auditSsh;

    /**
     * @return Define the settings for the Audit SSH action. Settable only for `l4` rules with `auditSsh` action.
     * 
     */
    public Optional<Output<PolicyRuleSettingsAuditSshArgs>> auditSsh() {
    ...
    private @Nullable Output<PolicyRuleSettingsBisoAdminControlsArgs> bisoAdminControls;

    /**
     * @return Configure browser isolation behavior. Settable only for `http` rules with the action set to `isolate`.
     * 
     */
    public Optional<Output<PolicyRuleSettingsBisoAdminControlsArgs>> bisoAdminControls() {
    ...
    private @Nullable Output<PolicyRuleSettingsBlockPageArgs> blockPage;
     ...
     * 
     */
    public Optional<Output<PolicyRuleSettingsBlockPageArgs>> blockPage() {
    ...
    private @Nullable Output<PolicyRuleSettingsCheckSessionArgs> checkSession;

    /**
     * @return Configure session check behavior. Settable only for `l4` and `http` rules with the action set to `allow`.
     * 
     */
    public Optional<Output<PolicyRuleSettingsCheckSessionArgs>> checkSession() {
    ...
    private @Nullable Output<PolicyRuleSettingsDnsResolversArgs> dnsResolvers;
     ...
     * 
     */
    public Optional<Output<PolicyRuleSettingsDnsResolversArgs>> dnsResolvers() {
     ...
     */
    @Import(name="egress")
    private @Nullable Output<PolicyRuleSettingsEgressArgs> egress;
     ...
     * 
     */
    public Optional<Output<PolicyRuleSettingsEgressArgs>> egress() {
    ...
    private @Nullable Output<PolicyRuleSettingsForensicCopyArgs> forensicCopy;

    /**
     * @return Configure whether a copy of the HTTP request will be sent to storage when the rule matches.
     * 
     */
    public Optional<Output<PolicyRuleSettingsForensicCopyArgs>> forensicCopy() {
    ...
    private @Nullable Output<PolicyRuleSettingsL4overrideArgs> l4override;
     ...
     * 
     */
    public Optional<Output<PolicyRuleSettingsL4overrideArgs>> l4override() {
    ...
    private @Nullable Output<PolicyRuleSettingsNotificationSettingsArgs> notificationSettings;
     ...
     * 
     */
    public Optional<Output<PolicyRuleSettingsNotificationSettingsArgs>> notificationSettings() {
    ...
    private @Nullable Output<PolicyRuleSettingsPayloadLogArgs> payloadLog;

    /**
     * @return Configure DLP payload logging. Settable only for `http` rules.
     * 
     */
    public Optional<Output<PolicyRuleSettingsPayloadLogArgs>> payloadLog() {
    ...
    private @Nullable Output<PolicyRuleSettingsQuarantineArgs> quarantine;

    /**
     * @return Configure settings that apply to quarantine rules. Settable only for `http` rules.
     * 
     */
    public Optional<Output<PolicyRuleSettingsQuarantineArgs>> quarantine() {
    ...
    private @Nullable Output<PolicyRuleSettingsRedirectArgs> redirect;

    /**
     * @return Apply settings to redirect rules. Settable only for `http` rules with the action set to `redirect`.
     * 
     */
    public Optional<Output<PolicyRuleSettingsRedirectArgs>> redirect() {
    ...
    private @Nullable Output<PolicyRuleSettingsResolveDnsInternallyArgs> resolveDnsInternally;
     ...
     * 
     */
    public Optional<Output<PolicyRuleSettingsResolveDnsInternallyArgs>> resolveDnsInternally() {
    ...
    private @Nullable Output<PolicyRuleSettingsUntrustedCertArgs> untrustedCert;
     ...
     * 
     */
    public Optional<Output<PolicyRuleSettingsUntrustedCertArgs>> untrustedCert() {
        return Optional.ofNullable(this.untrustedCert);
    }

    private PolicyRuleSettingsArgs() {}

    private PolicyRuleSettingsArgs(PolicyRuleSettingsArgs $) {
    ...
    public static Builder builder(PolicyRuleSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyRuleSettingsArgs();
        }

        public Builder(PolicyRuleSettingsArgs defaults) {
            $ = new PolicyRuleSettingsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder auditSsh(@Nullable Output<PolicyRuleSettingsAuditSshArgs> auditSsh) {
            $.auditSsh = auditSsh;
            return this;
        }
         ...
         * 
         */
        public Builder auditSsh(PolicyRuleSettingsAuditSshArgs auditSsh) {
         ...
         * 
         */
        public Builder bisoAdminControls(@Nullable Output<PolicyRuleSettingsBisoAdminControlsArgs> bisoAdminControls) {
         ...
         * 
         */
        public Builder bisoAdminControls(PolicyRuleSettingsBisoAdminControlsArgs bisoAdminControls) {
         ...
         * 
         */
        public Builder blockPage(@Nullable Output<PolicyRuleSettingsBlockPageArgs> blockPage) {
            $.blockPage = blockPage;
            return this;
        }
         ...
         * 
         */
        public Builder blockPage(PolicyRuleSettingsBlockPageArgs blockPage) {
         ...
         * 
         */
        public Builder checkSession(@Nullable Output<PolicyRuleSettingsCheckSessionArgs> checkSession) {
         ...
         * 
         */
        public Builder checkSession(PolicyRuleSettingsCheckSessionArgs checkSession) {
         ...
         * 
         */
        public Builder dnsResolvers(@Nullable Output<PolicyRuleSettingsDnsResolversArgs> dnsResolvers) {
         ...
         * 
         */
        public Builder dnsResolvers(PolicyRuleSettingsDnsResolversArgs dnsResolvers) {
         ...
         * 
         */
        public Builder egress(@Nullable Output<PolicyRuleSettingsEgressArgs> egress) {
            $.egress = egress;
            return this;
        }
         ...
         * 
         */
        public Builder egress(PolicyRuleSettingsEgressArgs egress) {
         ...
         * 
         */
        public Builder forensicCopy(@Nullable Output<PolicyRuleSettingsForensicCopyArgs> forensicCopy) {
         ...
         * 
         */
        public Builder forensicCopy(PolicyRuleSettingsForensicCopyArgs forensicCopy) {
         ...
         * 
         */
        public Builder l4override(@Nullable Output<PolicyRuleSettingsL4overrideArgs> l4override) {
         ...
         * 
         */
        public Builder l4override(PolicyRuleSettingsL4overrideArgs l4override) {
         ...
         * 
         */
        public Builder notificationSettings(@Nullable Output<PolicyRuleSettingsNotificationSettingsArgs> notificationSettings) {
         ...
         * 
         */
        public Builder notificationSettings(PolicyRuleSettingsNotificationSettingsArgs notificationSettings) {
         ...
         * 
         */
        public Builder payloadLog(@Nullable Output<PolicyRuleSettingsPayloadLogArgs> payloadLog) {
         ...
         * 
         */
        public Builder payloadLog(PolicyRuleSettingsPayloadLogArgs payloadLog) {
         ...
         * 
         */
        public Builder quarantine(@Nullable Output<PolicyRuleSettingsQuarantineArgs> quarantine) {
         ...
         * 
         */
        public Builder quarantine(PolicyRuleSettingsQuarantineArgs quarantine) {
         ...
         * 
         */
        public Builder redirect(@Nullable Output<PolicyRuleSettingsRedirectArgs> redirect) {
            $.redirect = redirect;
            return this;
        }
         ...
         * 
         */
        public Builder redirect(PolicyRuleSettingsRedirectArgs redirect) {
         ...
         * 
         */
        public Builder resolveDnsInternally(@Nullable Output<PolicyRuleSettingsResolveDnsInternallyArgs> resolveDnsInternally) {
         ...
         * 
         */
        public Builder resolveDnsInternally(PolicyRuleSettingsResolveDnsInternallyArgs resolveDnsInternally) {
         ...
         * 
         */
        public Builder untrustedCert(@Nullable Output<PolicyRuleSettingsUntrustedCertArgs> untrustedCert) {
         ...
         * 
         */
        public Builder untrustedCert(PolicyRuleSettingsUntrustedCertArgs untrustedCert) {
            return untrustedCert(Output.of(untrustedCert));
        }

        public PolicyRuleSettingsArgs build() {
            return $;
        }
    }
