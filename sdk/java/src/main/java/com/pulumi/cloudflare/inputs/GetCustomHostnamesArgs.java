...
public final class GetCustomHostnamesArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private @Nullable Output<GetCustomHostnamesHostnameArgs> hostname;

    public Optional<Output<GetCustomHostnamesHostnameArgs>> hostname() {
    ...
    public static final class Builder {
        ...
        public Builder hostname(@Nullable Output<GetCustomHostnamesHostnameArgs> hostname) {
            $.hostname = hostname;
            return this;
        }

        public Builder hostname(GetCustomHostnamesHostnameArgs hostname) {
