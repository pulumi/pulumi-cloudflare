...
@CustomType
public final class GetMagicTransitSiteAclsResultLan1 {
    /**
    ...
    private GetMagicTransitSiteAclsResultLan1() {}
    /**
     * @return The identifier for the LAN you want to create an ACL policy with.
     * 
     */
    ...
    public static Builder builder(GetMagicTransitSiteAclsResultLan1 defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> subnets;
        public Builder() {}
        public Builder(GetMagicTransitSiteAclsResultLan1 defaults) {
        ...
        public Builder lanId(String lanId) {
            if (lanId == null) {
              throw new MissingRequiredPropertyException("GetMagicTransitSiteAclsResultLan1", "lanId");
            }
            this.lanId = lanId;
            return this;
        }
        ...
        public Builder lanName(String lanName) {
            if (lanName == null) {
              throw new MissingRequiredPropertyException("GetMagicTransitSiteAclsResultLan1", "lanName");
            }
        ...
        public Builder portRanges(List<String> portRanges) {
            if (portRanges == null) {
              throw new MissingRequiredPropertyException("GetMagicTransitSiteAclsResultLan1", "portRanges");
            }
        ...
        public Builder ports(List<Integer> ports) {
            if (ports == null) {
              throw new MissingRequiredPropertyException("GetMagicTransitSiteAclsResultLan1", "ports");
            }
            this.ports = ports;
            return this;
        }
        ...
        public Builder subnets(List<String> subnets) {
            if (subnets == null) {
              throw new MissingRequiredPropertyException("GetMagicTransitSiteAclsResultLan1", "subnets");
            }
        ...
        public GetMagicTransitSiteAclsResultLan1 build() {
            final var _resultValue = new GetMagicTransitSiteAclsResultLan1();
