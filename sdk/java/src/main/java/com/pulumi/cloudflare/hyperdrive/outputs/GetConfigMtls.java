...
@CustomType
public final class GetConfigMtls {
    /**
    ...
    public static Builder builder(GetConfigMtls defaults) {
    ...
    public static final class Builder {
        ...
        private String sslmode;
        public Builder() {}
        public Builder(GetConfigMtls defaults) {
        ...
        public Builder caCertificateId(String caCertificateId) {
            if (caCertificateId == null) {
              throw new MissingRequiredPropertyException("GetConfigMtls", "caCertificateId");
            }
        ...
        public Builder mtlsCertificateId(String mtlsCertificateId) {
            if (mtlsCertificateId == null) {
              throw new MissingRequiredPropertyException("GetConfigMtls", "mtlsCertificateId");
            }
        ...
        public Builder sslmode(String sslmode) {
            if (sslmode == null) {
              throw new MissingRequiredPropertyException("GetConfigMtls", "sslmode");
            }
            this.sslmode = sslmode;
            return this;
        }
        public GetConfigMtls build() {
            final var _resultValue = new GetConfigMtls();
