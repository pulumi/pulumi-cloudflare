...
@CustomType
public final class GetProjectsResultLatestDeploymentBuildConfig {
    /**
    ...
    private GetProjectsResultLatestDeploymentBuildConfig() {}
    /**
     * @return Enable build caching for the project.
     * 
     */
    ...
    public static Builder builder(GetProjectsResultLatestDeploymentBuildConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String webAnalyticsToken;
        public Builder() {}
        public Builder(GetProjectsResultLatestDeploymentBuildConfig defaults) {
        ...
        public Builder buildCaching(Boolean buildCaching) {
            if (buildCaching == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultLatestDeploymentBuildConfig", "buildCaching");
            }
        ...
        public Builder buildCommand(String buildCommand) {
            if (buildCommand == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultLatestDeploymentBuildConfig", "buildCommand");
            }
        ...
        public Builder destinationDir(String destinationDir) {
            if (destinationDir == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultLatestDeploymentBuildConfig", "destinationDir");
            }
        ...
        public Builder rootDir(String rootDir) {
            if (rootDir == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultLatestDeploymentBuildConfig", "rootDir");
            }
        ...
        public Builder webAnalyticsTag(String webAnalyticsTag) {
            if (webAnalyticsTag == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultLatestDeploymentBuildConfig", "webAnalyticsTag");
            }
        ...
        public Builder webAnalyticsToken(String webAnalyticsToken) {
            if (webAnalyticsToken == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultLatestDeploymentBuildConfig", "webAnalyticsToken");
            }
            this.webAnalyticsToken = webAnalyticsToken;
            return this;
        }
        public GetProjectsResultLatestDeploymentBuildConfig build() {
            final var _resultValue = new GetProjectsResultLatestDeploymentBuildConfig();
