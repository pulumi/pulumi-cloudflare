...
public final class VariantOptionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final VariantOptionsArgs Empty = new VariantOptionsArgs();
    ...
    private VariantOptionsArgs() {}

    private VariantOptionsArgs(VariantOptionsArgs $) {
        this.fit = $.fit;
        this.height = $.height;
    ...
    public static Builder builder(VariantOptionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VariantOptionsArgs();
        }

        public Builder(VariantOptionsArgs defaults) {
            $ = new VariantOptionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VariantOptionsArgs build() {
            if ($.fit == null) {
                throw new MissingRequiredPropertyException("VariantOptionsArgs", "fit");
            }
            if ($.height == null) {
                throw new MissingRequiredPropertyException("VariantOptionsArgs", "height");
            }
            if ($.metadata == null) {
                throw new MissingRequiredPropertyException("VariantOptionsArgs", "metadata");
            }
            if ($.width == null) {
                throw new MissingRequiredPropertyException("VariantOptionsArgs", "width");
            }
            return $;
        }
    }
