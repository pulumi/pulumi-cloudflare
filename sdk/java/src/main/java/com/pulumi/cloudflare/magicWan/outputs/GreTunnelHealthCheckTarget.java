...
@CustomType
public final class GreTunnelHealthCheckTarget {
    /**
    ...
    private GreTunnelHealthCheckTarget() {}
    /**
     * @return The effective health check target. If &#39;saved&#39; is empty, then this field will be populated with the calculated default value on GET requests. Ignored in POST, PUT, and PATCH requests.
     * 
     */
    ...
    public static Builder builder(GreTunnelHealthCheckTarget defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String saved;
        public Builder() {}
        public Builder(GreTunnelHealthCheckTarget defaults) {
        ...
        public GreTunnelHealthCheckTarget build() {
            final var _resultValue = new GreTunnelHealthCheckTarget();
