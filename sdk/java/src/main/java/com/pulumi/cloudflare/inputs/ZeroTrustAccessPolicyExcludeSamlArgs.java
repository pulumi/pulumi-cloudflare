    ...
    public static final class Builder {
        ...
        public ZeroTrustAccessPolicyExcludeSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessPolicyExcludeSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessPolicyExcludeSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessPolicyExcludeSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
