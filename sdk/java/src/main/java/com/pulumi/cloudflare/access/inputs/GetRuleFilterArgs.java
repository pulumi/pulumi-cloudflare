...
import com.pulumi.cloudflare.access.inputs.GetRuleFilterConfigurationArgs;
...
public final class GetRuleFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<GetRuleFilterConfigurationArgs> configuration;

    public Optional<Output<GetRuleFilterConfigurationArgs>> configuration() {
    ...
    public static final class Builder {
        ...
        public Builder configuration(@Nullable Output<GetRuleFilterConfigurationArgs> configuration) {
            $.configuration = configuration;
            return this;
        }

        public Builder configuration(GetRuleFilterConfigurationArgs configuration) {
        ...
        public GetRuleFilterArgs build() {
            if ($.match == null) {
                throw new MissingRequiredPropertyException("GetRuleFilterArgs", "match");
            }
            return $;
        }
    }
