...
@CustomType
public final class ProjectSourceConfig {
    /**
    ...
    public static Builder builder(ProjectSourceConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repoName;
        public Builder() {}
        public Builder(ProjectSourceConfig defaults) {
        ...
        public ProjectSourceConfig build() {
            final var _resultValue = new ProjectSourceConfig();
