...
@CustomType
public final class GetInstanceRetrievalOptionsBoostBy {
    /**
    ...
    private GetInstanceRetrievalOptionsBoostBy() {}
    /**
     * @return Boost direction. &#39;desc&#39; = higher values rank higher (e.g. newer timestamps). &#39;asc&#39; = lower values rank higher. &#39;exists&#39; = boost chunks that have the field. &#39;not*exists&#39; = boost chunks that lack the field. Optional — defaults to &#39;asc&#39; for numeric/datetime fields, &#39;exists&#39; for text/boolean fields.
     * Available values: &#34;asc&#34;, &#34;desc&#34;, &#34;exists&#34;, &#34;not*exists&#34;.
     * 
    ...
    public static Builder builder(GetInstanceRetrievalOptionsBoostBy defaults) {
    ...
    public static final class Builder {
        ...
        private String field;
        public Builder() {}
        public Builder(GetInstanceRetrievalOptionsBoostBy defaults) {
        ...
        public Builder direction(String direction) {
            if (direction == null) {
              throw new MissingRequiredPropertyException("GetInstanceRetrievalOptionsBoostBy", "direction");
            }
        ...
        public Builder field(String field) {
            if (field == null) {
              throw new MissingRequiredPropertyException("GetInstanceRetrievalOptionsBoostBy", "field");
            }
            this.field = field;
            return this;
        }
        public GetInstanceRetrievalOptionsBoostBy build() {
            final var _resultValue = new GetInstanceRetrievalOptionsBoostBy();
