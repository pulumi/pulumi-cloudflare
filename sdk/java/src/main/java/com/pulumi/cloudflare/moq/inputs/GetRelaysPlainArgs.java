...
public final class GetRelaysPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetRelaysPlainArgs Empty = new GetRelaysPlainArgs();
    ...
    private GetRelaysPlainArgs() {}

    private GetRelaysPlainArgs(GetRelaysPlainArgs $) {
    ...
    public static Builder builder(GetRelaysPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRelaysPlainArgs();
        }

        public Builder(GetRelaysPlainArgs defaults) {
            $ = new GetRelaysPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRelaysPlainArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetRelaysPlainArgs", "accountId");
            }
            return $;
        }
    }
