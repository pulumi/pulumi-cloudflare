...
@CustomType
public final class GetHostnamesResultSslSettings {
    /**
    ...
    private GetHostnamesResultSslSettings() {}
    /**
     * @return An allowlist of ciphers for TLS termination. These ciphers must be in the BoringSSL format.
     * 
     */
    ...
    public static Builder builder(GetHostnamesResultSslSettings defaults) {
    ...
    public static final class Builder {
        ...
        private String tls13;
        public Builder() {}
        public Builder(GetHostnamesResultSslSettings defaults) {
        ...
        public Builder ciphers(List<String> ciphers) {
            if (ciphers == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResultSslSettings", "ciphers");
            }
        ...
        public Builder earlyHints(String earlyHints) {
            if (earlyHints == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResultSslSettings", "earlyHints");
            }
        ...
        public Builder http2(String http2) {
            if (http2 == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResultSslSettings", "http2");
            }
            this.http2 = http2;
            return this;
        }
        ...
        public Builder minTlsVersion(String minTlsVersion) {
            if (minTlsVersion == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResultSslSettings", "minTlsVersion");
            }
        ...
        public Builder tls13(String tls13) {
            if (tls13 == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResultSslSettings", "tls13");
            }
            this.tls13 = tls13;
            return this;
        }
        public GetHostnamesResultSslSettings build() {
            final var _resultValue = new GetHostnamesResultSslSettings();
