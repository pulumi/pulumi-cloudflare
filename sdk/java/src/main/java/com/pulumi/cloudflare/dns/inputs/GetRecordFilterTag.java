...
public final class GetRecordFilterTag extends com.pulumi.resources.InvokeArgs {

    public static final GetRecordFilterTag Empty = new GetRecordFilterTag();
    ...
    private GetRecordFilterTag() {}

    private GetRecordFilterTag(GetRecordFilterTag $) {
        this.absent = $.absent;
    ...
    public static Builder builder(GetRecordFilterTag defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRecordFilterTag();
        }

        public Builder(GetRecordFilterTag defaults) {
            $ = new GetRecordFilterTag(Objects.requireNonNull(defaults));
        }
        ...
        public GetRecordFilterTag build() {
            return $;
        }
    }
