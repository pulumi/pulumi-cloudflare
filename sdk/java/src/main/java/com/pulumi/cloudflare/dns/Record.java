...
import com.pulumi.cloudflare.dns.inputs.RecordState;
import com.pulumi.cloudflare.dns.outputs.RecordData;
import com.pulumi.cloudflare.dns.outputs.RecordSettings;
 ...
 * 
 * ```sh
 * $ pulumi import cloudflare:dns/record:Record example &#39;&lt;zone_id&gt;/&lt;dns_record_id&gt;&#39;
 * ```
 * 
 */
@ResourceType(type="cloudflare:dns/record:Record")
public class Record extends com.pulumi.resources.CustomResource {
    ...
    public Record(java.lang.String name, RecordArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:dns/record:Record", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Record(java.lang.String name, Output<java.lang.String> id, @Nullable RecordState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:dns/record:Record", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("cloudflare:index/dnsRecord:DnsRecord").build())
            ))
            .build();
