...
@CustomType
public final class GetIpsecTunnelIpsecTunnelBgpStatus {
    ...
    private GetIpsecTunnelIpsecTunnelBgpStatus() {}
    ...
    public static Builder builder(GetIpsecTunnelIpsecTunnelBgpStatus defaults) {
    ...
    public static final class Builder {
        ...
        private String updatedAt;
        public Builder() {}
        public Builder(GetIpsecTunnelIpsecTunnelBgpStatus defaults) {
        ...
        public Builder bgpState(String bgpState) {
            if (bgpState == null) {
              throw new MissingRequiredPropertyException("GetIpsecTunnelIpsecTunnelBgpStatus", "bgpState");
            }
        ...
        public Builder cfSpeakerIp(String cfSpeakerIp) {
            if (cfSpeakerIp == null) {
              throw new MissingRequiredPropertyException("GetIpsecTunnelIpsecTunnelBgpStatus", "cfSpeakerIp");
            }
        ...
        public Builder cfSpeakerPort(Integer cfSpeakerPort) {
            if (cfSpeakerPort == null) {
              throw new MissingRequiredPropertyException("GetIpsecTunnelIpsecTunnelBgpStatus", "cfSpeakerPort");
            }
        ...
        public Builder customerSpeakerIp(String customerSpeakerIp) {
            if (customerSpeakerIp == null) {
              throw new MissingRequiredPropertyException("GetIpsecTunnelIpsecTunnelBgpStatus", "customerSpeakerIp");
            }
        ...
        public Builder customerSpeakerPort(Integer customerSpeakerPort) {
            if (customerSpeakerPort == null) {
              throw new MissingRequiredPropertyException("GetIpsecTunnelIpsecTunnelBgpStatus", "customerSpeakerPort");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetIpsecTunnelIpsecTunnelBgpStatus", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder tcpEstablished(Boolean tcpEstablished) {
            if (tcpEstablished == null) {
              throw new MissingRequiredPropertyException("GetIpsecTunnelIpsecTunnelBgpStatus", "tcpEstablished");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetIpsecTunnelIpsecTunnelBgpStatus", "updatedAt");
            }
            this.updatedAt = updatedAt;
            return this;
        }
        public GetIpsecTunnelIpsecTunnelBgpStatus build() {
            final var _resultValue = new GetIpsecTunnelIpsecTunnelBgpStatus();
