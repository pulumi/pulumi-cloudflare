...
import com.pulumi.cloudflare.logpush.inputs.JobState;
import com.pulumi.cloudflare.logpush.outputs.JobOutputOptions;
 ...
 * 
 */
@ResourceType(type="cloudflare:logpush/job:Job")
public class Job extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="outputOptions", refs={JobOutputOptions.class}, tree="[0]")
    private Output</* @Nullable */ JobOutputOptions> outputOptions;

    /**
     * @return The structured replacement for `logpullOptions`. When including this field, the `logpullOption` field will be ignored.
     * 
     */
    public Output<Optional<JobOutputOptions>> outputOptions() {
    ...
    public Job(java.lang.String name, JobArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:logpush/job:Job", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Job(java.lang.String name, Output<java.lang.String> id, @Nullable JobState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:logpush/job:Job", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/logpushJob:LogpushJob").build())
            ))
