...
public final class MagicTransitSiteAclLan2Args extends com.pulumi.resources.ResourceArgs {

    public static final MagicTransitSiteAclLan2Args Empty = new MagicTransitSiteAclLan2Args();
    ...
    private MagicTransitSiteAclLan2Args() {}

    private MagicTransitSiteAclLan2Args(MagicTransitSiteAclLan2Args $) {
        this.lanId = $.lanId;
    ...
    public static Builder builder(MagicTransitSiteAclLan2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagicTransitSiteAclLan2Args();
        }

        public Builder(MagicTransitSiteAclLan2Args defaults) {
            $ = new MagicTransitSiteAclLan2Args(Objects.requireNonNull(defaults));
        }
        ...
        public MagicTransitSiteAclLan2Args build() {
            if ($.lanId == null) {
                throw new MissingRequiredPropertyException("MagicTransitSiteAclLan2Args", "lanId");
            }
            return $;
        }
    }
