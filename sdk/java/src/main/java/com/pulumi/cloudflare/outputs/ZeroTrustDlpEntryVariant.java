...
@CustomType
public final class ZeroTrustDlpEntryVariant {
    ...
    private ZeroTrustDlpEntryVariant() {}
    ...
    public static Builder builder(ZeroTrustDlpEntryVariant defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(ZeroTrustDlpEntryVariant defaults) {
        ...
        public ZeroTrustDlpEntryVariant build() {
            final var _resultValue = new ZeroTrustDlpEntryVariant();
