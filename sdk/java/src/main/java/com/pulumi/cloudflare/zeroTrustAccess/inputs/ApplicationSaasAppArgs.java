...
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationSaasAppCustomAttributeArgs;
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationSaasAppCustomClaimArgs;
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationSaasAppHybridAndImplicitOptionsArgs;
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationSaasAppRefreshTokenOptionsArgs;
...
public final class ApplicationSaasAppArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationSaasAppArgs Empty = new ApplicationSaasAppArgs();
    ...
    private @Nullable Output<List<ApplicationSaasAppCustomAttributeArgs>> customAttributes;

    public Optional<Output<List<ApplicationSaasAppCustomAttributeArgs>>> customAttributes() {
        return Optional.ofNullable(this.customAttributes);
    }

    @Import(name="customClaims")
    private @Nullable Output<List<ApplicationSaasAppCustomClaimArgs>> customClaims;

    public Optional<Output<List<ApplicationSaasAppCustomClaimArgs>>> customClaims() {
    ...
    private @Nullable Output<ApplicationSaasAppHybridAndImplicitOptionsArgs> hybridAndImplicitOptions;

    public Optional<Output<ApplicationSaasAppHybridAndImplicitOptionsArgs>> hybridAndImplicitOptions() {
    ...
    private @Nullable Output<ApplicationSaasAppRefreshTokenOptionsArgs> refreshTokenOptions;

    public Optional<Output<ApplicationSaasAppRefreshTokenOptionsArgs>> refreshTokenOptions() {
    ...
    private ApplicationSaasAppArgs() {}

    private ApplicationSaasAppArgs(ApplicationSaasAppArgs $) {
    ...
    public static Builder builder(ApplicationSaasAppArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationSaasAppArgs();
        }

        public Builder(ApplicationSaasAppArgs defaults) {
            $ = new ApplicationSaasAppArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder customAttributes(@Nullable Output<List<ApplicationSaasAppCustomAttributeArgs>> customAttributes) {
            $.customAttributes = customAttributes;
            return this;
        }

        public Builder customAttributes(List<ApplicationSaasAppCustomAttributeArgs> customAttributes) {
            return customAttributes(Output.of(customAttributes));
        }

        public Builder customAttributes(ApplicationSaasAppCustomAttributeArgs... customAttributes) {
            return customAttributes(List.of(customAttributes));
        }

        public Builder customClaims(@Nullable Output<List<ApplicationSaasAppCustomClaimArgs>> customClaims) {
            $.customClaims = customClaims;
            return this;
        }

        public Builder customClaims(List<ApplicationSaasAppCustomClaimArgs> customClaims) {
            return customClaims(Output.of(customClaims));
        }

        public Builder customClaims(ApplicationSaasAppCustomClaimArgs... customClaims) {
        ...
        public Builder hybridAndImplicitOptions(@Nullable Output<ApplicationSaasAppHybridAndImplicitOptionsArgs> hybridAndImplicitOptions) {
            $.hybridAndImplicitOptions = hybridAndImplicitOptions;
            return this;
        }

        public Builder hybridAndImplicitOptions(ApplicationSaasAppHybridAndImplicitOptionsArgs hybridAndImplicitOptions) {
        ...
        public Builder refreshTokenOptions(@Nullable Output<ApplicationSaasAppRefreshTokenOptionsArgs> refreshTokenOptions) {
            $.refreshTokenOptions = refreshTokenOptions;
            return this;
        }

        public Builder refreshTokenOptions(ApplicationSaasAppRefreshTokenOptionsArgs refreshTokenOptions) {
        ...
        public ApplicationSaasAppArgs build() {
            return $;
        }
    }
