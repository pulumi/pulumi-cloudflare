...
@CustomType
public final class GetAccountDnsSettingsZoneDefaultsSoa {
    /**
    ...
    private GetAccountDnsSettingsZoneDefaultsSoa() {}
    /**
     * @return Time in seconds of being unable to query the primary server after which secondary servers should stop serving the zone.
     * 
     */
    ...
    public static Builder builder(GetAccountDnsSettingsZoneDefaultsSoa defaults) {
    ...
    public static final class Builder {
        ...
        private Double ttl;
        public Builder() {}
        public Builder(GetAccountDnsSettingsZoneDefaultsSoa defaults) {
        ...
        public Builder expire(Double expire) {
            if (expire == null) {
              throw new MissingRequiredPropertyException("GetAccountDnsSettingsZoneDefaultsSoa", "expire");
            }
            this.expire = expire;
            return this;
        }
        ...
        public Builder minTtl(Double minTtl) {
            if (minTtl == null) {
              throw new MissingRequiredPropertyException("GetAccountDnsSettingsZoneDefaultsSoa", "minTtl");
            }
            this.minTtl = minTtl;
            return this;
        }
        ...
        public Builder mname(String mname) {
            if (mname == null) {
              throw new MissingRequiredPropertyException("GetAccountDnsSettingsZoneDefaultsSoa", "mname");
            }
            this.mname = mname;
            return this;
        }
        ...
        public Builder refresh(Double refresh) {
            if (refresh == null) {
              throw new MissingRequiredPropertyException("GetAccountDnsSettingsZoneDefaultsSoa", "refresh");
            }
        ...
        public Builder retry(Double retry) {
            if (retry == null) {
              throw new MissingRequiredPropertyException("GetAccountDnsSettingsZoneDefaultsSoa", "retry");
            }
            this.retry = retry;
            return this;
        }
        ...
        public Builder rname(String rname) {
            if (rname == null) {
              throw new MissingRequiredPropertyException("GetAccountDnsSettingsZoneDefaultsSoa", "rname");
            }
            this.rname = rname;
            return this;
        }
        ...
        public Builder ttl(Double ttl) {
            if (ttl == null) {
              throw new MissingRequiredPropertyException("GetAccountDnsSettingsZoneDefaultsSoa", "ttl");
            }
            this.ttl = ttl;
            return this;
        }
        public GetAccountDnsSettingsZoneDefaultsSoa build() {
            final var _resultValue = new GetAccountDnsSettingsZoneDefaultsSoa();
