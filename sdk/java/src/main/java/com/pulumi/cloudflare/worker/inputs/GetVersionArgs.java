...
public final class GetVersionArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetVersionArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetVersionArgs", "accountId");
            }
            if ($.versionId == null) {
                throw new MissingRequiredPropertyException("GetVersionArgs", "versionId");
            }
            if ($.workerId == null) {
                throw new MissingRequiredPropertyException("GetVersionArgs", "workerId");
            }
            return $;
        }
    }
