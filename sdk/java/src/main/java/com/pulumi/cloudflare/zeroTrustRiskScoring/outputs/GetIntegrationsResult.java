...
@CustomType
public final class GetIntegrationsResult {
    /**
    ...
    public static Builder builder(GetIntegrationsResult defaults) {
    ...
    public static final class Builder {
        ...
        private String wellKnownUrl;
        public Builder() {}
        public Builder(GetIntegrationsResult defaults) {
        ...
        public Builder accountTag(String accountTag) {
            if (accountTag == null) {
              throw new MissingRequiredPropertyException("GetIntegrationsResult", "accountTag");
            }
        ...
        public Builder active(Boolean active) {
            if (active == null) {
              throw new MissingRequiredPropertyException("GetIntegrationsResult", "active");
            }
            this.active = active;
            return this;
        }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetIntegrationsResult", "createdAt");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetIntegrationsResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder integrationType(String integrationType) {
            if (integrationType == null) {
              throw new MissingRequiredPropertyException("GetIntegrationsResult", "integrationType");
            }
        ...
        public Builder referenceId(String referenceId) {
            if (referenceId == null) {
              throw new MissingRequiredPropertyException("GetIntegrationsResult", "referenceId");
            }
        ...
        public Builder tenantUrl(String tenantUrl) {
            if (tenantUrl == null) {
              throw new MissingRequiredPropertyException("GetIntegrationsResult", "tenantUrl");
            }
        ...
        public Builder wellKnownUrl(String wellKnownUrl) {
            if (wellKnownUrl == null) {
              throw new MissingRequiredPropertyException("GetIntegrationsResult", "wellKnownUrl");
            }
            this.wellKnownUrl = wellKnownUrl;
            return this;
        }
        public GetIntegrationsResult build() {
            final var _resultValue = new GetIntegrationsResult();
