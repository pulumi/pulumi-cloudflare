...
import com.pulumi.cloudflare.inputs.ZeroTrustAccessApplicationPolicyConnectionRulesArgs;
import com.pulumi.cloudflare.inputs.ZeroTrustAccessApplicationPolicyExcludeArgs;
import com.pulumi.cloudflare.inputs.ZeroTrustAccessApplicationPolicyIncludeArgs;
import com.pulumi.cloudflare.inputs.ZeroTrustAccessApplicationPolicyMfaConfigArgs;
import com.pulumi.cloudflare.inputs.ZeroTrustAccessApplicationPolicyRequireArgs;
...
public final class ZeroTrustAccessApplicationPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZeroTrustAccessApplicationPolicyArgs Empty = new ZeroTrustAccessApplicationPolicyArgs();
    ...
    private @Nullable Output<ZeroTrustAccessApplicationPolicyConnectionRulesArgs> connectionRules;

    /**
     * @return The rules that define how users may connect to the targets secured by your application.
     * 
     */
    public Optional<Output<ZeroTrustAccessApplicationPolicyConnectionRulesArgs>> connectionRules() {
    ...
    private @Nullable Output<List<ZeroTrustAccessApplicationPolicyExcludeArgs>> excludes;

    /**
     * @return Rules evaluated with a NOT logical operator. To match the policy, a user cannot meet any of the Exclude rules.
     * 
     */
    public Optional<Output<List<ZeroTrustAccessApplicationPolicyExcludeArgs>>> excludes() {
    ...
    private @Nullable Output<List<ZeroTrustAccessApplicationPolicyIncludeArgs>> includes;

    /**
     * @return Rules evaluated with an OR logical operator. A user needs to meet only one of the Include rules.
     * 
     */
    public Optional<Output<List<ZeroTrustAccessApplicationPolicyIncludeArgs>>> includes() {
    ...
    private @Nullable Output<ZeroTrustAccessApplicationPolicyMfaConfigArgs> mfaConfig;
     ...
     * 
     */
    public Optional<Output<ZeroTrustAccessApplicationPolicyMfaConfigArgs>> mfaConfig() {
    ...
    private @Nullable Output<List<ZeroTrustAccessApplicationPolicyRequireArgs>> requires;

    /**
     * @return Rules evaluated with an AND logical operator. To match the policy, a user must meet all of the Require rules.
     * 
     */
    public Optional<Output<List<ZeroTrustAccessApplicationPolicyRequireArgs>>> requires() {
        return Optional.ofNullable(this.requires);
    }

    private ZeroTrustAccessApplicationPolicyArgs() {}

    private ZeroTrustAccessApplicationPolicyArgs(ZeroTrustAccessApplicationPolicyArgs $) {
    ...
    public static Builder builder(ZeroTrustAccessApplicationPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustAccessApplicationPolicyArgs();
        }

        public Builder(ZeroTrustAccessApplicationPolicyArgs defaults) {
            $ = new ZeroTrustAccessApplicationPolicyArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder connectionRules(@Nullable Output<ZeroTrustAccessApplicationPolicyConnectionRulesArgs> connectionRules) {
         ...
         * 
         */
        public Builder connectionRules(ZeroTrustAccessApplicationPolicyConnectionRulesArgs connectionRules) {
         ...
         * 
         */
        public Builder excludes(@Nullable Output<List<ZeroTrustAccessApplicationPolicyExcludeArgs>> excludes) {
            $.excludes = excludes;
            return this;
        }
         ...
         * 
         */
        public Builder excludes(List<ZeroTrustAccessApplicationPolicyExcludeArgs> excludes) {
         ...
         * 
         */
        public Builder excludes(ZeroTrustAccessApplicationPolicyExcludeArgs... excludes) {
         ...
         * 
         */
        public Builder includes(@Nullable Output<List<ZeroTrustAccessApplicationPolicyIncludeArgs>> includes) {
            $.includes = includes;
            return this;
        }
         ...
         * 
         */
        public Builder includes(List<ZeroTrustAccessApplicationPolicyIncludeArgs> includes) {
         ...
         * 
         */
        public Builder includes(ZeroTrustAccessApplicationPolicyIncludeArgs... includes) {
         ...
         * 
         */
        public Builder mfaConfig(@Nullable Output<ZeroTrustAccessApplicationPolicyMfaConfigArgs> mfaConfig) {
            $.mfaConfig = mfaConfig;
            return this;
        }
         ...
         * 
         */
        public Builder mfaConfig(ZeroTrustAccessApplicationPolicyMfaConfigArgs mfaConfig) {
         ...
         * 
         */
        public Builder requires(@Nullable Output<List<ZeroTrustAccessApplicationPolicyRequireArgs>> requires) {
            $.requires = requires;
            return this;
        }
         ...
         * 
         */
        public Builder requires(List<ZeroTrustAccessApplicationPolicyRequireArgs> requires) {
         ...
         * 
         */
        public Builder requires(ZeroTrustAccessApplicationPolicyRequireArgs... requires) {
            return requires(List.of(requires));
        }

        public ZeroTrustAccessApplicationPolicyArgs build() {
            return $;
        }
    }
