...
import com.pulumi.cloudflare.loadBalancer.outputs.PoolOriginHeader;
...
public final class PoolOrigin {
     ...
     * 
     */
    private @Nullable PoolOriginHeader header;
    /**
     ...
     * 
     */
    public Optional<PoolOriginHeader> header() {
    ...
    public static Builder builder(PoolOrigin defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double weight;
        public Builder() {}
        public Builder(PoolOrigin defaults) {
        ...
        @CustomType.Setter
        public Builder header(@Nullable PoolOriginHeader header) {
        ...
        public PoolOrigin build() {
            final var _resultValue = new PoolOrigin();
