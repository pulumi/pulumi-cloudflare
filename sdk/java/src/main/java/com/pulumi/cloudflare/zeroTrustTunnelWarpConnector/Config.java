...
import com.pulumi.cloudflare.zeroTrustTunnelWarpConnector.inputs.ConfigState;
import com.pulumi.cloudflare.zeroTrustTunnelWarpConnector.outputs.ConfigConfig;
 ...
 * 
 */
@ResourceType(type="cloudflare:zeroTrustTunnelWarpConnector/config:Config")
public class Config extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ ConfigConfig> config;
     ...
     * 
     */
    public Output<Optional<ConfigConfig>> config() {
    ...
    public Config(java.lang.String name, ConfigArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zeroTrustTunnelWarpConnector/config:Config", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Config(java.lang.String name, Output<java.lang.String> id, @Nullable ConfigState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zeroTrustTunnelWarpConnector/config:Config", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/zeroTrustTunnelWarpConnectorConfig:ZeroTrustTunnelWarpConnectorConfig").build())
            ))
            .build();
