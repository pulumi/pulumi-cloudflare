...
@CustomType
public final class GetHoldResult {
    ...
    public static Builder builder(GetHoldResult defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String zoneId;
        public Builder() {}
        public Builder(GetHoldResult defaults) {
        ...
        public Builder hold(Boolean hold) {
            if (hold == null) {
              throw new MissingRequiredPropertyException("GetHoldResult", "hold");
            }
            this.hold = hold;
            return this;
        }
        ...
        public Builder holdAfter(String holdAfter) {
            if (holdAfter == null) {
              throw new MissingRequiredPropertyException("GetHoldResult", "holdAfter");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetHoldResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder includeSubdomains(String includeSubdomains) {
            if (includeSubdomains == null) {
              throw new MissingRequiredPropertyException("GetHoldResult", "includeSubdomains");
            }
        ...
        public GetHoldResult build() {
            final var _resultValue = new GetHoldResult();
