...
import com.pulumi.cloudflare.magicTransitSite.outputs.GetWanStaticAddressing;
...
@CustomType
public final class GetWanResult {
    /**
     * @return Identifier
     * 
     */
     ...
     * 
     */
    private GetWanStaticAddressing staticAddressing;
    /**
     ...
     * 
     */
    public GetWanStaticAddressing staticAddressing() {
    ...
    public static Builder builder(GetWanResult defaults) {
    ...
    public static final class Builder {
        ...
        private String wanId;
        public Builder() {}
        public Builder(GetWanResult defaults) {
        ...
        public Builder accountId(String accountId) {
            if (accountId == null) {
              throw new MissingRequiredPropertyException("GetWanResult", "accountId");
            }
        ...
        public Builder healthCheckRate(String healthCheckRate) {
            if (healthCheckRate == null) {
              throw new MissingRequiredPropertyException("GetWanResult", "healthCheckRate");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetWanResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetWanResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder physport(Integer physport) {
            if (physport == null) {
              throw new MissingRequiredPropertyException("GetWanResult", "physport");
            }
        ...
        public Builder priority(Integer priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("GetWanResult", "priority");
            }
        ...
        public Builder siteId(String siteId) {
            if (siteId == null) {
              throw new MissingRequiredPropertyException("GetWanResult", "siteId");
            }
            this.siteId = siteId;
            return this;
        }
        @CustomType.Setter
        public Builder staticAddressing(GetWanStaticAddressing staticAddressing) {
            if (staticAddressing == null) {
              throw new MissingRequiredPropertyException("GetWanResult", "staticAddressing");
            }
        ...
        public Builder vlanTag(Integer vlanTag) {
            if (vlanTag == null) {
              throw new MissingRequiredPropertyException("GetWanResult", "vlanTag");
            }
        ...
        public Builder wanId(String wanId) {
            if (wanId == null) {
              throw new MissingRequiredPropertyException("GetWanResult", "wanId");
            }
            this.wanId = wanId;
            return this;
        }
        public GetWanResult build() {
            final var _resultValue = new GetWanResult();
