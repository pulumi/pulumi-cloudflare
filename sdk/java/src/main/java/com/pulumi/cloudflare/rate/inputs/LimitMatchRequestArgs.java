...
public final class LimitMatchRequestArgs extends com.pulumi.resources.ResourceArgs {

    public static final LimitMatchRequestArgs Empty = new LimitMatchRequestArgs();
    ...
    private LimitMatchRequestArgs() {}

    private LimitMatchRequestArgs(LimitMatchRequestArgs $) {
    ...
    public static Builder builder(LimitMatchRequestArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LimitMatchRequestArgs();
        }

        public Builder(LimitMatchRequestArgs defaults) {
            $ = new LimitMatchRequestArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LimitMatchRequestArgs build() {
            return $;
        }
    }
