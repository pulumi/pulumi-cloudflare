...
import com.pulumi.cloudflare.loadBalancer.inputs.LoadBalancerState;
import com.pulumi.cloudflare.loadBalancer.outputs.LoadBalancerAdaptiveRouting;
import com.pulumi.cloudflare.loadBalancer.outputs.LoadBalancerLocationStrategy;
import com.pulumi.cloudflare.loadBalancer.outputs.LoadBalancerRandomSteering;
import com.pulumi.cloudflare.loadBalancer.outputs.LoadBalancerRule;
import com.pulumi.cloudflare.loadBalancer.outputs.LoadBalancerSessionAffinityAttributes;
 ...
 * 
 */
@ResourceType(type="cloudflare:loadBalancer/loadBalancer:LoadBalancer")
public class LoadBalancer extends com.pulumi.resources.CustomResource {
    ...
    public LoadBalancer(java.lang.String name, LoadBalancerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:loadBalancer/loadBalancer:LoadBalancer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private LoadBalancer(java.lang.String name, Output<java.lang.String> id, @Nullable LoadBalancerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:loadBalancer/loadBalancer:LoadBalancer", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/loadBalancer:LoadBalancer").build())
            ))
            .build();
