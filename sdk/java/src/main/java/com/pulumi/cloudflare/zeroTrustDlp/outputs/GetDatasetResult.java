...
import com.pulumi.cloudflare.zeroTrustDlp.outputs.GetDatasetColumn;
import com.pulumi.cloudflare.zeroTrustDlp.outputs.GetDatasetUpload;
...
public final class GetDatasetResult {
    ...
    private List<GetDatasetColumn> columns;
    ...
    private List<GetDatasetUpload> uploads;
    ...
    public List<GetDatasetColumn> columns() {
        return this.columns;
    }
    ...
    public List<GetDatasetUpload> uploads() {
        return this.uploads;
    }
    ...
    public static final class Builder {
        ...
        public Builder caseSensitive(Boolean caseSensitive) {
            if (caseSensitive == null) {
              throw new MissingRequiredPropertyException("GetDatasetResult", "caseSensitive");
            }
            this.caseSensitive = caseSensitive;
            return this;
        }
        @CustomType.Setter
        public Builder columns(List<GetDatasetColumn> columns) {
            if (columns == null) {
              throw new MissingRequiredPropertyException("GetDatasetResult", "columns");
            }
            this.columns = columns;
            return this;
        }
        public Builder columns(GetDatasetColumn... columns) {
            return columns(List.of(columns));
        }
        @CustomType.Setter
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetDatasetResult", "createdAt");
            }
        ...
        public Builder encodingVersion(Integer encodingVersion) {
            if (encodingVersion == null) {
              throw new MissingRequiredPropertyException("GetDatasetResult", "encodingVersion");
            }
        ...
        public Builder numCells(Integer numCells) {
            if (numCells == null) {
              throw new MissingRequiredPropertyException("GetDatasetResult", "numCells");
            }
        ...
        public Builder secret(Boolean secret) {
            if (secret == null) {
              throw new MissingRequiredPropertyException("GetDatasetResult", "secret");
            }
            this.secret = secret;
            return this;
        }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetDatasetResult", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetDatasetResult", "updatedAt");
            }
            this.updatedAt = updatedAt;
            return this;
        }
        @CustomType.Setter
        public Builder uploads(List<GetDatasetUpload> uploads) {
            if (uploads == null) {
              throw new MissingRequiredPropertyException("GetDatasetResult", "uploads");
            }
            this.uploads = uploads;
            return this;
        }
        public Builder uploads(GetDatasetUpload... uploads) {
