...
public final class PagesProjectDeploymentConfigsProductionVectorizeBindings {
    ...
    public static Builder builder(PagesProjectDeploymentConfigsProductionVectorizeBindings defaults) {
    ...
    public static final class Builder {
        ...
        public PagesProjectDeploymentConfigsProductionVectorizeBindings build() {
            final var _resultValue = new PagesProjectDeploymentConfigsProductionVectorizeBindings();
