...
@CustomType
public final class ZeroTrustAccessGroupExcludeGithub {
    private @Nullable String identityProviderId;
    private @Nullable String name;
    private @Nullable List<String> teams;

    private ZeroTrustAccessGroupExcludeGithub() {}
    ...
    public static Builder builder(ZeroTrustAccessGroupExcludeGithub defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> teams;
        public Builder() {}
        public Builder(ZeroTrustAccessGroupExcludeGithub defaults) {
        ...
        public ZeroTrustAccessGroupExcludeGithub build() {
            final var _resultValue = new ZeroTrustAccessGroupExcludeGithub();
