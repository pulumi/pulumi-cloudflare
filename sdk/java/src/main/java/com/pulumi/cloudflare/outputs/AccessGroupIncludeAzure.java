...
@CustomType
public final class AccessGroupIncludeAzure {
    /**
    ...
    public static Builder builder(AccessGroupIncludeAzure defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> ids;
        public Builder() {}
        public Builder(AccessGroupIncludeAzure defaults) {
        ...
        public AccessGroupIncludeAzure build() {
            final var _resultValue = new AccessGroupIncludeAzure();
