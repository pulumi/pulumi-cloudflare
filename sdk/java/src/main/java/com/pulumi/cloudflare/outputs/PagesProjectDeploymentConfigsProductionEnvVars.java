...
public final class PagesProjectDeploymentConfigsProductionEnvVars {
    ...
    public static Builder builder(PagesProjectDeploymentConfigsProductionEnvVars defaults) {
    ...
    public static final class Builder {
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("PagesProjectDeploymentConfigsProductionEnvVars", "value");
            }
            this.value = value;
            return this;
        }
        public PagesProjectDeploymentConfigsProductionEnvVars build() {
            final var _resultValue = new PagesProjectDeploymentConfigsProductionEnvVars();
