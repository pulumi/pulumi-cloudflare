...
public final class LockdownState extends com.pulumi.resources.ResourceArgs {

    public static final LockdownState Empty = new LockdownState();
    ...
    private @Nullable Output<List<LockdownConfigurationArgs>> configurations;
     ...
     * 
     */
    public Optional<Output<List<LockdownConfigurationArgs>>> configurations() {
    ...
    public static Builder builder(LockdownState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LockdownState defaults) {
            $ = new LockdownState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder configurations(@Nullable Output<List<LockdownConfigurationArgs>> configurations) {
