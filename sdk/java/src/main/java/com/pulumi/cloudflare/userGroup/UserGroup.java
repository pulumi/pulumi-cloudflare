...
import com.pulumi.cloudflare.userGroup.inputs.UserGroupState;
import com.pulumi.cloudflare.userGroup.outputs.UserGroupPolicy;
 ...
 * 
 */
@ResourceType(type="cloudflare:userGroup/userGroup:UserGroup")
public class UserGroup extends com.pulumi.resources.CustomResource {
    ...
    public UserGroup(java.lang.String name, UserGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:userGroup/userGroup:UserGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private UserGroup(java.lang.String name, Output<java.lang.String> id, @Nullable UserGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:userGroup/userGroup:UserGroup", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/userGroup:UserGroup").build())
            ))
            .build();
