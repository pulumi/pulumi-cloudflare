...
public final class TunnelVirtualNetworkState extends com.pulumi.resources.ResourceArgs {
    ...
    private TunnelVirtualNetworkState() {}
    ...
    public static Builder builder(TunnelVirtualNetworkState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TunnelVirtualNetworkState();
        }

        public Builder(TunnelVirtualNetworkState defaults) {
            $ = new TunnelVirtualNetworkState(Objects.requireNonNull(defaults));
        }
        ...
        public TunnelVirtualNetworkState build() {
            return $;
        }
    }
