...
@CustomType
public final class GetWaitingRoomAdditionalRoute {
    /**
    ...
    private GetWaitingRoomAdditionalRoute() {}
    /**
     * @return The hostname to which this waiting room will be applied (no wildcards). The hostname must be the primary domain, subdomain, or custom hostname (if using SSL for SaaS) of this zone. Please do not include the scheme (http:// or https://).
     * 
     */
    ...
    public static Builder builder(GetWaitingRoomAdditionalRoute defaults) {
    ...
    public static final class Builder {
        ...
        private String path;
        public Builder() {}
        public Builder(GetWaitingRoomAdditionalRoute defaults) {
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("GetWaitingRoomAdditionalRoute", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder path(String path) {
            if (path == null) {
              throw new MissingRequiredPropertyException("GetWaitingRoomAdditionalRoute", "path");
            }
            this.path = path;
            return this;
        }
        public GetWaitingRoomAdditionalRoute build() {
            final var _resultValue = new GetWaitingRoomAdditionalRoute();
