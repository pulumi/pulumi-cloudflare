...
public final class GetPipelineStreamSchema {
    ...
    public static Builder builder(GetPipelineStreamSchema defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder fields(List<GetPipelineStreamSchemaField> fields) {
            if (fields == null) {
              throw new MissingRequiredPropertyException("GetPipelineStreamSchema", "fields");
            }
            this.fields = fields;
            return this;
        }
        public Builder fields(GetPipelineStreamSchemaField... fields) {
