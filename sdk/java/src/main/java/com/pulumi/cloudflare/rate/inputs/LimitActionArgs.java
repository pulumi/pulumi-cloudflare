...
public final class LimitActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final LimitActionArgs Empty = new LimitActionArgs();
    ...
    private @Nullable Output<LimitActionResponseArgs> response;
     ...
     * 
     */
    public Optional<Output<LimitActionResponseArgs>> response() {
    ...
    private LimitActionArgs() {}

    private LimitActionArgs(LimitActionArgs $) {
        this.mode = $.mode;
    ...
    public static Builder builder(LimitActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LimitActionArgs defaults) {
            $ = new LimitActionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder response(@Nullable Output<LimitActionResponseArgs> response) {
            $.response = response;
            return this;
        }
         ...
         * 
         */
        public Builder response(LimitActionResponseArgs response) {
