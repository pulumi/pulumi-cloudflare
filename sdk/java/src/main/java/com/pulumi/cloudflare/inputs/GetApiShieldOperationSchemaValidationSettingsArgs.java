...
public final class GetApiShieldOperationSchemaValidationSettingsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final GetApiShieldOperationSchemaValidationSettingsArgs Empty = new GetApiShieldOperationSchemaValidationSettingsArgs();
    ...
    private GetApiShieldOperationSchemaValidationSettingsArgs(GetApiShieldOperationSchemaValidationSettingsArgs $) {
    ...
    public static Builder builder(GetApiShieldOperationSchemaValidationSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetApiShieldOperationSchemaValidationSettingsArgs();
        }

        public Builder(GetApiShieldOperationSchemaValidationSettingsArgs defaults) {
            $ = new GetApiShieldOperationSchemaValidationSettingsArgs(Objects.requireNonNull(defaults));
        }
