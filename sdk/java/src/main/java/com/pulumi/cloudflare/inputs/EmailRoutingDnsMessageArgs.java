...
public final class EmailRoutingDnsMessageArgs extends com.pulumi.resources.ResourceArgs {

    public static final EmailRoutingDnsMessageArgs Empty = new EmailRoutingDnsMessageArgs();
    ...
    public static Builder builder(EmailRoutingDnsMessageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EmailRoutingDnsMessageArgs();
        }

        public Builder(EmailRoutingDnsMessageArgs defaults) {
            $ = new EmailRoutingDnsMessageArgs(Objects.requireNonNull(defaults));
        }
