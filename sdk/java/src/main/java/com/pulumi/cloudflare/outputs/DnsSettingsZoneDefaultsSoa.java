...
@CustomType
public final class DnsSettingsZoneDefaultsSoa {
    /**
    ...
    private DnsSettingsZoneDefaultsSoa() {}
    /**
     * @return Time in seconds of being unable to query the primary server after which secondary servers should stop serving the zone.
     * 
     */
    ...
    public static Builder builder(DnsSettingsZoneDefaultsSoa defaults) {
    ...
    public static final class Builder {
        ...
        private Double ttl;
        public Builder() {}
        public Builder(DnsSettingsZoneDefaultsSoa defaults) {
        ...
        public Builder expire(Double expire) {
            if (expire == null) {
              throw new MissingRequiredPropertyException("DnsSettingsZoneDefaultsSoa", "expire");
            }
            this.expire = expire;
            return this;
        }
        ...
        public Builder minTtl(Double minTtl) {
            if (minTtl == null) {
              throw new MissingRequiredPropertyException("DnsSettingsZoneDefaultsSoa", "minTtl");
            }
            this.minTtl = minTtl;
            return this;
        }
        ...
        public Builder mname(String mname) {
            if (mname == null) {
              throw new MissingRequiredPropertyException("DnsSettingsZoneDefaultsSoa", "mname");
            }
            this.mname = mname;
            return this;
        }
        ...
        public Builder refresh(Double refresh) {
            if (refresh == null) {
              throw new MissingRequiredPropertyException("DnsSettingsZoneDefaultsSoa", "refresh");
            }
        ...
        public Builder retry(Double retry) {
            if (retry == null) {
              throw new MissingRequiredPropertyException("DnsSettingsZoneDefaultsSoa", "retry");
            }
            this.retry = retry;
            return this;
        }
        ...
        public Builder rname(String rname) {
            if (rname == null) {
              throw new MissingRequiredPropertyException("DnsSettingsZoneDefaultsSoa", "rname");
            }
            this.rname = rname;
            return this;
        }
        ...
        public Builder ttl(Double ttl) {
            if (ttl == null) {
              throw new MissingRequiredPropertyException("DnsSettingsZoneDefaultsSoa", "ttl");
            }
            this.ttl = ttl;
            return this;
        }
        public DnsSettingsZoneDefaultsSoa build() {
            final var _resultValue = new DnsSettingsZoneDefaultsSoa();
