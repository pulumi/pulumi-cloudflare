...
@CustomType
public final class GetInstancesResultMetadata {
    private Boolean createdFromAisearchWizard;
    private String workerDomain;

    private GetInstancesResultMetadata() {}
    ...
    public static Builder builder(GetInstancesResultMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private String workerDomain;
        public Builder() {}
        public Builder(GetInstancesResultMetadata defaults) {
        ...
        public Builder createdFromAisearchWizard(Boolean createdFromAisearchWizard) {
            if (createdFromAisearchWizard == null) {
              throw new MissingRequiredPropertyException("GetInstancesResultMetadata", "createdFromAisearchWizard");
            }
        ...
        public Builder workerDomain(String workerDomain) {
            if (workerDomain == null) {
              throw new MissingRequiredPropertyException("GetInstancesResultMetadata", "workerDomain");
            }
            this.workerDomain = workerDomain;
            return this;
        }
        public GetInstancesResultMetadata build() {
            final var _resultValue = new GetInstancesResultMetadata();
