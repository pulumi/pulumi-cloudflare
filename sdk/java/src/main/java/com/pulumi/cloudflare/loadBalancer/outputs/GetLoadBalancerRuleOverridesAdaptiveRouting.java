...
@CustomType
public final class GetLoadBalancerRuleOverridesAdaptiveRouting {
    /**
    ...
    private GetLoadBalancerRuleOverridesAdaptiveRouting() {}
    /**
     * @return Extends zero-downtime failover of requests to healthy origins from alternate pools, when no healthy alternate exists in the same pool, according to the failover order defined by traffic and origin steering. When set false (the default) zero-downtime failover will only occur between origins within the same pool. See `sessionAffinityAttributes` for control over when sessions are broken or reassigned.
     * 
     */
    ...
    public static Builder builder(GetLoadBalancerRuleOverridesAdaptiveRouting defaults) {
    ...
    public static final class Builder {
        private Boolean failoverAcrossPools;
        public Builder() {}
        public Builder(GetLoadBalancerRuleOverridesAdaptiveRouting defaults) {
        ...
        public Builder failoverAcrossPools(Boolean failoverAcrossPools) {
            if (failoverAcrossPools == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerRuleOverridesAdaptiveRouting", "failoverAcrossPools");
            }
            this.failoverAcrossPools = failoverAcrossPools;
            return this;
        }
        public GetLoadBalancerRuleOverridesAdaptiveRouting build() {
            final var _resultValue = new GetLoadBalancerRuleOverridesAdaptiveRouting();
