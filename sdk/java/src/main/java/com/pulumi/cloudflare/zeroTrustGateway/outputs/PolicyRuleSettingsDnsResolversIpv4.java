...
@CustomType
public final class PolicyRuleSettingsDnsResolversIpv4 {
    /**
    ...
    private PolicyRuleSettingsDnsResolversIpv4() {}
    /**
     * @return Specify the IPv4 address of the upstream resolver.
     * 
     */
    ...
    public static Builder builder(PolicyRuleSettingsDnsResolversIpv4 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vnetId;
        public Builder() {}
        public Builder(PolicyRuleSettingsDnsResolversIpv4 defaults) {
        ...
        public Builder ip(String ip) {
            if (ip == null) {
              throw new MissingRequiredPropertyException("PolicyRuleSettingsDnsResolversIpv4", "ip");
            }
            this.ip = ip;
            return this;
        }
        ...
        public PolicyRuleSettingsDnsResolversIpv4 build() {
            final var _resultValue = new PolicyRuleSettingsDnsResolversIpv4();
            _resultValue.ip = ip;
