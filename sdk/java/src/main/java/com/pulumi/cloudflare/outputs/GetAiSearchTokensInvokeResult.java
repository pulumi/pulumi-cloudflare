...
import com.pulumi.cloudflare.outputs.GetAiSearchTokensResult;
...
public final class GetAiSearchTokensInvokeResult {
    ...
    public static Builder builder(GetAiSearchTokensInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetAiSearchTokensInvokeResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder results(List<GetAiSearchTokensResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetAiSearchTokensInvokeResult", "results");
            }
