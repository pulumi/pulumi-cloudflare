...
public final class GetMessagePlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetMessagePlainArgs build() {
            if ($.page == null) {
                throw new MissingRequiredPropertyException("GetMessagePlainArgs", "page");
            }
            if ($.perPage == null) {
                throw new MissingRequiredPropertyException("GetMessagePlainArgs", "perPage");
            }
            if ($.requestId == null) {
                throw new MissingRequiredPropertyException("GetMessagePlainArgs", "requestId");
            }
            return $;
        }
    }
