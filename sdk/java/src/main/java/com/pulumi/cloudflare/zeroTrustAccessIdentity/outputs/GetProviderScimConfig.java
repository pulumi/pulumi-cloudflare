...
@CustomType
public final class GetProviderScimConfig {
    /**
    ...
    public static Builder builder(GetProviderScimConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean userDeprovision;
        public Builder() {}
        public Builder(GetProviderScimConfig defaults) {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetProviderScimConfig", "enabled");
            }
        ...
        public Builder identityUpdateBehavior(String identityUpdateBehavior) {
            if (identityUpdateBehavior == null) {
              throw new MissingRequiredPropertyException("GetProviderScimConfig", "identityUpdateBehavior");
            }
        ...
        public Builder scimBaseUrl(String scimBaseUrl) {
            if (scimBaseUrl == null) {
              throw new MissingRequiredPropertyException("GetProviderScimConfig", "scimBaseUrl");
            }
        ...
        public Builder seatDeprovision(Boolean seatDeprovision) {
            if (seatDeprovision == null) {
              throw new MissingRequiredPropertyException("GetProviderScimConfig", "seatDeprovision");
            }
        ...
        public Builder secret(String secret) {
            if (secret == null) {
              throw new MissingRequiredPropertyException("GetProviderScimConfig", "secret");
            }
            this.secret = secret;
            return this;
        }
        ...
        public Builder userDeprovision(Boolean userDeprovision) {
            if (userDeprovision == null) {
              throw new MissingRequiredPropertyException("GetProviderScimConfig", "userDeprovision");
            }
            this.userDeprovision = userDeprovision;
            return this;
        }
        public GetProviderScimConfig build() {
            final var _resultValue = new GetProviderScimConfig();
