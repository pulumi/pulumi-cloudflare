...
public final class StaticRouteScopeArgs extends com.pulumi.resources.ResourceArgs {

    public static final StaticRouteScopeArgs Empty = new StaticRouteScopeArgs();
    ...
    private StaticRouteScopeArgs() {}

    private StaticRouteScopeArgs(StaticRouteScopeArgs $) {
    ...
    public static Builder builder(StaticRouteScopeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StaticRouteScopeArgs();
        }

        public Builder(StaticRouteScopeArgs defaults) {
            $ = new StaticRouteScopeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StaticRouteScopeArgs build() {
            return $;
        }
    }
