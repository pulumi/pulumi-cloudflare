...
@CustomType
public final class GetDnsSettingsZoneDefaultsSoa {
    /**
    ...
    private GetDnsSettingsZoneDefaultsSoa() {}
    /**
     * @return Time in seconds of being unable to query the primary server after which secondary servers should stop serving the zone.
     * 
     */
    ...
    public static Builder builder(GetDnsSettingsZoneDefaultsSoa defaults) {
    ...
    public static final class Builder {
        ...
        private Double ttl;
        public Builder() {}
        public Builder(GetDnsSettingsZoneDefaultsSoa defaults) {
        ...
        public Builder expire(Double expire) {
            if (expire == null) {
              throw new MissingRequiredPropertyException("GetDnsSettingsZoneDefaultsSoa", "expire");
            }
            this.expire = expire;
            return this;
        }
        ...
        public Builder minTtl(Double minTtl) {
            if (minTtl == null) {
              throw new MissingRequiredPropertyException("GetDnsSettingsZoneDefaultsSoa", "minTtl");
            }
            this.minTtl = minTtl;
            return this;
        }
        ...
        public Builder mname(String mname) {
            if (mname == null) {
              throw new MissingRequiredPropertyException("GetDnsSettingsZoneDefaultsSoa", "mname");
            }
            this.mname = mname;
            return this;
        }
        ...
        public Builder refresh(Double refresh) {
            if (refresh == null) {
              throw new MissingRequiredPropertyException("GetDnsSettingsZoneDefaultsSoa", "refresh");
            }
        ...
        public Builder retry(Double retry) {
            if (retry == null) {
              throw new MissingRequiredPropertyException("GetDnsSettingsZoneDefaultsSoa", "retry");
            }
            this.retry = retry;
            return this;
        }
        ...
        public Builder rname(String rname) {
            if (rname == null) {
              throw new MissingRequiredPropertyException("GetDnsSettingsZoneDefaultsSoa", "rname");
            }
            this.rname = rname;
            return this;
        }
        ...
        public Builder ttl(Double ttl) {
            if (ttl == null) {
              throw new MissingRequiredPropertyException("GetDnsSettingsZoneDefaultsSoa", "ttl");
            }
            this.ttl = ttl;
            return this;
        }
        public GetDnsSettingsZoneDefaultsSoa build() {
            final var _resultValue = new GetDnsSettingsZoneDefaultsSoa();
