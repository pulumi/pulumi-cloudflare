...
public final class GetZeroTrustDlpPredefinedProfileEntryConfidence {
    ...
    public static Builder builder(GetZeroTrustDlpPredefinedProfileEntryConfidence defaults) {
    ...
    public static final class Builder {
        ...
        public Builder available(Boolean available) {
            if (available == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustDlpPredefinedProfileEntryConfidence", "available");
            }
