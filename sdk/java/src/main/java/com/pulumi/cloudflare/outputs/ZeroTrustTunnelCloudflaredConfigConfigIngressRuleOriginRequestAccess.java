...
@CustomType
public final class ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestAccess {
    /**
    ...
    private ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestAccess() {}
    /**
     * @return Audience tags of the access rule.
     * 
     */
    ...
    public static Builder builder(ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestAccess defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String teamName;
        public Builder() {}
        public Builder(ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestAccess defaults) {
        ...
        public ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestAccess build() {
            final var _resultValue = new ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestAccess();
