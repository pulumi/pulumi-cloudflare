...
import com.pulumi.cloudflare.zeroTrustNetworkHostname.outputs.GetRoutesResult;
...
public final class GetRoutesInvokeResult {
    ...
    public static final class Builder {
        ...
        public Builder isDeleted(Boolean isDeleted) {
            if (isDeleted == null) {
              throw new MissingRequiredPropertyException("GetRoutesInvokeResult", "isDeleted");
            }
