...
public final class TeamsAccountSettingsCustomCertificate {
    ...
    public static Builder builder(TeamsAccountSettingsCustomCertificate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedAt;
        public Builder() {}
        public Builder(TeamsAccountSettingsCustomCertificate defaults) {
        ...
        public TeamsAccountSettingsCustomCertificate build() {
            final var _resultValue = new TeamsAccountSettingsCustomCertificate();
