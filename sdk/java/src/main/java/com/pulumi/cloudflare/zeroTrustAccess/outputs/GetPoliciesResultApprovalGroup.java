...
@CustomType
public final class GetPoliciesResultApprovalGroup {
    /**
    ...
    private GetPoliciesResultApprovalGroup() {}
    /**
     * @return The number of approvals needed to obtain access.
     * 
     */
    ...
    public static Builder builder(GetPoliciesResultApprovalGroup defaults) {
    ...
    public static final class Builder {
        ...
        private String emailListUuid;
        public Builder() {}
        public Builder(GetPoliciesResultApprovalGroup defaults) {
        ...
        public Builder approvalsNeeded(Double approvalsNeeded) {
            if (approvalsNeeded == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultApprovalGroup", "approvalsNeeded");
            }
        ...
        public Builder emailAddresses(List<String> emailAddresses) {
            if (emailAddresses == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultApprovalGroup", "emailAddresses");
            }
        ...
        public Builder emailListUuid(String emailListUuid) {
            if (emailListUuid == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultApprovalGroup", "emailListUuid");
            }
            this.emailListUuid = emailListUuid;
            return this;
        }
        public GetPoliciesResultApprovalGroup build() {
            final var _resultValue = new GetPoliciesResultApprovalGroup();
