...
@CustomType
public final class ZeroTrustAccessGroupIncludeGithub {
    /**
    ...
    private ZeroTrustAccessGroupIncludeGithub() {}
    /**
     * @return The ID of your Github identity provider.
     * 
     */
    ...
    public static Builder builder(ZeroTrustAccessGroupIncludeGithub defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> teams;
        public Builder() {}
        public Builder(ZeroTrustAccessGroupIncludeGithub defaults) {
        ...
        public ZeroTrustAccessGroupIncludeGithub build() {
            final var _resultValue = new ZeroTrustAccessGroupIncludeGithub();
