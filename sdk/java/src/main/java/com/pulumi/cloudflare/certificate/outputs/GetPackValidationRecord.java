...
@CustomType
public final class GetPackValidationRecord {
    /**
    ...
    private GetPackValidationRecord() {}
    /**
     * @return The CNAME record hostname for DCV delegation.
     * 
     */
    ...
    public static Builder builder(GetPackValidationRecord defaults) {
    ...
    public static final class Builder {
        ...
        private String txtValue;
        public Builder() {}
        public Builder(GetPackValidationRecord defaults) {
        ...
        public Builder cname(String cname) {
            if (cname == null) {
              throw new MissingRequiredPropertyException("GetPackValidationRecord", "cname");
            }
            this.cname = cname;
            return this;
        }
        ...
        public Builder cnameTarget(String cnameTarget) {
            if (cnameTarget == null) {
              throw new MissingRequiredPropertyException("GetPackValidationRecord", "cnameTarget");
            }
        ...
        public Builder emails(List<String> emails) {
            if (emails == null) {
              throw new MissingRequiredPropertyException("GetPackValidationRecord", "emails");
            }
            this.emails = emails;
            return this;
        }
        ...
        public Builder httpBody(String httpBody) {
            if (httpBody == null) {
              throw new MissingRequiredPropertyException("GetPackValidationRecord", "httpBody");
            }
        ...
        public Builder httpUrl(String httpUrl) {
            if (httpUrl == null) {
              throw new MissingRequiredPropertyException("GetPackValidationRecord", "httpUrl");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetPackValidationRecord", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder txtName(String txtName) {
            if (txtName == null) {
              throw new MissingRequiredPropertyException("GetPackValidationRecord", "txtName");
            }
        ...
        public Builder txtValue(String txtValue) {
            if (txtValue == null) {
              throw new MissingRequiredPropertyException("GetPackValidationRecord", "txtValue");
            }
            this.txtValue = txtValue;
            return this;
        }
        public GetPackValidationRecord build() {
            final var _resultValue = new GetPackValidationRecord();
