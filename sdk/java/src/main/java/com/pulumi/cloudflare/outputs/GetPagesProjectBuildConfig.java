...
@CustomType
public final class GetPagesProjectBuildConfig {
    /**
    ...
    private GetPagesProjectBuildConfig() {}
    /**
     * @return Enable build caching for the project.
     * 
     */
    ...
    public static Builder builder(GetPagesProjectBuildConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String webAnalyticsToken;
        public Builder() {}
        public Builder(GetPagesProjectBuildConfig defaults) {
        ...
        public Builder buildCaching(Boolean buildCaching) {
            if (buildCaching == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectBuildConfig", "buildCaching");
            }
        ...
        public Builder buildCommand(String buildCommand) {
            if (buildCommand == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectBuildConfig", "buildCommand");
            }
        ...
        public Builder destinationDir(String destinationDir) {
            if (destinationDir == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectBuildConfig", "destinationDir");
            }
        ...
        public Builder rootDir(String rootDir) {
            if (rootDir == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectBuildConfig", "rootDir");
            }
        ...
        public Builder webAnalyticsTag(String webAnalyticsTag) {
            if (webAnalyticsTag == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectBuildConfig", "webAnalyticsTag");
            }
        ...
        public Builder webAnalyticsToken(String webAnalyticsToken) {
            if (webAnalyticsToken == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectBuildConfig", "webAnalyticsToken");
            }
            this.webAnalyticsToken = webAnalyticsToken;
            return this;
        }
        public GetPagesProjectBuildConfig build() {
            final var _resultValue = new GetPagesProjectBuildConfig();
