...
public final class GetRecordsComment extends com.pulumi.resources.InvokeArgs {

    public static final GetRecordsComment Empty = new GetRecordsComment();
    ...
    private GetRecordsComment() {}

    private GetRecordsComment(GetRecordsComment $) {
        this.absent = $.absent;
    ...
    public static Builder builder(GetRecordsComment defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRecordsComment();
        }

        public Builder(GetRecordsComment defaults) {
            $ = new GetRecordsComment(Objects.requireNonNull(defaults));
        }
        ...
        public GetRecordsComment build() {
            return $;
        }
    }
