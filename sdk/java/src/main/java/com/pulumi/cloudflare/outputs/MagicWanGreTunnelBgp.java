...
@CustomType
public final class MagicWanGreTunnelBgp {
    /**
    ...
    public static Builder builder(MagicWanGreTunnelBgp defaults) {
    ...
    public static final class Builder {
        ...
        public Builder customerAsn(Integer customerAsn) {
            if (customerAsn == null) {
              throw new MissingRequiredPropertyException("MagicWanGreTunnelBgp", "customerAsn");
            }
