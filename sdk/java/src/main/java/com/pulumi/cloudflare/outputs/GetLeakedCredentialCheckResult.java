...
public final class GetLeakedCredentialCheckResult {
    ...
    public static Builder builder(GetLeakedCredentialCheckResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetLeakedCredentialCheckResult", "enabled");
            }
        ...
        public Builder zoneId(String zoneId) {
            if (zoneId == null) {
              throw new MissingRequiredPropertyException("GetLeakedCredentialCheckResult", "zoneId");
            }
            this.zoneId = zoneId;
            return this;
        }
