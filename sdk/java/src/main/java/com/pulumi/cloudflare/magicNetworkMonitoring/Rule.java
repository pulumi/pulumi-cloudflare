...
import com.pulumi.cloudflare.magicNetworkMonitoring.inputs.RuleState;
 ...
 * 
 */
@ResourceType(type="cloudflare:magicNetworkMonitoring/rule:Rule")
public class Rule extends com.pulumi.resources.CustomResource {
    ...
    public Rule(java.lang.String name, RuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:magicNetworkMonitoring/rule:Rule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Rule(java.lang.String name, Output<java.lang.String> id, @Nullable RuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:magicNetworkMonitoring/rule:Rule", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/magicNetworkMonitoringRule:MagicNetworkMonitoringRule").build())
            ))
            .build();
