...
@CustomType
public final class SiteRuleset {
    /**
    ...
    public static Builder builder(SiteRuleset defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String zoneTag;
        public Builder() {}
        public Builder(SiteRuleset defaults) {
        ...
        public SiteRuleset build() {
            final var _resultValue = new SiteRuleset();
