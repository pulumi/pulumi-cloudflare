...
@CustomType
public final class GetIncomingResult {
    /**
    ...
    public static Builder builder(GetIncomingResult defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String zoneId;
        public Builder() {}
        public Builder(GetIncomingResult defaults) {
        ...
        public Builder autoRefreshSeconds(Double autoRefreshSeconds) {
            if (autoRefreshSeconds == null) {
              throw new MissingRequiredPropertyException("GetIncomingResult", "autoRefreshSeconds");
            }
        ...
        public Builder checkedTime(String checkedTime) {
            if (checkedTime == null) {
              throw new MissingRequiredPropertyException("GetIncomingResult", "checkedTime");
            }
        ...
        public Builder createdTime(String createdTime) {
            if (createdTime == null) {
              throw new MissingRequiredPropertyException("GetIncomingResult", "createdTime");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetIncomingResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder modifiedTime(String modifiedTime) {
            if (modifiedTime == null) {
              throw new MissingRequiredPropertyException("GetIncomingResult", "modifiedTime");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetIncomingResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder peers(List<String> peers) {
            if (peers == null) {
              throw new MissingRequiredPropertyException("GetIncomingResult", "peers");
            }
            this.peers = peers;
            return this;
        }
        ...
        public Builder soaSerial(Double soaSerial) {
            if (soaSerial == null) {
              throw new MissingRequiredPropertyException("GetIncomingResult", "soaSerial");
            }
        ...
        public GetIncomingResult build() {
            final var _resultValue = new GetIncomingResult();
