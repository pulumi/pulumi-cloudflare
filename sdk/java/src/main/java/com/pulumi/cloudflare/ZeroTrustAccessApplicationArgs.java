...
import com.pulumi.cloudflare.inputs.ZeroTrustAccessApplicationMfaConfigArgs;
...
public final class ZeroTrustAccessApplicationArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZeroTrustAccessApplicationArgs Empty = new ZeroTrustAccessApplicationArgs();
    ...
    private @Nullable Output<ZeroTrustAccessApplicationMfaConfigArgs> mfaConfig;
     ...
     * 
     */
    public Optional<Output<ZeroTrustAccessApplicationMfaConfigArgs>> mfaConfig() {
    ...
    private @Nullable Output<ZeroTrustAccessApplicationScimConfigArgs> scimConfig;

    /**
     * @return Configuration for provisioning to this application via SCIM. This is currently in closed beta.
     * 
     */
    public Optional<Output<ZeroTrustAccessApplicationScimConfigArgs>> scimConfig() {
    ...
    private ZeroTrustAccessApplicationArgs() {}
    ...
    public static Builder builder(ZeroTrustAccessApplicationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustAccessApplicationArgs();
        }

        public Builder(ZeroTrustAccessApplicationArgs defaults) {
            $ = new ZeroTrustAccessApplicationArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder destinations(@Nullable Output<List<ZeroTrustAccessApplicationDestinationArgs>> destinations) {
         ...
         * 
         */
        public Builder destinations(List<ZeroTrustAccessApplicationDestinationArgs> destinations) {
         ...
         * 
         */
        public Builder footerLinks(@Nullable Output<List<ZeroTrustAccessApplicationFooterLinkArgs>> footerLinks) {
         ...
         * 
         */
        public Builder footerLinks(List<ZeroTrustAccessApplicationFooterLinkArgs> footerLinks) {
         ...
         * 
         */
        public Builder footerLinks(ZeroTrustAccessApplicationFooterLinkArgs... footerLinks) {
         ...
         * 
         */
        public Builder landingPageDesign(@Nullable Output<ZeroTrustAccessApplicationLandingPageDesignArgs> landingPageDesign) {
         ...
         * 
         */
        public Builder landingPageDesign(ZeroTrustAccessApplicationLandingPageDesignArgs landingPageDesign) {
         ...
         * 
         */
        public Builder mfaConfig(@Nullable Output<ZeroTrustAccessApplicationMfaConfigArgs> mfaConfig) {
            $.mfaConfig = mfaConfig;
            return this;
        }
         ...
         * 
         */
        public Builder mfaConfig(ZeroTrustAccessApplicationMfaConfigArgs mfaConfig) {
         ...
         * 
         */
        public Builder scimConfig(@Nullable Output<ZeroTrustAccessApplicationScimConfigArgs> scimConfig) {
         ...
         * 
         */
        public Builder scimConfig(ZeroTrustAccessApplicationScimConfigArgs scimConfig) {
        ...
        public ZeroTrustAccessApplicationArgs build() {
            return $;
        }
    }
