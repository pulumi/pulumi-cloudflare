...
import com.pulumi.cloudflare.outputs.GetPipelineSinksResult;
...
@CustomType
public final class GetPipelineSinksInvokeResult {
    /**
     ...
     * 
     */
    private List<GetPipelineSinksResult> results;

    private GetPipelineSinksInvokeResult() {}
    /**
     * @return Specifies the public ID of the account.
     * 
     */
     ...
     * 
     */
    public List<GetPipelineSinksResult> results() {
        return this.results;
    }
    ...
    public static Builder builder(GetPipelineSinksInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder results(List<GetPipelineSinksResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetPipelineSinksInvokeResult", "results");
            }
            this.results = results;
            return this;
        }
        public Builder results(GetPipelineSinksResult... results) {
