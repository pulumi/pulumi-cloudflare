...
public final class ConfigMtls {
    ...
    public static Builder builder(ConfigMtls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sslmode;
        public Builder() {}
        public Builder(ConfigMtls defaults) {
        ...
        public ConfigMtls build() {
            final var _resultValue = new ConfigMtls();
