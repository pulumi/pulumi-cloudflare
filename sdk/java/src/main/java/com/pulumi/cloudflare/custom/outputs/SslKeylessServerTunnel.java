...
@CustomType
public final class SslKeylessServerTunnel {
    /**
    ...
    public static Builder builder(SslKeylessServerTunnel defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vnetId;
        public Builder() {}
        public Builder(SslKeylessServerTunnel defaults) {
        ...
        public SslKeylessServerTunnel build() {
            final var _resultValue = new SslKeylessServerTunnel();
