...
import com.pulumi.cloudflare.outputs.GetCustomOriginTrustStoresResult;
...
public final class GetCustomOriginTrustStoresInvokeResult {
     ...
     * 
     */
    public List<GetCustomOriginTrustStoresResult> results() {
        return this.results;
    }
    /**
     * @return Identifier.
    ...
    public static Builder builder(GetCustomOriginTrustStoresInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder results(List<GetCustomOriginTrustStoresResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetCustomOriginTrustStoresInvokeResult", "results");
            }
            this.results = results;
            return this;
        }
        public Builder results(GetCustomOriginTrustStoresResult... results) {
