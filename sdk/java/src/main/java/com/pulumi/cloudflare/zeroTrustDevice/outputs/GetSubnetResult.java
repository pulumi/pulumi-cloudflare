...
import com.pulumi.cloudflare.zeroTrustDevice.outputs.GetSubnetCapacity;
...
public final class GetSubnetResult {
     ...
     * 
     */
    private GetSubnetCapacity capacity;
    /**
     ...
     * 
     */
    public GetSubnetCapacity capacity() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder capacity(GetSubnetCapacity capacity) {
            if (capacity == null) {
              throw new MissingRequiredPropertyException("GetSubnetResult", "capacity");
            }
        ...
        public Builder comment(String comment) {
            if (comment == null) {
              throw new MissingRequiredPropertyException("GetSubnetResult", "comment");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetSubnetResult", "createdAt");
            }
        ...
        public Builder deletedAt(String deletedAt) {
            if (deletedAt == null) {
              throw new MissingRequiredPropertyException("GetSubnetResult", "deletedAt");
            }
        ...
        public Builder isDefaultNetwork(Boolean isDefaultNetwork) {
            if (isDefaultNetwork == null) {
              throw new MissingRequiredPropertyException("GetSubnetResult", "isDefaultNetwork");
            }
        ...
        public Builder network(String network) {
            if (network == null) {
              throw new MissingRequiredPropertyException("GetSubnetResult", "network");
            }
        ...
        public Builder subnetType(String subnetType) {
            if (subnetType == null) {
              throw new MissingRequiredPropertyException("GetSubnetResult", "subnetType");
            }
