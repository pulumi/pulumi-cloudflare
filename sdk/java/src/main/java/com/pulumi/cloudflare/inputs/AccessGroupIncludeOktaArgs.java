    ...
    public static final class Builder {
        ...
        public AccessGroupIncludeOktaArgs build() {
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("AccessGroupIncludeOktaArgs", "identityProviderId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("AccessGroupIncludeOktaArgs", "name");
            }
            return $;
        }
    }
