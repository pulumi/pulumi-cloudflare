...
import com.pulumi.cloudflare.magicTransitSite.outputs.GetWansResultStaticAddressing;
...
@CustomType
public final class GetWansResult {
    /**
     ...
     * 
     */
    private GetWansResultStaticAddressing staticAddressing;
    /**
     ...
     * 
     */
    public GetWansResultStaticAddressing staticAddressing() {
    ...
    public static Builder builder(GetWansResult defaults) {
    ...
    public static final class Builder {
        ...
        private Integer vlanTag;
        public Builder() {}
        public Builder(GetWansResult defaults) {
        ...
        public Builder healthCheckRate(String healthCheckRate) {
            if (healthCheckRate == null) {
              throw new MissingRequiredPropertyException("GetWansResult", "healthCheckRate");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetWansResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetWansResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder physport(Integer physport) {
            if (physport == null) {
              throw new MissingRequiredPropertyException("GetWansResult", "physport");
            }
        ...
        public Builder priority(Integer priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("GetWansResult", "priority");
            }
        ...
        public Builder siteId(String siteId) {
            if (siteId == null) {
              throw new MissingRequiredPropertyException("GetWansResult", "siteId");
            }
            this.siteId = siteId;
            return this;
        }
        @CustomType.Setter
        public Builder staticAddressing(GetWansResultStaticAddressing staticAddressing) {
            if (staticAddressing == null) {
              throw new MissingRequiredPropertyException("GetWansResult", "staticAddressing");
            }
        ...
        public Builder vlanTag(Integer vlanTag) {
            if (vlanTag == null) {
              throw new MissingRequiredPropertyException("GetWansResult", "vlanTag");
            }
            this.vlanTag = vlanTag;
            return this;
        }
        public GetWansResult build() {
            final var _resultValue = new GetWansResult();
