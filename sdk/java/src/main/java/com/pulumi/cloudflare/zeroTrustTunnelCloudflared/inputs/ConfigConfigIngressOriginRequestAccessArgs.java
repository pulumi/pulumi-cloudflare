...
public final class ConfigConfigIngressOriginRequestAccessArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConfigConfigIngressOriginRequestAccessArgs Empty = new ConfigConfigIngressOriginRequestAccessArgs();
    ...
    private ConfigConfigIngressOriginRequestAccessArgs() {}

    private ConfigConfigIngressOriginRequestAccessArgs(ConfigConfigIngressOriginRequestAccessArgs $) {
    ...
    public static Builder builder(ConfigConfigIngressOriginRequestAccessArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConfigConfigIngressOriginRequestAccessArgs();
        }

        public Builder(ConfigConfigIngressOriginRequestAccessArgs defaults) {
            $ = new ConfigConfigIngressOriginRequestAccessArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ConfigConfigIngressOriginRequestAccessArgs build() {
            if ($.audTags == null) {
                throw new MissingRequiredPropertyException("ConfigConfigIngressOriginRequestAccessArgs", "audTags");
            }
            if ($.teamName == null) {
                throw new MissingRequiredPropertyException("ConfigConfigIngressOriginRequestAccessArgs", "teamName");
            }
            return $;
        }
    }
