...
@CustomType
public final class ZeroTrustDeviceCustomProfileExclude {
    /**
    ...
    public static Builder builder(ZeroTrustDeviceCustomProfileExclude defaults) {
    ...
    public static final class Builder {
        ...
        public ZeroTrustDeviceCustomProfileExclude build() {
            final var _resultValue = new ZeroTrustDeviceCustomProfileExclude();
