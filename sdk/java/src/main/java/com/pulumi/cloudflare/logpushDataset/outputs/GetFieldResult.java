...
@CustomType
public final class GetFieldResult {
    /**
    ...
    public static Builder builder(GetFieldResult defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String zoneId;
        public Builder() {}
        public Builder(GetFieldResult defaults) {
        ...
        public Builder datasetId(String datasetId) {
            if (datasetId == null) {
              throw new MissingRequiredPropertyException("GetFieldResult", "datasetId");
            }
        ...
        public GetFieldResult build() {
            final var _resultValue = new GetFieldResult();
