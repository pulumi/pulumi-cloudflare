...
public final class SiteRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final SiteRuleArgs Empty = new SiteRuleArgs();
    ...
    private SiteRuleArgs() {}

    private SiteRuleArgs(SiteRuleArgs $) {
    ...
    public static Builder builder(SiteRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SiteRuleArgs defaults) {
            $ = new SiteRuleArgs(Objects.requireNonNull(defaults));
        }
