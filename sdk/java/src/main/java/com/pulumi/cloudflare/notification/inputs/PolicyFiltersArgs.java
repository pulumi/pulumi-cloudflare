...
public final class PolicyFiltersArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyFiltersArgs Empty = new PolicyFiltersArgs();
    ...
    private PolicyFiltersArgs() {}

    private PolicyFiltersArgs(PolicyFiltersArgs $) {
    ...
    public static Builder builder(PolicyFiltersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyFiltersArgs();
        }

        public Builder(PolicyFiltersArgs defaults) {
            $ = new PolicyFiltersArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyFiltersArgs build() {
            return $;
        }
    }
