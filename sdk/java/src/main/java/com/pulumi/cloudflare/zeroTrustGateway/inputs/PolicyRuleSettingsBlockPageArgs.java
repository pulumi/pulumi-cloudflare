...
public final class PolicyRuleSettingsBlockPageArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyRuleSettingsBlockPageArgs Empty = new PolicyRuleSettingsBlockPageArgs();
    ...
    private PolicyRuleSettingsBlockPageArgs() {}

    private PolicyRuleSettingsBlockPageArgs(PolicyRuleSettingsBlockPageArgs $) {
    ...
    public static Builder builder(PolicyRuleSettingsBlockPageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyRuleSettingsBlockPageArgs();
        }

        public Builder(PolicyRuleSettingsBlockPageArgs defaults) {
            $ = new PolicyRuleSettingsBlockPageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyRuleSettingsBlockPageArgs build() {
            if ($.targetUri == null) {
                throw new MissingRequiredPropertyException("PolicyRuleSettingsBlockPageArgs", "targetUri");
            }
            return $;
        }
    }
