...
public final class GetZeroTrustAccessAiControlsMcpPortalServerUpdatedPrompt {
    ...
    public static Builder builder(GetZeroTrustAccessAiControlsMcpPortalServerUpdatedPrompt defaults) {
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessAiControlsMcpPortalServerUpdatedPrompt", "enabled");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessAiControlsMcpPortalServerUpdatedPrompt", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder portalAlias(String portalAlias) {
            if (portalAlias == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessAiControlsMcpPortalServerUpdatedPrompt", "portalAlias");
            }
