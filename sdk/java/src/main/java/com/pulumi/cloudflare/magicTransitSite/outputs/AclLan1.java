...
public final class AclLan1 {
    ...
    public static Builder builder(AclLan1 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> subnets;
        public Builder() {}
        public Builder(AclLan1 defaults) {
        ...
        public Builder lanId(String lanId) {
            if (lanId == null) {
              throw new MissingRequiredPropertyException("AclLan1", "lanId");
            }
            this.lanId = lanId;
            return this;
        }
        ...
        public AclLan1 build() {
            final var _resultValue = new AclLan1();
