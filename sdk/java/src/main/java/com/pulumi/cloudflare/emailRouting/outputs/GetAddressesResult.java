...
public final class GetAddressesResult {
    ...
    public static final class Builder {
        ...
        public Builder created(String created) {
            if (created == null) {
              throw new MissingRequiredPropertyException("GetAddressesResult", "created");
            }
        ...
        public Builder email(String email) {
            if (email == null) {
              throw new MissingRequiredPropertyException("GetAddressesResult", "email");
            }
            this.email = email;
            return this;
        }
        ...
        public Builder modified(String modified) {
            if (modified == null) {
              throw new MissingRequiredPropertyException("GetAddressesResult", "modified");
            }
        ...
        public Builder tag(String tag) {
            if (tag == null) {
              throw new MissingRequiredPropertyException("GetAddressesResult", "tag");
            }
            this.tag = tag;
            return this;
        }
        ...
        public Builder verified(String verified) {
            if (verified == null) {
              throw new MissingRequiredPropertyException("GetAddressesResult", "verified");
            }
