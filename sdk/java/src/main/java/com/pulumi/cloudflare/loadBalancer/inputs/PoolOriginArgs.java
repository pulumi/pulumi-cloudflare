...
public final class PoolOriginArgs extends com.pulumi.resources.ResourceArgs {

    public static final PoolOriginArgs Empty = new PoolOriginArgs();
    ...
    private PoolOriginArgs() {}

    private PoolOriginArgs(PoolOriginArgs $) {
    ...
    public static Builder builder(PoolOriginArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PoolOriginArgs defaults) {
            $ = new PoolOriginArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder header(@Nullable Output<PoolOriginHeaderArgs> header) {
            $.header = header;
            return this;
        }
         ...
         * 
         */
        public Builder header(PoolOriginHeaderArgs header) {
