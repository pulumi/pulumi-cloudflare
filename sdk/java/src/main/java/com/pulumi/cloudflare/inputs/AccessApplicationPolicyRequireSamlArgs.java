...
public final class AccessApplicationPolicyRequireSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccessApplicationPolicyRequireSamlArgs Empty = new AccessApplicationPolicyRequireSamlArgs();
    ...
    private AccessApplicationPolicyRequireSamlArgs() {}

    private AccessApplicationPolicyRequireSamlArgs(AccessApplicationPolicyRequireSamlArgs $) {
    ...
    public static Builder builder(AccessApplicationPolicyRequireSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessApplicationPolicyRequireSamlArgs();
        }

        public Builder(AccessApplicationPolicyRequireSamlArgs defaults) {
            $ = new AccessApplicationPolicyRequireSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccessApplicationPolicyRequireSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("AccessApplicationPolicyRequireSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("AccessApplicationPolicyRequireSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("AccessApplicationPolicyRequireSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
