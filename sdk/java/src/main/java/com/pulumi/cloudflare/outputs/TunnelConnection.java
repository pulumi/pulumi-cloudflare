...
public final class TunnelConnection {
    ...
    public static Builder builder(TunnelConnection defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uuid;
        public Builder() {}
        public Builder(TunnelConnection defaults) {
        ...
        public TunnelConnection build() {
            final var _resultValue = new TunnelConnection();
