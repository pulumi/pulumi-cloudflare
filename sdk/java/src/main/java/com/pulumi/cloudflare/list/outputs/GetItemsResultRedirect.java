...
@CustomType
public final class GetItemsResultRedirect {
    ...
    private GetItemsResultRedirect() {}
    ...
    public static Builder builder(GetItemsResultRedirect defaults) {
    ...
    public static final class Builder {
        ...
        private String targetUrl;
        public Builder() {}
        public Builder(GetItemsResultRedirect defaults) {
        ...
        public Builder includeSubdomains(Boolean includeSubdomains) {
            if (includeSubdomains == null) {
              throw new MissingRequiredPropertyException("GetItemsResultRedirect", "includeSubdomains");
            }
        ...
        public Builder preservePathSuffix(Boolean preservePathSuffix) {
            if (preservePathSuffix == null) {
              throw new MissingRequiredPropertyException("GetItemsResultRedirect", "preservePathSuffix");
            }
        ...
        public Builder preserveQueryString(Boolean preserveQueryString) {
            if (preserveQueryString == null) {
              throw new MissingRequiredPropertyException("GetItemsResultRedirect", "preserveQueryString");
            }
        ...
        public Builder sourceUrl(String sourceUrl) {
            if (sourceUrl == null) {
              throw new MissingRequiredPropertyException("GetItemsResultRedirect", "sourceUrl");
            }
        ...
        public Builder statusCode(Integer statusCode) {
            if (statusCode == null) {
              throw new MissingRequiredPropertyException("GetItemsResultRedirect", "statusCode");
            }
        ...
        public Builder subpathMatching(Boolean subpathMatching) {
            if (subpathMatching == null) {
              throw new MissingRequiredPropertyException("GetItemsResultRedirect", "subpathMatching");
            }
        ...
        public Builder targetUrl(String targetUrl) {
            if (targetUrl == null) {
              throw new MissingRequiredPropertyException("GetItemsResultRedirect", "targetUrl");
            }
            this.targetUrl = targetUrl;
            return this;
        }
        public GetItemsResultRedirect build() {
            final var _resultValue = new GetItemsResultRedirect();
