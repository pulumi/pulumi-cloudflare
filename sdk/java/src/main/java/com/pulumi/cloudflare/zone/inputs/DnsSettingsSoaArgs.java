...
public final class DnsSettingsSoaArgs extends com.pulumi.resources.ResourceArgs {

    public static final DnsSettingsSoaArgs Empty = new DnsSettingsSoaArgs();
    ...
    private DnsSettingsSoaArgs() {}

    private DnsSettingsSoaArgs(DnsSettingsSoaArgs $) {
        this.expire = $.expire;
        this.minTtl = $.minTtl;
        this.mname = $.mname;
    ...
    public static Builder builder(DnsSettingsSoaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DnsSettingsSoaArgs();
        }

        public Builder(DnsSettingsSoaArgs defaults) {
            $ = new DnsSettingsSoaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DnsSettingsSoaArgs build() {
            return $;
        }
    }
