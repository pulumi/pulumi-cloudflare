...
public final class DatasetColumnArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatasetColumnArgs Empty = new DatasetColumnArgs();
    ...
    private DatasetColumnArgs() {}

    private DatasetColumnArgs(DatasetColumnArgs $) {
    ...
    public static Builder builder(DatasetColumnArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatasetColumnArgs();
        }

        public Builder(DatasetColumnArgs defaults) {
            $ = new DatasetColumnArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DatasetColumnArgs build() {
            return $;
        }
    }
