...
import com.pulumi.cloudflare.organization.inputs.OrganizationState;
import com.pulumi.cloudflare.organization.outputs.OrganizationMeta;
import com.pulumi.cloudflare.organization.outputs.OrganizationParent;
import com.pulumi.cloudflare.organization.outputs.OrganizationProfile;
 ...
 * 
 * ```sh
 * $ pulumi import cloudflare:organization/organization:Organization example &#39;&lt;organization_id&gt;&#39;
 * ```
 * 
 */
@ResourceType(type="cloudflare:organization/organization:Organization")
public class Organization extends com.pulumi.resources.CustomResource {
    ...
    public Organization(java.lang.String name, OrganizationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:organization/organization:Organization", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Organization(java.lang.String name, Output<java.lang.String> id, @Nullable OrganizationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:organization/organization:Organization", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/organization:Organization").build())
            ))
            .build();
