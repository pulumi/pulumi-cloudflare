    ...
    public static final class Builder {
        ...
        public ZeroTrustAccessPolicyExcludeOktaArgs build() {
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessPolicyExcludeOktaArgs", "identityProviderId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessPolicyExcludeOktaArgs", "name");
            }
            return $;
        }
    }
