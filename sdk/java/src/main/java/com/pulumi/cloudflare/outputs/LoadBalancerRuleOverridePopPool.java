...
public final class LoadBalancerRuleOverridePopPool {
    ...
    public static final class Builder {
        ...
        public Builder poolIds(List<String> poolIds) {
            if (poolIds == null) {
              throw new MissingRequiredPropertyException("LoadBalancerRuleOverridePopPool", "poolIds");
            }
        ...
        public Builder pop(String pop) {
            if (pop == null) {
              throw new MissingRequiredPropertyException("LoadBalancerRuleOverridePopPool", "pop");
            }
            this.pop = pop;
            return this;
        }
