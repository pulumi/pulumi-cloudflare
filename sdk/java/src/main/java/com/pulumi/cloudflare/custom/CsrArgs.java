...
public final class CsrArgs extends com.pulumi.resources.ResourceArgs {

    public static final CsrArgs Empty = new CsrArgs();
    ...
    public static Builder builder(CsrArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CsrArgs defaults) {
            $ = new CsrArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CsrArgs build() {
            if ($.commonName == null) {
                throw new MissingRequiredPropertyException("CsrArgs", "commonName");
            }
            if ($.country == null) {
                throw new MissingRequiredPropertyException("CsrArgs", "country");
            }
            if ($.locality == null) {
                throw new MissingRequiredPropertyException("CsrArgs", "locality");
            }
            if ($.organization == null) {
                throw new MissingRequiredPropertyException("CsrArgs", "organization");
            }
            if ($.sans == null) {
                throw new MissingRequiredPropertyException("CsrArgs", "sans");
            }
            if ($.state == null) {
                throw new MissingRequiredPropertyException("CsrArgs", "state");
            }
            return $;
        }
    }
