...
import com.pulumi.cloudflare.r2Bucket.inputs.LifecycleState;
import com.pulumi.cloudflare.r2Bucket.outputs.LifecycleRule;
 ...
 * 
 */
@ResourceType(type="cloudflare:r2Bucket/lifecycle:Lifecycle")
public class Lifecycle extends com.pulumi.resources.CustomResource {
    /**
     * Account ID.
     * 
     */
    ...
    @Export(name="rules", refs={List.class,LifecycleRule.class}, tree="[0,1]")
    private Output</* @Nullable */ List<LifecycleRule>> rules;

    public Output<Optional<List<LifecycleRule>>> rules() {
     ...
     */
    public Lifecycle(java.lang.String name, LifecycleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Lifecycle(java.lang.String name, LifecycleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:r2Bucket/lifecycle:Lifecycle", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Lifecycle(java.lang.String name, Output<java.lang.String> id, @Nullable LifecycleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:r2Bucket/lifecycle:Lifecycle", name, state, makeResourceOptions(options, id), false);
    }

    private static LifecycleArgs makeArgs(LifecycleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LifecycleArgs.Empty : args;
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/r2BucketLifecycle:R2BucketLifecycle").build())
            ))
            .build();
     ...
     */
    public static Lifecycle get(java.lang.String name, Output<java.lang.String> id, @Nullable LifecycleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
