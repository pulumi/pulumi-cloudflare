...
import com.pulumi.cloudflare.inputs.DnsRecordDataArgs;
...
public final class DnsRecordState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<DnsRecordSettingsArgs> settings;

    /**
     * @return Settings for the DNS record.
     * 
     */
    public Optional<Output<DnsRecordSettingsArgs>> settings() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder data(@Nullable Output<DnsRecordDataArgs> data) {
            $.data = data;
            return this;
        }
         ...
         * 
         */
        public Builder data(DnsRecordDataArgs data) {
         ...
         * 
         */
        public Builder settings(@Nullable Output<DnsRecordSettingsArgs> settings) {
            $.settings = settings;
            return this;
        }
         ...
         * 
         */
        public Builder settings(DnsRecordSettingsArgs settings) {
