...
@CustomType
public final class TeamsAccountLoggingSettingsByRuleTypeDns {
    /**
    ...
    private TeamsAccountLoggingSettingsByRuleTypeDns() {}
    /**
     * @return Whether to log all activity.
     * 
     */
    ...
    public static Builder builder(TeamsAccountLoggingSettingsByRuleTypeDns defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean logBlocks;
        public Builder() {}
        public Builder(TeamsAccountLoggingSettingsByRuleTypeDns defaults) {
        ...
        public Builder logAll(Boolean logAll) {
            if (logAll == null) {
              throw new MissingRequiredPropertyException("TeamsAccountLoggingSettingsByRuleTypeDns", "logAll");
            }
            this.logAll = logAll;
            return this;
        }
        ...
        public Builder logBlocks(Boolean logBlocks) {
            if (logBlocks == null) {
              throw new MissingRequiredPropertyException("TeamsAccountLoggingSettingsByRuleTypeDns", "logBlocks");
            }
