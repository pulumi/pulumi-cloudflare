...
public final class TeamsAccountSettingsInspectionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TeamsAccountSettingsInspectionArgs() {}

    private TeamsAccountSettingsInspectionArgs(TeamsAccountSettingsInspectionArgs $) {
        this.mode = $.mode;
    }
    ...
    public static Builder builder(TeamsAccountSettingsInspectionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TeamsAccountSettingsInspectionArgs();
        }

        public Builder(TeamsAccountSettingsInspectionArgs defaults) {
            $ = new TeamsAccountSettingsInspectionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TeamsAccountSettingsInspectionArgs build() {
            return $;
        }
    }
