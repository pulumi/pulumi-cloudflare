...
public final class ConsumerSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConsumerSettingsArgs Empty = new ConsumerSettingsArgs();
    ...
    private ConsumerSettingsArgs() {}

    private ConsumerSettingsArgs(ConsumerSettingsArgs $) {
    ...
    public static Builder builder(ConsumerSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConsumerSettingsArgs();
        }

        public Builder(ConsumerSettingsArgs defaults) {
            $ = new ConsumerSettingsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ConsumerSettingsArgs build() {
            return $;
        }
    }
