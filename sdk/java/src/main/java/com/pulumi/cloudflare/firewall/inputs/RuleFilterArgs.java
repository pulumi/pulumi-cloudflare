...
public final class RuleFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuleFilterArgs Empty = new RuleFilterArgs();
    ...
    private RuleFilterArgs() {}

    private RuleFilterArgs(RuleFilterArgs $) {
    ...
    public static Builder builder(RuleFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RuleFilterArgs defaults) {
            $ = new RuleFilterArgs(Objects.requireNonNull(defaults));
        }
