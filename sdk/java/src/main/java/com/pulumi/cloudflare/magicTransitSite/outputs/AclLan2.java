...
public final class AclLan2 {
    ...
    public static Builder builder(AclLan2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> subnets;
        public Builder() {}
        public Builder(AclLan2 defaults) {
        ...
        public Builder lanId(String lanId) {
            if (lanId == null) {
              throw new MissingRequiredPropertyException("AclLan2", "lanId");
            }
            this.lanId = lanId;
            return this;
        }
        ...
        public AclLan2 build() {
            final var _resultValue = new AclLan2();
