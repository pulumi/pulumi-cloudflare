...
public class WorkersSecret extends com.pulumi.resources.CustomResource {
     ...
     */
    public WorkersSecret(java.lang.String name) {
     ...
     */
    public WorkersSecret(java.lang.String name, WorkersSecretArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WorkersSecret(java.lang.String name, WorkersSecretArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:index/workersSecret:WorkersSecret", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WorkersSecret(java.lang.String name, Output<java.lang.String> id, @Nullable WorkersSecretState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:index/workersSecret:WorkersSecret", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static WorkersSecret get(java.lang.String name, Output<java.lang.String> id, @Nullable WorkersSecretState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
