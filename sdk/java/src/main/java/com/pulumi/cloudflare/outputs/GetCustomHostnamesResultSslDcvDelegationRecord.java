...
@CustomType
public final class GetCustomHostnamesResultSslDcvDelegationRecord {
    /**
    ...
    private GetCustomHostnamesResultSslDcvDelegationRecord() {}
    /**
     * @return The CNAME record hostname for DCV delegation.
     * 
     */
    ...
    public static Builder builder(GetCustomHostnamesResultSslDcvDelegationRecord defaults) {
    ...
    public static final class Builder {
        ...
        private String txtValue;
        public Builder() {}
        public Builder(GetCustomHostnamesResultSslDcvDelegationRecord defaults) {
        ...
        public Builder cname(String cname) {
            if (cname == null) {
              throw new MissingRequiredPropertyException("GetCustomHostnamesResultSslDcvDelegationRecord", "cname");
            }
            this.cname = cname;
            return this;
        }
        ...
        public Builder cnameTarget(String cnameTarget) {
            if (cnameTarget == null) {
              throw new MissingRequiredPropertyException("GetCustomHostnamesResultSslDcvDelegationRecord", "cnameTarget");
            }
        ...
        public Builder emails(List<String> emails) {
            if (emails == null) {
              throw new MissingRequiredPropertyException("GetCustomHostnamesResultSslDcvDelegationRecord", "emails");
            }
            this.emails = emails;
            return this;
        }
        ...
        public Builder httpBody(String httpBody) {
            if (httpBody == null) {
              throw new MissingRequiredPropertyException("GetCustomHostnamesResultSslDcvDelegationRecord", "httpBody");
            }
        ...
        public Builder httpUrl(String httpUrl) {
            if (httpUrl == null) {
              throw new MissingRequiredPropertyException("GetCustomHostnamesResultSslDcvDelegationRecord", "httpUrl");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetCustomHostnamesResultSslDcvDelegationRecord", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder txtName(String txtName) {
            if (txtName == null) {
              throw new MissingRequiredPropertyException("GetCustomHostnamesResultSslDcvDelegationRecord", "txtName");
            }
        ...
        public Builder txtValue(String txtValue) {
            if (txtValue == null) {
              throw new MissingRequiredPropertyException("GetCustomHostnamesResultSslDcvDelegationRecord", "txtValue");
            }
            this.txtValue = txtValue;
            return this;
        }
        public GetCustomHostnamesResultSslDcvDelegationRecord build() {
            final var _resultValue = new GetCustomHostnamesResultSslDcvDelegationRecord();
