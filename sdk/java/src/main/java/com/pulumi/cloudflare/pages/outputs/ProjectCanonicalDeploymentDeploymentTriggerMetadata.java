...
@CustomType
public final class ProjectCanonicalDeploymentDeploymentTriggerMetadata {
    /**
    ...
    public static Builder builder(ProjectCanonicalDeploymentDeploymentTriggerMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String commitMessage;
        public Builder() {}
        public Builder(ProjectCanonicalDeploymentDeploymentTriggerMetadata defaults) {
        ...
        public ProjectCanonicalDeploymentDeploymentTriggerMetadata build() {
            final var _resultValue = new ProjectCanonicalDeploymentDeploymentTriggerMetadata();
