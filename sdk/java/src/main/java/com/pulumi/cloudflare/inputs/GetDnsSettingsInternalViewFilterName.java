...
public final class GetDnsSettingsInternalViewFilterName extends com.pulumi.resources.InvokeArgs {

    public static final GetDnsSettingsInternalViewFilterName Empty = new GetDnsSettingsInternalViewFilterName();
    ...
    private GetDnsSettingsInternalViewFilterName() {}

    private GetDnsSettingsInternalViewFilterName(GetDnsSettingsInternalViewFilterName $) {
    ...
    public static Builder builder(GetDnsSettingsInternalViewFilterName defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDnsSettingsInternalViewFilterName();
        }

        public Builder(GetDnsSettingsInternalViewFilterName defaults) {
            $ = new GetDnsSettingsInternalViewFilterName(Objects.requireNonNull(defaults));
        }
        ...
        public GetDnsSettingsInternalViewFilterName build() {
            return $;
        }
    }
