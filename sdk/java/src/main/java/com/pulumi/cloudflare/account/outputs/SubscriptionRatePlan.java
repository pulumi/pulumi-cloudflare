...
@CustomType
public final class SubscriptionRatePlan {
    /**
    ...
    public static Builder builder(SubscriptionRatePlan defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> sets;
        public Builder() {}
        public Builder(SubscriptionRatePlan defaults) {
        ...
        public SubscriptionRatePlan build() {
            final var _resultValue = new SubscriptionRatePlan();
