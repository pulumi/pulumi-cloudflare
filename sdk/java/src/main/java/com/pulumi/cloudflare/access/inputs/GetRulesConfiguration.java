...
public final class GetRulesConfiguration extends com.pulumi.resources.InvokeArgs {

    public static final GetRulesConfiguration Empty = new GetRulesConfiguration();
    ...
    private GetRulesConfiguration() {}

    private GetRulesConfiguration(GetRulesConfiguration $) {
        this.target = $.target;
        this.value = $.value;
    }
    ...
    public static Builder builder(GetRulesConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRulesConfiguration();
        }

        public Builder(GetRulesConfiguration defaults) {
            $ = new GetRulesConfiguration(Objects.requireNonNull(defaults));
        }
        ...
        public GetRulesConfiguration build() {
            return $;
        }
    }
