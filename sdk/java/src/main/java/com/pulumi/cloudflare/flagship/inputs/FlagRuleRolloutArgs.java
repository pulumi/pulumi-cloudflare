...
public final class FlagRuleRolloutArgs extends com.pulumi.resources.ResourceArgs {

    public static final FlagRuleRolloutArgs Empty = new FlagRuleRolloutArgs();
    ...
    private FlagRuleRolloutArgs() {}

    private FlagRuleRolloutArgs(FlagRuleRolloutArgs $) {
    ...
    public static Builder builder(FlagRuleRolloutArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FlagRuleRolloutArgs();
        }

        public Builder(FlagRuleRolloutArgs defaults) {
            $ = new FlagRuleRolloutArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FlagRuleRolloutArgs build() {
            if ($.percentage == null) {
                throw new MissingRequiredPropertyException("FlagRuleRolloutArgs", "percentage");
            }
            return $;
        }
    }
