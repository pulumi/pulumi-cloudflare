...
@CustomType
public final class ItemRedirect {
    ...
    public static Builder builder(ItemRedirect defaults) {
    ...
    public static final class Builder {
        ...
        private String targetUrl;
        public Builder() {}
        public Builder(ItemRedirect defaults) {
        ...
        public Builder sourceUrl(String sourceUrl) {
            if (sourceUrl == null) {
              throw new MissingRequiredPropertyException("ItemRedirect", "sourceUrl");
            }
        ...
        public Builder targetUrl(String targetUrl) {
            if (targetUrl == null) {
              throw new MissingRequiredPropertyException("ItemRedirect", "targetUrl");
            }
            this.targetUrl = targetUrl;
            return this;
        }
        public ItemRedirect build() {
            final var _resultValue = new ItemRedirect();
