...
@CustomType
public final class GetPolicyRuleSettingsBisoAdminControls {
    /**
    ...
    private GetPolicyRuleSettingsBisoAdminControls() {}
    /**
     * @return Configure copy behavior. If set to remote*only, users cannot copy isolated content from the remote browser to the local clipboard. If this field is absent, copying remains enabled. Applies only when version == &#34;v2&#34;.
     * Available values: &#34;enabled&#34;, &#34;disabled&#34;, &#34;remote*only&#34;.
     * 
    ...
    public static Builder builder(GetPolicyRuleSettingsBisoAdminControls defaults) {
    ...
    public static final class Builder {
        ...
        private String wmId;
        public Builder() {}
        public Builder(GetPolicyRuleSettingsBisoAdminControls defaults) {
        ...
        public Builder copy(String copy) {
            if (copy == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsBisoAdminControls", "copy");
            }
            this.copy = copy;
            return this;
        }
        ...
        public Builder dcp(Boolean dcp) {
            if (dcp == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsBisoAdminControls", "dcp");
            }
            this.dcp = dcp;
            return this;
        }
        ...
        public Builder dd(Boolean dd) {
            if (dd == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsBisoAdminControls", "dd");
            }
            this.dd = dd;
            return this;
        }
        ...
        public Builder dk(Boolean dk) {
            if (dk == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsBisoAdminControls", "dk");
            }
            this.dk = dk;
            return this;
        }
        ...
        public Builder download(String download) {
            if (download == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsBisoAdminControls", "download");
            }
        ...
        public Builder dp(Boolean dp) {
            if (dp == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsBisoAdminControls", "dp");
            }
            this.dp = dp;
            return this;
        }
        ...
        public Builder du(Boolean du) {
            if (du == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsBisoAdminControls", "du");
            }
            this.du = du;
            return this;
        }
        ...
        public Builder keyboard(String keyboard) {
            if (keyboard == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsBisoAdminControls", "keyboard");
            }
        ...
        public Builder paste(String paste) {
            if (paste == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsBisoAdminControls", "paste");
            }
            this.paste = paste;
            return this;
        }
        ...
        public Builder printing(String printing) {
            if (printing == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsBisoAdminControls", "printing");
            }
        ...
        public Builder upload(String upload) {
            if (upload == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsBisoAdminControls", "upload");
            }
            this.upload = upload;
            return this;
        }
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsBisoAdminControls", "version");
            }
        ...
        public Builder wmId(String wmId) {
            if (wmId == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsBisoAdminControls", "wmId");
            }
            this.wmId = wmId;
            return this;
        }
        public GetPolicyRuleSettingsBisoAdminControls build() {
            final var _resultValue = new GetPolicyRuleSettingsBisoAdminControls();
