...
@CustomType
public final class GetEntryConfidence {
    /**
    ...
    public static Builder builder(GetEntryConfidence defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean available;
        public Builder() {}
        public Builder(GetEntryConfidence defaults) {
        ...
        public Builder aiContextAvailable(Boolean aiContextAvailable) {
            if (aiContextAvailable == null) {
              throw new MissingRequiredPropertyException("GetEntryConfidence", "aiContextAvailable");
            }
        ...
        public Builder available(Boolean available) {
            if (available == null) {
              throw new MissingRequiredPropertyException("GetEntryConfidence", "available");
            }
            this.available = available;
            return this;
        }
        public GetEntryConfidence build() {
            final var _resultValue = new GetEntryConfidence();
