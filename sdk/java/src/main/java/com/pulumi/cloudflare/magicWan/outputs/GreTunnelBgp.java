...
@CustomType
public final class GreTunnelBgp {
    /**
    ...
    public static Builder builder(GreTunnelBgp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String md5Key;
        public Builder() {}
        public Builder(GreTunnelBgp defaults) {
        ...
        public Builder customerAsn(Integer customerAsn) {
            if (customerAsn == null) {
              throw new MissingRequiredPropertyException("GreTunnelBgp", "customerAsn");
            }
        ...
        public GreTunnelBgp build() {
            final var _resultValue = new GreTunnelBgp();
