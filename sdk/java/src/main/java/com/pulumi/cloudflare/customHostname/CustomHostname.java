...
import com.pulumi.cloudflare.customHostname.inputs.CustomHostnameState;
import com.pulumi.cloudflare.customHostname.outputs.CustomHostnameOwnershipVerification;
import com.pulumi.cloudflare.customHostname.outputs.CustomHostnameOwnershipVerificationHttp;
import com.pulumi.cloudflare.customHostname.outputs.CustomHostnameSsl;
 ...
 * 
 */
@ResourceType(type="cloudflare:customHostname/customHostname:CustomHostname")
public class CustomHostname extends com.pulumi.resources.CustomResource {
    ...
    public CustomHostname(java.lang.String name, CustomHostnameArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:customHostname/customHostname:CustomHostname", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private CustomHostname(java.lang.String name, Output<java.lang.String> id, @Nullable CustomHostnameState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:customHostname/customHostname:CustomHostname", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/customHostname:CustomHostname").build())
            ))
            .build();
