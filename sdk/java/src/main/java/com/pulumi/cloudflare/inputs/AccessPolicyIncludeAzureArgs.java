...
public final class AccessPolicyIncludeAzureArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AccessPolicyIncludeAzureArgs() {}

    private AccessPolicyIncludeAzureArgs(AccessPolicyIncludeAzureArgs $) {
    ...
    public static Builder builder(AccessPolicyIncludeAzureArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessPolicyIncludeAzureArgs();
        }

        public Builder(AccessPolicyIncludeAzureArgs defaults) {
            $ = new AccessPolicyIncludeAzureArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccessPolicyIncludeAzureArgs build() {
            return $;
        }
    }
