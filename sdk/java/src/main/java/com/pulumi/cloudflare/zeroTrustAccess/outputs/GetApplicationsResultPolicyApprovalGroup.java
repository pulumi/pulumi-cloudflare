...
@CustomType
public final class GetApplicationsResultPolicyApprovalGroup {
    /**
    ...
    private GetApplicationsResultPolicyApprovalGroup() {}
    /**
     * @return The number of approvals needed to obtain access.
     * 
     */
    ...
    public static Builder builder(GetApplicationsResultPolicyApprovalGroup defaults) {
    ...
    public static final class Builder {
        ...
        private String emailListUuid;
        public Builder() {}
        public Builder(GetApplicationsResultPolicyApprovalGroup defaults) {
        ...
        public Builder approvalsNeeded(Double approvalsNeeded) {
            if (approvalsNeeded == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResultPolicyApprovalGroup", "approvalsNeeded");
            }
        ...
        public Builder emailAddresses(List<String> emailAddresses) {
            if (emailAddresses == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResultPolicyApprovalGroup", "emailAddresses");
            }
        ...
        public Builder emailListUuid(String emailListUuid) {
            if (emailListUuid == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResultPolicyApprovalGroup", "emailListUuid");
            }
            this.emailListUuid = emailListUuid;
            return this;
        }
        public GetApplicationsResultPolicyApprovalGroup build() {
            final var _resultValue = new GetApplicationsResultPolicyApprovalGroup();
