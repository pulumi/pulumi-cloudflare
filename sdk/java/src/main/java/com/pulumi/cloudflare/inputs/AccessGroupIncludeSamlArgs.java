...
public final class AccessGroupIncludeSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccessGroupIncludeSamlArgs Empty = new AccessGroupIncludeSamlArgs();
    ...
    private AccessGroupIncludeSamlArgs() {}

    private AccessGroupIncludeSamlArgs(AccessGroupIncludeSamlArgs $) {
    ...
    public static Builder builder(AccessGroupIncludeSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessGroupIncludeSamlArgs();
        }

        public Builder(AccessGroupIncludeSamlArgs defaults) {
            $ = new AccessGroupIncludeSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccessGroupIncludeSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("AccessGroupIncludeSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("AccessGroupIncludeSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("AccessGroupIncludeSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
