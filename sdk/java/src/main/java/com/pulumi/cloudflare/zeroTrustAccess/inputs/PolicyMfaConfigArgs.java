...
public final class PolicyMfaConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyMfaConfigArgs Empty = new PolicyMfaConfigArgs();
    ...
    private PolicyMfaConfigArgs() {}

    private PolicyMfaConfigArgs(PolicyMfaConfigArgs $) {
    ...
    public static Builder builder(PolicyMfaConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyMfaConfigArgs();
        }

        public Builder(PolicyMfaConfigArgs defaults) {
            $ = new PolicyMfaConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyMfaConfigArgs build() {
            return $;
        }
    }
