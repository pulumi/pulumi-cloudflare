...
@CustomType
public final class DnsSettingsSoa {
    /**
    ...
    public static Builder builder(DnsSettingsSoa defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double ttl;
        public Builder() {}
        public Builder(DnsSettingsSoa defaults) {
        ...
        public DnsSettingsSoa build() {
            final var _resultValue = new DnsSettingsSoa();
