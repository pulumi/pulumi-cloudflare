...
@CustomType
public final class GetProjectLatestDeploymentSourceConfig {
    /**
    ...
    private GetProjectLatestDeploymentSourceConfig() {}
    /**
     * @return Whether to enable automatic deployments when pushing to the source repository.
     * When disabled, no deployments (production or preview) will be triggered automatically.
     * 
    ...
    public static Builder builder(GetProjectLatestDeploymentSourceConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String repoName;
        public Builder() {}
        public Builder(GetProjectLatestDeploymentSourceConfig defaults) {
        ...
        public Builder deploymentsEnabled(Boolean deploymentsEnabled) {
            if (deploymentsEnabled == null) {
              throw new MissingRequiredPropertyException("GetProjectLatestDeploymentSourceConfig", "deploymentsEnabled");
            }
        ...
        public Builder owner(String owner) {
            if (owner == null) {
              throw new MissingRequiredPropertyException("GetProjectLatestDeploymentSourceConfig", "owner");
            }
            this.owner = owner;
            return this;
        }
        ...
        public Builder ownerId(String ownerId) {
            if (ownerId == null) {
              throw new MissingRequiredPropertyException("GetProjectLatestDeploymentSourceConfig", "ownerId");
            }
        ...
        public Builder pathExcludes(List<String> pathExcludes) {
            if (pathExcludes == null) {
              throw new MissingRequiredPropertyException("GetProjectLatestDeploymentSourceConfig", "pathExcludes");
            }
        ...
        public Builder pathIncludes(List<String> pathIncludes) {
            if (pathIncludes == null) {
              throw new MissingRequiredPropertyException("GetProjectLatestDeploymentSourceConfig", "pathIncludes");
            }
        ...
        public Builder prCommentsEnabled(Boolean prCommentsEnabled) {
            if (prCommentsEnabled == null) {
              throw new MissingRequiredPropertyException("GetProjectLatestDeploymentSourceConfig", "prCommentsEnabled");
            }
        ...
        public Builder previewBranchExcludes(List<String> previewBranchExcludes) {
            if (previewBranchExcludes == null) {
              throw new MissingRequiredPropertyException("GetProjectLatestDeploymentSourceConfig", "previewBranchExcludes");
            }
        ...
        public Builder previewBranchIncludes(List<String> previewBranchIncludes) {
            if (previewBranchIncludes == null) {
              throw new MissingRequiredPropertyException("GetProjectLatestDeploymentSourceConfig", "previewBranchIncludes");
            }
        ...
        public Builder previewDeploymentSetting(String previewDeploymentSetting) {
            if (previewDeploymentSetting == null) {
              throw new MissingRequiredPropertyException("GetProjectLatestDeploymentSourceConfig", "previewDeploymentSetting");
            }
        ...
        public Builder productionBranch(String productionBranch) {
            if (productionBranch == null) {
              throw new MissingRequiredPropertyException("GetProjectLatestDeploymentSourceConfig", "productionBranch");
            }
        ...
        public Builder productionDeploymentsEnabled(Boolean productionDeploymentsEnabled) {
            if (productionDeploymentsEnabled == null) {
              throw new MissingRequiredPropertyException("GetProjectLatestDeploymentSourceConfig", "productionDeploymentsEnabled");
            }
        ...
        public Builder repoId(String repoId) {
            if (repoId == null) {
              throw new MissingRequiredPropertyException("GetProjectLatestDeploymentSourceConfig", "repoId");
            }
            this.repoId = repoId;
            return this;
        }
        ...
        public Builder repoName(String repoName) {
            if (repoName == null) {
              throw new MissingRequiredPropertyException("GetProjectLatestDeploymentSourceConfig", "repoName");
            }
            this.repoName = repoName;
            return this;
        }
        public GetProjectLatestDeploymentSourceConfig build() {
            final var _resultValue = new GetProjectLatestDeploymentSourceConfig();
