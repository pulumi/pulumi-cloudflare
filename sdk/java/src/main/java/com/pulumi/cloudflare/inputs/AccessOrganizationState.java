...
public final class AccessOrganizationState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<AccessOrganizationMfaConfigArgs> mfaConfig;

    /**
     * @return Configures multi-factor authentication (MFA) settings for an organization.
     * 
     */
    public Optional<Output<AccessOrganizationMfaConfigArgs>> mfaConfig() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder mfaConfig(@Nullable Output<AccessOrganizationMfaConfigArgs> mfaConfig) {
            $.mfaConfig = mfaConfig;
            return this;
        }
         ...
         * 
         */
        public Builder mfaConfig(AccessOrganizationMfaConfigArgs mfaConfig) {
