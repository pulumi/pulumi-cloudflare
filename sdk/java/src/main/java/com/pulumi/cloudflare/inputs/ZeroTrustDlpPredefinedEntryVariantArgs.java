...
public final class ZeroTrustDlpPredefinedEntryVariantArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ZeroTrustDlpPredefinedEntryVariantArgs() {}

    private ZeroTrustDlpPredefinedEntryVariantArgs(ZeroTrustDlpPredefinedEntryVariantArgs $) {
    ...
    public static Builder builder(ZeroTrustDlpPredefinedEntryVariantArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustDlpPredefinedEntryVariantArgs();
        }

        public Builder(ZeroTrustDlpPredefinedEntryVariantArgs defaults) {
        ...
        public ZeroTrustDlpPredefinedEntryVariantArgs build() {
            return $;
        }
    }
