...
import com.pulumi.cloudflare.rate.outputs.GetLimitsResultActionResponse;
...
@CustomType
public final class GetLimitsResultAction {
    /**
     ...
     * 
     */
    private GetLimitsResultActionResponse response;
    /**
     ...
     * 
     */
    public GetLimitsResultActionResponse response() {
    ...
    public static Builder builder(GetLimitsResultAction defaults) {
    ...
    public static final class Builder {
        ...
        private Double timeout;
        public Builder() {}
        public Builder(GetLimitsResultAction defaults) {
        ...
        public Builder mode(String mode) {
            if (mode == null) {
              throw new MissingRequiredPropertyException("GetLimitsResultAction", "mode");
            }
            this.mode = mode;
            return this;
        }
        @CustomType.Setter
        public Builder response(GetLimitsResultActionResponse response) {
            if (response == null) {
              throw new MissingRequiredPropertyException("GetLimitsResultAction", "response");
            }
        ...
        public Builder timeout(Double timeout) {
            if (timeout == null) {
              throw new MissingRequiredPropertyException("GetLimitsResultAction", "timeout");
            }
            this.timeout = timeout;
            return this;
        }
        public GetLimitsResultAction build() {
            final var _resultValue = new GetLimitsResultAction();
