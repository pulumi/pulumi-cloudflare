...
import com.pulumi.cloudflare.client.inputs.CertificateState;
import com.pulumi.cloudflare.client.outputs.CertificateCertificateAuthority;
 ...
 * 
 */
@ResourceType(type="cloudflare:client/certificate:Certificate")
public class Certificate extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="certificateAuthority", refs={CertificateCertificateAuthority.class}, tree="[0]")
    private Output<CertificateCertificateAuthority> certificateAuthority;

    /**
     * @return Certificate Authority used to issue the Client Certificate.
     * 
     */
    public Output<CertificateCertificateAuthority> certificateAuthority() {
    ...
    public Certificate(java.lang.String name, CertificateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:client/certificate:Certificate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Certificate(java.lang.String name, Output<java.lang.String> id, @Nullable CertificateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:client/certificate:Certificate", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/clientCertificate:ClientCertificate").build())
            ))
            .build();
