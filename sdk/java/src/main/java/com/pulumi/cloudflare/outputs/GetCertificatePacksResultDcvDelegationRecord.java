...
@CustomType
public final class GetCertificatePacksResultDcvDelegationRecord {
    /**
    ...
    private GetCertificatePacksResultDcvDelegationRecord() {}
    /**
     * @return The CNAME record hostname for DCV delegation.
     * 
     */
    ...
    public static Builder builder(GetCertificatePacksResultDcvDelegationRecord defaults) {
    ...
    public static final class Builder {
        ...
        private String txtValue;
        public Builder() {}
        public Builder(GetCertificatePacksResultDcvDelegationRecord defaults) {
        ...
        public Builder cname(String cname) {
            if (cname == null) {
              throw new MissingRequiredPropertyException("GetCertificatePacksResultDcvDelegationRecord", "cname");
            }
            this.cname = cname;
            return this;
        }
        ...
        public Builder cnameTarget(String cnameTarget) {
            if (cnameTarget == null) {
              throw new MissingRequiredPropertyException("GetCertificatePacksResultDcvDelegationRecord", "cnameTarget");
            }
        ...
        public Builder emails(List<String> emails) {
            if (emails == null) {
              throw new MissingRequiredPropertyException("GetCertificatePacksResultDcvDelegationRecord", "emails");
            }
            this.emails = emails;
            return this;
        }
        ...
        public Builder httpBody(String httpBody) {
            if (httpBody == null) {
              throw new MissingRequiredPropertyException("GetCertificatePacksResultDcvDelegationRecord", "httpBody");
            }
        ...
        public Builder httpUrl(String httpUrl) {
            if (httpUrl == null) {
              throw new MissingRequiredPropertyException("GetCertificatePacksResultDcvDelegationRecord", "httpUrl");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetCertificatePacksResultDcvDelegationRecord", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder txtName(String txtName) {
            if (txtName == null) {
              throw new MissingRequiredPropertyException("GetCertificatePacksResultDcvDelegationRecord", "txtName");
            }
        ...
        public Builder txtValue(String txtValue) {
            if (txtValue == null) {
              throw new MissingRequiredPropertyException("GetCertificatePacksResultDcvDelegationRecord", "txtValue");
            }
            this.txtValue = txtValue;
            return this;
        }
        public GetCertificatePacksResultDcvDelegationRecord build() {
            final var _resultValue = new GetCertificatePacksResultDcvDelegationRecord();
