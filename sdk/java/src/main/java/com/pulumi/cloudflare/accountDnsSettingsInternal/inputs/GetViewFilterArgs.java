...
import com.pulumi.cloudflare.accountDnsSettingsInternal.inputs.GetViewFilterNameArgs;
...
public final class GetViewFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetViewFilterArgs Empty = new GetViewFilterArgs();
    ...
    @Import(name="name")
    private @Nullable Output<GetViewFilterNameArgs> name;

    public Optional<Output<GetViewFilterNameArgs>> name() {
    ...
    private GetViewFilterArgs() {}

    private GetViewFilterArgs(GetViewFilterArgs $) {
    ...
    public static Builder builder(GetViewFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetViewFilterArgs();
        }

        public Builder(GetViewFilterArgs defaults) {
            $ = new GetViewFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder name(@Nullable Output<GetViewFilterNameArgs> name) {
            $.name = name;
            return this;
        }

        public Builder name(GetViewFilterNameArgs name) {
        ...
        public GetViewFilterArgs build() {
            if ($.direction == null) {
                throw new MissingRequiredPropertyException("GetViewFilterArgs", "direction");
            }
            if ($.match == null) {
                throw new MissingRequiredPropertyException("GetViewFilterArgs", "match");
            }
            return $;
        }
    }
