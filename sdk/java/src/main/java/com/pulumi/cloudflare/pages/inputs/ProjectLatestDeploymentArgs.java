...
import com.pulumi.cloudflare.pages.inputs.ProjectLatestDeploymentBuildConfigArgs;
import com.pulumi.cloudflare.pages.inputs.ProjectLatestDeploymentDeploymentTriggerArgs;
import com.pulumi.cloudflare.pages.inputs.ProjectLatestDeploymentEnvVarsArgs;
import com.pulumi.cloudflare.pages.inputs.ProjectLatestDeploymentLatestStageArgs;
import com.pulumi.cloudflare.pages.inputs.ProjectLatestDeploymentSourceArgs;
import com.pulumi.cloudflare.pages.inputs.ProjectLatestDeploymentStageArgs;
...
public final class ProjectLatestDeploymentArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectLatestDeploymentArgs Empty = new ProjectLatestDeploymentArgs();
    ...
    private @Nullable Output<ProjectLatestDeploymentBuildConfigArgs> buildConfig;

    /**
     * @return Configs for the project build process.
     * 
     */
    public Optional<Output<ProjectLatestDeploymentBuildConfigArgs>> buildConfig() {
    ...
    private @Nullable Output<ProjectLatestDeploymentDeploymentTriggerArgs> deploymentTrigger;

    /**
     * @return Info about what caused the deployment.
     * 
     */
    public Optional<Output<ProjectLatestDeploymentDeploymentTriggerArgs>> deploymentTrigger() {
     ...
     */
    @Import(name="envVars")
    private @Nullable Output<Map<String,ProjectLatestDeploymentEnvVarsArgs>> envVars;

    /**
     * @return Environment variables used for builds and Pages Functions.
     * 
     */
    public Optional<Output<Map<String,ProjectLatestDeploymentEnvVarsArgs>>> envVars() {
    ...
    private @Nullable Output<ProjectLatestDeploymentLatestStageArgs> latestStage;

    /**
     * @return The status of the deployment.
     * 
     */
    public Optional<Output<ProjectLatestDeploymentLatestStageArgs>> latestStage() {
     ...
     */
    @Import(name="source")
    private @Nullable Output<ProjectLatestDeploymentSourceArgs> source;

    /**
     * @return Configs for the project source control.
     * 
     */
    public Optional<Output<ProjectLatestDeploymentSourceArgs>> source() {
     ...
     */
    @Import(name="stages")
    private @Nullable Output<List<ProjectLatestDeploymentStageArgs>> stages;

    /**
     * @return List of past stages.
     * 
     */
    public Optional<Output<List<ProjectLatestDeploymentStageArgs>>> stages() {
    ...
    private ProjectLatestDeploymentArgs() {}

    private ProjectLatestDeploymentArgs(ProjectLatestDeploymentArgs $) {
    ...
    public static Builder builder(ProjectLatestDeploymentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectLatestDeploymentArgs();
        }

        public Builder(ProjectLatestDeploymentArgs defaults) {
            $ = new ProjectLatestDeploymentArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder buildConfig(@Nullable Output<ProjectLatestDeploymentBuildConfigArgs> buildConfig) {
         ...
         * 
         */
        public Builder buildConfig(ProjectLatestDeploymentBuildConfigArgs buildConfig) {
         ...
         * 
         */
        public Builder deploymentTrigger(@Nullable Output<ProjectLatestDeploymentDeploymentTriggerArgs> deploymentTrigger) {
         ...
         * 
         */
        public Builder deploymentTrigger(ProjectLatestDeploymentDeploymentTriggerArgs deploymentTrigger) {
         ...
         * 
         */
        public Builder envVars(@Nullable Output<Map<String,ProjectLatestDeploymentEnvVarsArgs>> envVars) {
            $.envVars = envVars;
            return this;
        }
         ...
         * 
         */
        public Builder envVars(Map<String,ProjectLatestDeploymentEnvVarsArgs> envVars) {
         ...
         * 
         */
        public Builder latestStage(@Nullable Output<ProjectLatestDeploymentLatestStageArgs> latestStage) {
         ...
         * 
         */
        public Builder latestStage(ProjectLatestDeploymentLatestStageArgs latestStage) {
         ...
         * 
         */
        public Builder source(@Nullable Output<ProjectLatestDeploymentSourceArgs> source) {
            $.source = source;
            return this;
        }
         ...
         * 
         */
        public Builder source(ProjectLatestDeploymentSourceArgs source) {
         ...
         * 
         */
        public Builder stages(@Nullable Output<List<ProjectLatestDeploymentStageArgs>> stages) {
            $.stages = stages;
            return this;
        }
         ...
         * 
         */
        public Builder stages(List<ProjectLatestDeploymentStageArgs> stages) {
         ...
         * 
         */
        public Builder stages(ProjectLatestDeploymentStageArgs... stages) {
        ...
        public ProjectLatestDeploymentArgs build() {
            return $;
        }
    }
