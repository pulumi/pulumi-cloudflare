...
public final class GetZeroTrustInfrastructureAccessTargetsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetZeroTrustInfrastructureAccessTargetsArgs Empty = new GetZeroTrustInfrastructureAccessTargetsArgs();
    ...
    private GetZeroTrustInfrastructureAccessTargetsArgs() {}

    private GetZeroTrustInfrastructureAccessTargetsArgs(GetZeroTrustInfrastructureAccessTargetsArgs $) {
    ...
    public static Builder builder(GetZeroTrustInfrastructureAccessTargetsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetZeroTrustInfrastructureAccessTargetsArgs();
        }

        public Builder(GetZeroTrustInfrastructureAccessTargetsArgs defaults) {
            $ = new GetZeroTrustInfrastructureAccessTargetsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetZeroTrustInfrastructureAccessTargetsArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetZeroTrustInfrastructureAccessTargetsArgs", "accountId");
            }
            return $;
        }
    }
