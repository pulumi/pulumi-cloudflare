...
public final class PolicyScheduleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyScheduleArgs Empty = new PolicyScheduleArgs();
    ...
    private PolicyScheduleArgs() {}

    private PolicyScheduleArgs(PolicyScheduleArgs $) {
        this.fri = $.fri;
        this.mon = $.mon;
        this.sat = $.sat;
        this.sun = $.sun;
    ...
    public static Builder builder(PolicyScheduleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyScheduleArgs();
        }

        public Builder(PolicyScheduleArgs defaults) {
            $ = new PolicyScheduleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyScheduleArgs build() {
            return $;
        }
    }
