...
public final class GetWorkersSecretArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetWorkersSecretArgs() {}

    private GetWorkersSecretArgs(GetWorkersSecretArgs $) {
    ...
    public static Builder builder(GetWorkersSecretArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetWorkersSecretArgs();
        }

        public Builder(GetWorkersSecretArgs defaults) {
            $ = new GetWorkersSecretArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetWorkersSecretArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetWorkersSecretArgs", "accountId");
            }
            if ($.dispatchNamespace == null) {
                throw new MissingRequiredPropertyException("GetWorkersSecretArgs", "dispatchNamespace");
            }
            if ($.scriptName == null) {
                throw new MissingRequiredPropertyException("GetWorkersSecretArgs", "scriptName");
            }
            return $;
        }
    }
