...
@CustomType
public final class GetItemRedirect {
    ...
    public static Builder builder(GetItemRedirect defaults) {
    ...
    public static final class Builder {
        ...
        private String targetUrl;
        public Builder() {}
        public Builder(GetItemRedirect defaults) {
        ...
        public Builder includeSubdomains(Boolean includeSubdomains) {
            if (includeSubdomains == null) {
              throw new MissingRequiredPropertyException("GetItemRedirect", "includeSubdomains");
            }
        ...
        public Builder preservePathSuffix(Boolean preservePathSuffix) {
            if (preservePathSuffix == null) {
              throw new MissingRequiredPropertyException("GetItemRedirect", "preservePathSuffix");
            }
        ...
        public Builder preserveQueryString(Boolean preserveQueryString) {
            if (preserveQueryString == null) {
              throw new MissingRequiredPropertyException("GetItemRedirect", "preserveQueryString");
            }
        ...
        public Builder sourceUrl(String sourceUrl) {
            if (sourceUrl == null) {
              throw new MissingRequiredPropertyException("GetItemRedirect", "sourceUrl");
            }
        ...
        public Builder statusCode(Integer statusCode) {
            if (statusCode == null) {
              throw new MissingRequiredPropertyException("GetItemRedirect", "statusCode");
            }
        ...
        public Builder subpathMatching(Boolean subpathMatching) {
            if (subpathMatching == null) {
              throw new MissingRequiredPropertyException("GetItemRedirect", "subpathMatching");
            }
        ...
        public Builder targetUrl(String targetUrl) {
            if (targetUrl == null) {
              throw new MissingRequiredPropertyException("GetItemRedirect", "targetUrl");
            }
            this.targetUrl = targetUrl;
            return this;
        }
        public GetItemRedirect build() {
            final var _resultValue = new GetItemRedirect();
