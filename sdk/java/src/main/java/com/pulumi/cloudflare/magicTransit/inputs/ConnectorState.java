...
public final class ConnectorState extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="device")
    private @Nullable Output<ConnectorDeviceArgs> device;

    public Optional<Output<ConnectorDeviceArgs>> device() {
    ...
    public static final class Builder {
        ...
        public Builder device(@Nullable Output<ConnectorDeviceArgs> device) {
            $.device = device;
            return this;
        }
