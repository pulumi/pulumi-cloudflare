...
@CustomType
public final class ProjectLatestDeploymentSourceConfig {
    /**
    ...
    public static Builder builder(ProjectLatestDeploymentSourceConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repoName;
        public Builder() {}
        public Builder(ProjectLatestDeploymentSourceConfig defaults) {
        ...
        public ProjectLatestDeploymentSourceConfig build() {
            final var _resultValue = new ProjectLatestDeploymentSourceConfig();
