...
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationScimConfigAuthenticationArgs;
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationScimConfigMappingArgs;
...
public final class ApplicationScimConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationScimConfigArgs Empty = new ApplicationScimConfigArgs();
    ...
    private @Nullable Output<ApplicationScimConfigAuthenticationArgs> authentication;

    /**
     * @return Attributes for configuring HTTP Basic authentication scheme for SCIM provisioning to an application.
     * 
     */
    public Optional<Output<ApplicationScimConfigAuthenticationArgs>> authentication() {
    ...
    private @Nullable Output<List<ApplicationScimConfigMappingArgs>> mappings;
     ...
     * 
     */
    public Optional<Output<List<ApplicationScimConfigMappingArgs>>> mappings() {
    ...
    private ApplicationScimConfigArgs() {}

    private ApplicationScimConfigArgs(ApplicationScimConfigArgs $) {
    ...
    public static Builder builder(ApplicationScimConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationScimConfigArgs();
        }

        public Builder(ApplicationScimConfigArgs defaults) {
            $ = new ApplicationScimConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder authentication(@Nullable Output<ApplicationScimConfigAuthenticationArgs> authentication) {
         ...
         * 
         */
        public Builder authentication(ApplicationScimConfigAuthenticationArgs authentication) {
         ...
         * 
         */
        public Builder mappings(@Nullable Output<List<ApplicationScimConfigMappingArgs>> mappings) {
            $.mappings = mappings;
            return this;
        }
         ...
         * 
         */
        public Builder mappings(List<ApplicationScimConfigMappingArgs> mappings) {
         ...
         * 
         */
        public Builder mappings(ApplicationScimConfigMappingArgs... mappings) {
        ...
        public ApplicationScimConfigArgs build() {
            if ($.idpUid == null) {
                throw new MissingRequiredPropertyException("ApplicationScimConfigArgs", "idpUid");
            }
            if ($.remoteUri == null) {
                throw new MissingRequiredPropertyException("ApplicationScimConfigArgs", "remoteUri");
            }
            return $;
        }
    }
