...
@CustomType
public final class LoadBalancerSessionAffinityAttributes {
    /**
    ...
    private LoadBalancerSessionAffinityAttributes() {}
    /**
     * @return Configures the drain duration in seconds. This field is only used when session affinity is enabled on the load balancer.
     * 
     */
    ...
    public static Builder builder(LoadBalancerSessionAffinityAttributes defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String zeroDowntimeFailover;
        public Builder() {}
        public Builder(LoadBalancerSessionAffinityAttributes defaults) {
        ...
        public LoadBalancerSessionAffinityAttributes build() {
            final var _resultValue = new LoadBalancerSessionAffinityAttributes();
