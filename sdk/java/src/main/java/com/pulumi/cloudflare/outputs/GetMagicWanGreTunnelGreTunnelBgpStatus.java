...
@CustomType
public final class GetMagicWanGreTunnelGreTunnelBgpStatus {
    ...
    private GetMagicWanGreTunnelGreTunnelBgpStatus() {}
    ...
    public static Builder builder(GetMagicWanGreTunnelGreTunnelBgpStatus defaults) {
    ...
    public static final class Builder {
        ...
        private String updatedAt;
        public Builder() {}
        public Builder(GetMagicWanGreTunnelGreTunnelBgpStatus defaults) {
        ...
        public Builder bgpState(String bgpState) {
            if (bgpState == null) {
              throw new MissingRequiredPropertyException("GetMagicWanGreTunnelGreTunnelBgpStatus", "bgpState");
            }
        ...
        public Builder cfSpeakerIp(String cfSpeakerIp) {
            if (cfSpeakerIp == null) {
              throw new MissingRequiredPropertyException("GetMagicWanGreTunnelGreTunnelBgpStatus", "cfSpeakerIp");
            }
        ...
        public Builder cfSpeakerPort(Integer cfSpeakerPort) {
            if (cfSpeakerPort == null) {
              throw new MissingRequiredPropertyException("GetMagicWanGreTunnelGreTunnelBgpStatus", "cfSpeakerPort");
            }
        ...
        public Builder customerSpeakerIp(String customerSpeakerIp) {
            if (customerSpeakerIp == null) {
              throw new MissingRequiredPropertyException("GetMagicWanGreTunnelGreTunnelBgpStatus", "customerSpeakerIp");
            }
        ...
        public Builder customerSpeakerPort(Integer customerSpeakerPort) {
            if (customerSpeakerPort == null) {
              throw new MissingRequiredPropertyException("GetMagicWanGreTunnelGreTunnelBgpStatus", "customerSpeakerPort");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetMagicWanGreTunnelGreTunnelBgpStatus", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder tcpEstablished(Boolean tcpEstablished) {
            if (tcpEstablished == null) {
              throw new MissingRequiredPropertyException("GetMagicWanGreTunnelGreTunnelBgpStatus", "tcpEstablished");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetMagicWanGreTunnelGreTunnelBgpStatus", "updatedAt");
            }
            this.updatedAt = updatedAt;
            return this;
        }
        public GetMagicWanGreTunnelGreTunnelBgpStatus build() {
            final var _resultValue = new GetMagicWanGreTunnelGreTunnelBgpStatus();
