...
public final class SettingsSettingsInspectionArgs extends com.pulumi.resources.ResourceArgs {

    public static final SettingsSettingsInspectionArgs Empty = new SettingsSettingsInspectionArgs();
    ...
    private SettingsSettingsInspectionArgs() {}

    private SettingsSettingsInspectionArgs(SettingsSettingsInspectionArgs $) {
        this.mode = $.mode;
    }
    ...
    public static Builder builder(SettingsSettingsInspectionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SettingsSettingsInspectionArgs();
        }

        public Builder(SettingsSettingsInspectionArgs defaults) {
            $ = new SettingsSettingsInspectionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SettingsSettingsInspectionArgs build() {
            return $;
        }
    }
