...
@CustomType
public final class ProjectLatestDeploymentDeploymentTriggerMetadata {
    /**
    ...
    public static Builder builder(ProjectLatestDeploymentDeploymentTriggerMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String commitMessage;
        public Builder() {}
        public Builder(ProjectLatestDeploymentDeploymentTriggerMetadata defaults) {
        ...
        public ProjectLatestDeploymentDeploymentTriggerMetadata build() {
            final var _resultValue = new ProjectLatestDeploymentDeploymentTriggerMetadata();
