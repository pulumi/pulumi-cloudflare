...
import com.pulumi.cloudflare.zeroTrustTunnelCloudflaredVirtual.outputs.GetNetworkFilter;
...
public final class GetNetworkResult {
    ...
    private @Nullable GetNetworkFilter filter;
    /**
    ...
    public Optional<GetNetworkFilter> filter() {
    ...
    public static final class Builder {
        ...
        public Builder comment(String comment) {
            if (comment == null) {
              throw new MissingRequiredPropertyException("GetNetworkResult", "comment");
            }
        ...
        public Builder deletedAt(String deletedAt) {
            if (deletedAt == null) {
              throw new MissingRequiredPropertyException("GetNetworkResult", "deletedAt");
            }
            this.deletedAt = deletedAt;
            return this;
        }
        @CustomType.Setter
        public Builder filter(@Nullable GetNetworkFilter filter) {
        ...
        public Builder isDefaultNetwork(Boolean isDefaultNetwork) {
            if (isDefaultNetwork == null) {
              throw new MissingRequiredPropertyException("GetNetworkResult", "isDefaultNetwork");
            }
