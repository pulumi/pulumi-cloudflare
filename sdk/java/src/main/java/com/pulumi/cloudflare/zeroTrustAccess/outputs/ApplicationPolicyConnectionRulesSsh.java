...
@CustomType
public final class ApplicationPolicyConnectionRulesSsh {
    /**
    ...
    private ApplicationPolicyConnectionRulesSsh() {}
    /**
     * @return Enables using Identity Provider email alias as SSH username.
     * 
     */
    ...
    public static Builder builder(ApplicationPolicyConnectionRulesSsh defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> usernames;
        public Builder() {}
        public Builder(ApplicationPolicyConnectionRulesSsh defaults) {
        ...
        public Builder usernames(List<String> usernames) {
            if (usernames == null) {
              throw new MissingRequiredPropertyException("ApplicationPolicyConnectionRulesSsh", "usernames");
            }
        ...
        public ApplicationPolicyConnectionRulesSsh build() {
            final var _resultValue = new ApplicationPolicyConnectionRulesSsh();
