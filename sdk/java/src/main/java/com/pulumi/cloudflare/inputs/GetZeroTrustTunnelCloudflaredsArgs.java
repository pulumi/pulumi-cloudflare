...
public final class GetZeroTrustTunnelCloudflaredsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetZeroTrustTunnelCloudflaredsArgs Empty = new GetZeroTrustTunnelCloudflaredsArgs();
    ...
    private GetZeroTrustTunnelCloudflaredsArgs() {}

    private GetZeroTrustTunnelCloudflaredsArgs(GetZeroTrustTunnelCloudflaredsArgs $) {
    ...
    public static Builder builder(GetZeroTrustTunnelCloudflaredsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetZeroTrustTunnelCloudflaredsArgs();
        }

        public Builder(GetZeroTrustTunnelCloudflaredsArgs defaults) {
            $ = new GetZeroTrustTunnelCloudflaredsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetZeroTrustTunnelCloudflaredsArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredsArgs", "accountId");
            }
            return $;
        }
    }
