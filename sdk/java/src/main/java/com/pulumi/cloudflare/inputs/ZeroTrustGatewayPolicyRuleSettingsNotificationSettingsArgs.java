...
public final class ZeroTrustGatewayPolicyRuleSettingsNotificationSettingsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ZeroTrustGatewayPolicyRuleSettingsNotificationSettingsArgs() {}
    ...
    public static Builder builder(ZeroTrustGatewayPolicyRuleSettingsNotificationSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustGatewayPolicyRuleSettingsNotificationSettingsArgs();
        }

        public Builder(ZeroTrustGatewayPolicyRuleSettingsNotificationSettingsArgs defaults) {
            $ = new ZeroTrustGatewayPolicyRuleSettingsNotificationSettingsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ZeroTrustGatewayPolicyRuleSettingsNotificationSettingsArgs build() {
            return $;
        }
    }
