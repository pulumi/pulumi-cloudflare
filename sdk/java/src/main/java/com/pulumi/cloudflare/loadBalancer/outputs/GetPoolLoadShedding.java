...
@CustomType
public final class GetPoolLoadShedding {
    /**
    ...
    public static Builder builder(GetPoolLoadShedding defaults) {
    ...
    public static final class Builder {
        ...
        private String sessionPolicy;
        public Builder() {}
        public Builder(GetPoolLoadShedding defaults) {
        ...
        public Builder defaultPercent(Double defaultPercent) {
            if (defaultPercent == null) {
              throw new MissingRequiredPropertyException("GetPoolLoadShedding", "defaultPercent");
            }
        ...
        public Builder defaultPolicy(String defaultPolicy) {
            if (defaultPolicy == null) {
              throw new MissingRequiredPropertyException("GetPoolLoadShedding", "defaultPolicy");
            }
        ...
        public Builder sessionPercent(Double sessionPercent) {
            if (sessionPercent == null) {
              throw new MissingRequiredPropertyException("GetPoolLoadShedding", "sessionPercent");
            }
        ...
        public Builder sessionPolicy(String sessionPolicy) {
            if (sessionPolicy == null) {
              throw new MissingRequiredPropertyException("GetPoolLoadShedding", "sessionPolicy");
            }
            this.sessionPolicy = sessionPolicy;
            return this;
        }
        public GetPoolLoadShedding build() {
            final var _resultValue = new GetPoolLoadShedding();
