...
import com.pulumi.cloudflare.outputs.GetZeroTrustAccessPoliciesResultExcludeCloudflareAccountMember;
...
import com.pulumi.cloudflare.outputs.GetZeroTrustAccessPoliciesResultExcludeLinkedAppToken;
import com.pulumi.cloudflare.outputs.GetZeroTrustAccessPoliciesResultExcludeLoginMethod;
import com.pulumi.cloudflare.outputs.GetZeroTrustAccessPoliciesResultExcludeOidc;
...
import com.pulumi.cloudflare.outputs.GetZeroTrustAccessPoliciesResultExcludeUserRiskScore;
...
public final class GetZeroTrustAccessPoliciesResultExclude {
    ...
    private GetZeroTrustAccessPoliciesResultExcludeCloudflareAccountMember cloudflareAccountMember;
    ...
    private GetZeroTrustAccessPoliciesResultExcludeLinkedAppToken linkedAppToken;
    private GetZeroTrustAccessPoliciesResultExcludeLoginMethod loginMethod;
    private GetZeroTrustAccessPoliciesResultExcludeOidc oidc;
    ...
    private GetZeroTrustAccessPoliciesResultExcludeUserRiskScore userRiskScore;
    ...
    public GetZeroTrustAccessPoliciesResultExcludeCloudflareAccountMember cloudflareAccountMember() {
    ...
    public GetZeroTrustAccessPoliciesResultExcludeLinkedAppToken linkedAppToken() {
        return this.linkedAppToken;
    }
    public GetZeroTrustAccessPoliciesResultExcludeLoginMethod loginMethod() {
        return this.loginMethod;
    }
    public GetZeroTrustAccessPoliciesResultExcludeOidc oidc() {
        return this.oidc;
    }
    ...
    public GetZeroTrustAccessPoliciesResultExcludeUserRiskScore userRiskScore() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder cloudflareAccountMember(GetZeroTrustAccessPoliciesResultExcludeCloudflareAccountMember cloudflareAccountMember) {
            if (cloudflareAccountMember == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessPoliciesResultExclude", "cloudflareAccountMember");
            }
        ...
        @CustomType.Setter
        public Builder linkedAppToken(GetZeroTrustAccessPoliciesResultExcludeLinkedAppToken linkedAppToken) {
            if (linkedAppToken == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessPoliciesResultExclude", "linkedAppToken");
            }
        ...
        @CustomType.Setter
        public Builder oidc(GetZeroTrustAccessPoliciesResultExcludeOidc oidc) {
            if (oidc == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessPoliciesResultExclude", "oidc");
            }
            this.oidc = oidc;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder userRiskScore(GetZeroTrustAccessPoliciesResultExcludeUserRiskScore userRiskScore) {
            if (userRiskScore == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessPoliciesResultExclude", "userRiskScore");
            }
