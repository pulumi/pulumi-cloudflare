...
public final class PolicyRuleSettingsDnsResolversIpv4Args extends com.pulumi.resources.ResourceArgs {

    public static final PolicyRuleSettingsDnsResolversIpv4Args Empty = new PolicyRuleSettingsDnsResolversIpv4Args();
    ...
    private PolicyRuleSettingsDnsResolversIpv4Args() {}

    private PolicyRuleSettingsDnsResolversIpv4Args(PolicyRuleSettingsDnsResolversIpv4Args $) {
        this.ip = $.ip;
        this.port = $.port;
    ...
    public static Builder builder(PolicyRuleSettingsDnsResolversIpv4Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyRuleSettingsDnsResolversIpv4Args();
        }

        public Builder(PolicyRuleSettingsDnsResolversIpv4Args defaults) {
            $ = new PolicyRuleSettingsDnsResolversIpv4Args(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyRuleSettingsDnsResolversIpv4Args build() {
            if ($.ip == null) {
                throw new MissingRequiredPropertyException("PolicyRuleSettingsDnsResolversIpv4Args", "ip");
            }
            return $;
        }
    }
