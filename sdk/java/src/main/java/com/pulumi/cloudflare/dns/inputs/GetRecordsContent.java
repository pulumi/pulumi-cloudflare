...
public final class GetRecordsContent extends com.pulumi.resources.InvokeArgs {

    public static final GetRecordsContent Empty = new GetRecordsContent();
    ...
    private GetRecordsContent() {}

    private GetRecordsContent(GetRecordsContent $) {
    ...
    public static Builder builder(GetRecordsContent defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRecordsContent();
        }

        public Builder(GetRecordsContent defaults) {
            $ = new GetRecordsContent(Objects.requireNonNull(defaults));
        }
        ...
        public GetRecordsContent build() {
            return $;
        }
    }
