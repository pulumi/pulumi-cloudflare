...
@CustomType
public final class AccessApplicationPolicyConnectionRulesSsh {
    /**
    ...
    public static Builder builder(AccessApplicationPolicyConnectionRulesSsh defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> usernames;
        public Builder() {}
        public Builder(AccessApplicationPolicyConnectionRulesSsh defaults) {
        ...
        public Builder usernames(List<String> usernames) {
            if (usernames == null) {
              throw new MissingRequiredPropertyException("AccessApplicationPolicyConnectionRulesSsh", "usernames");
            }
        ...
        public AccessApplicationPolicyConnectionRulesSsh build() {
            final var _resultValue = new AccessApplicationPolicyConnectionRulesSsh();
