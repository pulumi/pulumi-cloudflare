...
import com.pulumi.cloudflare.inputs.MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs;
...
public final class MagicWanGreTunnelModifiedGreTunnelHealthCheckArgs extends com.pulumi.resources.ResourceArgs {

    public static final MagicWanGreTunnelModifiedGreTunnelHealthCheckArgs Empty = new MagicWanGreTunnelModifiedGreTunnelHealthCheckArgs();
     ...
     */
    @Import(name="target")
    private @Nullable Output<MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs> target;

    /**
     * @return The destination address in a request type health check. After the healthcheck is decapsulated at the customer end of the tunnel, the ICMP echo will be forwarded to this address. This field defaults to `customer_gre_endpoint address`. This field is ignored for bidirectional healthchecks as the interface*address (not assigned to the Cloudflare side of the tunnel) is used as the target. Must be in object form if the x-magic-new-hc-target header is set to true and string form if x-magic-new-hc-target is absent or set to false.
     * 
     */
    public Optional<Output<MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs>> target() {
    ...
    private MagicWanGreTunnelModifiedGreTunnelHealthCheckArgs() {}

    private MagicWanGreTunnelModifiedGreTunnelHealthCheckArgs(MagicWanGreTunnelModifiedGreTunnelHealthCheckArgs $) {
    ...
    public static Builder builder(MagicWanGreTunnelModifiedGreTunnelHealthCheckArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagicWanGreTunnelModifiedGreTunnelHealthCheckArgs();
        }

        public Builder(MagicWanGreTunnelModifiedGreTunnelHealthCheckArgs defaults) {
            $ = new MagicWanGreTunnelModifiedGreTunnelHealthCheckArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder target(@Nullable Output<MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs> target) {
            $.target = target;
            return this;
        }
         ...
         * 
         */
        public Builder target(MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs target) {
        ...
        public MagicWanGreTunnelModifiedGreTunnelHealthCheckArgs build() {
            return $;
        }
    }
