...
import com.pulumi.cloudflare.inputs.ObservatoryScheduledTestTestMobileReportErrorArgs;
...
public final class ObservatoryScheduledTestTestMobileReportArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservatoryScheduledTestTestMobileReportArgs Empty = new ObservatoryScheduledTestTestMobileReportArgs();
    ...
    @Import(name="error")
    private @Nullable Output<ObservatoryScheduledTestTestMobileReportErrorArgs> error;

    public Optional<Output<ObservatoryScheduledTestTestMobileReportErrorArgs>> error() {
    ...
    private ObservatoryScheduledTestTestMobileReportArgs() {}

    private ObservatoryScheduledTestTestMobileReportArgs(ObservatoryScheduledTestTestMobileReportArgs $) {
        this.cls = $.cls;
    ...
    public static Builder builder(ObservatoryScheduledTestTestMobileReportArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservatoryScheduledTestTestMobileReportArgs();
        }

        public Builder(ObservatoryScheduledTestTestMobileReportArgs defaults) {
            $ = new ObservatoryScheduledTestTestMobileReportArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder error(@Nullable Output<ObservatoryScheduledTestTestMobileReportErrorArgs> error) {
            $.error = error;
            return this;
        }

        public Builder error(ObservatoryScheduledTestTestMobileReportErrorArgs error) {
        ...
        public ObservatoryScheduledTestTestMobileReportArgs build() {
            return $;
        }
    }
