...
@CustomType
public final class GetZeroTrustGatewayPolicySchedule {
    /**
    ...
    private GetZeroTrustGatewayPolicySchedule() {}
    /**
     * @return Specify the time intervals when the rule is active on Fridays, in the increasing order from 00:00-24:00.  If this parameter omitted, the rule is deactivated on Fridays. API returns a formatted version of this string, which may cause Terraform drift if a unformatted value is used.
     * 
     */
    ...
    public static Builder builder(GetZeroTrustGatewayPolicySchedule defaults) {
    ...
    public static final class Builder {
        ...
        private String wed;
        public Builder() {}
        public Builder(GetZeroTrustGatewayPolicySchedule defaults) {
        ...
        public Builder fri(String fri) {
            if (fri == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustGatewayPolicySchedule", "fri");
            }
            this.fri = fri;
            return this;
        }
        ...
        public Builder mon(String mon) {
            if (mon == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustGatewayPolicySchedule", "mon");
            }
            this.mon = mon;
            return this;
        }
        ...
        public Builder sat(String sat) {
            if (sat == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustGatewayPolicySchedule", "sat");
            }
            this.sat = sat;
            return this;
        }
        ...
        public Builder sun(String sun) {
            if (sun == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustGatewayPolicySchedule", "sun");
            }
            this.sun = sun;
            return this;
        }
        ...
        public Builder thu(String thu) {
            if (thu == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustGatewayPolicySchedule", "thu");
            }
            this.thu = thu;
            return this;
        }
        ...
        public Builder timeZone(String timeZone) {
            if (timeZone == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustGatewayPolicySchedule", "timeZone");
            }
        ...
        public Builder tue(String tue) {
            if (tue == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustGatewayPolicySchedule", "tue");
            }
            this.tue = tue;
            return this;
        }
        ...
        public Builder wed(String wed) {
            if (wed == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustGatewayPolicySchedule", "wed");
            }
            this.wed = wed;
            return this;
        }
        public GetZeroTrustGatewayPolicySchedule build() {
            final var _resultValue = new GetZeroTrustGatewayPolicySchedule();
