...
public final class WorkersCustomDomainArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WorkersCustomDomainArgs(WorkersCustomDomainArgs $) {
    ...
    public static Builder builder(WorkersCustomDomainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkersCustomDomainArgs();
        }

        public Builder(WorkersCustomDomainArgs defaults) {
            $ = new WorkersCustomDomainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WorkersCustomDomainArgs build() {
            ...
            if ($.environment == null) {
                throw new MissingRequiredPropertyException("WorkersCustomDomainArgs", "environment");
            }
            if ($.hostname == null) {
