...
public final class GetZeroTrustDexTestFilter extends com.pulumi.resources.InvokeArgs {
    ...
    private GetZeroTrustDexTestFilter(GetZeroTrustDexTestFilter $) {
        this.kind = $.kind;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetZeroTrustDexTestFilter();
        }

        public Builder(GetZeroTrustDexTestFilter defaults) {
            $ = new GetZeroTrustDexTestFilter(Objects.requireNonNull(defaults));
        }
