...
import com.pulumi.cloudflare.aiGateway.inputs.AiGatewayState;
import com.pulumi.cloudflare.aiGateway.outputs.AiGatewayDlp;
import com.pulumi.cloudflare.aiGateway.outputs.AiGatewayGuardrails;
import com.pulumi.cloudflare.aiGateway.outputs.AiGatewayOtel;
import com.pulumi.cloudflare.aiGateway.outputs.AiGatewaySpendLimits;
import com.pulumi.cloudflare.aiGateway.outputs.AiGatewayStripe;
 ...
 * 
 */
@ResourceType(type="cloudflare:aiGateway/aiGateway:AiGateway")
public class AiGateway extends com.pulumi.resources.CustomResource {
    ...
    public AiGateway(java.lang.String name, AiGatewayArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:aiGateway/aiGateway:AiGateway", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AiGateway(java.lang.String name, Output<java.lang.String> id, @Nullable AiGatewayState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:aiGateway/aiGateway:AiGateway", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/aiGateway:AiGateway").build())
            ))
            .build();
