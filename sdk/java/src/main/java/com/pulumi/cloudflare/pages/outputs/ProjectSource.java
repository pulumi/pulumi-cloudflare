...
import com.pulumi.cloudflare.pages.outputs.ProjectSourceConfig;
...
public final class ProjectSource {
    private ProjectSourceConfig config;
    /**
    ...
    public ProjectSourceConfig config() {
        return this.config;
    }
    /**
     * @return The source control management provider.
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder config(ProjectSourceConfig config) {
            if (config == null) {
              throw new MissingRequiredPropertyException("ProjectSource", "config");
            }
            this.config = config;
            return this;
        }
