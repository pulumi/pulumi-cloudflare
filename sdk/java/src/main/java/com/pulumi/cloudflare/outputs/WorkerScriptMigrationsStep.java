...
import com.pulumi.cloudflare.outputs.WorkerScriptMigrationsStepRenamedClass;
import com.pulumi.cloudflare.outputs.WorkerScriptMigrationsStepTransferredClass;
...
@CustomType
public final class WorkerScriptMigrationsStep {
    /**
     ...
     * 
     */
    private @Nullable List<WorkerScriptMigrationsStepRenamedClass> renamedClasses;
    /**
     ...
     * 
     */
    private @Nullable List<WorkerScriptMigrationsStepTransferredClass> transferredClasses;

    private WorkerScriptMigrationsStep() {}
    /**
     * @return A list of classes to delete Durable Object namespaces from.
     * 
     */
     ...
     * 
     */
    public List<WorkerScriptMigrationsStepRenamedClass> renamedClasses() {
     ...
     * 
     */
    public List<WorkerScriptMigrationsStepTransferredClass> transferredClasses() {
    ...
    public static Builder builder(WorkerScriptMigrationsStep defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<WorkerScriptMigrationsStepTransferredClass> transferredClasses;
        public Builder() {}
        public Builder(WorkerScriptMigrationsStep defaults) {
        ...
        @CustomType.Setter
        public Builder renamedClasses(@Nullable List<WorkerScriptMigrationsStepRenamedClass> renamedClasses) {

            this.renamedClasses = renamedClasses;
            return this;
        }
        public Builder renamedClasses(WorkerScriptMigrationsStepRenamedClass... renamedClasses) {
            return renamedClasses(List.of(renamedClasses));
        }
        @CustomType.Setter
        public Builder transferredClasses(@Nullable List<WorkerScriptMigrationsStepTransferredClass> transferredClasses) {

            this.transferredClasses = transferredClasses;
            return this;
        }
        public Builder transferredClasses(WorkerScriptMigrationsStepTransferredClass... transferredClasses) {
            return transferredClasses(List.of(transferredClasses));
        }
        public WorkerScriptMigrationsStep build() {
            final var _resultValue = new WorkerScriptMigrationsStep();
