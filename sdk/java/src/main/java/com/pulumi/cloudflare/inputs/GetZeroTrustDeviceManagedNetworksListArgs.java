...
public final class GetZeroTrustDeviceManagedNetworksListArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetZeroTrustDeviceManagedNetworksListArgs() {}

    private GetZeroTrustDeviceManagedNetworksListArgs(GetZeroTrustDeviceManagedNetworksListArgs $) {
    ...
    public static Builder builder(GetZeroTrustDeviceManagedNetworksListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetZeroTrustDeviceManagedNetworksListArgs();
        }

        public Builder(GetZeroTrustDeviceManagedNetworksListArgs defaults) {
