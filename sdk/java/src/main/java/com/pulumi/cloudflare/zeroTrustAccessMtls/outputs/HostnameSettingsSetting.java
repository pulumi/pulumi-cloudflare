...
@CustomType
public final class HostnameSettingsSetting {
    /**
    ...
    private HostnameSettingsSetting() {}
    /**
     * @return Request client certificates for this hostname in China. Can only be set to true if this zone is china network enabled.
     * 
     */
    ...
    public static Builder builder(HostnameSettingsSetting defaults) {
    ...
    public static final class Builder {
        ...
        private String hostname;
        public Builder() {}
        public Builder(HostnameSettingsSetting defaults) {
        ...
        public Builder chinaNetwork(Boolean chinaNetwork) {
            if (chinaNetwork == null) {
              throw new MissingRequiredPropertyException("HostnameSettingsSetting", "chinaNetwork");
            }
        ...
        public Builder clientCertificateForwarding(Boolean clientCertificateForwarding) {
            if (clientCertificateForwarding == null) {
              throw new MissingRequiredPropertyException("HostnameSettingsSetting", "clientCertificateForwarding");
            }
        ...
        public Builder hostname(String hostname) {
            if (hostname == null) {
              throw new MissingRequiredPropertyException("HostnameSettingsSetting", "hostname");
            }
            this.hostname = hostname;
            return this;
        }
        public HostnameSettingsSetting build() {
            final var _resultValue = new HostnameSettingsSetting();
