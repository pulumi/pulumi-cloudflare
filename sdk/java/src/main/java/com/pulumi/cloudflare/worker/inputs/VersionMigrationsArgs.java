...
import com.pulumi.cloudflare.worker.inputs.VersionMigrationsStepArgs;
...
public final class VersionMigrationsArgs extends com.pulumi.resources.ResourceArgs {

    public static final VersionMigrationsArgs Empty = new VersionMigrationsArgs();
    ...
    private @Nullable Output<List<VersionMigrationsRenamedClassArgs>> renamedClasses;

    /**
     * @return A list of classes with Durable Object namespaces that were renamed.
     * 
     */
    public Optional<Output<List<VersionMigrationsRenamedClassArgs>>> renamedClasses() {
     ...
     */
    @Import(name="steps")
    private @Nullable Output<List<VersionMigrationsStepArgs>> steps;

    /**
     * @return Migrations to apply in order.
     * 
     */
    public Optional<Output<List<VersionMigrationsStepArgs>>> steps() {
    ...
    private @Nullable Output<List<VersionMigrationsTransferredClassArgs>> transferredClasses;
     ...
     * 
     */
    public Optional<Output<List<VersionMigrationsTransferredClassArgs>>> transferredClasses() {
        return Optional.ofNullable(this.transferredClasses);
    }

    private VersionMigrationsArgs() {}

    private VersionMigrationsArgs(VersionMigrationsArgs $) {
    ...
    public static Builder builder(VersionMigrationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VersionMigrationsArgs();
        }

        public Builder(VersionMigrationsArgs defaults) {
            $ = new VersionMigrationsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder renamedClasses(@Nullable Output<List<VersionMigrationsRenamedClassArgs>> renamedClasses) {
         ...
         * 
         */
        public Builder renamedClasses(List<VersionMigrationsRenamedClassArgs> renamedClasses) {
         ...
         * 
         */
        public Builder renamedClasses(VersionMigrationsRenamedClassArgs... renamedClasses) {
         ...
         * 
         */
        public Builder steps(@Nullable Output<List<VersionMigrationsStepArgs>> steps) {
            $.steps = steps;
            return this;
        }
         ...
         * 
         */
        public Builder steps(List<VersionMigrationsStepArgs> steps) {
         ...
         * 
         */
        public Builder steps(VersionMigrationsStepArgs... steps) {
         ...
         * 
         */
        public Builder transferredClasses(@Nullable Output<List<VersionMigrationsTransferredClassArgs>> transferredClasses) {
         ...
         * 
         */
        public Builder transferredClasses(List<VersionMigrationsTransferredClassArgs> transferredClasses) {
         ...
         * 
         */
        public Builder transferredClasses(VersionMigrationsTransferredClassArgs... transferredClasses) {
            return transferredClasses(List.of(transferredClasses));
        }

        public VersionMigrationsArgs build() {
            return $;
        }
    }
