...
public final class AccessPolicyIncludeAuthContextArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AccessPolicyIncludeAuthContextArgs build() {
            if ($.acId == null) {
                throw new MissingRequiredPropertyException("AccessPolicyIncludeAuthContextArgs", "acId");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("AccessPolicyIncludeAuthContextArgs", "id");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("AccessPolicyIncludeAuthContextArgs", "identityProviderId");
            }
            return $;
        }
    }
