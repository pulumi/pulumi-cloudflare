...
public final class GetItemsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetItemsPlainArgs Empty = new GetItemsPlainArgs();
    ...
    private GetItemsPlainArgs() {}

    private GetItemsPlainArgs(GetItemsPlainArgs $) {
    ...
    public static Builder builder(GetItemsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetItemsPlainArgs();
        }

        public Builder(GetItemsPlainArgs defaults) {
            $ = new GetItemsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetItemsPlainArgs build() {
            if ($.listId == null) {
                throw new MissingRequiredPropertyException("GetItemsPlainArgs", "listId");
            }
            return $;
        }
    }
