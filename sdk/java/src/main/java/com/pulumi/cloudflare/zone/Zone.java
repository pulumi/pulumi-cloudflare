...
import com.pulumi.cloudflare.zone.inputs.ZoneState;
import com.pulumi.cloudflare.zone.outputs.ZoneAccount;
import com.pulumi.cloudflare.zone.outputs.ZoneMeta;
import com.pulumi.cloudflare.zone.outputs.ZoneOwner;
import com.pulumi.cloudflare.zone.outputs.ZonePlan;
import com.pulumi.cloudflare.zone.outputs.ZoneTenant;
import com.pulumi.cloudflare.zone.outputs.ZoneTenantUnit;
 ...
 * 
 */
@ResourceType(type="cloudflare:zone/zone:Zone")
...
see [Zone Plans](https://developers.cloudflare.com/api/resources/zones/subresources/plans/). */
    ...
    public Zone(java.lang.String name, ZoneArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zone/zone:Zone", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Zone(java.lang.String name, Output<java.lang.String> id, @Nullable ZoneState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zone/zone:Zone", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/zone:Zone").build())
            ))
            .build();
