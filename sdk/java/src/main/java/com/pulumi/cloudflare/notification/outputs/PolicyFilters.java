...
@CustomType
public final class PolicyFilters {
    /**
    ...
    public static Builder builder(PolicyFilters defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> zones;
        public Builder() {}
        public Builder(PolicyFilters defaults) {
        ...
        public PolicyFilters build() {
            final var _resultValue = new PolicyFilters();
