...
public final class AccessPolicyExcludeExternalEvaluation {
    ...
    public static final class Builder {
        ...
        public Builder evaluateUrl(String evaluateUrl) {
            if (evaluateUrl == null) {
              throw new MissingRequiredPropertyException("AccessPolicyExcludeExternalEvaluation", "evaluateUrl");
            }
        ...
        public Builder keysUrl(String keysUrl) {
            if (keysUrl == null) {
              throw new MissingRequiredPropertyException("AccessPolicyExcludeExternalEvaluation", "keysUrl");
            }
