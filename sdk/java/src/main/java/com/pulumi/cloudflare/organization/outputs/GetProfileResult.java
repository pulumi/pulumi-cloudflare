    ...
    public static final class Builder {
        ...
        public Builder businessAddress(String businessAddress) {
            if (businessAddress == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "businessAddress");
            }
        ...
        public Builder businessEmail(String businessEmail) {
            if (businessEmail == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "businessEmail");
            }
        ...
        public Builder businessName(String businessName) {
            if (businessName == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "businessName");
            }
        ...
        public Builder businessPhone(String businessPhone) {
            if (businessPhone == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "businessPhone");
            }
        ...
        public Builder externalMetadata(String externalMetadata) {
            if (externalMetadata == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "externalMetadata");
            }
        ...
        public Builder organizationId(String organizationId) {
            if (organizationId == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "organizationId");
            }
