...
@CustomType
public final class IpsecTunnelBgp {
    /**
    ...
    public static Builder builder(IpsecTunnelBgp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String md5Key;
        public Builder() {}
        public Builder(IpsecTunnelBgp defaults) {
        ...
        public Builder customerAsn(Integer customerAsn) {
            if (customerAsn == null) {
              throw new MissingRequiredPropertyException("IpsecTunnelBgp", "customerAsn");
            }
        ...
        public IpsecTunnelBgp build() {
            final var _resultValue = new IpsecTunnelBgp();
