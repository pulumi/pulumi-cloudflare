...
public final class GroupExcludeExternalEvaluationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupExcludeExternalEvaluationArgs Empty = new GroupExcludeExternalEvaluationArgs();
    ...
    private GroupExcludeExternalEvaluationArgs() {}

    private GroupExcludeExternalEvaluationArgs(GroupExcludeExternalEvaluationArgs $) {
    ...
    public static Builder builder(GroupExcludeExternalEvaluationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupExcludeExternalEvaluationArgs();
        }

        public Builder(GroupExcludeExternalEvaluationArgs defaults) {
            $ = new GroupExcludeExternalEvaluationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupExcludeExternalEvaluationArgs build() {
            if ($.evaluateUrl == null) {
                throw new MissingRequiredPropertyException("GroupExcludeExternalEvaluationArgs", "evaluateUrl");
            }
            if ($.keysUrl == null) {
                throw new MissingRequiredPropertyException("GroupExcludeExternalEvaluationArgs", "keysUrl");
            }
            return $;
        }
    }
