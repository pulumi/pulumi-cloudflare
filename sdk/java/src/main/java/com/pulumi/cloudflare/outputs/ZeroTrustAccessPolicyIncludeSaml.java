    ...
    public static final class Builder {
        ...
        public Builder attributeName(String attributeName) {
            if (attributeName == null) {
              throw new MissingRequiredPropertyException("ZeroTrustAccessPolicyIncludeSaml", "attributeName");
            }
        ...
        public Builder attributeValue(String attributeValue) {
            if (attributeValue == null) {
              throw new MissingRequiredPropertyException("ZeroTrustAccessPolicyIncludeSaml", "attributeValue");
            }
        ...
        public Builder identityProviderId(String identityProviderId) {
            if (identityProviderId == null) {
              throw new MissingRequiredPropertyException("ZeroTrustAccessPolicyIncludeSaml", "identityProviderId");
            }
