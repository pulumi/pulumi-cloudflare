...
import com.pulumi.cloudflare.zeroTrustDevice.outputs.GetCustomProfilesResultDnsSearchSuffix;
import com.pulumi.cloudflare.zeroTrustDevice.outputs.GetCustomProfilesResultExclude;
import com.pulumi.cloudflare.zeroTrustDevice.outputs.GetCustomProfilesResultFallbackDomain;
import com.pulumi.cloudflare.zeroTrustDevice.outputs.GetCustomProfilesResultInclude;
import com.pulumi.cloudflare.zeroTrustDevice.outputs.GetCustomProfilesResultServiceModeV2;
import com.pulumi.cloudflare.zeroTrustDevice.outputs.GetCustomProfilesResultTargetTest;
import com.pulumi.cloudflare.zeroTrustDevice.outputs.GetCustomProfilesResultVirtualNetworks;
...
@CustomType
public final class GetCustomProfilesResult {
    /**
     ...
     * 
     */
    private List<GetCustomProfilesResultDnsSearchSuffix> dnsSearchSuffixes;
    /**
     ...
     * 
     */
    private List<GetCustomProfilesResultExclude> excludes;
    private List<GetCustomProfilesResultFallbackDomain> fallbackDomains;
     ...
     * 
     */
    private List<GetCustomProfilesResultInclude> includes;
    /**
    ...
    private GetCustomProfilesResultServiceModeV2 serviceModeV2;
    /**
    ...
    private List<GetCustomProfilesResultTargetTest> targetTests;
    /**
     ...
     * 
     */
    private GetCustomProfilesResultVirtualNetworks virtualNetworks;

    private GetCustomProfilesResult() {}
    /**
     * @return Whether to allow the user to switch WARP between modes.
     * 
     */
     ...
     * 
     */
    public List<GetCustomProfilesResultDnsSearchSuffix> dnsSearchSuffixes() {
     ...
     * 
     */
    public List<GetCustomProfilesResultExclude> excludes() {
        return this.excludes;
    }
    public List<GetCustomProfilesResultFallbackDomain> fallbackDomains() {
     ...
     * 
     */
    public List<GetCustomProfilesResultInclude> includes() {
    ...
    public GetCustomProfilesResultServiceModeV2 serviceModeV2() {
    ...
    public List<GetCustomProfilesResultTargetTest> targetTests() {
     ...
     * 
     */
    public GetCustomProfilesResultVirtualNetworks virtualNetworks() {
    ...
    public static Builder builder(GetCustomProfilesResult defaults) {
    ...
    public static final class Builder {
        ...
        private GetCustomProfilesResultVirtualNetworks virtualNetworks;
        public Builder() {}
        public Builder(GetCustomProfilesResult defaults) {
        ...
        public Builder allowModeSwitch(Boolean allowModeSwitch) {
            if (allowModeSwitch == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "allowModeSwitch");
            }
        ...
        public Builder allowUpdates(Boolean allowUpdates) {
            if (allowUpdates == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "allowUpdates");
            }
        ...
        public Builder allowedToLeave(Boolean allowedToLeave) {
            if (allowedToLeave == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "allowedToLeave");
            }
        ...
        public Builder autoConnect(Double autoConnect) {
            if (autoConnect == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "autoConnect");
            }
        ...
        public Builder captivePortal(Double captivePortal) {
            if (captivePortal == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "captivePortal");
            }
        ...
        public Builder default_(Boolean default_) {
            if (default_ == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "default_");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "description");
            }
        ...
        public Builder disableAutoFallback(Boolean disableAutoFallback) {
            if (disableAutoFallback == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "disableAutoFallback");
            }
            this.disableAutoFallback = disableAutoFallback;
            return this;
        }
        @CustomType.Setter
        public Builder dnsSearchSuffixes(List<GetCustomProfilesResultDnsSearchSuffix> dnsSearchSuffixes) {
            if (dnsSearchSuffixes == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "dnsSearchSuffixes");
            }
            this.dnsSearchSuffixes = dnsSearchSuffixes;
            return this;
        }
        public Builder dnsSearchSuffixes(GetCustomProfilesResultDnsSearchSuffix... dnsSearchSuffixes) {
            return dnsSearchSuffixes(List.of(dnsSearchSuffixes));
        }
        @CustomType.Setter
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "enabled");
            }
        ...
        public Builder excludeOfficeIps(Boolean excludeOfficeIps) {
            if (excludeOfficeIps == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "excludeOfficeIps");
            }
            this.excludeOfficeIps = excludeOfficeIps;
            return this;
        }
        @CustomType.Setter
        public Builder excludes(List<GetCustomProfilesResultExclude> excludes) {
            if (excludes == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "excludes");
            }
            this.excludes = excludes;
            return this;
        }
        public Builder excludes(GetCustomProfilesResultExclude... excludes) {
            return excludes(List.of(excludes));
        }
        @CustomType.Setter
        public Builder fallbackDomains(List<GetCustomProfilesResultFallbackDomain> fallbackDomains) {
            if (fallbackDomains == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "fallbackDomains");
            }
            this.fallbackDomains = fallbackDomains;
            return this;
        }
        public Builder fallbackDomains(GetCustomProfilesResultFallbackDomain... fallbackDomains) {
            return fallbackDomains(List.of(fallbackDomains));
        }
        @CustomType.Setter
        public Builder gatewayUniqueId(String gatewayUniqueId) {
            if (gatewayUniqueId == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "gatewayUniqueId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "id");
            }
            this.id = id;
            return this;
        }
        @CustomType.Setter
        public Builder includes(List<GetCustomProfilesResultInclude> includes) {
            if (includes == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "includes");
            }
            this.includes = includes;
            return this;
        }
        public Builder includes(GetCustomProfilesResultInclude... includes) {
            return includes(List.of(includes));
        }
        @CustomType.Setter
        public Builder lanAllowMinutes(Double lanAllowMinutes) {
            if (lanAllowMinutes == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "lanAllowMinutes");
            }
        ...
        public Builder lanAllowSubnetSize(Double lanAllowSubnetSize) {
            if (lanAllowSubnetSize == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "lanAllowSubnetSize");
            }
        ...
        public Builder match(String match) {
            if (match == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "match");
            }
            this.match = match;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder policyId(String policyId) {
            if (policyId == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "policyId");
            }
        ...
        public Builder precedence(Double precedence) {
            if (precedence == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "precedence");
            }
        ...
        public Builder registerInterfaceIpWithDns(Boolean registerInterfaceIpWithDns) {
            if (registerInterfaceIpWithDns == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "registerInterfaceIpWithDns");
            }
        ...
        public Builder sccmVpnBoundarySupport(Boolean sccmVpnBoundarySupport) {
            if (sccmVpnBoundarySupport == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "sccmVpnBoundarySupport");
            }
            this.sccmVpnBoundarySupport = sccmVpnBoundarySupport;
            return this;
        }
        @CustomType.Setter
        public Builder serviceModeV2(GetCustomProfilesResultServiceModeV2 serviceModeV2) {
            if (serviceModeV2 == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "serviceModeV2");
            }
        ...
        public Builder supportUrl(String supportUrl) {
            if (supportUrl == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "supportUrl");
            }
        ...
        public Builder switchLocked(Boolean switchLocked) {
            if (switchLocked == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "switchLocked");
            }
            this.switchLocked = switchLocked;
            return this;
        }
        @CustomType.Setter
        public Builder targetTests(List<GetCustomProfilesResultTargetTest> targetTests) {
            if (targetTests == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "targetTests");
            }
            this.targetTests = targetTests;
            return this;
        }
        public Builder targetTests(GetCustomProfilesResultTargetTest... targetTests) {
            return targetTests(List.of(targetTests));
        }
        @CustomType.Setter
        public Builder tunnelProtocol(String tunnelProtocol) {
            if (tunnelProtocol == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "tunnelProtocol");
            }
            this.tunnelProtocol = tunnelProtocol;
            return this;
        }
        @CustomType.Setter
        public Builder virtualNetworks(GetCustomProfilesResultVirtualNetworks virtualNetworks) {
            if (virtualNetworks == null) {
              throw new MissingRequiredPropertyException("GetCustomProfilesResult", "virtualNetworks");
            }
            this.virtualNetworks = virtualNetworks;
            return this;
        }
        public GetCustomProfilesResult build() {
            final var _resultValue = new GetCustomProfilesResult();
