...
public final class PolicyRuleSettingsDnsResolversIpv6Args extends com.pulumi.resources.ResourceArgs {

    public static final PolicyRuleSettingsDnsResolversIpv6Args Empty = new PolicyRuleSettingsDnsResolversIpv6Args();
    ...
    private PolicyRuleSettingsDnsResolversIpv6Args() {}

    private PolicyRuleSettingsDnsResolversIpv6Args(PolicyRuleSettingsDnsResolversIpv6Args $) {
        this.ip = $.ip;
        this.port = $.port;
    ...
    public static Builder builder(PolicyRuleSettingsDnsResolversIpv6Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyRuleSettingsDnsResolversIpv6Args();
        }

        public Builder(PolicyRuleSettingsDnsResolversIpv6Args defaults) {
            $ = new PolicyRuleSettingsDnsResolversIpv6Args(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyRuleSettingsDnsResolversIpv6Args build() {
            if ($.ip == null) {
                throw new MissingRequiredPropertyException("PolicyRuleSettingsDnsResolversIpv6Args", "ip");
            }
            return $;
        }
    }
