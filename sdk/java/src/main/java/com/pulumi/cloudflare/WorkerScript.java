...
import com.pulumi.cloudflare.outputs.WorkerScriptAnnotations;
import com.pulumi.cloudflare.outputs.WorkerScriptAssets;
import com.pulumi.cloudflare.outputs.WorkerScriptBinding;
import com.pulumi.cloudflare.outputs.WorkerScriptCacheOptions;
import com.pulumi.cloudflare.outputs.WorkerScriptExports;
import com.pulumi.cloudflare.outputs.WorkerScriptFiles;
...
public class WorkerScript extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="annotations", refs={WorkerScriptAnnotations.class}, tree="[0]")
    private Output<WorkerScriptAnnotations> annotations;

    /**
     * @return Annotations for the version created by this upload.
     * 
     */
    public Output<WorkerScriptAnnotations> annotations() {
     ...
     * 
     */
    @Export(name="cacheOptions", refs={WorkerScriptCacheOptions.class}, tree="[0]")
    private Output</* @Nullable */ WorkerScriptCacheOptions> cacheOptions;
     ...
     * 
     */
    public Output<Optional<WorkerScriptCacheOptions>> cacheOptions() {
     ...
     * 
     */
    @Export(name="exports", refs={Map.class,String.class,WorkerScriptExports.class}, tree="[0,1,2]")
    private Output</* @Nullable */ Map<String,WorkerScriptExports>> exports;
     ...
     * 
     */
    public Output<Optional<Map<String,WorkerScriptExports>>> exports() {
     ...
     * 
     */
    @Export(name="files", refs={Map.class,String.class,WorkerScriptFiles.class}, tree="[0,1,2]")
    private Output</* @Nullable */ Map<String,WorkerScriptFiles>> files;
     ...
     * 
     */
    public Output<Optional<Map<String,WorkerScriptFiles>>> files() {
     ...
     * 
     */
    @Export(name="packageDependencies", refs={List.class,WorkerScriptPackageDependency.class}, tree="[0,1]")
    private Output</* @Nullable */ List<WorkerScriptPackageDependency>> packageDependencies;

    /**
     * @return The list of npm packages that were installed and used when this Worker was built.
     * 
     */
    public Output<Optional<List<WorkerScriptPackageDependency>>> packageDependencies() {
