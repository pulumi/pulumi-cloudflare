...
@CustomType
public final class GetValidationSettingsResult {
    /**
     * @return Identifier.
     * 
     */
    ...
    public static Builder builder(GetValidationSettingsResult defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String zoneId;
        public Builder() {}
        public Builder(GetValidationSettingsResult defaults) {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetValidationSettingsResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder validationDefaultMitigationAction(String validationDefaultMitigationAction) {
            if (validationDefaultMitigationAction == null) {
              throw new MissingRequiredPropertyException("GetValidationSettingsResult", "validationDefaultMitigationAction");
            }
        ...
        public Builder validationOverrideMitigationAction(String validationOverrideMitigationAction) {
            if (validationOverrideMitigationAction == null) {
              throw new MissingRequiredPropertyException("GetValidationSettingsResult", "validationOverrideMitigationAction");
            }
        ...
        public GetValidationSettingsResult build() {
            final var _resultValue = new GetValidationSettingsResult();
            _resultValue.id = id;
