...
import com.pulumi.cloudflare.stream.inputs.WatermarkState;
 ...
 * 
 */
@ResourceType(type="cloudflare:stream/watermark:Watermark")
public class Watermark extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public Watermark(java.lang.String name, WatermarkArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Watermark(java.lang.String name, WatermarkArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:stream/watermark:Watermark", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Watermark(java.lang.String name, Output<java.lang.String> id, @Nullable WatermarkState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:stream/watermark:Watermark", name, state, makeResourceOptions(options, id), false);
    }

    private static WatermarkArgs makeArgs(WatermarkArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WatermarkArgs.Empty : args;
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/streamWatermark:StreamWatermark").build())
            ))
            .build();
     ...
     */
    public static Watermark get(java.lang.String name, Output<java.lang.String> id, @Nullable WatermarkState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
