...
import com.pulumi.cloudflare.worker.outputs.VersionAssetsConfig;
...
@CustomType
public final class VersionAssets {
    /**
     ...
     * 
     */
    private @Nullable VersionAssetsConfig config;
    /**
     ...
     * 
     */
    public Optional<VersionAssetsConfig> config() {
    ...
    public static Builder builder(VersionAssets defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String jwt;
        public Builder() {}
        public Builder(VersionAssets defaults) {
        ...
        @CustomType.Setter
        public Builder config(@Nullable VersionAssetsConfig config) {
        ...
        public VersionAssets build() {
            final var _resultValue = new VersionAssets();
