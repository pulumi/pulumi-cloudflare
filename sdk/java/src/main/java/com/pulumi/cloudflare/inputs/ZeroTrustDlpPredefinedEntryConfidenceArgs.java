...
public final class ZeroTrustDlpPredefinedEntryConfidenceArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZeroTrustDlpPredefinedEntryConfidenceArgs Empty = new ZeroTrustDlpPredefinedEntryConfidenceArgs();
    ...
    private ZeroTrustDlpPredefinedEntryConfidenceArgs() {}

    private ZeroTrustDlpPredefinedEntryConfidenceArgs(ZeroTrustDlpPredefinedEntryConfidenceArgs $) {
    ...
    public static Builder builder(ZeroTrustDlpPredefinedEntryConfidenceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustDlpPredefinedEntryConfidenceArgs();
        }

        public Builder(ZeroTrustDlpPredefinedEntryConfidenceArgs defaults) {
            $ = new ZeroTrustDlpPredefinedEntryConfidenceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ZeroTrustDlpPredefinedEntryConfidenceArgs build() {
            return $;
        }
    }
