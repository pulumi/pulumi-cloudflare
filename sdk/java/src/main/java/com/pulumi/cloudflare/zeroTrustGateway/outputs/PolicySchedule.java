...
public final class PolicySchedule {
    ...
    public static Builder builder(PolicySchedule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String wed;
        public Builder() {}
        public Builder(PolicySchedule defaults) {
        ...
        public PolicySchedule build() {
            final var _resultValue = new PolicySchedule();
