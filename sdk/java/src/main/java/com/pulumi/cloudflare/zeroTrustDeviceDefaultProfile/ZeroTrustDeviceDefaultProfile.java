...
import com.pulumi.cloudflare.zeroTrustDeviceDefaultProfile.inputs.ZeroTrustDeviceDefaultProfileState;
import com.pulumi.cloudflare.zeroTrustDeviceDefaultProfile.outputs.ZeroTrustDeviceDefaultProfileDnsSearchSuffix;
import com.pulumi.cloudflare.zeroTrustDeviceDefaultProfile.outputs.ZeroTrustDeviceDefaultProfileExclude;
import com.pulumi.cloudflare.zeroTrustDeviceDefaultProfile.outputs.ZeroTrustDeviceDefaultProfileFallbackDomain;
import com.pulumi.cloudflare.zeroTrustDeviceDefaultProfile.outputs.ZeroTrustDeviceDefaultProfileGlobalAcceleration;
import com.pulumi.cloudflare.zeroTrustDeviceDefaultProfile.outputs.ZeroTrustDeviceDefaultProfileInclude;
import com.pulumi.cloudflare.zeroTrustDeviceDefaultProfile.outputs.ZeroTrustDeviceDefaultProfileServiceModeV2;
import com.pulumi.cloudflare.zeroTrustDeviceDefaultProfile.outputs.ZeroTrustDeviceDefaultProfileVirtualNetworks;
 ...
 * 
 */
@ResourceType(type="cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile")
public class ZeroTrustDeviceDefaultProfile extends com.pulumi.resources.CustomResource {
    ...
    public ZeroTrustDeviceDefaultProfile(java.lang.String name, ZeroTrustDeviceDefaultProfileArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ZeroTrustDeviceDefaultProfile(java.lang.String name, Output<java.lang.String> id, @Nullable ZeroTrustDeviceDefaultProfileState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile").build())
            ))
            .build();
