    ...
    public static final class Builder {
        ...
        public Builder previewTarget(String previewTarget) {
            if (previewTarget == null) {
              throw new MissingRequiredPropertyException("GetListResult", "previewTarget");
            }
        ...
        public Builder requiredTokens(List<String> requiredTokens) {
            if (requiredTokens == null) {
              throw new MissingRequiredPropertyException("GetListResult", "requiredTokens");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetListResult", "state");
            }
            this.state = state;
            return this;
        }
