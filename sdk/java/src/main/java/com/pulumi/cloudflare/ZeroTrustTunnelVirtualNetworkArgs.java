...
public final class ZeroTrustTunnelVirtualNetworkArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZeroTrustTunnelVirtualNetworkArgs Empty = new ZeroTrustTunnelVirtualNetworkArgs();
    ...
    private ZeroTrustTunnelVirtualNetworkArgs() {}

    private ZeroTrustTunnelVirtualNetworkArgs(ZeroTrustTunnelVirtualNetworkArgs $) {
    ...
    public static Builder builder(ZeroTrustTunnelVirtualNetworkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustTunnelVirtualNetworkArgs();
        }

        public Builder(ZeroTrustTunnelVirtualNetworkArgs defaults) {
            $ = new ZeroTrustTunnelVirtualNetworkArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ZeroTrustTunnelVirtualNetworkArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("ZeroTrustTunnelVirtualNetworkArgs", "accountId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ZeroTrustTunnelVirtualNetworkArgs", "name");
            }
            return $;
        }
    }
