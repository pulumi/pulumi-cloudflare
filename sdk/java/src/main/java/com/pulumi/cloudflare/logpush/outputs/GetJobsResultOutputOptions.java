...
package com.pulumi.cloudflare.logpush.outputs;
...
@CustomType
public final class GetJobsResultOutputOptions {
    /**
    ...
    private GetJobsResultOutputOptions() {}
    /**
     * @return String to be prepended before each batch.
     * 
     */
    ...
    public static Builder builder(GetJobsResultOutputOptions defaults) {
    ...
    public static final class Builder {
        ...
        private String timestampFormat;
        public Builder() {}
        public Builder(GetJobsResultOutputOptions defaults) {
        ...
        public Builder batchPrefix(String batchPrefix) {
            if (batchPrefix == null) {
              throw new MissingRequiredPropertyException("GetJobsResultOutputOptions", "batchPrefix");
            }
        ...
        public Builder batchSuffix(String batchSuffix) {
            if (batchSuffix == null) {
              throw new MissingRequiredPropertyException("GetJobsResultOutputOptions", "batchSuffix");
            }
        ...
        public Builder cve202144228(Boolean cve202144228) {
            if (cve202144228 == null) {
              throw new MissingRequiredPropertyException("GetJobsResultOutputOptions", "cve202144228");
            }
        ...
        public Builder fieldDelimiter(String fieldDelimiter) {
            if (fieldDelimiter == null) {
              throw new MissingRequiredPropertyException("GetJobsResultOutputOptions", "fieldDelimiter");
            }
        ...
        public Builder fieldNames(List<String> fieldNames) {
            if (fieldNames == null) {
              throw new MissingRequiredPropertyException("GetJobsResultOutputOptions", "fieldNames");
            }
        ...
        public Builder mergeSubrequests(Boolean mergeSubrequests) {
            if (mergeSubrequests == null) {
              throw new MissingRequiredPropertyException("GetJobsResultOutputOptions", "mergeSubrequests");
            }
        ...
        public Builder outputType(String outputType) {
            if (outputType == null) {
              throw new MissingRequiredPropertyException("GetJobsResultOutputOptions", "outputType");
            }
        ...
        public Builder recordDelimiter(String recordDelimiter) {
            if (recordDelimiter == null) {
              throw new MissingRequiredPropertyException("GetJobsResultOutputOptions", "recordDelimiter");
            }
        ...
        public Builder recordPrefix(String recordPrefix) {
            if (recordPrefix == null) {
              throw new MissingRequiredPropertyException("GetJobsResultOutputOptions", "recordPrefix");
            }
        ...
        public Builder recordSuffix(String recordSuffix) {
            if (recordSuffix == null) {
              throw new MissingRequiredPropertyException("GetJobsResultOutputOptions", "recordSuffix");
            }
        ...
        public Builder recordTemplate(String recordTemplate) {
            if (recordTemplate == null) {
              throw new MissingRequiredPropertyException("GetJobsResultOutputOptions", "recordTemplate");
            }
        ...
        public Builder sampleRate(Double sampleRate) {
            if (sampleRate == null) {
              throw new MissingRequiredPropertyException("GetJobsResultOutputOptions", "sampleRate");
            }
        ...
        public Builder timestampFormat(String timestampFormat) {
            if (timestampFormat == null) {
              throw new MissingRequiredPropertyException("GetJobsResultOutputOptions", "timestampFormat");
            }
            this.timestampFormat = timestampFormat;
            return this;
        }
        public GetJobsResultOutputOptions build() {
            final var _resultValue = new GetJobsResultOutputOptions();
