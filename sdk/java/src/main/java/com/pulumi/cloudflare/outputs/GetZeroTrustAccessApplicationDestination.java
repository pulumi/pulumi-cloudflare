...
@CustomType
public final class GetZeroTrustAccessApplicationDestination {
    /**
    ...
    public static Builder builder(GetZeroTrustAccessApplicationDestination defaults) {
    ...
    public static final class Builder {
        ...
        public Builder cidr(String cidr) {
            if (cidr == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessApplicationDestination", "cidr");
            }
            this.cidr = cidr;
            return this;
        }
        ...
        public Builder hostname(String hostname) {
            if (hostname == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessApplicationDestination", "hostname");
            }
        ...
        public Builder l4Protocol(String l4Protocol) {
            if (l4Protocol == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessApplicationDestination", "l4Protocol");
            }
        ...
        public Builder portRange(String portRange) {
            if (portRange == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessApplicationDestination", "portRange");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessApplicationDestination", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder uri(String uri) {
            if (uri == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessApplicationDestination", "uri");
            }
            this.uri = uri;
            return this;
        }
        ...
        public Builder vnetId(String vnetId) {
            if (vnetId == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessApplicationDestination", "vnetId");
            }
            this.vnetId = vnetId;
            return this;
        }
