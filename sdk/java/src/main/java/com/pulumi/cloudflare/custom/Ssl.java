...
import com.pulumi.cloudflare.custom.inputs.SslState;
import com.pulumi.cloudflare.custom.outputs.SslGeoRestrictions;
import com.pulumi.cloudflare.custom.outputs.SslKeylessServer;
 ...
 * 
 */
@ResourceType(type="cloudflare:custom/ssl:Ssl")
public class Ssl extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="geoRestrictions", refs={SslGeoRestrictions.class}, tree="[0]")
    private Output</* @Nullable */ SslGeoRestrictions> geoRestrictions;

    /**
     * @return Specify the region where your private key can be held locally for optimal TLS performance. HTTPS connections to any excluded data center will still be fully encrypted, but will incur some latency while Keyless SSL is used to complete the handshake with the nearest allowed data center. Options allow distribution to only to U.S. data centers, only to E.U. data centers, or only to highest security data centers. Default distribution is to all Cloudflare datacenters, for optimal performance.
     * 
     */
    public Output<Optional<SslGeoRestrictions>> geoRestrictions() {
    ...
    @Export(name="keylessServer", refs={SslKeylessServer.class}, tree="[0]")
    private Output<SslKeylessServer> keylessServer;

    public Output<SslKeylessServer> keylessServer() {
    ...
    public Ssl(java.lang.String name, SslArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:custom/ssl:Ssl", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Ssl(java.lang.String name, Output<java.lang.String> id, @Nullable SslState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:custom/ssl:Ssl", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/customSsl:CustomSsl").build())
            ))
