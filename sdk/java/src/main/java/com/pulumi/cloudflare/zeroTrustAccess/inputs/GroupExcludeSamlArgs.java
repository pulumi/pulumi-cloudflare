...
public final class GroupExcludeSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupExcludeSamlArgs Empty = new GroupExcludeSamlArgs();
    ...
    private GroupExcludeSamlArgs() {}

    private GroupExcludeSamlArgs(GroupExcludeSamlArgs $) {
    ...
    public static Builder builder(GroupExcludeSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupExcludeSamlArgs();
        }

        public Builder(GroupExcludeSamlArgs defaults) {
            $ = new GroupExcludeSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupExcludeSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("GroupExcludeSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("GroupExcludeSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("GroupExcludeSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
