...
public final class GetTunnelArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetTunnelArgs Empty = new GetTunnelArgs();
    ...
    private GetTunnelArgs() {}

    private GetTunnelArgs(GetTunnelArgs $) {
    ...
    public static Builder builder(GetTunnelArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetTunnelArgs defaults) {
            $ = new GetTunnelArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetTunnelArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetTunnelArgs", "accountId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetTunnelArgs", "name");
            }
            return $;
        }
    }
