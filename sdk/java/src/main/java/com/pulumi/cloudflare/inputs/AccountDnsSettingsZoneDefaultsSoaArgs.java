...
public final class AccountDnsSettingsZoneDefaultsSoaArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccountDnsSettingsZoneDefaultsSoaArgs Empty = new AccountDnsSettingsZoneDefaultsSoaArgs();
    ...
    private AccountDnsSettingsZoneDefaultsSoaArgs() {}

    private AccountDnsSettingsZoneDefaultsSoaArgs(AccountDnsSettingsZoneDefaultsSoaArgs $) {
        this.expire = $.expire;
        this.minTtl = $.minTtl;
        this.mname = $.mname;
    ...
    public static Builder builder(AccountDnsSettingsZoneDefaultsSoaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccountDnsSettingsZoneDefaultsSoaArgs();
        }

        public Builder(AccountDnsSettingsZoneDefaultsSoaArgs defaults) {
            $ = new AccountDnsSettingsZoneDefaultsSoaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccountDnsSettingsZoneDefaultsSoaArgs build() {
            if ($.expire == null) {
                throw new MissingRequiredPropertyException("AccountDnsSettingsZoneDefaultsSoaArgs", "expire");
            }
            if ($.minTtl == null) {
                throw new MissingRequiredPropertyException("AccountDnsSettingsZoneDefaultsSoaArgs", "minTtl");
            }
            if ($.mname == null) {
                throw new MissingRequiredPropertyException("AccountDnsSettingsZoneDefaultsSoaArgs", "mname");
            }
            if ($.refresh == null) {
                throw new MissingRequiredPropertyException("AccountDnsSettingsZoneDefaultsSoaArgs", "refresh");
            }
            if ($.retry == null) {
                throw new MissingRequiredPropertyException("AccountDnsSettingsZoneDefaultsSoaArgs", "retry");
            }
            if ($.rname == null) {
                throw new MissingRequiredPropertyException("AccountDnsSettingsZoneDefaultsSoaArgs", "rname");
            }
            if ($.ttl == null) {
                throw new MissingRequiredPropertyException("AccountDnsSettingsZoneDefaultsSoaArgs", "ttl");
            }
            return $;
        }
    }
