...
@CustomType
public final class GetWatermarksResult {
    /**
    ...
    public static Builder builder(GetWatermarksResult defaults) {
    ...
    public static final class Builder {
        ...
        private Integer width;
        public Builder() {}
        public Builder(GetWatermarksResult defaults) {
        ...
        public Builder created(String created) {
            if (created == null) {
              throw new MissingRequiredPropertyException("GetWatermarksResult", "created");
            }
        ...
        public Builder downloadedFrom(String downloadedFrom) {
            if (downloadedFrom == null) {
              throw new MissingRequiredPropertyException("GetWatermarksResult", "downloadedFrom");
            }
        ...
        public Builder height(Integer height) {
            if (height == null) {
              throw new MissingRequiredPropertyException("GetWatermarksResult", "height");
            }
            this.height = height;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetWatermarksResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder opacity(Double opacity) {
            if (opacity == null) {
              throw new MissingRequiredPropertyException("GetWatermarksResult", "opacity");
            }
        ...
        public Builder padding(Double padding) {
            if (padding == null) {
              throw new MissingRequiredPropertyException("GetWatermarksResult", "padding");
            }
        ...
        public Builder position(String position) {
            if (position == null) {
              throw new MissingRequiredPropertyException("GetWatermarksResult", "position");
            }
        ...
        public Builder scale(Double scale) {
            if (scale == null) {
              throw new MissingRequiredPropertyException("GetWatermarksResult", "scale");
            }
            this.scale = scale;
            return this;
        }
        ...
        public Builder size(Double size) {
            if (size == null) {
              throw new MissingRequiredPropertyException("GetWatermarksResult", "size");
            }
            this.size = size;
            return this;
        }
        ...
        public Builder uid(String uid) {
            if (uid == null) {
              throw new MissingRequiredPropertyException("GetWatermarksResult", "uid");
            }
            this.uid = uid;
            return this;
        }
        ...
        public Builder width(Integer width) {
            if (width == null) {
              throw new MissingRequiredPropertyException("GetWatermarksResult", "width");
            }
            this.width = width;
            return this;
        }
        public GetWatermarksResult build() {
            final var _resultValue = new GetWatermarksResult();
