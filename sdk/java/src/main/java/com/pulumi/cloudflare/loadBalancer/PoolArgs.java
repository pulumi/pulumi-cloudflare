...
public final class PoolArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<PoolLoadSheddingArgs> loadShedding;

    /**
     * @return Configures load shedding policies and percentages for the pool.
     * 
     */
    public Optional<Output<PoolLoadSheddingArgs>> loadShedding() {
    ...
    private @Nullable Output<PoolNotificationFilterArgs> notificationFilter;

    /**
     * @return Filter pool and origin health notifications by resource type or health status. Use null to reset.
     * 
     */
    public Optional<Output<PoolNotificationFilterArgs>> notificationFilter() {
    ...
    private @Nullable Output<PoolOriginSteeringArgs> originSteering;
     ...
     * 
     */
    public Optional<Output<PoolOriginSteeringArgs>> originSteering() {
    ...
    private Output<List<PoolOriginArgs>> origins;
     ...
     * 
     */
    public Output<List<PoolOriginArgs>> origins() {
        return this.origins;
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder loadShedding(@Nullable Output<PoolLoadSheddingArgs> loadShedding) {
         ...
         * 
         */
        public Builder loadShedding(PoolLoadSheddingArgs loadShedding) {
         ...
         * 
         */
        public Builder notificationFilter(@Nullable Output<PoolNotificationFilterArgs> notificationFilter) {
         ...
         * 
         */
        public Builder notificationFilter(PoolNotificationFilterArgs notificationFilter) {
         ...
         * 
         */
        public Builder originSteering(@Nullable Output<PoolOriginSteeringArgs> originSteering) {
         ...
         * 
         */
        public Builder originSteering(PoolOriginSteeringArgs originSteering) {
         ...
         * 
         */
        public Builder origins(Output<List<PoolOriginArgs>> origins) {
            $.origins = origins;
            return this;
        }
         ...
         * 
         */
        public Builder origins(List<PoolOriginArgs> origins) {
         ...
         * 
         */
        public Builder origins(PoolOriginArgs... origins) {
            return origins(List.of(origins));
        }

        public PoolArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("PoolArgs", "accountId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PoolArgs", "name");
            }
            if ($.origins == null) {
                throw new MissingRequiredPropertyException("PoolArgs", "origins");
            }
            return $;
        }
    }
