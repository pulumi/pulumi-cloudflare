...
package com.pulumi.cloudflare.logpushDataset.inputs;
...
public final class GetFieldPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetFieldPlainArgs Empty = new GetFieldPlainArgs();
    ...
    private GetFieldPlainArgs() {}

    private GetFieldPlainArgs(GetFieldPlainArgs $) {
    ...
    public static Builder builder(GetFieldPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFieldPlainArgs();
        }

        public Builder(GetFieldPlainArgs defaults) {
            $ = new GetFieldPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFieldPlainArgs build() {
            return $;
        }
    }
