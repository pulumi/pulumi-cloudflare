...
@CustomType
public final class LoggingSettingsByRuleTypeDns {
    /**
    ...
    private LoggingSettingsByRuleTypeDns() {}
    /**
     * @return Specify whether to log all requests to this service.
     * 
     */
    ...
    public static Builder builder(LoggingSettingsByRuleTypeDns defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean logBlocks;
        public Builder() {}
        public Builder(LoggingSettingsByRuleTypeDns defaults) {
        ...
        public LoggingSettingsByRuleTypeDns build() {
            final var _resultValue = new LoggingSettingsByRuleTypeDns();
