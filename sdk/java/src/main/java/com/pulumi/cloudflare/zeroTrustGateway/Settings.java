...
import com.pulumi.cloudflare.zeroTrustGateway.inputs.SettingsState;
import com.pulumi.cloudflare.zeroTrustGateway.outputs.SettingsSettings;
 ...
 * 
 */
@ResourceType(type="cloudflare:zeroTrustGateway/settings:Settings")
public class Settings extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="settings", refs={SettingsSettings.class}, tree="[0]")
    private Output</* @Nullable */ SettingsSettings> settings;

    /**
     * @return Specify account settings.
     * 
     */
    public Output<Optional<SettingsSettings>> settings() {
    ...
    public Settings(java.lang.String name, SettingsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zeroTrustGateway/settings:Settings", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Settings(java.lang.String name, Output<java.lang.String> id, @Nullable SettingsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zeroTrustGateway/settings:Settings", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/zeroTrustGatewaySettings:ZeroTrustGatewaySettings").build()),
