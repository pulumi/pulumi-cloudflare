...
public final class PageArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public PageArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("PageArgs", "accountId");
            }
            if ($.customHtml == null) {
                throw new MissingRequiredPropertyException("PageArgs", "customHtml");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PageArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("PageArgs", "type");
            }
            return $;
        }
    }
