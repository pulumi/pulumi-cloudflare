...
@CustomType
public final class GetMagicWanIpsecTunnelIpsecTunnelBgp {
    /**
    ...
    private GetMagicWanIpsecTunnelIpsecTunnelBgp() {}
    /**
     * @return ASN used on the customer end of the BGP session
     * 
     */
    ...
    public static Builder builder(GetMagicWanIpsecTunnelIpsecTunnelBgp defaults) {
    ...
    public static final class Builder {
        ...
        private String md5Key;
        public Builder() {}
        public Builder(GetMagicWanIpsecTunnelIpsecTunnelBgp defaults) {
        ...
        public Builder customerAsn(Integer customerAsn) {
            if (customerAsn == null) {
              throw new MissingRequiredPropertyException("GetMagicWanIpsecTunnelIpsecTunnelBgp", "customerAsn");
            }
        ...
        public Builder extraPrefixes(List<String> extraPrefixes) {
            if (extraPrefixes == null) {
              throw new MissingRequiredPropertyException("GetMagicWanIpsecTunnelIpsecTunnelBgp", "extraPrefixes");
            }
        ...
        public Builder md5Key(String md5Key) {
            if (md5Key == null) {
              throw new MissingRequiredPropertyException("GetMagicWanIpsecTunnelIpsecTunnelBgp", "md5Key");
            }
            this.md5Key = md5Key;
            return this;
        }
        public GetMagicWanIpsecTunnelIpsecTunnelBgp build() {
            final var _resultValue = new GetMagicWanIpsecTunnelIpsecTunnelBgp();
