...
import com.pulumi.cloudflare.inputs.MagicWanGreTunnelGreTunnelHealthCheckTargetArgs;
...
public final class MagicWanGreTunnelGreTunnelHealthCheckArgs extends com.pulumi.resources.ResourceArgs {

    public static final MagicWanGreTunnelGreTunnelHealthCheckArgs Empty = new MagicWanGreTunnelGreTunnelHealthCheckArgs();
     ...
     */
    @Import(name="target")
    private @Nullable Output<MagicWanGreTunnelGreTunnelHealthCheckTargetArgs> target;

    /**
     * @return The destination address in a request type health check. After the healthcheck is decapsulated at the customer end of the tunnel, the ICMP echo will be forwarded to this address. This field defaults to `customer_gre_endpoint address`. This field is ignored for bidirectional healthchecks as the interface*address (not assigned to the Cloudflare side of the tunnel) is used as the target. Must be in object form if the x-magic-new-hc-target header is set to true and string form if x-magic-new-hc-target is absent or set to false.
     * 
     */
    public Optional<Output<MagicWanGreTunnelGreTunnelHealthCheckTargetArgs>> target() {
    ...
    private MagicWanGreTunnelGreTunnelHealthCheckArgs() {}

    private MagicWanGreTunnelGreTunnelHealthCheckArgs(MagicWanGreTunnelGreTunnelHealthCheckArgs $) {
    ...
    public static Builder builder(MagicWanGreTunnelGreTunnelHealthCheckArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagicWanGreTunnelGreTunnelHealthCheckArgs();
        }

        public Builder(MagicWanGreTunnelGreTunnelHealthCheckArgs defaults) {
            $ = new MagicWanGreTunnelGreTunnelHealthCheckArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder target(@Nullable Output<MagicWanGreTunnelGreTunnelHealthCheckTargetArgs> target) {
            $.target = target;
            return this;
        }
         ...
         * 
         */
        public Builder target(MagicWanGreTunnelGreTunnelHealthCheckTargetArgs target) {
        ...
        public MagicWanGreTunnelGreTunnelHealthCheckArgs build() {
            return $;
        }
    }
