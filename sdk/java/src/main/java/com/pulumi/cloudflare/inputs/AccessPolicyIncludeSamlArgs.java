    ...
    public static final class Builder {
        ...
        public AccessPolicyIncludeSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("AccessPolicyIncludeSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("AccessPolicyIncludeSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("AccessPolicyIncludeSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
