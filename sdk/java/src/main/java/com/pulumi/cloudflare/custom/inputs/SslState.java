...
import com.pulumi.cloudflare.custom.inputs.SslKeylessServerArgs;
...
public final class SslState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<SslGeoRestrictionsArgs> geoRestrictions;

    /**
     * @return Specify the region where your private key can be held locally for optimal TLS performance. HTTPS connections to any excluded data center will still be fully encrypted, but will incur some latency while Keyless SSL is used to complete the handshake with the nearest allowed data center. Options allow distribution to only to U.S. data centers, only to E.U. data centers, or only to highest security data centers. Default distribution is to all Cloudflare datacenters, for optimal performance.
     * 
     */
    public Optional<Output<SslGeoRestrictionsArgs>> geoRestrictions() {
    ...
    private @Nullable Output<SslKeylessServerArgs> keylessServer;

    public Optional<Output<SslKeylessServerArgs>> keylessServer() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder geoRestrictions(@Nullable Output<SslGeoRestrictionsArgs> geoRestrictions) {
         ...
         * 
         */
        public Builder geoRestrictions(SslGeoRestrictionsArgs geoRestrictions) {
        ...
        public Builder keylessServer(@Nullable Output<SslKeylessServerArgs> keylessServer) {
            $.keylessServer = keylessServer;
            return this;
        }

        public Builder keylessServer(SslKeylessServerArgs keylessServer) {
