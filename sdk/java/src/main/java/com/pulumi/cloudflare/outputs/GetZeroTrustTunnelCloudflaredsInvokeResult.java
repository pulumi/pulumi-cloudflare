...
import com.pulumi.cloudflare.outputs.GetZeroTrustTunnelCloudflaredsResult;
...
@CustomType
public final class GetZeroTrustTunnelCloudflaredsInvokeResult {
    /**
    ...
    private GetZeroTrustTunnelCloudflaredsInvokeResult() {}
    /**
     * @return Cloudflare account ID
     * 
     */
     ...
     * 
     */
    public List<GetZeroTrustTunnelCloudflaredsResult> results() {
        return this.results;
    }
    /**
     * @return The status of the tunnel. Valid values are `inactive` (tunnel has never been run), `degraded` (tunnel is active and able to serve traffic but in an unhealthy state), `healthy` (tunnel is active and able to serve traffic), or `down` (tunnel can not serve traffic as it has no connections to the Cloudflare Edge).
    ...
    public static Builder builder(GetZeroTrustTunnelCloudflaredsInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String wasInactiveAt;
        public Builder() {}
        public Builder(GetZeroTrustTunnelCloudflaredsInvokeResult defaults) {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredsInvokeResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder results(List<GetZeroTrustTunnelCloudflaredsResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredsInvokeResult", "results");
            }
            this.results = results;
            return this;
        }
        public Builder results(GetZeroTrustTunnelCloudflaredsResult... results) {
        ...
        public GetZeroTrustTunnelCloudflaredsInvokeResult build() {
            final var _resultValue = new GetZeroTrustTunnelCloudflaredsInvokeResult();
