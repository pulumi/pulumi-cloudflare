...
public final class ZeroTrustAccessGroupExcludeSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZeroTrustAccessGroupExcludeSamlArgs Empty = new ZeroTrustAccessGroupExcludeSamlArgs();
    ...
    private ZeroTrustAccessGroupExcludeSamlArgs() {}

    private ZeroTrustAccessGroupExcludeSamlArgs(ZeroTrustAccessGroupExcludeSamlArgs $) {
    ...
    public static Builder builder(ZeroTrustAccessGroupExcludeSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustAccessGroupExcludeSamlArgs();
        }

        public Builder(ZeroTrustAccessGroupExcludeSamlArgs defaults) {
            $ = new ZeroTrustAccessGroupExcludeSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ZeroTrustAccessGroupExcludeSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessGroupExcludeSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessGroupExcludeSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessGroupExcludeSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
