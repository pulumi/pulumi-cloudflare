...
public final class DevicePostureRuleInputLocationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DevicePostureRuleInputLocationArgs() {}

    private DevicePostureRuleInputLocationArgs(DevicePostureRuleInputLocationArgs $) {
        this.paths = $.paths;
    ...
    public static Builder builder(DevicePostureRuleInputLocationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DevicePostureRuleInputLocationArgs();
        }

        public Builder(DevicePostureRuleInputLocationArgs defaults) {
            $ = new DevicePostureRuleInputLocationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DevicePostureRuleInputLocationArgs build() {
            return $;
        }
    }
