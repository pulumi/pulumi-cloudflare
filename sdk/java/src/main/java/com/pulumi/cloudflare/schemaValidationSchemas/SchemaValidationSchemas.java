...
import com.pulumi.cloudflare.schemaValidationSchemas.inputs.SchemaValidationSchemasState;
 ...
 * 
 * ```sh
 * $ pulumi import cloudflare:schemaValidationSchemas/schemaValidationSchemas:SchemaValidationSchemas example &#39;&lt;zone_id&gt;/&lt;schema_id&gt;&#39;
 * ```
 * 
 */
@ResourceType(type="cloudflare:schemaValidationSchemas/schemaValidationSchemas:SchemaValidationSchemas")
public class SchemaValidationSchemas extends com.pulumi.resources.CustomResource {
    ...
    public SchemaValidationSchemas(java.lang.String name, SchemaValidationSchemasArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:schemaValidationSchemas/schemaValidationSchemas:SchemaValidationSchemas", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private SchemaValidationSchemas(java.lang.String name, Output<java.lang.String> id, @Nullable SchemaValidationSchemasState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:schemaValidationSchemas/schemaValidationSchemas:SchemaValidationSchemas", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/schemaValidationSchemas:SchemaValidationSchemas").build())
            ))
            .build();
