...
@CustomType
public final class GetConfigsResultMtls {
    /**
    ...
    public static Builder builder(GetConfigsResultMtls defaults) {
    ...
    public static final class Builder {
        ...
        private String sslmode;
        public Builder() {}
        public Builder(GetConfigsResultMtls defaults) {
        ...
        public Builder caCertificateId(String caCertificateId) {
            if (caCertificateId == null) {
              throw new MissingRequiredPropertyException("GetConfigsResultMtls", "caCertificateId");
            }
        ...
        public Builder mtlsCertificateId(String mtlsCertificateId) {
            if (mtlsCertificateId == null) {
              throw new MissingRequiredPropertyException("GetConfigsResultMtls", "mtlsCertificateId");
            }
        ...
        public Builder sslmode(String sslmode) {
            if (sslmode == null) {
              throw new MissingRequiredPropertyException("GetConfigsResultMtls", "sslmode");
            }
            this.sslmode = sslmode;
            return this;
        }
        public GetConfigsResultMtls build() {
            final var _resultValue = new GetConfigsResultMtls();
