...
import com.pulumi.cloudflare.custom.outputs.GetSslsResultGeoRestrictions;
import com.pulumi.cloudflare.custom.outputs.GetSslsResultKeylessServer;
...
public final class GetSslsResult {
     ...
     * 
     */
    private GetSslsResultGeoRestrictions geoRestrictions;
    ...
    private GetSslsResultKeylessServer keylessServer;
    /**
     ...
     * 
     */
    public GetSslsResultGeoRestrictions geoRestrictions() {
    ...
    public GetSslsResultKeylessServer keylessServer() {
    ...
    public static final class Builder {
        ...
        public Builder bundleMethod(String bundleMethod) {
            if (bundleMethod == null) {
              throw new MissingRequiredPropertyException("GetSslsResult", "bundleMethod");
            }
        ...
        public Builder customCsrId(String customCsrId) {
            if (customCsrId == null) {
              throw new MissingRequiredPropertyException("GetSslsResult", "customCsrId");
            }
        ...
        public Builder expiresOn(String expiresOn) {
            if (expiresOn == null) {
              throw new MissingRequiredPropertyException("GetSslsResult", "expiresOn");
            }
            this.expiresOn = expiresOn;
            return this;
        }
        @CustomType.Setter
        public Builder geoRestrictions(GetSslsResultGeoRestrictions geoRestrictions) {
            if (geoRestrictions == null) {
              throw new MissingRequiredPropertyException("GetSslsResult", "geoRestrictions");
            }
        ...
        public Builder hosts(List<String> hosts) {
            if (hosts == null) {
              throw new MissingRequiredPropertyException("GetSslsResult", "hosts");
            }
            this.hosts = hosts;
            return this;
        }
        ...
        public Builder issuer(String issuer) {
            if (issuer == null) {
              throw new MissingRequiredPropertyException("GetSslsResult", "issuer");
            }
            this.issuer = issuer;
            return this;
        }
        @CustomType.Setter
        public Builder keylessServer(GetSslsResultKeylessServer keylessServer) {
            if (keylessServer == null) {
              throw new MissingRequiredPropertyException("GetSslsResult", "keylessServer");
            }
        ...
        public Builder modifiedOn(String modifiedOn) {
            if (modifiedOn == null) {
              throw new MissingRequiredPropertyException("GetSslsResult", "modifiedOn");
            }
        ...
        public Builder policyRestrictions(String policyRestrictions) {
            if (policyRestrictions == null) {
              throw new MissingRequiredPropertyException("GetSslsResult", "policyRestrictions");
            }
        ...
        public Builder priority(Double priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("GetSslsResult", "priority");
            }
        ...
        public Builder signature(String signature) {
            if (signature == null) {
              throw new MissingRequiredPropertyException("GetSslsResult", "signature");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetSslsResult", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder uploadedOn(String uploadedOn) {
            if (uploadedOn == null) {
              throw new MissingRequiredPropertyException("GetSslsResult", "uploadedOn");
            }
        ...
        public Builder zoneId(String zoneId) {
            if (zoneId == null) {
              throw new MissingRequiredPropertyException("GetSslsResult", "zoneId");
            }
            this.zoneId = zoneId;
            return this;
        }
