...
import com.pulumi.cloudflare.zeroTrustDlpCustom.outputs.GetProfileContextAwareness;
import com.pulumi.cloudflare.zeroTrustDlpCustom.outputs.GetProfileEntry;
import com.pulumi.cloudflare.zeroTrustDlpCustom.outputs.GetProfileSensitivityLevel;
import com.pulumi.cloudflare.zeroTrustDlpCustom.outputs.GetProfileSharedEntry;
...
public final class GetProfileResult {
    ...
    private GetProfileContextAwareness contextAwareness;
    /**
     ...
     * 
     */
    private List<GetProfileSensitivityLevel> sensitivityLevels;
    private List<GetProfileSharedEntry> sharedEntries;
    /**
     ...
     */
    @Deprecated /* This attribute is deprecated. */
    public GetProfileContextAwareness contextAwareness() {
     ...
     * 
     */
    public List<GetProfileSensitivityLevel> sensitivityLevels() {
        return this.sensitivityLevels;
    }
    public List<GetProfileSharedEntry> sharedEntries() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder contextAwareness(GetProfileContextAwareness contextAwareness) {
            if (contextAwareness == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "contextAwareness");
            }
        ...
        public Builder dataClasses(List<String> dataClasses) {
            if (dataClasses == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "dataClasses");
            }
        ...
        public Builder dataTags(List<String> dataTags) {
            if (dataTags == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "dataTags");
            }
        ...
        @CustomType.Setter
        public Builder sensitivityLevels(List<GetProfileSensitivityLevel> sensitivityLevels) {
            if (sensitivityLevels == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "sensitivityLevels");
            }
            this.sensitivityLevels = sensitivityLevels;
            return this;
        }
        public Builder sensitivityLevels(GetProfileSensitivityLevel... sensitivityLevels) {
            return sensitivityLevels(List.of(sensitivityLevels));
        }
        @CustomType.Setter
        public Builder sharedEntries(List<GetProfileSharedEntry> sharedEntries) {
            if (sharedEntries == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "sharedEntries");
            }
            this.sharedEntries = sharedEntries;
            return this;
        }
        public Builder sharedEntries(GetProfileSharedEntry... sharedEntries) {
