...
public final class GetSecretsStoreSecretFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetSecretsStoreSecretFilterArgs() {}

    private GetSecretsStoreSecretFilterArgs(GetSecretsStoreSecretFilterArgs $) {
    ...
    public static Builder builder(GetSecretsStoreSecretFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSecretsStoreSecretFilterArgs();
        }

        public Builder(GetSecretsStoreSecretFilterArgs defaults) {
            $ = new GetSecretsStoreSecretFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSecretsStoreSecretFilterArgs build() {
            if ($.direction == null) {
                throw new MissingRequiredPropertyException("GetSecretsStoreSecretFilterArgs", "direction");
            }
            if ($.order == null) {
                throw new MissingRequiredPropertyException("GetSecretsStoreSecretFilterArgs", "order");
            }
            return $;
        }
    }
