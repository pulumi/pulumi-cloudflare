...
public final class GetHostnamesArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private @Nullable Output<GetHostnamesHostnameArgs> hostname;

    public Optional<Output<GetHostnamesHostnameArgs>> hostname() {
    ...
    public static final class Builder {
        ...
        public Builder hostname(@Nullable Output<GetHostnamesHostnameArgs> hostname) {
            $.hostname = hostname;
            return this;
        }

        public Builder hostname(GetHostnamesHostnameArgs hostname) {
