...
@CustomType
public final class GetStreamWatermarksResult {
    /**
    ...
    public static Builder builder(GetStreamWatermarksResult defaults) {
    ...
    public static final class Builder {
        ...
        private Integer width;
        public Builder() {}
        public Builder(GetStreamWatermarksResult defaults) {
        ...
        public Builder created(String created) {
            if (created == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermarksResult", "created");
            }
        ...
        public Builder downloadedFrom(String downloadedFrom) {
            if (downloadedFrom == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermarksResult", "downloadedFrom");
            }
        ...
        public Builder height(Integer height) {
            if (height == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermarksResult", "height");
            }
            this.height = height;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermarksResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder opacity(Double opacity) {
            if (opacity == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermarksResult", "opacity");
            }
        ...
        public Builder padding(Double padding) {
            if (padding == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermarksResult", "padding");
            }
        ...
        public Builder position(String position) {
            if (position == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermarksResult", "position");
            }
        ...
        public Builder scale(Double scale) {
            if (scale == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermarksResult", "scale");
            }
            this.scale = scale;
            return this;
        }
        ...
        public Builder size(Double size) {
            if (size == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermarksResult", "size");
            }
            this.size = size;
            return this;
        }
        ...
        public Builder uid(String uid) {
            if (uid == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermarksResult", "uid");
            }
            this.uid = uid;
            return this;
        }
        ...
        public Builder width(Integer width) {
            if (width == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermarksResult", "width");
            }
            this.width = width;
            return this;
        }
        public GetStreamWatermarksResult build() {
            final var _resultValue = new GetStreamWatermarksResult();
