...
public final class HoldArgs extends com.pulumi.resources.ResourceArgs {

    public static final HoldArgs Empty = new HoldArgs();
    ...
    public static Builder builder(HoldArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(HoldArgs defaults) {
            $ = new HoldArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HoldArgs build() {
            if ($.zoneId == null) {
                throw new MissingRequiredPropertyException("HoldArgs", "zoneId");
            }
            return $;
        }
    }
