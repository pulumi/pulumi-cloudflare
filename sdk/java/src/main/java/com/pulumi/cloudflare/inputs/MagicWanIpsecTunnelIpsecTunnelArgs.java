...
import com.pulumi.cloudflare.inputs.MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs;
import com.pulumi.cloudflare.inputs.MagicWanIpsecTunnelIpsecTunnelPskMetadataArgs;
...
public final class MagicWanIpsecTunnelIpsecTunnelArgs extends com.pulumi.resources.ResourceArgs {

    public static final MagicWanIpsecTunnelIpsecTunnelArgs Empty = new MagicWanIpsecTunnelIpsecTunnelArgs();
    ...
    private @Nullable Output<MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs> healthCheck;

    public Optional<Output<MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs>> healthCheck() {
    ...
    private @Nullable Output<MagicWanIpsecTunnelIpsecTunnelPskMetadataArgs> pskMetadata;

    /**
     * @return The PSK metadata that includes when the PSK was generated.
     * 
     */
    public Optional<Output<MagicWanIpsecTunnelIpsecTunnelPskMetadataArgs>> pskMetadata() {
    ...
    private MagicWanIpsecTunnelIpsecTunnelArgs() {}

    private MagicWanIpsecTunnelIpsecTunnelArgs(MagicWanIpsecTunnelIpsecTunnelArgs $) {
    ...
    public static Builder builder(MagicWanIpsecTunnelIpsecTunnelArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagicWanIpsecTunnelIpsecTunnelArgs();
        }

        public Builder(MagicWanIpsecTunnelIpsecTunnelArgs defaults) {
            $ = new MagicWanIpsecTunnelIpsecTunnelArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder healthCheck(@Nullable Output<MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs> healthCheck) {
            $.healthCheck = healthCheck;
            return this;
        }

        public Builder healthCheck(MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs healthCheck) {
         ...
         * 
         */
        public Builder pskMetadata(@Nullable Output<MagicWanIpsecTunnelIpsecTunnelPskMetadataArgs> pskMetadata) {
         ...
         * 
         */
        public Builder pskMetadata(MagicWanIpsecTunnelIpsecTunnelPskMetadataArgs pskMetadata) {
        ...
        public MagicWanIpsecTunnelIpsecTunnelArgs build() {
            return $;
        }
    }
