...
@CustomType
public final class IpsecTunnelHealthCheckTarget {
    /**
    ...
    private IpsecTunnelHealthCheckTarget() {}
    /**
     * @return The effective health check target. If &#39;saved&#39; is empty, then this field will be populated with the calculated default value on GET requests. Ignored in POST, PUT, and PATCH requests.
     * 
     */
    ...
    public static Builder builder(IpsecTunnelHealthCheckTarget defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String saved;
        public Builder() {}
        public Builder(IpsecTunnelHealthCheckTarget defaults) {
        ...
        public IpsecTunnelHealthCheckTarget build() {
            final var _resultValue = new IpsecTunnelHealthCheckTarget();
