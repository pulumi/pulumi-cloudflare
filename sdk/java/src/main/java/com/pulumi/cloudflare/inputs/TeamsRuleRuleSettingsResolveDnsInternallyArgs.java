...
public final class TeamsRuleRuleSettingsResolveDnsInternallyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TeamsRuleRuleSettingsResolveDnsInternallyArgs() {}

    private TeamsRuleRuleSettingsResolveDnsInternallyArgs(TeamsRuleRuleSettingsResolveDnsInternallyArgs $) {
    ...
    public static Builder builder(TeamsRuleRuleSettingsResolveDnsInternallyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TeamsRuleRuleSettingsResolveDnsInternallyArgs();
        }

        public Builder(TeamsRuleRuleSettingsResolveDnsInternallyArgs defaults) {
            $ = new TeamsRuleRuleSettingsResolveDnsInternallyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TeamsRuleRuleSettingsResolveDnsInternallyArgs build() {
            return $;
        }
    }
