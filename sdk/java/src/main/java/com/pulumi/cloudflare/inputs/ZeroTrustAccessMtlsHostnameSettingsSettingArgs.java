    ...
    public static final class Builder {
        ...
        public ZeroTrustAccessMtlsHostnameSettingsSettingArgs build() {
            if ($.chinaNetwork == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessMtlsHostnameSettingsSettingArgs", "chinaNetwork");
            }
            if ($.clientCertificateForwarding == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessMtlsHostnameSettingsSettingArgs", "clientCertificateForwarding");
            }
            if ($.hostname == null) {
