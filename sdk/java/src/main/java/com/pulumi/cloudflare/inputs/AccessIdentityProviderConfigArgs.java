...
import com.pulumi.cloudflare.inputs.AccessIdentityProviderConfigHeaderAttributeArgs;
...
public final class AccessIdentityProviderConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<AccessIdentityProviderConfigHeaderAttributeArgs>> headerAttributes;

    /**
     * @return Add a list of attribute names that will be returned in the response header from the Access callback.
     * 
     */
    public Optional<Output<List<AccessIdentityProviderConfigHeaderAttributeArgs>>> headerAttributes() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder headerAttributes(@Nullable Output<List<AccessIdentityProviderConfigHeaderAttributeArgs>> headerAttributes) {
         ...
         * 
         */
        public Builder headerAttributes(List<AccessIdentityProviderConfigHeaderAttributeArgs> headerAttributes) {
         ...
         * 
         */
        public Builder headerAttributes(AccessIdentityProviderConfigHeaderAttributeArgs... headerAttributes) {
