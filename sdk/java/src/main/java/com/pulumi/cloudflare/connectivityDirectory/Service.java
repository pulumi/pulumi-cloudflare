...
import com.pulumi.cloudflare.connectivityDirectory.inputs.ServiceState;
import com.pulumi.cloudflare.connectivityDirectory.outputs.ServiceHost;
import com.pulumi.cloudflare.connectivityDirectory.outputs.ServiceTlsSettings;
 ...
 * 
 */
@ResourceType(type="cloudflare:connectivityDirectory/service:Service")
public class Service extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="host", refs={ServiceHost.class}, tree="[0]")
    private Output<ServiceHost> host;

    public Output<ServiceHost> host() {
        return this.host;
    }
     ...
     * 
     */
    @Export(name="tlsSettings", refs={ServiceTlsSettings.class}, tree="[0]")
    private Output</* @Nullable */ ServiceTlsSettings> tlsSettings;

    /**
     * @return TLS settings for a connectivity service.
     * 
     */
    public Output<Optional<ServiceTlsSettings>> tlsSettings() {
    ...
    public Service(java.lang.String name, ServiceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:connectivityDirectory/service:Service", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Service(java.lang.String name, Output<java.lang.String> id, @Nullable ServiceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:connectivityDirectory/service:Service", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/connectivityDirectoryService:ConnectivityDirectoryService").build())
            ))
            .build();
