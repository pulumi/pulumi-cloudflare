...
@CustomType
public final class GetOrganizationMfaConfig {
    /**
    ...
    private GetOrganizationMfaConfig() {}
    /**
     * @return Lists the MFA methods that users can authenticate with.
     * 
     */
    ...
    public static Builder builder(GetOrganizationMfaConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String sessionDuration;
        public Builder() {}
        public Builder(GetOrganizationMfaConfig defaults) {
        ...
        public Builder allowedAuthenticators(List<String> allowedAuthenticators) {
            if (allowedAuthenticators == null) {
              throw new MissingRequiredPropertyException("GetOrganizationMfaConfig", "allowedAuthenticators");
            }
        ...
        public Builder amrMatchingSessionDuration(String amrMatchingSessionDuration) {
            if (amrMatchingSessionDuration == null) {
              throw new MissingRequiredPropertyException("GetOrganizationMfaConfig", "amrMatchingSessionDuration");
            }
        ...
        public Builder requiredAaguids(String requiredAaguids) {
            if (requiredAaguids == null) {
              throw new MissingRequiredPropertyException("GetOrganizationMfaConfig", "requiredAaguids");
            }
        ...
        public Builder sessionDuration(String sessionDuration) {
            if (sessionDuration == null) {
              throw new MissingRequiredPropertyException("GetOrganizationMfaConfig", "sessionDuration");
            }
            this.sessionDuration = sessionDuration;
            return this;
        }
        public GetOrganizationMfaConfig build() {
            final var _resultValue = new GetOrganizationMfaConfig();
