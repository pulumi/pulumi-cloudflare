...
@CustomType
public final class ApplicationMfaConfig {
    /**
    ...
    public static Builder builder(ApplicationMfaConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sessionDuration;
        public Builder() {}
        public Builder(ApplicationMfaConfig defaults) {
        ...
        public ApplicationMfaConfig build() {
            final var _resultValue = new ApplicationMfaConfig();
