...
import com.pulumi.cloudflare.access.inputs.RuleScopeArgs;
...
public final class RuleState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<RuleConfigurationArgs> configuration;

    /**
     * @return The rule configuration.
     * 
     */
    public Optional<Output<RuleConfigurationArgs>> configuration() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder configuration(@Nullable Output<RuleConfigurationArgs> configuration) {
