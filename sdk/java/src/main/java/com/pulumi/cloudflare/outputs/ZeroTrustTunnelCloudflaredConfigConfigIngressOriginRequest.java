...
import com.pulumi.cloudflare.outputs.ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestAccess;
...
@CustomType
public final class ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest {
    /**
     ...
     * 
     */
    private @Nullable ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestAccess access;
    /**
    ...
    private ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest() {}
    /**
     * @return For all L7 requests to this hostname, cloudflared will validate each request&#39;s Cf-Access-Jwt-Assertion request header.
     * 
     */
    public Optional<ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestAccess> access() {
    ...
    public static Builder builder(ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer tlsTimeout;
        public Builder() {}
        public Builder(ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest defaults) {
        ...
        @CustomType.Setter
        public Builder access(@Nullable ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestAccess access) {
        ...
        public ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest build() {
            final var _resultValue = new ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest();
