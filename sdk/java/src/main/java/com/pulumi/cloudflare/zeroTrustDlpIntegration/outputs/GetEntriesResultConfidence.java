...
@CustomType
public final class GetEntriesResultConfidence {
    /**
    ...
    private GetEntriesResultConfidence() {}
    /**
     * @return Indicates whether this entry has AI remote service validation.
     * 
     */
    ...
    public static Builder builder(GetEntriesResultConfidence defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean available;
        public Builder() {}
        public Builder(GetEntriesResultConfidence defaults) {
        ...
        public Builder aiContextAvailable(Boolean aiContextAvailable) {
            if (aiContextAvailable == null) {
              throw new MissingRequiredPropertyException("GetEntriesResultConfidence", "aiContextAvailable");
            }
        ...
        public Builder available(Boolean available) {
            if (available == null) {
              throw new MissingRequiredPropertyException("GetEntriesResultConfidence", "available");
            }
            this.available = available;
            return this;
        }
        public GetEntriesResultConfidence build() {
            final var _resultValue = new GetEntriesResultConfidence();
