...
@CustomType
public final class PolicyRuleSettingsRedirect {
    /**
    ...
    private PolicyRuleSettingsRedirect() {}
    /**
     * @return Specify whether to pass the context information as query parameters.
     * 
     */
    ...
    public static Builder builder(PolicyRuleSettingsRedirect defaults) {
    ...
    public static final class Builder {
        ...
        private String targetUri;
        public Builder() {}
        public Builder(PolicyRuleSettingsRedirect defaults) {
        ...
        public Builder targetUri(String targetUri) {
            if (targetUri == null) {
              throw new MissingRequiredPropertyException("PolicyRuleSettingsRedirect", "targetUri");
            }
            this.targetUri = targetUri;
            return this;
        }
        public PolicyRuleSettingsRedirect build() {
            final var _resultValue = new PolicyRuleSettingsRedirect();
