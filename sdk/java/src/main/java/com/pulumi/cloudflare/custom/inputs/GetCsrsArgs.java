...
public final class GetCsrsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetCsrsArgs Empty = new GetCsrsArgs();
    ...
    private GetCsrsArgs(GetCsrsArgs $) {
    ...
    public static Builder builder(GetCsrsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetCsrsArgs defaults) {
            $ = new GetCsrsArgs(Objects.requireNonNull(defaults));
        }
