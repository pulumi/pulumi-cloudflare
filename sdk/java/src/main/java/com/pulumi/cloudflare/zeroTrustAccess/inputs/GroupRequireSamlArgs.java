...
public final class GroupRequireSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupRequireSamlArgs Empty = new GroupRequireSamlArgs();
    ...
    private GroupRequireSamlArgs() {}

    private GroupRequireSamlArgs(GroupRequireSamlArgs $) {
    ...
    public static Builder builder(GroupRequireSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupRequireSamlArgs();
        }

        public Builder(GroupRequireSamlArgs defaults) {
            $ = new GroupRequireSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupRequireSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("GroupRequireSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("GroupRequireSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("GroupRequireSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
