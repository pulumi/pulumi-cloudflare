...
@CustomType
public final class GetWatermarkResult {
    /**
    ...
    public static Builder builder(GetWatermarkResult defaults) {
    ...
    public static final class Builder {
        ...
        private Integer width;
        public Builder() {}
        public Builder(GetWatermarkResult defaults) {
        ...
        public Builder accountId(String accountId) {
            if (accountId == null) {
              throw new MissingRequiredPropertyException("GetWatermarkResult", "accountId");
            }
        ...
        public Builder created(String created) {
            if (created == null) {
              throw new MissingRequiredPropertyException("GetWatermarkResult", "created");
            }
        ...
        public Builder downloadedFrom(String downloadedFrom) {
            if (downloadedFrom == null) {
              throw new MissingRequiredPropertyException("GetWatermarkResult", "downloadedFrom");
            }
        ...
        public Builder height(Integer height) {
            if (height == null) {
              throw new MissingRequiredPropertyException("GetWatermarkResult", "height");
            }
            this.height = height;
            return this;
        }
        ...
        public Builder identifier(String identifier) {
            if (identifier == null) {
              throw new MissingRequiredPropertyException("GetWatermarkResult", "identifier");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetWatermarkResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder opacity(Double opacity) {
            if (opacity == null) {
              throw new MissingRequiredPropertyException("GetWatermarkResult", "opacity");
            }
        ...
        public Builder padding(Double padding) {
            if (padding == null) {
              throw new MissingRequiredPropertyException("GetWatermarkResult", "padding");
            }
        ...
        public Builder position(String position) {
            if (position == null) {
              throw new MissingRequiredPropertyException("GetWatermarkResult", "position");
            }
        ...
        public Builder scale(Double scale) {
            if (scale == null) {
              throw new MissingRequiredPropertyException("GetWatermarkResult", "scale");
            }
            this.scale = scale;
            return this;
        }
        ...
        public Builder size(Double size) {
            if (size == null) {
              throw new MissingRequiredPropertyException("GetWatermarkResult", "size");
            }
            this.size = size;
            return this;
        }
        ...
        public Builder uid(String uid) {
            if (uid == null) {
              throw new MissingRequiredPropertyException("GetWatermarkResult", "uid");
            }
            this.uid = uid;
            return this;
        }
        ...
        public Builder width(Integer width) {
            if (width == null) {
              throw new MissingRequiredPropertyException("GetWatermarkResult", "width");
            }
            this.width = width;
            return this;
        }
        public GetWatermarkResult build() {
            final var _resultValue = new GetWatermarkResult();
