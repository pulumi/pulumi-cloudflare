...
public final class GetRouteFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetRouteFilterArgs build() {
            if ($.isDeleted == null) {
                throw new MissingRequiredPropertyException("GetRouteFilterArgs", "isDeleted");
            }
            return $;
        }
    }
