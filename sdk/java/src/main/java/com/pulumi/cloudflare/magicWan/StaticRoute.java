...
import com.pulumi.cloudflare.magicWan.inputs.StaticRouteState;
import com.pulumi.cloudflare.magicWan.outputs.StaticRouteScope;
 ...
 * 
 * ```sh
 * $ pulumi import cloudflare:magicWan/staticRoute:StaticRoute example &#39;&lt;account_id&gt;/&lt;route_id&gt;&#39;
 * ```
 * 
 */
@ResourceType(type="cloudflare:magicWan/staticRoute:StaticRoute")
public class StaticRoute extends com.pulumi.resources.CustomResource {
    ...
    public StaticRoute(java.lang.String name, StaticRouteArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:magicWan/staticRoute:StaticRoute", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private StaticRoute(java.lang.String name, Output<java.lang.String> id, @Nullable StaticRouteState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:magicWan/staticRoute:StaticRoute", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("cloudflare:index/magicWanStaticRoute:MagicWanStaticRoute").build())
            ))
            .build();
