...
import com.pulumi.cloudflare.dns.outputs.GetFirewallsResultAttackMitigation;
...
public final class GetFirewallsResult {
     ...
     * 
     */
    private GetFirewallsResultAttackMitigation attackMitigation;
    /**
     ...
     * 
     */
    public GetFirewallsResultAttackMitigation attackMitigation() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder attackMitigation(GetFirewallsResultAttackMitigation attackMitigation) {
            if (attackMitigation == null) {
              throw new MissingRequiredPropertyException("GetFirewallsResult", "attackMitigation");
            }
        ...
        public Builder deprecateAnyRequests(Boolean deprecateAnyRequests) {
            if (deprecateAnyRequests == null) {
              throw new MissingRequiredPropertyException("GetFirewallsResult", "deprecateAnyRequests");
            }
        ...
        public Builder dnsFirewallIps(List<String> dnsFirewallIps) {
            if (dnsFirewallIps == null) {
              throw new MissingRequiredPropertyException("GetFirewallsResult", "dnsFirewallIps");
            }
        ...
        public Builder ecsFallback(Boolean ecsFallback) {
            if (ecsFallback == null) {
              throw new MissingRequiredPropertyException("GetFirewallsResult", "ecsFallback");
            }
        ...
        public Builder maximumCacheTtl(Double maximumCacheTtl) {
            if (maximumCacheTtl == null) {
              throw new MissingRequiredPropertyException("GetFirewallsResult", "maximumCacheTtl");
            }
        ...
        public Builder minimumCacheTtl(Double minimumCacheTtl) {
            if (minimumCacheTtl == null) {
              throw new MissingRequiredPropertyException("GetFirewallsResult", "minimumCacheTtl");
            }
        ...
        public Builder modifiedOn(String modifiedOn) {
            if (modifiedOn == null) {
              throw new MissingRequiredPropertyException("GetFirewallsResult", "modifiedOn");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetFirewallsResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder negativeCacheTtl(Double negativeCacheTtl) {
            if (negativeCacheTtl == null) {
              throw new MissingRequiredPropertyException("GetFirewallsResult", "negativeCacheTtl");
            }
        ...
        public Builder ratelimit(Double ratelimit) {
            if (ratelimit == null) {
              throw new MissingRequiredPropertyException("GetFirewallsResult", "ratelimit");
            }
        ...
        public Builder retries(Double retries) {
            if (retries == null) {
              throw new MissingRequiredPropertyException("GetFirewallsResult", "retries");
            }
        ...
        public Builder upstreamIps(List<String> upstreamIps) {
            if (upstreamIps == null) {
              throw new MissingRequiredPropertyException("GetFirewallsResult", "upstreamIps");
            }
