...
@CustomType
public final class PolicyRuleSettingsBlockPage {
    /**
    ...
    private PolicyRuleSettingsBlockPage() {}
    /**
     * @return Specify whether to pass the context information as query parameters.
     * 
     */
    ...
    public static Builder builder(PolicyRuleSettingsBlockPage defaults) {
    ...
    public static final class Builder {
        ...
        private String targetUri;
        public Builder() {}
        public Builder(PolicyRuleSettingsBlockPage defaults) {
        ...
        public Builder targetUri(String targetUri) {
            if (targetUri == null) {
              throw new MissingRequiredPropertyException("PolicyRuleSettingsBlockPage", "targetUri");
            }
            this.targetUri = targetUri;
            return this;
        }
        public PolicyRuleSettingsBlockPage build() {
            final var _resultValue = new PolicyRuleSettingsBlockPage();
