...
@CustomType
public final class GetLimitsResultMatchRequest {
    /**
    ...
    private GetLimitsResultMatchRequest() {}
    /**
     * @return The HTTP methods to match. You can specify a subset (for example, `[&#39;POST&#39;,&#39;PUT&#39;]`) or all methods (`[&#39;_ALL_&#39;]`). This field is optional when creating a rate limit.
     * 
     */
    ...
    public static Builder builder(GetLimitsResultMatchRequest defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(GetLimitsResultMatchRequest defaults) {
        ...
        public Builder methods(List<String> methods) {
            if (methods == null) {
              throw new MissingRequiredPropertyException("GetLimitsResultMatchRequest", "methods");
            }
        ...
        public Builder schemes(List<String> schemes) {
            if (schemes == null) {
              throw new MissingRequiredPropertyException("GetLimitsResultMatchRequest", "schemes");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetLimitsResultMatchRequest", "url");
            }
            this.url = url;
            return this;
        }
        public GetLimitsResultMatchRequest build() {
            final var _resultValue = new GetLimitsResultMatchRequest();
