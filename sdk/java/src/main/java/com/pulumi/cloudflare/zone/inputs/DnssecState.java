...
public final class DnssecState extends com.pulumi.resources.ResourceArgs {

    public static final DnssecState Empty = new DnssecState();
    ...
    private DnssecState(DnssecState $) {
    ...
    public static Builder builder(DnssecState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DnssecState defaults) {
            $ = new DnssecState(Objects.requireNonNull(defaults));
        }
