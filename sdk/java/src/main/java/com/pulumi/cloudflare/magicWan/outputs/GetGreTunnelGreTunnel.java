...
import com.pulumi.cloudflare.magicWan.outputs.GetGreTunnelGreTunnelBgp;
import com.pulumi.cloudflare.magicWan.outputs.GetGreTunnelGreTunnelBgpStatus;
import com.pulumi.cloudflare.magicWan.outputs.GetGreTunnelGreTunnelHealthCheck;
...
@CustomType
public final class GetGreTunnelGreTunnel {
    /**
    ...
    private GetGreTunnelGreTunnelBgp bgp;
    private GetGreTunnelGreTunnelBgpStatus bgpStatus;
    /**
    ...
    private GetGreTunnelGreTunnelHealthCheck healthCheck;
    /**
     * @return Identifier
     * 
     */
    ...
    public GetGreTunnelGreTunnelBgp bgp() {
        return this.bgp;
    }
    public GetGreTunnelGreTunnelBgpStatus bgpStatus() {
    ...
    public GetGreTunnelGreTunnelHealthCheck healthCheck() {
    ...
    public static Builder builder(GetGreTunnelGreTunnel defaults) {
    ...
    public static final class Builder {
        ...
        private Integer ttl;
        public Builder() {}
        public Builder(GetGreTunnelGreTunnel defaults) {
        ...
        public Builder automaticReturnRouting(Boolean automaticReturnRouting) {
            if (automaticReturnRouting == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnel", "automaticReturnRouting");
            }
            this.automaticReturnRouting = automaticReturnRouting;
            return this;
        }
        @CustomType.Setter
        public Builder bgp(GetGreTunnelGreTunnelBgp bgp) {
            if (bgp == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnel", "bgp");
            }
            this.bgp = bgp;
            return this;
        }
        @CustomType.Setter
        public Builder bgpStatus(GetGreTunnelGreTunnelBgpStatus bgpStatus) {
            if (bgpStatus == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnel", "bgpStatus");
            }
        ...
        public Builder cloudflareGreEndpoint(String cloudflareGreEndpoint) {
            if (cloudflareGreEndpoint == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnel", "cloudflareGreEndpoint");
            }
        ...
        public Builder createdOn(String createdOn) {
            if (createdOn == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnel", "createdOn");
            }
        ...
        public Builder customerGreEndpoint(String customerGreEndpoint) {
            if (customerGreEndpoint == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnel", "customerGreEndpoint");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnel", "description");
            }
            this.description = description;
            return this;
        }
        @CustomType.Setter
        public Builder healthCheck(GetGreTunnelGreTunnelHealthCheck healthCheck) {
            if (healthCheck == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnel", "healthCheck");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnel", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder interfaceAddress(String interfaceAddress) {
            if (interfaceAddress == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnel", "interfaceAddress");
            }
        ...
        public Builder interfaceAddress6(String interfaceAddress6) {
            if (interfaceAddress6 == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnel", "interfaceAddress6");
            }
        ...
        public Builder modifiedOn(String modifiedOn) {
            if (modifiedOn == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnel", "modifiedOn");
            }
        ...
        public Builder mtu(Integer mtu) {
            if (mtu == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnel", "mtu");
            }
            this.mtu = mtu;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnel", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder ttl(Integer ttl) {
            if (ttl == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnel", "ttl");
            }
            this.ttl = ttl;
            return this;
        }
        public GetGreTunnelGreTunnel build() {
            final var _resultValue = new GetGreTunnelGreTunnel();
