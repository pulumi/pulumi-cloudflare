...
import com.pulumi.cloudflare.image.inputs.VariantVariantOptionsArgs;
...
public final class VariantVariantArgs extends com.pulumi.resources.ResourceArgs {

    public static final VariantVariantArgs Empty = new VariantVariantArgs();
     ...
     */
    @Import(name="options")
    private @Nullable Output<VariantVariantOptionsArgs> options;

    /**
     * @return Allows you to define image resizing sizes for different use cases.
     * 
     */
    public Optional<Output<VariantVariantOptionsArgs>> options() {
        return Optional.ofNullable(this.options);
    }

    private VariantVariantArgs() {}

    private VariantVariantArgs(VariantVariantArgs $) {
        this.id = $.id;
    ...
    public static Builder builder(VariantVariantArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VariantVariantArgs();
        }

        public Builder(VariantVariantArgs defaults) {
            $ = new VariantVariantArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder options(@Nullable Output<VariantVariantOptionsArgs> options) {
            $.options = options;
            return this;
        }
         ...
         * 
         */
        public Builder options(VariantVariantOptionsArgs options) {
            return options(Output.of(options));
        }

        public VariantVariantArgs build() {
            return $;
        }
    }
