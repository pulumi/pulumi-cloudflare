...
@CustomType
public final class AccessGroupRequireSaml {
    /**
    ...
    private AccessGroupRequireSaml() {}
    /**
     * @return The name of the SAML attribute.
     * 
     */
    ...
    public static Builder builder(AccessGroupRequireSaml defaults) {
    ...
    public static final class Builder {
        ...
        private String identityProviderId;
        public Builder() {}
        public Builder(AccessGroupRequireSaml defaults) {
        ...
        public Builder attributeName(String attributeName) {
            if (attributeName == null) {
              throw new MissingRequiredPropertyException("AccessGroupRequireSaml", "attributeName");
            }
        ...
        public Builder attributeValue(String attributeValue) {
            if (attributeValue == null) {
              throw new MissingRequiredPropertyException("AccessGroupRequireSaml", "attributeValue");
            }
        ...
        public Builder identityProviderId(String identityProviderId) {
            if (identityProviderId == null) {
              throw new MissingRequiredPropertyException("AccessGroupRequireSaml", "identityProviderId");
            }
