...
import com.pulumi.cloudflare.zeroTrustAccessIdentity.inputs.GetProviderFilterArgs;
...
public final class GetProviderArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filter")
    private @Nullable Output<GetProviderFilterArgs> filter;

    public Optional<Output<GetProviderFilterArgs>> filter() {
    ...
    public static final class Builder {
        ...
        public Builder filter(@Nullable Output<GetProviderFilterArgs> filter) {
            $.filter = filter;
            return this;
        }

        public Builder filter(GetProviderFilterArgs filter) {
