...
public final class GetViewsName extends com.pulumi.resources.InvokeArgs {

    public static final GetViewsName Empty = new GetViewsName();
    ...
    private GetViewsName() {}

    private GetViewsName(GetViewsName $) {
    ...
    public static Builder builder(GetViewsName defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetViewsName defaults) {
            $ = new GetViewsName(Objects.requireNonNull(defaults));
        }
