...
public final class GetWorkerVersionsResultAssetsConfig {
    ...
    public static Builder builder(GetWorkerVersionsResultAssetsConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder htmlHandling(String htmlHandling) {
            if (htmlHandling == null) {
              throw new MissingRequiredPropertyException("GetWorkerVersionsResultAssetsConfig", "htmlHandling");
            }
        ...
        public Builder notFoundHandling(String notFoundHandling) {
            if (notFoundHandling == null) {
              throw new MissingRequiredPropertyException("GetWorkerVersionsResultAssetsConfig", "notFoundHandling");
            }
        ...
        public Builder runWorkerFirsts(List<String> runWorkerFirsts) {
            if (runWorkerFirsts == null) {
              throw new MissingRequiredPropertyException("GetWorkerVersionsResultAssetsConfig", "runWorkerFirsts");
            }
