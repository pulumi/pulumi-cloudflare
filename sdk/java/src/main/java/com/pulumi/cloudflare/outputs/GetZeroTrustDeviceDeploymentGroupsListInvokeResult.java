...
import com.pulumi.cloudflare.outputs.GetZeroTrustDeviceDeploymentGroupsListResult;
...
public final class GetZeroTrustDeviceDeploymentGroupsListInvokeResult {
     ...
     * 
     */
    public List<GetZeroTrustDeviceDeploymentGroupsListResult> results() {
        return this.results;
    }
    ...
    public static Builder builder(GetZeroTrustDeviceDeploymentGroupsListInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder results(List<GetZeroTrustDeviceDeploymentGroupsListResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustDeviceDeploymentGroupsListInvokeResult", "results");
            }
            this.results = results;
            return this;
        }
        public Builder results(GetZeroTrustDeviceDeploymentGroupsListResult... results) {
