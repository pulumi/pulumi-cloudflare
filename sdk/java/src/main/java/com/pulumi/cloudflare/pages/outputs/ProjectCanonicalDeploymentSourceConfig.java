...
@CustomType
public final class ProjectCanonicalDeploymentSourceConfig {
    /**
    ...
    public static Builder builder(ProjectCanonicalDeploymentSourceConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repoName;
        public Builder() {}
        public Builder(ProjectCanonicalDeploymentSourceConfig defaults) {
        ...
        public ProjectCanonicalDeploymentSourceConfig build() {
            final var _resultValue = new ProjectCanonicalDeploymentSourceConfig();
