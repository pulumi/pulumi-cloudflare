...
public final class GetCallsSfuAppResult {
    ...
    public static Builder builder(GetCallsSfuAppResult defaults) {
    ...
    public static final class Builder {
        ...
        private String uid;
        public Builder() {}
        public Builder(GetCallsSfuAppResult defaults) {
        ...
        public Builder appId(String appId) {
            if (appId == null) {
              throw new MissingRequiredPropertyException("GetCallsSfuAppResult", "appId");
            }
            this.appId = appId;
            return this;
        }
        ...
        public Builder modified(String modified) {
            if (modified == null) {
              throw new MissingRequiredPropertyException("GetCallsSfuAppResult", "modified");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetCallsSfuAppResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder uid(String uid) {
            if (uid == null) {
              throw new MissingRequiredPropertyException("GetCallsSfuAppResult", "uid");
            }
            this.uid = uid;
            return this;
        }
        public GetCallsSfuAppResult build() {
            final var _resultValue = new GetCallsSfuAppResult();
