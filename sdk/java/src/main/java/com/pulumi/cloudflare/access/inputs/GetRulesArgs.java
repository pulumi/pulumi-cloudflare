...
public final class GetRulesArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private @Nullable Output<GetRulesConfigurationArgs> configuration;

    public Optional<Output<GetRulesConfigurationArgs>> configuration() {
    ...
    public static final class Builder {
        ...
        public Builder configuration(@Nullable Output<GetRulesConfigurationArgs> configuration) {
            $.configuration = configuration;
            return this;
        }

        public Builder configuration(GetRulesConfigurationArgs configuration) {
