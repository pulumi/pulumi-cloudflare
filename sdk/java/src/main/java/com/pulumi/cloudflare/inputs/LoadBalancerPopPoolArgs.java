...
public final class LoadBalancerPopPoolArgs extends com.pulumi.resources.ResourceArgs {

    public static final LoadBalancerPopPoolArgs Empty = new LoadBalancerPopPoolArgs();
    ...
    private LoadBalancerPopPoolArgs() {}

    private LoadBalancerPopPoolArgs(LoadBalancerPopPoolArgs $) {
    ...
    public static Builder builder(LoadBalancerPopPoolArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoadBalancerPopPoolArgs();
        }

        public Builder(LoadBalancerPopPoolArgs defaults) {
            $ = new LoadBalancerPopPoolArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LoadBalancerPopPoolArgs build() {
            if ($.poolIds == null) {
                throw new MissingRequiredPropertyException("LoadBalancerPopPoolArgs", "poolIds");
            }
            if ($.pop == null) {
                throw new MissingRequiredPropertyException("LoadBalancerPopPoolArgs", "pop");
            }
            return $;
        }
    }
