...
@CustomType
public final class TunnelConfigConfigIngressOriginRequestAccess {
    /**
    ...
    public static Builder builder(TunnelConfigConfigIngressOriginRequestAccess defaults) {
    ...
    public static final class Builder {
        ...
        public Builder audTags(List<String> audTags) {
            if (audTags == null) {
              throw new MissingRequiredPropertyException("TunnelConfigConfigIngressOriginRequestAccess", "audTags");
            }
        ...
        public TunnelConfigConfigIngressOriginRequestAccess build() {
            final var _resultValue = new TunnelConfigConfigIngressOriginRequestAccess();
