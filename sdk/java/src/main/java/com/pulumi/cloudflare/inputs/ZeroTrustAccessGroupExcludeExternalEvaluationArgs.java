...
public final class ZeroTrustAccessGroupExcludeExternalEvaluationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ZeroTrustAccessGroupExcludeExternalEvaluationArgs() {}

    private ZeroTrustAccessGroupExcludeExternalEvaluationArgs(ZeroTrustAccessGroupExcludeExternalEvaluationArgs $) {
    ...
    public static Builder builder(ZeroTrustAccessGroupExcludeExternalEvaluationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustAccessGroupExcludeExternalEvaluationArgs();
        }

        public Builder(ZeroTrustAccessGroupExcludeExternalEvaluationArgs defaults) {
        ...
        public ZeroTrustAccessGroupExcludeExternalEvaluationArgs build() {
            if ($.evaluateUrl == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessGroupExcludeExternalEvaluationArgs", "evaluateUrl");
            }
            if ($.keysUrl == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessGroupExcludeExternalEvaluationArgs", "keysUrl");
            }
            return $;
        }
    }
