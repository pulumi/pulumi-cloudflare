...
public final class GetAiSearchTokensArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static Builder builder(GetAiSearchTokensArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAiSearchTokensArgs();
        }

        public Builder(GetAiSearchTokensArgs defaults) {
