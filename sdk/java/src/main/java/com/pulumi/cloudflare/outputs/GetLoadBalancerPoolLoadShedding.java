...
@CustomType
public final class GetLoadBalancerPoolLoadShedding {
    /**
    ...
    private GetLoadBalancerPoolLoadShedding() {}
    /**
     * @return The percent of traffic to shed from the pool, according to the default policy. Applies to new sessions and traffic without session affinity.
     * 
     */
    ...
    public static Builder builder(GetLoadBalancerPoolLoadShedding defaults) {
    ...
    public static final class Builder {
        ...
        private String sessionPolicy;
        public Builder() {}
        public Builder(GetLoadBalancerPoolLoadShedding defaults) {
        ...
        public Builder defaultPercent(Double defaultPercent) {
            if (defaultPercent == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerPoolLoadShedding", "defaultPercent");
            }
        ...
        public Builder defaultPolicy(String defaultPolicy) {
            if (defaultPolicy == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerPoolLoadShedding", "defaultPolicy");
            }
        ...
        public Builder sessionPercent(Double sessionPercent) {
            if (sessionPercent == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerPoolLoadShedding", "sessionPercent");
            }
        ...
        public Builder sessionPolicy(String sessionPolicy) {
            if (sessionPolicy == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerPoolLoadShedding", "sessionPolicy");
            }
            this.sessionPolicy = sessionPolicy;
            return this;
        }
        public GetLoadBalancerPoolLoadShedding build() {
            final var _resultValue = new GetLoadBalancerPoolLoadShedding();
