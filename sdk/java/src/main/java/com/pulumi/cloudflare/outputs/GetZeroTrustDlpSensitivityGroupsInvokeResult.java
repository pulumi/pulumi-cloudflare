...
import com.pulumi.cloudflare.outputs.GetZeroTrustDlpSensitivityGroupsResult;
...
public final class GetZeroTrustDlpSensitivityGroupsInvokeResult {
     ...
     * 
     */
    public List<GetZeroTrustDlpSensitivityGroupsResult> results() {
        return this.results;
    }
    ...
    public static Builder builder(GetZeroTrustDlpSensitivityGroupsInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder results(List<GetZeroTrustDlpSensitivityGroupsResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustDlpSensitivityGroupsInvokeResult", "results");
            }
            this.results = results;
            return this;
        }
        public Builder results(GetZeroTrustDlpSensitivityGroupsResult... results) {
