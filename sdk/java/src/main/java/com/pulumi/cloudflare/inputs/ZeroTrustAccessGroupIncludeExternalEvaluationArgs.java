...
public final class ZeroTrustAccessGroupIncludeExternalEvaluationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ZeroTrustAccessGroupIncludeExternalEvaluationArgs build() {
            if ($.evaluateUrl == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessGroupIncludeExternalEvaluationArgs", "evaluateUrl");
            }
            if ($.keysUrl == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessGroupIncludeExternalEvaluationArgs", "keysUrl");
            }
            return $;
        }
    }
