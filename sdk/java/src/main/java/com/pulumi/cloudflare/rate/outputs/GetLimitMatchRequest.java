...
@CustomType
public final class GetLimitMatchRequest {
    /**
    ...
    public static Builder builder(GetLimitMatchRequest defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(GetLimitMatchRequest defaults) {
        ...
        public Builder methods(List<String> methods) {
            if (methods == null) {
              throw new MissingRequiredPropertyException("GetLimitMatchRequest", "methods");
            }
        ...
        public Builder schemes(List<String> schemes) {
            if (schemes == null) {
              throw new MissingRequiredPropertyException("GetLimitMatchRequest", "schemes");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetLimitMatchRequest", "url");
            }
            this.url = url;
            return this;
        }
        public GetLimitMatchRequest build() {
            final var _resultValue = new GetLimitMatchRequest();
