...
public final class SettingsSettingsExtendedEmailMatchingArgs extends com.pulumi.resources.ResourceArgs {

    public static final SettingsSettingsExtendedEmailMatchingArgs Empty = new SettingsSettingsExtendedEmailMatchingArgs();
    ...
    private SettingsSettingsExtendedEmailMatchingArgs() {}

    private SettingsSettingsExtendedEmailMatchingArgs(SettingsSettingsExtendedEmailMatchingArgs $) {
    ...
    public static Builder builder(SettingsSettingsExtendedEmailMatchingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SettingsSettingsExtendedEmailMatchingArgs();
        }

        public Builder(SettingsSettingsExtendedEmailMatchingArgs defaults) {
            $ = new SettingsSettingsExtendedEmailMatchingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SettingsSettingsExtendedEmailMatchingArgs build() {
            return $;
        }
    }
