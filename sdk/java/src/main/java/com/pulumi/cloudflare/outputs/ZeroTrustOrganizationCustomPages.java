...
@CustomType
public final class ZeroTrustOrganizationCustomPages {
    /**
    ...
    public static Builder builder(ZeroTrustOrganizationCustomPages defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String identityDenied;
        public Builder() {}
        public Builder(ZeroTrustOrganizationCustomPages defaults) {
        ...
        public ZeroTrustOrganizationCustomPages build() {
            final var _resultValue = new ZeroTrustOrganizationCustomPages();
