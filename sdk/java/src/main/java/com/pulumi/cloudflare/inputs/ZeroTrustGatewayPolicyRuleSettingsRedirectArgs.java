...
public final class ZeroTrustGatewayPolicyRuleSettingsRedirectArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZeroTrustGatewayPolicyRuleSettingsRedirectArgs Empty = new ZeroTrustGatewayPolicyRuleSettingsRedirectArgs();
    ...
    private ZeroTrustGatewayPolicyRuleSettingsRedirectArgs() {}

    private ZeroTrustGatewayPolicyRuleSettingsRedirectArgs(ZeroTrustGatewayPolicyRuleSettingsRedirectArgs $) {
    ...
    public static Builder builder(ZeroTrustGatewayPolicyRuleSettingsRedirectArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustGatewayPolicyRuleSettingsRedirectArgs();
        }

        public Builder(ZeroTrustGatewayPolicyRuleSettingsRedirectArgs defaults) {
            $ = new ZeroTrustGatewayPolicyRuleSettingsRedirectArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ZeroTrustGatewayPolicyRuleSettingsRedirectArgs build() {
            if ($.targetUri == null) {
                throw new MissingRequiredPropertyException("ZeroTrustGatewayPolicyRuleSettingsRedirectArgs", "targetUri");
            }
            return $;
        }
    }
