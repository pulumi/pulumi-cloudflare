...
public final class RuleActionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<RuleActionResponseArgs> response;
     ...
     * 
     */
    public Optional<Output<RuleActionResponseArgs>> response() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder response(@Nullable Output<RuleActionResponseArgs> response) {
            $.response = response;
            return this;
        }
         ...
         * 
         */
        public Builder response(RuleActionResponseArgs response) {
