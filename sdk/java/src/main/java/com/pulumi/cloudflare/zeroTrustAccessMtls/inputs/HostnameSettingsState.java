...
public final class HostnameSettingsState extends com.pulumi.resources.ResourceArgs {

    public static final HostnameSettingsState Empty = new HostnameSettingsState();
    ...
    private @Nullable Output<List<HostnameSettingsSettingArgs>> settings;

    public Optional<Output<List<HostnameSettingsSettingArgs>>> settings() {
    ...
    private HostnameSettingsState() {}

    private HostnameSettingsState(HostnameSettingsState $) {
    ...
    public static Builder builder(HostnameSettingsState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HostnameSettingsState();
        }

        public Builder(HostnameSettingsState defaults) {
            $ = new HostnameSettingsState(Objects.requireNonNull(defaults));
        }
        ...
        public Builder settings(@Nullable Output<List<HostnameSettingsSettingArgs>> settings) {
            $.settings = settings;
            return this;
        }
        ...
        public HostnameSettingsState build() {
            return $;
        }
    }
