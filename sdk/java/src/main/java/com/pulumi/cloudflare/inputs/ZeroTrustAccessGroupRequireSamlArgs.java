...
public final class ZeroTrustAccessGroupRequireSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZeroTrustAccessGroupRequireSamlArgs Empty = new ZeroTrustAccessGroupRequireSamlArgs();
    ...
    private ZeroTrustAccessGroupRequireSamlArgs() {}

    private ZeroTrustAccessGroupRequireSamlArgs(ZeroTrustAccessGroupRequireSamlArgs $) {
    ...
    public static Builder builder(ZeroTrustAccessGroupRequireSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustAccessGroupRequireSamlArgs();
        }

        public Builder(ZeroTrustAccessGroupRequireSamlArgs defaults) {
            $ = new ZeroTrustAccessGroupRequireSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ZeroTrustAccessGroupRequireSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessGroupRequireSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessGroupRequireSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessGroupRequireSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
