...
import com.pulumi.cloudflare.workersScript.WorkersScriptArgs;
import com.pulumi.cloudflare.workersScript.inputs.WorkersScriptState;
import com.pulumi.cloudflare.workersScript.outputs.WorkersScriptAnnotations;
import com.pulumi.cloudflare.workersScript.outputs.WorkersScriptAssets;
import com.pulumi.cloudflare.workersScript.outputs.WorkersScriptBinding;
import com.pulumi.cloudflare.workersScript.outputs.WorkersScriptCacheOptions;
import com.pulumi.cloudflare.workersScript.outputs.WorkersScriptExports;
import com.pulumi.cloudflare.workersScript.outputs.WorkersScriptLimits;
import com.pulumi.cloudflare.workersScript.outputs.WorkersScriptMigrations;
import com.pulumi.cloudflare.workersScript.outputs.WorkersScriptNamedHandler;
import com.pulumi.cloudflare.workersScript.outputs.WorkersScriptObservability;
import com.pulumi.cloudflare.workersScript.outputs.WorkersScriptPackageDependency;
import com.pulumi.cloudflare.workersScript.outputs.WorkersScriptPlacement;
import com.pulumi.cloudflare.workersScript.outputs.WorkersScriptTailConsumer;
 ...
 * 
 */
@ResourceType(type="cloudflare:workersScript/workersScript:WorkersScript")
public class WorkersScript extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="annotations", refs={WorkersScriptAnnotations.class}, tree="[0]")
    private Output<WorkersScriptAnnotations> annotations;

    /**
     * @return Annotations for the version created by this upload.
     * 
     */
    public Output<WorkersScriptAnnotations> annotations() {
    ...
    public WorkersScript(java.lang.String name, WorkersScriptArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:workersScript/workersScript:WorkersScript", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private WorkersScript(java.lang.String name, Output<java.lang.String> id, @Nullable WorkersScriptState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:workersScript/workersScript:WorkersScript", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/workersScript:WorkersScript").build()),
