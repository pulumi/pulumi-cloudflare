...
@CustomType
public final class GetConfigsResultOrigin {
    /**
    ...
    private GetConfigsResultOrigin() {}
    /**
     * @return Defines the Client ID of the Access token to use when connecting to the origin database.
     * 
     */
    ...
    public static Builder builder(GetConfigsResultOrigin defaults) {
    ...
    public static final class Builder {
        ...
        private String user;
        public Builder() {}
        public Builder(GetConfigsResultOrigin defaults) {
        ...
        public Builder accessClientId(String accessClientId) {
            if (accessClientId == null) {
              throw new MissingRequiredPropertyException("GetConfigsResultOrigin", "accessClientId");
            }
        ...
        public Builder accessClientSecret(String accessClientSecret) {
            if (accessClientSecret == null) {
              throw new MissingRequiredPropertyException("GetConfigsResultOrigin", "accessClientSecret");
            }
        ...
        public Builder database(String database) {
            if (database == null) {
              throw new MissingRequiredPropertyException("GetConfigsResultOrigin", "database");
            }
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("GetConfigsResultOrigin", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("GetConfigsResultOrigin", "password");
            }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetConfigsResultOrigin", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder scheme(String scheme) {
            if (scheme == null) {
              throw new MissingRequiredPropertyException("GetConfigsResultOrigin", "scheme");
            }
            this.scheme = scheme;
            return this;
        }
        ...
        public Builder serviceId(String serviceId) {
            if (serviceId == null) {
              throw new MissingRequiredPropertyException("GetConfigsResultOrigin", "serviceId");
            }
        ...
        public Builder user(String user) {
            if (user == null) {
              throw new MissingRequiredPropertyException("GetConfigsResultOrigin", "user");
            }
            this.user = user;
            return this;
        }
        public GetConfigsResultOrigin build() {
            final var _resultValue = new GetConfigsResultOrigin();
