...
public final class GroupRequireExternalEvaluationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupRequireExternalEvaluationArgs Empty = new GroupRequireExternalEvaluationArgs();
    ...
    private GroupRequireExternalEvaluationArgs() {}

    private GroupRequireExternalEvaluationArgs(GroupRequireExternalEvaluationArgs $) {
    ...
    public static Builder builder(GroupRequireExternalEvaluationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupRequireExternalEvaluationArgs();
        }

        public Builder(GroupRequireExternalEvaluationArgs defaults) {
            $ = new GroupRequireExternalEvaluationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupRequireExternalEvaluationArgs build() {
            if ($.evaluateUrl == null) {
                throw new MissingRequiredPropertyException("GroupRequireExternalEvaluationArgs", "evaluateUrl");
            }
            if ($.keysUrl == null) {
                throw new MissingRequiredPropertyException("GroupRequireExternalEvaluationArgs", "keysUrl");
            }
            return $;
        }
    }
