...
@CustomType
public final class GetOrganizationLoginDesign {
    /**
    ...
    private GetOrganizationLoginDesign() {}
    /**
     * @return The background color on your login page.
     * 
     */
    ...
    public static Builder builder(GetOrganizationLoginDesign defaults) {
    ...
    public static final class Builder {
        ...
        private String textColor;
        public Builder() {}
        public Builder(GetOrganizationLoginDesign defaults) {
        ...
        public Builder backgroundColor(String backgroundColor) {
            if (backgroundColor == null) {
              throw new MissingRequiredPropertyException("GetOrganizationLoginDesign", "backgroundColor");
            }
        ...
        public Builder footerText(String footerText) {
            if (footerText == null) {
              throw new MissingRequiredPropertyException("GetOrganizationLoginDesign", "footerText");
            }
        ...
        public Builder headerText(String headerText) {
            if (headerText == null) {
              throw new MissingRequiredPropertyException("GetOrganizationLoginDesign", "headerText");
            }
        ...
        public Builder logoPath(String logoPath) {
            if (logoPath == null) {
              throw new MissingRequiredPropertyException("GetOrganizationLoginDesign", "logoPath");
            }
        ...
        public Builder textColor(String textColor) {
            if (textColor == null) {
              throw new MissingRequiredPropertyException("GetOrganizationLoginDesign", "textColor");
            }
            this.textColor = textColor;
            return this;
        }
        public GetOrganizationLoginDesign build() {
            final var _resultValue = new GetOrganizationLoginDesign();
