...
public final class ConfigCachingArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConfigCachingArgs Empty = new ConfigCachingArgs();
    ...
    private ConfigCachingArgs() {}

    private ConfigCachingArgs(ConfigCachingArgs $) {
    ...
    public static Builder builder(ConfigCachingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConfigCachingArgs();
        }

        public Builder(ConfigCachingArgs defaults) {
            $ = new ConfigCachingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ConfigCachingArgs build() {
            return $;
        }
    }
