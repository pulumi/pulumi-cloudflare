...
import com.pulumi.cloudflare.worker.outputs.GetVersionMigrationsStepRenamedClass;
import com.pulumi.cloudflare.worker.outputs.GetVersionMigrationsStepTransferredClass;
...
@CustomType
public final class GetVersionMigrationsStep {
    /**
     ...
     * 
     */
    private List<GetVersionMigrationsStepRenamedClass> renamedClasses;
    /**
     ...
     * 
     */
    private List<GetVersionMigrationsStepTransferredClass> transferredClasses;

    private GetVersionMigrationsStep() {}
    /**
     * @return A list of classes to delete Durable Object namespaces from.
     * 
     */
     ...
     * 
     */
    public List<GetVersionMigrationsStepRenamedClass> renamedClasses() {
     ...
     * 
     */
    public List<GetVersionMigrationsStepTransferredClass> transferredClasses() {
    ...
    public static Builder builder(GetVersionMigrationsStep defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetVersionMigrationsStepTransferredClass> transferredClasses;
        public Builder() {}
        public Builder(GetVersionMigrationsStep defaults) {
        ...
        public Builder deletedClasses(List<String> deletedClasses) {
            if (deletedClasses == null) {
              throw new MissingRequiredPropertyException("GetVersionMigrationsStep", "deletedClasses");
            }
        ...
        public Builder newClasses(List<String> newClasses) {
            if (newClasses == null) {
              throw new MissingRequiredPropertyException("GetVersionMigrationsStep", "newClasses");
            }
        ...
        public Builder newSqliteClasses(List<String> newSqliteClasses) {
            if (newSqliteClasses == null) {
              throw new MissingRequiredPropertyException("GetVersionMigrationsStep", "newSqliteClasses");
            }
        ...
        @CustomType.Setter
        public Builder renamedClasses(List<GetVersionMigrationsStepRenamedClass> renamedClasses) {
            if (renamedClasses == null) {
              throw new MissingRequiredPropertyException("GetVersionMigrationsStep", "renamedClasses");
            }
            this.renamedClasses = renamedClasses;
            return this;
        }
        public Builder renamedClasses(GetVersionMigrationsStepRenamedClass... renamedClasses) {
            return renamedClasses(List.of(renamedClasses));
        }
        @CustomType.Setter
        public Builder transferredClasses(List<GetVersionMigrationsStepTransferredClass> transferredClasses) {
            if (transferredClasses == null) {
              throw new MissingRequiredPropertyException("GetVersionMigrationsStep", "transferredClasses");
            }
            this.transferredClasses = transferredClasses;
            return this;
        }
        public Builder transferredClasses(GetVersionMigrationsStepTransferredClass... transferredClasses) {
            return transferredClasses(List.of(transferredClasses));
        }
        public GetVersionMigrationsStep build() {
            final var _resultValue = new GetVersionMigrationsStep();
