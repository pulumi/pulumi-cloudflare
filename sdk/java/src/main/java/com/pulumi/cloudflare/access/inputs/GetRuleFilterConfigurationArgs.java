...
public final class GetRuleFilterConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRuleFilterConfigurationArgs Empty = new GetRuleFilterConfigurationArgs();
    ...
    private GetRuleFilterConfigurationArgs() {}

    private GetRuleFilterConfigurationArgs(GetRuleFilterConfigurationArgs $) {
        this.target = $.target;
        this.value = $.value;
    }
    ...
    public static Builder builder(GetRuleFilterConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRuleFilterConfigurationArgs();
        }

        public Builder(GetRuleFilterConfigurationArgs defaults) {
            $ = new GetRuleFilterConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRuleFilterConfigurationArgs build() {
            return $;
        }
    }
