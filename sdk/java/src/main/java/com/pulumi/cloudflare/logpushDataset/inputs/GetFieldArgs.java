...
public final class GetFieldArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetFieldArgs Empty = new GetFieldArgs();
    ...
    private GetFieldArgs() {}

    private GetFieldArgs(GetFieldArgs $) {
    ...
    public static Builder builder(GetFieldArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetFieldArgs defaults) {
            $ = new GetFieldArgs(Objects.requireNonNull(defaults));
        }
