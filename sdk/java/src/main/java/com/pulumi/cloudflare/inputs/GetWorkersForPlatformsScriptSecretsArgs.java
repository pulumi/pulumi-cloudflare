...
public final class GetWorkersForPlatformsScriptSecretsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetWorkersForPlatformsScriptSecretsArgs Empty = new GetWorkersForPlatformsScriptSecretsArgs();
    ...
    private GetWorkersForPlatformsScriptSecretsArgs() {}

    private GetWorkersForPlatformsScriptSecretsArgs(GetWorkersForPlatformsScriptSecretsArgs $) {
    ...
    public static Builder builder(GetWorkersForPlatformsScriptSecretsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetWorkersForPlatformsScriptSecretsArgs();
        }

        public Builder(GetWorkersForPlatformsScriptSecretsArgs defaults) {
            $ = new GetWorkersForPlatformsScriptSecretsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetWorkersForPlatformsScriptSecretsArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetWorkersForPlatformsScriptSecretsArgs", "accountId");
            }
            if ($.dispatchNamespace == null) {
                throw new MissingRequiredPropertyException("GetWorkersForPlatformsScriptSecretsArgs", "dispatchNamespace");
            }
            if ($.scriptName == null) {
                throw new MissingRequiredPropertyException("GetWorkersForPlatformsScriptSecretsArgs", "scriptName");
            }
            return $;
        }
    }
