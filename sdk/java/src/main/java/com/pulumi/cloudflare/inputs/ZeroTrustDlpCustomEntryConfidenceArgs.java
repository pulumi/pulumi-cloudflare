...
public final class ZeroTrustDlpCustomEntryConfidenceArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZeroTrustDlpCustomEntryConfidenceArgs Empty = new ZeroTrustDlpCustomEntryConfidenceArgs();
    ...
    private ZeroTrustDlpCustomEntryConfidenceArgs() {}

    private ZeroTrustDlpCustomEntryConfidenceArgs(ZeroTrustDlpCustomEntryConfidenceArgs $) {
    ...
    public static Builder builder(ZeroTrustDlpCustomEntryConfidenceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustDlpCustomEntryConfidenceArgs();
        }

        public Builder(ZeroTrustDlpCustomEntryConfidenceArgs defaults) {
            $ = new ZeroTrustDlpCustomEntryConfidenceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ZeroTrustDlpCustomEntryConfidenceArgs build() {
            return $;
        }
    }
