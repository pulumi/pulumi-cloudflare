...
@CustomType
public final class LiveInputSrt {
    /**
    ...
    public static Builder builder(LiveInputSrt defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String url;
        public Builder() {}
        public Builder(LiveInputSrt defaults) {
        ...
        public LiveInputSrt build() {
            final var _resultValue = new LiveInputSrt();
