...
public final class ApplicationEdgeIpsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationEdgeIpsArgs Empty = new ApplicationEdgeIpsArgs();
    ...
    private ApplicationEdgeIpsArgs() {}

    private ApplicationEdgeIpsArgs(ApplicationEdgeIpsArgs $) {
    ...
    public static Builder builder(ApplicationEdgeIpsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationEdgeIpsArgs();
        }

        public Builder(ApplicationEdgeIpsArgs defaults) {
            $ = new ApplicationEdgeIpsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApplicationEdgeIpsArgs build() {
            return $;
        }
    }
