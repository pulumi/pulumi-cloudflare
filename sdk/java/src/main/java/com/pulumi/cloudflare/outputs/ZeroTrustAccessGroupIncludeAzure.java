...
@CustomType
public final class ZeroTrustAccessGroupIncludeAzure {
    /**
    ...
    private ZeroTrustAccessGroupIncludeAzure() {}
    /**
     * @return The ID of the Azure Identity provider.
     * 
     */
    ...
    public static Builder builder(ZeroTrustAccessGroupIncludeAzure defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> ids;
        public Builder() {}
        public Builder(ZeroTrustAccessGroupIncludeAzure defaults) {
        ...
        public ZeroTrustAccessGroupIncludeAzure build() {
            final var _resultValue = new ZeroTrustAccessGroupIncludeAzure();
