...
import com.pulumi.cloudflare.zeroTrustDns.outputs.GetLocationsResultEndpoints;
import com.pulumi.cloudflare.zeroTrustDns.outputs.GetLocationsResultMaxTtl;
import com.pulumi.cloudflare.zeroTrustDns.outputs.GetLocationsResultNetwork;
...
public final class GetLocationsResult {
     ...
     * 
     */
    private GetLocationsResultEndpoints endpoints;
    private String id;
    /**
     ...
     * 
     */
    private GetLocationsResultMaxTtl maxTtl;
    /**
     ...
     * 
     */
    private List<GetLocationsResultNetwork> networks;
     ...
     * 
     */
    public GetLocationsResultEndpoints endpoints() {
     ...
     * 
     */
    public GetLocationsResultMaxTtl maxTtl() {
        return this.maxTtl;
    }
    /**
     * @return Specify the location name.
     ...
     * 
     */
    public List<GetLocationsResultNetwork> networks() {
    ...
    public static final class Builder {
        ...
        public Builder clientDefault(Boolean clientDefault) {
            if (clientDefault == null) {
              throw new MissingRequiredPropertyException("GetLocationsResult", "clientDefault");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetLocationsResult", "createdAt");
            }
        ...
        public Builder dnsDestinationIpsId(String dnsDestinationIpsId) {
            if (dnsDestinationIpsId == null) {
              throw new MissingRequiredPropertyException("GetLocationsResult", "dnsDestinationIpsId");
            }
        ...
        public Builder dnsDestinationIpv6BlockId(String dnsDestinationIpv6BlockId) {
            if (dnsDestinationIpv6BlockId == null) {
              throw new MissingRequiredPropertyException("GetLocationsResult", "dnsDestinationIpv6BlockId");
            }
        ...
        public Builder dohSubdomain(String dohSubdomain) {
            if (dohSubdomain == null) {
              throw new MissingRequiredPropertyException("GetLocationsResult", "dohSubdomain");
            }
        ...
        public Builder ecsSupport(Boolean ecsSupport) {
            if (ecsSupport == null) {
              throw new MissingRequiredPropertyException("GetLocationsResult", "ecsSupport");
            }
            this.ecsSupport = ecsSupport;
            return this;
        }
        @CustomType.Setter
        public Builder endpoints(GetLocationsResultEndpoints endpoints) {
            if (endpoints == null) {
              throw new MissingRequiredPropertyException("GetLocationsResult", "endpoints");
            }
        ...
        public Builder ip(String ip) {
            if (ip == null) {
              throw new MissingRequiredPropertyException("GetLocationsResult", "ip");
            }
            this.ip = ip;
            return this;
        }
        ...
        public Builder ipv4Destination(String ipv4Destination) {
            if (ipv4Destination == null) {
              throw new MissingRequiredPropertyException("GetLocationsResult", "ipv4Destination");
            }
        ...
        public Builder ipv4DestinationBackup(String ipv4DestinationBackup) {
            if (ipv4DestinationBackup == null) {
              throw new MissingRequiredPropertyException("GetLocationsResult", "ipv4DestinationBackup");
            }
            this.ipv4DestinationBackup = ipv4DestinationBackup;
            return this;
        }
        @CustomType.Setter
        public Builder maxTtl(GetLocationsResultMaxTtl maxTtl) {
            if (maxTtl == null) {
              throw new MissingRequiredPropertyException("GetLocationsResult", "maxTtl");
            }
            this.maxTtl = maxTtl;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetLocationsResult", "name");
            }
            this.name = name;
            return this;
        }
        @CustomType.Setter
        public Builder networks(List<GetLocationsResultNetwork> networks) {
            if (networks == null) {
              throw new MissingRequiredPropertyException("GetLocationsResult", "networks");
            }
            this.networks = networks;
            return this;
        }
        public Builder networks(GetLocationsResultNetwork... networks) {
            return networks(List.of(networks));
        }
        @CustomType.Setter
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetLocationsResult", "updatedAt");
            }
