...
public final class MemberUserArgs extends com.pulumi.resources.ResourceArgs {

    public static final MemberUserArgs Empty = new MemberUserArgs();
    ...
    private MemberUserArgs() {}

    private MemberUserArgs(MemberUserArgs $) {
        this.email = $.email;
    ...
    public static Builder builder(MemberUserArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(MemberUserArgs defaults) {
            $ = new MemberUserArgs(Objects.requireNonNull(defaults));
        }
