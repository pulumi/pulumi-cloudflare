...
@CustomType
public final class VersionAssetsConfig {
    /**
    ...
    public static Builder builder(VersionAssetsConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Object runWorkerFirst;
        public Builder() {}
        public Builder(VersionAssetsConfig defaults) {
        ...
        public VersionAssetsConfig build() {
            final var _resultValue = new VersionAssetsConfig();
