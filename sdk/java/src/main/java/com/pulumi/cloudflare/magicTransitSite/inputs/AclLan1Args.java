...
public final class AclLan1Args extends com.pulumi.resources.ResourceArgs {

    public static final AclLan1Args Empty = new AclLan1Args();
    ...
    private AclLan1Args(AclLan1Args $) {
        this.lanId = $.lanId;
    ...
    public static Builder builder(AclLan1Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AclLan1Args defaults) {
            $ = new AclLan1Args(Objects.requireNonNull(defaults));
        }
        ...
        public AclLan1Args build() {
            if ($.lanId == null) {
                throw new MissingRequiredPropertyException("AclLan1Args", "lanId");
            }
            return $;
        }
    }
