...
public final class TeamsRuleRuleSettingsDnsResolversIpv6 {
    ...
    public static Builder builder(TeamsRuleRuleSettingsDnsResolversIpv6 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vnetId;
        public Builder() {}
        public Builder(TeamsRuleRuleSettingsDnsResolversIpv6 defaults) {
        ...
        public Builder ip(String ip) {
            if (ip == null) {
              throw new MissingRequiredPropertyException("TeamsRuleRuleSettingsDnsResolversIpv6", "ip");
            }
            this.ip = ip;
            return this;
        }
        ...
        public TeamsRuleRuleSettingsDnsResolversIpv6 build() {
            final var _resultValue = new TeamsRuleRuleSettingsDnsResolversIpv6();
            _resultValue.ip = ip;
