...
@CustomType
public final class MagicTransitSiteAclLan2 {
    /**
    ...
    private MagicTransitSiteAclLan2() {}
    /**
     * @return The identifier for the LAN you want to create an ACL policy with.
     * 
     */
    ...
    public static Builder builder(MagicTransitSiteAclLan2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> subnets;
        public Builder() {}
        public Builder(MagicTransitSiteAclLan2 defaults) {
        ...
        public Builder lanId(String lanId) {
            if (lanId == null) {
              throw new MissingRequiredPropertyException("MagicTransitSiteAclLan2", "lanId");
            }
            this.lanId = lanId;
            return this;
        }
        ...
        public MagicTransitSiteAclLan2 build() {
            final var _resultValue = new MagicTransitSiteAclLan2();
