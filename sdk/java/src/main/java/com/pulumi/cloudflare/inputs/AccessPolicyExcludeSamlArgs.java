    ...
    public static final class Builder {
        ...
        public AccessPolicyExcludeSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("AccessPolicyExcludeSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("AccessPolicyExcludeSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("AccessPolicyExcludeSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
