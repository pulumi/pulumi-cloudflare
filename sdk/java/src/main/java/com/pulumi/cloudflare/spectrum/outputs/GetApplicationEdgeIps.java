...
@CustomType
public final class GetApplicationEdgeIps {
    /**
    ...
    public static Builder builder(GetApplicationEdgeIps defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetApplicationEdgeIps defaults) {
        ...
        public Builder connectivity(String connectivity) {
            if (connectivity == null) {
              throw new MissingRequiredPropertyException("GetApplicationEdgeIps", "connectivity");
            }
        ...
        public Builder ips(List<String> ips) {
            if (ips == null) {
              throw new MissingRequiredPropertyException("GetApplicationEdgeIps", "ips");
            }
            this.ips = ips;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetApplicationEdgeIps", "type");
            }
            this.type = type;
            return this;
        }
        public GetApplicationEdgeIps build() {
            final var _resultValue = new GetApplicationEdgeIps();
