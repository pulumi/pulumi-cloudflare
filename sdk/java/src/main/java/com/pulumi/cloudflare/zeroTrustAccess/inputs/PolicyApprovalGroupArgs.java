...
public final class PolicyApprovalGroupArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyApprovalGroupArgs Empty = new PolicyApprovalGroupArgs();
    ...
    private PolicyApprovalGroupArgs() {}

    private PolicyApprovalGroupArgs(PolicyApprovalGroupArgs $) {
    ...
    public static Builder builder(PolicyApprovalGroupArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyApprovalGroupArgs();
        }

        public Builder(PolicyApprovalGroupArgs defaults) {
            $ = new PolicyApprovalGroupArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyApprovalGroupArgs build() {
            if ($.approvalsNeeded == null) {
                throw new MissingRequiredPropertyException("PolicyApprovalGroupArgs", "approvalsNeeded");
            }
            return $;
        }
    }
