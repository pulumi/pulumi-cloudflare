...
import com.pulumi.cloudflare.outputs.ZoneSettingsOverrideInitialSettingAegis;
import com.pulumi.cloudflare.outputs.ZoneSettingsOverrideInitialSettingMinify;
import com.pulumi.cloudflare.outputs.ZoneSettingsOverrideInitialSettingMobileRedirect;
import com.pulumi.cloudflare.outputs.ZoneSettingsOverrideInitialSettingNel;
import com.pulumi.cloudflare.outputs.ZoneSettingsOverrideInitialSettingSecurityHeader;
...
public final class ZoneSettingsOverrideInitialSetting {
    private @Nullable ZoneSettingsOverrideInitialSettingAegis aegis;
    ...
    private @Nullable ZoneSettingsOverrideInitialSettingMinify minify;
     ...
     */
    @Deprecated /* Mobile redirects has been deprecated and disabled in favour of [Single Redirects](https://developers.cloudflare.com/rules/url-forwarding/single-redirects/) and are no longer configurable using the API. Refer to [Perform mobile redirects](https://developers.cloudflare.com/rules/url-forwarding/single-redirects/examples/#perform-mobile-redirects) for examples of performing mobile redirects with Single Redirects. */
    private @Nullable ZoneSettingsOverrideInitialSettingMobileRedirect mobileRedirect;
    private @Nullable ZoneSettingsOverrideInitialSettingNel nel;
    ...
    public Optional<ZoneSettingsOverrideInitialSettingAegis> aegis() {
    ...
    public Optional<ZoneSettingsOverrideInitialSettingMinify> minify() {
     ...
     */
    @Deprecated /* Mobile redirects has been deprecated and disabled in favour of [Single Redirects](https://developers.cloudflare.com/rules/url-forwarding/single-redirects/) and are no longer configurable using the API. Refer to [Perform mobile redirects](https://developers.cloudflare.com/rules/url-forwarding/single-redirects/examples/#perform-mobile-redirects) for examples of performing mobile redirects with Single Redirects. */
    public Optional<ZoneSettingsOverrideInitialSettingMobileRedirect> mobileRedirect() {
        return Optional.ofNullable(this.mobileRedirect);
    }
    public Optional<ZoneSettingsOverrideInitialSettingNel> nel() {
    ...
    public Optional<ZoneSettingsOverrideInitialSettingSecurityHeader> securityHeader() {
    ...
    public static Builder builder(ZoneSettingsOverrideInitialSetting defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String zeroRtt;
        public Builder() {}
        public Builder(ZoneSettingsOverrideInitialSetting defaults) {
        ...
        @CustomType.Setter
        public Builder aegis(@Nullable ZoneSettingsOverrideInitialSettingAegis aegis) {
        ...
        @CustomType.Setter
        public Builder minify(@Nullable ZoneSettingsOverrideInitialSettingMinify minify) {
        ...
        @CustomType.Setter
        public Builder mobileRedirect(@Nullable ZoneSettingsOverrideInitialSettingMobileRedirect mobileRedirect) {

            this.mobileRedirect = mobileRedirect;
            return this;
        }
        @CustomType.Setter
        public Builder nel(@Nullable ZoneSettingsOverrideInitialSettingNel nel) {
        ...
        @CustomType.Setter
        public Builder securityHeader(@Nullable ZoneSettingsOverrideInitialSettingSecurityHeader securityHeader) {
        ...
        public ZoneSettingsOverrideInitialSetting build() {
            final var _resultValue = new ZoneSettingsOverrideInitialSetting();
