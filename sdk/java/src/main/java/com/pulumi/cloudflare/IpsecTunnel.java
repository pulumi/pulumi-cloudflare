...
public class IpsecTunnel extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="allowNullCipher", type=Boolean.class, parameters={})
     ...
     * 
     */
    @Export(name="cloudflareEndpoint", type=String.class, parameters={})
     ...
     * 
     */
    @Export(name="customerEndpoint", type=String.class, parameters={})
     ...
     * 
     */
    @Export(name="fqdnId", type=String.class, parameters={})
     ...
     * 
     */
    @Export(name="hexId", type=String.class, parameters={})
