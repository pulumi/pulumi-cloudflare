...
import com.pulumi.cloudflare.outputs.ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestAccess;
import com.pulumi.cloudflare.outputs.ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestIpRule;
...
@CustomType
public final class ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequest {
    /**
     * @return Access rules for the ingress service.
     * 
     */
    private @Nullable ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestAccess access;
    /**
     ...
     * 
     */
    private @Nullable List<ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestIpRule> ipRules;
    /**
     ...
     * 
     */
    public Optional<ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestAccess> access() {
     ...
     * 
     */
    public List<ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestIpRule> ipRules() {
    ...
    public static Builder builder(ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequest defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tlsTimeout;
        public Builder() {}
        public Builder(ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequest defaults) {
        ...
        @CustomType.Setter
        public Builder access(@Nullable ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestAccess access) {
        ...
        @CustomType.Setter
        public Builder ipRules(@Nullable List<ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestIpRule> ipRules) {

            this.ipRules = ipRules;
            return this;
        }
        public Builder ipRules(ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestIpRule... ipRules) {
        ...
        public ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequest build() {
            final var _resultValue = new ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequest();
