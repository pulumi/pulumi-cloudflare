...
@CustomType
public final class LiveInputRecording {
    /**
    ...
    public static Builder builder(LiveInputRecording defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer timeoutSeconds;
        public Builder() {}
        public Builder(LiveInputRecording defaults) {
        ...
        public LiveInputRecording build() {
            final var _resultValue = new LiveInputRecording();
