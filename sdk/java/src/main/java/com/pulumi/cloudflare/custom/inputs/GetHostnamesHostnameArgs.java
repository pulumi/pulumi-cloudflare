...
public final class GetHostnamesHostnameArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetHostnamesHostnameArgs Empty = new GetHostnamesHostnameArgs();
    ...
    private GetHostnamesHostnameArgs() {}

    private GetHostnamesHostnameArgs(GetHostnamesHostnameArgs $) {
    ...
    public static Builder builder(GetHostnamesHostnameArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetHostnamesHostnameArgs();
        }

        public Builder(GetHostnamesHostnameArgs defaults) {
            $ = new GetHostnamesHostnameArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetHostnamesHostnameArgs build() {
            return $;
        }
    }
