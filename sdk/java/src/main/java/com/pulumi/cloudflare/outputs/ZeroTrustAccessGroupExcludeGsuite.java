...
public final class ZeroTrustAccessGroupExcludeGsuite {
    ...
    public static Builder builder(ZeroTrustAccessGroupExcludeGsuite defaults) {
    ...
    public static final class Builder {
        ...
        public Builder identityProviderId(String identityProviderId) {
            if (identityProviderId == null) {
              throw new MissingRequiredPropertyException("ZeroTrustAccessGroupExcludeGsuite", "identityProviderId");
            }
