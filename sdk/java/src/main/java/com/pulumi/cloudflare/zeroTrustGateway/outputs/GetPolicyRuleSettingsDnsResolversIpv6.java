...
@CustomType
public final class GetPolicyRuleSettingsDnsResolversIpv6 {
    /**
    ...
    private GetPolicyRuleSettingsDnsResolversIpv6() {}
    /**
     * @return Specify the IPv6 address of the upstream resolver.
     * 
     */
    ...
    public static Builder builder(GetPolicyRuleSettingsDnsResolversIpv6 defaults) {
    ...
    public static final class Builder {
        ...
        private String vnetId;
        public Builder() {}
        public Builder(GetPolicyRuleSettingsDnsResolversIpv6 defaults) {
        ...
        public Builder ip(String ip) {
            if (ip == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsDnsResolversIpv6", "ip");
            }
            this.ip = ip;
            return this;
        }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsDnsResolversIpv6", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder routeThroughPrivateNetwork(Boolean routeThroughPrivateNetwork) {
            if (routeThroughPrivateNetwork == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsDnsResolversIpv6", "routeThroughPrivateNetwork");
            }
        ...
        public Builder vnetId(String vnetId) {
            if (vnetId == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsDnsResolversIpv6", "vnetId");
            }
            this.vnetId = vnetId;
            return this;
        }
        public GetPolicyRuleSettingsDnsResolversIpv6 build() {
            final var _resultValue = new GetPolicyRuleSettingsDnsResolversIpv6();
            _resultValue.ip = ip;
