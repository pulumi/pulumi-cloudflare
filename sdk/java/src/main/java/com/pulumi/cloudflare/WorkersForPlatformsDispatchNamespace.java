...
public class WorkersForPlatformsDispatchNamespace extends com.pulumi.resources.CustomResource {
     ...
     */
    public WorkersForPlatformsDispatchNamespace(java.lang.String name) {
    ...
    private WorkersForPlatformsDispatchNamespace(java.lang.String name, Output<java.lang.String> id, @Nullable WorkersForPlatformsDispatchNamespaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static WorkersForPlatformsDispatchNamespace get(java.lang.String name, Output<java.lang.String> id, @Nullable WorkersForPlatformsDispatchNamespaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
