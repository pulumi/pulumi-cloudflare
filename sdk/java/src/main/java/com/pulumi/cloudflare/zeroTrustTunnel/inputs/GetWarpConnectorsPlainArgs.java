...
package com.pulumi.cloudflare.zeroTrustTunnel.inputs;
...
public final class GetWarpConnectorsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetWarpConnectorsPlainArgs Empty = new GetWarpConnectorsPlainArgs();
    ...
    private GetWarpConnectorsPlainArgs() {}

    private GetWarpConnectorsPlainArgs(GetWarpConnectorsPlainArgs $) {
    ...
    public static Builder builder(GetWarpConnectorsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetWarpConnectorsPlainArgs();
        }

        public Builder(GetWarpConnectorsPlainArgs defaults) {
            $ = new GetWarpConnectorsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetWarpConnectorsPlainArgs build() {
            return $;
        }
    }
