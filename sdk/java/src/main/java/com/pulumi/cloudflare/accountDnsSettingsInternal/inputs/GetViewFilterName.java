...
public final class GetViewFilterName extends com.pulumi.resources.InvokeArgs {

    public static final GetViewFilterName Empty = new GetViewFilterName();
    ...
    private GetViewFilterName() {}

    private GetViewFilterName(GetViewFilterName $) {
    ...
    public static Builder builder(GetViewFilterName defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetViewFilterName();
        }

        public Builder(GetViewFilterName defaults) {
            $ = new GetViewFilterName(Objects.requireNonNull(defaults));
        }
        ...
        public GetViewFilterName build() {
            return $;
        }
    }
