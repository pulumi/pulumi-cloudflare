...
public final class GetPagesProjectLatestDeploymentSourceConfig {
    ...
    public static final class Builder {
        ...
        public Builder ownerId(String ownerId) {
            if (ownerId == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectLatestDeploymentSourceConfig", "ownerId");
            }
        ...
        public Builder repoId(String repoId) {
            if (repoId == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectLatestDeploymentSourceConfig", "repoId");
            }
            this.repoId = repoId;
            return this;
        }
