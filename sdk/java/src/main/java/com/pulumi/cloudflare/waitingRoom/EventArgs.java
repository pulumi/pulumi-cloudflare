    ...
    public static final class Builder {
        ...
        public EventArgs build() {
            if ($.eventEndTime == null) {
                throw new MissingRequiredPropertyException("EventArgs", "eventEndTime");
            }
            if ($.eventStartTime == null) {
                throw new MissingRequiredPropertyException("EventArgs", "eventStartTime");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("EventArgs", "name");
            }
            if ($.waitingRoomId == null) {
                throw new MissingRequiredPropertyException("EventArgs", "waitingRoomId");
            }
            if ($.zoneId == null) {
                throw new MissingRequiredPropertyException("EventArgs", "zoneId");
            }
            return $;
        }
    }
