...
@CustomType
public final class AccountTokenConditionRequestIp {
    /**
    ...
    private AccountTokenConditionRequestIp() {}
    /**
     * @return List of IPv4/IPv6 CIDR addresses.
     * 
     */
    ...
    public static Builder builder(AccountTokenConditionRequestIp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> notIns;
        public Builder() {}
        public Builder(AccountTokenConditionRequestIp defaults) {
        ...
        public AccountTokenConditionRequestIp build() {
            final var _resultValue = new AccountTokenConditionRequestIp();
