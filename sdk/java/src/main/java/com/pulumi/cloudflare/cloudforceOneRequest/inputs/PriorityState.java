...
public final class PriorityState extends com.pulumi.resources.ResourceArgs {

    public static final PriorityState Empty = new PriorityState();
    ...
    public static Builder builder(PriorityState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PriorityState defaults) {
            $ = new PriorityState(Objects.requireNonNull(defaults));
        }
