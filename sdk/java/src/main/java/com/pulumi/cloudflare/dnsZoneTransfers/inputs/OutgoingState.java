...
public final class OutgoingState extends com.pulumi.resources.ResourceArgs {

    public static final OutgoingState Empty = new OutgoingState();
    ...
    public static Builder builder(OutgoingState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(OutgoingState defaults) {
            $ = new OutgoingState(Objects.requireNonNull(defaults));
        }
