...
@CustomType
public final class PoolLoadShedding {
    /**
    ...
    public static Builder builder(PoolLoadShedding defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sessionPolicy;
        public Builder() {}
        public Builder(PoolLoadShedding defaults) {
        ...
        public PoolLoadShedding build() {
            final var _resultValue = new PoolLoadShedding();
