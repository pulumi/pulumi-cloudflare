...
public final class TeamsAccountSettingsSandboxArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TeamsAccountSettingsSandboxArgs() {}

    private TeamsAccountSettingsSandboxArgs(TeamsAccountSettingsSandboxArgs $) {
    ...
    public static Builder builder(TeamsAccountSettingsSandboxArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TeamsAccountSettingsSandboxArgs();
        }

        public Builder(TeamsAccountSettingsSandboxArgs defaults) {
            $ = new TeamsAccountSettingsSandboxArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TeamsAccountSettingsSandboxArgs build() {
            return $;
        }
    }
