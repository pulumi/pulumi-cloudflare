...
import com.pulumi.cloudflare.inputs.ZeroTrustTunnelCloudflaredRouteState;
...
public class ZeroTrustTunnelCloudflaredRoute extends com.pulumi.resources.CustomResource {
     ...
     */
    public ZeroTrustTunnelCloudflaredRoute(java.lang.String name) {
        this(name, ZeroTrustTunnelCloudflaredRouteArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ZeroTrustTunnelCloudflaredRoute(java.lang.String name, ZeroTrustTunnelCloudflaredRouteArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ZeroTrustTunnelCloudflaredRoute(java.lang.String name, ZeroTrustTunnelCloudflaredRouteArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:index/zeroTrustTunnelCloudflaredRoute:ZeroTrustTunnelCloudflaredRoute", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ZeroTrustTunnelCloudflaredRoute(java.lang.String name, Output<java.lang.String> id, @Nullable ZeroTrustTunnelCloudflaredRouteState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:index/zeroTrustTunnelCloudflaredRoute:ZeroTrustTunnelCloudflaredRoute", name, state, makeResourceOptions(options, id), false);
    }

    private static ZeroTrustTunnelCloudflaredRouteArgs makeArgs(ZeroTrustTunnelCloudflaredRouteArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ZeroTrustTunnelCloudflaredRouteArgs.Empty : args;
    }
     ...
     */
    public static ZeroTrustTunnelCloudflaredRoute get(java.lang.String name, Output<java.lang.String> id, @Nullable ZeroTrustTunnelCloudflaredRouteState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
