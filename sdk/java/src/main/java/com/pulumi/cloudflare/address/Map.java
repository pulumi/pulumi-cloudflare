...
import com.pulumi.cloudflare.address.inputs.MapState;
import com.pulumi.cloudflare.address.outputs.MapMembership;
 ...
 * 
 */
@ResourceType(type="cloudflare:address/map:Map")
public class Map extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="memberships", refs={List.class,MapMembership.class}, tree="[0,1]")
    private Output</* @Nullable */ List<MapMembership>> memberships;
     ...
     * 
     */
    public Output<Optional<List<MapMembership>>> memberships() {
    ...
    public Map(java.lang.String name, MapArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:address/map:Map", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Map(java.lang.String name, Output<java.lang.String> id, @Nullable MapState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:address/map:Map", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/addressMap:AddressMap").build())
            ))
            .build();
