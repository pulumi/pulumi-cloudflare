...
public final class DatasetColumn {
    ...
    public static Builder builder(DatasetColumn defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uploadStatus;
        public Builder() {}
        public Builder(DatasetColumn defaults) {
        ...
        public DatasetColumn build() {
            final var _resultValue = new DatasetColumn();
