...
@CustomType
public final class PagesProjectCanonicalDeploymentSourceConfig {
    /**
    ...
    private PagesProjectCanonicalDeploymentSourceConfig() {}
    /**
     * @return Whether to enable automatic deployments when pushing to the source repository.
     * When disabled, no deployments (production or preview) will be triggered automatically.
     * 
    ...
    public static Builder builder(PagesProjectCanonicalDeploymentSourceConfig defaults) {
    ...
    public static final class Builder {
        ...
        public PagesProjectCanonicalDeploymentSourceConfig build() {
