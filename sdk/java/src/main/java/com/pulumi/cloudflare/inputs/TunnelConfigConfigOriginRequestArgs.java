...
public final class TunnelConfigConfigOriginRequestArgs extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="ipRules")
    private @Nullable Output<List<TunnelConfigConfigOriginRequestIpRuleArgs>> ipRules;

    public Optional<Output<List<TunnelConfigConfigOriginRequestIpRuleArgs>>> ipRules() {
    ...
    public static Builder builder(TunnelConfigConfigOriginRequestArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TunnelConfigConfigOriginRequestArgs();
        }
        ...
        public Builder ipRules(@Nullable Output<List<TunnelConfigConfigOriginRequestIpRuleArgs>> ipRules) {
            $.ipRules = ipRules;
            return this;
        }

        public Builder ipRules(List<TunnelConfigConfigOriginRequestIpRuleArgs> ipRules) {
            return ipRules(Output.of(ipRules));
        }

        public Builder ipRules(TunnelConfigConfigOriginRequestIpRuleArgs... ipRules) {
        ...
        public TunnelConfigConfigOriginRequestArgs build() {
            return $;
        }
    }
