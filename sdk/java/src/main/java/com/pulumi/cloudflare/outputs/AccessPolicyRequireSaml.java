...
public final class AccessPolicyRequireSaml {
    ...
    public static Builder builder(AccessPolicyRequireSaml defaults) {
    ...
    public static final class Builder {
        ...
        private String identityProviderId;
        public Builder() {}
        public Builder(AccessPolicyRequireSaml defaults) {
        ...
        public Builder attributeName(String attributeName) {
            if (attributeName == null) {
              throw new MissingRequiredPropertyException("AccessPolicyRequireSaml", "attributeName");
            }
        ...
        public Builder attributeValue(String attributeValue) {
            if (attributeValue == null) {
              throw new MissingRequiredPropertyException("AccessPolicyRequireSaml", "attributeValue");
            }
        ...
        public Builder identityProviderId(String identityProviderId) {
            if (identityProviderId == null) {
              throw new MissingRequiredPropertyException("AccessPolicyRequireSaml", "identityProviderId");
            }
