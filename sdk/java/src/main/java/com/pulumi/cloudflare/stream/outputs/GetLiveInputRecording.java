...
@CustomType
public final class GetLiveInputRecording {
    /**
    ...
    public static Builder builder(GetLiveInputRecording defaults) {
    ...
    public static final class Builder {
        ...
        private Integer timeoutSeconds;
        public Builder() {}
        public Builder(GetLiveInputRecording defaults) {
        ...
        public Builder allowedOrigins(List<String> allowedOrigins) {
            if (allowedOrigins == null) {
              throw new MissingRequiredPropertyException("GetLiveInputRecording", "allowedOrigins");
            }
        ...
        public Builder hideLiveViewerCount(Boolean hideLiveViewerCount) {
            if (hideLiveViewerCount == null) {
              throw new MissingRequiredPropertyException("GetLiveInputRecording", "hideLiveViewerCount");
            }
        ...
        public Builder mode(String mode) {
            if (mode == null) {
              throw new MissingRequiredPropertyException("GetLiveInputRecording", "mode");
            }
            this.mode = mode;
            return this;
        }
        ...
        public Builder requireSignedUrls(Boolean requireSignedUrls) {
            if (requireSignedUrls == null) {
              throw new MissingRequiredPropertyException("GetLiveInputRecording", "requireSignedUrls");
            }
        ...
        public Builder timeoutSeconds(Integer timeoutSeconds) {
            if (timeoutSeconds == null) {
              throw new MissingRequiredPropertyException("GetLiveInputRecording", "timeoutSeconds");
            }
            this.timeoutSeconds = timeoutSeconds;
            return this;
        }
        public GetLiveInputRecording build() {
            final var _resultValue = new GetLiveInputRecording();
