...
@CustomType
public final class GetDnsRecordSettings {
    /**
    ...
    public static Builder builder(GetDnsRecordSettings defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean ipv6Only;
        public Builder() {}
        public Builder(GetDnsRecordSettings defaults) {
        ...
        public Builder flattenCname(Boolean flattenCname) {
            if (flattenCname == null) {
              throw new MissingRequiredPropertyException("GetDnsRecordSettings", "flattenCname");
            }
        ...
        public Builder ipv4Only(Boolean ipv4Only) {
            if (ipv4Only == null) {
              throw new MissingRequiredPropertyException("GetDnsRecordSettings", "ipv4Only");
            }
        ...
        public Builder ipv6Only(Boolean ipv6Only) {
            if (ipv6Only == null) {
              throw new MissingRequiredPropertyException("GetDnsRecordSettings", "ipv6Only");
            }
            this.ipv6Only = ipv6Only;
            return this;
        }
        public GetDnsRecordSettings build() {
            final var _resultValue = new GetDnsRecordSettings();
