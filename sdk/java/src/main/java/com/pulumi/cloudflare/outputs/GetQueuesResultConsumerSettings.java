...
@CustomType
public final class GetQueuesResultConsumerSettings {
    /**
    ...
    private GetQueuesResultConsumerSettings() {}
    /**
     * @return The maximum number of messages to include in a batch.
     * 
     */
    ...
    public static Builder builder(GetQueuesResultConsumerSettings defaults) {
    ...
    public static final class Builder {
        ...
        private Double visibilityTimeoutMs;
        public Builder() {}
        public Builder(GetQueuesResultConsumerSettings defaults) {
        ...
        public Builder batchSize(Double batchSize) {
            if (batchSize == null) {
              throw new MissingRequiredPropertyException("GetQueuesResultConsumerSettings", "batchSize");
            }
        ...
        public Builder maxConcurrency(Double maxConcurrency) {
            if (maxConcurrency == null) {
              throw new MissingRequiredPropertyException("GetQueuesResultConsumerSettings", "maxConcurrency");
            }
        ...
        public Builder maxRetries(Double maxRetries) {
            if (maxRetries == null) {
              throw new MissingRequiredPropertyException("GetQueuesResultConsumerSettings", "maxRetries");
            }
        ...
        public Builder maxWaitTimeMs(Double maxWaitTimeMs) {
            if (maxWaitTimeMs == null) {
              throw new MissingRequiredPropertyException("GetQueuesResultConsumerSettings", "maxWaitTimeMs");
            }
        ...
        public Builder retryDelay(Double retryDelay) {
            if (retryDelay == null) {
              throw new MissingRequiredPropertyException("GetQueuesResultConsumerSettings", "retryDelay");
            }
        ...
        public Builder visibilityTimeoutMs(Double visibilityTimeoutMs) {
            if (visibilityTimeoutMs == null) {
              throw new MissingRequiredPropertyException("GetQueuesResultConsumerSettings", "visibilityTimeoutMs");
            }
            this.visibilityTimeoutMs = visibilityTimeoutMs;
            return this;
        }
        public GetQueuesResultConsumerSettings build() {
            final var _resultValue = new GetQueuesResultConsumerSettings();
