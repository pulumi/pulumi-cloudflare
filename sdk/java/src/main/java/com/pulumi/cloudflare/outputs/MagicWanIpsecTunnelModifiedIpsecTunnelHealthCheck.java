...
import com.pulumi.cloudflare.outputs.MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTarget;
...
@CustomType
public final class MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheck {
    /**
     ...
     * 
     */
    private @Nullable MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTarget target;
    /**
    ...
    private MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheck() {}
    /**
     * @return The direction of the flow of the healthcheck. Either unidirectional, where the probe comes to you via the tunnel and the result comes back to Cloudflare via the open Internet, or bidirectional where both the probe and result come and go via the tunnel.
     * Available values: &#34;unidirectional&#34;, &#34;bidirectional&#34;.
     * 
     ...
     * 
     */
    public Optional<MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTarget> target() {
    ...
    public static Builder builder(MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheck defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheck defaults) {
        ...
        @CustomType.Setter
        public Builder target(@Nullable MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTarget target) {
        ...
        public MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheck build() {
            final var _resultValue = new MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheck();
