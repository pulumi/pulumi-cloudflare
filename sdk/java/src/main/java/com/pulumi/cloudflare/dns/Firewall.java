...
import com.pulumi.cloudflare.dns.inputs.FirewallState;
import com.pulumi.cloudflare.dns.outputs.FirewallAttackMitigation;
 ...
 * 
 */
@ResourceType(type="cloudflare:dns/firewall:Firewall")
public class Firewall extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="attackMitigation", refs={FirewallAttackMitigation.class}, tree="[0]")
    private Output<FirewallAttackMitigation> attackMitigation;

    /**
     * @return Attack mitigation settings
     * 
     */
    public Output<FirewallAttackMitigation> attackMitigation() {
     ...
     * 
     */
    @Export(name="dnsFirewallIpCount", refs={Integer.class}, tree="[0]")
    private Output<Integer> dnsFirewallIpCount;
     ...
     * 
     */
    public Output<Integer> dnsFirewallIpCount() {
        return this.dnsFirewallIpCount;
    }
    ...
    public Firewall(java.lang.String name, FirewallArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:dns/firewall:Firewall", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Firewall(java.lang.String name, Output<java.lang.String> id, @Nullable FirewallState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:dns/firewall:Firewall", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/dnsFirewall:DnsFirewall").build())
            ))
            .build();
