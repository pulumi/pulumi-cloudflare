...
package com.pulumi.cloudflare.emailSecurityImpersonation.outputs;

import com.pulumi.cloudflare.emailSecurityImpersonation.outputs.GetRegistryFilter;
...
public final class GetRegistryResult {
    ...
    public static final class Builder {
        ...
        public Builder comments(String comments) {
            if (comments == null) {
              throw new MissingRequiredPropertyException("GetRegistryResult", "comments");
            }
        ...
        public Builder directoryId(Integer directoryId) {
            if (directoryId == null) {
              throw new MissingRequiredPropertyException("GetRegistryResult", "directoryId");
            }
        ...
        public Builder directoryNodeId(Integer directoryNodeId) {
            if (directoryNodeId == null) {
              throw new MissingRequiredPropertyException("GetRegistryResult", "directoryNodeId");
            }
        ...
        public Builder email(String email) {
            if (email == null) {
              throw new MissingRequiredPropertyException("GetRegistryResult", "email");
            }
            this.email = email;
            return this;
        }
        ...
        public Builder externalDirectoryNodeId(String externalDirectoryNodeId) {
            if (externalDirectoryNodeId == null) {
              throw new MissingRequiredPropertyException("GetRegistryResult", "externalDirectoryNodeId");
            }
        ...
        public Builder isEmailRegex(Boolean isEmailRegex) {
            if (isEmailRegex == null) {
              throw new MissingRequiredPropertyException("GetRegistryResult", "isEmailRegex");
            }
        ...
        public Builder lastModified(String lastModified) {
            if (lastModified == null) {
              throw new MissingRequiredPropertyException("GetRegistryResult", "lastModified");
            }
        ...
        public Builder modifiedAt(String modifiedAt) {
            if (modifiedAt == null) {
              throw new MissingRequiredPropertyException("GetRegistryResult", "modifiedAt");
            }
        ...
        public Builder provenance(String provenance) {
            if (provenance == null) {
              throw new MissingRequiredPropertyException("GetRegistryResult", "provenance");
            }
