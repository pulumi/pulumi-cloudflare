...
public final class ZeroTrustGatewaySettingsSettingsFips {
    ...
    public static Builder builder(ZeroTrustGatewaySettingsSettingsFips defaults) {
    ...
    public static final class Builder {
        private @Nullable Boolean tls;
        public Builder() {}
        public Builder(ZeroTrustGatewaySettingsSettingsFips defaults) {
        ...
        public ZeroTrustGatewaySettingsSettingsFips build() {
            final var _resultValue = new ZeroTrustGatewaySettingsSettingsFips();
