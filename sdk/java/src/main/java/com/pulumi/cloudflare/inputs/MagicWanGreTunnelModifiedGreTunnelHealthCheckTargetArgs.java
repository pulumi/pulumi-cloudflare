...
public final class MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs extends com.pulumi.resources.ResourceArgs {

    public static final MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs Empty = new MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs();
    ...
    private MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs() {}

    private MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs(MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs $) {
    ...
    public static Builder builder(MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs();
        }

        public Builder(MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs defaults) {
            $ = new MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetArgs build() {
            return $;
        }
    }
