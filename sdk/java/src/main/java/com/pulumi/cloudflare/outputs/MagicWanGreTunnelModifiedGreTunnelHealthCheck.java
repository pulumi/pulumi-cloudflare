...
import com.pulumi.cloudflare.outputs.MagicWanGreTunnelModifiedGreTunnelHealthCheckTarget;
...
@CustomType
public final class MagicWanGreTunnelModifiedGreTunnelHealthCheck {
    /**
     ...
     * 
     */
    private @Nullable MagicWanGreTunnelModifiedGreTunnelHealthCheckTarget target;
    /**
    ...
    private MagicWanGreTunnelModifiedGreTunnelHealthCheck() {}
    /**
     * @return The direction of the flow of the healthcheck. Either unidirectional, where the probe comes to you via the tunnel and the result comes back to Cloudflare via the open Internet, or bidirectional where both the probe and result come and go via the tunnel.
     * Available values: &#34;unidirectional&#34;, &#34;bidirectional&#34;.
     * 
     ...
     * 
     */
    public Optional<MagicWanGreTunnelModifiedGreTunnelHealthCheckTarget> target() {
    ...
    public static Builder builder(MagicWanGreTunnelModifiedGreTunnelHealthCheck defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(MagicWanGreTunnelModifiedGreTunnelHealthCheck defaults) {
        ...
        @CustomType.Setter
        public Builder target(@Nullable MagicWanGreTunnelModifiedGreTunnelHealthCheckTarget target) {
        ...
        public MagicWanGreTunnelModifiedGreTunnelHealthCheck build() {
            final var _resultValue = new MagicWanGreTunnelModifiedGreTunnelHealthCheck();
