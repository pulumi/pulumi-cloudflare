...
import com.pulumi.cloudflare.accountDnsSettingsInternal.outputs.GetViewFilterName;
...
@CustomType
public final class GetViewFilter {
    /**
    ...
    public static final class Builder {
        ...
        public GetViewFilter build() {
            final var _resultValue = new GetViewFilter();
