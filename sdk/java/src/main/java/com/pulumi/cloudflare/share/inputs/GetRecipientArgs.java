...
public final class GetRecipientArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetRecipientArgs Empty = new GetRecipientArgs();
    ...
    private GetRecipientArgs() {}

    private GetRecipientArgs(GetRecipientArgs $) {
    ...
    public static Builder builder(GetRecipientArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRecipientArgs();
        }

        public Builder(GetRecipientArgs defaults) {
            $ = new GetRecipientArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRecipientArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetRecipientArgs", "accountId");
            }
            if ($.recipientId == null) {
                throw new MissingRequiredPropertyException("GetRecipientArgs", "recipientId");
            }
            if ($.shareId == null) {
                throw new MissingRequiredPropertyException("GetRecipientArgs", "shareId");
            }
            return $;
        }
    }
