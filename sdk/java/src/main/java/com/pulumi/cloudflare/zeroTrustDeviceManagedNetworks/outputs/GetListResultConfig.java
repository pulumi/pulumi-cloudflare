...
@CustomType
public final class GetListResultConfig {
    /**
    ...
    public static Builder builder(GetListResultConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String tlsSockaddr;
        public Builder() {}
        public Builder(GetListResultConfig defaults) {
        ...
        public Builder sha256(String sha256) {
            if (sha256 == null) {
              throw new MissingRequiredPropertyException("GetListResultConfig", "sha256");
            }
            this.sha256 = sha256;
            return this;
        }
        ...
        public Builder tlsSockaddr(String tlsSockaddr) {
            if (tlsSockaddr == null) {
              throw new MissingRequiredPropertyException("GetListResultConfig", "tlsSockaddr");
            }
            this.tlsSockaddr = tlsSockaddr;
            return this;
        }
        public GetListResultConfig build() {
            final var _resultValue = new GetListResultConfig();
