...
public final class GetRegionResult {
    ...
    public static final class Builder {
        ...
        public Builder modifiedOn(String modifiedOn) {
            if (modifiedOn == null) {
              throw new MissingRequiredPropertyException("GetRegionResult", "modifiedOn");
            }
        ...
        public Builder originIp(String originIp) {
            if (originIp == null) {
              throw new MissingRequiredPropertyException("GetRegionResult", "originIp");
            }
        ...
        public Builder vendor(String vendor) {
            if (vendor == null) {
              throw new MissingRequiredPropertyException("GetRegionResult", "vendor");
            }
            this.vendor = vendor;
            return this;
        }
        ...
        public Builder zoneId(String zoneId) {
            if (zoneId == null) {
              throw new MissingRequiredPropertyException("GetRegionResult", "zoneId");
            }
            this.zoneId = zoneId;
            return this;
        }
