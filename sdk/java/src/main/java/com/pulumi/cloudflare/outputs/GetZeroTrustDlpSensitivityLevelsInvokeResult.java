...
import com.pulumi.cloudflare.outputs.GetZeroTrustDlpSensitivityLevelsResult;
...
public final class GetZeroTrustDlpSensitivityLevelsInvokeResult {
     ...
     * 
     */
    public List<GetZeroTrustDlpSensitivityLevelsResult> results() {
        return this.results;
    }
    ...
    public static Builder builder(GetZeroTrustDlpSensitivityLevelsInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder results(List<GetZeroTrustDlpSensitivityLevelsResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustDlpSensitivityLevelsInvokeResult", "results");
            }
            this.results = results;
            return this;
        }
        public Builder results(GetZeroTrustDlpSensitivityLevelsResult... results) {
            return results(List.of(results));
        }
        @CustomType.Setter
        public Builder sensitivityGroupId(String sensitivityGroupId) {
            if (sensitivityGroupId == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustDlpSensitivityLevelsInvokeResult", "sensitivityGroupId");
            }
