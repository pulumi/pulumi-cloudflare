...
import com.pulumi.cloudflare.outputs.ZeroTrustAccessPolicyIncludeAzure;
import com.pulumi.cloudflare.outputs.ZeroTrustAccessPolicyIncludeExternalEvaluation;
import com.pulumi.cloudflare.outputs.ZeroTrustAccessPolicyIncludeGithub;
...
public final class ZeroTrustAccessPolicyInclude {
    ...
    private @Nullable List<ZeroTrustAccessPolicyIncludeAuthContext> authContexts;
    private @Nullable String authMethod;
    private @Nullable List<ZeroTrustAccessPolicyIncludeAzure> azures;
    ...
    private @Nullable List<ZeroTrustAccessPolicyIncludeExternalEvaluation> externalEvaluations;
    private @Nullable List<String> geos;
    private @Nullable List<ZeroTrustAccessPolicyIncludeGithub> githubs;
    private @Nullable List<String> groups;
    private @Nullable List<ZeroTrustAccessPolicyIncludeGsuite> gsuites;
    /**
    ...
    private @Nullable List<ZeroTrustAccessPolicyIncludeOkta> oktas;
    private @Nullable List<ZeroTrustAccessPolicyIncludeSaml> samls;
    ...
    public List<ZeroTrustAccessPolicyIncludeAuthContext> authContexts() {
    ...
    public List<ZeroTrustAccessPolicyIncludeAzure> azures() {
    ...
    public List<ZeroTrustAccessPolicyIncludeExternalEvaluation> externalEvaluations() {
    ...
    public List<ZeroTrustAccessPolicyIncludeGithub> githubs() {
        return this.githubs == null ? List.of() : this.githubs;
    }
    public List<String> groups() {
        return this.groups == null ? List.of() : this.groups;
    }
    public List<ZeroTrustAccessPolicyIncludeGsuite> gsuites() {
    ...
    public List<ZeroTrustAccessPolicyIncludeOkta> oktas() {
        return this.oktas == null ? List.of() : this.oktas;
    }
    public List<ZeroTrustAccessPolicyIncludeSaml> samls() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder authContexts(@Nullable List<ZeroTrustAccessPolicyIncludeAuthContext> authContexts) {

            this.authContexts = authContexts;
            return this;
        }
        public Builder authContexts(ZeroTrustAccessPolicyIncludeAuthContext... authContexts) {
        ...
        @CustomType.Setter
        public Builder azures(@Nullable List<ZeroTrustAccessPolicyIncludeAzure> azures) {

            this.azures = azures;
            return this;
        }
        public Builder azures(ZeroTrustAccessPolicyIncludeAzure... azures) {
        ...
        @CustomType.Setter
        public Builder externalEvaluations(@Nullable List<ZeroTrustAccessPolicyIncludeExternalEvaluation> externalEvaluations) {

            this.externalEvaluations = externalEvaluations;
            return this;
        }
        public Builder externalEvaluations(ZeroTrustAccessPolicyIncludeExternalEvaluation... externalEvaluations) {
        ...
        @CustomType.Setter
        public Builder githubs(@Nullable List<ZeroTrustAccessPolicyIncludeGithub> githubs) {

            this.githubs = githubs;
            return this;
        }
        public Builder githubs(ZeroTrustAccessPolicyIncludeGithub... githubs) {
        ...
        @CustomType.Setter
        public Builder gsuites(@Nullable List<ZeroTrustAccessPolicyIncludeGsuite> gsuites) {

            this.gsuites = gsuites;
            return this;
        }
        public Builder gsuites(ZeroTrustAccessPolicyIncludeGsuite... gsuites) {
        ...
        @CustomType.Setter
        public Builder oktas(@Nullable List<ZeroTrustAccessPolicyIncludeOkta> oktas) {

            this.oktas = oktas;
            return this;
        }
        public Builder oktas(ZeroTrustAccessPolicyIncludeOkta... oktas) {
            return oktas(List.of(oktas));
        }
        @CustomType.Setter
        public Builder samls(@Nullable List<ZeroTrustAccessPolicyIncludeSaml> samls) {

            this.samls = samls;
            return this;
        }
        public Builder samls(ZeroTrustAccessPolicyIncludeSaml... samls) {
