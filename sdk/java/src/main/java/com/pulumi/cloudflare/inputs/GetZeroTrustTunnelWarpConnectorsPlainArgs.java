...
public final class GetZeroTrustTunnelWarpConnectorsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetZeroTrustTunnelWarpConnectorsPlainArgs Empty = new GetZeroTrustTunnelWarpConnectorsPlainArgs();
    ...
    private GetZeroTrustTunnelWarpConnectorsPlainArgs() {}

    private GetZeroTrustTunnelWarpConnectorsPlainArgs(GetZeroTrustTunnelWarpConnectorsPlainArgs $) {
    ...
    public static Builder builder(GetZeroTrustTunnelWarpConnectorsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetZeroTrustTunnelWarpConnectorsPlainArgs();
        }

        public Builder(GetZeroTrustTunnelWarpConnectorsPlainArgs defaults) {
            $ = new GetZeroTrustTunnelWarpConnectorsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetZeroTrustTunnelWarpConnectorsPlainArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetZeroTrustTunnelWarpConnectorsPlainArgs", "accountId");
            }
            return $;
        }
    }
