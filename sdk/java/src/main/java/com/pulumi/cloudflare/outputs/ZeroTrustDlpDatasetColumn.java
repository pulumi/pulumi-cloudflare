...
@CustomType
public final class ZeroTrustDlpDatasetColumn {
    ...
    private ZeroTrustDlpDatasetColumn() {}
    ...
    public static Builder builder(ZeroTrustDlpDatasetColumn defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uploadStatus;
        public Builder() {}
        public Builder(ZeroTrustDlpDatasetColumn defaults) {
        ...
        public ZeroTrustDlpDatasetColumn build() {
            final var _resultValue = new ZeroTrustDlpDatasetColumn();
