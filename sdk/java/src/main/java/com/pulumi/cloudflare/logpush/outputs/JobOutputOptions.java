...
@CustomType
public final class JobOutputOptions {
    /**
    ...
    public static Builder builder(JobOutputOptions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timestampFormat;
        public Builder() {}
        public Builder(JobOutputOptions defaults) {
        ...
        @CustomType.Setter
        public Builder mergeSubrequests(@Nullable Boolean mergeSubrequests) {
        ...
        public JobOutputOptions build() {
            final var _resultValue = new JobOutputOptions();
