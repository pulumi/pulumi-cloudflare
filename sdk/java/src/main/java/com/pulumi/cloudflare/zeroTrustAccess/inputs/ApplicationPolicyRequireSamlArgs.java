...
public final class ApplicationPolicyRequireSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationPolicyRequireSamlArgs Empty = new ApplicationPolicyRequireSamlArgs();
    ...
    private ApplicationPolicyRequireSamlArgs() {}

    private ApplicationPolicyRequireSamlArgs(ApplicationPolicyRequireSamlArgs $) {
    ...
    public static Builder builder(ApplicationPolicyRequireSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationPolicyRequireSamlArgs();
        }

        public Builder(ApplicationPolicyRequireSamlArgs defaults) {
            $ = new ApplicationPolicyRequireSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApplicationPolicyRequireSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("ApplicationPolicyRequireSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("ApplicationPolicyRequireSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("ApplicationPolicyRequireSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
