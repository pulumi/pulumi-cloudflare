...
public final class IntegrationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<IntegrationConfigArgs> config;

    /**
     * @return The configuration object containing third-party integration information.
     * 
     */
    public Output<IntegrationConfigArgs> config() {
        return this.config;
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder config(Output<IntegrationConfigArgs> config) {
            $.config = config;
            return this;
        }
        ...
        public IntegrationArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("IntegrationArgs", "accountId");
            }
            if ($.config == null) {
                throw new MissingRequiredPropertyException("IntegrationArgs", "config");
            }
            if ($.interval == null) {
                throw new MissingRequiredPropertyException("IntegrationArgs", "interval");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("IntegrationArgs", "name");
            }
            if ($.type == null) {
