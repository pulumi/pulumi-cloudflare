...
@CustomType
public final class GetWarpConnectorsResultConnection {
    /**
    ...
    private GetWarpConnectorsResultConnection() {}
    /**
     * @return UUID of the Cloudflare Tunnel connector.
     * 
     */
    ...
    public static Builder builder(GetWarpConnectorsResultConnection defaults) {
    ...
    public static final class Builder {
        ...
        private String uuid;
        public Builder() {}
        public Builder(GetWarpConnectorsResultConnection defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetWarpConnectorsResultConnection", "clientId");
            }
        ...
        public Builder clientVersion(String clientVersion) {
            if (clientVersion == null) {
              throw new MissingRequiredPropertyException("GetWarpConnectorsResultConnection", "clientVersion");
            }
        ...
        public Builder coloName(String coloName) {
            if (coloName == null) {
              throw new MissingRequiredPropertyException("GetWarpConnectorsResultConnection", "coloName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetWarpConnectorsResultConnection", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isPendingReconnect(Boolean isPendingReconnect) {
            if (isPendingReconnect == null) {
              throw new MissingRequiredPropertyException("GetWarpConnectorsResultConnection", "isPendingReconnect");
            }
        ...
        public Builder openedAt(String openedAt) {
            if (openedAt == null) {
              throw new MissingRequiredPropertyException("GetWarpConnectorsResultConnection", "openedAt");
            }
        ...
        public Builder originIp(String originIp) {
            if (originIp == null) {
              throw new MissingRequiredPropertyException("GetWarpConnectorsResultConnection", "originIp");
            }
        ...
        public Builder uuid(String uuid) {
            if (uuid == null) {
              throw new MissingRequiredPropertyException("GetWarpConnectorsResultConnection", "uuid");
            }
            this.uuid = uuid;
            return this;
        }
        public GetWarpConnectorsResultConnection build() {
            final var _resultValue = new GetWarpConnectorsResultConnection();
