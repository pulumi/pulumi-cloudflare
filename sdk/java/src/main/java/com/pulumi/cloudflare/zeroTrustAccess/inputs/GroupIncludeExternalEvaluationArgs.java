...
public final class GroupIncludeExternalEvaluationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupIncludeExternalEvaluationArgs Empty = new GroupIncludeExternalEvaluationArgs();
    ...
    private GroupIncludeExternalEvaluationArgs() {}

    private GroupIncludeExternalEvaluationArgs(GroupIncludeExternalEvaluationArgs $) {
    ...
    public static Builder builder(GroupIncludeExternalEvaluationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupIncludeExternalEvaluationArgs();
        }

        public Builder(GroupIncludeExternalEvaluationArgs defaults) {
            $ = new GroupIncludeExternalEvaluationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupIncludeExternalEvaluationArgs build() {
            if ($.evaluateUrl == null) {
                throw new MissingRequiredPropertyException("GroupIncludeExternalEvaluationArgs", "evaluateUrl");
            }
            if ($.keysUrl == null) {
                throw new MissingRequiredPropertyException("GroupIncludeExternalEvaluationArgs", "keysUrl");
            }
            return $;
        }
    }
