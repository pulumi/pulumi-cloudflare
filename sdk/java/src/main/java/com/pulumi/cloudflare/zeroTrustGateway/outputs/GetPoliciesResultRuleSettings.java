...
import com.pulumi.cloudflare.zeroTrustGateway.outputs.GetPoliciesResultRuleSettingsAuditSsh;
import com.pulumi.cloudflare.zeroTrustGateway.outputs.GetPoliciesResultRuleSettingsBisoAdminControls;
import com.pulumi.cloudflare.zeroTrustGateway.outputs.GetPoliciesResultRuleSettingsBlockPage;
import com.pulumi.cloudflare.zeroTrustGateway.outputs.GetPoliciesResultRuleSettingsCheckSession;
import com.pulumi.cloudflare.zeroTrustGateway.outputs.GetPoliciesResultRuleSettingsDnsResolvers;
import com.pulumi.cloudflare.zeroTrustGateway.outputs.GetPoliciesResultRuleSettingsEgress;
import com.pulumi.cloudflare.zeroTrustGateway.outputs.GetPoliciesResultRuleSettingsForensicCopy;
import com.pulumi.cloudflare.zeroTrustGateway.outputs.GetPoliciesResultRuleSettingsL4override;
import com.pulumi.cloudflare.zeroTrustGateway.outputs.GetPoliciesResultRuleSettingsNotificationSettings;
import com.pulumi.cloudflare.zeroTrustGateway.outputs.GetPoliciesResultRuleSettingsPayloadLog;
import com.pulumi.cloudflare.zeroTrustGateway.outputs.GetPoliciesResultRuleSettingsQuarantine;
import com.pulumi.cloudflare.zeroTrustGateway.outputs.GetPoliciesResultRuleSettingsRedirect;
import com.pulumi.cloudflare.zeroTrustGateway.outputs.GetPoliciesResultRuleSettingsResolveDnsInternally;
import com.pulumi.cloudflare.zeroTrustGateway.outputs.GetPoliciesResultRuleSettingsUntrustedCert;
...
@CustomType
public final class GetPoliciesResultRuleSettings {
    /**
     ...
     * 
     */
    private GetPoliciesResultRuleSettingsAuditSsh auditSsh;
    /**
     * @return Configure browser isolation behavior. Settable only for `http` rules with the action set to `isolate`.
     * 
     */
    private GetPoliciesResultRuleSettingsBisoAdminControls bisoAdminControls;
    /**
     ...
     * 
     */
    private GetPoliciesResultRuleSettingsBlockPage blockPage;
    /**
     ...
     * 
     */
    private GetPoliciesResultRuleSettingsCheckSession checkSession;
    /**
     ...
     * 
     */
    private GetPoliciesResultRuleSettingsDnsResolvers dnsResolvers;
    /**
     ...
     * 
     */
    private GetPoliciesResultRuleSettingsEgress egress;
    /**
     * @return Configure whether a copy of the HTTP request will be sent to storage when the rule matches.
     * 
     */
    private GetPoliciesResultRuleSettingsForensicCopy forensicCopy;
    /**
     ...
     * 
     */
    private GetPoliciesResultRuleSettingsL4override l4override;
    /**
     ...
     * 
     */
    private GetPoliciesResultRuleSettingsNotificationSettings notificationSettings;
    /**
     ...
     * 
     */
    private GetPoliciesResultRuleSettingsResolveDnsInternally resolveDnsInternally;
    /**
     ...
     * 
     */
    private GetPoliciesResultRuleSettingsUntrustedCert untrustedCert;

    private GetPoliciesResultRuleSettings() {}
    /**
     * @return Add custom headers to allowed requests as key-value pairs. Use header names as keys that map to arrays of header values. Header values may contain `{@literal @}{selector.name}` variable references that are interpolated at the edge. Use `{@literal @@}{` to escape a literal `{@literal @}{`. A maximum of 20 header operations (add + set + delete) is allowed per policy. Each header name may not exceed 256 bytes and each header value may not exceed 4 KB. Settable only for `http` rules with the action set to `allow`.
     * 
     */
     ...
     * 
     */
    public GetPoliciesResultRuleSettingsAuditSsh auditSsh() {
     ...
     * 
     */
    public GetPoliciesResultRuleSettingsBisoAdminControls bisoAdminControls() {
     ...
     * 
     */
    public GetPoliciesResultRuleSettingsBlockPage blockPage() {
     ...
     * 
     */
    public GetPoliciesResultRuleSettingsCheckSession checkSession() {
     ...
     * 
     */
    public GetPoliciesResultRuleSettingsDnsResolvers dnsResolvers() {
     ...
     * 
     */
    public GetPoliciesResultRuleSettingsEgress egress() {
        return this.egress;
    }
    /**
     * @return Configure whether a copy of the HTTP request will be sent to storage when the rule matches.
     * 
     */
    public GetPoliciesResultRuleSettingsForensicCopy forensicCopy() {
     ...
     * 
     */
    public GetPoliciesResultRuleSettingsL4override l4override() {
     ...
     * 
     */
    public GetPoliciesResultRuleSettingsNotificationSettings notificationSettings() {
     ...
     * 
     */
    public GetPoliciesResultRuleSettingsPayloadLog payloadLog() {
     ...
     * 
     */
    public GetPoliciesResultRuleSettingsQuarantine quarantine() {
     ...
     * 
     */
    public GetPoliciesResultRuleSettingsRedirect redirect() {
     ...
     * 
     */
    public GetPoliciesResultRuleSettingsResolveDnsInternally resolveDnsInternally() {
     ...
     * 
     */
    public GetPoliciesResultRuleSettingsUntrustedCert untrustedCert() {
    ...
    public static Builder builder(GetPoliciesResultRuleSettings defaults) {
    ...
    public static final class Builder {
        ...
        private GetPoliciesResultRuleSettingsUntrustedCert untrustedCert;
        public Builder() {}
        public Builder(GetPoliciesResultRuleSettings defaults) {
        ...
        public Builder addHeaders(Map<String,List<String>> addHeaders) {
            if (addHeaders == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "addHeaders");
            }
        ...
        public Builder allowChildBypass(Boolean allowChildBypass) {
            if (allowChildBypass == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "allowChildBypass");
            }
            this.allowChildBypass = allowChildBypass;
            return this;
        }
        @CustomType.Setter
        public Builder auditSsh(GetPoliciesResultRuleSettingsAuditSsh auditSsh) {
            if (auditSsh == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "auditSsh");
            }
            this.auditSsh = auditSsh;
            return this;
        }
        @CustomType.Setter
        public Builder bisoAdminControls(GetPoliciesResultRuleSettingsBisoAdminControls bisoAdminControls) {
            if (bisoAdminControls == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "bisoAdminControls");
            }
            this.bisoAdminControls = bisoAdminControls;
            return this;
        }
        @CustomType.Setter
        public Builder blockPage(GetPoliciesResultRuleSettingsBlockPage blockPage) {
            if (blockPage == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "blockPage");
            }
        ...
        public Builder blockPageEnabled(Boolean blockPageEnabled) {
            if (blockPageEnabled == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "blockPageEnabled");
            }
        ...
        public Builder blockReason(String blockReason) {
            if (blockReason == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "blockReason");
            }
        ...
        public Builder bypassParentRule(Boolean bypassParentRule) {
            if (bypassParentRule == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "bypassParentRule");
            }
            this.bypassParentRule = bypassParentRule;
            return this;
        }
        @CustomType.Setter
        public Builder checkSession(GetPoliciesResultRuleSettingsCheckSession checkSession) {
            if (checkSession == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "checkSession");
            }
        ...
        public Builder deleteHeaders(List<String> deleteHeaders) {
            if (deleteHeaders == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "deleteHeaders");
            }
        ...
        @CustomType.Setter
        public Builder dnsResolvers(GetPoliciesResultRuleSettingsDnsResolvers dnsResolvers) {
            if (dnsResolvers == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "dnsResolvers");
            }
            this.dnsResolvers = dnsResolvers;
            return this;
        }
        @CustomType.Setter
        public Builder egress(GetPoliciesResultRuleSettingsEgress egress) {
            if (egress == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "egress");
            }
            this.egress = egress;
            return this;
        }
        @CustomType.Setter
        public Builder forensicCopy(GetPoliciesResultRuleSettingsForensicCopy forensicCopy) {
            if (forensicCopy == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "forensicCopy");
            }
        ...
        public Builder ignoreCnameCategoryMatches(Boolean ignoreCnameCategoryMatches) {
            if (ignoreCnameCategoryMatches == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "ignoreCnameCategoryMatches");
            }
        ...
        public Builder insecureDisableDnssecValidation(Boolean insecureDisableDnssecValidation) {
            if (insecureDisableDnssecValidation == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "insecureDisableDnssecValidation");
            }
        ...
        public Builder ipCategories(Boolean ipCategories) {
            if (ipCategories == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "ipCategories");
            }
        ...
        public Builder ipIndicatorFeeds(Boolean ipIndicatorFeeds) {
            if (ipIndicatorFeeds == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "ipIndicatorFeeds");
            }
            this.ipIndicatorFeeds = ipIndicatorFeeds;
            return this;
        }
        @CustomType.Setter
        public Builder l4override(GetPoliciesResultRuleSettingsL4override l4override) {
            if (l4override == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "l4override");
            }
            this.l4override = l4override;
            return this;
        }
        @CustomType.Setter
        public Builder notificationSettings(GetPoliciesResultRuleSettingsNotificationSettings notificationSettings) {
            if (notificationSettings == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "notificationSettings");
            }
        ...
        public Builder overrideHost(String overrideHost) {
            if (overrideHost == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "overrideHost");
            }
        ...
        public Builder overrideIps(List<String> overrideIps) {
            if (overrideIps == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "overrideIps");
            }
        ...
        @CustomType.Setter
        public Builder payloadLog(GetPoliciesResultRuleSettingsPayloadLog payloadLog) {
            if (payloadLog == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "payloadLog");
            }
            this.payloadLog = payloadLog;
            return this;
        }
        @CustomType.Setter
        public Builder quarantine(GetPoliciesResultRuleSettingsQuarantine quarantine) {
            if (quarantine == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "quarantine");
            }
            this.quarantine = quarantine;
            return this;
        }
        @CustomType.Setter
        public Builder redirect(GetPoliciesResultRuleSettingsRedirect redirect) {
            if (redirect == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "redirect");
            }
            this.redirect = redirect;
            return this;
        }
        @CustomType.Setter
        public Builder resolveDnsInternally(GetPoliciesResultRuleSettingsResolveDnsInternally resolveDnsInternally) {
            if (resolveDnsInternally == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "resolveDnsInternally");
            }
        ...
        public Builder resolveDnsThroughCloudflare(Boolean resolveDnsThroughCloudflare) {
            if (resolveDnsThroughCloudflare == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "resolveDnsThroughCloudflare");
            }
        ...
        public Builder setHeaders(Map<String,List<String>> setHeaders) {
            if (setHeaders == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "setHeaders");
            }
            this.setHeaders = setHeaders;
            return this;
        }
        @CustomType.Setter
        public Builder untrustedCert(GetPoliciesResultRuleSettingsUntrustedCert untrustedCert) {
            if (untrustedCert == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettings", "untrustedCert");
            }
            this.untrustedCert = untrustedCert;
            return this;
        }
        public GetPoliciesResultRuleSettings build() {
            final var _resultValue = new GetPoliciesResultRuleSettings();
