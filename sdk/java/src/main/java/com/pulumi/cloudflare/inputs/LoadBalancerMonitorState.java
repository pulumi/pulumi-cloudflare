...
public final class LoadBalancerMonitorState extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(LoadBalancerMonitorState defaults) {
    ...
    public static final class Builder {
        ...
        /**
         * @param createdOn The RFC3339 timestamp of when the load balancer monitor was created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param expectedBody A case-insensitive sub-string to look for in the response body. If this string is not found, the origin will be marked as unhealthy. Only valid if `type` is &#34;http&#34; or &#34;https&#34;. Default: &#34;&#34;.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param modifiedOn The RFC3339 timestamp of when the load balancer monitor was last modified.
         * 
         * @return builder
         * 
         */
        ...
        public LoadBalancerMonitorState build() {
            return $;
        }
    }
