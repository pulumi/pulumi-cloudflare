...
public final class GetDnsRecordsComment extends com.pulumi.resources.InvokeArgs {

    public static final GetDnsRecordsComment Empty = new GetDnsRecordsComment();
    ...
    private GetDnsRecordsComment(GetDnsRecordsComment $) {
        this.absent = $.absent;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDnsRecordsComment();
        }

        public Builder(GetDnsRecordsComment defaults) {
            $ = new GetDnsRecordsComment(Objects.requireNonNull(defaults));
        }
