...
public final class GetRoutesResult {
    ...
    public static final class Builder {
        ...
        public Builder comment(String comment) {
            if (comment == null) {
              throw new MissingRequiredPropertyException("GetRoutesResult", "comment");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetRoutesResult", "createdAt");
            }
        ...
        public Builder deletedAt(String deletedAt) {
            if (deletedAt == null) {
              throw new MissingRequiredPropertyException("GetRoutesResult", "deletedAt");
            }
        ...
        public Builder network(String network) {
            if (network == null) {
              throw new MissingRequiredPropertyException("GetRoutesResult", "network");
            }
        ...
        public Builder tunType(String tunType) {
            if (tunType == null) {
              throw new MissingRequiredPropertyException("GetRoutesResult", "tunType");
            }
        ...
        public Builder tunnelId(String tunnelId) {
            if (tunnelId == null) {
              throw new MissingRequiredPropertyException("GetRoutesResult", "tunnelId");
            }
        ...
        public Builder tunnelName(String tunnelName) {
            if (tunnelName == null) {
              throw new MissingRequiredPropertyException("GetRoutesResult", "tunnelName");
            }
        ...
        public Builder virtualNetworkId(String virtualNetworkId) {
            if (virtualNetworkId == null) {
              throw new MissingRequiredPropertyException("GetRoutesResult", "virtualNetworkId");
            }
        ...
        public Builder virtualNetworkName(String virtualNetworkName) {
            if (virtualNetworkName == null) {
              throw new MissingRequiredPropertyException("GetRoutesResult", "virtualNetworkName");
            }
