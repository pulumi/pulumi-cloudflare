...
import com.pulumi.cloudflare.zeroTrustDlpPredefined.inputs.EntryState;
import com.pulumi.cloudflare.zeroTrustDlpPredefined.outputs.EntryConfidence;
import com.pulumi.cloudflare.zeroTrustDlpPredefined.outputs.EntryPattern;
import com.pulumi.cloudflare.zeroTrustDlpPredefined.outputs.EntryProfile;
import com.pulumi.cloudflare.zeroTrustDlpPredefined.outputs.EntryVariant;
 ...
 * 
 */
@ResourceType(type="cloudflare:zeroTrustDlpPredefined/entry:Entry")
public class Entry extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="confidence", refs={EntryConfidence.class}, tree="[0]")
    private Output<EntryConfidence> confidence;

    public Output<EntryConfidence> confidence() {
    ...
    @Export(name="pattern", refs={EntryPattern.class}, tree="[0]")
    private Output<EntryPattern> pattern;

    public Output<EntryPattern> pattern() {
        return this.pattern;
    }
    /**
    ...
    @Export(name="profiles", refs={List.class,EntryProfile.class}, tree="[0,1]")
    private Output<List<EntryProfile>> profiles;

    public Output<List<EntryProfile>> profiles() {
     ...
     * 
     */
    @Export(name="variant", refs={EntryVariant.class}, tree="[0]")
    private Output<EntryVariant> variant;

    /**
     * @return A Predefined AI prompt classification topic entry.
     * 
     */
    public Output<EntryVariant> variant() {
        return this.variant;
    }
    ...
    public Entry(java.lang.String name, EntryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zeroTrustDlpPredefined/entry:Entry", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Entry(java.lang.String name, Output<java.lang.String> id, @Nullable EntryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zeroTrustDlpPredefined/entry:Entry", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/zeroTrustDlpPredefinedEntry:ZeroTrustDlpPredefinedEntry").build())
            ))
            .build();
