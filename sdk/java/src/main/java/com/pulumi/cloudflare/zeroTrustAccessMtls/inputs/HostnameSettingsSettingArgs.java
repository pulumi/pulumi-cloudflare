...
public final class HostnameSettingsSettingArgs extends com.pulumi.resources.ResourceArgs {

    public static final HostnameSettingsSettingArgs Empty = new HostnameSettingsSettingArgs();
    ...
    private HostnameSettingsSettingArgs() {}

    private HostnameSettingsSettingArgs(HostnameSettingsSettingArgs $) {
    ...
    public static Builder builder(HostnameSettingsSettingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HostnameSettingsSettingArgs();
        }

        public Builder(HostnameSettingsSettingArgs defaults) {
            $ = new HostnameSettingsSettingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HostnameSettingsSettingArgs build() {
            if ($.chinaNetwork == null) {
                throw new MissingRequiredPropertyException("HostnameSettingsSettingArgs", "chinaNetwork");
            }
            if ($.clientCertificateForwarding == null) {
                throw new MissingRequiredPropertyException("HostnameSettingsSettingArgs", "clientCertificateForwarding");
            }
            if ($.hostname == null) {
                throw new MissingRequiredPropertyException("HostnameSettingsSettingArgs", "hostname");
            }
            return $;
        }
    }
