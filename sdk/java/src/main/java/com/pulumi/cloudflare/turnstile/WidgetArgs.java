...
public final class WidgetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public WidgetArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("WidgetArgs", "accountId");
            }
            if ($.domains == null) {
                throw new MissingRequiredPropertyException("WidgetArgs", "domains");
            }
            if ($.mode == null) {
                throw new MissingRequiredPropertyException("WidgetArgs", "mode");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("WidgetArgs", "name");
            }
            return $;
        }
    }
