...
public final class MagicWanIpsecTunnelArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param replayProtection Specifies if replay protection is enabled. Defaults to `false`.
         * 
         * @return builder
         * 
         */
        ...
        public MagicWanIpsecTunnelArgs build() {
            ...
            if ($.customerEndpoint == null) {
                throw new MissingRequiredPropertyException("MagicWanIpsecTunnelArgs", "customerEndpoint");
            }
