    ...
    public static final class Builder {
        ...
        public ZoneSettingsOverrideSettingsMobileRedirectArgs build() {
            if ($.mobileSubdomain == null) {
                throw new MissingRequiredPropertyException("ZoneSettingsOverrideSettingsMobileRedirectArgs", "mobileSubdomain");
            }
            if ($.status == null) {
                throw new MissingRequiredPropertyException("ZoneSettingsOverrideSettingsMobileRedirectArgs", "status");
            }
            if ($.stripUri == null) {
                throw new MissingRequiredPropertyException("ZoneSettingsOverrideSettingsMobileRedirectArgs", "stripUri");
            }
            return $;
        }
    }
