...
public final class EntryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<EntryPatternArgs> pattern;

    public Output<EntryPatternArgs> pattern() {
        return this.pattern;
    }
    ...
    public static final class Builder {
        ...
        public Builder pattern(Output<EntryPatternArgs> pattern) {
            $.pattern = pattern;
            return this;
        }
        ...
        public EntryArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("EntryArgs", "accountId");
            }
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("EntryArgs", "enabled");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("EntryArgs", "name");
            }
            if ($.pattern == null) {
                throw new MissingRequiredPropertyException("EntryArgs", "pattern");
            }
            return $;
        }
    }
