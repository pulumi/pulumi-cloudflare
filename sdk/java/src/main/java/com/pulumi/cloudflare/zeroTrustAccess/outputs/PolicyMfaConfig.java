...
@CustomType
public final class PolicyMfaConfig {
    /**
    ...
    public static Builder builder(PolicyMfaConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sessionDuration;
        public Builder() {}
        public Builder(PolicyMfaConfig defaults) {
        ...
        public PolicyMfaConfig build() {
            final var _resultValue = new PolicyMfaConfig();
