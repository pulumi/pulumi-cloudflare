...
@CustomType
public final class SettingsSettingsExtendedEmailMatching {
    /**
    ...
    private SettingsSettingsExtendedEmailMatching() {}
    /**
     * @return Specify whether to match all variants of user emails (with + or . modifiers) used as criteria in Firewall policies.
     * 
     */
    ...
    public static Builder builder(SettingsSettingsExtendedEmailMatching defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer version;
        public Builder() {}
        public Builder(SettingsSettingsExtendedEmailMatching defaults) {
        ...
        public SettingsSettingsExtendedEmailMatching build() {
            final var _resultValue = new SettingsSettingsExtendedEmailMatching();
