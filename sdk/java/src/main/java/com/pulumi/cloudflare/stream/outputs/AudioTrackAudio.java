...
@CustomType
public final class AudioTrackAudio {
    /**
    ...
    public static Builder builder(AudioTrackAudio defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uid;
        public Builder() {}
        public Builder(AudioTrackAudio defaults) {
        ...
        public AudioTrackAudio build() {
            final var _resultValue = new AudioTrackAudio();
