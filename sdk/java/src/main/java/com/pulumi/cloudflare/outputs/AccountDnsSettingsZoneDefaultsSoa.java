...
public final class AccountDnsSettingsZoneDefaultsSoa {
    ...
    public static final class Builder {
        ...
        public Builder expire(Double expire) {
            if (expire == null) {
              throw new MissingRequiredPropertyException("AccountDnsSettingsZoneDefaultsSoa", "expire");
            }
            this.expire = expire;
            return this;
        }
        ...
        public Builder minTtl(Double minTtl) {
            if (minTtl == null) {
              throw new MissingRequiredPropertyException("AccountDnsSettingsZoneDefaultsSoa", "minTtl");
            }
            this.minTtl = minTtl;
            return this;
        }
        ...
        public Builder mname(String mname) {
            if (mname == null) {
              throw new MissingRequiredPropertyException("AccountDnsSettingsZoneDefaultsSoa", "mname");
            }
            this.mname = mname;
            return this;
        }
        ...
        public Builder refresh(Double refresh) {
            if (refresh == null) {
              throw new MissingRequiredPropertyException("AccountDnsSettingsZoneDefaultsSoa", "refresh");
            }
        ...
        public Builder retry(Double retry) {
            if (retry == null) {
              throw new MissingRequiredPropertyException("AccountDnsSettingsZoneDefaultsSoa", "retry");
            }
            this.retry = retry;
            return this;
        }
        ...
        public Builder rname(String rname) {
            if (rname == null) {
              throw new MissingRequiredPropertyException("AccountDnsSettingsZoneDefaultsSoa", "rname");
            }
            this.rname = rname;
            return this;
        }
        ...
        public Builder ttl(Double ttl) {
            if (ttl == null) {
              throw new MissingRequiredPropertyException("AccountDnsSettingsZoneDefaultsSoa", "ttl");
            }
            this.ttl = ttl;
            return this;
        }
