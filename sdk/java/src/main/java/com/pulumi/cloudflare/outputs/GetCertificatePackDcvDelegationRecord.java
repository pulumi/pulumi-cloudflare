...
@CustomType
public final class GetCertificatePackDcvDelegationRecord {
    /**
    ...
    private GetCertificatePackDcvDelegationRecord() {}
    /**
     * @return The CNAME record hostname for DCV delegation.
     * 
     */
    ...
    public static Builder builder(GetCertificatePackDcvDelegationRecord defaults) {
    ...
    public static final class Builder {
        ...
        private String txtValue;
        public Builder() {}
        public Builder(GetCertificatePackDcvDelegationRecord defaults) {
        ...
        public Builder cname(String cname) {
            if (cname == null) {
              throw new MissingRequiredPropertyException("GetCertificatePackDcvDelegationRecord", "cname");
            }
            this.cname = cname;
            return this;
        }
        ...
        public Builder cnameTarget(String cnameTarget) {
            if (cnameTarget == null) {
              throw new MissingRequiredPropertyException("GetCertificatePackDcvDelegationRecord", "cnameTarget");
            }
        ...
        public Builder emails(List<String> emails) {
            if (emails == null) {
              throw new MissingRequiredPropertyException("GetCertificatePackDcvDelegationRecord", "emails");
            }
            this.emails = emails;
            return this;
        }
        ...
        public Builder httpBody(String httpBody) {
            if (httpBody == null) {
              throw new MissingRequiredPropertyException("GetCertificatePackDcvDelegationRecord", "httpBody");
            }
        ...
        public Builder httpUrl(String httpUrl) {
            if (httpUrl == null) {
              throw new MissingRequiredPropertyException("GetCertificatePackDcvDelegationRecord", "httpUrl");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetCertificatePackDcvDelegationRecord", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder txtName(String txtName) {
            if (txtName == null) {
              throw new MissingRequiredPropertyException("GetCertificatePackDcvDelegationRecord", "txtName");
            }
        ...
        public Builder txtValue(String txtValue) {
            if (txtValue == null) {
              throw new MissingRequiredPropertyException("GetCertificatePackDcvDelegationRecord", "txtValue");
            }
            this.txtValue = txtValue;
            return this;
        }
        public GetCertificatePackDcvDelegationRecord build() {
            final var _resultValue = new GetCertificatePackDcvDelegationRecord();
