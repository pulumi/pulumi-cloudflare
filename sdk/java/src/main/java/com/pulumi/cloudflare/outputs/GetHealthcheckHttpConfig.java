...
@CustomType
public final class GetHealthcheckHttpConfig {
    /**
    ...
    private GetHealthcheckHttpConfig() {}
    /**
     * @return Do not validate the certificate when the health check uses HTTPS.
     * 
     */
    ...
    public static Builder builder(GetHealthcheckHttpConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Integer port;
        public Builder() {}
        public Builder(GetHealthcheckHttpConfig defaults) {
        ...
        public Builder allowInsecure(Boolean allowInsecure) {
            if (allowInsecure == null) {
              throw new MissingRequiredPropertyException("GetHealthcheckHttpConfig", "allowInsecure");
            }
        ...
        public Builder expectedBody(String expectedBody) {
            if (expectedBody == null) {
              throw new MissingRequiredPropertyException("GetHealthcheckHttpConfig", "expectedBody");
            }
        ...
        public Builder expectedCodes(List<String> expectedCodes) {
            if (expectedCodes == null) {
              throw new MissingRequiredPropertyException("GetHealthcheckHttpConfig", "expectedCodes");
            }
        ...
        public Builder followRedirects(Boolean followRedirects) {
            if (followRedirects == null) {
              throw new MissingRequiredPropertyException("GetHealthcheckHttpConfig", "followRedirects");
            }
        ...
        public Builder header(Map<String,List<String>> header) {
            if (header == null) {
              throw new MissingRequiredPropertyException("GetHealthcheckHttpConfig", "header");
            }
            this.header = header;
            return this;
        }
        ...
        public Builder method(String method) {
            if (method == null) {
              throw new MissingRequiredPropertyException("GetHealthcheckHttpConfig", "method");
            }
            this.method = method;
            return this;
        }
        ...
        public Builder path(String path) {
            if (path == null) {
              throw new MissingRequiredPropertyException("GetHealthcheckHttpConfig", "path");
            }
            this.path = path;
            return this;
        }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetHealthcheckHttpConfig", "port");
            }
            this.port = port;
            return this;
        }
        public GetHealthcheckHttpConfig build() {
            final var _resultValue = new GetHealthcheckHttpConfig();
