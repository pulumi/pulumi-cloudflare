...
public final class PoolNotificationFilterOriginArgs extends com.pulumi.resources.ResourceArgs {

    public static final PoolNotificationFilterOriginArgs Empty = new PoolNotificationFilterOriginArgs();
    ...
    private PoolNotificationFilterOriginArgs() {}

    private PoolNotificationFilterOriginArgs(PoolNotificationFilterOriginArgs $) {
    ...
    public static Builder builder(PoolNotificationFilterOriginArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PoolNotificationFilterOriginArgs();
        }

        public Builder(PoolNotificationFilterOriginArgs defaults) {
            $ = new PoolNotificationFilterOriginArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PoolNotificationFilterOriginArgs build() {
            return $;
        }
    }
