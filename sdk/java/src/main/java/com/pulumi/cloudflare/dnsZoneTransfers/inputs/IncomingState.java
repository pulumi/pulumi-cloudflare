...
public final class IncomingState extends com.pulumi.resources.ResourceArgs {

    public static final IncomingState Empty = new IncomingState();
    ...
    public static Builder builder(IncomingState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(IncomingState defaults) {
            $ = new IncomingState(Objects.requireNonNull(defaults));
        }
