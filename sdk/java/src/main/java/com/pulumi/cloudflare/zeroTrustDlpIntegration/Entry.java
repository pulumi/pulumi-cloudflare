...
import com.pulumi.cloudflare.zeroTrustDlpIntegration.inputs.EntryState;
import com.pulumi.cloudflare.zeroTrustDlpIntegration.outputs.EntryConfidence;
import com.pulumi.cloudflare.zeroTrustDlpIntegration.outputs.EntryPattern;
import com.pulumi.cloudflare.zeroTrustDlpIntegration.outputs.EntryProfile;
import com.pulumi.cloudflare.zeroTrustDlpIntegration.outputs.EntryVariant;
 ...
 * 
 */
@ResourceType(type="cloudflare:zeroTrustDlpIntegration/entry:Entry")
public class Entry extends com.pulumi.resources.CustomResource {
    ...
    public Entry(java.lang.String name, EntryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zeroTrustDlpIntegration/entry:Entry", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Entry(java.lang.String name, Output<java.lang.String> id, @Nullable EntryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zeroTrustDlpIntegration/entry:Entry", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/zeroTrustDlpIntegrationEntry:ZeroTrustDlpIntegrationEntry").build())
            ))
            .build();
