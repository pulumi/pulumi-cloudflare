...
public final class GetHostnamesResult {
    ...
    public static final class Builder {
        ...
        public Builder createdOn(String createdOn) {
            if (createdOn == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "createdOn");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "description");
            }
        ...
        public Builder dnslink(String dnslink) {
            if (dnslink == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "dnslink");
            }
        ...
        public Builder modifiedOn(String modifiedOn) {
            if (modifiedOn == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "modifiedOn");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder target(String target) {
            if (target == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "target");
            }
            this.target = target;
            return this;
        }
