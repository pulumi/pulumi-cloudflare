...
public final class FirewallRuleActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final FirewallRuleActionArgs Empty = new FirewallRuleActionArgs();
    ...
    private @Nullable Output<FirewallRuleActionResponseArgs> response;
     ...
     * 
     */
    public Optional<Output<FirewallRuleActionResponseArgs>> response() {
    ...
    private FirewallRuleActionArgs() {}

    private FirewallRuleActionArgs(FirewallRuleActionArgs $) {
        this.mode = $.mode;
    ...
    public static Builder builder(FirewallRuleActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirewallRuleActionArgs();
        }

        public Builder(FirewallRuleActionArgs defaults) {
            $ = new FirewallRuleActionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder response(@Nullable Output<FirewallRuleActionResponseArgs> response) {
            $.response = response;
            return this;
        }
         ...
         * 
         */
        public Builder response(FirewallRuleActionResponseArgs response) {
        ...
        public FirewallRuleActionArgs build() {
            return $;
        }
    }
