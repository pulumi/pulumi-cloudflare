...
@CustomType
public final class GetMapsResult {
    /**
    ...
    public static Builder builder(GetMapsResult defaults) {
    ...
    public static final class Builder {
        ...
        private String modifiedAt;
        public Builder() {}
        public Builder(GetMapsResult defaults) {
        ...
        public Builder canDelete(Boolean canDelete) {
            if (canDelete == null) {
              throw new MissingRequiredPropertyException("GetMapsResult", "canDelete");
            }
        ...
        public Builder canModifyIps(Boolean canModifyIps) {
            if (canModifyIps == null) {
              throw new MissingRequiredPropertyException("GetMapsResult", "canModifyIps");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetMapsResult", "createdAt");
            }
        ...
        public Builder defaultSni(String defaultSni) {
            if (defaultSni == null) {
              throw new MissingRequiredPropertyException("GetMapsResult", "defaultSni");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetMapsResult", "description");
            }
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetMapsResult", "enabled");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetMapsResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder modifiedAt(String modifiedAt) {
            if (modifiedAt == null) {
              throw new MissingRequiredPropertyException("GetMapsResult", "modifiedAt");
            }
            this.modifiedAt = modifiedAt;
            return this;
        }
        public GetMapsResult build() {
            final var _resultValue = new GetMapsResult();
