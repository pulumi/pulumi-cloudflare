...
import com.pulumi.cloudflare.zeroTrustDeviceManagedNetworks.outputs.GetListResultConfig;
...
public final class GetListResult {
     ...
     * 
     */
    private GetListResultConfig config;
    /**
     * @return API UUID.
     * 
     */
     ...
     * 
     */
    public GetListResultConfig config() {
        return this.config;
    }
    /**
     * @return API UUID.
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder config(GetListResultConfig config) {
            if (config == null) {
              throw new MissingRequiredPropertyException("GetListResult", "config");
            }
            this.config = config;
            return this;
        }
        ...
        public Builder networkId(String networkId) {
            if (networkId == null) {
              throw new MissingRequiredPropertyException("GetListResult", "networkId");
            }
