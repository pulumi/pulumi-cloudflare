...
import com.pulumi.cloudflare.zeroTrustTunnelCloudflared.outputs.ConfigConfigIngressOriginRequestAccess;
...
@CustomType
public final class ConfigConfigIngressOriginRequest {
    /**
     ...
     * 
     */
    private @Nullable ConfigConfigIngressOriginRequestAccess access;
    /**
    ...
    private ConfigConfigIngressOriginRequest() {}
    /**
     * @return For all L7 requests to this hostname, cloudflared will validate each request&#39;s Cf-Access-Jwt-Assertion request header.
     * 
     */
    public Optional<ConfigConfigIngressOriginRequestAccess> access() {
    ...
    public static Builder builder(ConfigConfigIngressOriginRequest defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer tlsTimeout;
        public Builder() {}
        public Builder(ConfigConfigIngressOriginRequest defaults) {
        ...
        @CustomType.Setter
        public Builder access(@Nullable ConfigConfigIngressOriginRequestAccess access) {
        ...
        public ConfigConfigIngressOriginRequest build() {
            final var _resultValue = new ConfigConfigIngressOriginRequest();
