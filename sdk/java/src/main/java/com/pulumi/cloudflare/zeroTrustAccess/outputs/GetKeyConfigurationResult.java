...
@CustomType
public final class GetKeyConfigurationResult {
    /**
     * @return Identifier.
     * 
     */
    ...
    public static Builder builder(GetKeyConfigurationResult defaults) {
    ...
    public static final class Builder {
        ...
        private String lastKeyRotationAt;
        public Builder() {}
        public Builder(GetKeyConfigurationResult defaults) {
        ...
        public Builder daysUntilNextRotation(Double daysUntilNextRotation) {
            if (daysUntilNextRotation == null) {
              throw new MissingRequiredPropertyException("GetKeyConfigurationResult", "daysUntilNextRotation");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetKeyConfigurationResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder keyRotationIntervalDays(Double keyRotationIntervalDays) {
            if (keyRotationIntervalDays == null) {
              throw new MissingRequiredPropertyException("GetKeyConfigurationResult", "keyRotationIntervalDays");
            }
        ...
        public Builder lastKeyRotationAt(String lastKeyRotationAt) {
            if (lastKeyRotationAt == null) {
              throw new MissingRequiredPropertyException("GetKeyConfigurationResult", "lastKeyRotationAt");
            }
            this.lastKeyRotationAt = lastKeyRotationAt;
            return this;
        }
        public GetKeyConfigurationResult build() {
            final var _resultValue = new GetKeyConfigurationResult();
