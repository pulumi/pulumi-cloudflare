...
public final class GetMoqRelaysArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetMoqRelaysArgs Empty = new GetMoqRelaysArgs();
    ...
    private GetMoqRelaysArgs() {}

    private GetMoqRelaysArgs(GetMoqRelaysArgs $) {
    ...
    public static Builder builder(GetMoqRelaysArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMoqRelaysArgs();
        }

        public Builder(GetMoqRelaysArgs defaults) {
            $ = new GetMoqRelaysArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetMoqRelaysArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetMoqRelaysArgs", "accountId");
            }
            return $;
        }
    }
