...
import com.pulumi.cloudflare.zeroTrustTunnelCloudflared.outputs.ConfigConfigOriginRequestAccess;
...
@CustomType
public final class ConfigConfigOriginRequest {
    /**
     ...
     * 
     */
    private @Nullable ConfigConfigOriginRequestAccess access;
    /**
    ...
    private ConfigConfigOriginRequest() {}
    /**
     * @return For all L7 requests to this hostname, cloudflared will validate each request&#39;s Cf-Access-Jwt-Assertion request header.
     * 
     */
    public Optional<ConfigConfigOriginRequestAccess> access() {
    ...
    public static Builder builder(ConfigConfigOriginRequest defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer tlsTimeout;
        public Builder() {}
        public Builder(ConfigConfigOriginRequest defaults) {
        ...
        @CustomType.Setter
        public Builder access(@Nullable ConfigConfigOriginRequestAccess access) {
        ...
        public ConfigConfigOriginRequest build() {
            final var _resultValue = new ConfigConfigOriginRequest();
