...
public final class ProjectCanonicalDeploymentDeploymentTriggerMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectCanonicalDeploymentDeploymentTriggerMetadataArgs Empty = new ProjectCanonicalDeploymentDeploymentTriggerMetadataArgs();
    ...
    private ProjectCanonicalDeploymentDeploymentTriggerMetadataArgs() {}

    private ProjectCanonicalDeploymentDeploymentTriggerMetadataArgs(ProjectCanonicalDeploymentDeploymentTriggerMetadataArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(ProjectCanonicalDeploymentDeploymentTriggerMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectCanonicalDeploymentDeploymentTriggerMetadataArgs();
        }

        public Builder(ProjectCanonicalDeploymentDeploymentTriggerMetadataArgs defaults) {
            $ = new ProjectCanonicalDeploymentDeploymentTriggerMetadataArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProjectCanonicalDeploymentDeploymentTriggerMetadataArgs build() {
            return $;
        }
    }
