...
public final class AccessGroupExcludeExternalEvaluation {
    ...
    public static final class Builder {
        ...
        public Builder evaluateUrl(String evaluateUrl) {
            if (evaluateUrl == null) {
              throw new MissingRequiredPropertyException("AccessGroupExcludeExternalEvaluation", "evaluateUrl");
            }
        ...
        public Builder keysUrl(String keysUrl) {
            if (keysUrl == null) {
              throw new MissingRequiredPropertyException("AccessGroupExcludeExternalEvaluation", "keysUrl");
            }
