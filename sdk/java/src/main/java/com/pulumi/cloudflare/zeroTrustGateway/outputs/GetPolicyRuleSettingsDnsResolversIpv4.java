...
@CustomType
public final class GetPolicyRuleSettingsDnsResolversIpv4 {
    /**
    ...
    private GetPolicyRuleSettingsDnsResolversIpv4() {}
    /**
     * @return Specify the IPv4 address of the upstream resolver.
     * 
     */
    ...
    public static Builder builder(GetPolicyRuleSettingsDnsResolversIpv4 defaults) {
    ...
    public static final class Builder {
        ...
        private String vnetId;
        public Builder() {}
        public Builder(GetPolicyRuleSettingsDnsResolversIpv4 defaults) {
        ...
        public Builder ip(String ip) {
            if (ip == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsDnsResolversIpv4", "ip");
            }
            this.ip = ip;
            return this;
        }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsDnsResolversIpv4", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder routeThroughPrivateNetwork(Boolean routeThroughPrivateNetwork) {
            if (routeThroughPrivateNetwork == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsDnsResolversIpv4", "routeThroughPrivateNetwork");
            }
        ...
        public Builder vnetId(String vnetId) {
            if (vnetId == null) {
              throw new MissingRequiredPropertyException("GetPolicyRuleSettingsDnsResolversIpv4", "vnetId");
            }
            this.vnetId = vnetId;
            return this;
        }
        public GetPolicyRuleSettingsDnsResolversIpv4 build() {
            final var _resultValue = new GetPolicyRuleSettingsDnsResolversIpv4();
            _resultValue.ip = ip;
