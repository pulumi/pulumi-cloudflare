...
@CustomType
public final class GetZeroTrustAccessPolicyApprovalGroup {
    /**
    ...
    private GetZeroTrustAccessPolicyApprovalGroup() {}
    /**
     * @return The number of approvals needed to obtain access.
     * 
     */
    ...
    public static Builder builder(GetZeroTrustAccessPolicyApprovalGroup defaults) {
    ...
    public static final class Builder {
        ...
        private String emailListUuid;
        public Builder() {}
        public Builder(GetZeroTrustAccessPolicyApprovalGroup defaults) {
        ...
        public Builder approvalsNeeded(Double approvalsNeeded) {
            if (approvalsNeeded == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessPolicyApprovalGroup", "approvalsNeeded");
            }
        ...
        public Builder emailAddresses(List<String> emailAddresses) {
            if (emailAddresses == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessPolicyApprovalGroup", "emailAddresses");
            }
        ...
        public Builder emailListUuid(String emailListUuid) {
            if (emailListUuid == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessPolicyApprovalGroup", "emailListUuid");
            }
            this.emailListUuid = emailListUuid;
            return this;
        }
        public GetZeroTrustAccessPolicyApprovalGroup build() {
            final var _resultValue = new GetZeroTrustAccessPolicyApprovalGroup();
