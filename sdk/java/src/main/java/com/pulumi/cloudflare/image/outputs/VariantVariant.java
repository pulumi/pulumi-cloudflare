...
import com.pulumi.cloudflare.image.outputs.VariantVariantOptions;
...
@CustomType
public final class VariantVariant {
     ...
     * 
     */
    private @Nullable VariantVariantOptions options;
     ...
     * 
     */
    public Optional<VariantVariantOptions> options() {
    ...
    public static Builder builder(VariantVariant defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable VariantVariantOptions options;
        public Builder() {}
        public Builder(VariantVariant defaults) {
        ...
        @CustomType.Setter
        public Builder options(@Nullable VariantVariantOptions options) {

            this.options = options;
            return this;
        }
        public VariantVariant build() {
            final var _resultValue = new VariantVariant();
            _resultValue.id = id;
