...
public final class VariantsValueArgs extends com.pulumi.resources.ResourceArgs {

    public static final VariantsValueArgs Empty = new VariantsValueArgs();
    ...
    private VariantsValueArgs() {}

    private VariantsValueArgs(VariantsValueArgs $) {
        this.avifs = $.avifs;
        this.bmps = $.bmps;
        this.gifs = $.gifs;
        this.jp2s = $.jp2s;
    ...
    public static Builder builder(VariantsValueArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VariantsValueArgs();
        }

        public Builder(VariantsValueArgs defaults) {
            $ = new VariantsValueArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VariantsValueArgs build() {
            return $;
        }
    }
