...
public final class WatermarkArgs extends com.pulumi.resources.ResourceArgs {

    public static final WatermarkArgs Empty = new WatermarkArgs();
    ...
    private WatermarkArgs() {}

    private WatermarkArgs(WatermarkArgs $) {
    ...
    public static Builder builder(WatermarkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WatermarkArgs defaults) {
            $ = new WatermarkArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WatermarkArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("WatermarkArgs", "accountId");
            }
            return $;
        }
    }
