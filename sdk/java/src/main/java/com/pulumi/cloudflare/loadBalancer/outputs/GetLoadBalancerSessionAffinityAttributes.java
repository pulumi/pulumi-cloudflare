...
@CustomType
public final class GetLoadBalancerSessionAffinityAttributes {
    /**
    ...
    private GetLoadBalancerSessionAffinityAttributes() {}
    /**
     * @return Configures the drain duration in seconds. This field is only used when session affinity is enabled on the load balancer.
     * 
     */
    ...
    public static Builder builder(GetLoadBalancerSessionAffinityAttributes defaults) {
    ...
    public static final class Builder {
        ...
        private String zeroDowntimeFailover;
        public Builder() {}
        public Builder(GetLoadBalancerSessionAffinityAttributes defaults) {
        ...
        public Builder drainDuration(Double drainDuration) {
            if (drainDuration == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerSessionAffinityAttributes", "drainDuration");
            }
        ...
        public Builder headers(List<String> headers) {
            if (headers == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerSessionAffinityAttributes", "headers");
            }
        ...
        public Builder requireAllHeaders(Boolean requireAllHeaders) {
            if (requireAllHeaders == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerSessionAffinityAttributes", "requireAllHeaders");
            }
        ...
        public Builder samesite(String samesite) {
            if (samesite == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerSessionAffinityAttributes", "samesite");
            }
        ...
        public Builder secure(String secure) {
            if (secure == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerSessionAffinityAttributes", "secure");
            }
            this.secure = secure;
            return this;
        }
        ...
        public Builder zeroDowntimeFailover(String zeroDowntimeFailover) {
            if (zeroDowntimeFailover == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerSessionAffinityAttributes", "zeroDowntimeFailover");
            }
            this.zeroDowntimeFailover = zeroDowntimeFailover;
            return this;
        }
        public GetLoadBalancerSessionAffinityAttributes build() {
            final var _resultValue = new GetLoadBalancerSessionAffinityAttributes();
