...
@CustomType
public final class PoolNotificationFilterOrigin {
    /**
    ...
    private PoolNotificationFilterOrigin() {}
    /**
     * @return If set true, disable notifications for this type of resource (pool or origin).
     * 
     */
    ...
    public static Builder builder(PoolNotificationFilterOrigin defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean healthy;
        public Builder() {}
        public Builder(PoolNotificationFilterOrigin defaults) {
        ...
        public PoolNotificationFilterOrigin build() {
            final var _resultValue = new PoolNotificationFilterOrigin();
