...
public final class ApiShieldSchemaValidationSettingsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ApiShieldSchemaValidationSettingsArgs build() {
            $.validationDefaultMitigationAction = Objects.requireNonNull($.validationDefaultMitigationAction, "expected parameter 'validationDefaultMitigationAction' to be non-null");
