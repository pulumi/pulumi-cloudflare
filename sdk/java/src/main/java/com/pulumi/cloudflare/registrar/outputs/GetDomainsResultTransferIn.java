...
@CustomType
public final class GetDomainsResultTransferIn {
    /**
    ...
    private GetDomainsResultTransferIn() {}
    /**
     * @return Form of authorization has been accepted by the registrant.
     * Available values: &#34;needed&#34;, &#34;ok&#34;.
     * 
    ...
    public static Builder builder(GetDomainsResultTransferIn defaults) {
    ...
    public static final class Builder {
        ...
        private String unlockDomain;
        public Builder() {}
        public Builder(GetDomainsResultTransferIn defaults) {
        ...
        public Builder acceptFoa(String acceptFoa) {
            if (acceptFoa == null) {
              throw new MissingRequiredPropertyException("GetDomainsResultTransferIn", "acceptFoa");
            }
        ...
        public Builder approveTransfer(String approveTransfer) {
            if (approveTransfer == null) {
              throw new MissingRequiredPropertyException("GetDomainsResultTransferIn", "approveTransfer");
            }
        ...
        public Builder canCancelTransfer(Boolean canCancelTransfer) {
            if (canCancelTransfer == null) {
              throw new MissingRequiredPropertyException("GetDomainsResultTransferIn", "canCancelTransfer");
            }
        ...
        public Builder disablePrivacy(String disablePrivacy) {
            if (disablePrivacy == null) {
              throw new MissingRequiredPropertyException("GetDomainsResultTransferIn", "disablePrivacy");
            }
        ...
        public Builder enterAuthCode(String enterAuthCode) {
            if (enterAuthCode == null) {
              throw new MissingRequiredPropertyException("GetDomainsResultTransferIn", "enterAuthCode");
            }
        ...
        public Builder unlockDomain(String unlockDomain) {
            if (unlockDomain == null) {
              throw new MissingRequiredPropertyException("GetDomainsResultTransferIn", "unlockDomain");
            }
            this.unlockDomain = unlockDomain;
            return this;
        }
        public GetDomainsResultTransferIn build() {
            final var _resultValue = new GetDomainsResultTransferIn();
