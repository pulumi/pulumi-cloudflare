...
public final class AccessGroupRequireAuthContextArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AccessGroupRequireAuthContextArgs() {}

    private AccessGroupRequireAuthContextArgs(AccessGroupRequireAuthContextArgs $) {
        this.acId = $.acId;
        this.id = $.id;
    ...
    public static Builder builder(AccessGroupRequireAuthContextArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessGroupRequireAuthContextArgs();
        }

        public Builder(AccessGroupRequireAuthContextArgs defaults) {
        ...
        public AccessGroupRequireAuthContextArgs build() {
            if ($.acId == null) {
                throw new MissingRequiredPropertyException("AccessGroupRequireAuthContextArgs", "acId");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("AccessGroupRequireAuthContextArgs", "id");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("AccessGroupRequireAuthContextArgs", "identityProviderId");
            }
            return $;
        }
    }
