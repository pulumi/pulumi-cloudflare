...
import com.pulumi.cloudflare.zeroTrustTunnel.outputs.GetWarpConnectorsResult;
...
@CustomType
public final class GetWarpConnectorsInvokeResult {
    /**
     ...
     * 
     */
    private List<GetWarpConnectorsResult> results;
    /**
    ...
    private GetWarpConnectorsInvokeResult() {}
    /**
     * @return Cloudflare account ID
     * 
     */
     ...
     * 
     */
    public List<GetWarpConnectorsResult> results() {
        return this.results;
    }
    /**
     * @return The status of the tunnel. Valid values are `inactive` (tunnel has never been run), `degraded` (tunnel is active and able to serve traffic but in an unhealthy state), `healthy` (tunnel is active and able to serve traffic), or `down` (tunnel can not serve traffic as it has no connections to the Cloudflare Edge).
    ...
    public static Builder builder(GetWarpConnectorsInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String wasInactiveAt;
        public Builder() {}
        public Builder(GetWarpConnectorsInvokeResult defaults) {
        ...
        @CustomType.Setter
        public Builder results(List<GetWarpConnectorsResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetWarpConnectorsInvokeResult", "results");
            }
            this.results = results;
            return this;
        }
        public Builder results(GetWarpConnectorsResult... results) {
        ...
        public GetWarpConnectorsInvokeResult build() {
            final var _resultValue = new GetWarpConnectorsInvokeResult();
