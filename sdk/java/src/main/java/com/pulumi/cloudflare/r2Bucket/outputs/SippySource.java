...
@CustomType
public final class SippySource {
    /**
    ...
    public static Builder builder(SippySource defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String secretAccessKey;
        public Builder() {}
        public Builder(SippySource defaults) {
        ...
        public SippySource build() {
            final var _resultValue = new SippySource();
