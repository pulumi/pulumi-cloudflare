    ...
    public static final class Builder {
        ...
        public Builder identityProviderId(String identityProviderId) {
            if (identityProviderId == null) {
              throw new MissingRequiredPropertyException("ZeroTrustAccessPolicyExcludeOkta", "identityProviderId");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ZeroTrustAccessPolicyExcludeOkta", "name");
            }
            this.name = name;
            return this;
        }
