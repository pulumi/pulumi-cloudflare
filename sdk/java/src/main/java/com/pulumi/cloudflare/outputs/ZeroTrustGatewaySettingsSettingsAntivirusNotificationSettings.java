...
@CustomType
public final class ZeroTrustGatewaySettingsSettingsAntivirusNotificationSettings {
    /**
    ...
    public static Builder builder(ZeroTrustGatewaySettingsSettingsAntivirusNotificationSettings defaults) {
