...
import com.pulumi.cloudflare.zeroTrustAccessInfrastructure.outputs.GetTargetsResult;
...
@CustomType
public final class GetTargetsInvokeResult {
    /**
     ...
     * 
     */
    private List<GetTargetsResult> results;
    /**
    ...
    private GetTargetsInvokeResult() {}
    /**
     * @return Account identifier
     * 
     */
     ...
     * 
     */
    public List<GetTargetsResult> results() {
        return this.results;
    }
    /**
     * @return Filters for targets that have any of the following UUIDs. Specify
    ...
    public static Builder builder(GetTargetsInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String virtualNetworkId;
        public Builder() {}
        public Builder(GetTargetsInvokeResult defaults) {
        ...
        @CustomType.Setter
        public Builder results(List<GetTargetsResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetTargetsInvokeResult", "results");
            }
            this.results = results;
            return this;
        }
        public Builder results(GetTargetsResult... results) {
        ...
        public GetTargetsInvokeResult build() {
            final var _resultValue = new GetTargetsInvokeResult();
