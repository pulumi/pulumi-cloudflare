...
import com.pulumi.cloudflare.certificate.outputs.PackCertificateGeoRestrictions;
...
@CustomType
public final class PackCertificate {
    /**
     ...
     * 
     */
    private @Nullable PackCertificateGeoRestrictions geoRestrictions;
    /**
     ...
     * 
     */
    public Optional<PackCertificateGeoRestrictions> geoRestrictions() {
    ...
    public static Builder builder(PackCertificate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String zoneId;
        public Builder() {}
        public Builder(PackCertificate defaults) {
        ...
        @CustomType.Setter
        public Builder geoRestrictions(@Nullable PackCertificateGeoRestrictions geoRestrictions) {
        ...
        public PackCertificate build() {
            final var _resultValue = new PackCertificate();
