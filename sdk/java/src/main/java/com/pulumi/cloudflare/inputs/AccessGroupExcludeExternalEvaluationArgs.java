...
public final class AccessGroupExcludeExternalEvaluationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AccessGroupExcludeExternalEvaluationArgs build() {
            if ($.evaluateUrl == null) {
                throw new MissingRequiredPropertyException("AccessGroupExcludeExternalEvaluationArgs", "evaluateUrl");
            }
            if ($.keysUrl == null) {
                throw new MissingRequiredPropertyException("AccessGroupExcludeExternalEvaluationArgs", "keysUrl");
            }
            return $;
        }
    }
