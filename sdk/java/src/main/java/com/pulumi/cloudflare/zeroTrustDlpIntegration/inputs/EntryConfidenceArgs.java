...
public final class EntryConfidenceArgs extends com.pulumi.resources.ResourceArgs {

    public static final EntryConfidenceArgs Empty = new EntryConfidenceArgs();
    ...
    private EntryConfidenceArgs() {}

    private EntryConfidenceArgs(EntryConfidenceArgs $) {
    ...
    public static Builder builder(EntryConfidenceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EntryConfidenceArgs();
        }

        public Builder(EntryConfidenceArgs defaults) {
            $ = new EntryConfidenceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EntryConfidenceArgs build() {
            return $;
        }
    }
