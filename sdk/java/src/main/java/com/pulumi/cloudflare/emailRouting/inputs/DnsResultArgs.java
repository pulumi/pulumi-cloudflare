...
import com.pulumi.cloudflare.emailRouting.inputs.DnsResultErrorArgs;
import com.pulumi.cloudflare.emailRouting.inputs.DnsResultRecordArgs;
...
public final class DnsResultArgs extends com.pulumi.resources.ResourceArgs {

    public static final DnsResultArgs Empty = new DnsResultArgs();
    ...
    @Import(name="errors")
    private @Nullable Output<List<DnsResultErrorArgs>> errors;

    public Optional<Output<List<DnsResultErrorArgs>>> errors() {
    ...
    @Import(name="records")
    private @Nullable Output<List<DnsResultRecordArgs>> records;

    public Optional<Output<List<DnsResultRecordArgs>>> records() {
    ...
    private DnsResultArgs() {}

    private DnsResultArgs(DnsResultArgs $) {
    ...
    public static Builder builder(DnsResultArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DnsResultArgs defaults) {
            $ = new DnsResultArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder errors(@Nullable Output<List<DnsResultErrorArgs>> errors) {
            $.errors = errors;
            return this;
        }

        public Builder errors(List<DnsResultErrorArgs> errors) {
            return errors(Output.of(errors));
        }

        public Builder errors(DnsResultErrorArgs... errors) {
        ...
        public Builder records(@Nullable Output<List<DnsResultRecordArgs>> records) {
            $.records = records;
            return this;
        }

        public Builder records(List<DnsResultRecordArgs> records) {
            return records(Output.of(records));
        }

        public Builder records(DnsResultRecordArgs... records) {
