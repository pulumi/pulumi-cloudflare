...
import com.pulumi.cloudflare.outputs.ZeroTrustAccessGroupRequireAzure;
import com.pulumi.cloudflare.outputs.ZeroTrustAccessGroupRequireExternalEvaluation;
import com.pulumi.cloudflare.outputs.ZeroTrustAccessGroupRequireGithub;
...
public final class ZeroTrustAccessGroupRequire {
    ...
    private @Nullable List<ZeroTrustAccessGroupRequireAuthContext> authContexts;
    private @Nullable String authMethod;
    private @Nullable List<ZeroTrustAccessGroupRequireAzure> azures;
    ...
    private @Nullable List<ZeroTrustAccessGroupRequireExternalEvaluation> externalEvaluations;
    private @Nullable List<String> geos;
    private @Nullable List<ZeroTrustAccessGroupRequireGithub> githubs;
    private @Nullable List<String> groups;
    private @Nullable List<ZeroTrustAccessGroupRequireGsuite> gsuites;
    /**
    ...
    private @Nullable List<ZeroTrustAccessGroupRequireOkta> oktas;
    private @Nullable List<ZeroTrustAccessGroupRequireSaml> samls;
    ...
    public List<ZeroTrustAccessGroupRequireAuthContext> authContexts() {
    ...
    public List<ZeroTrustAccessGroupRequireAzure> azures() {
    ...
    public List<ZeroTrustAccessGroupRequireExternalEvaluation> externalEvaluations() {
    ...
    public List<ZeroTrustAccessGroupRequireGithub> githubs() {
        return this.githubs == null ? List.of() : this.githubs;
    }
    public List<String> groups() {
        return this.groups == null ? List.of() : this.groups;
    }
    public List<ZeroTrustAccessGroupRequireGsuite> gsuites() {
    ...
    public List<ZeroTrustAccessGroupRequireOkta> oktas() {
        return this.oktas == null ? List.of() : this.oktas;
    }
    public List<ZeroTrustAccessGroupRequireSaml> samls() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder authContexts(@Nullable List<ZeroTrustAccessGroupRequireAuthContext> authContexts) {

            this.authContexts = authContexts;
            return this;
        }
        public Builder authContexts(ZeroTrustAccessGroupRequireAuthContext... authContexts) {
        ...
        @CustomType.Setter
        public Builder azures(@Nullable List<ZeroTrustAccessGroupRequireAzure> azures) {

            this.azures = azures;
            return this;
        }
        public Builder azures(ZeroTrustAccessGroupRequireAzure... azures) {
        ...
        @CustomType.Setter
        public Builder externalEvaluations(@Nullable List<ZeroTrustAccessGroupRequireExternalEvaluation> externalEvaluations) {

            this.externalEvaluations = externalEvaluations;
            return this;
        }
        public Builder externalEvaluations(ZeroTrustAccessGroupRequireExternalEvaluation... externalEvaluations) {
        ...
        @CustomType.Setter
        public Builder githubs(@Nullable List<ZeroTrustAccessGroupRequireGithub> githubs) {

            this.githubs = githubs;
            return this;
        }
        public Builder githubs(ZeroTrustAccessGroupRequireGithub... githubs) {
        ...
        @CustomType.Setter
        public Builder gsuites(@Nullable List<ZeroTrustAccessGroupRequireGsuite> gsuites) {

            this.gsuites = gsuites;
            return this;
        }
        public Builder gsuites(ZeroTrustAccessGroupRequireGsuite... gsuites) {
        ...
        @CustomType.Setter
        public Builder oktas(@Nullable List<ZeroTrustAccessGroupRequireOkta> oktas) {

            this.oktas = oktas;
            return this;
        }
        public Builder oktas(ZeroTrustAccessGroupRequireOkta... oktas) {
            return oktas(List.of(oktas));
        }
        @CustomType.Setter
        public Builder samls(@Nullable List<ZeroTrustAccessGroupRequireSaml> samls) {

            this.samls = samls;
            return this;
        }
        public Builder samls(ZeroTrustAccessGroupRequireSaml... samls) {
