...
public final class LoggingSettingsByRuleTypeHttpArgs extends com.pulumi.resources.ResourceArgs {

    public static final LoggingSettingsByRuleTypeHttpArgs Empty = new LoggingSettingsByRuleTypeHttpArgs();
    ...
    private LoggingSettingsByRuleTypeHttpArgs() {}

    private LoggingSettingsByRuleTypeHttpArgs(LoggingSettingsByRuleTypeHttpArgs $) {
        this.logAll = $.logAll;
    ...
    public static Builder builder(LoggingSettingsByRuleTypeHttpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoggingSettingsByRuleTypeHttpArgs();
        }

        public Builder(LoggingSettingsByRuleTypeHttpArgs defaults) {
            $ = new LoggingSettingsByRuleTypeHttpArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LoggingSettingsByRuleTypeHttpArgs build() {
            return $;
        }
    }
