...
@CustomType
public final class ServerAuthConfigSummaryConfig {
    ...
    private ServerAuthConfigSummaryConfig() {}
    ...
    public static Builder builder(ServerAuthConfigSummaryConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tokenEndpoint;
        public Builder() {}
        public Builder(ServerAuthConfigSummaryConfig defaults) {
        ...
        public ServerAuthConfigSummaryConfig build() {
            final var _resultValue = new ServerAuthConfigSummaryConfig();
