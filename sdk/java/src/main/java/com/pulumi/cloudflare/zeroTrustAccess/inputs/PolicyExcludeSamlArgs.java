...
public final class PolicyExcludeSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyExcludeSamlArgs Empty = new PolicyExcludeSamlArgs();
    ...
    private PolicyExcludeSamlArgs() {}

    private PolicyExcludeSamlArgs(PolicyExcludeSamlArgs $) {
    ...
    public static Builder builder(PolicyExcludeSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyExcludeSamlArgs();
        }

        public Builder(PolicyExcludeSamlArgs defaults) {
            $ = new PolicyExcludeSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyExcludeSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("PolicyExcludeSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("PolicyExcludeSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("PolicyExcludeSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
