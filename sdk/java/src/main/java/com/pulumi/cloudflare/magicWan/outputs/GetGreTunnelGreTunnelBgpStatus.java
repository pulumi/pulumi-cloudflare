...
@CustomType
public final class GetGreTunnelGreTunnelBgpStatus {
    ...
    private GetGreTunnelGreTunnelBgpStatus() {}
    ...
    public static Builder builder(GetGreTunnelGreTunnelBgpStatus defaults) {
    ...
    public static final class Builder {
        ...
        private String updatedAt;
        public Builder() {}
        public Builder(GetGreTunnelGreTunnelBgpStatus defaults) {
        ...
        public Builder bgpState(String bgpState) {
            if (bgpState == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnelBgpStatus", "bgpState");
            }
        ...
        public Builder cfSpeakerIp(String cfSpeakerIp) {
            if (cfSpeakerIp == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnelBgpStatus", "cfSpeakerIp");
            }
        ...
        public Builder cfSpeakerPort(Integer cfSpeakerPort) {
            if (cfSpeakerPort == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnelBgpStatus", "cfSpeakerPort");
            }
        ...
        public Builder customerSpeakerIp(String customerSpeakerIp) {
            if (customerSpeakerIp == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnelBgpStatus", "customerSpeakerIp");
            }
        ...
        public Builder customerSpeakerPort(Integer customerSpeakerPort) {
            if (customerSpeakerPort == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnelBgpStatus", "customerSpeakerPort");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnelBgpStatus", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder tcpEstablished(Boolean tcpEstablished) {
            if (tcpEstablished == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnelBgpStatus", "tcpEstablished");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGreTunnelGreTunnelBgpStatus", "updatedAt");
            }
            this.updatedAt = updatedAt;
            return this;
        }
        public GetGreTunnelGreTunnelBgpStatus build() {
            final var _resultValue = new GetGreTunnelGreTunnelBgpStatus();
