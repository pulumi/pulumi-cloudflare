    ...
    public static final class Builder {
        ...
        public Builder allowInsecure(Boolean allowInsecure) {
            if (allowInsecure == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "allowInsecure");
            }
        ...
        public Builder consecutiveDown(Integer consecutiveDown) {
            if (consecutiveDown == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "consecutiveDown");
            }
        ...
        public Builder consecutiveUp(Integer consecutiveUp) {
            if (consecutiveUp == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "consecutiveUp");
            }
        ...
        public Builder createdOn(String createdOn) {
            if (createdOn == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "createdOn");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "description");
            }
        ...
        public Builder expectedBody(String expectedBody) {
            if (expectedBody == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "expectedBody");
            }
        ...
        public Builder expectedCodes(String expectedCodes) {
            if (expectedCodes == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "expectedCodes");
            }
        ...
        public Builder followRedirects(Boolean followRedirects) {
            if (followRedirects == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "followRedirects");
            }
        ...
        public Builder header(Map<String,List<String>> header) {
            if (header == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "header");
            }
            this.header = header;
            return this;
        }
        ...
        public Builder interval(Integer interval) {
            if (interval == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "interval");
            }
        ...
        public Builder method(String method) {
            if (method == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "method");
            }
            this.method = method;
            return this;
        }
        ...
        public Builder modifiedOn(String modifiedOn) {
            if (modifiedOn == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "modifiedOn");
            }
        ...
        public Builder path(String path) {
            if (path == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "path");
            }
            this.path = path;
            return this;
        }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder probeZone(String probeZone) {
            if (probeZone == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "probeZone");
            }
        ...
        public Builder retries(Integer retries) {
            if (retries == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "retries");
            }
        ...
        public Builder timeout(Integer timeout) {
            if (timeout == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "timeout");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetMonitorsResult", "type");
            }
            this.type = type;
            return this;
        }
