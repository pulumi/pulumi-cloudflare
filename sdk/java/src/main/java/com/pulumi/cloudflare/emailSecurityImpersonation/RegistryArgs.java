...
public final class RegistryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public RegistryArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("RegistryArgs", "accountId");
            }
            if ($.email == null) {
                throw new MissingRequiredPropertyException("RegistryArgs", "email");
            }
            if ($.isEmailRegex == null) {
                throw new MissingRequiredPropertyException("RegistryArgs", "isEmailRegex");
            }
            if ($.name == null) {
