...
public final class MagicTransitSiteLanState extends com.pulumi.resources.ResourceArgs {

    public static final MagicTransitSiteLanState Empty = new MagicTransitSiteLanState();
    ...
    private MagicTransitSiteLanState() {}
    ...
    public static Builder builder(MagicTransitSiteLanState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagicTransitSiteLanState();
        }

        public Builder(MagicTransitSiteLanState defaults) {
            $ = new MagicTransitSiteLanState(Objects.requireNonNull(defaults));
        }
        ...
        public MagicTransitSiteLanState build() {
            return $;
        }
    }
