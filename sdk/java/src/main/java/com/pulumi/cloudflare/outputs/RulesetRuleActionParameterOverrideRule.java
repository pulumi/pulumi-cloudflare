...
@CustomType
public final class RulesetRuleActionParameterOverrideRule {
    /**
    ...
    private RulesetRuleActionParameterOverrideRule() {}
    /**
     * @return Action to perform in the ruleset rule. Available values: `allow`, `block`, `challenge`, `ddos_dynamic`, `execute`, `force_connection_close`, `js_challenge`, `log`, `log_custom_field`, `managed_challenge`, `redirect`, `rewrite`, `route`, `score`, `set_cache_settings`, `set_config`, `serve_error`, `skip`.
     * 
     */
    ...
    public static Builder builder(RulesetRuleActionParameterOverrideRule defaults) {
    ...
    public static final class Builder {
        ...
        private String sensitivityLevel;
        public Builder() {}
        public Builder(RulesetRuleActionParameterOverrideRule defaults) {
        ...
        public RulesetRuleActionParameterOverrideRule build() {
            final var o = new RulesetRuleActionParameterOverrideRule();
            o.action = action;
            o.enabled = enabled;
            o.id = id;
