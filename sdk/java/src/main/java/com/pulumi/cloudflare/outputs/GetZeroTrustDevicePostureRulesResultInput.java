...
public final class GetZeroTrustDevicePostureRulesResultInput {
    ...
    public static final class Builder {
        ...
        public Builder authStates(List<String> authStates) {
            if (authStates == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustDevicePostureRulesResultInput", "authStates");
            }
        ...
        public Builder updateWindowDays(Double updateWindowDays) {
            if (updateWindowDays == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustDevicePostureRulesResultInput", "updateWindowDays");
            }
