...
package com.pulumi.cloudflare.byoIp.outputs;
...
@CustomType
public final class GetPrefixesResult {
    /**
    ...
    public static Builder builder(GetPrefixesResult defaults) {
    ...
    public static final class Builder {
        ...
        private String rpkiValidationState;
        public Builder() {}
        public Builder(GetPrefixesResult defaults) {
        ...
        public Builder accountId(String accountId) {
            if (accountId == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "accountId");
            }
        ...
        public Builder advertised(Boolean advertised) {
            if (advertised == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "advertised");
            }
        ...
        public Builder advertisedModifiedAt(String advertisedModifiedAt) {
            if (advertisedModifiedAt == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "advertisedModifiedAt");
            }
        ...
        public Builder approved(String approved) {
            if (approved == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "approved");
            }
        ...
        public Builder asn(Integer asn) {
            if (asn == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "asn");
            }
            this.asn = asn;
            return this;
        }
        ...
        public Builder cidr(String cidr) {
            if (cidr == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "cidr");
            }
            this.cidr = cidr;
            return this;
        }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "createdAt");
            }
        ...
        public Builder delegateLoaCreation(Boolean delegateLoaCreation) {
            if (delegateLoaCreation == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "delegateLoaCreation");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "description");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder irrValidationState(String irrValidationState) {
            if (irrValidationState == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "irrValidationState");
            }
        ...
        public Builder loaDocumentId(String loaDocumentId) {
            if (loaDocumentId == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "loaDocumentId");
            }
        ...
        public Builder modifiedAt(String modifiedAt) {
            if (modifiedAt == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "modifiedAt");
            }
        ...
        public Builder onDemandEnabled(Boolean onDemandEnabled) {
            if (onDemandEnabled == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "onDemandEnabled");
            }
        ...
        public Builder onDemandLocked(Boolean onDemandLocked) {
            if (onDemandLocked == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "onDemandLocked");
            }
        ...
        public Builder ownershipValidationState(String ownershipValidationState) {
            if (ownershipValidationState == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "ownershipValidationState");
            }
        ...
        public Builder ownershipValidationToken(String ownershipValidationToken) {
            if (ownershipValidationToken == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "ownershipValidationToken");
            }
        ...
        public Builder rpkiValidationState(String rpkiValidationState) {
            if (rpkiValidationState == null) {
              throw new MissingRequiredPropertyException("GetPrefixesResult", "rpkiValidationState");
            }
            this.rpkiValidationState = rpkiValidationState;
            return this;
        }
        public GetPrefixesResult build() {
            final var _resultValue = new GetPrefixesResult();
