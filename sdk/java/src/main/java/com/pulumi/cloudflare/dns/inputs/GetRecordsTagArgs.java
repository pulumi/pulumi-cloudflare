...
public final class GetRecordsTagArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRecordsTagArgs Empty = new GetRecordsTagArgs();
    ...
    private GetRecordsTagArgs() {}

    private GetRecordsTagArgs(GetRecordsTagArgs $) {
        this.absent = $.absent;
    ...
    public static Builder builder(GetRecordsTagArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRecordsTagArgs();
        }

        public Builder(GetRecordsTagArgs defaults) {
            $ = new GetRecordsTagArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRecordsTagArgs build() {
            return $;
        }
    }
