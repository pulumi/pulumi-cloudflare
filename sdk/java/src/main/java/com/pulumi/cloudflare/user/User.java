...
import com.pulumi.cloudflare.user.inputs.UserState;
import com.pulumi.cloudflare.user.outputs.UserOrganization;
 ...
 * 
 */
@ResourceType(type="cloudflare:user/user:User")
public class User extends com.pulumi.resources.CustomResource {
    ...
    public User(java.lang.String name, @Nullable UserArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:user/user:User", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private User(java.lang.String name, Output<java.lang.String> id, @Nullable UserState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:user/user:User", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/user:User").build())
            ))
            .build();
