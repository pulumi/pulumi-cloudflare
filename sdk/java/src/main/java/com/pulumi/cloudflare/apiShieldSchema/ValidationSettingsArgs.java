...
public final class ValidationSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ValidationSettingsArgs Empty = new ValidationSettingsArgs();
    ...
    private ValidationSettingsArgs() {}

    private ValidationSettingsArgs(ValidationSettingsArgs $) {
    ...
    public static Builder builder(ValidationSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ValidationSettingsArgs();
        }

        public Builder(ValidationSettingsArgs defaults) {
            $ = new ValidationSettingsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ValidationSettingsArgs build() {
            if ($.validationDefaultMitigationAction == null) {
                throw new MissingRequiredPropertyException("ValidationSettingsArgs", "validationDefaultMitigationAction");
            }
            if ($.zoneId == null) {
                throw new MissingRequiredPropertyException("ValidationSettingsArgs", "zoneId");
            }
            return $;
        }
    }
