...
import com.pulumi.cloudflare.loadBalancer.outputs.GetPoolOriginHeader;
...
@CustomType
public final class GetPoolOrigin {
    /**
     ...
     * 
     */
    private GetPoolOriginHeader header;
    /**
     ...
     * 
     */
    public GetPoolOriginHeader header() {
        return this.header;
    }
    /**
     * @return A human-identifiable name for the origin.
    ...
    public static Builder builder(GetPoolOrigin defaults) {
    ...
    public static final class Builder {
        ...
        private Double weight;
        public Builder() {}
        public Builder(GetPoolOrigin defaults) {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetPoolOrigin", "address");
            }
        ...
        public Builder disabledAt(String disabledAt) {
            if (disabledAt == null) {
              throw new MissingRequiredPropertyException("GetPoolOrigin", "disabledAt");
            }
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetPoolOrigin", "enabled");
            }
        ...
        public Builder flattenCname(Boolean flattenCname) {
            if (flattenCname == null) {
              throw new MissingRequiredPropertyException("GetPoolOrigin", "flattenCname");
            }
            this.flattenCname = flattenCname;
            return this;
        }
        @CustomType.Setter
        public Builder header(GetPoolOriginHeader header) {
            if (header == null) {
              throw new MissingRequiredPropertyException("GetPoolOrigin", "header");
            }
            this.header = header;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetPoolOrigin", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetPoolOrigin", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder virtualNetworkId(String virtualNetworkId) {
            if (virtualNetworkId == null) {
              throw new MissingRequiredPropertyException("GetPoolOrigin", "virtualNetworkId");
            }
        ...
        public Builder weight(Double weight) {
            if (weight == null) {
              throw new MissingRequiredPropertyException("GetPoolOrigin", "weight");
            }
            this.weight = weight;
            return this;
        }
        public GetPoolOrigin build() {
            final var _resultValue = new GetPoolOrigin();
