...
@CustomType
public final class ZeroTrustDlpPredefinedEntryConfidence {
    /**
    ...
    private ZeroTrustDlpPredefinedEntryConfidence() {}
    /**
     * @return Indicates whether this entry has AI remote service validation.
     * 
     */
    ...
    public static Builder builder(ZeroTrustDlpPredefinedEntryConfidence defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean available;
        public Builder() {}
        public Builder(ZeroTrustDlpPredefinedEntryConfidence defaults) {
        ...
        public ZeroTrustDlpPredefinedEntryConfidence build() {
            final var _resultValue = new ZeroTrustDlpPredefinedEntryConfidence();
