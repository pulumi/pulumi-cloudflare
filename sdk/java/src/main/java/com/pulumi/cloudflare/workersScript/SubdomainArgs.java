...
public final class SubdomainArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public SubdomainArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("SubdomainArgs", "accountId");
            }
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("SubdomainArgs", "enabled");
            }
            if ($.scriptName == null) {
                throw new MissingRequiredPropertyException("SubdomainArgs", "scriptName");
            }
            return $;
        }
    }
