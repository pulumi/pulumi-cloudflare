...
@CustomType
public final class LockdownConfiguration {
    /**
    ...
    public static Builder builder(LockdownConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(LockdownConfiguration defaults) {
        ...
        public LockdownConfiguration build() {
            final var _resultValue = new LockdownConfiguration();
