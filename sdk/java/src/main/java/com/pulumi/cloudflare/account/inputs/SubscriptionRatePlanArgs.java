...
public final class SubscriptionRatePlanArgs extends com.pulumi.resources.ResourceArgs {

    public static final SubscriptionRatePlanArgs Empty = new SubscriptionRatePlanArgs();
    ...
    private SubscriptionRatePlanArgs() {}

    private SubscriptionRatePlanArgs(SubscriptionRatePlanArgs $) {
    ...
    public static Builder builder(SubscriptionRatePlanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SubscriptionRatePlanArgs();
        }

        public Builder(SubscriptionRatePlanArgs defaults) {
            $ = new SubscriptionRatePlanArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SubscriptionRatePlanArgs build() {
            return $;
        }
    }
