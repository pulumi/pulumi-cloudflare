...
public final class GetStoresResult {
    ...
    public static final class Builder {
        ...
        public Builder certificate(String certificate) {
            if (certificate == null) {
              throw new MissingRequiredPropertyException("GetStoresResult", "certificate");
            }
        ...
        public Builder expiresOn(String expiresOn) {
            if (expiresOn == null) {
              throw new MissingRequiredPropertyException("GetStoresResult", "expiresOn");
            }
        ...
        public Builder issuer(String issuer) {
            if (issuer == null) {
              throw new MissingRequiredPropertyException("GetStoresResult", "issuer");
            }
            this.issuer = issuer;
            return this;
        }
        ...
        public Builder signature(String signature) {
            if (signature == null) {
              throw new MissingRequiredPropertyException("GetStoresResult", "signature");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetStoresResult", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetStoresResult", "updatedAt");
            }
        ...
        public Builder uploadedOn(String uploadedOn) {
            if (uploadedOn == null) {
              throw new MissingRequiredPropertyException("GetStoresResult", "uploadedOn");
            }
