...
import com.pulumi.cloudflare.r2.inputs.CustomDomainStatusArgs;
...
public final class CustomDomainState extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="status")
    private @Nullable Output<CustomDomainStatusArgs> status;

    public Optional<Output<CustomDomainStatusArgs>> status() {
    ...
    public static final class Builder {
        ...
        public Builder status(@Nullable Output<CustomDomainStatusArgs> status) {
            $.status = status;
            return this;
        }

        public Builder status(CustomDomainStatusArgs status) {
