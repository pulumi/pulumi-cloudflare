...
@CustomType
public final class ConnectorDevice {
    ...
    public static Builder builder(ConnectorDevice defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String serialNumber;
        public Builder() {}
        public Builder(ConnectorDevice defaults) {
        ...
        public ConnectorDevice build() {
            final var _resultValue = new ConnectorDevice();
            _resultValue.id = id;
