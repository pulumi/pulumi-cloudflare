...
import com.pulumi.cloudflare.outputs.AccessPolicyMfaConfig;
...
public class AccessPolicy extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="mfaConfig", refs={AccessPolicyMfaConfig.class}, tree="[0]")
    private Output</* @Nullable */ AccessPolicyMfaConfig> mfaConfig;

    /**
     * @return Configures multi-factor authentication (MFA) settings.
     * 
     */
    public Output<Optional<AccessPolicyMfaConfig>> mfaConfig() {
