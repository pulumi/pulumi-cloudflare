...
public final class FirewallArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<FirewallAttackMitigationArgs> attackMitigation;

    /**
     * @return Attack mitigation settings
     * 
     */
    public Optional<Output<FirewallAttackMitigationArgs>> attackMitigation() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder attackMitigation(@Nullable Output<FirewallAttackMitigationArgs> attackMitigation) {
         ...
         * 
         */
        public Builder attackMitigation(FirewallAttackMitigationArgs attackMitigation) {
        ...
        public FirewallArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("FirewallArgs", "accountId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("FirewallArgs", "name");
            }
            if ($.upstreamIps == null) {
                throw new MissingRequiredPropertyException("FirewallArgs", "upstreamIps");
            }
            return $;
        }
    }
