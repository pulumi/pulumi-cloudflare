 ...
 *                 .dhcp_relay(Map.of("serverAddresses", List.of("192.0.2.1")))
 *                 .dhcp_server(Map.ofEntries(
 *                     Map.entry("dhcpPoolEnd", "192.0.2.1"),
 *                     Map.entry("dhcpPoolStart", "192.0.2.1"),
 *                     Map.entry("dnsServer", "192.0.2.1"),
 *                     Map.entry("dnsServers", List.of("192.0.2.1")),
 *                     Map.entry("reservations", Map.ofEntries(
