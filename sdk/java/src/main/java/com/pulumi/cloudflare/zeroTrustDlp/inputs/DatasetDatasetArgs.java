...
import com.pulumi.cloudflare.zeroTrustDlp.inputs.DatasetDatasetColumnArgs;
import com.pulumi.cloudflare.zeroTrustDlp.inputs.DatasetDatasetUploadArgs;
...
public final class DatasetDatasetArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatasetDatasetArgs Empty = new DatasetDatasetArgs();
    ...
    @Import(name="columns")
    private @Nullable Output<List<DatasetDatasetColumnArgs>> columns;

    public Optional<Output<List<DatasetDatasetColumnArgs>>> columns() {
    ...
    @Import(name="uploads")
    private @Nullable Output<List<DatasetDatasetUploadArgs>> uploads;

    public Optional<Output<List<DatasetDatasetUploadArgs>>> uploads() {
        return Optional.ofNullable(this.uploads);
    }

    private DatasetDatasetArgs() {}

    private DatasetDatasetArgs(DatasetDatasetArgs $) {
    ...
    public static Builder builder(DatasetDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatasetDatasetArgs();
        }

        public Builder(DatasetDatasetArgs defaults) {
            $ = new DatasetDatasetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder columns(@Nullable Output<List<DatasetDatasetColumnArgs>> columns) {
            $.columns = columns;
            return this;
        }

        public Builder columns(List<DatasetDatasetColumnArgs> columns) {
            return columns(Output.of(columns));
        }

        public Builder columns(DatasetDatasetColumnArgs... columns) {
        ...
        public Builder uploads(@Nullable Output<List<DatasetDatasetUploadArgs>> uploads) {
            $.uploads = uploads;
            return this;
        }

        public Builder uploads(List<DatasetDatasetUploadArgs> uploads) {
            return uploads(Output.of(uploads));
        }

        public Builder uploads(DatasetDatasetUploadArgs... uploads) {
            return uploads(List.of(uploads));
        }

        public DatasetDatasetArgs build() {
            return $;
        }
    }
