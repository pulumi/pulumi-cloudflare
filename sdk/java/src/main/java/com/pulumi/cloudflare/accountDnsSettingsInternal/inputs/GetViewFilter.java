...
import com.pulumi.cloudflare.accountDnsSettingsInternal.inputs.GetViewFilterName;
...
public final class GetViewFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetViewFilter Empty = new GetViewFilter();
    ...
    @Import(name="name")
    private @Nullable GetViewFilterName name;

    public Optional<GetViewFilterName> name() {
    ...
    private GetViewFilter(GetViewFilter $) {
    ...
    public static Builder builder(GetViewFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetViewFilter defaults) {
            $ = new GetViewFilter(Objects.requireNonNull(defaults));
        }
        ...
        public Builder name(@Nullable GetViewFilterName name) {
            $.name = name;
            return this;
        }
        ...
        public GetViewFilter build() {
            if ($.direction == null) {
                throw new MissingRequiredPropertyException("GetViewFilter", "direction");
            }
            if ($.match == null) {
                throw new MissingRequiredPropertyException("GetViewFilter", "match");
            }
            return $;
        }
    }
