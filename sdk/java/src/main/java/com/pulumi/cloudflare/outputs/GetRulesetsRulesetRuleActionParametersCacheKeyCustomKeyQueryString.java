...
public final class GetRulesetsRulesetRuleActionParametersCacheKeyCustomKeyQueryString {
    ...
    public static Builder builder(GetRulesetsRulesetRuleActionParametersCacheKeyCustomKeyQueryString defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(GetRulesetsRulesetRuleActionParametersCacheKeyCustomKeyQueryString defaults) {
