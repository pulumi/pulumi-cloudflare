...
public final class PolicyIncludeExternalEvaluationArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyIncludeExternalEvaluationArgs Empty = new PolicyIncludeExternalEvaluationArgs();
    ...
    private PolicyIncludeExternalEvaluationArgs() {}

    private PolicyIncludeExternalEvaluationArgs(PolicyIncludeExternalEvaluationArgs $) {
    ...
    public static Builder builder(PolicyIncludeExternalEvaluationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyIncludeExternalEvaluationArgs();
        }

        public Builder(PolicyIncludeExternalEvaluationArgs defaults) {
            $ = new PolicyIncludeExternalEvaluationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyIncludeExternalEvaluationArgs build() {
            if ($.evaluateUrl == null) {
                throw new MissingRequiredPropertyException("PolicyIncludeExternalEvaluationArgs", "evaluateUrl");
            }
            if ($.keysUrl == null) {
                throw new MissingRequiredPropertyException("PolicyIncludeExternalEvaluationArgs", "keysUrl");
            }
            return $;
        }
    }
