...
public final class GetBindingsResult {
    ...
    public static final class Builder {
        ...
        public Builder cidr(String cidr) {
            if (cidr == null) {
              throw new MissingRequiredPropertyException("GetBindingsResult", "cidr");
            }
            this.cidr = cidr;
            return this;
        }
        ...
        public Builder prefixId(String prefixId) {
            if (prefixId == null) {
              throw new MissingRequiredPropertyException("GetBindingsResult", "prefixId");
            }
        ...
        public Builder regionKey(String regionKey) {
            if (regionKey == null) {
              throw new MissingRequiredPropertyException("GetBindingsResult", "regionKey");
            }
