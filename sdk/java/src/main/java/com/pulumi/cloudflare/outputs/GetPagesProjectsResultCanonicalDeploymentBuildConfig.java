...
@CustomType
public final class GetPagesProjectsResultCanonicalDeploymentBuildConfig {
    /**
    ...
    private GetPagesProjectsResultCanonicalDeploymentBuildConfig() {}
    /**
     * @return Enable build caching for the project.
     * 
     */
    ...
    public static Builder builder(GetPagesProjectsResultCanonicalDeploymentBuildConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String webAnalyticsToken;
        public Builder() {}
        public Builder(GetPagesProjectsResultCanonicalDeploymentBuildConfig defaults) {
        ...
        public Builder buildCaching(Boolean buildCaching) {
            if (buildCaching == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultCanonicalDeploymentBuildConfig", "buildCaching");
            }
        ...
        public Builder buildCommand(String buildCommand) {
            if (buildCommand == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultCanonicalDeploymentBuildConfig", "buildCommand");
            }
        ...
        public Builder destinationDir(String destinationDir) {
            if (destinationDir == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultCanonicalDeploymentBuildConfig", "destinationDir");
            }
        ...
        public Builder rootDir(String rootDir) {
            if (rootDir == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultCanonicalDeploymentBuildConfig", "rootDir");
            }
        ...
        public Builder webAnalyticsTag(String webAnalyticsTag) {
            if (webAnalyticsTag == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultCanonicalDeploymentBuildConfig", "webAnalyticsTag");
            }
        ...
        public Builder webAnalyticsToken(String webAnalyticsToken) {
            if (webAnalyticsToken == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultCanonicalDeploymentBuildConfig", "webAnalyticsToken");
            }
            this.webAnalyticsToken = webAnalyticsToken;
            return this;
        }
        public GetPagesProjectsResultCanonicalDeploymentBuildConfig build() {
            final var _resultValue = new GetPagesProjectsResultCanonicalDeploymentBuildConfig();
