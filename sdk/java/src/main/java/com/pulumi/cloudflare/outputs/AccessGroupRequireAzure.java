...
@CustomType
public final class AccessGroupRequireAzure {
    /**
    ...
    public static Builder builder(AccessGroupRequireAzure defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> ids;
        public Builder() {}
        public Builder(AccessGroupRequireAzure defaults) {
