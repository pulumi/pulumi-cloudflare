...
public final class GetZeroTrustTunnelWarpConnectorFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetZeroTrustTunnelWarpConnectorFilter Empty = new GetZeroTrustTunnelWarpConnectorFilter();
    ...
    private GetZeroTrustTunnelWarpConnectorFilter() {}

    private GetZeroTrustTunnelWarpConnectorFilter(GetZeroTrustTunnelWarpConnectorFilter $) {
    ...
    public static Builder builder(GetZeroTrustTunnelWarpConnectorFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetZeroTrustTunnelWarpConnectorFilter();
        }

        public Builder(GetZeroTrustTunnelWarpConnectorFilter defaults) {
            $ = new GetZeroTrustTunnelWarpConnectorFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetZeroTrustTunnelWarpConnectorFilter build() {
            return $;
        }
    }
