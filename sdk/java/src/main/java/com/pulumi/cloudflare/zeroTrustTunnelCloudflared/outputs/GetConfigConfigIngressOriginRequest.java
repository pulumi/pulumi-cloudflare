...
import com.pulumi.cloudflare.zeroTrustTunnelCloudflared.outputs.GetConfigConfigIngressOriginRequestAccess;
...
@CustomType
public final class GetConfigConfigIngressOriginRequest {
    /**
     ...
     * 
     */
    private GetConfigConfigIngressOriginRequestAccess access;
    /**
    ...
    private GetConfigConfigIngressOriginRequest() {}
    /**
     * @return For all L7 requests to this hostname, cloudflared will validate each request&#39;s Cf-Access-Jwt-Assertion request header.
     * 
     */
    public GetConfigConfigIngressOriginRequestAccess access() {
        return this.access;
    }
    /**
     * @return Path to the certificate authority (CA) for the certificate of your origin. This option should be used only if your certificate is not signed by Cloudflare.
    ...
    public static Builder builder(GetConfigConfigIngressOriginRequest defaults) {
    ...
    public static final class Builder {
        ...
        private Integer tlsTimeout;
        public Builder() {}
        public Builder(GetConfigConfigIngressOriginRequest defaults) {
        ...
        @CustomType.Setter
        public Builder access(GetConfigConfigIngressOriginRequestAccess access) {
            if (access == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigIngressOriginRequest", "access");
            }
            this.access = access;
            return this;
        }
        ...
        public Builder caPool(String caPool) {
            if (caPool == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigIngressOriginRequest", "caPool");
            }
            this.caPool = caPool;
            return this;
        }
        ...
        public Builder connectTimeout(Integer connectTimeout) {
            if (connectTimeout == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigIngressOriginRequest", "connectTimeout");
            }
        ...
        public Builder disableChunkedEncoding(Boolean disableChunkedEncoding) {
            if (disableChunkedEncoding == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigIngressOriginRequest", "disableChunkedEncoding");
            }
        ...
        public Builder http2Origin(Boolean http2Origin) {
            if (http2Origin == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigIngressOriginRequest", "http2Origin");
            }
        ...
        public Builder httpHostHeader(String httpHostHeader) {
            if (httpHostHeader == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigIngressOriginRequest", "httpHostHeader");
            }
        ...
        public Builder keepAliveConnections(Integer keepAliveConnections) {
            if (keepAliveConnections == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigIngressOriginRequest", "keepAliveConnections");
            }
        ...
        public Builder keepAliveTimeout(Integer keepAliveTimeout) {
            if (keepAliveTimeout == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigIngressOriginRequest", "keepAliveTimeout");
            }
        ...
        public Builder matchSnItoHost(Boolean matchSnItoHost) {
            if (matchSnItoHost == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigIngressOriginRequest", "matchSnItoHost");
            }
        ...
        public Builder noHappyEyeballs(Boolean noHappyEyeballs) {
            if (noHappyEyeballs == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigIngressOriginRequest", "noHappyEyeballs");
            }
        ...
        public Builder noTlsVerify(Boolean noTlsVerify) {
            if (noTlsVerify == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigIngressOriginRequest", "noTlsVerify");
            }
        ...
        public Builder originServerName(String originServerName) {
            if (originServerName == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigIngressOriginRequest", "originServerName");
            }
        ...
        public Builder proxyType(String proxyType) {
            if (proxyType == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigIngressOriginRequest", "proxyType");
            }
        ...
        public Builder tcpKeepAlive(Integer tcpKeepAlive) {
            if (tcpKeepAlive == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigIngressOriginRequest", "tcpKeepAlive");
            }
        ...
        public Builder tlsTimeout(Integer tlsTimeout) {
            if (tlsTimeout == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigIngressOriginRequest", "tlsTimeout");
            }
            this.tlsTimeout = tlsTimeout;
            return this;
        }
        public GetConfigConfigIngressOriginRequest build() {
            final var _resultValue = new GetConfigConfigIngressOriginRequest();
