 ...
 * 
 * @deprecated
 * cloudflare:index/zeroTrustOrganization:ZeroTrustOrganization has been deprecated in favor of cloudflare:zeroTrust/organization:Organization
 * 
 */
...
public class ZeroTrustOrganization extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="mfaConfig", refs={ZeroTrustOrganizationMfaConfig.class}, tree="[0]")
    private Output</* @Nullable */ ZeroTrustOrganizationMfaConfig> mfaConfig;

    /**
     * @return Configures multi-factor authentication (MFA) settings for an organization.
     * 
     */
    public Output<Optional<ZeroTrustOrganizationMfaConfig>> mfaConfig() {
