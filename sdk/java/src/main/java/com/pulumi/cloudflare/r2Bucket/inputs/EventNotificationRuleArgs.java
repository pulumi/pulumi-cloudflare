...
public final class EventNotificationRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final EventNotificationRuleArgs Empty = new EventNotificationRuleArgs();
    ...
    private EventNotificationRuleArgs() {}

    private EventNotificationRuleArgs(EventNotificationRuleArgs $) {
    ...
    public static Builder builder(EventNotificationRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EventNotificationRuleArgs();
        }

        public Builder(EventNotificationRuleArgs defaults) {
            $ = new EventNotificationRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EventNotificationRuleArgs build() {
            if ($.actions == null) {
                throw new MissingRequiredPropertyException("EventNotificationRuleArgs", "actions");
            }
            return $;
        }
    }
