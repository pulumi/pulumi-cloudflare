...
@CustomType
public final class GetConsumerSettings {
    /**
    ...
    public static Builder builder(GetConsumerSettings defaults) {
    ...
    public static final class Builder {
        ...
        private Double visibilityTimeoutMs;
        public Builder() {}
        public Builder(GetConsumerSettings defaults) {
        ...
        public Builder batchSize(Double batchSize) {
            if (batchSize == null) {
              throw new MissingRequiredPropertyException("GetConsumerSettings", "batchSize");
            }
        ...
        public Builder maxConcurrency(Double maxConcurrency) {
            if (maxConcurrency == null) {
              throw new MissingRequiredPropertyException("GetConsumerSettings", "maxConcurrency");
            }
        ...
        public Builder maxRetries(Double maxRetries) {
            if (maxRetries == null) {
              throw new MissingRequiredPropertyException("GetConsumerSettings", "maxRetries");
            }
        ...
        public Builder maxWaitTimeMs(Double maxWaitTimeMs) {
            if (maxWaitTimeMs == null) {
              throw new MissingRequiredPropertyException("GetConsumerSettings", "maxWaitTimeMs");
            }
        ...
        public Builder retryDelay(Double retryDelay) {
            if (retryDelay == null) {
              throw new MissingRequiredPropertyException("GetConsumerSettings", "retryDelay");
            }
        ...
        public Builder visibilityTimeoutMs(Double visibilityTimeoutMs) {
            if (visibilityTimeoutMs == null) {
              throw new MissingRequiredPropertyException("GetConsumerSettings", "visibilityTimeoutMs");
            }
            this.visibilityTimeoutMs = visibilityTimeoutMs;
            return this;
        }
        public GetConsumerSettings build() {
            final var _resultValue = new GetConsumerSettings();
