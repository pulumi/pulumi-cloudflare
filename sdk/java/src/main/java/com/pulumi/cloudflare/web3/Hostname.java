...
import com.pulumi.cloudflare.web3.inputs.HostnameState;
 ...
 * 
 */
@ResourceType(type="cloudflare:web3/hostname:Hostname")
public class Hostname extends com.pulumi.resources.CustomResource {
    ...
    public Hostname(java.lang.String name, HostnameArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:web3/hostname:Hostname", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Hostname(java.lang.String name, Output<java.lang.String> id, @Nullable HostnameState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:web3/hostname:Hostname", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/web3Hostname:Web3Hostname").build())
            ))
            .build();
