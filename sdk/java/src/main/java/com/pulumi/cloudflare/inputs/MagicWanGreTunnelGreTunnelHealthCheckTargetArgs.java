...
public final class MagicWanGreTunnelGreTunnelHealthCheckTargetArgs extends com.pulumi.resources.ResourceArgs {

    public static final MagicWanGreTunnelGreTunnelHealthCheckTargetArgs Empty = new MagicWanGreTunnelGreTunnelHealthCheckTargetArgs();
    ...
    private MagicWanGreTunnelGreTunnelHealthCheckTargetArgs() {}

    private MagicWanGreTunnelGreTunnelHealthCheckTargetArgs(MagicWanGreTunnelGreTunnelHealthCheckTargetArgs $) {
    ...
    public static Builder builder(MagicWanGreTunnelGreTunnelHealthCheckTargetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagicWanGreTunnelGreTunnelHealthCheckTargetArgs();
        }

        public Builder(MagicWanGreTunnelGreTunnelHealthCheckTargetArgs defaults) {
            $ = new MagicWanGreTunnelGreTunnelHealthCheckTargetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MagicWanGreTunnelGreTunnelHealthCheckTargetArgs build() {
            return $;
        }
    }
