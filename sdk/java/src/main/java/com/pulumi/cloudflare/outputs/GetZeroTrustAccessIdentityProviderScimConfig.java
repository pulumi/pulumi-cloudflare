...
@CustomType
public final class GetZeroTrustAccessIdentityProviderScimConfig {
    /**
    ...
    private GetZeroTrustAccessIdentityProviderScimConfig() {}
    /**
     * @return A flag to enable or disable SCIM for the identity provider.
     * 
     */
    ...
    public static Builder builder(GetZeroTrustAccessIdentityProviderScimConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean userDeprovision;
        public Builder() {}
        public Builder(GetZeroTrustAccessIdentityProviderScimConfig defaults) {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessIdentityProviderScimConfig", "enabled");
            }
        ...
        public Builder identityUpdateBehavior(String identityUpdateBehavior) {
            if (identityUpdateBehavior == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessIdentityProviderScimConfig", "identityUpdateBehavior");
            }
        ...
        public Builder scimBaseUrl(String scimBaseUrl) {
            if (scimBaseUrl == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessIdentityProviderScimConfig", "scimBaseUrl");
            }
        ...
        public Builder seatDeprovision(Boolean seatDeprovision) {
            if (seatDeprovision == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessIdentityProviderScimConfig", "seatDeprovision");
            }
        ...
        public Builder secret(String secret) {
            if (secret == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessIdentityProviderScimConfig", "secret");
            }
            this.secret = secret;
            return this;
        }
        ...
        public Builder userDeprovision(Boolean userDeprovision) {
            if (userDeprovision == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessIdentityProviderScimConfig", "userDeprovision");
            }
            this.userDeprovision = userDeprovision;
            return this;
        }
        public GetZeroTrustAccessIdentityProviderScimConfig build() {
            final var _resultValue = new GetZeroTrustAccessIdentityProviderScimConfig();
