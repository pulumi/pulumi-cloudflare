...
public final class MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs extends com.pulumi.resources.ResourceArgs {

    public static final MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs Empty = new MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs();
    ...
    private MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs() {}

    private MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs(MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs $) {
    ...
    public static Builder builder(MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs();
        }

        public Builder(MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs defaults) {
            $ = new MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs build() {
            return $;
        }
    }
