...
import com.pulumi.cloudflare.magicTransitSite.outputs.GetAclLan1;
import com.pulumi.cloudflare.magicTransitSite.outputs.GetAclLan2;
...
public final class GetAclResult {
     ...
     */
    private String id;
    private GetAclLan1 lan1;
    private GetAclLan2 lan2;
    /**
    ...
    public GetAclLan1 lan1() {
        return this.lan1;
    }
    public GetAclLan2 lan2() {
        return this.lan2;
    }
    /**
     * @return The name of the ACL.
    ...
    public static final class Builder {
        ...
        public Builder accountId(String accountId) {
            if (accountId == null) {
              throw new MissingRequiredPropertyException("GetAclResult", "accountId");
            }
        ...
        public Builder forwardLocally(Boolean forwardLocally) {
            if (forwardLocally == null) {
              throw new MissingRequiredPropertyException("GetAclResult", "forwardLocally");
            }
        ...
        @CustomType.Setter
        public Builder lan1(GetAclLan1 lan1) {
            if (lan1 == null) {
              throw new MissingRequiredPropertyException("GetAclResult", "lan1");
            }
            this.lan1 = lan1;
            return this;
        }
        @CustomType.Setter
        public Builder lan2(GetAclLan2 lan2) {
            if (lan2 == null) {
              throw new MissingRequiredPropertyException("GetAclResult", "lan2");
            }
            this.lan2 = lan2;
            return this;
        }
        ...
        public Builder protocols(List<String> protocols) {
            if (protocols == null) {
              throw new MissingRequiredPropertyException("GetAclResult", "protocols");
            }
        ...
        public Builder siteId(String siteId) {
            if (siteId == null) {
              throw new MissingRequiredPropertyException("GetAclResult", "siteId");
            }
            this.siteId = siteId;
            return this;
        }
        ...
        public Builder unidirectional(Boolean unidirectional) {
            if (unidirectional == null) {
              throw new MissingRequiredPropertyException("GetAclResult", "unidirectional");
            }
