...
@CustomType
public final class AccessGroupExcludeAzure {
    /**
    ...
    public static Builder builder(AccessGroupExcludeAzure defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> ids;
        public Builder() {}
        public Builder(AccessGroupExcludeAzure defaults) {
