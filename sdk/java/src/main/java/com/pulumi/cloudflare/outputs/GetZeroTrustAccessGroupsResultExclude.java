...
import com.pulumi.cloudflare.outputs.GetZeroTrustAccessGroupsResultExcludeCloudflareAccountMember;
...
import com.pulumi.cloudflare.outputs.GetZeroTrustAccessGroupsResultExcludeLinkedAppToken;
import com.pulumi.cloudflare.outputs.GetZeroTrustAccessGroupsResultExcludeLoginMethod;
import com.pulumi.cloudflare.outputs.GetZeroTrustAccessGroupsResultExcludeOidc;
...
import com.pulumi.cloudflare.outputs.GetZeroTrustAccessGroupsResultExcludeUserRiskScore;
...
public final class GetZeroTrustAccessGroupsResultExclude {
    ...
    private GetZeroTrustAccessGroupsResultExcludeCloudflareAccountMember cloudflareAccountMember;
    ...
    private GetZeroTrustAccessGroupsResultExcludeLinkedAppToken linkedAppToken;
    private GetZeroTrustAccessGroupsResultExcludeLoginMethod loginMethod;
    private GetZeroTrustAccessGroupsResultExcludeOidc oidc;
    ...
    private GetZeroTrustAccessGroupsResultExcludeUserRiskScore userRiskScore;
    ...
    public GetZeroTrustAccessGroupsResultExcludeCloudflareAccountMember cloudflareAccountMember() {
    ...
    public GetZeroTrustAccessGroupsResultExcludeLinkedAppToken linkedAppToken() {
        return this.linkedAppToken;
    }
    public GetZeroTrustAccessGroupsResultExcludeLoginMethod loginMethod() {
        return this.loginMethod;
    }
    public GetZeroTrustAccessGroupsResultExcludeOidc oidc() {
        return this.oidc;
    }
    ...
    public GetZeroTrustAccessGroupsResultExcludeUserRiskScore userRiskScore() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder cloudflareAccountMember(GetZeroTrustAccessGroupsResultExcludeCloudflareAccountMember cloudflareAccountMember) {
            if (cloudflareAccountMember == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessGroupsResultExclude", "cloudflareAccountMember");
            }
        ...
        @CustomType.Setter
        public Builder linkedAppToken(GetZeroTrustAccessGroupsResultExcludeLinkedAppToken linkedAppToken) {
            if (linkedAppToken == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessGroupsResultExclude", "linkedAppToken");
            }
        ...
        @CustomType.Setter
        public Builder oidc(GetZeroTrustAccessGroupsResultExcludeOidc oidc) {
            if (oidc == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessGroupsResultExclude", "oidc");
            }
            this.oidc = oidc;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder userRiskScore(GetZeroTrustAccessGroupsResultExcludeUserRiskScore userRiskScore) {
            if (userRiskScore == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessGroupsResultExclude", "userRiskScore");
            }
