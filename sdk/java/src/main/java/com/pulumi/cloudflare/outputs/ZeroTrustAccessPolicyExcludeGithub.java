...
@CustomType
public final class ZeroTrustAccessPolicyExcludeGithub {
    /**
    ...
    public static Builder builder(ZeroTrustAccessPolicyExcludeGithub defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> teams;
        public Builder() {}
        public Builder(ZeroTrustAccessPolicyExcludeGithub defaults) {
        ...
        public ZeroTrustAccessPolicyExcludeGithub build() {
            final var _resultValue = new ZeroTrustAccessPolicyExcludeGithub();
