...
@CustomType
public final class PagesProjectCanonicalDeploymentBuildConfig {
    /**
    ...
    private PagesProjectCanonicalDeploymentBuildConfig() {}
    /**
     * @return Enable build caching for the project.
     * 
     */
    ...
    public static Builder builder(PagesProjectCanonicalDeploymentBuildConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String webAnalyticsToken;
        public Builder() {}
        public Builder(PagesProjectCanonicalDeploymentBuildConfig defaults) {
        ...
        public PagesProjectCanonicalDeploymentBuildConfig build() {
            final var _resultValue = new PagesProjectCanonicalDeploymentBuildConfig();
