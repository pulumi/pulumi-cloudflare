...
import com.pulumi.cloudflare.magicTransitSite.inputs.LanStaticAddressingDhcpServerDhcpOptionArgs;
...
public final class LanStaticAddressingDhcpServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final LanStaticAddressingDhcpServerArgs Empty = new LanStaticAddressingDhcpServerArgs();
    ...
    private @Nullable Output<List<LanStaticAddressingDhcpServerDhcpOptionArgs>> dhcpOptions;

    /**
     * @return Optional list of custom DHCP options to include in DHCP responses. Only valid when DHCP server is enabled.
     * 
     */
    public Optional<Output<List<LanStaticAddressingDhcpServerDhcpOptionArgs>>> dhcpOptions() {
    ...
    private LanStaticAddressingDhcpServerArgs() {}

    private LanStaticAddressingDhcpServerArgs(LanStaticAddressingDhcpServerArgs $) {
    ...
    public static Builder builder(LanStaticAddressingDhcpServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LanStaticAddressingDhcpServerArgs();
        }

        public Builder(LanStaticAddressingDhcpServerArgs defaults) {
            $ = new LanStaticAddressingDhcpServerArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder dhcpOptions(@Nullable Output<List<LanStaticAddressingDhcpServerDhcpOptionArgs>> dhcpOptions) {
         ...
         * 
         */
        public Builder dhcpOptions(List<LanStaticAddressingDhcpServerDhcpOptionArgs> dhcpOptions) {
         ...
         * 
         */
        public Builder dhcpOptions(LanStaticAddressingDhcpServerDhcpOptionArgs... dhcpOptions) {
        ...
        public LanStaticAddressingDhcpServerArgs build() {
            return $;
        }
    }
