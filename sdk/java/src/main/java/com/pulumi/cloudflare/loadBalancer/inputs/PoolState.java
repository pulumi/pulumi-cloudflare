...
public final class PoolState extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="origins")
    private @Nullable Output<List<PoolOriginArgs>> origins;
     ...
     * 
     */
    public Optional<Output<List<PoolOriginArgs>>> origins() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder origins(@Nullable Output<List<PoolOriginArgs>> origins) {
            $.origins = origins;
            return this;
        }
