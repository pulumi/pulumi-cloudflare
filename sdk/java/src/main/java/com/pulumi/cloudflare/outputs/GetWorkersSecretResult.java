...
public final class GetWorkersSecretResult {
    ...
    public static Builder builder(GetWorkersSecretResult defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetWorkersSecretResult defaults) {
        ...
        public Builder accountId(String accountId) {
            if (accountId == null) {
              throw new MissingRequiredPropertyException("GetWorkersSecretResult", "accountId");
            }
        ...
        public Builder dispatchNamespace(String dispatchNamespace) {
            if (dispatchNamespace == null) {
              throw new MissingRequiredPropertyException("GetWorkersSecretResult", "dispatchNamespace");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetWorkersSecretResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetWorkersSecretResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder scriptName(String scriptName) {
            if (scriptName == null) {
              throw new MissingRequiredPropertyException("GetWorkersSecretResult", "scriptName");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetWorkersSecretResult", "type");
            }
            this.type = type;
            return this;
        }
        public GetWorkersSecretResult build() {
            final var _resultValue = new GetWorkersSecretResult();
