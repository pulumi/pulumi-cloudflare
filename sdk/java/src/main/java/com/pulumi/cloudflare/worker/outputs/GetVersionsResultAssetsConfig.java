...
@CustomType
public final class GetVersionsResultAssetsConfig {
    /**
    ...
    private GetVersionsResultAssetsConfig() {}
    /**
     * @return Determines the redirects and rewrites of requests for HTML content.
     * Available values: &#34;auto-trailing-slash&#34;, &#34;force-trailing-slash&#34;, &#34;drop-trailing-slash&#34;, &#34;none&#34;.
     * 
    ...
    public static Builder builder(GetVersionsResultAssetsConfig defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> runWorkerFirsts;
        public Builder() {}
        public Builder(GetVersionsResultAssetsConfig defaults) {
        ...
        public Builder htmlHandling(String htmlHandling) {
            if (htmlHandling == null) {
              throw new MissingRequiredPropertyException("GetVersionsResultAssetsConfig", "htmlHandling");
            }
        ...
        public Builder notFoundHandling(String notFoundHandling) {
            if (notFoundHandling == null) {
              throw new MissingRequiredPropertyException("GetVersionsResultAssetsConfig", "notFoundHandling");
            }
        ...
        public Builder runWorkerFirsts(List<String> runWorkerFirsts) {
            if (runWorkerFirsts == null) {
              throw new MissingRequiredPropertyException("GetVersionsResultAssetsConfig", "runWorkerFirsts");
            }
        ...
        public GetVersionsResultAssetsConfig build() {
            final var _resultValue = new GetVersionsResultAssetsConfig();
