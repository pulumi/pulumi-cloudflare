...
@CustomType
public final class EntryConfidence {
    /**
    ...
    public static Builder builder(EntryConfidence defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean available;
        public Builder() {}
        public Builder(EntryConfidence defaults) {
        ...
        public EntryConfidence build() {
            final var _resultValue = new EntryConfidence();
