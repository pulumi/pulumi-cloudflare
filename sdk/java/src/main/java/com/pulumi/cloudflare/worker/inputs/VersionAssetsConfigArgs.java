...
public final class VersionAssetsConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final VersionAssetsConfigArgs Empty = new VersionAssetsConfigArgs();
    ...
    private VersionAssetsConfigArgs() {}

    private VersionAssetsConfigArgs(VersionAssetsConfigArgs $) {
    ...
    public static Builder builder(VersionAssetsConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VersionAssetsConfigArgs();
        }

        public Builder(VersionAssetsConfigArgs defaults) {
            $ = new VersionAssetsConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VersionAssetsConfigArgs build() {
            return $;
        }
    }
