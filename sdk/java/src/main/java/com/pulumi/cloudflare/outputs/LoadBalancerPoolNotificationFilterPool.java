...
@CustomType
public final class LoadBalancerPoolNotificationFilterPool {
    /**
    ...
    private LoadBalancerPoolNotificationFilterPool() {}
    /**
     * @return If set true, disable notifications for this type of resource (pool or origin).
     * 
     */
    ...
    public static Builder builder(LoadBalancerPoolNotificationFilterPool defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean healthy;
        public Builder() {}
        public Builder(LoadBalancerPoolNotificationFilterPool defaults) {
        ...
        public LoadBalancerPoolNotificationFilterPool build() {
            final var _resultValue = new LoadBalancerPoolNotificationFilterPool();
