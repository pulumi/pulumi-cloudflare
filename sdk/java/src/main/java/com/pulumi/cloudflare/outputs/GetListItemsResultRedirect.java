...
public final class GetListItemsResultRedirect {
    ...
    private GetListItemsResultRedirect() {}
    ...
    public static Builder builder(GetListItemsResultRedirect defaults) {
    ...
    public static final class Builder {
        ...
        private String targetUrl;
        public Builder() {}
        public Builder(GetListItemsResultRedirect defaults) {
        ...
        public Builder includeSubdomains(Boolean includeSubdomains) {
            if (includeSubdomains == null) {
              throw new MissingRequiredPropertyException("GetListItemsResultRedirect", "includeSubdomains");
            }
        ...
        public Builder preservePathSuffix(Boolean preservePathSuffix) {
            if (preservePathSuffix == null) {
              throw new MissingRequiredPropertyException("GetListItemsResultRedirect", "preservePathSuffix");
            }
        ...
        public Builder preserveQueryString(Boolean preserveQueryString) {
            if (preserveQueryString == null) {
              throw new MissingRequiredPropertyException("GetListItemsResultRedirect", "preserveQueryString");
            }
        ...
        public Builder sourceUrl(String sourceUrl) {
            if (sourceUrl == null) {
              throw new MissingRequiredPropertyException("GetListItemsResultRedirect", "sourceUrl");
            }
        ...
        public Builder statusCode(Integer statusCode) {
            if (statusCode == null) {
              throw new MissingRequiredPropertyException("GetListItemsResultRedirect", "statusCode");
            }
        ...
        public Builder subpathMatching(Boolean subpathMatching) {
            if (subpathMatching == null) {
              throw new MissingRequiredPropertyException("GetListItemsResultRedirect", "subpathMatching");
            }
        ...
        public Builder targetUrl(String targetUrl) {
            if (targetUrl == null) {
              throw new MissingRequiredPropertyException("GetListItemsResultRedirect", "targetUrl");
            }
            this.targetUrl = targetUrl;
            return this;
        }
        public GetListItemsResultRedirect build() {
            final var _resultValue = new GetListItemsResultRedirect();
