...
@CustomType
public final class EntryVariant {
    /**
    ...
    public static Builder builder(EntryVariant defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(EntryVariant defaults) {
        ...
        public EntryVariant build() {
            final var _resultValue = new EntryVariant();
