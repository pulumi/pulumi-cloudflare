...
@CustomType
public final class ZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4 {
    /**
    ...
    private ZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4() {}
    /**
     * @return Specify the IPv4 address of the upstream resolver.
     * 
     */
    ...
    public static Builder builder(ZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vnetId;
        public Builder() {}
        public Builder(ZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4 defaults) {
        ...
        public Builder ip(String ip) {
            if (ip == null) {
              throw new MissingRequiredPropertyException("ZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4", "ip");
            }
            this.ip = ip;
            return this;
        }
        ...
        public ZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4 build() {
            final var _resultValue = new ZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4();
            _resultValue.ip = ip;
