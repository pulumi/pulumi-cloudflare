...
import com.pulumi.cloudflare.cloudforceOneRequest.inputs.AssetState;
 ...
 * 
 */
@ResourceType(type="cloudflare:cloudforceOneRequest/asset:Asset")
public class Asset extends com.pulumi.resources.CustomResource {
    ...
    public Asset(java.lang.String name, AssetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:cloudforceOneRequest/asset:Asset", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Asset(java.lang.String name, Output<java.lang.String> id, @Nullable AssetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:cloudforceOneRequest/asset:Asset", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/cloudforceOneRequestAsset:CloudforceOneRequestAsset").build())
            ))
            .build();
