...
public final class ZeroTrustAccessApplicationMfaConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZeroTrustAccessApplicationMfaConfigArgs Empty = new ZeroTrustAccessApplicationMfaConfigArgs();
    ...
    private ZeroTrustAccessApplicationMfaConfigArgs() {}

    private ZeroTrustAccessApplicationMfaConfigArgs(ZeroTrustAccessApplicationMfaConfigArgs $) {
    ...
    public static Builder builder(ZeroTrustAccessApplicationMfaConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustAccessApplicationMfaConfigArgs();
        }

        public Builder(ZeroTrustAccessApplicationMfaConfigArgs defaults) {
            $ = new ZeroTrustAccessApplicationMfaConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ZeroTrustAccessApplicationMfaConfigArgs build() {
            return $;
        }
    }
