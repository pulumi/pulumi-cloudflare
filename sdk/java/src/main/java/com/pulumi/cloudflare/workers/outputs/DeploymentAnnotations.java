...
@CustomType
public final class DeploymentAnnotations {
    /**
    ...
    public static Builder builder(DeploymentAnnotations defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String workersTriggeredBy;
        public Builder() {}
        public Builder(DeploymentAnnotations defaults) {
        ...
        public DeploymentAnnotations build() {
            final var _resultValue = new DeploymentAnnotations();
