...
public final class LimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final LimitArgs Empty = new LimitArgs();
    ...
    public static Builder builder(LimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LimitArgs defaults) {
            $ = new LimitArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder action(Output<LimitActionArgs> action) {
            $.action = action;
            return this;
        }
         ...
         * 
         */
        public Builder match(Output<LimitMatchArgs> match) {
            $.match = match;
            return this;
        }
        ...
        public LimitArgs build() {
            if ($.action == null) {
                throw new MissingRequiredPropertyException("LimitArgs", "action");
            }
            if ($.match == null) {
                throw new MissingRequiredPropertyException("LimitArgs", "match");
            }
            if ($.period == null) {
                throw new MissingRequiredPropertyException("LimitArgs", "period");
            }
            if ($.threshold == null) {
                throw new MissingRequiredPropertyException("LimitArgs", "threshold");
            }
            if ($.zoneId == null) {
                throw new MissingRequiredPropertyException("LimitArgs", "zoneId");
            }
            return $;
        }
    }
