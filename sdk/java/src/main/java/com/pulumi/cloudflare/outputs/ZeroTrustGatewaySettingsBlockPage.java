...
@CustomType
public final class ZeroTrustGatewaySettingsBlockPage {
    /**
    ...
    private ZeroTrustGatewaySettingsBlockPage() {}
    /**
     * @return Hex code of block page background color.
     * 
     */
    ...
    public static Builder builder(ZeroTrustGatewaySettingsBlockPage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String name;
        public Builder() {}
        public Builder(ZeroTrustGatewaySettingsBlockPage defaults) {
        ...
        public ZeroTrustGatewaySettingsBlockPage build() {
            final var _resultValue = new ZeroTrustGatewaySettingsBlockPage();
