...
import com.pulumi.cloudflare.outputs.MagicWanIpsecTunnelIpsecTunnelHealthCheck;
import com.pulumi.cloudflare.outputs.MagicWanIpsecTunnelIpsecTunnelPskMetadata;
...
@CustomType
public final class MagicWanIpsecTunnelIpsecTunnel {
    /**
    ...
    private @Nullable MagicWanIpsecTunnelIpsecTunnelHealthCheck healthCheck;
    /**
     * @return Identifier
     * 
     */
     ...
     * 
     */
    private @Nullable MagicWanIpsecTunnelIpsecTunnelPskMetadata pskMetadata;
    /**
    ...
    private MagicWanIpsecTunnelIpsecTunnel() {}
    /**
     * @return When `true`, the tunnel can use a null-cipher (`ENCR_NULL`) in the ESP tunnel (Phase 2).
     * 
     */
    ...
    public Optional<MagicWanIpsecTunnelIpsecTunnelHealthCheck> healthCheck() {
     ...
     * 
     */
    public Optional<MagicWanIpsecTunnelIpsecTunnelPskMetadata> pskMetadata() {
    ...
    public static Builder builder(MagicWanIpsecTunnelIpsecTunnel defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean replayProtection;
        public Builder() {}
        public Builder(MagicWanIpsecTunnelIpsecTunnel defaults) {
        ...
        @CustomType.Setter
        public Builder healthCheck(@Nullable MagicWanIpsecTunnelIpsecTunnelHealthCheck healthCheck) {
        ...
        @CustomType.Setter
        public Builder pskMetadata(@Nullable MagicWanIpsecTunnelIpsecTunnelPskMetadata pskMetadata) {
        ...
        public MagicWanIpsecTunnelIpsecTunnel build() {
            final var _resultValue = new MagicWanIpsecTunnelIpsecTunnel();
