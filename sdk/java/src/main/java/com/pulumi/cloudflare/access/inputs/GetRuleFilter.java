...
import com.pulumi.cloudflare.access.inputs.GetRuleFilterConfiguration;
...
public final class GetRuleFilter extends com.pulumi.resources.InvokeArgs {
    ...
    private @Nullable GetRuleFilterConfiguration configuration;

    public Optional<GetRuleFilterConfiguration> configuration() {
    ...
    public static final class Builder {
        ...
        public Builder configuration(@Nullable GetRuleFilterConfiguration configuration) {
        ...
        public GetRuleFilter build() {
            if ($.match == null) {
                throw new MissingRequiredPropertyException("GetRuleFilter", "match");
            }
            return $;
        }
    }
