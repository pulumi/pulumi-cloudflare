...
public final class GetListItem {
    ...
    public static final class Builder {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetListItem", "createdAt");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetListItem", "description");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetListItem", "value");
            }
            this.value = value;
            return this;
        }
