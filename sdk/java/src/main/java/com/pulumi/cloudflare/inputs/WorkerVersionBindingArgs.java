...
public final class WorkerVersionBindingArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkerVersionBindingArgs Empty = new WorkerVersionBindingArgs();
    ...
    private @Nullable Output<WorkerVersionBindingOutboundArgs> outbound;
    ...
    private WorkerVersionBindingArgs() {}
    ...
    public static Builder builder(WorkerVersionBindingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WorkerVersionBindingArgs defaults) {
            $ = new WorkerVersionBindingArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder outbound(@Nullable Output<WorkerVersionBindingOutboundArgs> outbound) {
            $.outbound = outbound;
            return this;
        }
        ...
        public WorkerVersionBindingArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("WorkerVersionBindingArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("WorkerVersionBindingArgs", "type");
            }
            return $;
        }
    }
