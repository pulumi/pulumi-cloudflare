...
import com.pulumi.cloudflare.magicWan.inputs.GreTunnelBgpStatusArgs;
...
public final class GreTunnelState extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="bgp")
    private @Nullable Output<GreTunnelBgpArgs> bgp;

    public Optional<Output<GreTunnelBgpArgs>> bgp() {
        return Optional.ofNullable(this.bgp);
    }

    @Import(name="bgpStatus")
    private @Nullable Output<GreTunnelBgpStatusArgs> bgpStatus;

    public Optional<Output<GreTunnelBgpStatusArgs>> bgpStatus() {
    ...
    private @Nullable Output<GreTunnelHealthCheckArgs> healthCheck;

    public Optional<Output<GreTunnelHealthCheckArgs>> healthCheck() {
    ...
    public static final class Builder {
        ...
        public Builder bgp(@Nullable Output<GreTunnelBgpArgs> bgp) {
            $.bgp = bgp;
            return this;
        }

        public Builder bgp(GreTunnelBgpArgs bgp) {
            return bgp(Output.of(bgp));
        }

        public Builder bgpStatus(@Nullable Output<GreTunnelBgpStatusArgs> bgpStatus) {
            $.bgpStatus = bgpStatus;
            return this;
        }

        public Builder bgpStatus(GreTunnelBgpStatusArgs bgpStatus) {
        ...
        public Builder healthCheck(@Nullable Output<GreTunnelHealthCheckArgs> healthCheck) {
            $.healthCheck = healthCheck;
            return this;
        }

        public Builder healthCheck(GreTunnelHealthCheckArgs healthCheck) {
