...
@CustomType
public final class ApplicationSaasAppCustomAttributeSourceNameByIdp {
    /**
    ...
    private ApplicationSaasAppCustomAttributeSourceNameByIdp() {}
    /**
     * @return The UID of the IdP.
     * 
     */
    ...
    public static Builder builder(ApplicationSaasAppCustomAttributeSourceNameByIdp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sourceName;
        public Builder() {}
        public Builder(ApplicationSaasAppCustomAttributeSourceNameByIdp defaults) {
        ...
        public ApplicationSaasAppCustomAttributeSourceNameByIdp build() {
            final var _resultValue = new ApplicationSaasAppCustomAttributeSourceNameByIdp();
