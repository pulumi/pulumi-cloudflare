...
@CustomType
public final class TeamsAccountSettingsBlockPage {
    /**
    ...
    public static Builder builder(TeamsAccountSettingsBlockPage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer version;
        public Builder() {}
        public Builder(TeamsAccountSettingsBlockPage defaults) {
        ...
        public TeamsAccountSettingsBlockPage build() {
            final var _resultValue = new TeamsAccountSettingsBlockPage();
