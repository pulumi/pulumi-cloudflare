...
public final class PoolNotificationFilterPoolArgs extends com.pulumi.resources.ResourceArgs {

    public static final PoolNotificationFilterPoolArgs Empty = new PoolNotificationFilterPoolArgs();
    ...
    private PoolNotificationFilterPoolArgs() {}

    private PoolNotificationFilterPoolArgs(PoolNotificationFilterPoolArgs $) {
    ...
    public static Builder builder(PoolNotificationFilterPoolArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PoolNotificationFilterPoolArgs();
        }

        public Builder(PoolNotificationFilterPoolArgs defaults) {
            $ = new PoolNotificationFilterPoolArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PoolNotificationFilterPoolArgs build() {
            return $;
        }
    }
