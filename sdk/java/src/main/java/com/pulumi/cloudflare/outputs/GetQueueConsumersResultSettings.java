...
@CustomType
public final class GetQueueConsumersResultSettings {
    /**
    ...
    private GetQueueConsumersResultSettings() {}
    /**
     * @return The maximum number of messages to include in a batch.
     * 
     */
    ...
    public static Builder builder(GetQueueConsumersResultSettings defaults) {
    ...
    public static final class Builder {
        ...
        private Double visibilityTimeoutMs;
        public Builder() {}
        public Builder(GetQueueConsumersResultSettings defaults) {
        ...
        public Builder batchSize(Double batchSize) {
            if (batchSize == null) {
              throw new MissingRequiredPropertyException("GetQueueConsumersResultSettings", "batchSize");
            }
        ...
        public Builder maxConcurrency(Double maxConcurrency) {
            if (maxConcurrency == null) {
              throw new MissingRequiredPropertyException("GetQueueConsumersResultSettings", "maxConcurrency");
            }
        ...
        public Builder maxRetries(Double maxRetries) {
            if (maxRetries == null) {
              throw new MissingRequiredPropertyException("GetQueueConsumersResultSettings", "maxRetries");
            }
        ...
        public Builder maxWaitTimeMs(Double maxWaitTimeMs) {
            if (maxWaitTimeMs == null) {
              throw new MissingRequiredPropertyException("GetQueueConsumersResultSettings", "maxWaitTimeMs");
            }
        ...
        public Builder retryDelay(Double retryDelay) {
            if (retryDelay == null) {
              throw new MissingRequiredPropertyException("GetQueueConsumersResultSettings", "retryDelay");
            }
        ...
        public Builder visibilityTimeoutMs(Double visibilityTimeoutMs) {
            if (visibilityTimeoutMs == null) {
              throw new MissingRequiredPropertyException("GetQueueConsumersResultSettings", "visibilityTimeoutMs");
            }
            this.visibilityTimeoutMs = visibilityTimeoutMs;
            return this;
        }
        public GetQueueConsumersResultSettings build() {
            final var _resultValue = new GetQueueConsumersResultSettings();
