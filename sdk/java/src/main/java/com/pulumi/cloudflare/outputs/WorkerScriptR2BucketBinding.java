...
public final class WorkerScriptR2BucketBinding {
    ...
    public static final class Builder {
        ...
        public Builder bucketName(String bucketName) {
            if (bucketName == null) {
              throw new MissingRequiredPropertyException("WorkerScriptR2BucketBinding", "bucketName");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("WorkerScriptR2BucketBinding", "name");
            }
            this.name = name;
            return this;
        }
