...
public final class LimitMatchResponseArgs extends com.pulumi.resources.ResourceArgs {

    public static final LimitMatchResponseArgs Empty = new LimitMatchResponseArgs();
    ...
    private LimitMatchResponseArgs() {}

    private LimitMatchResponseArgs(LimitMatchResponseArgs $) {
    ...
    public static Builder builder(LimitMatchResponseArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LimitMatchResponseArgs();
        }

        public Builder(LimitMatchResponseArgs defaults) {
            $ = new LimitMatchResponseArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LimitMatchResponseArgs build() {
            return $;
        }
    }
