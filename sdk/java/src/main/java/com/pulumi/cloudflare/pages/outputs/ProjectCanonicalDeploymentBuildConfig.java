...
@CustomType
public final class ProjectCanonicalDeploymentBuildConfig {
    /**
    ...
    public static Builder builder(ProjectCanonicalDeploymentBuildConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String webAnalyticsToken;
        public Builder() {}
        public Builder(ProjectCanonicalDeploymentBuildConfig defaults) {
        ...
        public ProjectCanonicalDeploymentBuildConfig build() {
            final var _resultValue = new ProjectCanonicalDeploymentBuildConfig();
