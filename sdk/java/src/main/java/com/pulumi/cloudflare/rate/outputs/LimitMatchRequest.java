...
@CustomType
public final class LimitMatchRequest {
    /**
    ...
    public static Builder builder(LimitMatchRequest defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String url;
        public Builder() {}
        public Builder(LimitMatchRequest defaults) {
        ...
        public LimitMatchRequest build() {
            final var _resultValue = new LimitMatchRequest();
