...
public final class GetRulesConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRulesConfigurationArgs Empty = new GetRulesConfigurationArgs();
    ...
    private GetRulesConfigurationArgs() {}

    private GetRulesConfigurationArgs(GetRulesConfigurationArgs $) {
        this.target = $.target;
        this.value = $.value;
    }
    ...
    public static Builder builder(GetRulesConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRulesConfigurationArgs();
        }

        public Builder(GetRulesConfigurationArgs defaults) {
            $ = new GetRulesConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRulesConfigurationArgs build() {
            return $;
        }
    }
