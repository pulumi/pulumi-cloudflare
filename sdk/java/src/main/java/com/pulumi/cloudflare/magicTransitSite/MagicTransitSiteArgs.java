...
public final class MagicTransitSiteArgs extends com.pulumi.resources.ResourceArgs {

    public static final MagicTransitSiteArgs Empty = new MagicTransitSiteArgs();
    ...
    private MagicTransitSiteArgs() {}

    private MagicTransitSiteArgs(MagicTransitSiteArgs $) {
    ...
    public static Builder builder(MagicTransitSiteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagicTransitSiteArgs();
        }

        public Builder(MagicTransitSiteArgs defaults) {
            $ = new MagicTransitSiteArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MagicTransitSiteArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("MagicTransitSiteArgs", "accountId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("MagicTransitSiteArgs", "name");
            }
            return $;
        }
    }
