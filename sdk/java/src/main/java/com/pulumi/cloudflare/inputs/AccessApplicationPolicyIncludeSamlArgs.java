...
public final class AccessApplicationPolicyIncludeSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccessApplicationPolicyIncludeSamlArgs Empty = new AccessApplicationPolicyIncludeSamlArgs();
    ...
    private AccessApplicationPolicyIncludeSamlArgs() {}

    private AccessApplicationPolicyIncludeSamlArgs(AccessApplicationPolicyIncludeSamlArgs $) {
    ...
    public static Builder builder(AccessApplicationPolicyIncludeSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessApplicationPolicyIncludeSamlArgs();
        }

        public Builder(AccessApplicationPolicyIncludeSamlArgs defaults) {
            $ = new AccessApplicationPolicyIncludeSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccessApplicationPolicyIncludeSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("AccessApplicationPolicyIncludeSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("AccessApplicationPolicyIncludeSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("AccessApplicationPolicyIncludeSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
