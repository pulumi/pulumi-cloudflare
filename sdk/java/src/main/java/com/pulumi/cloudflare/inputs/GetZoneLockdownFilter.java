...
public final class GetZoneLockdownFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetZoneLockdownFilter Empty = new GetZoneLockdownFilter();
    ...
    private GetZoneLockdownFilter(GetZoneLockdownFilter $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetZoneLockdownFilter();
        }

        public Builder(GetZoneLockdownFilter defaults) {
            $ = new GetZoneLockdownFilter(Objects.requireNonNull(defaults));
        }
