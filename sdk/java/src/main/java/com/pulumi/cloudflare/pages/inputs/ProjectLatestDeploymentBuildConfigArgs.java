...
public final class ProjectLatestDeploymentBuildConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectLatestDeploymentBuildConfigArgs Empty = new ProjectLatestDeploymentBuildConfigArgs();
    ...
    private ProjectLatestDeploymentBuildConfigArgs() {}

    private ProjectLatestDeploymentBuildConfigArgs(ProjectLatestDeploymentBuildConfigArgs $) {
    ...
    public static Builder builder(ProjectLatestDeploymentBuildConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectLatestDeploymentBuildConfigArgs();
        }

        public Builder(ProjectLatestDeploymentBuildConfigArgs defaults) {
            $ = new ProjectLatestDeploymentBuildConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProjectLatestDeploymentBuildConfigArgs build() {
            return $;
        }
    }
