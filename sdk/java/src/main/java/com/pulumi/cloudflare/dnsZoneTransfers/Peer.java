...
import com.pulumi.cloudflare.dnsZoneTransfers.inputs.PeerState;
 ...
 * 
 */
@ResourceType(type="cloudflare:dnsZoneTransfers/peer:Peer")
public class Peer extends com.pulumi.resources.CustomResource {
    ...
    public Peer(java.lang.String name, PeerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:dnsZoneTransfers/peer:Peer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Peer(java.lang.String name, Output<java.lang.String> id, @Nullable PeerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:dnsZoneTransfers/peer:Peer", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/dnsZoneTransfersPeer:DnsZoneTransfersPeer").build())
            ))
            .build();
