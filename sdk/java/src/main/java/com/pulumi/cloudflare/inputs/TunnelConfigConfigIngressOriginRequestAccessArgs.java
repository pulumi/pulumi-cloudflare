...
public final class TunnelConfigConfigIngressOriginRequestAccessArgs extends com.pulumi.resources.ResourceArgs {

    public static final TunnelConfigConfigIngressOriginRequestAccessArgs Empty = new TunnelConfigConfigIngressOriginRequestAccessArgs();
    ...
    private TunnelConfigConfigIngressOriginRequestAccessArgs() {}

    private TunnelConfigConfigIngressOriginRequestAccessArgs(TunnelConfigConfigIngressOriginRequestAccessArgs $) {
    ...
    public static Builder builder(TunnelConfigConfigIngressOriginRequestAccessArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TunnelConfigConfigIngressOriginRequestAccessArgs();
        }

        public Builder(TunnelConfigConfigIngressOriginRequestAccessArgs defaults) {
            $ = new TunnelConfigConfigIngressOriginRequestAccessArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TunnelConfigConfigIngressOriginRequestAccessArgs build() {
            if ($.audTags == null) {
                throw new MissingRequiredPropertyException("TunnelConfigConfigIngressOriginRequestAccessArgs", "audTags");
            }
            if ($.teamName == null) {
                throw new MissingRequiredPropertyException("TunnelConfigConfigIngressOriginRequestAccessArgs", "teamName");
            }
            return $;
        }
    }
