...
public final class TestState extends com.pulumi.resources.ResourceArgs {

    public static final TestState Empty = new TestState();
    ...
    public static Builder builder(TestState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(TestState defaults) {
            $ = new TestState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder data(@Nullable Output<TestDataArgs> data) {
            $.data = data;
            return this;
        }
