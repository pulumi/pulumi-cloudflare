...
import com.pulumi.cloudflare.waitingRoom.inputs.EventState;
 ...
 * 
 */
@ResourceType(type="cloudflare:waitingRoom/event:Event")
public class Event extends com.pulumi.resources.CustomResource {
    ...
    public Event(java.lang.String name, EventArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:waitingRoom/event:Event", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Event(java.lang.String name, Output<java.lang.String> id, @Nullable EventState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:waitingRoom/event:Event", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/waitingRoomEvent:WaitingRoomEvent").build())
            ))
            .build();
