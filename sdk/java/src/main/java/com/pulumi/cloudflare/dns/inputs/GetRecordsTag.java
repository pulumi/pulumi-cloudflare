...
public final class GetRecordsTag extends com.pulumi.resources.InvokeArgs {

    public static final GetRecordsTag Empty = new GetRecordsTag();
    ...
    private GetRecordsTag() {}

    private GetRecordsTag(GetRecordsTag $) {
        this.absent = $.absent;
    ...
    public static Builder builder(GetRecordsTag defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetRecordsTag defaults) {
            $ = new GetRecordsTag(Objects.requireNonNull(defaults));
        }
