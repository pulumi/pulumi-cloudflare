...
import com.pulumi.cloudflare.magicWan.outputs.IpsecTunnelHealthCheckTarget;
...
@CustomType
public final class IpsecTunnelHealthCheck {
    /**
     ...
     * 
     */
    private @Nullable IpsecTunnelHealthCheckTarget target;
    /**
    ...
    private IpsecTunnelHealthCheck() {}
    /**
     * @return The direction of the flow of the healthcheck. Either unidirectional, where the probe comes to you via the tunnel and the result comes back to Cloudflare via the open Internet, or bidirectional where both the probe and result come and go via the tunnel.
     * Available values: &#34;unidirectional&#34;, &#34;bidirectional&#34;.
     * 
     ...
     * 
     */
    public Optional<IpsecTunnelHealthCheckTarget> target() {
    ...
    public static Builder builder(IpsecTunnelHealthCheck defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(IpsecTunnelHealthCheck defaults) {
        ...
        @CustomType.Setter
        public Builder target(@Nullable IpsecTunnelHealthCheckTarget target) {
        ...
        public IpsecTunnelHealthCheck build() {
            final var _resultValue = new IpsecTunnelHealthCheck();
