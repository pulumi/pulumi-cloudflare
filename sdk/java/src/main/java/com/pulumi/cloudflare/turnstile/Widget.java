...
import com.pulumi.cloudflare.turnstile.inputs.WidgetState;
 ...
 * 
 */
@ResourceType(type="cloudflare:turnstile/widget:Widget")
public class Widget extends com.pulumi.resources.CustomResource {
    /**
     * Identifier
     * 
     */
     ...
     */
    public Widget(java.lang.String name, WidgetArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Widget(java.lang.String name, WidgetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:turnstile/widget:Widget", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Widget(java.lang.String name, Output<java.lang.String> id, @Nullable WidgetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:turnstile/widget:Widget", name, state, makeResourceOptions(options, id), false);
    }

    private static WidgetArgs makeArgs(WidgetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WidgetArgs.Empty : args;
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/turnstileWidget:TurnstileWidget").build())
            ))
     ...
     */
    public static Widget get(java.lang.String name, Output<java.lang.String> id, @Nullable WidgetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new Widget(name, id, state, options);
    }
}
