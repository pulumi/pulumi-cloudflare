...
public final class ZeroTrustAccessOrganizationLoginDesign {
    ...
    public static Builder builder(ZeroTrustAccessOrganizationLoginDesign defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String textColor;
        public Builder() {}
        public Builder(ZeroTrustAccessOrganizationLoginDesign defaults) {
        ...
        public ZeroTrustAccessOrganizationLoginDesign build() {
            final var _resultValue = new ZeroTrustAccessOrganizationLoginDesign();
