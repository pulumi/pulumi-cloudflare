...
public final class CertificateArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="tunnel")
    private @Nullable Output<CertificateTunnelArgs> tunnel;

    /**
     * @return Configuration for using Keyless SSL through a Cloudflare Tunnel.
     * 
     */
    public Optional<Output<CertificateTunnelArgs>> tunnel() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder tunnel(@Nullable Output<CertificateTunnelArgs> tunnel) {
            $.tunnel = tunnel;
            return this;
        }
         ...
         * 
         */
        public Builder tunnel(CertificateTunnelArgs tunnel) {
        ...
        public CertificateArgs build() {
            ...
            if ($.host == null) {
                throw new MissingRequiredPropertyException("CertificateArgs", "host");
            }
            if ($.zoneId == null) {
