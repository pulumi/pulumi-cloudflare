...
import com.pulumi.cloudflare.inputs.WorkerVersionMigrationsStepArgs;
...
public final class WorkerVersionMigrationsArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkerVersionMigrationsArgs Empty = new WorkerVersionMigrationsArgs();
    ...
    private @Nullable Output<List<WorkerVersionMigrationsRenamedClassArgs>> renamedClasses;

    /**
     * @return A list of classes with Durable Object namespaces that were renamed.
     * 
     */
    public Optional<Output<List<WorkerVersionMigrationsRenamedClassArgs>>> renamedClasses() {
     ...
     */
    @Import(name="steps")
    private @Nullable Output<List<WorkerVersionMigrationsStepArgs>> steps;

    /**
     * @return Migrations to apply in order.
     * 
     */
    public Optional<Output<List<WorkerVersionMigrationsStepArgs>>> steps() {
    ...
    private @Nullable Output<List<WorkerVersionMigrationsTransferredClassArgs>> transferredClasses;
     ...
     * 
     */
    public Optional<Output<List<WorkerVersionMigrationsTransferredClassArgs>>> transferredClasses() {
        return Optional.ofNullable(this.transferredClasses);
    }

    private WorkerVersionMigrationsArgs() {}

    private WorkerVersionMigrationsArgs(WorkerVersionMigrationsArgs $) {
    ...
    public static Builder builder(WorkerVersionMigrationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkerVersionMigrationsArgs();
        }

        public Builder(WorkerVersionMigrationsArgs defaults) {
            $ = new WorkerVersionMigrationsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder renamedClasses(@Nullable Output<List<WorkerVersionMigrationsRenamedClassArgs>> renamedClasses) {
         ...
         * 
         */
        public Builder renamedClasses(List<WorkerVersionMigrationsRenamedClassArgs> renamedClasses) {
         ...
         * 
         */
        public Builder renamedClasses(WorkerVersionMigrationsRenamedClassArgs... renamedClasses) {
         ...
         * 
         */
        public Builder steps(@Nullable Output<List<WorkerVersionMigrationsStepArgs>> steps) {
            $.steps = steps;
            return this;
        }
         ...
         * 
         */
        public Builder steps(List<WorkerVersionMigrationsStepArgs> steps) {
         ...
         * 
         */
        public Builder steps(WorkerVersionMigrationsStepArgs... steps) {
         ...
         * 
         */
        public Builder transferredClasses(@Nullable Output<List<WorkerVersionMigrationsTransferredClassArgs>> transferredClasses) {
         ...
         * 
         */
        public Builder transferredClasses(List<WorkerVersionMigrationsTransferredClassArgs> transferredClasses) {
         ...
         * 
         */
        public Builder transferredClasses(WorkerVersionMigrationsTransferredClassArgs... transferredClasses) {
            return transferredClasses(List.of(transferredClasses));
        }

        public WorkerVersionMigrationsArgs build() {
            return $;
        }
    }
