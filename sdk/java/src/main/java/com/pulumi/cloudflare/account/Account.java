...
import com.pulumi.cloudflare.account.inputs.AccountState;
import com.pulumi.cloudflare.account.outputs.AccountManagedBy;
import com.pulumi.cloudflare.account.outputs.AccountSettings;
import com.pulumi.cloudflare.account.outputs.AccountUnit;
 ...
 * 
 */
@ResourceType(type="cloudflare:account/account:Account")
public class Account extends com.pulumi.resources.CustomResource {
    ...
    public Account(java.lang.String name, AccountArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:account/account:Account", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Account(java.lang.String name, Output<java.lang.String> id, @Nullable AccountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:account/account:Account", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/account:Account").build())
            ))
            .build();
