...
public final class AccessGroupRequireExternalEvaluationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AccessGroupRequireExternalEvaluationArgs build() {
            if ($.evaluateUrl == null) {
                throw new MissingRequiredPropertyException("AccessGroupRequireExternalEvaluationArgs", "evaluateUrl");
            }
            if ($.keysUrl == null) {
                throw new MissingRequiredPropertyException("AccessGroupRequireExternalEvaluationArgs", "keysUrl");
            }
            return $;
        }
    }
