...
public final class LoadBalancerMonitorHeader {
    ...
    public static final class Builder {
        ...
        public Builder header(String header) {
            if (header == null) {
              throw new MissingRequiredPropertyException("LoadBalancerMonitorHeader", "header");
            }
            this.header = header;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("LoadBalancerMonitorHeader", "values");
            }
            this.values = values;
            return this;
        }
