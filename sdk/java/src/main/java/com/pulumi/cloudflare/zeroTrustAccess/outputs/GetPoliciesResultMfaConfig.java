...
@CustomType
public final class GetPoliciesResultMfaConfig {
    /**
    ...
    private GetPoliciesResultMfaConfig() {}
    /**
     * @return Lists the MFA methods that users can authenticate with.
     * 
     */
    ...
    public static Builder builder(GetPoliciesResultMfaConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String sessionDuration;
        public Builder() {}
        public Builder(GetPoliciesResultMfaConfig defaults) {
        ...
        public Builder allowedAuthenticators(List<String> allowedAuthenticators) {
            if (allowedAuthenticators == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultMfaConfig", "allowedAuthenticators");
            }
        ...
        public Builder mfaDisabled(Boolean mfaDisabled) {
            if (mfaDisabled == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultMfaConfig", "mfaDisabled");
            }
        ...
        public Builder sessionDuration(String sessionDuration) {
            if (sessionDuration == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultMfaConfig", "sessionDuration");
            }
            this.sessionDuration = sessionDuration;
            return this;
        }
        public GetPoliciesResultMfaConfig build() {
            final var _resultValue = new GetPoliciesResultMfaConfig();
