...
public final class HoldState extends com.pulumi.resources.ResourceArgs {

    public static final HoldState Empty = new HoldState();
    ...
    public static Builder builder(HoldState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(HoldState defaults) {
            $ = new HoldState(Objects.requireNonNull(defaults));
        }
