...
public final class ProviderScimConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProviderScimConfigArgs Empty = new ProviderScimConfigArgs();
    ...
    private ProviderScimConfigArgs() {}

    private ProviderScimConfigArgs(ProviderScimConfigArgs $) {
    ...
    public static Builder builder(ProviderScimConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProviderScimConfigArgs();
        }

        public Builder(ProviderScimConfigArgs defaults) {
            $ = new ProviderScimConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProviderScimConfigArgs build() {
            return $;
        }
    }
