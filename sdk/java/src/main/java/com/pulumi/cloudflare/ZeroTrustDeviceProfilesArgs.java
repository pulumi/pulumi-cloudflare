...
public final class ZeroTrustDeviceProfilesArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final ZeroTrustDeviceProfilesArgs Empty = new ZeroTrustDeviceProfilesArgs();
    ...
    private ZeroTrustDeviceProfilesArgs() {}

    private ZeroTrustDeviceProfilesArgs(ZeroTrustDeviceProfilesArgs $) {
    ...
    public static Builder builder(ZeroTrustDeviceProfilesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustDeviceProfilesArgs();
        }

        public Builder(ZeroTrustDeviceProfilesArgs defaults) {
            $ = new ZeroTrustDeviceProfilesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ZeroTrustDeviceProfilesArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("ZeroTrustDeviceProfilesArgs", "accountId");
            }
            if ($.description == null) {
                throw new MissingRequiredPropertyException("ZeroTrustDeviceProfilesArgs", "description");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ZeroTrustDeviceProfilesArgs", "name");
            }
            return $;
        }
    }
