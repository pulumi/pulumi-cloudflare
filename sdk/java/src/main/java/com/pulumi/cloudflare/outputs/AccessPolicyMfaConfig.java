...
@CustomType
public final class AccessPolicyMfaConfig {
    /**
    ...
    public static Builder builder(AccessPolicyMfaConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sessionDuration;
        public Builder() {}
        public Builder(AccessPolicyMfaConfig defaults) {
        ...
        public AccessPolicyMfaConfig build() {
            final var _resultValue = new AccessPolicyMfaConfig();
