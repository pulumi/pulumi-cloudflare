...
@CustomType
public final class LimitMatchHeader {
    /**
    ...
    public static Builder builder(LimitMatchHeader defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(LimitMatchHeader defaults) {
        ...
        public LimitMatchHeader build() {
            final var _resultValue = new LimitMatchHeader();
