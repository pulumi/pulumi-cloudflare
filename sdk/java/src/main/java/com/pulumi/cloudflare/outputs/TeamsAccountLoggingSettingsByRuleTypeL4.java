...
public final class TeamsAccountLoggingSettingsByRuleTypeL4 {
    ...
    public static Builder builder(TeamsAccountLoggingSettingsByRuleTypeL4 defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean logBlocks;
        public Builder() {}
        public Builder(TeamsAccountLoggingSettingsByRuleTypeL4 defaults) {
        ...
        public Builder logAll(Boolean logAll) {
            if (logAll == null) {
              throw new MissingRequiredPropertyException("TeamsAccountLoggingSettingsByRuleTypeL4", "logAll");
            }
            this.logAll = logAll;
            return this;
        }
        ...
        public Builder logBlocks(Boolean logBlocks) {
            if (logBlocks == null) {
              throw new MissingRequiredPropertyException("TeamsAccountLoggingSettingsByRuleTypeL4", "logBlocks");
            }
