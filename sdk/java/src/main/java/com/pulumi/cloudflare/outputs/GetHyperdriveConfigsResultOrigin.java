...
@CustomType
public final class GetHyperdriveConfigsResultOrigin {
    /**
    ...
    private GetHyperdriveConfigsResultOrigin() {}
    /**
     * @return Defines the Client ID of the Access token to use when connecting to the origin database.
     * 
     */
    ...
    public static Builder builder(GetHyperdriveConfigsResultOrigin defaults) {
    ...
    public static final class Builder {
        ...
        private String user;
        public Builder() {}
        public Builder(GetHyperdriveConfigsResultOrigin defaults) {
        ...
        public Builder accessClientId(String accessClientId) {
            if (accessClientId == null) {
              throw new MissingRequiredPropertyException("GetHyperdriveConfigsResultOrigin", "accessClientId");
            }
        ...
        public Builder accessClientSecret(String accessClientSecret) {
            if (accessClientSecret == null) {
              throw new MissingRequiredPropertyException("GetHyperdriveConfigsResultOrigin", "accessClientSecret");
            }
        ...
        public Builder database(String database) {
            if (database == null) {
              throw new MissingRequiredPropertyException("GetHyperdriveConfigsResultOrigin", "database");
            }
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("GetHyperdriveConfigsResultOrigin", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("GetHyperdriveConfigsResultOrigin", "password");
            }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetHyperdriveConfigsResultOrigin", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder scheme(String scheme) {
            if (scheme == null) {
              throw new MissingRequiredPropertyException("GetHyperdriveConfigsResultOrigin", "scheme");
            }
            this.scheme = scheme;
            return this;
        }
        ...
        public Builder serviceId(String serviceId) {
            if (serviceId == null) {
              throw new MissingRequiredPropertyException("GetHyperdriveConfigsResultOrigin", "serviceId");
            }
        ...
        public Builder user(String user) {
            if (user == null) {
              throw new MissingRequiredPropertyException("GetHyperdriveConfigsResultOrigin", "user");
            }
            this.user = user;
            return this;
        }
        public GetHyperdriveConfigsResultOrigin build() {
            final var _resultValue = new GetHyperdriveConfigsResultOrigin();
