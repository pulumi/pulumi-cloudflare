...
public final class GetDnsRecordFilterContent extends com.pulumi.resources.InvokeArgs {

    public static final GetDnsRecordFilterContent Empty = new GetDnsRecordFilterContent();
    ...
    private GetDnsRecordFilterContent() {}

    private GetDnsRecordFilterContent(GetDnsRecordFilterContent $) {
    ...
    public static Builder builder(GetDnsRecordFilterContent defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDnsRecordFilterContent();
        }

        public Builder(GetDnsRecordFilterContent defaults) {
            $ = new GetDnsRecordFilterContent(Objects.requireNonNull(defaults));
        }
        ...
        public GetDnsRecordFilterContent build() {
            return $;
        }
    }
