...
public final class PolicyExpirationArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyExpirationArgs Empty = new PolicyExpirationArgs();
    ...
    private PolicyExpirationArgs() {}

    private PolicyExpirationArgs(PolicyExpirationArgs $) {
    ...
    public static Builder builder(PolicyExpirationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyExpirationArgs();
        }

        public Builder(PolicyExpirationArgs defaults) {
            $ = new PolicyExpirationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyExpirationArgs build() {
            if ($.expiresAt == null) {
                throw new MissingRequiredPropertyException("PolicyExpirationArgs", "expiresAt");
            }
            return $;
        }
    }
