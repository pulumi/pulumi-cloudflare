...
@CustomType
public final class AccessApplicationPolicyMfaConfig {
    /**
    ...
    public static Builder builder(AccessApplicationPolicyMfaConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sessionDuration;
        public Builder() {}
        public Builder(AccessApplicationPolicyMfaConfig defaults) {
        ...
        public AccessApplicationPolicyMfaConfig build() {
            final var _resultValue = new AccessApplicationPolicyMfaConfig();
