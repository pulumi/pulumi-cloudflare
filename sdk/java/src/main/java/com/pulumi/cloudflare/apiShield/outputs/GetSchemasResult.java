...
public final class GetSchemasResult {
    ...
    public static final class Builder {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetSchemasResult", "createdAt");
            }
        ...
        public Builder kind(String kind) {
            if (kind == null) {
              throw new MissingRequiredPropertyException("GetSchemasResult", "kind");
            }
            this.kind = kind;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSchemasResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder schemaId(String schemaId) {
            if (schemaId == null) {
              throw new MissingRequiredPropertyException("GetSchemasResult", "schemaId");
            }
        ...
        public Builder source(String source) {
            if (source == null) {
              throw new MissingRequiredPropertyException("GetSchemasResult", "source");
            }
            this.source = source;
            return this;
        }
        ...
        public Builder validationEnabled(Boolean validationEnabled) {
            if (validationEnabled == null) {
              throw new MissingRequiredPropertyException("GetSchemasResult", "validationEnabled");
            }
