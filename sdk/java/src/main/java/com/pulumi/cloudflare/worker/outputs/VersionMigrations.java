...
import com.pulumi.cloudflare.worker.outputs.VersionMigrationsRenamedClass;
import com.pulumi.cloudflare.worker.outputs.VersionMigrationsStep;
import com.pulumi.cloudflare.worker.outputs.VersionMigrationsTransferredClass;
...
@CustomType
public final class VersionMigrations {
    /**
     ...
     * 
     */
    private @Nullable List<VersionMigrationsRenamedClass> renamedClasses;
    /**
     * @return Migrations to apply in order.
     * 
     */
    private @Nullable List<VersionMigrationsStep> steps;
    /**
     ...
     * 
     */
    private @Nullable List<VersionMigrationsTransferredClass> transferredClasses;

    private VersionMigrations() {}
    /**
     * @return A list of classes to delete Durable Object namespaces from.
     * 
     */
     ...
     * 
     */
    public List<VersionMigrationsRenamedClass> renamedClasses() {
     ...
     * 
     */
    public List<VersionMigrationsStep> steps() {
     ...
     * 
     */
    public List<VersionMigrationsTransferredClass> transferredClasses() {
    ...
    public static Builder builder(VersionMigrations defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<VersionMigrationsTransferredClass> transferredClasses;
        public Builder() {}
        public Builder(VersionMigrations defaults) {
        ...
        @CustomType.Setter
        public Builder renamedClasses(@Nullable List<VersionMigrationsRenamedClass> renamedClasses) {

            this.renamedClasses = renamedClasses;
            return this;
        }
        public Builder renamedClasses(VersionMigrationsRenamedClass... renamedClasses) {
            return renamedClasses(List.of(renamedClasses));
        }
        @CustomType.Setter
        public Builder steps(@Nullable List<VersionMigrationsStep> steps) {

            this.steps = steps;
            return this;
        }
        public Builder steps(VersionMigrationsStep... steps) {
            return steps(List.of(steps));
        }
        @CustomType.Setter
        public Builder transferredClasses(@Nullable List<VersionMigrationsTransferredClass> transferredClasses) {

            this.transferredClasses = transferredClasses;
            return this;
        }
        public Builder transferredClasses(VersionMigrationsTransferredClass... transferredClasses) {
            return transferredClasses(List.of(transferredClasses));
        }
        public VersionMigrations build() {
            final var _resultValue = new VersionMigrations();
