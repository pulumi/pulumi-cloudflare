...
@CustomType
public final class AccessApplicationTargetCriteria {
    /**
    ...
    public static Builder builder(AccessApplicationTargetCriteria defaults) {
    ...
    public static final class Builder {
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("AccessApplicationTargetCriteria", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("AccessApplicationTargetCriteria", "protocol");
            }
