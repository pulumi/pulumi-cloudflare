...
public final class PolicyState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder mechanisms(@Nullable Output<PolicyMechanismsArgs> mechanisms) {
