...
@CustomType
public final class MagicTransitSiteAclLan1 {
    /**
     ...
     * 
     */
    private @Nullable List<String> portRanges;
    /**
    ...
    private MagicTransitSiteAclLan1() {}
    /**
     * @return The identifier for the LAN you want to create an ACL policy with.
     * 
     */
    ...
    public static Builder builder(MagicTransitSiteAclLan1 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> subnets;
        public Builder() {}
        public Builder(MagicTransitSiteAclLan1 defaults) {
        ...
        public Builder lanId(String lanId) {
            if (lanId == null) {
              throw new MissingRequiredPropertyException("MagicTransitSiteAclLan1", "lanId");
            }
            this.lanId = lanId;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder portRanges(@Nullable List<String> portRanges) {
        ...
        public MagicTransitSiteAclLan1 build() {
            final var _resultValue = new MagicTransitSiteAclLan1();
