...
@CustomType
public final class ZeroTrustGatewaySettingsSettingsBrowserIsolation {
    /**
    ...
    private ZeroTrustGatewaySettingsSettingsBrowserIsolation() {}
    /**
     * @return Specify whether to enable non-identity onramp support for Browser Isolation.
     * 
     */
    ...
    public static Builder builder(ZeroTrustGatewaySettingsSettingsBrowserIsolation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean urlBrowserIsolationEnabled;
        public Builder() {}
        public Builder(ZeroTrustGatewaySettingsSettingsBrowserIsolation defaults) {
        ...
        public ZeroTrustGatewaySettingsSettingsBrowserIsolation build() {
            final var _resultValue = new ZeroTrustGatewaySettingsSettingsBrowserIsolation();
