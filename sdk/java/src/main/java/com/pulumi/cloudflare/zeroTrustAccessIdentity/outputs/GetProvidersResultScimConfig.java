...
@CustomType
public final class GetProvidersResultScimConfig {
    /**
    ...
    private GetProvidersResultScimConfig() {}
    /**
     * @return A flag to enable or disable SCIM for the identity provider.
     * 
     */
    ...
    public static Builder builder(GetProvidersResultScimConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean userDeprovision;
        public Builder() {}
        public Builder(GetProvidersResultScimConfig defaults) {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetProvidersResultScimConfig", "enabled");
            }
        ...
        public Builder identityUpdateBehavior(String identityUpdateBehavior) {
            if (identityUpdateBehavior == null) {
              throw new MissingRequiredPropertyException("GetProvidersResultScimConfig", "identityUpdateBehavior");
            }
        ...
        public Builder scimBaseUrl(String scimBaseUrl) {
            if (scimBaseUrl == null) {
              throw new MissingRequiredPropertyException("GetProvidersResultScimConfig", "scimBaseUrl");
            }
        ...
        public Builder seatDeprovision(Boolean seatDeprovision) {
            if (seatDeprovision == null) {
              throw new MissingRequiredPropertyException("GetProvidersResultScimConfig", "seatDeprovision");
            }
        ...
        public Builder secret(String secret) {
            if (secret == null) {
              throw new MissingRequiredPropertyException("GetProvidersResultScimConfig", "secret");
            }
            this.secret = secret;
            return this;
        }
        ...
        public Builder userDeprovision(Boolean userDeprovision) {
            if (userDeprovision == null) {
              throw new MissingRequiredPropertyException("GetProvidersResultScimConfig", "userDeprovision");
            }
            this.userDeprovision = userDeprovision;
            return this;
        }
        public GetProvidersResultScimConfig build() {
            final var _resultValue = new GetProvidersResultScimConfig();
