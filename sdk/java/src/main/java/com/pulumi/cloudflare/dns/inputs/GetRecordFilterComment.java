...
public final class GetRecordFilterComment extends com.pulumi.resources.InvokeArgs {

    public static final GetRecordFilterComment Empty = new GetRecordFilterComment();
    ...
    private GetRecordFilterComment() {}

    private GetRecordFilterComment(GetRecordFilterComment $) {
        this.absent = $.absent;
    ...
    public static Builder builder(GetRecordFilterComment defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRecordFilterComment();
        }

        public Builder(GetRecordFilterComment defaults) {
            $ = new GetRecordFilterComment(Objects.requireNonNull(defaults));
        }
        ...
        public GetRecordFilterComment build() {
            return $;
        }
    }
