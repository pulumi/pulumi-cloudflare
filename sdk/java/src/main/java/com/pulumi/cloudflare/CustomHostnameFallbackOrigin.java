...
public class CustomHostnameFallbackOrigin extends com.pulumi.resources.CustomResource {
     ...
     */
    public CustomHostnameFallbackOrigin(java.lang.String name) {
     ...
     */
    public CustomHostnameFallbackOrigin(java.lang.String name, CustomHostnameFallbackOriginArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CustomHostnameFallbackOrigin(java.lang.String name, CustomHostnameFallbackOriginArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:index/customHostnameFallbackOrigin:CustomHostnameFallbackOrigin", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CustomHostnameFallbackOrigin(java.lang.String name, Output<java.lang.String> id, @Nullable CustomHostnameFallbackOriginState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:index/customHostnameFallbackOrigin:CustomHostnameFallbackOrigin", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static CustomHostnameFallbackOrigin get(java.lang.String name, Output<java.lang.String> id, @Nullable CustomHostnameFallbackOriginState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
