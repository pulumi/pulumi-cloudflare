...
public final class ZeroTrustAccessPolicyIncludeSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZeroTrustAccessPolicyIncludeSamlArgs Empty = new ZeroTrustAccessPolicyIncludeSamlArgs();
    ...
    private ZeroTrustAccessPolicyIncludeSamlArgs() {}

    private ZeroTrustAccessPolicyIncludeSamlArgs(ZeroTrustAccessPolicyIncludeSamlArgs $) {
    ...
    public static Builder builder(ZeroTrustAccessPolicyIncludeSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustAccessPolicyIncludeSamlArgs();
        }

        public Builder(ZeroTrustAccessPolicyIncludeSamlArgs defaults) {
            $ = new ZeroTrustAccessPolicyIncludeSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ZeroTrustAccessPolicyIncludeSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessPolicyIncludeSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessPolicyIncludeSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("ZeroTrustAccessPolicyIncludeSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
