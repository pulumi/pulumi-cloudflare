...
import com.pulumi.cloudflare.pipeline.inputs.GetStreamFilterArgs;
...
public final class GetStreamArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filter")
    private @Nullable Output<GetStreamFilterArgs> filter;

    public Optional<Output<GetStreamFilterArgs>> filter() {
    ...
    public static final class Builder {
        ...
        public Builder filter(@Nullable Output<GetStreamFilterArgs> filter) {
            $.filter = filter;
            return this;
        }

        public Builder filter(GetStreamFilterArgs filter) {
