...
@CustomType
public final class GetZonesResultPlan {
    /**
    ...
    public static Builder builder(GetZonesResultPlan defaults) {
    ...
    public static final class Builder {
        ...
        private Double price;
        public Builder() {}
        public Builder(GetZonesResultPlan defaults) {
        ...
        public Builder canSubscribe(Boolean canSubscribe) {
            if (canSubscribe == null) {
              throw new MissingRequiredPropertyException("GetZonesResultPlan", "canSubscribe");
            }
        ...
        public Builder currency(String currency) {
            if (currency == null) {
              throw new MissingRequiredPropertyException("GetZonesResultPlan", "currency");
            }
        ...
        public Builder externallyManaged(Boolean externallyManaged) {
            if (externallyManaged == null) {
              throw new MissingRequiredPropertyException("GetZonesResultPlan", "externallyManaged");
            }
        ...
        public Builder frequency(String frequency) {
            if (frequency == null) {
              throw new MissingRequiredPropertyException("GetZonesResultPlan", "frequency");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetZonesResultPlan", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isSubscribed(Boolean isSubscribed) {
            if (isSubscribed == null) {
              throw new MissingRequiredPropertyException("GetZonesResultPlan", "isSubscribed");
            }
        ...
        public Builder legacyDiscount(Boolean legacyDiscount) {
            if (legacyDiscount == null) {
              throw new MissingRequiredPropertyException("GetZonesResultPlan", "legacyDiscount");
            }
        ...
        public Builder legacyId(String legacyId) {
            if (legacyId == null) {
              throw new MissingRequiredPropertyException("GetZonesResultPlan", "legacyId");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetZonesResultPlan", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder price(Double price) {
            if (price == null) {
              throw new MissingRequiredPropertyException("GetZonesResultPlan", "price");
            }
            this.price = price;
            return this;
        }
        public GetZonesResultPlan build() {
            final var _resultValue = new GetZonesResultPlan();
