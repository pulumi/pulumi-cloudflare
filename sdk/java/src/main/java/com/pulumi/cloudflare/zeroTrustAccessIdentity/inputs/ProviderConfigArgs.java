...
import com.pulumi.cloudflare.zeroTrustAccessIdentity.inputs.ProviderConfigHeaderAttributeArgs;
...
public final class ProviderConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<ProviderConfigHeaderAttributeArgs>> headerAttributes;

    /**
     * @return Add a list of attribute names that will be returned in the response header from the Access callback.
     * 
     */
    public Optional<Output<List<ProviderConfigHeaderAttributeArgs>>> headerAttributes() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder headerAttributes(@Nullable Output<List<ProviderConfigHeaderAttributeArgs>> headerAttributes) {
         ...
         * 
         */
        public Builder headerAttributes(List<ProviderConfigHeaderAttributeArgs> headerAttributes) {
         ...
         * 
         */
        public Builder headerAttributes(ProviderConfigHeaderAttributeArgs... headerAttributes) {
