...
public final class AccessPolicyApprovalGroupArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AccessPolicyApprovalGroupArgs() {}

    private AccessPolicyApprovalGroupArgs(AccessPolicyApprovalGroupArgs $) {
    ...
    public static Builder builder(AccessPolicyApprovalGroupArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessPolicyApprovalGroupArgs();
        }

        public Builder(AccessPolicyApprovalGroupArgs defaults) {
            $ = new AccessPolicyApprovalGroupArgs(Objects.requireNonNull(defaults));
        }
