...
public final class ZeroTrustAccessGroupIncludeSaml {
    ...
    public static Builder builder(ZeroTrustAccessGroupIncludeSaml defaults) {
    ...
    public static final class Builder {
        ...
        public ZeroTrustAccessGroupIncludeSaml build() {
            final var _resultValue = new ZeroTrustAccessGroupIncludeSaml();
