...
public final class CorsRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<CorsRuleAllowedArgs> allowed;

    /**
     * @return Object specifying allowed origins, methods and headers for this CORS rule.
     * 
     */
    public Output<CorsRuleAllowedArgs> allowed() {
        return this.allowed;
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder allowed(Output<CorsRuleAllowedArgs> allowed) {
            $.allowed = allowed;
            return this;
        }
         ...
         * 
         */
        public Builder allowed(CorsRuleAllowedArgs allowed) {
        ...
        public CorsRuleArgs build() {
            if ($.allowed == null) {
                throw new MissingRequiredPropertyException("CorsRuleArgs", "allowed");
            }
            return $;
        }
    }
