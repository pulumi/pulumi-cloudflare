...
@CustomType
public final class GetConsumersResultSettings {
    /**
    ...
    private GetConsumersResultSettings() {}
    /**
     * @return The maximum number of messages to include in a batch.
     * 
     */
    ...
    public static Builder builder(GetConsumersResultSettings defaults) {
    ...
    public static final class Builder {
        ...
        private Double visibilityTimeoutMs;
        public Builder() {}
        public Builder(GetConsumersResultSettings defaults) {
        ...
        public Builder batchSize(Double batchSize) {
            if (batchSize == null) {
              throw new MissingRequiredPropertyException("GetConsumersResultSettings", "batchSize");
            }
        ...
        public Builder maxConcurrency(Double maxConcurrency) {
            if (maxConcurrency == null) {
              throw new MissingRequiredPropertyException("GetConsumersResultSettings", "maxConcurrency");
            }
        ...
        public Builder maxRetries(Double maxRetries) {
            if (maxRetries == null) {
              throw new MissingRequiredPropertyException("GetConsumersResultSettings", "maxRetries");
            }
        ...
        public Builder maxWaitTimeMs(Double maxWaitTimeMs) {
            if (maxWaitTimeMs == null) {
              throw new MissingRequiredPropertyException("GetConsumersResultSettings", "maxWaitTimeMs");
            }
        ...
        public Builder retryDelay(Double retryDelay) {
            if (retryDelay == null) {
              throw new MissingRequiredPropertyException("GetConsumersResultSettings", "retryDelay");
            }
        ...
        public Builder visibilityTimeoutMs(Double visibilityTimeoutMs) {
            if (visibilityTimeoutMs == null) {
              throw new MissingRequiredPropertyException("GetConsumersResultSettings", "visibilityTimeoutMs");
            }
            this.visibilityTimeoutMs = visibilityTimeoutMs;
            return this;
        }
        public GetConsumersResultSettings build() {
            final var _resultValue = new GetConsumersResultSettings();
