...
public final class ZeroTrustAccessPolicyExcludeAzureArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ZeroTrustAccessPolicyExcludeAzureArgs() {}

    private ZeroTrustAccessPolicyExcludeAzureArgs(ZeroTrustAccessPolicyExcludeAzureArgs $) {
    ...
    public static Builder builder(ZeroTrustAccessPolicyExcludeAzureArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustAccessPolicyExcludeAzureArgs();
        }

        public Builder(ZeroTrustAccessPolicyExcludeAzureArgs defaults) {
            $ = new ZeroTrustAccessPolicyExcludeAzureArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ZeroTrustAccessPolicyExcludeAzureArgs build() {
            return $;
        }
    }
