...
import com.pulumi.cloudflare.zeroTrustAccessIdentity.inputs.ProviderSamlCertificateSetArgs;
...
public final class ProviderState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<ProviderSamlCertificateSetArgs> samlCertificateSet;
     ...
     * 
     */
    public Optional<Output<ProviderSamlCertificateSetArgs>> samlCertificateSet() {
    ...
    private @Nullable Output<ProviderScimConfigArgs> scimConfig;
     ...
     * 
     */
    public Optional<Output<ProviderScimConfigArgs>> scimConfig() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder samlCertificateSet(@Nullable Output<ProviderSamlCertificateSetArgs> samlCertificateSet) {
         ...
         * 
         */
        public Builder samlCertificateSet(ProviderSamlCertificateSetArgs samlCertificateSet) {
         ...
         * 
         */
        public Builder scimConfig(@Nullable Output<ProviderScimConfigArgs> scimConfig) {
         ...
         * 
         */
        public Builder scimConfig(ProviderScimConfigArgs scimConfig) {
