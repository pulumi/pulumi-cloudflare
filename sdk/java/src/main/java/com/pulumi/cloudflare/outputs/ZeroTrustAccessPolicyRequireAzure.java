...
@CustomType
public final class ZeroTrustAccessPolicyRequireAzure {
    /**
    ...
    public static Builder builder(ZeroTrustAccessPolicyRequireAzure defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> ids;
        public Builder() {}
        public Builder(ZeroTrustAccessPolicyRequireAzure defaults) {
        ...
        public ZeroTrustAccessPolicyRequireAzure build() {
            final var _resultValue = new ZeroTrustAccessPolicyRequireAzure();
