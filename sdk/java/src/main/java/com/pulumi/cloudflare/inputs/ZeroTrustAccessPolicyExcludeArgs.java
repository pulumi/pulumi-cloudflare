...
import com.pulumi.cloudflare.inputs.ZeroTrustAccessPolicyExcludeAzureArgs;
import com.pulumi.cloudflare.inputs.ZeroTrustAccessPolicyExcludeExternalEvaluationArgs;
import com.pulumi.cloudflare.inputs.ZeroTrustAccessPolicyExcludeGithubArgs;
...
public final class ZeroTrustAccessPolicyExcludeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<ZeroTrustAccessPolicyExcludeAuthContextArgs>> authContexts;

    public Optional<Output<List<ZeroTrustAccessPolicyExcludeAuthContextArgs>>> authContexts() {
    ...
    @Import(name="azures")
    private @Nullable Output<List<ZeroTrustAccessPolicyExcludeAzureArgs>> azures;

    public Optional<Output<List<ZeroTrustAccessPolicyExcludeAzureArgs>>> azures() {
    ...
    private @Nullable Output<List<ZeroTrustAccessPolicyExcludeExternalEvaluationArgs>> externalEvaluations;

    public Optional<Output<List<ZeroTrustAccessPolicyExcludeExternalEvaluationArgs>>> externalEvaluations() {
    ...
    @Import(name="githubs")
    private @Nullable Output<List<ZeroTrustAccessPolicyExcludeGithubArgs>> githubs;

    public Optional<Output<List<ZeroTrustAccessPolicyExcludeGithubArgs>>> githubs() {
    ...
    @Import(name="gsuites")
    private @Nullable Output<List<ZeroTrustAccessPolicyExcludeGsuiteArgs>> gsuites;

    public Optional<Output<List<ZeroTrustAccessPolicyExcludeGsuiteArgs>>> gsuites() {
    ...
    @Import(name="oktas")
    private @Nullable Output<List<ZeroTrustAccessPolicyExcludeOktaArgs>> oktas;

    public Optional<Output<List<ZeroTrustAccessPolicyExcludeOktaArgs>>> oktas() {
        return Optional.ofNullable(this.oktas);
    }

    @Import(name="samls")
    private @Nullable Output<List<ZeroTrustAccessPolicyExcludeSamlArgs>> samls;

    public Optional<Output<List<ZeroTrustAccessPolicyExcludeSamlArgs>>> samls() {
    ...
    public static final class Builder {
        ...
        public Builder authContexts(@Nullable Output<List<ZeroTrustAccessPolicyExcludeAuthContextArgs>> authContexts) {
            $.authContexts = authContexts;
            return this;
        }

        public Builder authContexts(List<ZeroTrustAccessPolicyExcludeAuthContextArgs> authContexts) {
            return authContexts(Output.of(authContexts));
        }

        public Builder authContexts(ZeroTrustAccessPolicyExcludeAuthContextArgs... authContexts) {
        ...
        public Builder azures(@Nullable Output<List<ZeroTrustAccessPolicyExcludeAzureArgs>> azures) {
            $.azures = azures;
            return this;
        }

        public Builder azures(List<ZeroTrustAccessPolicyExcludeAzureArgs> azures) {
            return azures(Output.of(azures));
        }

        public Builder azures(ZeroTrustAccessPolicyExcludeAzureArgs... azures) {
        ...
        public Builder externalEvaluations(@Nullable Output<List<ZeroTrustAccessPolicyExcludeExternalEvaluationArgs>> externalEvaluations) {
            $.externalEvaluations = externalEvaluations;
            return this;
        }

        public Builder externalEvaluations(List<ZeroTrustAccessPolicyExcludeExternalEvaluationArgs> externalEvaluations) {
            return externalEvaluations(Output.of(externalEvaluations));
        }

        public Builder externalEvaluations(ZeroTrustAccessPolicyExcludeExternalEvaluationArgs... externalEvaluations) {
        ...
        public Builder githubs(@Nullable Output<List<ZeroTrustAccessPolicyExcludeGithubArgs>> githubs) {
            $.githubs = githubs;
            return this;
        }

        public Builder githubs(List<ZeroTrustAccessPolicyExcludeGithubArgs> githubs) {
            return githubs(Output.of(githubs));
        }

        public Builder githubs(ZeroTrustAccessPolicyExcludeGithubArgs... githubs) {
        ...
        public Builder gsuites(@Nullable Output<List<ZeroTrustAccessPolicyExcludeGsuiteArgs>> gsuites) {
            $.gsuites = gsuites;
            return this;
        }

        public Builder gsuites(List<ZeroTrustAccessPolicyExcludeGsuiteArgs> gsuites) {
            return gsuites(Output.of(gsuites));
        }

        public Builder gsuites(ZeroTrustAccessPolicyExcludeGsuiteArgs... gsuites) {
        ...
        public Builder oktas(@Nullable Output<List<ZeroTrustAccessPolicyExcludeOktaArgs>> oktas) {
            $.oktas = oktas;
            return this;
        }

        public Builder oktas(List<ZeroTrustAccessPolicyExcludeOktaArgs> oktas) {
            return oktas(Output.of(oktas));
        }

        public Builder oktas(ZeroTrustAccessPolicyExcludeOktaArgs... oktas) {
            return oktas(List.of(oktas));
        }

        public Builder samls(@Nullable Output<List<ZeroTrustAccessPolicyExcludeSamlArgs>> samls) {
            $.samls = samls;
            return this;
        }

        public Builder samls(List<ZeroTrustAccessPolicyExcludeSamlArgs> samls) {
            return samls(Output.of(samls));
        }

        public Builder samls(ZeroTrustAccessPolicyExcludeSamlArgs... samls) {
