...
public final class GetWorkersSecretPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetWorkersSecretPlainArgs() {}

    private GetWorkersSecretPlainArgs(GetWorkersSecretPlainArgs $) {
    ...
    public static Builder builder(GetWorkersSecretPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetWorkersSecretPlainArgs();
        }

        public Builder(GetWorkersSecretPlainArgs defaults) {
            $ = new GetWorkersSecretPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetWorkersSecretPlainArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetWorkersSecretPlainArgs", "accountId");
            }
            if ($.dispatchNamespace == null) {
                throw new MissingRequiredPropertyException("GetWorkersSecretPlainArgs", "dispatchNamespace");
            }
            if ($.scriptName == null) {
                throw new MissingRequiredPropertyException("GetWorkersSecretPlainArgs", "scriptName");
            }
            return $;
        }
    }
