...
@CustomType
public final class WorkerScriptAnnotations {
    /**
    ...
    private WorkerScriptAnnotations() {}
    /**
     * @return Human-readable message about the version. Truncated to 1000 bytes if longer.
     * 
     */
    ...
    public static Builder builder(WorkerScriptAnnotations defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String workersTriggeredBy;
        public Builder() {}
        public Builder(WorkerScriptAnnotations defaults) {
        ...
        public WorkerScriptAnnotations build() {
            final var _resultValue = new WorkerScriptAnnotations();
