...
import com.pulumi.cloudflare.inputs.MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs;
...
public final class MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckArgs extends com.pulumi.resources.ResourceArgs {

    public static final MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckArgs Empty = new MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckArgs();
     ...
     */
    @Import(name="target")
    private @Nullable Output<MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs> target;

    /**
     * @return The destination address in a request type health check. After the healthcheck is decapsulated at the customer end of the tunnel, the ICMP echo will be forwarded to this address. This field defaults to `customer_gre_endpoint address`. This field is ignored for bidirectional healthchecks as the interface*address (not assigned to the Cloudflare side of the tunnel) is used as the target. Must be in object form if the x-magic-new-hc-target header is set to true and string form if x-magic-new-hc-target is absent or set to false.
     * 
     */
    public Optional<Output<MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs>> target() {
    ...
    private MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckArgs() {}

    private MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckArgs(MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckArgs $) {
    ...
    public static Builder builder(MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckArgs();
        }

        public Builder(MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckArgs defaults) {
            $ = new MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder target(@Nullable Output<MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs> target) {
            $.target = target;
            return this;
        }
         ...
         * 
         */
        public Builder target(MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetArgs target) {
        ...
        public MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckArgs build() {
            return $;
        }
    }
