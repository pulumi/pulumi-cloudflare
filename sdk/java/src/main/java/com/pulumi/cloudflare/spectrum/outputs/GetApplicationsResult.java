...
import com.pulumi.cloudflare.spectrum.outputs.GetApplicationsResultDns;
import com.pulumi.cloudflare.spectrum.outputs.GetApplicationsResultEdgeIps;
import com.pulumi.cloudflare.spectrum.outputs.GetApplicationsResultOriginDns;
...
public final class GetApplicationsResult {
     ...
     * 
     */
    private GetApplicationsResultDns dns;
    /**
     * @return The anycast edge IP configuration for the hostname of this application.
     * 
     */
    private GetApplicationsResultEdgeIps edgeIps;
    /**
     ...
     * 
     */
    private GetApplicationsResultOriginDns originDns;
    /**
     ...
     * 
     */
    public GetApplicationsResultDns dns() {
        return this.dns;
    }
    /**
     * @return The anycast edge IP configuration for the hostname of this application.
     * 
     */
    public GetApplicationsResultEdgeIps edgeIps() {
        return this.edgeIps;
    }
    /**
     * @return App identifier.
     ...
     * 
     */
    public GetApplicationsResultOriginDns originDns() {
    ...
    public static final class Builder {
        ...
        public Builder argoSmartRouting(Boolean argoSmartRouting) {
            if (argoSmartRouting == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResult", "argoSmartRouting");
            }
        ...
        public Builder createdOn(String createdOn) {
            if (createdOn == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResult", "createdOn");
            }
            this.createdOn = createdOn;
            return this;
        }
        @CustomType.Setter
        public Builder dns(GetApplicationsResultDns dns) {
            if (dns == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResult", "dns");
            }
            this.dns = dns;
            return this;
        }
        @CustomType.Setter
        public Builder edgeIps(GetApplicationsResultEdgeIps edgeIps) {
            if (edgeIps == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResult", "edgeIps");
            }
        ...
        public Builder ipFirewall(Boolean ipFirewall) {
            if (ipFirewall == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResult", "ipFirewall");
            }
        ...
        public Builder modifiedOn(String modifiedOn) {
            if (modifiedOn == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResult", "modifiedOn");
            }
        ...
        public Builder originDirects(List<String> originDirects) {
            if (originDirects == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResult", "originDirects");
            }
        ...
        @CustomType.Setter
        public Builder originDns(GetApplicationsResultOriginDns originDns) {
            if (originDns == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResult", "originDns");
            }
        ...
        public Builder originPort(Object originPort) {
            if (originPort == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResult", "originPort");
            }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResult", "protocol");
            }
        ...
        public Builder proxyProtocol(String proxyProtocol) {
            if (proxyProtocol == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResult", "proxyProtocol");
            }
        ...
        public Builder tls(String tls) {
            if (tls == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResult", "tls");
            }
            this.tls = tls;
            return this;
        }
        ...
        public Builder trafficType(String trafficType) {
            if (trafficType == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResult", "trafficType");
            }
