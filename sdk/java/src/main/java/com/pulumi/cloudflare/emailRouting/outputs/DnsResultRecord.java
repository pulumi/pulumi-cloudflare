...
@CustomType
public final class DnsResultRecord {
    /**
    ...
    public static Builder builder(DnsResultRecord defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(DnsResultRecord defaults) {
        ...
        public DnsResultRecord build() {
            final var _resultValue = new DnsResultRecord();
