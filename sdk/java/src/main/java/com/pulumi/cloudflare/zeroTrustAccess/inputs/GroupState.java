...
public final class GroupState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<GroupIncludeArgs>> includes;

    /**
     * @return Rules evaluated with an OR logical operator. A user needs to meet only one of the Include rules.
     * 
     */
    public Optional<Output<List<GroupIncludeArgs>>> includes() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder includes(@Nullable Output<List<GroupIncludeArgs>> includes) {
            $.includes = includes;
            return this;
        }
