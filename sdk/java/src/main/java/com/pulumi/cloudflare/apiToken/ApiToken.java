...
import com.pulumi.cloudflare.apiToken.inputs.ApiTokenState;
import com.pulumi.cloudflare.apiToken.outputs.ApiTokenCondition;
import com.pulumi.cloudflare.apiToken.outputs.ApiTokenPolicy;
 ...
 * 
 * ```sh
 * $ pulumi import cloudflare:apiToken/apiToken:ApiToken example &#39;&lt;token_id&gt;&#39;
 * ```
 * 
 */
@ResourceType(type="cloudflare:apiToken/apiToken:ApiToken")
public class ApiToken extends com.pulumi.resources.CustomResource {
    ...
    public ApiToken(java.lang.String name, ApiTokenArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:apiToken/apiToken:ApiToken", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ApiToken(java.lang.String name, Output<java.lang.String> id, @Nullable ApiTokenState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:apiToken/apiToken:ApiToken", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/apiToken:ApiToken").build())
            ))
