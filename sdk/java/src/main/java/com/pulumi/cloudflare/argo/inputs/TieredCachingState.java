...
public final class TieredCachingState extends com.pulumi.resources.ResourceArgs {

    public static final TieredCachingState Empty = new TieredCachingState();
    ...
    private TieredCachingState() {}

    private TieredCachingState(TieredCachingState $) {
    ...
    public static Builder builder(TieredCachingState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TieredCachingState();
        }

        public Builder(TieredCachingState defaults) {
            $ = new TieredCachingState(Objects.requireNonNull(defaults));
        }
        ...
        public TieredCachingState build() {
            return $;
        }
    }
