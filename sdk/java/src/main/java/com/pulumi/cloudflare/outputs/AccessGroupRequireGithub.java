...
@CustomType
public final class AccessGroupRequireGithub {
    /**
    ...
    private AccessGroupRequireGithub() {}
    /**
     * @return The ID of the Azure Identity provider.
     * 
     */
    ...
    public static Builder builder(AccessGroupRequireGithub defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> teams;
        public Builder() {}
        public Builder(AccessGroupRequireGithub defaults) {
        ...
        public AccessGroupRequireGithub build() {
            final var _resultValue = new AccessGroupRequireGithub();
