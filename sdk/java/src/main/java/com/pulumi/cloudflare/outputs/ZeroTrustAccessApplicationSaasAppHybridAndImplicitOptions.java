...
@CustomType
public final class ZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions {
    /**
    ...
    public static Builder builder(ZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean returnIdTokenFromAuthorizationEndpoint;
        public Builder() {}
        public Builder(ZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions defaults) {
        ...
        public ZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions build() {
            final var _resultValue = new ZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions();
