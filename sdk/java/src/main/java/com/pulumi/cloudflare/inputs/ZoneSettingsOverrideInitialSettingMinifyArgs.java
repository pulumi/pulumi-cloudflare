...
public final class ZoneSettingsOverrideInitialSettingMinifyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ZoneSettingsOverrideInitialSettingMinifyArgs build() {
            if ($.css == null) {
                throw new MissingRequiredPropertyException("ZoneSettingsOverrideInitialSettingMinifyArgs", "css");
            }
            if ($.html == null) {
                throw new MissingRequiredPropertyException("ZoneSettingsOverrideInitialSettingMinifyArgs", "html");
            }
            if ($.js == null) {
                throw new MissingRequiredPropertyException("ZoneSettingsOverrideInitialSettingMinifyArgs", "js");
            }
            return $;
        }
    }
