...
import com.pulumi.cloudflare.inputs.StaticRouteRouteScopeArgs;
...
public final class StaticRouteRouteArgs extends com.pulumi.resources.ResourceArgs {

    public static final StaticRouteRouteArgs Empty = new StaticRouteRouteArgs();
     ...
     */
    @Import(name="scope")
    private @Nullable Output<StaticRouteRouteScopeArgs> scope;

    /**
     * @return Used only for ECMP routes.
     * 
     */
    public Optional<Output<StaticRouteRouteScopeArgs>> scope() {
    ...
    private StaticRouteRouteArgs() {}

    private StaticRouteRouteArgs(StaticRouteRouteArgs $) {
    ...
    public static Builder builder(StaticRouteRouteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StaticRouteRouteArgs();
        }

        public Builder(StaticRouteRouteArgs defaults) {
            $ = new StaticRouteRouteArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder scope(@Nullable Output<StaticRouteRouteScopeArgs> scope) {
            $.scope = scope;
            return this;
        }
         ...
         * 
         */
        public Builder scope(StaticRouteRouteScopeArgs scope) {
        ...
        public StaticRouteRouteArgs build() {
            return $;
        }
    }
