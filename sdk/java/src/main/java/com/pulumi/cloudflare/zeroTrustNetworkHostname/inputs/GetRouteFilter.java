...
public final class GetRouteFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetRouteFilter Empty = new GetRouteFilter();
    ...
    private GetRouteFilter(GetRouteFilter $) {
    ...
    public static Builder builder(GetRouteFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetRouteFilter defaults) {
            $ = new GetRouteFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetRouteFilter build() {
            if ($.isDeleted == null) {
                throw new MissingRequiredPropertyException("GetRouteFilter", "isDeleted");
            }
            return $;
        }
    }
