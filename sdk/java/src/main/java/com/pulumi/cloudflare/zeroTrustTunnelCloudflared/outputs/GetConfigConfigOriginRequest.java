...
import com.pulumi.cloudflare.zeroTrustTunnelCloudflared.outputs.GetConfigConfigOriginRequestAccess;
...
@CustomType
public final class GetConfigConfigOriginRequest {
    /**
     ...
     * 
     */
    private GetConfigConfigOriginRequestAccess access;
    /**
    ...
    private GetConfigConfigOriginRequest() {}
    /**
     * @return For all L7 requests to this hostname, cloudflared will validate each request&#39;s Cf-Access-Jwt-Assertion request header.
     * 
     */
    public GetConfigConfigOriginRequestAccess access() {
        return this.access;
    }
    /**
     * @return Path to the certificate authority (CA) for the certificate of your origin. This option should be used only if your certificate is not signed by Cloudflare.
    ...
    public static Builder builder(GetConfigConfigOriginRequest defaults) {
    ...
    public static final class Builder {
        ...
        private Integer tlsTimeout;
        public Builder() {}
        public Builder(GetConfigConfigOriginRequest defaults) {
        ...
        @CustomType.Setter
        public Builder access(GetConfigConfigOriginRequestAccess access) {
            if (access == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigOriginRequest", "access");
            }
            this.access = access;
            return this;
        }
        ...
        public Builder caPool(String caPool) {
            if (caPool == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigOriginRequest", "caPool");
            }
            this.caPool = caPool;
            return this;
        }
        ...
        public Builder connectTimeout(Integer connectTimeout) {
            if (connectTimeout == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigOriginRequest", "connectTimeout");
            }
        ...
        public Builder disableChunkedEncoding(Boolean disableChunkedEncoding) {
            if (disableChunkedEncoding == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigOriginRequest", "disableChunkedEncoding");
            }
        ...
        public Builder http2Origin(Boolean http2Origin) {
            if (http2Origin == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigOriginRequest", "http2Origin");
            }
        ...
        public Builder httpHostHeader(String httpHostHeader) {
            if (httpHostHeader == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigOriginRequest", "httpHostHeader");
            }
        ...
        public Builder keepAliveConnections(Integer keepAliveConnections) {
            if (keepAliveConnections == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigOriginRequest", "keepAliveConnections");
            }
        ...
        public Builder keepAliveTimeout(Integer keepAliveTimeout) {
            if (keepAliveTimeout == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigOriginRequest", "keepAliveTimeout");
            }
        ...
        public Builder matchSnItoHost(Boolean matchSnItoHost) {
            if (matchSnItoHost == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigOriginRequest", "matchSnItoHost");
            }
        ...
        public Builder noHappyEyeballs(Boolean noHappyEyeballs) {
            if (noHappyEyeballs == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigOriginRequest", "noHappyEyeballs");
            }
        ...
        public Builder noTlsVerify(Boolean noTlsVerify) {
            if (noTlsVerify == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigOriginRequest", "noTlsVerify");
            }
        ...
        public Builder originServerName(String originServerName) {
            if (originServerName == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigOriginRequest", "originServerName");
            }
        ...
        public Builder proxyType(String proxyType) {
            if (proxyType == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigOriginRequest", "proxyType");
            }
        ...
        public Builder tcpKeepAlive(Integer tcpKeepAlive) {
            if (tcpKeepAlive == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigOriginRequest", "tcpKeepAlive");
            }
        ...
        public Builder tlsTimeout(Integer tlsTimeout) {
            if (tlsTimeout == null) {
              throw new MissingRequiredPropertyException("GetConfigConfigOriginRequest", "tlsTimeout");
            }
            this.tlsTimeout = tlsTimeout;
            return this;
        }
        public GetConfigConfigOriginRequest build() {
            final var _resultValue = new GetConfigConfigOriginRequest();
