...
@CustomType
public final class GetScriptsResultObservabilityLogs {
    /**
    ...
    private GetScriptsResultObservabilityLogs() {}
    /**
     * @return A list of destinations where logs will be exported to.
     * 
     */
    ...
    public static Builder builder(GetScriptsResultObservabilityLogs defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean persist;
        public Builder() {}
        public Builder(GetScriptsResultObservabilityLogs defaults) {
        ...
        public Builder destinations(List<String> destinations) {
            if (destinations == null) {
              throw new MissingRequiredPropertyException("GetScriptsResultObservabilityLogs", "destinations");
            }
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetScriptsResultObservabilityLogs", "enabled");
            }
        ...
        public Builder headSamplingRate(Double headSamplingRate) {
            if (headSamplingRate == null) {
              throw new MissingRequiredPropertyException("GetScriptsResultObservabilityLogs", "headSamplingRate");
            }
        ...
        public Builder invocationLogs(Boolean invocationLogs) {
            if (invocationLogs == null) {
              throw new MissingRequiredPropertyException("GetScriptsResultObservabilityLogs", "invocationLogs");
            }
        ...
        public Builder persist(Boolean persist) {
            if (persist == null) {
              throw new MissingRequiredPropertyException("GetScriptsResultObservabilityLogs", "persist");
            }
            this.persist = persist;
            return this;
        }
        public GetScriptsResultObservabilityLogs build() {
            final var _resultValue = new GetScriptsResultObservabilityLogs();
