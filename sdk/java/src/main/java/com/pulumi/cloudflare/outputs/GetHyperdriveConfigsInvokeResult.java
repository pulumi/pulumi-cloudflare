...
import com.pulumi.cloudflare.outputs.GetHyperdriveConfigsResult;
...
public final class GetHyperdriveConfigsInvokeResult {
     ...
     * 
     */
    public List<GetHyperdriveConfigsResult> results() {
        return this.results;
    }
    ...
    public static Builder builder(GetHyperdriveConfigsInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder accountId(String accountId) {
            if (accountId == null) {
              throw new MissingRequiredPropertyException("GetHyperdriveConfigsInvokeResult", "accountId");
            }
        ...
        @CustomType.Setter
        public Builder results(List<GetHyperdriveConfigsResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetHyperdriveConfigsInvokeResult", "results");
            }
            this.results = results;
            return this;
        }
        public Builder results(GetHyperdriveConfigsResult... results) {
