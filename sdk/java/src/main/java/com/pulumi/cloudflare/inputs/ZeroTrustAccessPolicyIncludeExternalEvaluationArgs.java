...
public final class ZeroTrustAccessPolicyIncludeExternalEvaluationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final ZeroTrustAccessPolicyIncludeExternalEvaluationArgs Empty = new ZeroTrustAccessPolicyIncludeExternalEvaluationArgs();
    ...
    private ZeroTrustAccessPolicyIncludeExternalEvaluationArgs(ZeroTrustAccessPolicyIncludeExternalEvaluationArgs $) {
    ...
    public static Builder builder(ZeroTrustAccessPolicyIncludeExternalEvaluationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustAccessPolicyIncludeExternalEvaluationArgs();
        }

        public Builder(ZeroTrustAccessPolicyIncludeExternalEvaluationArgs defaults) {
            $ = new ZeroTrustAccessPolicyIncludeExternalEvaluationArgs(Objects.requireNonNull(defaults));
        }
