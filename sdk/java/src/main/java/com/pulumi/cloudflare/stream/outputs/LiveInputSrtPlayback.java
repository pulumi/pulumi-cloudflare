...
@CustomType
public final class LiveInputSrtPlayback {
    /**
    ...
    public static Builder builder(LiveInputSrtPlayback defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String url;
        public Builder() {}
        public Builder(LiveInputSrtPlayback defaults) {
        ...
        public LiveInputSrtPlayback build() {
            final var _resultValue = new LiveInputSrtPlayback();
