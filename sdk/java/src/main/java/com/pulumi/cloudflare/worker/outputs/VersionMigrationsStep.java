...
import com.pulumi.cloudflare.worker.outputs.VersionMigrationsStepRenamedClass;
import com.pulumi.cloudflare.worker.outputs.VersionMigrationsStepTransferredClass;
...
@CustomType
public final class VersionMigrationsStep {
    /**
     ...
     * 
     */
    private @Nullable List<VersionMigrationsStepRenamedClass> renamedClasses;
    /**
     ...
     * 
     */
    private @Nullable List<VersionMigrationsStepTransferredClass> transferredClasses;

    private VersionMigrationsStep() {}
    /**
     * @return A list of classes to delete Durable Object namespaces from.
     * 
     */
     ...
     * 
     */
    public List<VersionMigrationsStepRenamedClass> renamedClasses() {
     ...
     * 
     */
    public List<VersionMigrationsStepTransferredClass> transferredClasses() {
    ...
    public static Builder builder(VersionMigrationsStep defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<VersionMigrationsStepTransferredClass> transferredClasses;
        public Builder() {}
        public Builder(VersionMigrationsStep defaults) {
        ...
        @CustomType.Setter
        public Builder renamedClasses(@Nullable List<VersionMigrationsStepRenamedClass> renamedClasses) {

            this.renamedClasses = renamedClasses;
            return this;
        }
        public Builder renamedClasses(VersionMigrationsStepRenamedClass... renamedClasses) {
            return renamedClasses(List.of(renamedClasses));
        }
        @CustomType.Setter
        public Builder transferredClasses(@Nullable List<VersionMigrationsStepTransferredClass> transferredClasses) {

            this.transferredClasses = transferredClasses;
            return this;
        }
        public Builder transferredClasses(VersionMigrationsStepTransferredClass... transferredClasses) {
            return transferredClasses(List.of(transferredClasses));
        }
        public VersionMigrationsStep build() {
            final var _resultValue = new VersionMigrationsStep();
