...
public final class AclLan2Args extends com.pulumi.resources.ResourceArgs {

    public static final AclLan2Args Empty = new AclLan2Args();
    ...
    private AclLan2Args(AclLan2Args $) {
        this.lanId = $.lanId;
    ...
    public static Builder builder(AclLan2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AclLan2Args defaults) {
            $ = new AclLan2Args(Objects.requireNonNull(defaults));
        }
        ...
        public AclLan2Args build() {
            if ($.lanId == null) {
                throw new MissingRequiredPropertyException("AclLan2Args", "lanId");
            }
            return $;
        }
    }
