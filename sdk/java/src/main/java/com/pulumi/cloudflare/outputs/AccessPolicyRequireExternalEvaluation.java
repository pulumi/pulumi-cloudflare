...
@CustomType
public final class AccessPolicyRequireExternalEvaluation {
    /**
    ...
    public static Builder builder(AccessPolicyRequireExternalEvaluation defaults) {
    ...
    public static final class Builder {
        ...
        private String keysUrl;
        public Builder() {}
        public Builder(AccessPolicyRequireExternalEvaluation defaults) {
        ...
        public Builder evaluateUrl(String evaluateUrl) {
            if (evaluateUrl == null) {
              throw new MissingRequiredPropertyException("AccessPolicyRequireExternalEvaluation", "evaluateUrl");
            }
        ...
        public Builder keysUrl(String keysUrl) {
            if (keysUrl == null) {
              throw new MissingRequiredPropertyException("AccessPolicyRequireExternalEvaluation", "keysUrl");
            }
