...
public final class WanState extends com.pulumi.resources.ResourceArgs {

    public static final WanState Empty = new WanState();
    ...
    public static Builder builder(WanState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WanState defaults) {
            $ = new WanState(Objects.requireNonNull(defaults));
        }
