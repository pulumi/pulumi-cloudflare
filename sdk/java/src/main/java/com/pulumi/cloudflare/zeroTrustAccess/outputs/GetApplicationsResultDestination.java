...
@CustomType
public final class GetApplicationsResultDestination {
    /**
    ...
    private GetApplicationsResultDestination() {}
    /**
     * @return The CIDR range of the destination. Single IPs will be computed as /32.
     * 
     */
    ...
    public static Builder builder(GetApplicationsResultDestination defaults) {
    ...
    public static final class Builder {
        ...
        private String vnetId;
        public Builder() {}
        public Builder(GetApplicationsResultDestination defaults) {
        ...
        public Builder cidr(String cidr) {
            if (cidr == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResultDestination", "cidr");
            }
            this.cidr = cidr;
            return this;
        }
        ...
        public Builder hostname(String hostname) {
            if (hostname == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResultDestination", "hostname");
            }
        ...
        public Builder l4Protocol(String l4Protocol) {
            if (l4Protocol == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResultDestination", "l4Protocol");
            }
        ...
        public Builder portRange(String portRange) {
            if (portRange == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResultDestination", "portRange");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResultDestination", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder uri(String uri) {
            if (uri == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResultDestination", "uri");
            }
            this.uri = uri;
            return this;
        }
        ...
        public Builder vnetId(String vnetId) {
            if (vnetId == null) {
              throw new MissingRequiredPropertyException("GetApplicationsResultDestination", "vnetId");
            }
            this.vnetId = vnetId;
            return this;
        }
        public GetApplicationsResultDestination build() {
            final var _resultValue = new GetApplicationsResultDestination();
