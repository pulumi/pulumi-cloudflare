...
import com.pulumi.cloudflare.zeroTrustTunnel.outputs.GetCloudflaredsResultConnection;
...
@CustomType
public final class GetCloudflaredsResult {
    /**
    ...
    private List<GetCloudflaredsResultConnection> connections;
    /**
     ...
     */
    @Deprecated /* This field will start returning an empty array. To fetch the connections of a given tunnel, please use the dedicated endpoint `/accounts/{account_id}/{tunnel_type}/{tunnel_id}/connections` */
    public List<GetCloudflaredsResultConnection> connections() {
    ...
    public static Builder builder(GetCloudflaredsResult defaults) {
    ...
    public static final class Builder {
        ...
        private String tunType;
        public Builder() {}
        public Builder(GetCloudflaredsResult defaults) {
        ...
        public Builder accountTag(String accountTag) {
            if (accountTag == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResult", "accountTag");
            }
        ...
        public Builder configSrc(String configSrc) {
            if (configSrc == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResult", "configSrc");
            }
            this.configSrc = configSrc;
            return this;
        }
        @CustomType.Setter
        public Builder connections(List<GetCloudflaredsResultConnection> connections) {
            if (connections == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResult", "connections");
            }
            this.connections = connections;
            return this;
        }
        public Builder connections(GetCloudflaredsResultConnection... connections) {
            return connections(List.of(connections));
        }
        @CustomType.Setter
        public Builder connsActiveAt(String connsActiveAt) {
            if (connsActiveAt == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResult", "connsActiveAt");
            }
        ...
        public Builder connsInactiveAt(String connsInactiveAt) {
            if (connsInactiveAt == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResult", "connsInactiveAt");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResult", "createdAt");
            }
        ...
        public Builder deletedAt(String deletedAt) {
            if (deletedAt == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResult", "deletedAt");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder metadata(String metadata) {
            if (metadata == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResult", "metadata");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder remoteConfig(Boolean remoteConfig) {
            if (remoteConfig == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResult", "remoteConfig");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResult", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder tunType(String tunType) {
            if (tunType == null) {
              throw new MissingRequiredPropertyException("GetCloudflaredsResult", "tunType");
            }
            this.tunType = tunType;
            return this;
        }
        public GetCloudflaredsResult build() {
            final var _resultValue = new GetCloudflaredsResult();
