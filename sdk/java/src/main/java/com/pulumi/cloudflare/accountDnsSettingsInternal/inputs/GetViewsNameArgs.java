...
public final class GetViewsNameArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetViewsNameArgs Empty = new GetViewsNameArgs();
    ...
    private GetViewsNameArgs() {}

    private GetViewsNameArgs(GetViewsNameArgs $) {
    ...
    public static Builder builder(GetViewsNameArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetViewsNameArgs();
        }

        public Builder(GetViewsNameArgs defaults) {
            $ = new GetViewsNameArgs(Objects.requireNonNull(defaults));
        }
