...
@CustomType
public final class OrganizationLoginDesign {
    /**
    ...
    private OrganizationLoginDesign() {}
    /**
     * @return The background color on your login page.
     * 
     */
    ...
    public static Builder builder(OrganizationLoginDesign defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String textColor;
        public Builder() {}
        public Builder(OrganizationLoginDesign defaults) {
        ...
        public OrganizationLoginDesign build() {
            final var _resultValue = new OrganizationLoginDesign();
