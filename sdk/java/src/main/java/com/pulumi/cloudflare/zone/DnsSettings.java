...
import com.pulumi.cloudflare.zone.inputs.DnsSettingsState;
import com.pulumi.cloudflare.zone.outputs.DnsSettingsInternalDns;
import com.pulumi.cloudflare.zone.outputs.DnsSettingsNameservers;
import com.pulumi.cloudflare.zone.outputs.DnsSettingsSoa;
 ...
 * 
 */
@ResourceType(type="cloudflare:zone/dnsSettings:DnsSettings")
public class DnsSettings extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="internalDns", refs={DnsSettingsInternalDns.class}, tree="[0]")
    private Output</* @Nullable */ DnsSettingsInternalDns> internalDns;

    /**
     * @return Settings for this internal zone.
     * 
     */
    public Output<Optional<DnsSettingsInternalDns>> internalDns() {
     ...
     * 
     */
    @Export(name="nameservers", refs={DnsSettingsNameservers.class}, tree="[0]")
    private Output</* @Nullable */ DnsSettingsNameservers> nameservers;

    /**
     * @return Settings determining the nameservers through which the zone should be available.
     * 
     */
    public Output<Optional<DnsSettingsNameservers>> nameservers() {
     ...
     * 
     */
    @Export(name="soa", refs={DnsSettingsSoa.class}, tree="[0]")
    private Output</* @Nullable */ DnsSettingsSoa> soa;

    /**
     * @return Components of the zone&#39;s SOA record.
     * 
     */
    public Output<Optional<DnsSettingsSoa>> soa() {
    ...
    public DnsSettings(java.lang.String name, DnsSettingsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zone/dnsSettings:DnsSettings", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DnsSettings(java.lang.String name, Output<java.lang.String> id, @Nullable DnsSettingsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zone/dnsSettings:DnsSettings", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/zoneDnsSettings:ZoneDnsSettings").build())
            ))
            .build();
