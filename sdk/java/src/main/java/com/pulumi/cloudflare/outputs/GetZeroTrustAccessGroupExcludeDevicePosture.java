...
public final class GetZeroTrustAccessGroupExcludeDevicePosture {
    ...
    public static Builder builder(GetZeroTrustAccessGroupExcludeDevicePosture defaults) {
    ...
    public static final class Builder {
        ...
        public Builder integrationUid(String integrationUid) {
            if (integrationUid == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessGroupExcludeDevicePosture", "integrationUid");
            }
