...
public final class ConfigConfigOriginRequestAccessArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConfigConfigOriginRequestAccessArgs Empty = new ConfigConfigOriginRequestAccessArgs();
    ...
    private ConfigConfigOriginRequestAccessArgs() {}

    private ConfigConfigOriginRequestAccessArgs(ConfigConfigOriginRequestAccessArgs $) {
    ...
    public static Builder builder(ConfigConfigOriginRequestAccessArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConfigConfigOriginRequestAccessArgs();
        }

        public Builder(ConfigConfigOriginRequestAccessArgs defaults) {
            $ = new ConfigConfigOriginRequestAccessArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ConfigConfigOriginRequestAccessArgs build() {
            if ($.audTags == null) {
                throw new MissingRequiredPropertyException("ConfigConfigOriginRequestAccessArgs", "audTags");
            }
            if ($.teamName == null) {
                throw new MissingRequiredPropertyException("ConfigConfigOriginRequestAccessArgs", "teamName");
            }
            return $;
        }
    }
