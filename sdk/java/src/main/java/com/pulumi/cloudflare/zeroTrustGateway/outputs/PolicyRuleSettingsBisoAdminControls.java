...
@CustomType
public final class PolicyRuleSettingsBisoAdminControls {
    /**
    ...
    private PolicyRuleSettingsBisoAdminControls() {}
    /**
     * @return Configure copy behavior. If set to remote*only, users cannot copy isolated content from the remote browser to the local clipboard. If this field is absent, copying remains enabled. Applies only when version == &#34;v2&#34;.
     * Available values: &#34;enabled&#34;, &#34;disabled&#34;, &#34;remote*only&#34;.
     * 
    ...
    public static Builder builder(PolicyRuleSettingsBisoAdminControls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String wmId;
        public Builder() {}
        public Builder(PolicyRuleSettingsBisoAdminControls defaults) {
        ...
        public PolicyRuleSettingsBisoAdminControls build() {
            final var _resultValue = new PolicyRuleSettingsBisoAdminControls();
