...
public final class ZeroTrustGatewayLoggingSettingsByRuleTypeDnsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZeroTrustGatewayLoggingSettingsByRuleTypeDnsArgs Empty = new ZeroTrustGatewayLoggingSettingsByRuleTypeDnsArgs();
    ...
    private ZeroTrustGatewayLoggingSettingsByRuleTypeDnsArgs() {}

    private ZeroTrustGatewayLoggingSettingsByRuleTypeDnsArgs(ZeroTrustGatewayLoggingSettingsByRuleTypeDnsArgs $) {
        this.logAll = $.logAll;
    ...
    public static Builder builder(ZeroTrustGatewayLoggingSettingsByRuleTypeDnsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustGatewayLoggingSettingsByRuleTypeDnsArgs();
        }

        public Builder(ZeroTrustGatewayLoggingSettingsByRuleTypeDnsArgs defaults) {
            $ = new ZeroTrustGatewayLoggingSettingsByRuleTypeDnsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ZeroTrustGatewayLoggingSettingsByRuleTypeDnsArgs build() {
            return $;
        }
    }
