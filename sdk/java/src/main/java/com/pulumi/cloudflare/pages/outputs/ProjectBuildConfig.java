...
public final class ProjectBuildConfig {
    ...
    public static Builder builder(ProjectBuildConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String webAnalyticsToken;
        public Builder() {}
        public Builder(ProjectBuildConfig defaults) {
        ...
        public ProjectBuildConfig build() {
            final var _resultValue = new ProjectBuildConfig();
