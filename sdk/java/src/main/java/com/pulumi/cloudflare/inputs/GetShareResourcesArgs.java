...
public final class GetShareResourcesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetShareResourcesArgs Empty = new GetShareResourcesArgs();
    ...
    private GetShareResourcesArgs() {}

    private GetShareResourcesArgs(GetShareResourcesArgs $) {
    ...
    public static Builder builder(GetShareResourcesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetShareResourcesArgs();
        }

        public Builder(GetShareResourcesArgs defaults) {
            $ = new GetShareResourcesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetShareResourcesArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetShareResourcesArgs", "accountId");
            }
            if ($.shareId == null) {
                throw new MissingRequiredPropertyException("GetShareResourcesArgs", "shareId");
            }
            return $;
        }
    }
