...
@CustomType
public final class GetRateLimitsResultMatchRequest {
    /**
    ...
    private GetRateLimitsResultMatchRequest() {}
    /**
     * @return The HTTP methods to match. You can specify a subset (for example, `[&#39;POST&#39;,&#39;PUT&#39;]`) or all methods (`[&#39;_ALL_&#39;]`). This field is optional when creating a rate limit.
     * 
     */
    ...
    public static Builder builder(GetRateLimitsResultMatchRequest defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(GetRateLimitsResultMatchRequest defaults) {
        ...
        public Builder methods(List<String> methods) {
            if (methods == null) {
              throw new MissingRequiredPropertyException("GetRateLimitsResultMatchRequest", "methods");
            }
        ...
        public Builder schemes(List<String> schemes) {
            if (schemes == null) {
              throw new MissingRequiredPropertyException("GetRateLimitsResultMatchRequest", "schemes");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetRateLimitsResultMatchRequest", "url");
            }
            this.url = url;
            return this;
        }
        public GetRateLimitsResultMatchRequest build() {
            final var _resultValue = new GetRateLimitsResultMatchRequest();
