...
public final class VariantOptions {
    ...
    public static Builder builder(VariantOptions defaults) {
    ...
    public static final class Builder {
        ...
        private Double width;
        public Builder() {}
        public Builder(VariantOptions defaults) {
        ...
        public Builder fit(String fit) {
            if (fit == null) {
              throw new MissingRequiredPropertyException("VariantOptions", "fit");
            }
            this.fit = fit;
            return this;
        }
        ...
        public Builder height(Double height) {
            if (height == null) {
              throw new MissingRequiredPropertyException("VariantOptions", "height");
            }
            this.height = height;
            return this;
        }
        ...
        public Builder metadata(String metadata) {
            if (metadata == null) {
              throw new MissingRequiredPropertyException("VariantOptions", "metadata");
            }
        ...
        public Builder width(Double width) {
            if (width == null) {
              throw new MissingRequiredPropertyException("VariantOptions", "width");
            }
            this.width = width;
            return this;
        }
        public VariantOptions build() {
            final var _resultValue = new VariantOptions();
