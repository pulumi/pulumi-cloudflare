...
package com.pulumi.cloudflare.zoneCache.outputs;
...
@CustomType
public final class GetVariantsValue {
    /**
    ...
    public static Builder builder(GetVariantsValue defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> webps;
        public Builder() {}
        public Builder(GetVariantsValue defaults) {
        ...
        public Builder avifs(List<String> avifs) {
            if (avifs == null) {
              throw new MissingRequiredPropertyException("GetVariantsValue", "avifs");
            }
            this.avifs = avifs;
            return this;
        }
        ...
        public Builder bmps(List<String> bmps) {
            if (bmps == null) {
              throw new MissingRequiredPropertyException("GetVariantsValue", "bmps");
            }
            this.bmps = bmps;
            return this;
        }
        ...
        public Builder gifs(List<String> gifs) {
            if (gifs == null) {
              throw new MissingRequiredPropertyException("GetVariantsValue", "gifs");
            }
            this.gifs = gifs;
            return this;
        }
        ...
        public Builder jp2s(List<String> jp2s) {
            if (jp2s == null) {
              throw new MissingRequiredPropertyException("GetVariantsValue", "jp2s");
            }
            this.jp2s = jp2s;
            return this;
        }
        ...
        public Builder jpegs(List<String> jpegs) {
            if (jpegs == null) {
              throw new MissingRequiredPropertyException("GetVariantsValue", "jpegs");
            }
            this.jpegs = jpegs;
            return this;
        }
        ...
        public Builder jpg2s(List<String> jpg2s) {
            if (jpg2s == null) {
              throw new MissingRequiredPropertyException("GetVariantsValue", "jpg2s");
            }
            this.jpg2s = jpg2s;
            return this;
        }
        ...
        public Builder jpgs(List<String> jpgs) {
            if (jpgs == null) {
              throw new MissingRequiredPropertyException("GetVariantsValue", "jpgs");
            }
            this.jpgs = jpgs;
            return this;
        }
        ...
        public Builder pngs(List<String> pngs) {
            if (pngs == null) {
              throw new MissingRequiredPropertyException("GetVariantsValue", "pngs");
            }
            this.pngs = pngs;
            return this;
        }
        ...
        public Builder tiffs(List<String> tiffs) {
            if (tiffs == null) {
              throw new MissingRequiredPropertyException("GetVariantsValue", "tiffs");
            }
            this.tiffs = tiffs;
            return this;
        }
        ...
        public Builder tifs(List<String> tifs) {
            if (tifs == null) {
              throw new MissingRequiredPropertyException("GetVariantsValue", "tifs");
            }
            this.tifs = tifs;
            return this;
        }
        ...
        public Builder webps(List<String> webps) {
            if (webps == null) {
              throw new MissingRequiredPropertyException("GetVariantsValue", "webps");
            }
            this.webps = webps;
            return this;
        }
        ...
        public GetVariantsValue build() {
            final var _resultValue = new GetVariantsValue();
