...
import com.pulumi.cloudflare.zeroTrustDevicePosture.outputs.GetRulesResultInput;
import com.pulumi.cloudflare.zeroTrustDevicePosture.outputs.GetRulesResultMatch;
...
public final class GetRulesResult {
     ...
     * 
     */
    private GetRulesResultInput input;
    /**
     * @return The conditions that the client must match to run the rule.
     * 
     */
    private List<GetRulesResultMatch> matches;
    /**
     ...
     * 
     */
    public GetRulesResultInput input() {
        return this.input;
    }
    /**
     * @return The conditions that the client must match to run the rule.
     * 
     */
    public List<GetRulesResultMatch> matches() {
        return this.matches;
    }
    /**
     * @return The name of the device posture rule.
    ...
    public static final class Builder {
        ...
        public Builder expiration(String expiration) {
            if (expiration == null) {
              throw new MissingRequiredPropertyException("GetRulesResult", "expiration");
            }
        ...
        @CustomType.Setter
        public Builder input(GetRulesResultInput input) {
            if (input == null) {
              throw new MissingRequiredPropertyException("GetRulesResult", "input");
            }
            this.input = input;
            return this;
        }
        @CustomType.Setter
        public Builder matches(List<GetRulesResultMatch> matches) {
            if (matches == null) {
              throw new MissingRequiredPropertyException("GetRulesResult", "matches");
            }
            this.matches = matches;
            return this;
        }
        public Builder matches(GetRulesResultMatch... matches) {
        ...
        public Builder schedule(String schedule) {
            if (schedule == null) {
              throw new MissingRequiredPropertyException("GetRulesResult", "schedule");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetRulesResult", "type");
            }
            this.type = type;
            return this;
        }
