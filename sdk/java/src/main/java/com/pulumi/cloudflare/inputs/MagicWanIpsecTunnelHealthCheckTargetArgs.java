...
public final class MagicWanIpsecTunnelHealthCheckTargetArgs extends com.pulumi.resources.ResourceArgs {

    public static final MagicWanIpsecTunnelHealthCheckTargetArgs Empty = new MagicWanIpsecTunnelHealthCheckTargetArgs();
    ...
    private MagicWanIpsecTunnelHealthCheckTargetArgs() {}

    private MagicWanIpsecTunnelHealthCheckTargetArgs(MagicWanIpsecTunnelHealthCheckTargetArgs $) {
    ...
    public static Builder builder(MagicWanIpsecTunnelHealthCheckTargetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagicWanIpsecTunnelHealthCheckTargetArgs();
        }

        public Builder(MagicWanIpsecTunnelHealthCheckTargetArgs defaults) {
            $ = new MagicWanIpsecTunnelHealthCheckTargetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MagicWanIpsecTunnelHealthCheckTargetArgs build() {
            return $;
        }
    }
