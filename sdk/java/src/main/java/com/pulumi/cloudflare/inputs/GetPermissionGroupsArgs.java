...
public final class GetPermissionGroupsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetPermissionGroupsArgs Empty = new GetPermissionGroupsArgs();
    ...
    private GetPermissionGroupsArgs() {}

    private GetPermissionGroupsArgs(GetPermissionGroupsArgs $) {
    ...
    public static Builder builder(GetPermissionGroupsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPermissionGroupsArgs();
        }

        public Builder(GetPermissionGroupsArgs defaults) {
            $ = new GetPermissionGroupsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPermissionGroupsArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetPermissionGroupsArgs", "accountId");
            }
            return $;
        }
    }
