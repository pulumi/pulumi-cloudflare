...
import com.pulumi.cloudflare.inputs.ZeroTrustDeviceProfilesState;
 ...
 * 
 */
@ResourceType(type="cloudflare:index/zeroTrustDeviceProfiles:ZeroTrustDeviceProfiles")
public class ZeroTrustDeviceProfiles extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ZeroTrustDeviceProfiles(java.lang.String name) {
        this(name, ZeroTrustDeviceProfilesArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ZeroTrustDeviceProfiles(java.lang.String name, ZeroTrustDeviceProfilesArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ZeroTrustDeviceProfiles(java.lang.String name, ZeroTrustDeviceProfilesArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:index/zeroTrustDeviceProfiles:ZeroTrustDeviceProfiles", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ZeroTrustDeviceProfiles(java.lang.String name, Output<java.lang.String> id, @Nullable ZeroTrustDeviceProfilesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:index/zeroTrustDeviceProfiles:ZeroTrustDeviceProfiles", name, state, makeResourceOptions(options, id), false);
    }

    private static ZeroTrustDeviceProfilesArgs makeArgs(ZeroTrustDeviceProfilesArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ZeroTrustDeviceProfilesArgs.Empty : args;
    }
     ...
     */
    public static ZeroTrustDeviceProfiles get(java.lang.String name, Output<java.lang.String> id, @Nullable ZeroTrustDeviceProfilesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new ZeroTrustDeviceProfiles(name, id, state, options);
    }
}
