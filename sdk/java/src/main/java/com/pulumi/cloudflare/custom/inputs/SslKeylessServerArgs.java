...
import com.pulumi.cloudflare.custom.inputs.SslKeylessServerTunnelArgs;
...
public final class SslKeylessServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final SslKeylessServerArgs Empty = new SslKeylessServerArgs();
     ...
     */
    @Import(name="tunnel")
    private @Nullable Output<SslKeylessServerTunnelArgs> tunnel;

    /**
     * @return Configuration for using Keyless SSL through a Cloudflare Tunnel.
     * 
     */
    public Optional<Output<SslKeylessServerTunnelArgs>> tunnel() {
        return Optional.ofNullable(this.tunnel);
    }

    private SslKeylessServerArgs() {}

    private SslKeylessServerArgs(SslKeylessServerArgs $) {
    ...
    public static Builder builder(SslKeylessServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SslKeylessServerArgs();
        }

        public Builder(SslKeylessServerArgs defaults) {
            $ = new SslKeylessServerArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder tunnel(@Nullable Output<SslKeylessServerTunnelArgs> tunnel) {
            $.tunnel = tunnel;
            return this;
        }
         ...
         * 
         */
        public Builder tunnel(SslKeylessServerTunnelArgs tunnel) {
            return tunnel(Output.of(tunnel));
        }

        public SslKeylessServerArgs build() {
            return $;
        }
    }
