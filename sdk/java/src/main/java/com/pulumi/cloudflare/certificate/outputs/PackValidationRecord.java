...
@CustomType
public final class PackValidationRecord {
    /**
    ...
    public static Builder builder(PackValidationRecord defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String txtValue;
        public Builder() {}
        public Builder(PackValidationRecord defaults) {
        ...
        public PackValidationRecord build() {
            final var _resultValue = new PackValidationRecord();
