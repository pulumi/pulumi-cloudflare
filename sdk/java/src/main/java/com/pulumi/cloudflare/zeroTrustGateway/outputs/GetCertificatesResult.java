    ...
    public static final class Builder {
        ...
        public Builder bindingStatus(String bindingStatus) {
            if (bindingStatus == null) {
              throw new MissingRequiredPropertyException("GetCertificatesResult", "bindingStatus");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetCertificatesResult", "createdAt");
            }
        ...
        public Builder fingerprint(String fingerprint) {
            if (fingerprint == null) {
              throw new MissingRequiredPropertyException("GetCertificatesResult", "fingerprint");
            }
        ...
        public Builder inUse(Boolean inUse) {
            if (inUse == null) {
              throw new MissingRequiredPropertyException("GetCertificatesResult", "inUse");
            }
            this.inUse = inUse;
            return this;
        }
        ...
        public Builder issuerOrg(String issuerOrg) {
            if (issuerOrg == null) {
              throw new MissingRequiredPropertyException("GetCertificatesResult", "issuerOrg");
            }
        ...
        public Builder issuerRaw(String issuerRaw) {
            if (issuerRaw == null) {
              throw new MissingRequiredPropertyException("GetCertificatesResult", "issuerRaw");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetCertificatesResult", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetCertificatesResult", "updatedAt");
            }
        ...
        public Builder uploadedOn(String uploadedOn) {
            if (uploadedOn == null) {
              throw new MissingRequiredPropertyException("GetCertificatesResult", "uploadedOn");
            }
