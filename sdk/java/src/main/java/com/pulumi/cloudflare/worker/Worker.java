...
import com.pulumi.cloudflare.worker.inputs.WorkerState;
import com.pulumi.cloudflare.worker.outputs.WorkerObservability;
import com.pulumi.cloudflare.worker.outputs.WorkerReferences;
import com.pulumi.cloudflare.worker.outputs.WorkerSubdomain;
import com.pulumi.cloudflare.worker.outputs.WorkerTailConsumer;
 ...
 * 
 */
@ResourceType(type="cloudflare:worker/worker:Worker")
public class Worker extends com.pulumi.resources.CustomResource {
    ...
    public Worker(java.lang.String name, WorkerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:worker/worker:Worker", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Worker(java.lang.String name, Output<java.lang.String> id, @Nullable WorkerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:worker/worker:Worker", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/worker:Worker").build())
            ))
            .build();
