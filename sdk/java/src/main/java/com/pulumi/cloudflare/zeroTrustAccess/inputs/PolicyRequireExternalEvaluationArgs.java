...
public final class PolicyRequireExternalEvaluationArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyRequireExternalEvaluationArgs Empty = new PolicyRequireExternalEvaluationArgs();
    ...
    private PolicyRequireExternalEvaluationArgs() {}

    private PolicyRequireExternalEvaluationArgs(PolicyRequireExternalEvaluationArgs $) {
    ...
    public static Builder builder(PolicyRequireExternalEvaluationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyRequireExternalEvaluationArgs();
        }

        public Builder(PolicyRequireExternalEvaluationArgs defaults) {
            $ = new PolicyRequireExternalEvaluationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyRequireExternalEvaluationArgs build() {
            if ($.evaluateUrl == null) {
                throw new MissingRequiredPropertyException("PolicyRequireExternalEvaluationArgs", "evaluateUrl");
            }
            if ($.keysUrl == null) {
                throw new MissingRequiredPropertyException("PolicyRequireExternalEvaluationArgs", "keysUrl");
            }
            return $;
        }
    }
