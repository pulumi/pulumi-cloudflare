...
import com.pulumi.cloudflare.aiSearch.outputs.GetInstanceRetrievalOptionsBoostBy;
...
@CustomType
public final class GetInstanceRetrievalOptions {
    /**
     ...
     * 
     */
    private List<GetInstanceRetrievalOptionsBoostBy> boostBies;
    /**
    ...
    private GetInstanceRetrievalOptions() {}
    /**
     * @return Metadata fields to boost search results by. Each entry specifies a metadata field and an optional direction. Direction defaults to &#39;asc&#39; for numeric/datetime fields and &#39;exists&#39; for text/boolean fields. Fields must match &#39;timestamp&#39; or a defined custom*metadata field.
     * 
     */
    public List<GetInstanceRetrievalOptionsBoostBy> boostBies() {
    ...
    public static Builder builder(GetInstanceRetrievalOptions defaults) {
    ...
    public static final class Builder {
        ...
        private String keywordMatchMode;
        public Builder() {}
        public Builder(GetInstanceRetrievalOptions defaults) {
        ...
        @CustomType.Setter
        public Builder boostBies(List<GetInstanceRetrievalOptionsBoostBy> boostBies) {
            if (boostBies == null) {
              throw new MissingRequiredPropertyException("GetInstanceRetrievalOptions", "boostBies");
            }
            this.boostBies = boostBies;
            return this;
        }
        public Builder boostBies(GetInstanceRetrievalOptionsBoostBy... boostBies) {
            return boostBies(List.of(boostBies));
        }
        @CustomType.Setter
        public Builder keywordMatchMode(String keywordMatchMode) {
            if (keywordMatchMode == null) {
              throw new MissingRequiredPropertyException("GetInstanceRetrievalOptions", "keywordMatchMode");
            }
            this.keywordMatchMode = keywordMatchMode;
            return this;
        }
        public GetInstanceRetrievalOptions build() {
            final var _resultValue = new GetInstanceRetrievalOptions();
