...
@CustomType
public final class OrganizationMfaConfig {
    /**
    ...
    public static Builder builder(OrganizationMfaConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sessionDuration;
        public Builder() {}
        public Builder(OrganizationMfaConfig defaults) {
        ...
        public OrganizationMfaConfig build() {
            final var _resultValue = new OrganizationMfaConfig();
