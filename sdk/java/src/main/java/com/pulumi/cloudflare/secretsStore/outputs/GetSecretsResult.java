...
public final class GetSecretsResult {
    ...
    public static final class Builder {
        ...
        public Builder comment(String comment) {
            if (comment == null) {
              throw new MissingRequiredPropertyException("GetSecretsResult", "comment");
            }
        ...
        public Builder created(String created) {
            if (created == null) {
              throw new MissingRequiredPropertyException("GetSecretsResult", "created");
            }
        ...
        public Builder modified(String modified) {
            if (modified == null) {
              throw new MissingRequiredPropertyException("GetSecretsResult", "modified");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSecretsResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder scopes(List<String> scopes) {
            if (scopes == null) {
              throw new MissingRequiredPropertyException("GetSecretsResult", "scopes");
            }
            this.scopes = scopes;
            return this;
        }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetSecretsResult", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder storeId(String storeId) {
            if (storeId == null) {
              throw new MissingRequiredPropertyException("GetSecretsResult", "storeId");
            }
