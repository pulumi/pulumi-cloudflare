...
@CustomType
public final class VariantVariantOptions {
    /**
    ...
    public static Builder builder(VariantVariantOptions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double width;
        public Builder() {}
        public Builder(VariantVariantOptions defaults) {
        ...
        public VariantVariantOptions build() {
            final var _resultValue = new VariantVariantOptions();
