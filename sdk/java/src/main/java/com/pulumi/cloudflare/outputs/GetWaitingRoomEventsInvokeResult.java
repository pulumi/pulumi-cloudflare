...
import com.pulumi.cloudflare.outputs.GetWaitingRoomEventsResult;
...
public final class GetWaitingRoomEventsInvokeResult {
     ...
     * 
     */
    public List<GetWaitingRoomEventsResult> results() {
        return this.results;
    }
    ...
    public static Builder builder(GetWaitingRoomEventsInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder results(List<GetWaitingRoomEventsResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetWaitingRoomEventsInvokeResult", "results");
            }
            this.results = results;
            return this;
        }
        public Builder results(GetWaitingRoomEventsResult... results) {
            return results(List.of(results));
        }
        @CustomType.Setter
        public Builder waitingRoomId(String waitingRoomId) {
            if (waitingRoomId == null) {
              throw new MissingRequiredPropertyException("GetWaitingRoomEventsInvokeResult", "waitingRoomId");
            }
