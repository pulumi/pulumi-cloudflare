...
public final class ZeroTrustAccessGroupExcludeGithubArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZeroTrustAccessGroupExcludeGithubArgs Empty = new ZeroTrustAccessGroupExcludeGithubArgs();
    ...
    private ZeroTrustAccessGroupExcludeGithubArgs() {}

    private ZeroTrustAccessGroupExcludeGithubArgs(ZeroTrustAccessGroupExcludeGithubArgs $) {
    ...
    public static Builder builder(ZeroTrustAccessGroupExcludeGithubArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZeroTrustAccessGroupExcludeGithubArgs();
        }

        public Builder(ZeroTrustAccessGroupExcludeGithubArgs defaults) {
            $ = new ZeroTrustAccessGroupExcludeGithubArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ZeroTrustAccessGroupExcludeGithubArgs build() {
            return $;
        }
    }
