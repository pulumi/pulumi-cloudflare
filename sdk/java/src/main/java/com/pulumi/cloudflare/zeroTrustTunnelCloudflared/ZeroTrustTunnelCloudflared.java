...
import com.pulumi.cloudflare.zeroTrustTunnelCloudflared.inputs.ZeroTrustTunnelCloudflaredState;
import com.pulumi.cloudflare.zeroTrustTunnelCloudflared.outputs.ZeroTrustTunnelCloudflaredConnection;
 ...
 * 
 */
@ResourceType(type="cloudflare:zeroTrustTunnelCloudflared/zeroTrustTunnelCloudflared:ZeroTrustTunnelCloudflared")
public class ZeroTrustTunnelCloudflared extends com.pulumi.resources.CustomResource {
    ...
    public ZeroTrustTunnelCloudflared(java.lang.String name, ZeroTrustTunnelCloudflaredArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zeroTrustTunnelCloudflared/zeroTrustTunnelCloudflared:ZeroTrustTunnelCloudflared", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ZeroTrustTunnelCloudflared(java.lang.String name, Output<java.lang.String> id, @Nullable ZeroTrustTunnelCloudflaredState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zeroTrustTunnelCloudflared/zeroTrustTunnelCloudflared:ZeroTrustTunnelCloudflared", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/zeroTrustTunnelCloudflared:ZeroTrustTunnelCloudflared").build()),
