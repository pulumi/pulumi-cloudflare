...
public final class AccessPolicyRequireSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccessPolicyRequireSamlArgs Empty = new AccessPolicyRequireSamlArgs();
    ...
    private AccessPolicyRequireSamlArgs() {}

    private AccessPolicyRequireSamlArgs(AccessPolicyRequireSamlArgs $) {
    ...
    public static Builder builder(AccessPolicyRequireSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessPolicyRequireSamlArgs();
        }

        public Builder(AccessPolicyRequireSamlArgs defaults) {
            $ = new AccessPolicyRequireSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccessPolicyRequireSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("AccessPolicyRequireSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("AccessPolicyRequireSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("AccessPolicyRequireSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
