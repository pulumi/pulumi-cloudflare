...
@CustomType
public final class TeamsRuleSchedule {
    /**
    ...
    public static Builder builder(TeamsRuleSchedule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String wed;
        public Builder() {}
        public Builder(TeamsRuleSchedule defaults) {
        ...
        public TeamsRuleSchedule build() {
            final var _resultValue = new TeamsRuleSchedule();
