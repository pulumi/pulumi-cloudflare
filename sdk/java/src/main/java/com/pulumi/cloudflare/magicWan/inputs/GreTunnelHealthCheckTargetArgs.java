...
public final class GreTunnelHealthCheckTargetArgs extends com.pulumi.resources.ResourceArgs {

    public static final GreTunnelHealthCheckTargetArgs Empty = new GreTunnelHealthCheckTargetArgs();
    ...
    private GreTunnelHealthCheckTargetArgs() {}

    private GreTunnelHealthCheckTargetArgs(GreTunnelHealthCheckTargetArgs $) {
    ...
    public static Builder builder(GreTunnelHealthCheckTargetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GreTunnelHealthCheckTargetArgs();
        }

        public Builder(GreTunnelHealthCheckTargetArgs defaults) {
            $ = new GreTunnelHealthCheckTargetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GreTunnelHealthCheckTargetArgs build() {
            return $;
        }
    }
