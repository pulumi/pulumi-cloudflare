...
public final class ApplicationPolicyExcludeSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationPolicyExcludeSamlArgs Empty = new ApplicationPolicyExcludeSamlArgs();
    ...
    private ApplicationPolicyExcludeSamlArgs() {}

    private ApplicationPolicyExcludeSamlArgs(ApplicationPolicyExcludeSamlArgs $) {
    ...
    public static Builder builder(ApplicationPolicyExcludeSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationPolicyExcludeSamlArgs();
        }

        public Builder(ApplicationPolicyExcludeSamlArgs defaults) {
            $ = new ApplicationPolicyExcludeSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApplicationPolicyExcludeSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("ApplicationPolicyExcludeSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("ApplicationPolicyExcludeSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("ApplicationPolicyExcludeSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
