...
@CustomType
public final class GetLoadBalancersResultSessionAffinityAttributes {
    /**
    ...
    private GetLoadBalancersResultSessionAffinityAttributes() {}
    /**
     * @return Configures the drain duration in seconds. This field is only used when session affinity is enabled on the load balancer.
     * 
     */
    ...
    public static Builder builder(GetLoadBalancersResultSessionAffinityAttributes defaults) {
    ...
    public static final class Builder {
        ...
        private String zeroDowntimeFailover;
        public Builder() {}
        public Builder(GetLoadBalancersResultSessionAffinityAttributes defaults) {
        ...
        public Builder drainDuration(Double drainDuration) {
            if (drainDuration == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancersResultSessionAffinityAttributes", "drainDuration");
            }
        ...
        public Builder headers(List<String> headers) {
            if (headers == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancersResultSessionAffinityAttributes", "headers");
            }
        ...
        public Builder requireAllHeaders(Boolean requireAllHeaders) {
            if (requireAllHeaders == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancersResultSessionAffinityAttributes", "requireAllHeaders");
            }
        ...
        public Builder samesite(String samesite) {
            if (samesite == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancersResultSessionAffinityAttributes", "samesite");
            }
        ...
        public Builder secure(String secure) {
            if (secure == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancersResultSessionAffinityAttributes", "secure");
            }
            this.secure = secure;
            return this;
        }
        ...
        public Builder zeroDowntimeFailover(String zeroDowntimeFailover) {
            if (zeroDowntimeFailover == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancersResultSessionAffinityAttributes", "zeroDowntimeFailover");
            }
            this.zeroDowntimeFailover = zeroDowntimeFailover;
            return this;
        }
        public GetLoadBalancersResultSessionAffinityAttributes build() {
            final var _resultValue = new GetLoadBalancersResultSessionAffinityAttributes();
