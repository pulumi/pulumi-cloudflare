...
public final class GetZeroTrustAccessGroupsResultIncludeDevicePosture {
    ...
    public static Builder builder(GetZeroTrustAccessGroupsResultIncludeDevicePosture defaults) {
    ...
    public static final class Builder {
        ...
        public Builder integrationUid(String integrationUid) {
            if (integrationUid == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessGroupsResultIncludeDevicePosture", "integrationUid");
            }
