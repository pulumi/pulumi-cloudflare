...
public final class WanStaticAddressingArgs extends com.pulumi.resources.ResourceArgs {

    public static final WanStaticAddressingArgs Empty = new WanStaticAddressingArgs();
    ...
    private WanStaticAddressingArgs() {}

    private WanStaticAddressingArgs(WanStaticAddressingArgs $) {
    ...
    public static Builder builder(WanStaticAddressingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WanStaticAddressingArgs();
        }

        public Builder(WanStaticAddressingArgs defaults) {
            $ = new WanStaticAddressingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WanStaticAddressingArgs build() {
            if ($.address == null) {
                throw new MissingRequiredPropertyException("WanStaticAddressingArgs", "address");
            }
            if ($.gatewayAddress == null) {
                throw new MissingRequiredPropertyException("WanStaticAddressingArgs", "gatewayAddress");
            }
            return $;
        }
    }
