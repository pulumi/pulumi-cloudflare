    ...
    public static final class Builder {
        ...
        public Builder identityProviderId(String identityProviderId) {
            if (identityProviderId == null) {
              throw new MissingRequiredPropertyException("AccessGroupRequireOkta", "identityProviderId");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("AccessGroupRequireOkta", "name");
            }
            this.name = name;
            return this;
        }
