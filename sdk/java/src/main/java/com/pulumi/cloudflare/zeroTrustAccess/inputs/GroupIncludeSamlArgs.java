...
public final class GroupIncludeSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupIncludeSamlArgs Empty = new GroupIncludeSamlArgs();
    ...
    private GroupIncludeSamlArgs() {}

    private GroupIncludeSamlArgs(GroupIncludeSamlArgs $) {
    ...
    public static Builder builder(GroupIncludeSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupIncludeSamlArgs();
        }

        public Builder(GroupIncludeSamlArgs defaults) {
            $ = new GroupIncludeSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupIncludeSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("GroupIncludeSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("GroupIncludeSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("GroupIncludeSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
