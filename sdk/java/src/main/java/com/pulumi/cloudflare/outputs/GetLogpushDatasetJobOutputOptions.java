...
@CustomType
public final class GetLogpushDatasetJobOutputOptions {
    /**
    ...
    private GetLogpushDatasetJobOutputOptions() {}
    /**
     * @return String to be prepended before each batch.
     * 
     */
    ...
    public static Builder builder(GetLogpushDatasetJobOutputOptions defaults) {
    ...
    public static final class Builder {
        ...
        private String timestampFormat;
        public Builder() {}
        public Builder(GetLogpushDatasetJobOutputOptions defaults) {
        ...
        public Builder batchPrefix(String batchPrefix) {
            if (batchPrefix == null) {
              throw new MissingRequiredPropertyException("GetLogpushDatasetJobOutputOptions", "batchPrefix");
            }
        ...
        public Builder batchSuffix(String batchSuffix) {
            if (batchSuffix == null) {
              throw new MissingRequiredPropertyException("GetLogpushDatasetJobOutputOptions", "batchSuffix");
            }
        ...
        public Builder cve202144228(Boolean cve202144228) {
            if (cve202144228 == null) {
              throw new MissingRequiredPropertyException("GetLogpushDatasetJobOutputOptions", "cve202144228");
            }
        ...
        public Builder fieldDelimiter(String fieldDelimiter) {
            if (fieldDelimiter == null) {
              throw new MissingRequiredPropertyException("GetLogpushDatasetJobOutputOptions", "fieldDelimiter");
            }
        ...
        public Builder fieldNames(List<String> fieldNames) {
            if (fieldNames == null) {
              throw new MissingRequiredPropertyException("GetLogpushDatasetJobOutputOptions", "fieldNames");
            }
        ...
        public Builder outputType(String outputType) {
            if (outputType == null) {
              throw new MissingRequiredPropertyException("GetLogpushDatasetJobOutputOptions", "outputType");
            }
        ...
        public Builder recordDelimiter(String recordDelimiter) {
            if (recordDelimiter == null) {
              throw new MissingRequiredPropertyException("GetLogpushDatasetJobOutputOptions", "recordDelimiter");
            }
        ...
        public Builder recordPrefix(String recordPrefix) {
            if (recordPrefix == null) {
              throw new MissingRequiredPropertyException("GetLogpushDatasetJobOutputOptions", "recordPrefix");
            }
        ...
        public Builder recordSuffix(String recordSuffix) {
            if (recordSuffix == null) {
              throw new MissingRequiredPropertyException("GetLogpushDatasetJobOutputOptions", "recordSuffix");
            }
        ...
        public Builder recordTemplate(String recordTemplate) {
            if (recordTemplate == null) {
              throw new MissingRequiredPropertyException("GetLogpushDatasetJobOutputOptions", "recordTemplate");
            }
        ...
        public Builder sampleRate(Double sampleRate) {
            if (sampleRate == null) {
              throw new MissingRequiredPropertyException("GetLogpushDatasetJobOutputOptions", "sampleRate");
            }
        ...
        public Builder timestampFormat(String timestampFormat) {
            if (timestampFormat == null) {
              throw new MissingRequiredPropertyException("GetLogpushDatasetJobOutputOptions", "timestampFormat");
            }
            this.timestampFormat = timestampFormat;
            return this;
        }
        public GetLogpushDatasetJobOutputOptions build() {
            final var _resultValue = new GetLogpushDatasetJobOutputOptions();
