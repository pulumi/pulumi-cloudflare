...
@CustomType
public final class GetConfigsResultCaching {
    /**
    ...
    private GetConfigsResultCaching() {}
    /**
     * @return Set to true to disable caching of SQL responses. Default is false.
     * 
     */
    ...
    public static Builder builder(GetConfigsResultCaching defaults) {
    ...
    public static final class Builder {
        ...
        private Integer staleWhileRevalidate;
        public Builder() {}
        public Builder(GetConfigsResultCaching defaults) {
        ...
        public Builder disabled(Boolean disabled) {
            if (disabled == null) {
              throw new MissingRequiredPropertyException("GetConfigsResultCaching", "disabled");
            }
        ...
        public Builder maxAge(Integer maxAge) {
            if (maxAge == null) {
              throw new MissingRequiredPropertyException("GetConfigsResultCaching", "maxAge");
            }
            this.maxAge = maxAge;
            return this;
        }
        ...
        public Builder staleWhileRevalidate(Integer staleWhileRevalidate) {
            if (staleWhileRevalidate == null) {
              throw new MissingRequiredPropertyException("GetConfigsResultCaching", "staleWhileRevalidate");
            }
            this.staleWhileRevalidate = staleWhileRevalidate;
            return this;
        }
        public GetConfigsResultCaching build() {
            final var _resultValue = new GetConfigsResultCaching();
