...
@CustomType
public final class ProjectLatestDeploymentBuildConfig {
    /**
    ...
    public static Builder builder(ProjectLatestDeploymentBuildConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String webAnalyticsToken;
        public Builder() {}
        public Builder(ProjectLatestDeploymentBuildConfig defaults) {
        ...
        public ProjectLatestDeploymentBuildConfig build() {
            final var _resultValue = new ProjectLatestDeploymentBuildConfig();
