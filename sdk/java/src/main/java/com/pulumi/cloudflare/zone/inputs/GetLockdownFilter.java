...
public final class GetLockdownFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetLockdownFilter Empty = new GetLockdownFilter();
    ...
    private GetLockdownFilter() {}

    private GetLockdownFilter(GetLockdownFilter $) {
    ...
    public static Builder builder(GetLockdownFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLockdownFilter();
        }

        public Builder(GetLockdownFilter defaults) {
            $ = new GetLockdownFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetLockdownFilter build() {
            return $;
        }
    }
