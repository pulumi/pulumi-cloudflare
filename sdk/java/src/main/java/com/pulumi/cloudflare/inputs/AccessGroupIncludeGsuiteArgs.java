...
public final class AccessGroupIncludeGsuiteArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AccessGroupIncludeGsuiteArgs build() {
            if ($.emails == null) {
                throw new MissingRequiredPropertyException("AccessGroupIncludeGsuiteArgs", "emails");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("AccessGroupIncludeGsuiteArgs", "identityProviderId");
            }
            return $;
        }
    }
