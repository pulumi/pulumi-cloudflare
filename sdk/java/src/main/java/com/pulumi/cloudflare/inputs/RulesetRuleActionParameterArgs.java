...
import com.pulumi.cloudflare.inputs.RulesetRuleActionParameterAutominifyArgs;
import com.pulumi.cloudflare.inputs.RulesetRuleActionParameterBrowserTtlArgs;
import com.pulumi.cloudflare.inputs.RulesetRuleActionParameterCacheKeyArgs;
import com.pulumi.cloudflare.inputs.RulesetRuleActionParameterEdgeTtlArgs;
import com.pulumi.cloudflare.inputs.RulesetRuleActionParameterFromListArgs;
import com.pulumi.cloudflare.inputs.RulesetRuleActionParameterFromValueArgs;
import com.pulumi.cloudflare.inputs.RulesetRuleActionParameterHeaderArgs;
import com.pulumi.cloudflare.inputs.RulesetRuleActionParameterMatchedDataArgs;
import com.pulumi.cloudflare.inputs.RulesetRuleActionParameterOriginArgs;
import com.pulumi.cloudflare.inputs.RulesetRuleActionParameterOverrideArgs;
import com.pulumi.cloudflare.inputs.RulesetRuleActionParameterResponseArgs;
import com.pulumi.cloudflare.inputs.RulesetRuleActionParameterServeStaleArgs;
import com.pulumi.cloudflare.inputs.RulesetRuleActionParameterSniArgs;
import com.pulumi.cloudflare.inputs.RulesetRuleActionParameterUriArgs;
...
public final class RulesetRuleActionParameterArgs extends com.pulumi.resources.ResourceArgs {

    public static final RulesetRuleActionParameterArgs Empty = new RulesetRuleActionParameterArgs();
    ...
    private Output<List<RulesetRuleActionParameterAutominifyArgs>> autominifies;

    public Output<List<RulesetRuleActionParameterAutominifyArgs>> autominifies() {
    ...
    private Output<List<RulesetRuleActionParameterBrowserTtlArgs>> browserTtls;

    public Output<List<RulesetRuleActionParameterBrowserTtlArgs>> browserTtls() {
    ...
    private Output<List<RulesetRuleActionParameterCacheKeyArgs>> cacheKeys;

    public Output<List<RulesetRuleActionParameterCacheKeyArgs>> cacheKeys() {
    ...
    private Output<List<RulesetRuleActionParameterEdgeTtlArgs>> edgeTtls;

    public Output<List<RulesetRuleActionParameterEdgeTtlArgs>> edgeTtls() {
    ...
    private Output<List<RulesetRuleActionParameterFromListArgs>> fromLists;

    public Output<List<RulesetRuleActionParameterFromListArgs>> fromLists() {
        return this.fromLists;
    }

    @Import(name="fromValues", required=true)
    private Output<List<RulesetRuleActionParameterFromValueArgs>> fromValues;

    public Output<List<RulesetRuleActionParameterFromValueArgs>> fromValues() {
        return this.fromValues;
    }

    @Import(name="headers", required=true)
    private Output<List<RulesetRuleActionParameterHeaderArgs>> headers;

    public Output<List<RulesetRuleActionParameterHeaderArgs>> headers() {
        return this.headers;
    }
    ...
    private Output<List<RulesetRuleActionParameterMatchedDataArgs>> matchedDatas;

    public Output<List<RulesetRuleActionParameterMatchedDataArgs>> matchedDatas() {
    ...
    private Output<List<RulesetRuleActionParameterOriginArgs>> origins;

    public Output<List<RulesetRuleActionParameterOriginArgs>> origins() {
        return this.origins;
    }

    @Import(name="overrides", required=true)
    private Output<List<RulesetRuleActionParameterOverrideArgs>> overrides;

    public Output<List<RulesetRuleActionParameterOverrideArgs>> overrides() {
    ...
    private Output<List<RulesetRuleActionParameterResponseArgs>> responses;

    public Output<List<RulesetRuleActionParameterResponseArgs>> responses() {
    ...
    private Output<List<RulesetRuleActionParameterServeStaleArgs>> serveStales;

    public Output<List<RulesetRuleActionParameterServeStaleArgs>> serveStales() {
    ...
    private Output<List<RulesetRuleActionParameterSniArgs>> snis;

    public Output<List<RulesetRuleActionParameterSniArgs>> snis() {
        return this.snis;
    }
    ...
    private Output<List<RulesetRuleActionParameterUriArgs>> uris;

    public Output<List<RulesetRuleActionParameterUriArgs>> uris() {
        return this.uris;
    }
    ...
    private RulesetRuleActionParameterArgs() {}

    private RulesetRuleActionParameterArgs(RulesetRuleActionParameterArgs $) {
    ...
    public static Builder builder(RulesetRuleActionParameterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RulesetRuleActionParameterArgs();
        }

        public Builder(RulesetRuleActionParameterArgs defaults) {
            $ = new RulesetRuleActionParameterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder autominifies(Output<List<RulesetRuleActionParameterAutominifyArgs>> autominifies) {
            $.autominifies = autominifies;
            return this;
        }

        public Builder autominifies(List<RulesetRuleActionParameterAutominifyArgs> autominifies) {
            return autominifies(Output.of(autominifies));
        }

        public Builder autominifies(RulesetRuleActionParameterAutominifyArgs... autominifies) {
        ...
        public Builder browserTtls(Output<List<RulesetRuleActionParameterBrowserTtlArgs>> browserTtls) {
            $.browserTtls = browserTtls;
            return this;
        }

        public Builder browserTtls(List<RulesetRuleActionParameterBrowserTtlArgs> browserTtls) {
            return browserTtls(Output.of(browserTtls));
        }

        public Builder browserTtls(RulesetRuleActionParameterBrowserTtlArgs... browserTtls) {
        ...
        public Builder cacheKeys(Output<List<RulesetRuleActionParameterCacheKeyArgs>> cacheKeys) {
            $.cacheKeys = cacheKeys;
            return this;
        }

        public Builder cacheKeys(List<RulesetRuleActionParameterCacheKeyArgs> cacheKeys) {
            return cacheKeys(Output.of(cacheKeys));
        }

        public Builder cacheKeys(RulesetRuleActionParameterCacheKeyArgs... cacheKeys) {
        ...
        public Builder edgeTtls(Output<List<RulesetRuleActionParameterEdgeTtlArgs>> edgeTtls) {
            $.edgeTtls = edgeTtls;
            return this;
        }

        public Builder edgeTtls(List<RulesetRuleActionParameterEdgeTtlArgs> edgeTtls) {
            return edgeTtls(Output.of(edgeTtls));
        }

        public Builder edgeTtls(RulesetRuleActionParameterEdgeTtlArgs... edgeTtls) {
        ...
        public Builder fromLists(Output<List<RulesetRuleActionParameterFromListArgs>> fromLists) {
            $.fromLists = fromLists;
            return this;
        }

        public Builder fromLists(List<RulesetRuleActionParameterFromListArgs> fromLists) {
            return fromLists(Output.of(fromLists));
        }

        public Builder fromLists(RulesetRuleActionParameterFromListArgs... fromLists) {
            return fromLists(List.of(fromLists));
        }

        public Builder fromValues(Output<List<RulesetRuleActionParameterFromValueArgs>> fromValues) {
            $.fromValues = fromValues;
            return this;
        }

        public Builder fromValues(List<RulesetRuleActionParameterFromValueArgs> fromValues) {
            return fromValues(Output.of(fromValues));
        }

        public Builder fromValues(RulesetRuleActionParameterFromValueArgs... fromValues) {
            return fromValues(List.of(fromValues));
        }

        public Builder headers(Output<List<RulesetRuleActionParameterHeaderArgs>> headers) {
            $.headers = headers;
            return this;
        }

        public Builder headers(List<RulesetRuleActionParameterHeaderArgs> headers) {
            return headers(Output.of(headers));
        }

        public Builder headers(RulesetRuleActionParameterHeaderArgs... headers) {
        ...
        public Builder matchedDatas(Output<List<RulesetRuleActionParameterMatchedDataArgs>> matchedDatas) {
            $.matchedDatas = matchedDatas;
            return this;
        }

        public Builder matchedDatas(List<RulesetRuleActionParameterMatchedDataArgs> matchedDatas) {
            return matchedDatas(Output.of(matchedDatas));
        }

        public Builder matchedDatas(RulesetRuleActionParameterMatchedDataArgs... matchedDatas) {
        ...
        public Builder origins(Output<List<RulesetRuleActionParameterOriginArgs>> origins) {
            $.origins = origins;
            return this;
        }

        public Builder origins(List<RulesetRuleActionParameterOriginArgs> origins) {
            return origins(Output.of(origins));
        }

        public Builder origins(RulesetRuleActionParameterOriginArgs... origins) {
            return origins(List.of(origins));
        }

        public Builder overrides(Output<List<RulesetRuleActionParameterOverrideArgs>> overrides) {
            $.overrides = overrides;
            return this;
        }

        public Builder overrides(List<RulesetRuleActionParameterOverrideArgs> overrides) {
            return overrides(Output.of(overrides));
        }

        public Builder overrides(RulesetRuleActionParameterOverrideArgs... overrides) {
        ...
        public Builder responses(Output<List<RulesetRuleActionParameterResponseArgs>> responses) {
            $.responses = responses;
            return this;
        }

        public Builder responses(List<RulesetRuleActionParameterResponseArgs> responses) {
            return responses(Output.of(responses));
        }

        public Builder responses(RulesetRuleActionParameterResponseArgs... responses) {
        ...
        public Builder serveStales(Output<List<RulesetRuleActionParameterServeStaleArgs>> serveStales) {
            $.serveStales = serveStales;
            return this;
        }

        public Builder serveStales(List<RulesetRuleActionParameterServeStaleArgs> serveStales) {
            return serveStales(Output.of(serveStales));
        }

        public Builder serveStales(RulesetRuleActionParameterServeStaleArgs... serveStales) {
        ...
        public Builder snis(Output<List<RulesetRuleActionParameterSniArgs>> snis) {
            $.snis = snis;
            return this;
        }

        public Builder snis(List<RulesetRuleActionParameterSniArgs> snis) {
            return snis(Output.of(snis));
        }

        public Builder snis(RulesetRuleActionParameterSniArgs... snis) {
        ...
        public Builder uris(Output<List<RulesetRuleActionParameterUriArgs>> uris) {
            $.uris = uris;
            return this;
        }

        public Builder uris(List<RulesetRuleActionParameterUriArgs> uris) {
            return uris(Output.of(uris));
        }

        public Builder uris(RulesetRuleActionParameterUriArgs... uris) {
        ...
        public RulesetRuleActionParameterArgs build() {
