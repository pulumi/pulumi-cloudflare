...
@CustomType
public final class ZeroTrustAccessPolicyApprovalGroup {
    /**
    ...
    public static Builder builder(ZeroTrustAccessPolicyApprovalGroup defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String emailListUuid;
        public Builder() {}
        public Builder(ZeroTrustAccessPolicyApprovalGroup defaults) {
        ...
        public Builder approvalsNeeded(Double approvalsNeeded) {
            if (approvalsNeeded == null) {
              throw new MissingRequiredPropertyException("ZeroTrustAccessPolicyApprovalGroup", "approvalsNeeded");
            }
        ...
        public ZeroTrustAccessPolicyApprovalGroup build() {
            final var _resultValue = new ZeroTrustAccessPolicyApprovalGroup();
