...
import com.pulumi.cloudflare.zeroTrustAccess.outputs.ApplicationScimConfigMappingOperations;
...
@CustomType
public final class ApplicationScimConfigMapping {
    /**
     ...
     * 
     */
    private @Nullable ApplicationScimConfigMappingOperations operations;
    /**
    ...
    private ApplicationScimConfigMapping() {}
    /**
     * @return Whether or not this mapping is enabled.
     * 
     */
     ...
     * 
     */
    public Optional<ApplicationScimConfigMappingOperations> operations() {
    ...
    public static Builder builder(ApplicationScimConfigMapping defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String transformJsonata;
        public Builder() {}
        public Builder(ApplicationScimConfigMapping defaults) {
        ...
        @CustomType.Setter
        public Builder operations(@Nullable ApplicationScimConfigMappingOperations operations) {
        ...
        public Builder schema(String schema) {
            if (schema == null) {
              throw new MissingRequiredPropertyException("ApplicationScimConfigMapping", "schema");
            }
            this.schema = schema;
            return this;
        }
        ...
        public ApplicationScimConfigMapping build() {
            final var _resultValue = new ApplicationScimConfigMapping();
