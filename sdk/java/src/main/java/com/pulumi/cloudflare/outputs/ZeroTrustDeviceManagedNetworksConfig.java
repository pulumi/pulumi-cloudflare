...
@CustomType
public final class ZeroTrustDeviceManagedNetworksConfig {
    /**
    ...
    public static Builder builder(ZeroTrustDeviceManagedNetworksConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String tlsSockaddr;
        public Builder() {}
        public Builder(ZeroTrustDeviceManagedNetworksConfig defaults) {
        ...
        public Builder sha256(String sha256) {
            if (sha256 == null) {
              throw new MissingRequiredPropertyException("ZeroTrustDeviceManagedNetworksConfig", "sha256");
            }
            this.sha256 = sha256;
            return this;
        }
        ...
        public Builder tlsSockaddr(String tlsSockaddr) {
            if (tlsSockaddr == null) {
              throw new MissingRequiredPropertyException("ZeroTrustDeviceManagedNetworksConfig", "tlsSockaddr");
            }
            this.tlsSockaddr = tlsSockaddr;
            return this;
        }
        public ZeroTrustDeviceManagedNetworksConfig build() {
            final var _resultValue = new ZeroTrustDeviceManagedNetworksConfig();
