...
import com.pulumi.cloudflare.oauth.inputs.ClientState;
import com.pulumi.cloudflare.oauth.outputs.ClientClientUriVerification;
 ...
 * 
 */
@ResourceType(type="cloudflare:oauth/client:Client")
public class Client extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="clientUriVerification", refs={ClientClientUriVerification.class}, tree="[0]")
    private Output<ClientClientUriVerification> clientUriVerification;

    /**
     * @return Client URI domain control verification state.
     * 
     */
    public Output<ClientClientUriVerification> clientUriVerification() {
    ...
    public Client(java.lang.String name, ClientArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:oauth/client:Client", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Client(java.lang.String name, Output<java.lang.String> id, @Nullable ClientState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:oauth/client:Client", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/oauthClient:OauthClient").build())
            ))
