...
public final class GetVersionPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetVersionPlainArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetVersionPlainArgs", "accountId");
            }
            if ($.versionId == null) {
                throw new MissingRequiredPropertyException("GetVersionPlainArgs", "versionId");
            }
            if ($.workerId == null) {
                throw new MissingRequiredPropertyException("GetVersionPlainArgs", "workerId");
            }
            return $;
        }
    }
