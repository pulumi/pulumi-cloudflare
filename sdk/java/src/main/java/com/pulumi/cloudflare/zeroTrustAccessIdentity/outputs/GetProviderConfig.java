...
import com.pulumi.cloudflare.zeroTrustAccessIdentity.outputs.GetProviderConfigHeaderAttribute;
...
@CustomType
public final class GetProviderConfig {
    /**
     ...
     * 
     */
    private List<GetProviderConfigHeaderAttribute> headerAttributes;
    /**
     ...
     * 
     */
    public List<GetProviderConfigHeaderAttribute> headerAttributes() {
    ...
    public static Builder builder(GetProviderConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String tokenUrl;
        public Builder() {}
        public Builder(GetProviderConfig defaults) {
        ...
        public Builder appsDomain(String appsDomain) {
            if (appsDomain == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "appsDomain");
            }
        ...
        public Builder attributes(List<String> attributes) {
            if (attributes == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "attributes");
            }
        ...
        public Builder authUrl(String authUrl) {
            if (authUrl == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "authUrl");
            }
        ...
        public Builder authorizationServerId(String authorizationServerId) {
            if (authorizationServerId == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "authorizationServerId");
            }
        ...
        public Builder centrifyAccount(String centrifyAccount) {
            if (centrifyAccount == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "centrifyAccount");
            }
        ...
        public Builder centrifyAppId(String centrifyAppId) {
            if (centrifyAppId == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "centrifyAppId");
            }
        ...
        public Builder certsUrl(String certsUrl) {
            if (certsUrl == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "certsUrl");
            }
        ...
        public Builder claims(List<String> claims) {
            if (claims == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "claims");
            }
            this.claims = claims;
            return this;
        }
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "clientId");
            }
        ...
        public Builder clientSecret(String clientSecret) {
            if (clientSecret == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "clientSecret");
            }
        ...
        public Builder conditionalAccessEnabled(Boolean conditionalAccessEnabled) {
            if (conditionalAccessEnabled == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "conditionalAccessEnabled");
            }
        ...
        public Builder directoryId(String directoryId) {
            if (directoryId == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "directoryId");
            }
        ...
        public Builder emailAttributeName(String emailAttributeName) {
            if (emailAttributeName == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "emailAttributeName");
            }
        ...
        public Builder emailClaimName(String emailClaimName) {
            if (emailClaimName == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "emailClaimName");
            }
        ...
        public Builder enableEncryption(Boolean enableEncryption) {
            if (enableEncryption == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "enableEncryption");
            }
            this.enableEncryption = enableEncryption;
            return this;
        }
        @CustomType.Setter
        public Builder headerAttributes(List<GetProviderConfigHeaderAttribute> headerAttributes) {
            if (headerAttributes == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "headerAttributes");
            }
            this.headerAttributes = headerAttributes;
            return this;
        }
        public Builder headerAttributes(GetProviderConfigHeaderAttribute... headerAttributes) {
        ...
        public Builder idpPublicCerts(List<String> idpPublicCerts) {
            if (idpPublicCerts == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "idpPublicCerts");
            }
        ...
        public Builder issuerUrl(String issuerUrl) {
            if (issuerUrl == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "issuerUrl");
            }
        ...
        public Builder oktaAccount(String oktaAccount) {
            if (oktaAccount == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "oktaAccount");
            }
        ...
        public Builder oneloginAccount(String oneloginAccount) {
            if (oneloginAccount == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "oneloginAccount");
            }
        ...
        public Builder pingEnvId(String pingEnvId) {
            if (pingEnvId == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "pingEnvId");
            }
        ...
        public Builder pkceEnabled(Boolean pkceEnabled) {
            if (pkceEnabled == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "pkceEnabled");
            }
        ...
        public Builder prompt(String prompt) {
            if (prompt == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "prompt");
            }
            this.prompt = prompt;
            return this;
        }
        ...
        public Builder redirectUrl(String redirectUrl) {
            if (redirectUrl == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "redirectUrl");
            }
        ...
        public Builder restrictToAccountMembers(Boolean restrictToAccountMembers) {
            if (restrictToAccountMembers == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "restrictToAccountMembers");
            }
        ...
        public Builder scopes(List<String> scopes) {
            if (scopes == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "scopes");
            }
            this.scopes = scopes;
            return this;
        }
        ...
        public Builder signRequest(Boolean signRequest) {
            if (signRequest == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "signRequest");
            }
        ...
        public Builder ssoTargetUrl(String ssoTargetUrl) {
            if (ssoTargetUrl == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "ssoTargetUrl");
            }
        ...
        public Builder supportGroups(Boolean supportGroups) {
            if (supportGroups == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "supportGroups");
            }
        ...
        public Builder tokenUrl(String tokenUrl) {
            if (tokenUrl == null) {
              throw new MissingRequiredPropertyException("GetProviderConfig", "tokenUrl");
            }
            this.tokenUrl = tokenUrl;
            return this;
        }
        public GetProviderConfig build() {
            final var _resultValue = new GetProviderConfig();
