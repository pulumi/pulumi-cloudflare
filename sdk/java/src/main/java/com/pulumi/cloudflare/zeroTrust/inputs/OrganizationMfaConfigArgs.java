...
public final class OrganizationMfaConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final OrganizationMfaConfigArgs Empty = new OrganizationMfaConfigArgs();
    ...
    private OrganizationMfaConfigArgs() {}

    private OrganizationMfaConfigArgs(OrganizationMfaConfigArgs $) {
    ...
    public static Builder builder(OrganizationMfaConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OrganizationMfaConfigArgs();
        }

        public Builder(OrganizationMfaConfigArgs defaults) {
            $ = new OrganizationMfaConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OrganizationMfaConfigArgs build() {
            return $;
        }
    }
