...
import com.pulumi.cloudflare.zeroTrustDeviceCustomProfile.inputs.ZeroTrustDeviceCustomProfileState;
import com.pulumi.cloudflare.zeroTrustDeviceCustomProfile.outputs.ZeroTrustDeviceCustomProfileDnsSearchSuffix;
import com.pulumi.cloudflare.zeroTrustDeviceCustomProfile.outputs.ZeroTrustDeviceCustomProfileExclude;
import com.pulumi.cloudflare.zeroTrustDeviceCustomProfile.outputs.ZeroTrustDeviceCustomProfileFallbackDomain;
import com.pulumi.cloudflare.zeroTrustDeviceCustomProfile.outputs.ZeroTrustDeviceCustomProfileGlobalAcceleration;
import com.pulumi.cloudflare.zeroTrustDeviceCustomProfile.outputs.ZeroTrustDeviceCustomProfileInclude;
import com.pulumi.cloudflare.zeroTrustDeviceCustomProfile.outputs.ZeroTrustDeviceCustomProfileServiceModeV2;
import com.pulumi.cloudflare.zeroTrustDeviceCustomProfile.outputs.ZeroTrustDeviceCustomProfileTargetTest;
import com.pulumi.cloudflare.zeroTrustDeviceCustomProfile.outputs.ZeroTrustDeviceCustomProfileVirtualNetworks;
 ...
 * 
 */
@ResourceType(type="cloudflare:zeroTrustDeviceCustomProfile/zeroTrustDeviceCustomProfile:ZeroTrustDeviceCustomProfile")
public class ZeroTrustDeviceCustomProfile extends com.pulumi.resources.CustomResource {
    ...
    public ZeroTrustDeviceCustomProfile(java.lang.String name, ZeroTrustDeviceCustomProfileArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zeroTrustDeviceCustomProfile/zeroTrustDeviceCustomProfile:ZeroTrustDeviceCustomProfile", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ZeroTrustDeviceCustomProfile(java.lang.String name, Output<java.lang.String> id, @Nullable ZeroTrustDeviceCustomProfileState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zeroTrustDeviceCustomProfile/zeroTrustDeviceCustomProfile:ZeroTrustDeviceCustomProfile", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/zeroTrustDeviceCustomProfile:ZeroTrustDeviceCustomProfile").build())
            ))
            .build();
