...
public final class GetMessageArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetMessageArgs build() {
            if ($.page == null) {
                throw new MissingRequiredPropertyException("GetMessageArgs", "page");
            }
            if ($.perPage == null) {
                throw new MissingRequiredPropertyException("GetMessageArgs", "perPage");
            }
            if ($.requestId == null) {
                throw new MissingRequiredPropertyException("GetMessageArgs", "requestId");
            }
            return $;
        }
    }
