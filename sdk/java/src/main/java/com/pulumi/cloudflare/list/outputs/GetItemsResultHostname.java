...
@CustomType
public final class GetItemsResultHostname {
    /**
    ...
    private GetItemsResultHostname() {}
    /**
     * @return Only applies to wildcard hostnames (e.g., *.example.com). When true (default), only subdomains are blocked. When false, both the root domain and subdomains are blocked.
     * 
     */
    ...
    public static Builder builder(GetItemsResultHostname defaults) {
    ...
    public static final class Builder {
        ...
        private String urlHostname;
        public Builder() {}
        public Builder(GetItemsResultHostname defaults) {
        ...
        public Builder excludeExactHostname(Boolean excludeExactHostname) {
            if (excludeExactHostname == null) {
              throw new MissingRequiredPropertyException("GetItemsResultHostname", "excludeExactHostname");
            }
        ...
        public Builder urlHostname(String urlHostname) {
            if (urlHostname == null) {
              throw new MissingRequiredPropertyException("GetItemsResultHostname", "urlHostname");
            }
            this.urlHostname = urlHostname;
            return this;
        }
        public GetItemsResultHostname build() {
            final var _resultValue = new GetItemsResultHostname();
