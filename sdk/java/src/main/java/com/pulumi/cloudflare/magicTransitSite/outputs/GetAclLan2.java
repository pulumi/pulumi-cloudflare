...
public final class GetAclLan2 {
    ...
    public static Builder builder(GetAclLan2 defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> subnets;
        public Builder() {}
        public Builder(GetAclLan2 defaults) {
        ...
        public Builder lanId(String lanId) {
            if (lanId == null) {
              throw new MissingRequiredPropertyException("GetAclLan2", "lanId");
            }
            this.lanId = lanId;
            return this;
        }
        ...
        public Builder lanName(String lanName) {
            if (lanName == null) {
              throw new MissingRequiredPropertyException("GetAclLan2", "lanName");
            }
        ...
        public Builder portRanges(List<String> portRanges) {
            if (portRanges == null) {
              throw new MissingRequiredPropertyException("GetAclLan2", "portRanges");
            }
        ...
        public Builder ports(List<Integer> ports) {
            if (ports == null) {
              throw new MissingRequiredPropertyException("GetAclLan2", "ports");
            }
            this.ports = ports;
            return this;
        }
        ...
        public Builder subnets(List<String> subnets) {
            if (subnets == null) {
              throw new MissingRequiredPropertyException("GetAclLan2", "subnets");
            }
        ...
        public GetAclLan2 build() {
            final var _resultValue = new GetAclLan2();
