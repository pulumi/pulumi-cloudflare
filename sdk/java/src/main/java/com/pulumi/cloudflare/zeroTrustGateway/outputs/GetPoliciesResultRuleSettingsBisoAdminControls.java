...
@CustomType
public final class GetPoliciesResultRuleSettingsBisoAdminControls {
    /**
    ...
    private GetPoliciesResultRuleSettingsBisoAdminControls() {}
    /**
     * @return Configure copy behavior. If set to remote*only, users cannot copy isolated content from the remote browser to the local clipboard. If this field is absent, copying remains enabled. Applies only when version == &#34;v2&#34;.
     * Available values: &#34;enabled&#34;, &#34;disabled&#34;, &#34;remote*only&#34;.
     * 
    ...
    public static Builder builder(GetPoliciesResultRuleSettingsBisoAdminControls defaults) {
    ...
    public static final class Builder {
        ...
        private String wmId;
        public Builder() {}
        public Builder(GetPoliciesResultRuleSettingsBisoAdminControls defaults) {
        ...
        public Builder copy(String copy) {
            if (copy == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettingsBisoAdminControls", "copy");
            }
            this.copy = copy;
            return this;
        }
        ...
        public Builder dcp(Boolean dcp) {
            if (dcp == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettingsBisoAdminControls", "dcp");
            }
            this.dcp = dcp;
            return this;
        }
        ...
        public Builder dd(Boolean dd) {
            if (dd == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettingsBisoAdminControls", "dd");
            }
            this.dd = dd;
            return this;
        }
        ...
        public Builder dk(Boolean dk) {
            if (dk == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettingsBisoAdminControls", "dk");
            }
            this.dk = dk;
            return this;
        }
        ...
        public Builder download(String download) {
            if (download == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettingsBisoAdminControls", "download");
            }
        ...
        public Builder dp(Boolean dp) {
            if (dp == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettingsBisoAdminControls", "dp");
            }
            this.dp = dp;
            return this;
        }
        ...
        public Builder du(Boolean du) {
            if (du == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettingsBisoAdminControls", "du");
            }
            this.du = du;
            return this;
        }
        ...
        public Builder keyboard(String keyboard) {
            if (keyboard == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettingsBisoAdminControls", "keyboard");
            }
        ...
        public Builder paste(String paste) {
            if (paste == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettingsBisoAdminControls", "paste");
            }
            this.paste = paste;
            return this;
        }
        ...
        public Builder printing(String printing) {
            if (printing == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettingsBisoAdminControls", "printing");
            }
        ...
        public Builder upload(String upload) {
            if (upload == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettingsBisoAdminControls", "upload");
            }
            this.upload = upload;
            return this;
        }
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettingsBisoAdminControls", "version");
            }
        ...
        public Builder wmId(String wmId) {
            if (wmId == null) {
              throw new MissingRequiredPropertyException("GetPoliciesResultRuleSettingsBisoAdminControls", "wmId");
            }
            this.wmId = wmId;
            return this;
        }
        public GetPoliciesResultRuleSettingsBisoAdminControls build() {
            final var _resultValue = new GetPoliciesResultRuleSettingsBisoAdminControls();
