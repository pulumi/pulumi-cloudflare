...
@CustomType
public final class GetStreamWatermark {
    /**
    ...
    public static Builder builder(GetStreamWatermark defaults) {
    ...
    public static final class Builder {
        ...
        private Integer width;
        public Builder() {}
        public Builder(GetStreamWatermark defaults) {
        ...
        public Builder created(String created) {
            if (created == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermark", "created");
            }
        ...
        public Builder downloadedFrom(String downloadedFrom) {
            if (downloadedFrom == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermark", "downloadedFrom");
            }
        ...
        public Builder height(Integer height) {
            if (height == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermark", "height");
            }
            this.height = height;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermark", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder opacity(Double opacity) {
            if (opacity == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermark", "opacity");
            }
        ...
        public Builder padding(Double padding) {
            if (padding == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermark", "padding");
            }
        ...
        public Builder position(String position) {
            if (position == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermark", "position");
            }
        ...
        public Builder scale(Double scale) {
            if (scale == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermark", "scale");
            }
            this.scale = scale;
            return this;
        }
        ...
        public Builder size(Double size) {
            if (size == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermark", "size");
            }
            this.size = size;
            return this;
        }
        ...
        public Builder uid(String uid) {
            if (uid == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermark", "uid");
            }
            this.uid = uid;
            return this;
        }
        ...
        public Builder width(Integer width) {
            if (width == null) {
              throw new MissingRequiredPropertyException("GetStreamWatermark", "width");
            }
            this.width = width;
            return this;
        }
        public GetStreamWatermark build() {
            final var _resultValue = new GetStreamWatermark();
