...
public final class AccessOrganizationMfaConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AccessOrganizationMfaConfigArgs() {}
    ...
    public static Builder builder(AccessOrganizationMfaConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessOrganizationMfaConfigArgs();
        }

        public Builder(AccessOrganizationMfaConfigArgs defaults) {
            $ = new AccessOrganizationMfaConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccessOrganizationMfaConfigArgs build() {
            return $;
        }
    }
