...
@CustomType
public final class GetProjectCanonicalDeploymentBuildConfig {
    /**
    ...
    private GetProjectCanonicalDeploymentBuildConfig() {}
    /**
     * @return Enable build caching for the project.
     * 
     */
    ...
    public static Builder builder(GetProjectCanonicalDeploymentBuildConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String webAnalyticsToken;
        public Builder() {}
        public Builder(GetProjectCanonicalDeploymentBuildConfig defaults) {
        ...
        public Builder buildCaching(Boolean buildCaching) {
            if (buildCaching == null) {
              throw new MissingRequiredPropertyException("GetProjectCanonicalDeploymentBuildConfig", "buildCaching");
            }
        ...
        public Builder buildCommand(String buildCommand) {
            if (buildCommand == null) {
              throw new MissingRequiredPropertyException("GetProjectCanonicalDeploymentBuildConfig", "buildCommand");
            }
        ...
        public Builder destinationDir(String destinationDir) {
            if (destinationDir == null) {
              throw new MissingRequiredPropertyException("GetProjectCanonicalDeploymentBuildConfig", "destinationDir");
            }
        ...
        public Builder rootDir(String rootDir) {
            if (rootDir == null) {
              throw new MissingRequiredPropertyException("GetProjectCanonicalDeploymentBuildConfig", "rootDir");
            }
        ...
        public Builder webAnalyticsTag(String webAnalyticsTag) {
            if (webAnalyticsTag == null) {
              throw new MissingRequiredPropertyException("GetProjectCanonicalDeploymentBuildConfig", "webAnalyticsTag");
            }
        ...
        public Builder webAnalyticsToken(String webAnalyticsToken) {
            if (webAnalyticsToken == null) {
              throw new MissingRequiredPropertyException("GetProjectCanonicalDeploymentBuildConfig", "webAnalyticsToken");
            }
            this.webAnalyticsToken = webAnalyticsToken;
            return this;
        }
        public GetProjectCanonicalDeploymentBuildConfig build() {
            final var _resultValue = new GetProjectCanonicalDeploymentBuildConfig();
