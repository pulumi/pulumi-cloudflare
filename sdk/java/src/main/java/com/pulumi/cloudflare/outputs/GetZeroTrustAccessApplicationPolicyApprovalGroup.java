...
@CustomType
public final class GetZeroTrustAccessApplicationPolicyApprovalGroup {
    /**
    ...
    private GetZeroTrustAccessApplicationPolicyApprovalGroup() {}
    /**
     * @return The number of approvals needed to obtain access.
     * 
     */
    ...
    public static Builder builder(GetZeroTrustAccessApplicationPolicyApprovalGroup defaults) {
    ...
    public static final class Builder {
        ...
        private String emailListUuid;
        public Builder() {}
        public Builder(GetZeroTrustAccessApplicationPolicyApprovalGroup defaults) {
        ...
        public Builder approvalsNeeded(Double approvalsNeeded) {
            if (approvalsNeeded == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessApplicationPolicyApprovalGroup", "approvalsNeeded");
            }
        ...
        public Builder emailAddresses(List<String> emailAddresses) {
            if (emailAddresses == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessApplicationPolicyApprovalGroup", "emailAddresses");
            }
        ...
        public Builder emailListUuid(String emailListUuid) {
            if (emailListUuid == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustAccessApplicationPolicyApprovalGroup", "emailListUuid");
            }
            this.emailListUuid = emailListUuid;
            return this;
        }
        public GetZeroTrustAccessApplicationPolicyApprovalGroup build() {
            final var _resultValue = new GetZeroTrustAccessApplicationPolicyApprovalGroup();
