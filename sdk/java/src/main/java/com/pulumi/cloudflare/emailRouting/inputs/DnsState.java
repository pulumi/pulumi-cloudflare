...
import com.pulumi.cloudflare.emailRouting.inputs.DnsErrorArgs;
import com.pulumi.cloudflare.emailRouting.inputs.DnsMessageArgs;
import com.pulumi.cloudflare.emailRouting.inputs.DnsResultArgs;
import com.pulumi.cloudflare.emailRouting.inputs.DnsResultInfoArgs;
...
public final class DnsState extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="errors")
    private @Nullable Output<List<DnsErrorArgs>> errors;

    public Optional<Output<List<DnsErrorArgs>>> errors() {
        return Optional.ofNullable(this.errors);
    }

    @Import(name="messages")
    private @Nullable Output<List<DnsMessageArgs>> messages;

    public Optional<Output<List<DnsMessageArgs>>> messages() {
    ...
    @Import(name="result")
    private @Nullable Output<DnsResultArgs> result;

    public Optional<Output<DnsResultArgs>> result() {
        return Optional.ofNullable(this.result);
    }

    @Import(name="resultInfo")
    private @Nullable Output<DnsResultInfoArgs> resultInfo;

    public Optional<Output<DnsResultInfoArgs>> resultInfo() {
    ...
    public static final class Builder {
        ...
        public Builder errors(@Nullable Output<List<DnsErrorArgs>> errors) {
            $.errors = errors;
            return this;
        }

        public Builder errors(List<DnsErrorArgs> errors) {
            return errors(Output.of(errors));
        }

        public Builder errors(DnsErrorArgs... errors) {
            return errors(List.of(errors));
        }

        public Builder messages(@Nullable Output<List<DnsMessageArgs>> messages) {
            $.messages = messages;
            return this;
        }

        public Builder messages(List<DnsMessageArgs> messages) {
            return messages(Output.of(messages));
        }

        public Builder messages(DnsMessageArgs... messages) {
        ...
        public Builder result(@Nullable Output<DnsResultArgs> result) {
            $.result = result;
            return this;
        }

        public Builder result(DnsResultArgs result) {
            return result(Output.of(result));
        }

        public Builder resultInfo(@Nullable Output<DnsResultInfoArgs> resultInfo) {
            $.resultInfo = resultInfo;
            return this;
        }

        public Builder resultInfo(DnsResultInfoArgs resultInfo) {
