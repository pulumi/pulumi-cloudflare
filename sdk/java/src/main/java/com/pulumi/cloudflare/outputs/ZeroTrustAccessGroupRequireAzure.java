...
@CustomType
public final class ZeroTrustAccessGroupRequireAzure {
    /**
    ...
    private ZeroTrustAccessGroupRequireAzure() {}
    /**
     * @return The ID of the Azure identity provider.
     * 
     */
    ...
    public static Builder builder(ZeroTrustAccessGroupRequireAzure defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> ids;
        public Builder() {}
        public Builder(ZeroTrustAccessGroupRequireAzure defaults) {
        ...
        public ZeroTrustAccessGroupRequireAzure build() {
            final var _resultValue = new ZeroTrustAccessGroupRequireAzure();
