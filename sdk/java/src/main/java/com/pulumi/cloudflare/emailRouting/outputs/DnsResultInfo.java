...
@CustomType
public final class DnsResultInfo {
    /**
    ...
    public static Builder builder(DnsResultInfo defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double totalPages;
        public Builder() {}
        public Builder(DnsResultInfo defaults) {
        ...
        public DnsResultInfo build() {
            final var _resultValue = new DnsResultInfo();
