...
import com.pulumi.cloudflare.address.outputs.GetMapIp;
import com.pulumi.cloudflare.address.outputs.GetMapMembership;
...
public final class GetMapResult {
     ...
     * 
     */
    private List<GetMapMembership> memberships;
     ...
     * 
     */
    public List<GetMapMembership> memberships() {
    ...
    public static final class Builder {
        ...
        public Builder addressMapId(String addressMapId) {
            if (addressMapId == null) {
              throw new MissingRequiredPropertyException("GetMapResult", "addressMapId");
            }
        ...
        public Builder canDelete(Boolean canDelete) {
            if (canDelete == null) {
              throw new MissingRequiredPropertyException("GetMapResult", "canDelete");
            }
        ...
        public Builder canModifyIps(Boolean canModifyIps) {
            if (canModifyIps == null) {
              throw new MissingRequiredPropertyException("GetMapResult", "canModifyIps");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetMapResult", "createdAt");
            }
        ...
        public Builder defaultSni(String defaultSni) {
            if (defaultSni == null) {
              throw new MissingRequiredPropertyException("GetMapResult", "defaultSni");
            }
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetMapResult", "enabled");
            }
        ...
        @CustomType.Setter
        public Builder ips(List<GetMapIp> ips) {
            if (ips == null) {
              throw new MissingRequiredPropertyException("GetMapResult", "ips");
            }
            this.ips = ips;
            return this;
        }
        public Builder ips(GetMapIp... ips) {
            return ips(List.of(ips));
        }
        @CustomType.Setter
        public Builder memberships(List<GetMapMembership> memberships) {
            if (memberships == null) {
              throw new MissingRequiredPropertyException("GetMapResult", "memberships");
            }
            this.memberships = memberships;
            return this;
        }
        public Builder memberships(GetMapMembership... memberships) {
            return memberships(List.of(memberships));
        }
        @CustomType.Setter
        public Builder modifiedAt(String modifiedAt) {
            if (modifiedAt == null) {
              throw new MissingRequiredPropertyException("GetMapResult", "modifiedAt");
            }
