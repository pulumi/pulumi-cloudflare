...
import com.pulumi.cloudflare.custom.outputs.GetHostnamesResultOwnershipVerification;
import com.pulumi.cloudflare.custom.outputs.GetHostnamesResultOwnershipVerificationHttp;
import com.pulumi.cloudflare.custom.outputs.GetHostnamesResultSsl;
...
public final class GetHostnamesResult {
     ...
     * 
     */
    private GetHostnamesResultOwnershipVerification ownershipVerification;
    /**
     * @return This presents the token to be served by the given http url to activate a hostname.
     * 
     */
    private GetHostnamesResultOwnershipVerificationHttp ownershipVerificationHttp;
    private GetHostnamesResultSsl ssl;
    /**
     ...
     * 
     */
    public GetHostnamesResultOwnershipVerification ownershipVerification() {
     ...
     * 
     */
    public GetHostnamesResultOwnershipVerificationHttp ownershipVerificationHttp() {
        return this.ownershipVerificationHttp;
    }
    public GetHostnamesResultSsl ssl() {
        return this.ssl;
    }
    /**
     * @return Status of the hostname&#39;s activation.
    ...
    public static final class Builder {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "createdAt");
            }
        ...
        public Builder customMetadata(Map<String,String> customMetadata) {
            if (customMetadata == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "customMetadata");
            }
        ...
        public Builder customOriginServer(String customOriginServer) {
            if (customOriginServer == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "customOriginServer");
            }
        ...
        public Builder customOriginSni(String customOriginSni) {
            if (customOriginSni == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "customOriginSni");
            }
        ...
        public Builder hostname(String hostname) {
            if (hostname == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "hostname");
            }
        ...
        @CustomType.Setter
        public Builder ownershipVerification(GetHostnamesResultOwnershipVerification ownershipVerification) {
            if (ownershipVerification == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "ownershipVerification");
            }
            this.ownershipVerification = ownershipVerification;
            return this;
        }
        @CustomType.Setter
        public Builder ownershipVerificationHttp(GetHostnamesResultOwnershipVerificationHttp ownershipVerificationHttp) {
            if (ownershipVerificationHttp == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "ownershipVerificationHttp");
            }
            this.ownershipVerificationHttp = ownershipVerificationHttp;
            return this;
        }
        @CustomType.Setter
        public Builder ssl(GetHostnamesResultSsl ssl) {
            if (ssl == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "ssl");
            }
            this.ssl = ssl;
            return this;
        }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder verificationErrors(List<String> verificationErrors) {
            if (verificationErrors == null) {
              throw new MissingRequiredPropertyException("GetHostnamesResult", "verificationErrors");
            }
