...
public final class GetWorkersForPlatformsScriptSecretArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetWorkersForPlatformsScriptSecretArgs Empty = new GetWorkersForPlatformsScriptSecretArgs();
    ...
    private GetWorkersForPlatformsScriptSecretArgs() {}

    private GetWorkersForPlatformsScriptSecretArgs(GetWorkersForPlatformsScriptSecretArgs $) {
    ...
    public static Builder builder(GetWorkersForPlatformsScriptSecretArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetWorkersForPlatformsScriptSecretArgs();
        }

        public Builder(GetWorkersForPlatformsScriptSecretArgs defaults) {
            $ = new GetWorkersForPlatformsScriptSecretArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetWorkersForPlatformsScriptSecretArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetWorkersForPlatformsScriptSecretArgs", "accountId");
            }
            if ($.dispatchNamespace == null) {
                throw new MissingRequiredPropertyException("GetWorkersForPlatformsScriptSecretArgs", "dispatchNamespace");
            }
            if ($.scriptName == null) {
                throw new MissingRequiredPropertyException("GetWorkersForPlatformsScriptSecretArgs", "scriptName");
            }
            return $;
        }
    }
