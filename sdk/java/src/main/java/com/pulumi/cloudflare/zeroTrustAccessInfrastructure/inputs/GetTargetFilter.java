...
public final class GetTargetFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetTargetFilter Empty = new GetTargetFilter();
    ...
    private GetTargetFilter(GetTargetFilter $) {
    ...
    public static Builder builder(GetTargetFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetTargetFilter defaults) {
            $ = new GetTargetFilter(Objects.requireNonNull(defaults));
        }
