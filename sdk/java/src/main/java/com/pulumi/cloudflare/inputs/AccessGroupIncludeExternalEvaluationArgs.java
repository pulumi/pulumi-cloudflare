...
public final class AccessGroupIncludeExternalEvaluationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AccessGroupIncludeExternalEvaluationArgs build() {
            if ($.evaluateUrl == null) {
                throw new MissingRequiredPropertyException("AccessGroupIncludeExternalEvaluationArgs", "evaluateUrl");
            }
            if ($.keysUrl == null) {
                throw new MissingRequiredPropertyException("AccessGroupIncludeExternalEvaluationArgs", "keysUrl");
            }
            return $;
        }
    }
