...
@CustomType
public final class AccessApplicationPolicy {
    /**
     * @return The rules that define how users may connect to the targets secured by your application.
     * 
     */
    private @Nullable AccessApplicationPolicyConnectionRules connectionRules;
    /**
     ...
     * 
     */
    public Optional<AccessApplicationPolicyConnectionRules> connectionRules() {
     ...
     * 
     */
    public List<AccessApplicationPolicyExclude> excludes() {
     ...
     * 
     */
    public List<AccessApplicationPolicyInclude> includes() {
     ...
     * 
     */
    public List<AccessApplicationPolicyRequire> requires() {
    ...
    public static Builder builder(AccessApplicationPolicy defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<AccessApplicationPolicyRequire> requires;
        public Builder() {}
        public Builder(AccessApplicationPolicy defaults) {
        ...
        @CustomType.Setter
        public Builder connectionRules(@Nullable AccessApplicationPolicyConnectionRules connectionRules) {
        ...
        @CustomType.Setter
        public Builder excludes(@Nullable List<AccessApplicationPolicyExclude> excludes) {

            this.excludes = excludes;
            return this;
        }
        public Builder excludes(AccessApplicationPolicyExclude... excludes) {
        ...
        @CustomType.Setter
        public Builder includes(@Nullable List<AccessApplicationPolicyInclude> includes) {

            this.includes = includes;
            return this;
        }
        public Builder includes(AccessApplicationPolicyInclude... includes) {
        ...
        @CustomType.Setter
        public Builder requires(@Nullable List<AccessApplicationPolicyRequire> requires) {

            this.requires = requires;
            return this;
        }
        public Builder requires(AccessApplicationPolicyRequire... requires) {
            return requires(List.of(requires));
        }
        public AccessApplicationPolicy build() {
            final var _resultValue = new AccessApplicationPolicy();
