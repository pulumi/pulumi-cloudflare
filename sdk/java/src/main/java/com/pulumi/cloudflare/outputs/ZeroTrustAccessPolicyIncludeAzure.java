...
public final class ZeroTrustAccessPolicyIncludeAzure {
    ...
    public static Builder builder(ZeroTrustAccessPolicyIncludeAzure defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> ids;
        public Builder() {}
        public Builder(ZeroTrustAccessPolicyIncludeAzure defaults) {
        ...
        public ZeroTrustAccessPolicyIncludeAzure build() {
            final var _resultValue = new ZeroTrustAccessPolicyIncludeAzure();
