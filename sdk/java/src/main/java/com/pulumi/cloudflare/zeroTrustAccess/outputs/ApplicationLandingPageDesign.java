...
@CustomType
public final class ApplicationLandingPageDesign {
    /**
    ...
    private ApplicationLandingPageDesign() {}
    /**
     * @return The background color of the log in button on the landing page.
     * 
     */
    ...
    public static Builder builder(ApplicationLandingPageDesign defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String title;
        public Builder() {}
        public Builder(ApplicationLandingPageDesign defaults) {
        ...
        public ApplicationLandingPageDesign build() {
            final var _resultValue = new ApplicationLandingPageDesign();
