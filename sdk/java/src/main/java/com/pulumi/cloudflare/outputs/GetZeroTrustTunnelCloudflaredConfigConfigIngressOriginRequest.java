...
import com.pulumi.cloudflare.outputs.GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestAccess;
...
public final class GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest {
     ...
     * 
     */
    private GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestAccess access;
    /**
    ...
    private GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest() {}
    /**
     * @return For all L7 requests to this hostname, cloudflared will validate each request&#39;s Cf-Access-Jwt-Assertion request header.
     * 
     */
    public GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestAccess access() {
        return this.access;
    }
    /**
     * @return Path to the certificate authority (CA) for the certificate of your origin. This option should be used only if your certificate is not signed by Cloudflare.
    ...
    public static Builder builder(GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest defaults) {
    ...
    public static final class Builder {
        ...
        private Integer tlsTimeout;
        public Builder() {}
        public Builder(GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest defaults) {
        ...
        @CustomType.Setter
        public Builder access(GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestAccess access) {
            if (access == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest", "access");
            }
            this.access = access;
            return this;
        }
        ...
        public Builder caPool(String caPool) {
            if (caPool == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest", "caPool");
            }
            this.caPool = caPool;
            return this;
        }
        ...
        public Builder connectTimeout(Integer connectTimeout) {
            if (connectTimeout == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest", "connectTimeout");
            }
        ...
        public Builder disableChunkedEncoding(Boolean disableChunkedEncoding) {
            if (disableChunkedEncoding == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest", "disableChunkedEncoding");
            }
        ...
        public Builder http2Origin(Boolean http2Origin) {
            if (http2Origin == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest", "http2Origin");
            }
        ...
        public Builder httpHostHeader(String httpHostHeader) {
            if (httpHostHeader == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest", "httpHostHeader");
            }
        ...
        public Builder keepAliveConnections(Integer keepAliveConnections) {
            if (keepAliveConnections == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest", "keepAliveConnections");
            }
        ...
        public Builder keepAliveTimeout(Integer keepAliveTimeout) {
            if (keepAliveTimeout == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest", "keepAliveTimeout");
            }
        ...
        public Builder matchSnItoHost(Boolean matchSnItoHost) {
            if (matchSnItoHost == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest", "matchSnItoHost");
            }
        ...
        public Builder noHappyEyeballs(Boolean noHappyEyeballs) {
            if (noHappyEyeballs == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest", "noHappyEyeballs");
            }
        ...
        public Builder noTlsVerify(Boolean noTlsVerify) {
            if (noTlsVerify == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest", "noTlsVerify");
            }
        ...
        public Builder originServerName(String originServerName) {
            if (originServerName == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest", "originServerName");
            }
        ...
        public Builder proxyType(String proxyType) {
            if (proxyType == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest", "proxyType");
            }
        ...
        public Builder tcpKeepAlive(Integer tcpKeepAlive) {
            if (tcpKeepAlive == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest", "tcpKeepAlive");
            }
        ...
        public Builder tlsTimeout(Integer tlsTimeout) {
            if (tlsTimeout == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest", "tlsTimeout");
            }
            this.tlsTimeout = tlsTimeout;
            return this;
        }
        public GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest build() {
            final var _resultValue = new GetZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest();
