...
import com.pulumi.cloudflare.zone.inputs.LockdownState;
import com.pulumi.cloudflare.zone.outputs.LockdownConfiguration;
 ...
 * 
 */
@ResourceType(type="cloudflare:zone/lockdown:Lockdown")
public class Lockdown extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="configurations", refs={List.class,LockdownConfiguration.class}, tree="[0,1]")
    private Output<List<LockdownConfiguration>> configurations;
     ...
     * 
     */
    public Output<List<LockdownConfiguration>> configurations() {
     ...
     */
    public Lockdown(java.lang.String name) {
        this(name, LockdownArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public Lockdown(java.lang.String name, LockdownArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Lockdown(java.lang.String name, LockdownArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zone/lockdown:Lockdown", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Lockdown(java.lang.String name, Output<java.lang.String> id, @Nullable LockdownState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:zone/lockdown:Lockdown", name, state, makeResourceOptions(options, id), false);
    }

    private static LockdownArgs makeArgs(LockdownArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LockdownArgs.Empty : args;
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/zoneLockdown:ZoneLockdown").build())
            ))
            .build();
     ...
     */
    public static Lockdown get(java.lang.String name, Output<java.lang.String> id, @Nullable LockdownState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new Lockdown(name, id, state, options);
    }
}
