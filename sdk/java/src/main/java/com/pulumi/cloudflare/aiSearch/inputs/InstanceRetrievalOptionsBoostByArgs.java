...
public final class InstanceRetrievalOptionsBoostByArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceRetrievalOptionsBoostByArgs Empty = new InstanceRetrievalOptionsBoostByArgs();
    ...
    private InstanceRetrievalOptionsBoostByArgs() {}

    private InstanceRetrievalOptionsBoostByArgs(InstanceRetrievalOptionsBoostByArgs $) {
    ...
    public static Builder builder(InstanceRetrievalOptionsBoostByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceRetrievalOptionsBoostByArgs();
        }

        public Builder(InstanceRetrievalOptionsBoostByArgs defaults) {
            $ = new InstanceRetrievalOptionsBoostByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceRetrievalOptionsBoostByArgs build() {
            if ($.field == null) {
                throw new MissingRequiredPropertyException("InstanceRetrievalOptionsBoostByArgs", "field");
            }
            return $;
        }
    }
