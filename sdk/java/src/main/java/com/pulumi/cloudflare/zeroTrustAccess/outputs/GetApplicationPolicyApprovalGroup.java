...
@CustomType
public final class GetApplicationPolicyApprovalGroup {
    /**
    ...
    private GetApplicationPolicyApprovalGroup() {}
    /**
     * @return The number of approvals needed to obtain access.
     * 
     */
    ...
    public static Builder builder(GetApplicationPolicyApprovalGroup defaults) {
    ...
    public static final class Builder {
        ...
        private String emailListUuid;
        public Builder() {}
        public Builder(GetApplicationPolicyApprovalGroup defaults) {
        ...
        public Builder approvalsNeeded(Double approvalsNeeded) {
            if (approvalsNeeded == null) {
              throw new MissingRequiredPropertyException("GetApplicationPolicyApprovalGroup", "approvalsNeeded");
            }
        ...
        public Builder emailAddresses(List<String> emailAddresses) {
            if (emailAddresses == null) {
              throw new MissingRequiredPropertyException("GetApplicationPolicyApprovalGroup", "emailAddresses");
            }
        ...
        public Builder emailListUuid(String emailListUuid) {
            if (emailListUuid == null) {
              throw new MissingRequiredPropertyException("GetApplicationPolicyApprovalGroup", "emailListUuid");
            }
            this.emailListUuid = emailListUuid;
            return this;
        }
        public GetApplicationPolicyApprovalGroup build() {
            final var _resultValue = new GetApplicationPolicyApprovalGroup();
