...
public final class ReserveState extends com.pulumi.resources.ResourceArgs {

    public static final ReserveState Empty = new ReserveState();
    ...
    public static Builder builder(ReserveState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ReserveState defaults) {
            $ = new ReserveState(Objects.requireNonNull(defaults));
        }
