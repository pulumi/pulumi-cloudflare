...
public final class LocationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<LocationEndpointsArgs> endpoints;

    /**
     * @return Configure the destination endpoints for this location.
     * 
     */
    public Optional<Output<LocationEndpointsArgs>> endpoints() {
     ...
     */
    @Import(name="maxTtl")
    private @Nullable Output<LocationMaxTtlArgs> maxTtl;
     ...
     * 
     */
    public Optional<Output<LocationMaxTtlArgs>> maxTtl() {
    ...
    private @Nullable Output<List<LocationNetworkArgs>> networks;
     ...
     * 
     */
    public Optional<Output<List<LocationNetworkArgs>>> networks() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder endpoints(@Nullable Output<LocationEndpointsArgs> endpoints) {
            $.endpoints = endpoints;
            return this;
        }
         ...
         * 
         */
        public Builder endpoints(LocationEndpointsArgs endpoints) {
         ...
         * 
         */
        public Builder maxTtl(@Nullable Output<LocationMaxTtlArgs> maxTtl) {
            $.maxTtl = maxTtl;
            return this;
        }
         ...
         * 
         */
        public Builder maxTtl(LocationMaxTtlArgs maxTtl) {
         ...
         * 
         */
        public Builder networks(@Nullable Output<List<LocationNetworkArgs>> networks) {
            $.networks = networks;
            return this;
        }
         ...
         * 
         */
        public Builder networks(List<LocationNetworkArgs> networks) {
         ...
         * 
         */
        public Builder networks(LocationNetworkArgs... networks) {
            return networks(List.of(networks));
        }

        public LocationArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("LocationArgs", "accountId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("LocationArgs", "name");
            }
            return $;
        }
    }
