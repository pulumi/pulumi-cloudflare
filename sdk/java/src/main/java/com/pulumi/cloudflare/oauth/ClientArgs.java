...
public final class ClientArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ClientArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("ClientArgs", "accountId");
            }
            if ($.clientName == null) {
                throw new MissingRequiredPropertyException("ClientArgs", "clientName");
            }
            if ($.grantTypes == null) {
                throw new MissingRequiredPropertyException("ClientArgs", "grantTypes");
            }
            if ($.redirectUris == null) {
                throw new MissingRequiredPropertyException("ClientArgs", "redirectUris");
            }
            if ($.responseTypes == null) {
                throw new MissingRequiredPropertyException("ClientArgs", "responseTypes");
            }
            if ($.scopes == null) {
                throw new MissingRequiredPropertyException("ClientArgs", "scopes");
            }
            if ($.tokenEndpointAuthMethod == null) {
                throw new MissingRequiredPropertyException("ClientArgs", "tokenEndpointAuthMethod");
            }
            return $;
        }
    }
