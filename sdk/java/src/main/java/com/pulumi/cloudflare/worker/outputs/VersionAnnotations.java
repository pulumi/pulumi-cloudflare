...
public final class VersionAnnotations {
    ...
    public static Builder builder(VersionAnnotations defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String workersTriggeredBy;
        public Builder() {}
        public Builder(VersionAnnotations defaults) {
        ...
        public VersionAnnotations build() {
            final var _resultValue = new VersionAnnotations();
