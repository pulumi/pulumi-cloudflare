...
@CustomType
public final class LockRuleCondition {
    ...
    public static Builder builder(LockRuleCondition defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(LockRuleCondition defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("LockRuleCondition", "type");
            }
            this.type = type;
            return this;
        }
        public LockRuleCondition build() {
            final var _resultValue = new LockRuleCondition();
