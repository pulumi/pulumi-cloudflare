...
public final class IpsecTunnelHealthCheckTargetArgs extends com.pulumi.resources.ResourceArgs {

    public static final IpsecTunnelHealthCheckTargetArgs Empty = new IpsecTunnelHealthCheckTargetArgs();
    ...
    private IpsecTunnelHealthCheckTargetArgs() {}

    private IpsecTunnelHealthCheckTargetArgs(IpsecTunnelHealthCheckTargetArgs $) {
    ...
    public static Builder builder(IpsecTunnelHealthCheckTargetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IpsecTunnelHealthCheckTargetArgs();
        }

        public Builder(IpsecTunnelHealthCheckTargetArgs defaults) {
            $ = new IpsecTunnelHealthCheckTargetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public IpsecTunnelHealthCheckTargetArgs build() {
            return $;
        }
    }
