...
import com.pulumi.cloudflare.registrar.outputs.GetDomainsResultRegistrantContact;
import com.pulumi.cloudflare.registrar.outputs.GetDomainsResultTransferIn;
...
public final class GetDomainsResult {
     ...
     * 
     */
    private GetDomainsResultRegistrantContact registrantContact;
    /**
     ...
     * 
     */
    private GetDomainsResultTransferIn transferIn;
    /**
     * @return Last updated.
     * 
     */
     ...
     * 
     */
    public GetDomainsResultRegistrantContact registrantContact() {
     ...
     * 
     */
    public GetDomainsResultTransferIn transferIn() {
    ...
    public static final class Builder {
        ...
        public Builder available(Boolean available) {
            if (available == null) {
              throw new MissingRequiredPropertyException("GetDomainsResult", "available");
            }
        ...
        public Builder canRegister(Boolean canRegister) {
            if (canRegister == null) {
              throw new MissingRequiredPropertyException("GetDomainsResult", "canRegister");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetDomainsResult", "createdAt");
            }
        ...
        public Builder currentRegistrar(String currentRegistrar) {
            if (currentRegistrar == null) {
              throw new MissingRequiredPropertyException("GetDomainsResult", "currentRegistrar");
            }
        ...
        public Builder expiresAt(String expiresAt) {
            if (expiresAt == null) {
              throw new MissingRequiredPropertyException("GetDomainsResult", "expiresAt");
            }
        ...
        public Builder locked(Boolean locked) {
            if (locked == null) {
              throw new MissingRequiredPropertyException("GetDomainsResult", "locked");
            }
            this.locked = locked;
            return this;
        }
        @CustomType.Setter
        public Builder registrantContact(GetDomainsResultRegistrantContact registrantContact) {
            if (registrantContact == null) {
              throw new MissingRequiredPropertyException("GetDomainsResult", "registrantContact");
            }
        ...
        public Builder registryStatuses(String registryStatuses) {
            if (registryStatuses == null) {
              throw new MissingRequiredPropertyException("GetDomainsResult", "registryStatuses");
            }
        ...
        public Builder supportedTld(Boolean supportedTld) {
            if (supportedTld == null) {
              throw new MissingRequiredPropertyException("GetDomainsResult", "supportedTld");
            }
            this.supportedTld = supportedTld;
            return this;
        }
        @CustomType.Setter
        public Builder transferIn(GetDomainsResultTransferIn transferIn) {
            if (transferIn == null) {
              throw new MissingRequiredPropertyException("GetDomainsResult", "transferIn");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetDomainsResult", "updatedAt");
            }
