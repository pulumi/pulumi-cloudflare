...
@CustomType
public final class GetR2BucketCorsRuleAllowed {
    /**
    ...
    private GetR2BucketCorsRuleAllowed() {}
    /**
     * @return Specifies the value for the Access-Control-Allow-Headers header R2 sets when requesting objects in this bucket from a browser. Cross-origin requests that include custom headers (e.g. x-user-id) should specify these headers as AllowedHeaders.
     * 
     */
    ...
    public static Builder builder(GetR2BucketCorsRuleAllowed defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> origins;
        public Builder() {}
        public Builder(GetR2BucketCorsRuleAllowed defaults) {
        ...
        public Builder headers(List<String> headers) {
            if (headers == null) {
              throw new MissingRequiredPropertyException("GetR2BucketCorsRuleAllowed", "headers");
            }
        ...
        public Builder methods(List<String> methods) {
            if (methods == null) {
              throw new MissingRequiredPropertyException("GetR2BucketCorsRuleAllowed", "methods");
            }
        ...
        public Builder origins(List<String> origins) {
            if (origins == null) {
              throw new MissingRequiredPropertyException("GetR2BucketCorsRuleAllowed", "origins");
            }
        ...
        public GetR2BucketCorsRuleAllowed build() {
            final var _resultValue = new GetR2BucketCorsRuleAllowed();
