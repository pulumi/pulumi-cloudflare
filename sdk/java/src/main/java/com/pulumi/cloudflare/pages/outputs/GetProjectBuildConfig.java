...
@CustomType
public final class GetProjectBuildConfig {
    /**
    ...
    public static Builder builder(GetProjectBuildConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String webAnalyticsToken;
        public Builder() {}
        public Builder(GetProjectBuildConfig defaults) {
        ...
        public Builder buildCaching(Boolean buildCaching) {
            if (buildCaching == null) {
              throw new MissingRequiredPropertyException("GetProjectBuildConfig", "buildCaching");
            }
        ...
        public Builder buildCommand(String buildCommand) {
            if (buildCommand == null) {
              throw new MissingRequiredPropertyException("GetProjectBuildConfig", "buildCommand");
            }
        ...
        public Builder destinationDir(String destinationDir) {
            if (destinationDir == null) {
              throw new MissingRequiredPropertyException("GetProjectBuildConfig", "destinationDir");
            }
        ...
        public Builder rootDir(String rootDir) {
            if (rootDir == null) {
              throw new MissingRequiredPropertyException("GetProjectBuildConfig", "rootDir");
            }
        ...
        public Builder webAnalyticsTag(String webAnalyticsTag) {
            if (webAnalyticsTag == null) {
              throw new MissingRequiredPropertyException("GetProjectBuildConfig", "webAnalyticsTag");
            }
        ...
        public Builder webAnalyticsToken(String webAnalyticsToken) {
            if (webAnalyticsToken == null) {
              throw new MissingRequiredPropertyException("GetProjectBuildConfig", "webAnalyticsToken");
            }
            this.webAnalyticsToken = webAnalyticsToken;
            return this;
        }
        public GetProjectBuildConfig build() {
            final var _resultValue = new GetProjectBuildConfig();
