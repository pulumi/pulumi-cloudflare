...
public final class OperationArgs extends com.pulumi.resources.ResourceArgs {

    public static final OperationArgs Empty = new OperationArgs();
    ...
    public static Builder builder(OperationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(OperationArgs defaults) {
            $ = new OperationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OperationArgs build() {
            if ($.operationId == null) {
                throw new MissingRequiredPropertyException("OperationArgs", "operationId");
            }
            return $;
        }
    }
