...
@CustomType
public final class OrganizationCustomPages {
    /**
    ...
    private OrganizationCustomPages() {}
    /**
     * @return The uid of the custom page to use when a user is denied access after failing a non-identity rule.
     * 
     */
    ...
    public static Builder builder(OrganizationCustomPages defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String identityDenied;
        public Builder() {}
        public Builder(OrganizationCustomPages defaults) {
        ...
        public OrganizationCustomPages build() {
            final var _resultValue = new OrganizationCustomPages();
