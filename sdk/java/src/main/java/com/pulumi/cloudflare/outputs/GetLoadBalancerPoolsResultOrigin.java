...
import com.pulumi.cloudflare.outputs.GetLoadBalancerPoolsResultOriginHeader;
...
@CustomType
public final class GetLoadBalancerPoolsResultOrigin {
    /**
    ...
    private GetLoadBalancerPoolsResultOrigin() {}
    /**
     * @return The IP address (IPv4 or IPv6) of the origin, or its publicly addressable hostname. Hostnames entered here should resolve directly to the origin, and not be a hostname proxied by Cloudflare. To set an internal/reserved address, virtual*network*id must also be set.
     * 
     */
     ...
     * 
     */
    public GetLoadBalancerPoolsResultOriginHeader header() {
        return this.header;
    }
    /**
     * @return A human-identifiable name for the origin.
    ...
    public static Builder builder(GetLoadBalancerPoolsResultOrigin defaults) {
    ...
    public static final class Builder {
        ...
        private Double weight;
        public Builder() {}
        public Builder(GetLoadBalancerPoolsResultOrigin defaults) {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerPoolsResultOrigin", "address");
            }
        ...
        public Builder disabledAt(String disabledAt) {
            if (disabledAt == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerPoolsResultOrigin", "disabledAt");
            }
        ...
        @CustomType.Setter
        public Builder header(GetLoadBalancerPoolsResultOriginHeader header) {
            if (header == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerPoolsResultOrigin", "header");
            }
            this.header = header;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerPoolsResultOrigin", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder weight(Double weight) {
            if (weight == null) {
              throw new MissingRequiredPropertyException("GetLoadBalancerPoolsResultOrigin", "weight");
            }
            this.weight = weight;
            return this;
        }
        public GetLoadBalancerPoolsResultOrigin build() {
            final var _resultValue = new GetLoadBalancerPoolsResultOrigin();
