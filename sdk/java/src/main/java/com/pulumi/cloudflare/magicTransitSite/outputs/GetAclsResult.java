...
import com.pulumi.cloudflare.magicTransitSite.outputs.GetAclsResultLan1;
import com.pulumi.cloudflare.magicTransitSite.outputs.GetAclsResultLan2;
...
public final class GetAclsResult {
     ...
     */
    private String id;
    private GetAclsResultLan1 lan1;
    private GetAclsResultLan2 lan2;
    /**
    ...
    public GetAclsResultLan1 lan1() {
        return this.lan1;
    }
    public GetAclsResultLan2 lan2() {
        return this.lan2;
    }
    /**
     * @return The name of the ACL.
    ...
    public static final class Builder {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetAclsResult", "description");
            }
        ...
        public Builder forwardLocally(Boolean forwardLocally) {
            if (forwardLocally == null) {
              throw new MissingRequiredPropertyException("GetAclsResult", "forwardLocally");
            }
        ...
        @CustomType.Setter
        public Builder lan1(GetAclsResultLan1 lan1) {
            if (lan1 == null) {
              throw new MissingRequiredPropertyException("GetAclsResult", "lan1");
            }
            this.lan1 = lan1;
            return this;
        }
        @CustomType.Setter
        public Builder lan2(GetAclsResultLan2 lan2) {
            if (lan2 == null) {
              throw new MissingRequiredPropertyException("GetAclsResult", "lan2");
            }
            this.lan2 = lan2;
            return this;
        }
        ...
        public Builder protocols(List<String> protocols) {
            if (protocols == null) {
              throw new MissingRequiredPropertyException("GetAclsResult", "protocols");
            }
        ...
        public Builder unidirectional(Boolean unidirectional) {
            if (unidirectional == null) {
              throw new MissingRequiredPropertyException("GetAclsResult", "unidirectional");
            }
