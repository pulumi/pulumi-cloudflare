...
import com.pulumi.cloudflare.zeroTrustAccessAiControlsMcp.outputs.GetPortalServerAuthConfigSummary;
import com.pulumi.cloudflare.zeroTrustAccessAiControlsMcp.outputs.GetPortalServerErrorDetails;
import com.pulumi.cloudflare.zeroTrustAccessAiControlsMcp.outputs.GetPortalServerUpdatedPrompt;
import com.pulumi.cloudflare.zeroTrustAccessAiControlsMcp.outputs.GetPortalServerUpdatedTool;
...
@CustomType
public final class GetPortalServer {
    /**
     ...
     * 
     */
    private GetPortalServerAuthConfigSummary authConfigSummary;
    /**
    ...
    private GetPortalServerErrorDetails errorDetails;
    ...
    private List<GetPortalServerUpdatedPrompt> updatedPrompts;
    private List<GetPortalServerUpdatedTool> updatedTools;

    private GetPortalServer() {}
    /**
     * @return Safe subset of auth*credentials surfaced to the dashboard. Includes auth*mode (dcr|manual), has*client*secret, client*secret*version, and the OAuth endpoints + client*id for manual servers. Never includes the secret value.
     * 
     */
    public GetPortalServerAuthConfigSummary authConfigSummary() {
    ...
    public GetPortalServerErrorDetails errorDetails() {
    ...
    public List<GetPortalServerUpdatedPrompt> updatedPrompts() {
        return this.updatedPrompts;
    }
    public List<GetPortalServerUpdatedTool> updatedTools() {
    ...
    public static Builder builder(GetPortalServer defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetPortalServerUpdatedTool> updatedTools;
        public Builder() {}
        public Builder(GetPortalServer defaults) {
        ...
        @CustomType.Setter
        public Builder authConfigSummary(GetPortalServerAuthConfigSummary authConfigSummary) {
            if (authConfigSummary == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "authConfigSummary");
            }
        ...
        public Builder authType(String authType) {
            if (authType == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "authType");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "createdAt");
            }
        ...
        public Builder createdBy(String createdBy) {
            if (createdBy == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "createdBy");
            }
        ...
        public Builder defaultDisabled(Boolean defaultDisabled) {
            if (defaultDisabled == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "defaultDisabled");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "description");
            }
        ...
        public Builder error(String error) {
            if (error == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "error");
            }
            this.error = error;
            return this;
        }
        @CustomType.Setter
        public Builder errorDetails(GetPortalServerErrorDetails errorDetails) {
            if (errorDetails == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "errorDetails");
            }
        ...
        public Builder hostname(String hostname) {
            if (hostname == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "hostname");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isSharedOauthCallbackEnabled(Boolean isSharedOauthCallbackEnabled) {
            if (isSharedOauthCallbackEnabled == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "isSharedOauthCallbackEnabled");
            }
        ...
        public Builder lastSuccessfulSync(String lastSuccessfulSync) {
            if (lastSuccessfulSync == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "lastSuccessfulSync");
            }
        ...
        public Builder lastSynced(String lastSynced) {
            if (lastSynced == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "lastSynced");
            }
        ...
        public Builder modifiedAt(String modifiedAt) {
            if (modifiedAt == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "modifiedAt");
            }
        ...
        public Builder modifiedBy(String modifiedBy) {
            if (modifiedBy == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "modifiedBy");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder onBehalf(Boolean onBehalf) {
            if (onBehalf == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "onBehalf");
            }
        ...
        public Builder prompts(List<Map<String,String>> prompts) {
            if (prompts == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "prompts");
            }
        ...
        public Builder secureWebGateway(Boolean secureWebGateway) {
            if (secureWebGateway == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "secureWebGateway");
            }
        ...
        public Builder serverId(String serverId) {
            if (serverId == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "serverId");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder tools(List<Map<String,String>> tools) {
            if (tools == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "tools");
            }
            this.tools = tools;
            return this;
        }
        @CustomType.Setter
        public Builder updatedPrompts(List<GetPortalServerUpdatedPrompt> updatedPrompts) {
            if (updatedPrompts == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "updatedPrompts");
            }
            this.updatedPrompts = updatedPrompts;
            return this;
        }
        public Builder updatedPrompts(GetPortalServerUpdatedPrompt... updatedPrompts) {
            return updatedPrompts(List.of(updatedPrompts));
        }
        @CustomType.Setter
        public Builder updatedTools(List<GetPortalServerUpdatedTool> updatedTools) {
            if (updatedTools == null) {
              throw new MissingRequiredPropertyException("GetPortalServer", "updatedTools");
            }
            this.updatedTools = updatedTools;
            return this;
        }
        public Builder updatedTools(GetPortalServerUpdatedTool... updatedTools) {
            return updatedTools(List.of(updatedTools));
        }
        public GetPortalServer build() {
            final var _resultValue = new GetPortalServer();
