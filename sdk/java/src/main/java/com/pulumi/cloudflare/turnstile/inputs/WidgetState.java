...
public final class WidgetState extends com.pulumi.resources.ResourceArgs {

    public static final WidgetState Empty = new WidgetState();
    ...
    public static Builder builder(WidgetState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WidgetState defaults) {
            $ = new WidgetState(Objects.requireNonNull(defaults));
        }
