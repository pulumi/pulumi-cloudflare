...
public final class GetPagesProjectsResultSourceConfig {
    ...
    public static Builder builder(GetPagesProjectsResultSourceConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String repoName;
        public Builder() {}
        public Builder(GetPagesProjectsResultSourceConfig defaults) {
        ...
        public Builder deploymentsEnabled(Boolean deploymentsEnabled) {
            if (deploymentsEnabled == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultSourceConfig", "deploymentsEnabled");
            }
        ...
        public Builder owner(String owner) {
            if (owner == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultSourceConfig", "owner");
            }
            this.owner = owner;
            return this;
        }
        ...
        public Builder ownerId(String ownerId) {
            if (ownerId == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultSourceConfig", "ownerId");
            }
        ...
        public Builder pathExcludes(List<String> pathExcludes) {
            if (pathExcludes == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultSourceConfig", "pathExcludes");
            }
        ...
        public Builder pathIncludes(List<String> pathIncludes) {
            if (pathIncludes == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultSourceConfig", "pathIncludes");
            }
        ...
        public Builder prCommentsEnabled(Boolean prCommentsEnabled) {
            if (prCommentsEnabled == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultSourceConfig", "prCommentsEnabled");
            }
        ...
        public Builder previewBranchExcludes(List<String> previewBranchExcludes) {
            if (previewBranchExcludes == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultSourceConfig", "previewBranchExcludes");
            }
        ...
        public Builder previewBranchIncludes(List<String> previewBranchIncludes) {
            if (previewBranchIncludes == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultSourceConfig", "previewBranchIncludes");
            }
        ...
        public Builder previewDeploymentSetting(String previewDeploymentSetting) {
            if (previewDeploymentSetting == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultSourceConfig", "previewDeploymentSetting");
            }
        ...
        public Builder productionBranch(String productionBranch) {
            if (productionBranch == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultSourceConfig", "productionBranch");
            }
        ...
        public Builder productionDeploymentsEnabled(Boolean productionDeploymentsEnabled) {
            if (productionDeploymentsEnabled == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultSourceConfig", "productionDeploymentsEnabled");
            }
        ...
        public Builder repoId(String repoId) {
            if (repoId == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultSourceConfig", "repoId");
            }
            this.repoId = repoId;
            return this;
        }
        ...
        public Builder repoName(String repoName) {
            if (repoName == null) {
              throw new MissingRequiredPropertyException("GetPagesProjectsResultSourceConfig", "repoName");
            }
            this.repoName = repoName;
            return this;
        }
        public GetPagesProjectsResultSourceConfig build() {
            final var _resultValue = new GetPagesProjectsResultSourceConfig();
