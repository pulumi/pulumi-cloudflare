...
import com.pulumi.cloudflare.inputs.MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs;
...
public final class MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs extends com.pulumi.resources.ResourceArgs {

    public static final MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs Empty = new MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs();
     ...
     */
    @Import(name="target")
    private @Nullable Output<MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs> target;

    /**
     * @return The destination address in a request type health check. After the healthcheck is decapsulated at the customer end of the tunnel, the ICMP echo will be forwarded to this address. This field defaults to `customer_gre_endpoint address`. This field is ignored for bidirectional healthchecks as the interface*address (not assigned to the Cloudflare side of the tunnel) is used as the target. Must be in object form if the x-magic-new-hc-target header is set to true and string form if x-magic-new-hc-target is absent or set to false.
     * 
     */
    public Optional<Output<MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs>> target() {
    ...
    private MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs() {}

    private MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs(MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs $) {
    ...
    public static Builder builder(MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs();
        }

        public Builder(MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs defaults) {
            $ = new MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder target(@Nullable Output<MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs> target) {
            $.target = target;
            return this;
        }
         ...
         * 
         */
        public Builder target(MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs target) {
        ...
        public MagicWanIpsecTunnelIpsecTunnelHealthCheckArgs build() {
            return $;
        }
    }
