...
public final class LanStaticAddressingArgs extends com.pulumi.resources.ResourceArgs {

    public static final LanStaticAddressingArgs Empty = new LanStaticAddressingArgs();
    ...
    private @Nullable Output<LanStaticAddressingDhcpRelayArgs> dhcpRelay;

    public Optional<Output<LanStaticAddressingDhcpRelayArgs>> dhcpRelay() {
        return Optional.ofNullable(this.dhcpRelay);
    }

    @Import(name="dhcpServer")
    private @Nullable Output<LanStaticAddressingDhcpServerArgs> dhcpServer;

    public Optional<Output<LanStaticAddressingDhcpServerArgs>> dhcpServer() {
    ...
    private LanStaticAddressingArgs() {}

    private LanStaticAddressingArgs(LanStaticAddressingArgs $) {
    ...
    public static Builder builder(LanStaticAddressingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LanStaticAddressingArgs();
        }

        public Builder(LanStaticAddressingArgs defaults) {
            $ = new LanStaticAddressingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder dhcpRelay(@Nullable Output<LanStaticAddressingDhcpRelayArgs> dhcpRelay) {
            $.dhcpRelay = dhcpRelay;
            return this;
        }

        public Builder dhcpRelay(LanStaticAddressingDhcpRelayArgs dhcpRelay) {
            return dhcpRelay(Output.of(dhcpRelay));
        }

        public Builder dhcpServer(@Nullable Output<LanStaticAddressingDhcpServerArgs> dhcpServer) {
            $.dhcpServer = dhcpServer;
            return this;
        }

        public Builder dhcpServer(LanStaticAddressingDhcpServerArgs dhcpServer) {
        ...
        public LanStaticAddressingArgs build() {
            if ($.address == null) {
                throw new MissingRequiredPropertyException("LanStaticAddressingArgs", "address");
            }
            return $;
        }
    }
