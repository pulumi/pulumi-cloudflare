...
public final class GetCertificatePacksResultValidationRecord {
    ...
    public static Builder builder(GetCertificatePacksResultValidationRecord defaults) {
    ...
    public static final class Builder {
        ...
        public Builder emails(List<String> emails) {
            if (emails == null) {
              throw new MissingRequiredPropertyException("GetCertificatePacksResultValidationRecord", "emails");
            }
            this.emails = emails;
            return this;
        }
        ...
        public Builder httpBody(String httpBody) {
            if (httpBody == null) {
              throw new MissingRequiredPropertyException("GetCertificatePacksResultValidationRecord", "httpBody");
            }
        ...
        public Builder httpUrl(String httpUrl) {
            if (httpUrl == null) {
              throw new MissingRequiredPropertyException("GetCertificatePacksResultValidationRecord", "httpUrl");
            }
        ...
        public Builder txtValue(String txtValue) {
            if (txtValue == null) {
              throw new MissingRequiredPropertyException("GetCertificatePacksResultValidationRecord", "txtValue");
            }
