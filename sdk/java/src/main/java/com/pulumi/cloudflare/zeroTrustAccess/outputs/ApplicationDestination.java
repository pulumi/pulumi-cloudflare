...
@CustomType
public final class ApplicationDestination {
    /**
    ...
    public static Builder builder(ApplicationDestination defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vnetId;
        public Builder() {}
        public Builder(ApplicationDestination defaults) {
        ...
        public ApplicationDestination build() {
            final var _resultValue = new ApplicationDestination();
