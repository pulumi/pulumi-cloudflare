...
public final class GreTunnelHealthCheckArgs extends com.pulumi.resources.ResourceArgs {

    public static final GreTunnelHealthCheckArgs Empty = new GreTunnelHealthCheckArgs();
     ...
     */
    @Import(name="target")
    private @Nullable Output<GreTunnelHealthCheckTargetArgs> target;

    /**
     * @return The destination address in a request type health check. After the healthcheck is decapsulated at the customer end of the tunnel, the ICMP echo will be forwarded to this address. This field defaults to `customerGreEndpoint address`. This field is ignored for bidirectional healthchecks as the interface*address (not assigned to the Cloudflare side of the tunnel) is used as the target. Must be in object form if the x-magic-new-hc-target header is set to true and string form if x-magic-new-hc-target is absent or set to false.
     * 
     */
    public Optional<Output<GreTunnelHealthCheckTargetArgs>> target() {
    ...
    private GreTunnelHealthCheckArgs() {}

    private GreTunnelHealthCheckArgs(GreTunnelHealthCheckArgs $) {
    ...
    public static Builder builder(GreTunnelHealthCheckArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GreTunnelHealthCheckArgs();
        }

        public Builder(GreTunnelHealthCheckArgs defaults) {
            $ = new GreTunnelHealthCheckArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder target(@Nullable Output<GreTunnelHealthCheckTargetArgs> target) {
            $.target = target;
            return this;
        }
         ...
         * 
         */
        public Builder target(GreTunnelHealthCheckTargetArgs target) {
        ...
        public GreTunnelHealthCheckArgs build() {
            return $;
        }
    }
