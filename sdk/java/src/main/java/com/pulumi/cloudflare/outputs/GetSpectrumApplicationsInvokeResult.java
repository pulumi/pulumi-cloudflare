...
import com.pulumi.cloudflare.outputs.GetSpectrumApplicationsResult;
...
public final class GetSpectrumApplicationsInvokeResult {
     ...
     * 
     */
    public List<GetSpectrumApplicationsResult> results() {
        return this.results;
    }
    /**
     * @return Zone identifier.
    ...
    public static Builder builder(GetSpectrumApplicationsInvokeResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder order(String order) {
            if (order == null) {
              throw new MissingRequiredPropertyException("GetSpectrumApplicationsInvokeResult", "order");
            }
            this.order = order;
            return this;
        }
        @CustomType.Setter
        public Builder results(List<GetSpectrumApplicationsResult> results) {
            if (results == null) {
              throw new MissingRequiredPropertyException("GetSpectrumApplicationsInvokeResult", "results");
            }
            this.results = results;
            return this;
        }
        public Builder results(GetSpectrumApplicationsResult... results) {
