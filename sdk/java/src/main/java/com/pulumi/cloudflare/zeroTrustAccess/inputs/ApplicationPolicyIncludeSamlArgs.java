...
public final class ApplicationPolicyIncludeSamlArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationPolicyIncludeSamlArgs Empty = new ApplicationPolicyIncludeSamlArgs();
    ...
    private ApplicationPolicyIncludeSamlArgs() {}

    private ApplicationPolicyIncludeSamlArgs(ApplicationPolicyIncludeSamlArgs $) {
    ...
    public static Builder builder(ApplicationPolicyIncludeSamlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationPolicyIncludeSamlArgs();
        }

        public Builder(ApplicationPolicyIncludeSamlArgs defaults) {
            $ = new ApplicationPolicyIncludeSamlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApplicationPolicyIncludeSamlArgs build() {
            if ($.attributeName == null) {
                throw new MissingRequiredPropertyException("ApplicationPolicyIncludeSamlArgs", "attributeName");
            }
            if ($.attributeValue == null) {
                throw new MissingRequiredPropertyException("ApplicationPolicyIncludeSamlArgs", "attributeValue");
            }
            if ($.identityProviderId == null) {
                throw new MissingRequiredPropertyException("ApplicationPolicyIncludeSamlArgs", "identityProviderId");
            }
            return $;
        }
    }
