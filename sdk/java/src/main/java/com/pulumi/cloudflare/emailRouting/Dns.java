...
import com.pulumi.cloudflare.emailRouting.inputs.DnsState;
import com.pulumi.cloudflare.emailRouting.outputs.DnsError;
import com.pulumi.cloudflare.emailRouting.outputs.DnsMessage;
import com.pulumi.cloudflare.emailRouting.outputs.DnsResult;
import com.pulumi.cloudflare.emailRouting.outputs.DnsResultInfo;
 ...
 * 
 */
@ResourceType(type="cloudflare:emailRouting/dns:Dns")
public class Dns extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="errors", refs={List.class,DnsError.class}, tree="[0,1]")
    private Output<List<DnsError>> errors;

    public Output<List<DnsError>> errors() {
        return this.errors;
    }
    @Export(name="messages", refs={List.class,DnsMessage.class}, tree="[0,1]")
    private Output<List<DnsMessage>> messages;

    public Output<List<DnsMessage>> messages() {
    ...
    @Export(name="result", refs={DnsResult.class}, tree="[0]")
    private Output<DnsResult> result;

    public Output<DnsResult> result() {
        return this.result;
    }
    @Export(name="resultInfo", refs={DnsResultInfo.class}, tree="[0]")
    private Output<DnsResultInfo> resultInfo;

    public Output<DnsResultInfo> resultInfo() {
    ...
    public Dns(java.lang.String name, DnsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:emailRouting/dns:Dns", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Dns(java.lang.String name, Output<java.lang.String> id, @Nullable DnsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:emailRouting/dns:Dns", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/emailRoutingDns:EmailRoutingDns").build())
            ))
            .build();
