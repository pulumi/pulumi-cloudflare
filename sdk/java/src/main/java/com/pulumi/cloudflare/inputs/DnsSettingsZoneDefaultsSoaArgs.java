...
public final class DnsSettingsZoneDefaultsSoaArgs extends com.pulumi.resources.ResourceArgs {

    public static final DnsSettingsZoneDefaultsSoaArgs Empty = new DnsSettingsZoneDefaultsSoaArgs();
    ...
    private DnsSettingsZoneDefaultsSoaArgs() {}

    private DnsSettingsZoneDefaultsSoaArgs(DnsSettingsZoneDefaultsSoaArgs $) {
        this.expire = $.expire;
        this.minTtl = $.minTtl;
        this.mname = $.mname;
    ...
    public static Builder builder(DnsSettingsZoneDefaultsSoaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DnsSettingsZoneDefaultsSoaArgs();
        }

        public Builder(DnsSettingsZoneDefaultsSoaArgs defaults) {
            $ = new DnsSettingsZoneDefaultsSoaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DnsSettingsZoneDefaultsSoaArgs build() {
            if ($.expire == null) {
                throw new MissingRequiredPropertyException("DnsSettingsZoneDefaultsSoaArgs", "expire");
            }
            if ($.minTtl == null) {
                throw new MissingRequiredPropertyException("DnsSettingsZoneDefaultsSoaArgs", "minTtl");
            }
            if ($.mname == null) {
                throw new MissingRequiredPropertyException("DnsSettingsZoneDefaultsSoaArgs", "mname");
            }
            if ($.refresh == null) {
                throw new MissingRequiredPropertyException("DnsSettingsZoneDefaultsSoaArgs", "refresh");
            }
            if ($.retry == null) {
                throw new MissingRequiredPropertyException("DnsSettingsZoneDefaultsSoaArgs", "retry");
            }
            if ($.rname == null) {
                throw new MissingRequiredPropertyException("DnsSettingsZoneDefaultsSoaArgs", "rname");
            }
            if ($.ttl == null) {
                throw new MissingRequiredPropertyException("DnsSettingsZoneDefaultsSoaArgs", "ttl");
            }
            return $;
        }
    }
