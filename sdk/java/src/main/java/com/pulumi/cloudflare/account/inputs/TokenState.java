...
public final class TokenState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<TokenPolicyArgs>> policies;

    /**
     * @return Set of access policies assigned to the token.
     * 
     */
    public Optional<Output<List<TokenPolicyArgs>>> policies() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder policies(@Nullable Output<List<TokenPolicyArgs>> policies) {
            $.policies = policies;
            return this;
        }
