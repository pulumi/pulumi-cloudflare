...
public final class AccessGroupIncludeGithub {
    ...
    public static Builder builder(AccessGroupIncludeGithub defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> teams;
        public Builder() {}
        public Builder(AccessGroupIncludeGithub defaults) {
        ...
        public AccessGroupIncludeGithub build() {
            final var _resultValue = new AccessGroupIncludeGithub();
