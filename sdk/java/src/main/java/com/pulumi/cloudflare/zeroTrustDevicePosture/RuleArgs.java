...
public final class RuleArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="input")
    private @Nullable Output<RuleInputArgs> input;

    /**
     * @return The value to be checked against.
     * 
     */
    public Optional<Output<RuleInputArgs>> input() {
     ...
     */
    @Import(name="matches")
    private @Nullable Output<List<RuleMatchArgs>> matches;

    /**
     * @return The conditions that the client must match to run the rule.
     * 
     */
    public Optional<Output<List<RuleMatchArgs>>> matches() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder input(@Nullable Output<RuleInputArgs> input) {
            $.input = input;
            return this;
        }
         ...
         * 
         */
        public Builder input(RuleInputArgs input) {
         ...
         * 
         */
        public Builder matches(@Nullable Output<List<RuleMatchArgs>> matches) {
            $.matches = matches;
            return this;
        }
         ...
         * 
         */
        public Builder matches(List<RuleMatchArgs> matches) {
         ...
         * 
         */
        public Builder matches(RuleMatchArgs... matches) {
