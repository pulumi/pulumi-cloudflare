...
@CustomType
public final class GetDnsSettingsSoa {
    /**
    ...
    public static Builder builder(GetDnsSettingsSoa defaults) {
    ...
    public static final class Builder {
        ...
        private Double ttl;
        public Builder() {}
        public Builder(GetDnsSettingsSoa defaults) {
        ...
        public Builder expire(Double expire) {
            if (expire == null) {
              throw new MissingRequiredPropertyException("GetDnsSettingsSoa", "expire");
            }
            this.expire = expire;
            return this;
        }
        ...
        public Builder minTtl(Double minTtl) {
            if (minTtl == null) {
              throw new MissingRequiredPropertyException("GetDnsSettingsSoa", "minTtl");
            }
            this.minTtl = minTtl;
            return this;
        }
        ...
        public Builder mname(String mname) {
            if (mname == null) {
              throw new MissingRequiredPropertyException("GetDnsSettingsSoa", "mname");
            }
            this.mname = mname;
            return this;
        }
        ...
        public Builder refresh(Double refresh) {
            if (refresh == null) {
              throw new MissingRequiredPropertyException("GetDnsSettingsSoa", "refresh");
            }
        ...
        public Builder retry(Double retry) {
            if (retry == null) {
              throw new MissingRequiredPropertyException("GetDnsSettingsSoa", "retry");
            }
            this.retry = retry;
            return this;
        }
        ...
        public Builder rname(String rname) {
            if (rname == null) {
              throw new MissingRequiredPropertyException("GetDnsSettingsSoa", "rname");
            }
            this.rname = rname;
            return this;
        }
        ...
        public Builder ttl(Double ttl) {
            if (ttl == null) {
              throw new MissingRequiredPropertyException("GetDnsSettingsSoa", "ttl");
            }
            this.ttl = ttl;
            return this;
        }
        public GetDnsSettingsSoa build() {
            final var _resultValue = new GetDnsSettingsSoa();
