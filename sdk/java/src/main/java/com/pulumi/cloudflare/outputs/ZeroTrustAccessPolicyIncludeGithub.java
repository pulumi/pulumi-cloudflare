...
@CustomType
public final class ZeroTrustAccessPolicyIncludeGithub {
    private @Nullable String identityProviderId;
    private @Nullable String name;
    private @Nullable List<String> teams;

    private ZeroTrustAccessPolicyIncludeGithub() {}
    ...
    public static Builder builder(ZeroTrustAccessPolicyIncludeGithub defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> teams;
        public Builder() {}
        public Builder(ZeroTrustAccessPolicyIncludeGithub defaults) {
        ...
        public ZeroTrustAccessPolicyIncludeGithub build() {
            final var _resultValue = new ZeroTrustAccessPolicyIncludeGithub();
