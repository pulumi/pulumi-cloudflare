...
public final class MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs extends com.pulumi.resources.ResourceArgs {

    public static final MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs Empty = new MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs();
    ...
    private MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs() {}

    private MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs(MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs $) {
    ...
    public static Builder builder(MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs();
        }

        public Builder(MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs defaults) {
            $ = new MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetArgs build() {
            return $;
        }
    }
