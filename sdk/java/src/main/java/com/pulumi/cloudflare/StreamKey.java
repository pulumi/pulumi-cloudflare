...
import com.pulumi.cloudflare.inputs.StreamKeyState;
...
public class StreamKey extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="jwk", refs={String.class}, tree="[0]")
    private Output<String> jwk;

    /**
     * @return The signing key in JWK format.
     * 
     */
    public Output<String> jwk() {
        return this.jwk;
    }
    /**
     ...
     * 
     */
    @Export(name="pem", refs={String.class}, tree="[0]")
     ...
     */
    public StreamKey(java.lang.String name) {
    ...
    private StreamKey(java.lang.String name, Output<java.lang.String> id, @Nullable StreamKeyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static StreamKeyArgs makeArgs(StreamKeyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        ...
        return args == null ? StreamKeyArgs.Empty : args;
    }
     ...
     */
    public static StreamKey get(java.lang.String name, Output<java.lang.String> id, @Nullable StreamKeyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
