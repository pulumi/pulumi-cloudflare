...
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationCorsHeadersArgs;
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationDestinationArgs;
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationFooterLinkArgs;
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationLandingPageDesignArgs;
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationMfaConfigArgs;
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationOauthConfigurationArgs;
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationPolicyArgs;
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationSaasAppArgs;
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationScimConfigArgs;
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationTargetCriteriaArgs;
...
public final class ApplicationState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<ApplicationCorsHeadersArgs> corsHeaders;

    public Optional<Output<ApplicationCorsHeadersArgs>> corsHeaders() {
    ...
    private @Nullable Output<List<ApplicationDestinationArgs>> destinations;
     ...
     * 
     */
    public Optional<Output<List<ApplicationDestinationArgs>>> destinations() {
    ...
    private @Nullable Output<List<ApplicationFooterLinkArgs>> footerLinks;

    /**
     * @return The links in the App Launcher footer.
     * 
     */
    public Optional<Output<List<ApplicationFooterLinkArgs>>> footerLinks() {
    ...
    private @Nullable Output<ApplicationLandingPageDesignArgs> landingPageDesign;

    /**
     * @return The design of the App Launcher landing page shown to users when they log in.
     * 
     */
    public Optional<Output<ApplicationLandingPageDesignArgs>> landingPageDesign() {
    ...
    private @Nullable Output<ApplicationMfaConfigArgs> mfaConfig;
     ...
     * 
     */
    public Optional<Output<ApplicationMfaConfigArgs>> mfaConfig() {
    ...
    private @Nullable Output<ApplicationOauthConfigurationArgs> oauthConfiguration;
     ...
     * 
     */
    public Optional<Output<ApplicationOauthConfigurationArgs>> oauthConfiguration() {
    ...
    @Import(name="saasApp")
    private @Nullable Output<ApplicationSaasAppArgs> saasApp;

    public Optional<Output<ApplicationSaasAppArgs>> saasApp() {
    ...
    private @Nullable Output<ApplicationScimConfigArgs> scimConfig;

    /**
     * @return Configuration for provisioning to this application via SCIM. This is currently in closed beta.
     * 
     */
    public Optional<Output<ApplicationScimConfigArgs>> scimConfig() {
    ...
    private @Nullable Output<List<ApplicationTargetCriteriaArgs>> targetCriterias;

    public Optional<Output<List<ApplicationTargetCriteriaArgs>>> targetCriterias() {
    ...
    public static final class Builder {
        ...
        public Builder corsHeaders(@Nullable Output<ApplicationCorsHeadersArgs> corsHeaders) {
            $.corsHeaders = corsHeaders;
            return this;
        }

        public Builder corsHeaders(ApplicationCorsHeadersArgs corsHeaders) {
         ...
         * 
         */
        public Builder destinations(@Nullable Output<List<ApplicationDestinationArgs>> destinations) {
         ...
         * 
         */
        public Builder destinations(List<ApplicationDestinationArgs> destinations) {
         ...
         * 
         */
        public Builder destinations(ApplicationDestinationArgs... destinations) {
         ...
         * 
         */
        public Builder footerLinks(@Nullable Output<List<ApplicationFooterLinkArgs>> footerLinks) {
         ...
         * 
         */
        public Builder footerLinks(List<ApplicationFooterLinkArgs> footerLinks) {
         ...
         * 
         */
        public Builder footerLinks(ApplicationFooterLinkArgs... footerLinks) {
         ...
         * 
         */
        public Builder landingPageDesign(@Nullable Output<ApplicationLandingPageDesignArgs> landingPageDesign) {
         ...
         * 
         */
        public Builder landingPageDesign(ApplicationLandingPageDesignArgs landingPageDesign) {
         ...
         * 
         */
        public Builder mfaConfig(@Nullable Output<ApplicationMfaConfigArgs> mfaConfig) {
            $.mfaConfig = mfaConfig;
            return this;
        }
         ...
         * 
         */
        public Builder mfaConfig(ApplicationMfaConfigArgs mfaConfig) {
         ...
         * 
         */
        public Builder oauthConfiguration(@Nullable Output<ApplicationOauthConfigurationArgs> oauthConfiguration) {
         ...
         * 
         */
        public Builder oauthConfiguration(ApplicationOauthConfigurationArgs oauthConfiguration) {
        ...
        public Builder saasApp(@Nullable Output<ApplicationSaasAppArgs> saasApp) {
            $.saasApp = saasApp;
            return this;
        }

        public Builder saasApp(ApplicationSaasAppArgs saasApp) {
         ...
         * 
         */
        public Builder scimConfig(@Nullable Output<ApplicationScimConfigArgs> scimConfig) {
         ...
         * 
         */
        public Builder scimConfig(ApplicationScimConfigArgs scimConfig) {
        ...
        public Builder targetCriterias(@Nullable Output<List<ApplicationTargetCriteriaArgs>> targetCriterias) {
            $.targetCriterias = targetCriterias;
            return this;
        }

        public Builder targetCriterias(List<ApplicationTargetCriteriaArgs> targetCriterias) {
            return targetCriterias(Output.of(targetCriterias));
        }

        public Builder targetCriterias(ApplicationTargetCriteriaArgs... targetCriterias) {
