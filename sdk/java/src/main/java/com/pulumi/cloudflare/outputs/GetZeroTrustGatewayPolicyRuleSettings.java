    ...
    public static final class Builder {
        ...
        public Builder deleteHeaders(List<String> deleteHeaders) {
            if (deleteHeaders == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustGatewayPolicyRuleSettings", "deleteHeaders");
            }
        ...
        public Builder setHeaders(Map<String,List<String>> setHeaders) {
            if (setHeaders == null) {
              throw new MissingRequiredPropertyException("GetZeroTrustGatewayPolicyRuleSettings", "setHeaders");
            }
