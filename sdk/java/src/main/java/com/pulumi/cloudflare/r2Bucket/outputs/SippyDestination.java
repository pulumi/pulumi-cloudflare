...
@CustomType
public final class SippyDestination {
    /**
    ...
    public static Builder builder(SippyDestination defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String secretAccessKey;
        public Builder() {}
        public Builder(SippyDestination defaults) {
        ...
        public SippyDestination build() {
            final var _resultValue = new SippyDestination();
