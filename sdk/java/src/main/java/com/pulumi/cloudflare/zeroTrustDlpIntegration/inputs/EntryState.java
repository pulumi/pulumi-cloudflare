...
import com.pulumi.cloudflare.zeroTrustDlpIntegration.inputs.EntryConfidenceArgs;
import com.pulumi.cloudflare.zeroTrustDlpIntegration.inputs.EntryPatternArgs;
import com.pulumi.cloudflare.zeroTrustDlpIntegration.inputs.EntryProfileArgs;
import com.pulumi.cloudflare.zeroTrustDlpIntegration.inputs.EntryVariantArgs;
...
public final class EntryState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<EntryConfidenceArgs> confidence;

    public Optional<Output<EntryConfidenceArgs>> confidence() {
    ...
    @Import(name="pattern")
    private @Nullable Output<EntryPatternArgs> pattern;

    public Optional<Output<EntryPatternArgs>> pattern() {
    ...
    private @Nullable Output<List<EntryProfileArgs>> profiles;

    public Optional<Output<List<EntryProfileArgs>>> profiles() {
     ...
     */
    @Import(name="variant")
    private @Nullable Output<EntryVariantArgs> variant;

    /**
     * @return A Predefined AI prompt classification topic entry.
     * 
     */
    public Optional<Output<EntryVariantArgs>> variant() {
    ...
    public static final class Builder {
        ...
        public Builder confidence(@Nullable Output<EntryConfidenceArgs> confidence) {
            $.confidence = confidence;
            return this;
        }

        public Builder confidence(EntryConfidenceArgs confidence) {
        ...
        public Builder pattern(@Nullable Output<EntryPatternArgs> pattern) {
            $.pattern = pattern;
            return this;
        }

        public Builder pattern(EntryPatternArgs pattern) {
        ...
        public Builder profiles(@Nullable Output<List<EntryProfileArgs>> profiles) {
            $.profiles = profiles;
            return this;
        }

        public Builder profiles(List<EntryProfileArgs> profiles) {
            return profiles(Output.of(profiles));
        }

        public Builder profiles(EntryProfileArgs... profiles) {
         ...
         * 
         */
        public Builder variant(@Nullable Output<EntryVariantArgs> variant) {
            $.variant = variant;
            return this;
        }
         ...
         * 
         */
        public Builder variant(EntryVariantArgs variant) {
