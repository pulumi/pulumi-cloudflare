...
@CustomType
public final class LoggingSettingsByRuleTypeHttp {
    /**
    ...
    private LoggingSettingsByRuleTypeHttp() {}
    /**
     * @return Specify whether to log all requests to this service.
     * 
     */
    ...
    public static Builder builder(LoggingSettingsByRuleTypeHttp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean logBlocks;
        public Builder() {}
        public Builder(LoggingSettingsByRuleTypeHttp defaults) {
        ...
        public LoggingSettingsByRuleTypeHttp build() {
            final var _resultValue = new LoggingSettingsByRuleTypeHttp();
