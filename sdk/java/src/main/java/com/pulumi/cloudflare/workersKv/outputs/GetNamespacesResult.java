    ...
    public static final class Builder {
        ...
        public Builder supportsUrlEncoding(Boolean supportsUrlEncoding) {
            if (supportsUrlEncoding == null) {
              throw new MissingRequiredPropertyException("GetNamespacesResult", "supportsUrlEncoding");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("GetNamespacesResult", "title");
            }
            this.title = title;
            return this;
        }
