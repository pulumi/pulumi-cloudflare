...
import com.pulumi.cloudflare.notification.inputs.PolicyState;
import com.pulumi.cloudflare.notification.outputs.PolicyFilters;
import com.pulumi.cloudflare.notification.outputs.PolicyMechanisms;
 ...
 * 
 */
@ResourceType(type="cloudflare:notification/policy:Policy")
public class Policy extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="filters", refs={PolicyFilters.class}, tree="[0]")
    private Output</* @Nullable */ PolicyFilters> filters;
     ...
     * 
     */
    public Output<Optional<PolicyFilters>> filters() {
     ...
     * 
     */
    @Export(name="mechanisms", refs={PolicyMechanisms.class}, tree="[0]")
    private Output<PolicyMechanisms> mechanisms;

    /**
     * @return List of IDs that will be used when dispatching a notification. IDs for email type will be the email address.
     * 
     */
    public Output<PolicyMechanisms> mechanisms() {
    ...
    public Policy(java.lang.String name, PolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:notification/policy:Policy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Policy(java.lang.String name, Output<java.lang.String> id, @Nullable PolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:notification/policy:Policy", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/notificationPolicy:NotificationPolicy").build())
            ))
            .build();
