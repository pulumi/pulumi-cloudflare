...
public final class GetViewsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="name")
    private @Nullable Output<GetViewsNameArgs> name;

    public Optional<Output<GetViewsNameArgs>> name() {
    ...
    public static final class Builder {
        ...
        public Builder name(@Nullable Output<GetViewsNameArgs> name) {
            $.name = name;
            return this;
        }

        public Builder name(GetViewsNameArgs name) {
