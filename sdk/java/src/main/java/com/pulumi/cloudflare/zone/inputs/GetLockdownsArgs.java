...
public final class GetLockdownsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLockdownsArgs Empty = new GetLockdownsArgs();
    ...
    private GetLockdownsArgs() {}

    private GetLockdownsArgs(GetLockdownsArgs $) {
    ...
    public static Builder builder(GetLockdownsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLockdownsArgs();
        }

        public Builder(GetLockdownsArgs defaults) {
            $ = new GetLockdownsArgs(Objects.requireNonNull(defaults));
        }
