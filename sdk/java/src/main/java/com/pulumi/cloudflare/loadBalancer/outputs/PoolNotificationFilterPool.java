...
@CustomType
public final class PoolNotificationFilterPool {
    /**
    ...
    private PoolNotificationFilterPool() {}
    /**
     * @return If set true, disable notifications for this type of resource (pool or origin).
     * 
     */
    ...
    public static Builder builder(PoolNotificationFilterPool defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean healthy;
        public Builder() {}
        public Builder(PoolNotificationFilterPool defaults) {
        ...
        public PoolNotificationFilterPool build() {
            final var _resultValue = new PoolNotificationFilterPool();
