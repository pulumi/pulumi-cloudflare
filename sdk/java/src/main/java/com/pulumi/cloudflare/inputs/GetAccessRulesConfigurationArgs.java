...
public final class GetAccessRulesConfigurationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetAccessRulesConfigurationArgs() {}

    private GetAccessRulesConfigurationArgs(GetAccessRulesConfigurationArgs $) {
        this.target = $.target;
        this.value = $.value;
    }
    ...
    public static Builder builder(GetAccessRulesConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAccessRulesConfigurationArgs();
        }

        public Builder(GetAccessRulesConfigurationArgs defaults) {
            $ = new GetAccessRulesConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAccessRulesConfigurationArgs build() {
            return $;
        }
    }
