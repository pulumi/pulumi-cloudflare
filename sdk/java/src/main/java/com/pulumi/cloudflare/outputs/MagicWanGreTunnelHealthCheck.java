...
import com.pulumi.cloudflare.outputs.MagicWanGreTunnelHealthCheckTarget;
...
@CustomType
public final class MagicWanGreTunnelHealthCheck {
    /**
     ...
     * 
     */
    private @Nullable MagicWanGreTunnelHealthCheckTarget target;
    /**
    ...
    private MagicWanGreTunnelHealthCheck() {}
    /**
     * @return The direction of the flow of the healthcheck. Either unidirectional, where the probe comes to you via the tunnel and the result comes back to Cloudflare via the open Internet, or bidirectional where both the probe and result come and go via the tunnel.
     * Available values: &#34;unidirectional&#34;, &#34;bidirectional&#34;.
     * 
     ...
     * 
     */
    public Optional<MagicWanGreTunnelHealthCheckTarget> target() {
    ...
    public static Builder builder(MagicWanGreTunnelHealthCheck defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(MagicWanGreTunnelHealthCheck defaults) {
        ...
        @CustomType.Setter
        public Builder target(@Nullable MagicWanGreTunnelHealthCheckTarget target) {
        ...
        public MagicWanGreTunnelHealthCheck build() {
            final var _resultValue = new MagicWanGreTunnelHealthCheck();
