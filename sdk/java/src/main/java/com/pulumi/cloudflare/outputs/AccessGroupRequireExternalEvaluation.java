...
@CustomType
public final class AccessGroupRequireExternalEvaluation {
    /**
    ...
    private AccessGroupRequireExternalEvaluation() {}
    /**
     * @return The API endpoint containing your business logic.
     * 
     */
    ...
    public static Builder builder(AccessGroupRequireExternalEvaluation defaults) {
    ...
    public static final class Builder {
        ...
        private String keysUrl;
        public Builder() {}
        public Builder(AccessGroupRequireExternalEvaluation defaults) {
        ...
        public Builder evaluateUrl(String evaluateUrl) {
            if (evaluateUrl == null) {
              throw new MissingRequiredPropertyException("AccessGroupRequireExternalEvaluation", "evaluateUrl");
            }
        ...
        public Builder keysUrl(String keysUrl) {
            if (keysUrl == null) {
              throw new MissingRequiredPropertyException("AccessGroupRequireExternalEvaluation", "keysUrl");
            }
