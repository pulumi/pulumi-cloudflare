...
public final class ApplicationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<ApplicationDnsArgs> dns;

    /**
     * @return The name and type of DNS record for the Spectrum application.
     * 
     */
    public Output<ApplicationDnsArgs> dns() {
        return this.dns;
    }
     ...
     */
    @Import(name="edgeIps")
    private @Nullable Output<ApplicationEdgeIpsArgs> edgeIps;

    /**
     * @return The anycast edge IP configuration for the hostname of this application.
     * 
     */
    public Optional<Output<ApplicationEdgeIpsArgs>> edgeIps() {
    ...
    private @Nullable Output<ApplicationOriginDnsArgs> originDns;

    /**
     * @return The name and type of DNS record for the Spectrum application.
     * 
     */
    public Optional<Output<ApplicationOriginDnsArgs>> originDns() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder dns(Output<ApplicationDnsArgs> dns) {
            $.dns = dns;
            return this;
        }
         ...
         * 
         */
        public Builder dns(ApplicationDnsArgs dns) {
         ...
         * 
         */
        public Builder edgeIps(@Nullable Output<ApplicationEdgeIpsArgs> edgeIps) {
            $.edgeIps = edgeIps;
            return this;
        }
         ...
         * 
         */
        public Builder edgeIps(ApplicationEdgeIpsArgs edgeIps) {
         ...
         * 
         */
        public Builder originDns(@Nullable Output<ApplicationOriginDnsArgs> originDns) {
            $.originDns = originDns;
            return this;
        }
         ...
         * 
         */
        public Builder originDns(ApplicationOriginDnsArgs originDns) {
        ...
        public ApplicationArgs build() {
            if ($.dns == null) {
                throw new MissingRequiredPropertyException("ApplicationArgs", "dns");
            }
            if ($.protocol == null) {
                throw new MissingRequiredPropertyException("ApplicationArgs", "protocol");
            }
            if ($.zoneId == null) {
                throw new MissingRequiredPropertyException("ApplicationArgs", "zoneId");
            }
            return $;
        }
    }
