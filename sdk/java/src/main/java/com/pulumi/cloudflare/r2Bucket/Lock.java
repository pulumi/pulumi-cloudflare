...
import com.pulumi.cloudflare.r2Bucket.inputs.LockState;
import com.pulumi.cloudflare.r2Bucket.outputs.LockRule;
 ...
 * 
 */
@ResourceType(type="cloudflare:r2Bucket/lock:Lock")
public class Lock extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="rules", refs={List.class,LockRule.class}, tree="[0,1]")
    private Output</* @Nullable */ List<LockRule>> rules;

    public Output<Optional<List<LockRule>>> rules() {
    ...
    public Lock(java.lang.String name, LockArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:r2Bucket/lock:Lock", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Lock(java.lang.String name, Output<java.lang.String> id, @Nullable LockState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:r2Bucket/lock:Lock", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/r2BucketLock:R2BucketLock").build())
            ))
            .build();
