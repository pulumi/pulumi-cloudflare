...
import com.pulumi.cloudflare.zeroTrustAccess.inputs.ApplicationScimConfigMappingOperationsArgs;
...
public final class ApplicationScimConfigMappingArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationScimConfigMappingArgs Empty = new ApplicationScimConfigMappingArgs();
    ...
    private @Nullable Output<ApplicationScimConfigMappingOperationsArgs> operations;

    /**
     * @return Whether or not this mapping applies to creates, updates, or deletes.
     * 
     */
    public Optional<Output<ApplicationScimConfigMappingOperationsArgs>> operations() {
    ...
    private ApplicationScimConfigMappingArgs() {}

    private ApplicationScimConfigMappingArgs(ApplicationScimConfigMappingArgs $) {
    ...
    public static Builder builder(ApplicationScimConfigMappingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationScimConfigMappingArgs();
        }

        public Builder(ApplicationScimConfigMappingArgs defaults) {
            $ = new ApplicationScimConfigMappingArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder operations(@Nullable Output<ApplicationScimConfigMappingOperationsArgs> operations) {
         ...
         * 
         */
        public Builder operations(ApplicationScimConfigMappingOperationsArgs operations) {
        ...
        public ApplicationScimConfigMappingArgs build() {
            if ($.schema == null) {
                throw new MissingRequiredPropertyException("ApplicationScimConfigMappingArgs", "schema");
            }
            return $;
        }
    }
