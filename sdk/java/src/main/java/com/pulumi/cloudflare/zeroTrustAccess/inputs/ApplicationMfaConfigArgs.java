...
public final class ApplicationMfaConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationMfaConfigArgs Empty = new ApplicationMfaConfigArgs();
    ...
    private ApplicationMfaConfigArgs() {}

    private ApplicationMfaConfigArgs(ApplicationMfaConfigArgs $) {
    ...
    public static Builder builder(ApplicationMfaConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationMfaConfigArgs();
        }

        public Builder(ApplicationMfaConfigArgs defaults) {
            $ = new ApplicationMfaConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApplicationMfaConfigArgs build() {
            return $;
        }
    }
