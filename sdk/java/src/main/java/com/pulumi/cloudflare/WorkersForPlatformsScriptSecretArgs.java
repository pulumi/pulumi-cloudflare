...
public final class WorkersForPlatformsScriptSecretArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkersForPlatformsScriptSecretArgs Empty = new WorkersForPlatformsScriptSecretArgs();
    ...
    private WorkersForPlatformsScriptSecretArgs() {}

    private WorkersForPlatformsScriptSecretArgs(WorkersForPlatformsScriptSecretArgs $) {
    ...
    public static Builder builder(WorkersForPlatformsScriptSecretArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkersForPlatformsScriptSecretArgs();
        }

        public Builder(WorkersForPlatformsScriptSecretArgs defaults) {
            $ = new WorkersForPlatformsScriptSecretArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WorkersForPlatformsScriptSecretArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("WorkersForPlatformsScriptSecretArgs", "accountId");
            }
            if ($.dispatchNamespace == null) {
                throw new MissingRequiredPropertyException("WorkersForPlatformsScriptSecretArgs", "dispatchNamespace");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("WorkersForPlatformsScriptSecretArgs", "name");
            }
            if ($.scriptName == null) {
                throw new MissingRequiredPropertyException("WorkersForPlatformsScriptSecretArgs", "scriptName");
            }
            return $;
        }
    }
