...
import com.pulumi.cloudflare.outputs.TunnelConfigConfigIngressOriginRequestAccess;
...
@CustomType
public final class TunnelConfigConfigIngressOriginRequest {
    /**
     ...
     * 
     */
    private @Nullable TunnelConfigConfigIngressOriginRequestAccess access;
    /**
     ...
     * 
     */
    public Optional<TunnelConfigConfigIngressOriginRequestAccess> access() {
    ...
    public static Builder builder(TunnelConfigConfigIngressOriginRequest defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer tlsTimeout;
        public Builder() {}
        public Builder(TunnelConfigConfigIngressOriginRequest defaults) {
        ...
        @CustomType.Setter
        public Builder access(@Nullable TunnelConfigConfigIngressOriginRequestAccess access) {
        ...
        public TunnelConfigConfigIngressOriginRequest build() {
            final var _resultValue = new TunnelConfigConfigIngressOriginRequest();
