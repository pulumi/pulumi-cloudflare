...
public final class GetZeroTrustGatewayPoliciesArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static Builder builder(GetZeroTrustGatewayPoliciesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetZeroTrustGatewayPoliciesArgs();
        }

        public Builder(GetZeroTrustGatewayPoliciesArgs defaults) {
        ...
        public GetZeroTrustGatewayPoliciesArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetZeroTrustGatewayPoliciesArgs", "accountId");
            }
            return $;
        }
    }
