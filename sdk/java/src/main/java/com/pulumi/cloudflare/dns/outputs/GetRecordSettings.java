...
@CustomType
public final class GetRecordSettings {
    /**
    ...
    public static Builder builder(GetRecordSettings defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean ipv6Only;
        public Builder() {}
        public Builder(GetRecordSettings defaults) {
        ...
        public Builder flattenCname(Boolean flattenCname) {
            if (flattenCname == null) {
              throw new MissingRequiredPropertyException("GetRecordSettings", "flattenCname");
            }
        ...
        public Builder ipv4Only(Boolean ipv4Only) {
            if (ipv4Only == null) {
              throw new MissingRequiredPropertyException("GetRecordSettings", "ipv4Only");
            }
        ...
        public Builder ipv6Only(Boolean ipv6Only) {
            if (ipv6Only == null) {
              throw new MissingRequiredPropertyException("GetRecordSettings", "ipv6Only");
            }
            this.ipv6Only = ipv6Only;
            return this;
        }
        public GetRecordSettings build() {
            final var _resultValue = new GetRecordSettings();
