...
import com.pulumi.cloudflare.stream.inputs.StreamState;
import com.pulumi.cloudflare.stream.outputs.StreamInput;
import com.pulumi.cloudflare.stream.outputs.StreamPlayback;
import com.pulumi.cloudflare.stream.outputs.StreamPublicDetails;
import com.pulumi.cloudflare.stream.outputs.StreamStatus;
import com.pulumi.cloudflare.stream.outputs.StreamWatermark;
 ...
 * 
 */
@ResourceType(type="cloudflare:stream/stream:Stream")
public class Stream extends com.pulumi.resources.CustomResource {
    ...
    public Stream(java.lang.String name, StreamArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:stream/stream:Stream", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Stream(java.lang.String name, Output<java.lang.String> id, @Nullable StreamState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:stream/stream:Stream", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/stream:Stream").build())
            ))
            .build();
