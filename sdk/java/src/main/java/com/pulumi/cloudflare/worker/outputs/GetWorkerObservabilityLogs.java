...
@CustomType
public final class GetWorkerObservabilityLogs {
    /**
    ...
    private GetWorkerObservabilityLogs() {}
    /**
     * @return A list of destinations where logs will be exported to.
     * 
     */
    ...
    public static Builder builder(GetWorkerObservabilityLogs defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean persist;
        public Builder() {}
        public Builder(GetWorkerObservabilityLogs defaults) {
        ...
        public Builder destinations(List<String> destinations) {
            if (destinations == null) {
              throw new MissingRequiredPropertyException("GetWorkerObservabilityLogs", "destinations");
            }
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetWorkerObservabilityLogs", "enabled");
            }
        ...
        public Builder headSamplingRate(Double headSamplingRate) {
            if (headSamplingRate == null) {
              throw new MissingRequiredPropertyException("GetWorkerObservabilityLogs", "headSamplingRate");
            }
        ...
        public Builder invocationLogs(Boolean invocationLogs) {
            if (invocationLogs == null) {
              throw new MissingRequiredPropertyException("GetWorkerObservabilityLogs", "invocationLogs");
            }
        ...
        public Builder persist(Boolean persist) {
            if (persist == null) {
              throw new MissingRequiredPropertyException("GetWorkerObservabilityLogs", "persist");
            }
            this.persist = persist;
            return this;
        }
        public GetWorkerObservabilityLogs build() {
            final var _resultValue = new GetWorkerObservabilityLogs();
