...
@CustomType
public final class GetSubscriptionRatePlan {
    /**
    ...
    private GetSubscriptionRatePlan() {}
    /**
     * @return The currency applied to the rate plan subscription.
     * 
     */
    ...
    public static Builder builder(GetSubscriptionRatePlan defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> sets;
        public Builder() {}
        public Builder(GetSubscriptionRatePlan defaults) {
        ...
        public Builder currency(String currency) {
            if (currency == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionRatePlan", "currency");
            }
        ...
        public Builder externallyManaged(Boolean externallyManaged) {
            if (externallyManaged == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionRatePlan", "externallyManaged");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionRatePlan", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isContract(Boolean isContract) {
            if (isContract == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionRatePlan", "isContract");
            }
        ...
        public Builder publicName(String publicName) {
            if (publicName == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionRatePlan", "publicName");
            }
        ...
        public Builder scope(String scope) {
            if (scope == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionRatePlan", "scope");
            }
            this.scope = scope;
            return this;
        }
        ...
        public Builder sets(List<String> sets) {
            if (sets == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionRatePlan", "sets");
            }
            this.sets = sets;
            return this;
        }
        ...
        public GetSubscriptionRatePlan build() {
            final var _resultValue = new GetSubscriptionRatePlan();
