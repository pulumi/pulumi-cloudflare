...
@CustomType
public final class ZeroTrustAccessGroupExcludeAzure {
    /**
    ...
    private ZeroTrustAccessGroupExcludeAzure() {}
    /**
     * @return The ID of the Azure Identity provider.
     * 
     */
    ...
    public static Builder builder(ZeroTrustAccessGroupExcludeAzure defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> ids;
        public Builder() {}
        public Builder(ZeroTrustAccessGroupExcludeAzure defaults) {
        ...
        public ZeroTrustAccessGroupExcludeAzure build() {
            final var _resultValue = new ZeroTrustAccessGroupExcludeAzure();
