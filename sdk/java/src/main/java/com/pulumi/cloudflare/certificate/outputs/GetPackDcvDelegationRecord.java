...
@CustomType
public final class GetPackDcvDelegationRecord {
    /**
    ...
    private GetPackDcvDelegationRecord() {}
    /**
     * @return The CNAME record hostname for DCV delegation.
     * 
     */
    ...
    public static Builder builder(GetPackDcvDelegationRecord defaults) {
    ...
    public static final class Builder {
        ...
        private String txtValue;
        public Builder() {}
        public Builder(GetPackDcvDelegationRecord defaults) {
        ...
        public Builder cname(String cname) {
            if (cname == null) {
              throw new MissingRequiredPropertyException("GetPackDcvDelegationRecord", "cname");
            }
            this.cname = cname;
            return this;
        }
        ...
        public Builder cnameTarget(String cnameTarget) {
            if (cnameTarget == null) {
              throw new MissingRequiredPropertyException("GetPackDcvDelegationRecord", "cnameTarget");
            }
        ...
        public Builder emails(List<String> emails) {
            if (emails == null) {
              throw new MissingRequiredPropertyException("GetPackDcvDelegationRecord", "emails");
            }
            this.emails = emails;
            return this;
        }
        ...
        public Builder httpBody(String httpBody) {
            if (httpBody == null) {
              throw new MissingRequiredPropertyException("GetPackDcvDelegationRecord", "httpBody");
            }
        ...
        public Builder httpUrl(String httpUrl) {
            if (httpUrl == null) {
              throw new MissingRequiredPropertyException("GetPackDcvDelegationRecord", "httpUrl");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetPackDcvDelegationRecord", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder txtName(String txtName) {
            if (txtName == null) {
              throw new MissingRequiredPropertyException("GetPackDcvDelegationRecord", "txtName");
            }
        ...
        public Builder txtValue(String txtValue) {
            if (txtValue == null) {
              throw new MissingRequiredPropertyException("GetPackDcvDelegationRecord", "txtValue");
            }
            this.txtValue = txtValue;
            return this;
        }
        public GetPackDcvDelegationRecord build() {
            final var _resultValue = new GetPackDcvDelegationRecord();
