...
@CustomType
public final class TeamsRuleRuleSettingsResolveDnsInternally {
    /**
    ...
    private TeamsRuleRuleSettingsResolveDnsInternally() {}
    /**
     * @return The fallback behavior to apply when the internal DNS response code is different from &#39;NOERROR&#39; or when the response data only contains CNAME records for &#39;A&#39; or &#39;AAAA&#39; queries.
     * 
     */
    ...
    public static Builder builder(TeamsRuleRuleSettingsResolveDnsInternally defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String viewId;
        public Builder() {}
        public Builder(TeamsRuleRuleSettingsResolveDnsInternally defaults) {
        ...
        public TeamsRuleRuleSettingsResolveDnsInternally build() {
            final var _resultValue = new TeamsRuleRuleSettingsResolveDnsInternally();
