...
public final class ManagedTransformsState extends com.pulumi.resources.ResourceArgs {

    public static final ManagedTransformsState Empty = new ManagedTransformsState();
    ...
    private ManagedTransformsState() {}

    private ManagedTransformsState(ManagedTransformsState $) {
    ...
    public static Builder builder(ManagedTransformsState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagedTransformsState();
        }

        public Builder(ManagedTransformsState defaults) {
            $ = new ManagedTransformsState(Objects.requireNonNull(defaults));
        }
        ...
        public ManagedTransformsState build() {
            return $;
        }
    }
