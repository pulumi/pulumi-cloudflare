...
import com.pulumi.cloudflare.pages.outputs.ProjectCanonicalDeploymentBuildConfig;
import com.pulumi.cloudflare.pages.outputs.ProjectCanonicalDeploymentDeploymentTrigger;
import com.pulumi.cloudflare.pages.outputs.ProjectCanonicalDeploymentEnvVars;
import com.pulumi.cloudflare.pages.outputs.ProjectCanonicalDeploymentLatestStage;
import com.pulumi.cloudflare.pages.outputs.ProjectCanonicalDeploymentSource;
import com.pulumi.cloudflare.pages.outputs.ProjectCanonicalDeploymentStage;
...
@CustomType
public final class ProjectCanonicalDeployment {
    /**
     ...
     * 
     */
    private @Nullable ProjectCanonicalDeploymentBuildConfig buildConfig;
    /**
     ...
     * 
     */
    private @Nullable ProjectCanonicalDeploymentDeploymentTrigger deploymentTrigger;
    /**
     * @return Environment variables used for builds and Pages Functions.
     * 
     */
    private @Nullable Map<String,ProjectCanonicalDeploymentEnvVars> envVars;
    /**
     ...
     * 
     */
    private @Nullable ProjectCanonicalDeploymentLatestStage latestStage;
    /**
     ...
     * 
     */
    private @Nullable ProjectCanonicalDeploymentSource source;
    /**
     * @return List of past stages.
     * 
     */
    private @Nullable List<ProjectCanonicalDeploymentStage> stages;
    /**
     ...
     * 
     */
    public Optional<ProjectCanonicalDeploymentBuildConfig> buildConfig() {
     ...
     * 
     */
    public Optional<ProjectCanonicalDeploymentDeploymentTrigger> deploymentTrigger() {
     ...
     * 
     */
    public Map<String,ProjectCanonicalDeploymentEnvVars> envVars() {
     ...
     * 
     */
    public Optional<ProjectCanonicalDeploymentLatestStage> latestStage() {
     ...
     * 
     */
    public Optional<ProjectCanonicalDeploymentSource> source() {
     ...
     * 
     */
    public List<ProjectCanonicalDeploymentStage> stages() {
    ...
    public static Builder builder(ProjectCanonicalDeployment defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean usesFunctions;
        public Builder() {}
        public Builder(ProjectCanonicalDeployment defaults) {
        ...
        @CustomType.Setter
        public Builder buildConfig(@Nullable ProjectCanonicalDeploymentBuildConfig buildConfig) {
        ...
        @CustomType.Setter
        public Builder deploymentTrigger(@Nullable ProjectCanonicalDeploymentDeploymentTrigger deploymentTrigger) {

            this.deploymentTrigger = deploymentTrigger;
            return this;
        }
        @CustomType.Setter
        public Builder envVars(@Nullable Map<String,ProjectCanonicalDeploymentEnvVars> envVars) {
        ...
        @CustomType.Setter
        public Builder latestStage(@Nullable ProjectCanonicalDeploymentLatestStage latestStage) {
        ...
        @CustomType.Setter
        public Builder source(@Nullable ProjectCanonicalDeploymentSource source) {

            this.source = source;
            return this;
        }
        @CustomType.Setter
        public Builder stages(@Nullable List<ProjectCanonicalDeploymentStage> stages) {

            this.stages = stages;
            return this;
        }
        public Builder stages(ProjectCanonicalDeploymentStage... stages) {
        ...
        public ProjectCanonicalDeployment build() {
            final var _resultValue = new ProjectCanonicalDeployment();
