...
@CustomType
public final class GetCustomHostnameSslSettings {
    /**
    ...
    private GetCustomHostnameSslSettings() {}
    /**
     * @return An allowlist of ciphers for TLS termination. These ciphers must be in the BoringSSL format.
     * 
     */
    ...
    public static Builder builder(GetCustomHostnameSslSettings defaults) {
    ...
    public static final class Builder {
        ...
        private String tls13;
        public Builder() {}
        public Builder(GetCustomHostnameSslSettings defaults) {
        ...
        public Builder ciphers(List<String> ciphers) {
            if (ciphers == null) {
              throw new MissingRequiredPropertyException("GetCustomHostnameSslSettings", "ciphers");
            }
        ...
        public Builder earlyHints(String earlyHints) {
            if (earlyHints == null) {
              throw new MissingRequiredPropertyException("GetCustomHostnameSslSettings", "earlyHints");
            }
        ...
        public Builder http2(String http2) {
            if (http2 == null) {
              throw new MissingRequiredPropertyException("GetCustomHostnameSslSettings", "http2");
            }
            this.http2 = http2;
            return this;
        }
        ...
        public Builder minTlsVersion(String minTlsVersion) {
            if (minTlsVersion == null) {
              throw new MissingRequiredPropertyException("GetCustomHostnameSslSettings", "minTlsVersion");
            }
        ...
        public Builder tls13(String tls13) {
            if (tls13 == null) {
              throw new MissingRequiredPropertyException("GetCustomHostnameSslSettings", "tls13");
            }
            this.tls13 = tls13;
            return this;
        }
        public GetCustomHostnameSslSettings build() {
            final var _resultValue = new GetCustomHostnameSslSettings();
