...
public final class StaticRouteRouteScopeArgs extends com.pulumi.resources.ResourceArgs {

    public static final StaticRouteRouteScopeArgs Empty = new StaticRouteRouteScopeArgs();
    ...
    private StaticRouteRouteScopeArgs() {}

    private StaticRouteRouteScopeArgs(StaticRouteRouteScopeArgs $) {
    ...
    public static Builder builder(StaticRouteRouteScopeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StaticRouteRouteScopeArgs();
        }

        public Builder(StaticRouteRouteScopeArgs defaults) {
            $ = new StaticRouteRouteScopeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StaticRouteRouteScopeArgs build() {
            return $;
        }
    }
