...
public final class VersionBindingSimpleArgs extends com.pulumi.resources.ResourceArgs {

    public static final VersionBindingSimpleArgs Empty = new VersionBindingSimpleArgs();
    ...
    private VersionBindingSimpleArgs() {}

    private VersionBindingSimpleArgs(VersionBindingSimpleArgs $) {
        this.limit = $.limit;
    ...
    public static Builder builder(VersionBindingSimpleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VersionBindingSimpleArgs();
        }

        public Builder(VersionBindingSimpleArgs defaults) {
            $ = new VersionBindingSimpleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VersionBindingSimpleArgs build() {
            if ($.limit == null) {
                throw new MissingRequiredPropertyException("VersionBindingSimpleArgs", "limit");
            }
            if ($.period == null) {
                throw new MissingRequiredPropertyException("VersionBindingSimpleArgs", "period");
            }
            return $;
        }
    }
