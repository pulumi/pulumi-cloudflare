...
@CustomType
public final class GetSettingsSettingsBlockPage {
    /**
    ...
    private GetSettingsSettingsBlockPage() {}
    /**
     * @return Specify the block page background color in `#rrggbb` format when the mode is customized*block*page.
     * 
     */
    ...
    public static Builder builder(GetSettingsSettingsBlockPage defaults) {
    ...
    public static final class Builder {
        ...
        private Integer version;
        public Builder() {}
        public Builder(GetSettingsSettingsBlockPage defaults) {
        ...
        public Builder backgroundColor(String backgroundColor) {
            if (backgroundColor == null) {
              throw new MissingRequiredPropertyException("GetSettingsSettingsBlockPage", "backgroundColor");
            }
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetSettingsSettingsBlockPage", "enabled");
            }
        ...
        public Builder footerText(String footerText) {
            if (footerText == null) {
              throw new MissingRequiredPropertyException("GetSettingsSettingsBlockPage", "footerText");
            }
        ...
        public Builder headerText(String headerText) {
            if (headerText == null) {
              throw new MissingRequiredPropertyException("GetSettingsSettingsBlockPage", "headerText");
            }
        ...
        public Builder includeContext(Boolean includeContext) {
            if (includeContext == null) {
              throw new MissingRequiredPropertyException("GetSettingsSettingsBlockPage", "includeContext");
            }
        ...
        public Builder logoPath(String logoPath) {
            if (logoPath == null) {
              throw new MissingRequiredPropertyException("GetSettingsSettingsBlockPage", "logoPath");
            }
        ...
        public Builder mailtoAddress(String mailtoAddress) {
            if (mailtoAddress == null) {
              throw new MissingRequiredPropertyException("GetSettingsSettingsBlockPage", "mailtoAddress");
            }
        ...
        public Builder mailtoSubject(String mailtoSubject) {
            if (mailtoSubject == null) {
              throw new MissingRequiredPropertyException("GetSettingsSettingsBlockPage", "mailtoSubject");
            }
        ...
        public Builder mode(String mode) {
            if (mode == null) {
              throw new MissingRequiredPropertyException("GetSettingsSettingsBlockPage", "mode");
            }
            this.mode = mode;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSettingsSettingsBlockPage", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder readOnly(Boolean readOnly) {
            if (readOnly == null) {
              throw new MissingRequiredPropertyException("GetSettingsSettingsBlockPage", "readOnly");
            }
        ...
        public Builder sourceAccount(String sourceAccount) {
            if (sourceAccount == null) {
              throw new MissingRequiredPropertyException("GetSettingsSettingsBlockPage", "sourceAccount");
            }
        ...
        public Builder suppressFooter(Boolean suppressFooter) {
            if (suppressFooter == null) {
              throw new MissingRequiredPropertyException("GetSettingsSettingsBlockPage", "suppressFooter");
            }
        ...
        public Builder targetUri(String targetUri) {
            if (targetUri == null) {
              throw new MissingRequiredPropertyException("GetSettingsSettingsBlockPage", "targetUri");
            }
        ...
        public Builder version(Integer version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetSettingsSettingsBlockPage", "version");
            }
            this.version = version;
            return this;
        }
        public GetSettingsSettingsBlockPage build() {
            final var _resultValue = new GetSettingsSettingsBlockPage();
