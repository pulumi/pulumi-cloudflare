...
import com.pulumi.cloudflare.inputs.DnsSettingsZoneDefaultsInternalDnsArgs;
...
public final class DnsSettingsZoneDefaultsArgs extends com.pulumi.resources.ResourceArgs {

    public static final DnsSettingsZoneDefaultsArgs Empty = new DnsSettingsZoneDefaultsArgs();
    ...
    private @Nullable Output<DnsSettingsZoneDefaultsInternalDnsArgs> internalDns;

    /**
     * @return Settings for this internal zone.
     * 
     */
    public Optional<Output<DnsSettingsZoneDefaultsInternalDnsArgs>> internalDns() {
    ...
    private @Nullable Output<DnsSettingsZoneDefaultsNameserversArgs> nameservers;

    /**
     * @return Settings determining the nameservers through which the zone should be available.
     * 
     */
    public Optional<Output<DnsSettingsZoneDefaultsNameserversArgs>> nameservers() {
     ...
     */
    @Import(name="soa")
    private @Nullable Output<DnsSettingsZoneDefaultsSoaArgs> soa;

    /**
     * @return Components of the zone&#39;s SOA record.
     * 
     */
    public Optional<Output<DnsSettingsZoneDefaultsSoaArgs>> soa() {
    ...
    private DnsSettingsZoneDefaultsArgs() {}

    private DnsSettingsZoneDefaultsArgs(DnsSettingsZoneDefaultsArgs $) {
    ...
    public static Builder builder(DnsSettingsZoneDefaultsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DnsSettingsZoneDefaultsArgs();
        }

        public Builder(DnsSettingsZoneDefaultsArgs defaults) {
            $ = new DnsSettingsZoneDefaultsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder internalDns(@Nullable Output<DnsSettingsZoneDefaultsInternalDnsArgs> internalDns) {
         ...
         * 
         */
        public Builder internalDns(DnsSettingsZoneDefaultsInternalDnsArgs internalDns) {
         ...
         * 
         */
        public Builder nameservers(@Nullable Output<DnsSettingsZoneDefaultsNameserversArgs> nameservers) {
         ...
         * 
         */
        public Builder nameservers(DnsSettingsZoneDefaultsNameserversArgs nameservers) {
         ...
         * 
         */
        public Builder soa(@Nullable Output<DnsSettingsZoneDefaultsSoaArgs> soa) {
            $.soa = soa;
            return this;
        }
         ...
         * 
         */
        public Builder soa(DnsSettingsZoneDefaultsSoaArgs soa) {
        ...
        public DnsSettingsZoneDefaultsArgs build() {
            return $;
        }
    }
