...
@CustomType
public final class DatasetDatasetColumn {
    ...
    public static Builder builder(DatasetDatasetColumn defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uploadStatus;
        public Builder() {}
        public Builder(DatasetDatasetColumn defaults) {
        ...
        public DatasetDatasetColumn build() {
            final var _resultValue = new DatasetDatasetColumn();
