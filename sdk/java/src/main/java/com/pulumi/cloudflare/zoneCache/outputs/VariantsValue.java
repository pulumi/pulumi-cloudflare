...
@CustomType
public final class VariantsValue {
    /**
    ...
    public static Builder builder(VariantsValue defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> webps;
        public Builder() {}
        public Builder(VariantsValue defaults) {
        ...
        public VariantsValue build() {
            final var _resultValue = new VariantsValue();
