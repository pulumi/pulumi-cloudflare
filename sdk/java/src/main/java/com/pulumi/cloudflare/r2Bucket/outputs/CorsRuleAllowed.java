...
@CustomType
public final class CorsRuleAllowed {
    /**
    ...
    public static Builder builder(CorsRuleAllowed defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> origins;
        public Builder() {}
        public Builder(CorsRuleAllowed defaults) {
        ...
        public Builder methods(List<String> methods) {
            if (methods == null) {
              throw new MissingRequiredPropertyException("CorsRuleAllowed", "methods");
            }
        ...
        public Builder origins(List<String> origins) {
            if (origins == null) {
              throw new MissingRequiredPropertyException("CorsRuleAllowed", "origins");
            }
        ...
        public CorsRuleAllowed build() {
            final var _resultValue = new CorsRuleAllowed();
