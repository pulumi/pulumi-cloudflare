...
public final class ItemRedirectArgs extends com.pulumi.resources.ResourceArgs {

    public static final ItemRedirectArgs Empty = new ItemRedirectArgs();
    ...
    private ItemRedirectArgs() {}

    private ItemRedirectArgs(ItemRedirectArgs $) {
    ...
    public static Builder builder(ItemRedirectArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ItemRedirectArgs();
        }

        public Builder(ItemRedirectArgs defaults) {
            $ = new ItemRedirectArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ItemRedirectArgs build() {
            if ($.sourceUrl == null) {
                throw new MissingRequiredPropertyException("ItemRedirectArgs", "sourceUrl");
            }
            if ($.targetUrl == null) {
                throw new MissingRequiredPropertyException("ItemRedirectArgs", "targetUrl");
            }
            return $;
        }
    }
