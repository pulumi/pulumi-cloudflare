...
import com.pulumi.cloudflare.spectrum.inputs.ApplicationState;
import com.pulumi.cloudflare.spectrum.outputs.ApplicationDns;
import com.pulumi.cloudflare.spectrum.outputs.ApplicationEdgeIps;
import com.pulumi.cloudflare.spectrum.outputs.ApplicationOriginDns;
 ...
 * 
 */
@ResourceType(type="cloudflare:spectrum/application:Application")
public class Application extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="dns", refs={ApplicationDns.class}, tree="[0]")
    private Output<ApplicationDns> dns;

    /**
     * @return The name and type of DNS record for the Spectrum application.
     * 
     */
    public Output<ApplicationDns> dns() {
        return this.dns;
    }
    /**
     ...
     * 
     */
    @Export(name="edgeIps", refs={ApplicationEdgeIps.class}, tree="[0]")
    private Output<ApplicationEdgeIps> edgeIps;

    /**
     * @return The anycast edge IP configuration for the hostname of this application.
     * 
     */
    public Output<ApplicationEdgeIps> edgeIps() {
        return this.edgeIps;
    }
    /**
     ...
     * 
     */
    @Export(name="originDns", refs={ApplicationOriginDns.class}, tree="[0]")
    private Output</* @Nullable */ ApplicationOriginDns> originDns;

    /**
     * @return The name and type of DNS record for the Spectrum application.
     * 
     */
    public Output<Optional<ApplicationOriginDns>> originDns() {
    ...
    public Application(java.lang.String name, ApplicationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:spectrum/application:Application", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Application(java.lang.String name, Output<java.lang.String> id, @Nullable ApplicationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudflare:spectrum/application:Application", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("cloudflare:index/spectrumApplication:SpectrumApplication").build())
            ))
            .build();
