...
public final class GetItemsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetItemsArgs Empty = new GetItemsArgs();
    ...
    private GetItemsArgs() {}

    private GetItemsArgs(GetItemsArgs $) {
    ...
    public static Builder builder(GetItemsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetItemsArgs defaults) {
            $ = new GetItemsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetItemsArgs build() {
            if ($.listId == null) {
                throw new MissingRequiredPropertyException("GetItemsArgs", "listId");
            }
            return $;
        }
    }
