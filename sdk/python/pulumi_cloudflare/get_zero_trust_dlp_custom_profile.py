...
warnings.warn("""cloudflare:index/getZeroTrustDlpCustomProfile:getZeroTrustDlpCustomProfile has been deprecated in favor of cloudflare:zeroTrustDlpCustom/profile:getProfile""", DeprecationWarning)
...
def get_zero_trust_dlp_custom_profile(account_id: Optional[_builtins.str] = None,
    ...
    ```
    """
    pulumi.log.warn("""get_zero_trust_dlp_custom_profile is deprecated: cloudflare:index/getZeroTrustDlpCustomProfile:getZeroTrustDlpCustomProfile has been deprecated in favor of cloudflare:zeroTrustDlpCustom/profile:getProfile""")
    __args__ = dict()
