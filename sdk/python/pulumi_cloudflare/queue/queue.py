...
@pulumi.type_token("cloudflare:queue/queue:Queue")
class Queue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/queue:Queue")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Queue, __self__).__init__(
            'cloudflare:queue/queue:Queue',
            resource_name,
            __props__,
            opts)
