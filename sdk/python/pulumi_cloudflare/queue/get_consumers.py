...
class GetConsumersResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetConsumersResultResult']:
        """
...
def get_consumers(account_id: Optional[_builtins.str] = None,
                  max_items: Optional[_builtins.int] = None,
                  queue_id: Optional[_builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConsumersResult:
    """
    ...
    example_queue_consumers = cloudflare.queue.get_consumers(account_id="023e105f4ecef8ad9ca31a8372d0c353",
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:queue/consumers:getConsumers', __args__, opts=opts, typ=GetConsumersResult).value
...
def get_consumers_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                         max_items: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                         queue_id: pulumi.Input[Optional[_builtins.str]] = None,
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetConsumersResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:queue/consumers:getConsumers', __args__, opts=opts, typ=GetConsumersResult)
    return __ret__.apply(lambda __response__: GetConsumersResult(
