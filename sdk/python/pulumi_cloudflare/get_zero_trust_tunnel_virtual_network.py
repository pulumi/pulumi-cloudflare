...
def get_zero_trust_tunnel_virtual_network(account_id: Optional[builtins.str] = None,
...
def get_zero_trust_tunnel_virtual_network_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
