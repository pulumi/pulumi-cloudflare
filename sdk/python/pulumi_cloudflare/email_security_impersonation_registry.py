...
class _EmailSecurityImpersonationRegistryState:
    def __init__(__self__, *,
                 ...
                 directory_node_id: Optional[pulumi.Input[int]] = None,
    ...
    def directory_node_id(self) -> Optional[pulumi.Input[int]]:
        return pulumi.get(self, "directory_node_id")

    @directory_node_id.setter
    def directory_node_id(self, value: Optional[pulumi.Input[int]]):
...
class EmailSecurityImpersonationRegistry(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="directoryNodeId")
    def directory_node_id(self) -> pulumi.Output[int]:
        return pulumi.get(self, "directory_node_id")
