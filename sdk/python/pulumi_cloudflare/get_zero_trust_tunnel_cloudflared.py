...
def get_zero_trust_tunnel_cloudflared(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str account_id: The account identifier to target for the resource. **Modifying this attribute will force creation of a new resource.**
    :param builtins.bool is_deleted: If true, only include deleted tunnels. If false, exclude deleted tunnels. If empty, all tunnels will be included. **Modifying this attribute will force creation of a new resource.**
    :param builtins.str name: Name of the tunnel. **Modifying this attribute will force creation of a new resource.**
    """
    __args__ = dict()
