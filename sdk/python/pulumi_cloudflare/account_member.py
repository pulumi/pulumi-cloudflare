...
class AccountMemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: Account ID to create the account member in.
        :param pulumi.Input[builtins.str] email_address: The email address of the user who you wish to manage. Following creation, this field becomes read only via the API and cannot be updated.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] role_ids: List of account role IDs that you want to assign to a member.
        :param pulumi.Input[builtins.str] status: A member's status in the account. Available values: `accepted`, `pending`.
        """
...
class AccountMember(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            email_address: Optional[pulumi.Input[builtins.str]] = None,
            role_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'AccountMember':
        """
