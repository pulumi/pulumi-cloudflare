...
def get_origin_ca_root_certificate(algorithm: Optional[builtins.str] = None,
    ...
    :param builtins.str algorithm: The name of the algorithm used when creating an Origin CA certificate. Available values: `rsa`, `ecc`.
    """
    __args__ = dict()
...
def get_origin_ca_root_certificate_output(algorithm: Optional[pulumi.Input[builtins.str]] = None,
