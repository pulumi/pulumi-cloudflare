...
class GetClientsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetClientsResultResult']:
        """
...
def get_clients(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:oauth/clients:getClients', __args__, opts=opts, typ=GetClientsResult).value

    return AwaitableGetClientsResult(
        account_id=pulumi.get(__ret__, 'account_id'),
        max_items=pulumi.get(__ret__, 'max_items'),
        results=pulumi.get(__ret__, 'results'))
def get_clients_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:oauth/clients:getClients', __args__, opts=opts, typ=GetClientsResult)
