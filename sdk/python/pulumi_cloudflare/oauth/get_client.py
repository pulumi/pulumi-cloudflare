...
class GetClientResult:
    ...
    def client_uri_verification(self) -> 'outputs.GetClientClientUriVerificationResult':
        """
...
def get_client(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:oauth/client:getClient', __args__, opts=opts, typ=GetClientResult).value
...
def get_client_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:oauth/client:getClient', __args__, opts=opts, typ=GetClientResult)
