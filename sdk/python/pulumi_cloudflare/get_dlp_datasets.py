...
def get_dlp_datasets(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str account_id: The account ID to fetch DLP Datasets from.
    """
    __args__ = dict()
...
def get_dlp_datasets_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDlpDatasetsResult]:
    """
    Use this data source to retrieve all DLP datasets for an account.
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getDlpDatasets:getDlpDatasets', __args__, opts=opts, typ=GetDlpDatasetsResult)
    return __ret__.apply(lambda __response__: GetDlpDatasetsResult(
