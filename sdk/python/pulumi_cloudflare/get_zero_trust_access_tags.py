...
def get_zero_trust_access_tags(account_id: Optional[builtins.str] = None,
...
def get_zero_trust_access_tags_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
