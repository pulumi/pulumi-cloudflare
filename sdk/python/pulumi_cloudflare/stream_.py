...
warnings.warn("""cloudflare:index/stream:Stream has been deprecated in favor of cloudflare:stream/stream:Stream""", DeprecationWarning)
...
class Stream(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_stream = cloudflare.stream.Stream("example_stream", account_id="023e105f4ecef8ad9ca31a8372d0c353")
        ```
    ...
    def _internal_init(__self__,
                 ...
                 upload_expiry: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        pulumi.log.warn("""Stream is deprecated: cloudflare:index/stream:Stream has been deprecated in favor of cloudflare:stream/stream:Stream""")
