...
class GetConfigResult:
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> 'outputs.GetConfigConfigResult':
        """
...
def get_config(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustTunnelWarpConnector/config:getConfig', __args__, opts=opts, typ=GetConfigResult).value
...
def get_config_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustTunnelWarpConnector/config:getConfig', __args__, opts=opts, typ=GetConfigResult)
