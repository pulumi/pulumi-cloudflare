...
class ConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ConfigConfigArgs'] config: Provider-specific configuration. Required shape depends on ha_mode. For `aws`, must contain `fnr_id`. For `local`, must contain `vips`. For `none` and `disabled`, must be empty or omitted.
        """
...
@pulumi.type_token("cloudflare:zeroTrustTunnelWarpConnector/config:Config")
class Config(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] account_id: Identifier.
        :param pulumi.Input[Union['ConfigConfigArgs', 'ConfigConfigArgsDict']] config: Provider-specific configuration. Required shape depends on ha_mode. For `aws`, must contain `fnr_id`. For `local`, must contain `vips`. For `none` and `disabled`, must be empty or omitted.
        :param pulumi.Input[_builtins.str] ha_mode: High-availability mode for the WARP Connector tunnel. `none` means HA is enabled but no provider is configured yet (newly created tunnels default to this). `disabled` means HA is explicitly turned off. `aws` uses AWS ENI move for failover. `local` uses virtual IPs (VIPs) on the local interface.
               Available values: "none", "disabled", "aws", "local".
        :param pulumi.Input[_builtins.str] tunnel_id: UUID of the tunnel.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zeroTrustTunnelWarpConnectorConfig:ZeroTrustTunnelWarpConnectorConfig")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Config, __self__).__init__(
            'cloudflare:zeroTrustTunnelWarpConnector/config:Config',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            ha_mode: pulumi.Input[Optional[_builtins.str]] = None,
            tunnel_id: pulumi.Input[Optional[_builtins.str]] = None,
            updated_at: pulumi.Input[Optional[_builtins.str]] = None) -> 'Config':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> pulumi.Output[Optional['outputs.ConfigConfig']]:
        """
        Provider-specific configuration. Required shape depends on ha_mode. For `aws`, must contain `fnr_id`. For `local`, must contain `vips`. For `none` and `disabled`, must be empty or omitted.
        """
        return pulumi.get(self, "config")
