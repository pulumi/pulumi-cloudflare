...
__all__ = [
    'GetZeroTrustTunnelWarpConnectorResult',
    'AwaitableGetZeroTrustTunnelWarpConnectorResult',
    'get_zero_trust_tunnel_warp_connector',
...
class GetZeroTrustTunnelWarpConnectorResult:
    ...
    def connections(self) -> Sequence['outputs.GetZeroTrustTunnelWarpConnectorConnectionResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetZeroTrustTunnelWarpConnectorFilterResult']:
...
class AwaitableGetZeroTrustTunnelWarpConnectorResult(GetZeroTrustTunnelWarpConnectorResult):
...
def get_zero_trust_tunnel_warp_connector(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustTunnelWarpConnector/zeroTrustTunnelWarpConnector:getZeroTrustTunnelWarpConnector', __args__, opts=opts, typ=GetZeroTrustTunnelWarpConnectorResult).value
...
def get_zero_trust_tunnel_warp_connector_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustTunnelWarpConnector/zeroTrustTunnelWarpConnector:getZeroTrustTunnelWarpConnector', __args__, opts=opts, typ=GetZeroTrustTunnelWarpConnectorResult)
