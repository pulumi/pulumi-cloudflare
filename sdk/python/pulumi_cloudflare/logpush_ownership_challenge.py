...
class _LogpushOwnershipChallengeState:
    def __init__(__self__, *,
                 ...
                 ownership_challenge_filename: Optional[pulumi.Input[builtins.str]] = None,
                 zone_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering LogpushOwnershipChallenge resources.
        :param pulumi.Input[builtins.str] account_id: The account identifier to target for the resource. Must provide only one of `account_id`, `zone_id`.
        :param pulumi.Input[builtins.str] destination_conf: Uniquely identifies a resource (such as an s3 bucket) where data will be pushed. Additional configuration parameters supported by the destination may be included. See [Logpush destination documentation](https://developers.cloudflare.com/logs/logpush/logpush-configuration-api/understanding-logpush-api/#destination). **Modifying this attribute will force creation of a new resource.**
        :param pulumi.Input[builtins.str] ownership_challenge_filename: The filename of the ownership challenge which	contains the contents required for Logpush Job creation.
        :param pulumi.Input[builtins.str] zone_id: The zone identifier to target for the resource. Must provide only one of `account_id`, `zone_id`.
        """
        if account_id is not None:
            pulumi.set(__self__, "account_id", account_id)
    ...
    def ownership_challenge_filename(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ownership_challenge_filename(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LogpushOwnershipChallenge(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            destination_conf: Optional[pulumi.Input[builtins.str]] = None,
            ownership_challenge_filename: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'LogpushOwnershipChallenge':
        """
    ...
    @property
    @pulumi.getter(name="ownershipChallengeFilename")
    def ownership_challenge_filename(self) -> pulumi.Output[builtins.str]:
        """
        The filename of the ownership challenge which	contains the contents required for Logpush Job creation.
        """
        return pulumi.get(self, "ownership_challenge_filename")
