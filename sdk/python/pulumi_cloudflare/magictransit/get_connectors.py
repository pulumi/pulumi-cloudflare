...
class GetConnectorsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetConnectorsResultResult']:
        """
...
def get_connectors(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:magicTransit/connectors:getConnectors', __args__, opts=opts, typ=GetConnectorsResult).value
...
def get_connectors_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:magicTransit/connectors:getConnectors', __args__, opts=opts, typ=GetConnectorsResult)
