...
class GetSitesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetSitesResultResult']:
        """
...
def get_sites(account_id: Optional[_builtins.str] = None,
    ...
    example_magic_transit_sites = cloudflare.magictransit.get_sites(account_id="023e105f4ecef8ad9ca31a8372d0c353",
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:magicTransit/sites:getSites', __args__, opts=opts, typ=GetSitesResult).value
...
def get_sites_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                     connectorid: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:magicTransit/sites:getSites', __args__, opts=opts, typ=GetSitesResult)
