...
class GetConnectorResult:
    ...
    @_builtins.property
    @pulumi.getter
    def device(self) -> 'outputs.GetConnectorDeviceResult':
        return pulumi.get(self, "device")

    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetConnectorFilterResult']:
...
def get_connector(account_id: Optional[_builtins.str] = None,
                  ...
                  filter: Optional[Union['GetConnectorFilterArgs', 'GetConnectorFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:magicTransit/connector:getConnector', __args__, opts=opts, typ=GetConnectorResult).value
...
def get_connector_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                         ...
                         filter: pulumi.Input[Optional[Optional[Union['GetConnectorFilterArgs', 'GetConnectorFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:magicTransit/connector:getConnector', __args__, opts=opts, typ=GetConnectorResult)
