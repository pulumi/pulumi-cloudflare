...
warnings.warn("""cloudflare:index/worker:Worker has been deprecated in favor of cloudflare:worker/worker:Worker""", DeprecationWarning)
...
class Worker(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_worker = cloudflare.worker.Worker("example_worker",
    ...
    def _internal_init(__self__,
                 ...
                 tail_consumers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['WorkerTailConsumerArgs', 'WorkerTailConsumerArgsDict']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Worker is deprecated: cloudflare:index/worker:Worker has been deprecated in favor of cloudflare:worker/worker:Worker""")
