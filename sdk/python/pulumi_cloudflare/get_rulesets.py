...
class GetRulesetsResult:
    ...
    """
    def __init__(__self__, account_id=None, max_items=None, results=None, rulesets=None, zone_id=None):
...
def get_rulesets_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
