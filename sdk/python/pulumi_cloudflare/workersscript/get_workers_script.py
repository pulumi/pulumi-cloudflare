...
def get_workers_script(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:workersScript/workersScript:getWorkersScript', __args__, opts=opts, typ=GetWorkersScriptResult).value
...
def get_workers_script_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:workersScript/workersScript:getWorkersScript', __args__, opts=opts, typ=GetWorkersScriptResult)
