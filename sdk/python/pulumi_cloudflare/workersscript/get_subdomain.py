...
__all__ = [
    'GetSubdomainResult',
    'AwaitableGetSubdomainResult',
    'get_subdomain',
    'get_subdomain_output',
]

@pulumi.output_type
class GetSubdomainResult:
    """
...
class AwaitableGetSubdomainResult(GetSubdomainResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSubdomainResult(
...
def get_subdomain(account_id: Optional[_builtins.str] = None,
                  script_name: Optional[_builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSubdomainResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:workersScript/subdomain:getSubdomain', __args__, opts=opts, typ=GetSubdomainResult).value

    return AwaitableGetSubdomainResult(
        account_id=pulumi.get(__ret__, 'account_id'),
        enabled=pulumi.get(__ret__, 'enabled'),
        previews_enabled=pulumi.get(__ret__, 'previews_enabled'),
        script_name=pulumi.get(__ret__, 'script_name'))
def get_subdomain_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
                         script_name: pulumi.Input[Optional[_builtins.str]] = None,
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSubdomainResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:workersScript/subdomain:getSubdomain', __args__, opts=opts, typ=GetSubdomainResult)
    return __ret__.apply(lambda __response__: GetSubdomainResult(
