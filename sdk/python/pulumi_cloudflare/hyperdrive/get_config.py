...
class GetConfigResult:
    ...
    @_builtins.property
    @pulumi.getter
    def caching(self) -> 'outputs.GetConfigCachingResult':
    ...
    @_builtins.property
    @pulumi.getter
    def mtls(self) -> 'outputs.GetConfigMtlsResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def origin(self) -> 'outputs.GetConfigOriginResult':
...
def get_config(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:hyperdrive/config:getConfig', __args__, opts=opts, typ=GetConfigResult).value
...
def get_config_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:hyperdrive/config:getConfig', __args__, opts=opts, typ=GetConfigResult)
