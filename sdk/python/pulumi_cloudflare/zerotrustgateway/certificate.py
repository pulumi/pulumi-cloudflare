...
@pulumi.type_token("cloudflare:zeroTrustGateway/certificate:Certificate")
class Certificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zeroTrustGatewayCertificate:ZeroTrustGatewayCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Certificate, __self__).__init__(
            'cloudflare:zeroTrustGateway/certificate:Certificate',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            updated_at: pulumi.Input[Optional[_builtins.str]] = None,
            uploaded_on: pulumi.Input[Optional[_builtins.str]] = None,
            validity_period_days: pulumi.Input[Optional[_builtins.int]] = None) -> 'Certificate':
        """
