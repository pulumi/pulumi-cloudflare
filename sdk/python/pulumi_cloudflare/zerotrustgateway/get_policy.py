...
class GetPolicyResult:
    ...
    @_builtins.property
    @pulumi.getter
    def expiration(self) -> 'outputs.GetPolicyExpirationResult':
        """
    ...
    def rule_settings(self) -> 'outputs.GetPolicyRuleSettingsResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def schedule(self) -> 'outputs.GetPolicyScheduleResult':
        """
...
def get_policy(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustGateway/policy:getPolicy', __args__, opts=opts, typ=GetPolicyResult).value
...
def get_policy_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustGateway/policy:getPolicy', __args__, opts=opts, typ=GetPolicyResult)
