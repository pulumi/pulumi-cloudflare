...
class LoggingArgs:
    def __init__(__self__, *,
                 ...
                 settings_by_rule_type: pulumi.Input[Optional['LoggingSettingsByRuleTypeArgs']] = None):
        """
        ...
        :param pulumi.Input['LoggingSettingsByRuleTypeArgs'] settings_by_rule_type: Configure logging settings for each rule type.
        """
    ...
    def settings_by_rule_type(self) -> pulumi.Input[Optional['LoggingSettingsByRuleTypeArgs']]:
        """
    ...
    def settings_by_rule_type(self, value: pulumi.Input[Optional['LoggingSettingsByRuleTypeArgs']]):
...
@pulumi.type_token("cloudflare:zeroTrustGateway/logging:Logging")
class Logging(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 account_id: pulumi.Input[Optional[_builtins.str]] = None,
                 redact_pii: pulumi.Input[Optional[_builtins.bool]] = None,
                 settings_by_rule_type: pulumi.Input[Optional[Union['LoggingSettingsByRuleTypeArgs', 'LoggingSettingsByRuleTypeArgsDict']]] = None,
                 __props__=None):
        """
        ## Example Usage
        ...
        :param pulumi.Input[_builtins.bool] redact_pii: Indicate whether to redact personally identifiable information from activity logging (PII fields include source IP, user email, user ID, device ID, URL, referrer, and user agent).
        :param pulumi.Input[Union['LoggingSettingsByRuleTypeArgs', 'LoggingSettingsByRuleTypeArgsDict']] settings_by_rule_type: Configure logging settings for each rule type.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zeroTrustGatewayLogging:ZeroTrustGatewayLogging")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Logging, __self__).__init__(
            'cloudflare:zeroTrustGateway/logging:Logging',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            account_id: pulumi.Input[Optional[_builtins.str]] = None,
            redact_pii: pulumi.Input[Optional[_builtins.bool]] = None,
            settings_by_rule_type: pulumi.Input[Optional[Union['LoggingSettingsByRuleTypeArgs', 'LoggingSettingsByRuleTypeArgsDict']]] = None) -> 'Logging':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="settingsByRuleType")
    def settings_by_rule_type(self) -> pulumi.Output['outputs.LoggingSettingsByRuleType']:
        """
        Configure logging settings for each rule type.
        """
        return pulumi.get(self, "settings_by_rule_type")
