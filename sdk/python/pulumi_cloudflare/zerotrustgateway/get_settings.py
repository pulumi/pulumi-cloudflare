...
class GetSettingsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def settings(self) -> 'outputs.GetSettingsSettingsResult':
        """
...
def get_settings(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustGateway/settings:getSettings', __args__, opts=opts, typ=GetSettingsResult).value
...
def get_settings_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustGateway/settings:getSettings', __args__, opts=opts, typ=GetSettingsResult)
