...
__all__ = [
    'GetSchemaValidationSettingsResult',
    'AwaitableGetSchemaValidationSettingsResult',
    'get_schema_validation_settings',
    'get_schema_validation_settings_output',
]
...
class AwaitableGetSchemaValidationSettingsResult(GetSchemaValidationSettingsResult):
...
def get_schema_validation_settings(operation_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:apiShieldOperation/schemaValidationSettings:getSchemaValidationSettings', __args__, opts=opts, typ=GetSchemaValidationSettingsResult).value
...
def get_schema_validation_settings_output(operation_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:apiShieldOperation/schemaValidationSettings:getSchemaValidationSettings', __args__, opts=opts, typ=GetSchemaValidationSettingsResult)
