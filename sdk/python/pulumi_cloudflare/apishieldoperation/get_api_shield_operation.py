...
def get_api_shield_operation(feature: Optional[Sequence[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:apiShieldOperation/apiShieldOperation:getApiShieldOperation', __args__, opts=opts, typ=GetApiShieldOperationResult).value
...
def get_api_shield_operation_output(feature: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:apiShieldOperation/apiShieldOperation:getApiShieldOperation', __args__, opts=opts, typ=GetApiShieldOperationResult)
