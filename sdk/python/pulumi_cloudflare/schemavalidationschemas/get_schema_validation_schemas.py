...
def get_schema_validation_schemas(filter: Optional[Union['GetSchemaValidationSchemasFilterArgs', 'GetSchemaValidationSchemasFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:schemaValidationSchemas/schemaValidationSchemas:getSchemaValidationSchemas', __args__, opts=opts, typ=GetSchemaValidationSchemasResult).value
...
def get_schema_validation_schemas_output(filter: pulumi.Input[Optional[Optional[Union['GetSchemaValidationSchemasFilterArgs', 'GetSchemaValidationSchemasFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:schemaValidationSchemas/schemaValidationSchemas:getSchemaValidationSchemas', __args__, opts=opts, typ=GetSchemaValidationSchemasResult)
