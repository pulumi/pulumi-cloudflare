...
@pulumi.type_token("cloudflare:schemaValidationSchemas/schemaValidationSchemas:SchemaValidationSchemas")
class SchemaValidationSchemas(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/schemaValidationSchemas:SchemaValidationSchemas")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SchemaValidationSchemas, __self__).__init__(
            'cloudflare:schemaValidationSchemas/schemaValidationSchemas:SchemaValidationSchemas',
            resource_name,
            __props__,
            opts)
