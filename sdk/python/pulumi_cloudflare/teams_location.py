...
class TeamsLocationArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def endpoints(self) -> pulumi.Input[Optional['TeamsLocationEndpointsArgs']]:
        """
    ...
    @endpoints.setter
    def endpoints(self, value: pulumi.Input[Optional['TeamsLocationEndpointsArgs']]):
    ...
    @networks.setter
    def networks(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['TeamsLocationNetworkArgs']]]]):
