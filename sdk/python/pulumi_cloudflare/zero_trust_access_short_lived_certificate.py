...
class _ZeroTrustAccessShortLivedCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] public_key: The public key to add to your SSH server configuration.
        :param pulumi.Input[_builtins.str] zone_id: The Zone ID to use for this endpoint. Mutually exclusive with the Account ID.
        """
        if account_id is not None:
            pulumi.set(__self__, "account_id", account_id)
...
class ZeroTrustAccessShortLivedCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            aud: Optional[pulumi.Input[_builtins.str]] = None,
            public_key: Optional[pulumi.Input[_builtins.str]] = None,
            zone_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'ZeroTrustAccessShortLivedCertificate':
        """
