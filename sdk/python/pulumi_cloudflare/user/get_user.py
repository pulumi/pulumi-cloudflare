...
def get_user(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetUserResult:
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:user/user:getUser', __args__, opts=opts, typ=GetUserResult).value
...
def get_user_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetUserResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:user/user:getUser', __args__, opts=opts, typ=GetUserResult)
