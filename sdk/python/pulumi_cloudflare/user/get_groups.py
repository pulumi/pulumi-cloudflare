...
def get_groups(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:user/groups:getGroups', __args__, opts=opts, typ=GetGroupsResult).value
...
def get_groups_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:user/groups:getGroups', __args__, opts=opts, typ=GetGroupsResult)
