...
@pulumi.type_token("cloudflare:user/user:User")
class User(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/user:User")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(User, __self__).__init__(
            'cloudflare:user/user:User',
            resource_name,
            __props__,
            opts)
