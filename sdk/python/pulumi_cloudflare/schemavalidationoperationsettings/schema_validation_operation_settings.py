...
@pulumi.type_token("cloudflare:schemaValidationOperationSettings/schemaValidationOperationSettings:SchemaValidationOperationSettings")
class SchemaValidationOperationSettings(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/schemaValidationOperationSettings:SchemaValidationOperationSettings")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SchemaValidationOperationSettings, __self__).__init__(
            'cloudflare:schemaValidationOperationSettings/schemaValidationOperationSettings:SchemaValidationOperationSettings',
            resource_name,
            __props__,
            opts)
