...
class GetPolicyResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> 'outputs.GetPolicyFiltersResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def mechanisms(self) -> 'outputs.GetPolicyMechanismsResult':
        """
...
def get_policy(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:notification/policy:getPolicy', __args__, opts=opts, typ=GetPolicyResult).value
...
def get_policy_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:notification/policy:getPolicy', __args__, opts=opts, typ=GetPolicyResult)
