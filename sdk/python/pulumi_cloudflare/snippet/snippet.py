...
@pulumi.type_token("cloudflare:snippet/snippet:Snippet")
class Snippet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
        $ pulumi import cloudflare:snippet/snippet:Snippet example '<zone_id>/<snippet_name>'
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/snippet:Snippet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Snippet, __self__).__init__(
            'cloudflare:snippet/snippet:Snippet',
            resource_name,
            __props__,
            opts)
