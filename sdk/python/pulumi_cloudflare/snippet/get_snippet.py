...
def get_snippet(snippet_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:snippet/snippet:getSnippet', __args__, opts=opts, typ=GetSnippetResult).value
...
def get_snippet_output(snippet_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:snippet/snippet:getSnippet', __args__, opts=opts, typ=GetSnippetResult)
