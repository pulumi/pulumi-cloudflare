...
class ListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kind: The type of items the list will contain. Must provide only one of: `ip`, `redirect`, `hostname`, `asn`..
        :param pulumi.Input[builtins.str] name: The name of the list.
        :param pulumi.Input[builtins.str] description: An optional description of the list.
