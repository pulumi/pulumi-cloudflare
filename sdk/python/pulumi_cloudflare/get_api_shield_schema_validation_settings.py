...
def get_api_shield_schema_validation_settings(zone_id: Optional[builtins.str] = None,
...
def get_api_shield_schema_validation_settings_output(zone_id: Optional[pulumi.Input[builtins.str]] = None,
