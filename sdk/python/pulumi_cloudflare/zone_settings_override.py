...
class _ZoneSettingsOverrideState:
    def __init__(__self__, *,
                 ...
                 initial_settings_read_at: Optional[pulumi.Input[builtins.str]] = None,
                 readonly_settings: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 settings: Optional[pulumi.Input['ZoneSettingsOverrideSettingsArgs']] = None,
    ...
    def initial_settings_read_at(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "initial_settings_read_at")

    @initial_settings_read_at.setter
    def initial_settings_read_at(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "initial_settings_read_at", value)

    @property
    @pulumi.getter(name="readonlySettings")
    def readonly_settings(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "readonly_settings")

    @readonly_settings.setter
    def readonly_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ZoneSettingsOverride(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            zone_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_status: Optional[pulumi.Input[builtins.str]] = None,
            zone_type: Optional[pulumi.Input[builtins.str]] = None) -> 'ZoneSettingsOverride':
        """
    ...
    @property
    @pulumi.getter(name="initialSettingsReadAt")
    def initial_settings_read_at(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "initial_settings_read_at")

    @property
    @pulumi.getter(name="readonlySettings")
    def readonly_settings(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "readonly_settings")
