...
__all__ = ['ManagedDomainArgs', 'ManagedDomain']

@pulumi.input_type
class ManagedDomainArgs:
...
@pulumi.type_token("cloudflare:r2/managedDomain:ManagedDomain")
class ManagedDomain(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ManagedDomainArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ManagedDomainArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ManagedDomainArgs.__new__(ManagedDomainArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/r2ManagedDomain:R2ManagedDomain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedDomain, __self__).__init__(
            'cloudflare:r2/managedDomain:ManagedDomain',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            domain: pulumi.Input[Optional[_builtins.str]] = None,
            enabled: pulumi.Input[Optional[_builtins.bool]] = None,
            jurisdiction: pulumi.Input[Optional[_builtins.str]] = None) -> 'ManagedDomain':
        """
        ...
        __props__ = _ManagedDomainState.__new__(_ManagedDomainState)
        ...
        __props__.__dict__["enabled"] = enabled
        __props__.__dict__["jurisdiction"] = jurisdiction
        return ManagedDomain(resource_name, opts=opts, __props__=__props__)
