...
class GetCustomDomainResult:
    ...
    @_builtins.property
    @pulumi.getter
    def status(self) -> 'outputs.GetCustomDomainStatusResult':
...
def get_custom_domain(account_id: Optional[_builtins.str] = None,
    ...
    example_r2_custom_domain = cloudflare.r2.get_custom_domain(account_id="023e105f4ecef8ad9ca31a8372d0c353",
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:r2/customDomain:getCustomDomain', __args__, opts=opts, typ=GetCustomDomainResult).value
...
def get_custom_domain_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:r2/customDomain:getCustomDomain', __args__, opts=opts, typ=GetCustomDomainResult)
