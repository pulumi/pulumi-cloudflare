...
__all__ = [
    'GetRelaysResult',
    'AwaitableGetRelaysResult',
    'get_relays',
    'get_relays_output',
]

@pulumi.output_type
class GetRelaysResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetRelaysResultResult']:
        """
...
class AwaitableGetRelaysResult(GetRelaysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRelaysResult(
...
def get_relays(account_id: Optional[_builtins.str] = None,
               ...
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRelaysResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:moq/relays:getRelays', __args__, opts=opts, typ=GetRelaysResult).value

    return AwaitableGetRelaysResult(
...
def get_relays_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
                      ...
                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRelaysResult]:
    """
    Use this data source to access information about an existing resource.
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:moq/relays:getRelays', __args__, opts=opts, typ=GetRelaysResult)
    return __ret__.apply(lambda __response__: GetRelaysResult(
