...
class GetLocationResult:
    ...
    @_builtins.property
    @pulumi.getter
    def endpoints(self) -> 'outputs.GetLocationEndpointsResult':
        """
    ...
    def max_ttl(self) -> 'outputs.GetLocationMaxTtlResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def networks(self) -> Sequence['outputs.GetLocationNetworkResult']:
        """
...
def get_location(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDns/location:getLocation', __args__, opts=opts, typ=GetLocationResult).value
...
def get_location_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDns/location:getLocation', __args__, opts=opts, typ=GetLocationResult)
