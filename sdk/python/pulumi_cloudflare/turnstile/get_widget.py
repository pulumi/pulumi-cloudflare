...
class GetWidgetResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetWidgetFilterResult']:
...
class AwaitableGetWidgetResult(GetWidgetResult):
...
def get_widget(account_id: Optional[_builtins.str] = None,
               filter: Optional[Union['GetWidgetFilterArgs', 'GetWidgetFilterArgsDict']] = None,
               sitekey: Optional[_builtins.str] = None,
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWidgetResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:turnstile/widget:getWidget', __args__, opts=opts, typ=GetWidgetResult).value

    return AwaitableGetWidgetResult(
...
def get_widget_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                      filter: pulumi.Input[Optional[Optional[Union['GetWidgetFilterArgs', 'GetWidgetFilterArgsDict']]]] = None,
                      sitekey: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWidgetResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:turnstile/widget:getWidget', __args__, opts=opts, typ=GetWidgetResult)
    return __ret__.apply(lambda __response__: GetWidgetResult(
