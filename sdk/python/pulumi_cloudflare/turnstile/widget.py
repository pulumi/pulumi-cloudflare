...
@pulumi.type_token("cloudflare:turnstile/widget:Widget")
class Widget(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param WidgetArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WidgetArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WidgetArgs.__new__(WidgetArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/turnstileWidget:TurnstileWidget")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["secret"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(Widget, __self__).__init__(
            'cloudflare:turnstile/widget:Widget',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            region: pulumi.Input[Optional[_builtins.str]] = None,
            secret: pulumi.Input[Optional[_builtins.str]] = None,
            sitekey: pulumi.Input[Optional[_builtins.str]] = None) -> 'Widget':
        """
        ...
        __props__ = _WidgetState.__new__(_WidgetState)
        ...
        return Widget(resource_name, opts=opts, __props__=__props__)
