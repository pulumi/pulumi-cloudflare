...
class PagesDomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain: Custom domain. **Modifying this attribute will force creation of a new resource.**
        :param pulumi.Input[builtins.str] project_name: Name of the Pages Project. **Modifying this attribute will force creation of a new resource.**
        """
...
class _PagesDomainState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain: Custom domain. **Modifying this attribute will force creation of a new resource.**
        :param pulumi.Input[builtins.str] project_name: Name of the Pages Project. **Modifying this attribute will force creation of a new resource.**
        :param pulumi.Input[builtins.str] status: Status of the custom domain.
        """
...
class PagesDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            domain: Optional[pulumi.Input[builtins.str]] = None,
            project_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'PagesDomain':
        """
