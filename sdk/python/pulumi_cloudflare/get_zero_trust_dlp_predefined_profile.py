...
def get_zero_trust_dlp_predefined_profile(account_id: Optional[builtins.str] = None,
...
def get_zero_trust_dlp_predefined_profile_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
