...
class FlagArgs:
    def __init__(__self__, *,
                 ...
                 rules: pulumi.Input[Sequence[pulumi.Input['FlagRuleArgs']]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FlagRuleArgs']]] rules: Targeting rules evaluated in ascending `priority`; the first matching rule wins. An empty array means the flag always serves `default_variation`.
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Input[Sequence[pulumi.Input['FlagRuleArgs']]]:
        """
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Sequence[pulumi.Input['FlagRuleArgs']]]):
...
class _FlagState:
    def __init__(__self__, *,
                 ...
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input['FlagRuleArgs']]]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['FlagRuleArgs']]]]:
        """
        Targeting rules evaluated in ascending `priority`; the first matching rule wins. An empty array means the flag always serves `default_variation`.
        """
        return pulumi.get(self, "rules")
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['FlagRuleArgs']]]]):
        pulumi.set(self, "rules", value)
...
@pulumi.type_token("cloudflare:flagship/flag:Flag")
class Flag(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 flag_key: pulumi.Input[Optional[_builtins.str]] = None,
                 key: pulumi.Input[Optional[_builtins.str]] = None,
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['FlagRuleArgs', 'FlagRuleArgsDict']]]]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 variations: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] flag_key: Flag key (slug).
        :param pulumi.Input[_builtins.str] key: Unique identifier for the flag within an app. Used in all evaluation and SDK calls.
        :param pulumi.Input[Sequence[pulumi.Input[Union['FlagRuleArgs', 'FlagRuleArgsDict']]]] rules: Targeting rules evaluated in ascending `priority`; the first matching rule wins. An empty array means the flag always serves `default_variation`.
        :param pulumi.Input[_builtins.str] type: Value type of the flag's variations. Inferred from the variation values on write, so it may be omitted in requests.
               Available values: "boolean", "string", "number", "json".
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] variations: Map of variation name to value. All values must be the same type (boolean, string, number, or JSON object/array). Each serialized value must be 10KB or smaller.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/flagshipFlag:FlagshipFlag")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Flag, __self__).__init__(
            'cloudflare:flagship/flag:Flag',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            updated_at: pulumi.Input[Optional[_builtins.str]] = None,
            updated_by: pulumi.Input[Optional[_builtins.str]] = None,
            variations: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'Flag':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Output[Sequence['outputs.FlagRule']]:
        """
        Targeting rules evaluated in ascending `priority`; the first matching rule wins. An empty array means the flag always serves `default_variation`.
        """
        return pulumi.get(self, "rules")
