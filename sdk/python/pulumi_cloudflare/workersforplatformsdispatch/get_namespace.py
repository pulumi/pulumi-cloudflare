...
def get_namespace(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:workersForPlatformsDispatch/namespace:getNamespace', __args__, opts=opts, typ=GetNamespaceResult).value
...
def get_namespace_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:workersForPlatformsDispatch/namespace:getNamespace', __args__, opts=opts, typ=GetNamespaceResult)
