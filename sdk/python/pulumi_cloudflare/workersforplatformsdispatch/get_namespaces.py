...
def get_namespaces(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:workersForPlatformsDispatch/namespaces:getNamespaces', __args__, opts=opts, typ=GetNamespacesResult).value
...
def get_namespaces_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:workersForPlatformsDispatch/namespaces:getNamespaces', __args__, opts=opts, typ=GetNamespacesResult)
