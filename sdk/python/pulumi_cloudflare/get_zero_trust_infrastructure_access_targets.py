...
def get_zero_trust_infrastructure_access_targets(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str created_after: A date and time after a target was created to filter on.
    :param builtins.str hostname: The hostname of the target.
    :param builtins.str hostname_contains: Partial match to the hostname of a target
    :param builtins.str ipv4: The target's IPv4 address.
    :param builtins.str ipv6: The target's IPv6 address.
    :param builtins.str modified_after: A date and time after a target was modified to filter on.
...
def get_zero_trust_infrastructure_access_targets_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
