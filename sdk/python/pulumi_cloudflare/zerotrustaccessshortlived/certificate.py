...
@pulumi.type_token("cloudflare:zeroTrustAccessShortLived/certificate:Certificate")
class Certificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zeroTrustAccessShortLivedCertificate:ZeroTrustAccessShortLivedCertificate"), pulumi.Alias(type_="cloudflare:index/accessCaCertificate:AccessCaCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Certificate, __self__).__init__(
            'cloudflare:zeroTrustAccessShortLived/certificate:Certificate',
            resource_name,
            __props__,
            opts)
