...
def get_certificate(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustAccessShortLived/certificate:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
...
def get_certificate_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustAccessShortLived/certificate:getCertificate', __args__, opts=opts, typ=GetCertificateResult)
