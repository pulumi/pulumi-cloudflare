...
def get_certificates(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustAccessShortLived/certificates:getCertificates', __args__, opts=opts, typ=GetCertificatesResult).value
...
def get_certificates_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustAccessShortLived/certificates:getCertificates', __args__, opts=opts, typ=GetCertificatesResult)
