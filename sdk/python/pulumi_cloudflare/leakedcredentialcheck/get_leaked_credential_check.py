...
def get_leaked_credential_check(zone_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:leakedCredentialCheck/leakedCredentialCheck:getLeakedCredentialCheck', __args__, opts=opts, typ=GetLeakedCredentialCheckResult).value
...
def get_leaked_credential_check_output(zone_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:leakedCredentialCheck/leakedCredentialCheck:getLeakedCredentialCheck', __args__, opts=opts, typ=GetLeakedCredentialCheckResult)
