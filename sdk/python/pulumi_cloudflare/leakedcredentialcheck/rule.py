...
@pulumi.type_token("cloudflare:leakedCredentialCheck/rule:Rule")
class Rule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/leakedCredentialCheckRule:LeakedCredentialCheckRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Rule, __self__).__init__(
            'cloudflare:leakedCredentialCheck/rule:Rule',
            resource_name,
            __props__,
            opts)
