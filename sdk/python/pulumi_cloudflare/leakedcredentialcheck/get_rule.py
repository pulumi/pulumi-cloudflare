...
def get_rule(detection_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:leakedCredentialCheck/rule:getRule', __args__, opts=opts, typ=GetRuleResult).value
...
def get_rule_output(detection_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:leakedCredentialCheck/rule:getRule', __args__, opts=opts, typ=GetRuleResult)
