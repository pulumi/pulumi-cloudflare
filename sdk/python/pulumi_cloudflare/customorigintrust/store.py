...
@pulumi.type_token("cloudflare:customOriginTrust/store:Store")
class Store(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/customOriginTrustStore:CustomOriginTrustStore")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Store, __self__).__init__(
            'cloudflare:customOriginTrust/store:Store',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            updated_at: pulumi.Input[Optional[_builtins.str]] = None,
            uploaded_on: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Store':
        """
