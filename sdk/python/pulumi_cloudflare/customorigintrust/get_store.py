...
class GetStoreResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetStoreFilterResult']:
...
def get_store(custom_origin_trust_store_id: Optional[_builtins.str] = None,
              filter: Optional[Union['GetStoreFilterArgs', 'GetStoreFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:customOriginTrust/store:getStore', __args__, opts=opts, typ=GetStoreResult).value
...
def get_store_output(custom_origin_trust_store_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                     filter: pulumi.Input[Optional[Optional[Union['GetStoreFilterArgs', 'GetStoreFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:customOriginTrust/store:getStore', __args__, opts=opts, typ=GetStoreResult)
