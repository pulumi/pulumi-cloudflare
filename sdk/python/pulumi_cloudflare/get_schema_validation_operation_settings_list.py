...
__all__ = [
    ...
    'AwaitableGetSchemaValidationOperationSettingsListResult',
    'get_schema_validation_operation_settings_list',
...
class GetSchemaValidationOperationSettingsListResult:
    ...
    @property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetSchemaValidationOperationSettingsListResultResult']:
...
class AwaitableGetSchemaValidationOperationSettingsListResult(GetSchemaValidationOperationSettingsListResult):
...
def get_schema_validation_operation_settings_list(max_items: Optional[builtins.int] = None,
                                                  zone_id: Optional[builtins.str] = None,
                                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSchemaValidationOperationSettingsListResult:
    """
    ## Example Usage
...
def get_schema_validation_operation_settings_list_output(max_items: Optional[pulumi.Input[Optional[builtins.int]]] = None,
