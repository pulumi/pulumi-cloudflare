...
def get_zero_trust_tunnel_cloudflared_routes(account_id: Optional[_builtins.str] = None,
...
def get_zero_trust_tunnel_cloudflared_routes_output(account_id: Optional[pulumi.Input[_builtins.str]] = None,
