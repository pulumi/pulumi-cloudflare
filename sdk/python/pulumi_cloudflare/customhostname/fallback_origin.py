...
__all__ = ['FallbackOriginArgs', 'FallbackOrigin']

@pulumi.input_type
class FallbackOriginArgs:
...
@pulumi.type_token("cloudflare:customHostname/fallbackOrigin:FallbackOrigin")
class FallbackOrigin(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param FallbackOriginArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FallbackOriginArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FallbackOriginArgs.__new__(FallbackOriginArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/customHostnameFallbackOrigin:CustomHostnameFallbackOrigin")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FallbackOrigin, __self__).__init__(
            'cloudflare:customHostname/fallbackOrigin:FallbackOrigin',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            status: pulumi.Input[Optional[_builtins.str]] = None,
            updated_at: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'FallbackOrigin':
        """
        ...
        __props__ = _FallbackOriginState.__new__(_FallbackOriginState)
        ...
        __props__.__dict__["zone_id"] = zone_id
        return FallbackOrigin(resource_name, opts=opts, __props__=__props__)
