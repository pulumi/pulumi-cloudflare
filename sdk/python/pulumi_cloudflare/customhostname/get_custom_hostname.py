...
def get_custom_hostname(custom_hostname_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:customHostname/customHostname:getCustomHostname', __args__, opts=opts, typ=GetCustomHostnameResult).value
...
def get_custom_hostname_output(custom_hostname_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:customHostname/customHostname:getCustomHostname', __args__, opts=opts, typ=GetCustomHostnameResult)
