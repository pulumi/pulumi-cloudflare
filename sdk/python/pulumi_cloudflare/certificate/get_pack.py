...
class GetPackResult:
    ...
    @_builtins.property
    @pulumi.getter
    def certificates(self) -> Sequence['outputs.GetPackCertificateResult']:
        """
    ...
    def dcv_delegation_records(self) -> Sequence['outputs.GetPackDcvDelegationRecordResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetPackFilterResult']:
    ...
    def validation_errors(self) -> Sequence['outputs.GetPackValidationErrorResult']:
        """
    ...
    def validation_records(self) -> Sequence['outputs.GetPackValidationRecordResult']:
        """
...
class AwaitableGetPackResult(GetPackResult):
...
def get_pack(certificate_pack_id: Optional[_builtins.str] = None,
             filter: Optional[Union['GetPackFilterArgs', 'GetPackFilterArgsDict']] = None,
             zone_id: Optional[_builtins.str] = None,
             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPackResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:certificate/pack:getPack', __args__, opts=opts, typ=GetPackResult).value

    return AwaitableGetPackResult(
...
def get_pack_output(certificate_pack_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                    filter: pulumi.Input[Optional[Optional[Union['GetPackFilterArgs', 'GetPackFilterArgsDict']]]] = None,
                    zone_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPackResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:certificate/pack:getPack', __args__, opts=opts, typ=GetPackResult)
    return __ret__.apply(lambda __response__: GetPackResult(
