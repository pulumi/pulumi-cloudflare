...
class _PackState:
    def __init__(__self__, *,
                 ...
                 certificates: pulumi.Input[Optional[Sequence[pulumi.Input['PackCertificateArgs']]]] = None,
                 cloudflare_branding: pulumi.Input[Optional[_builtins.bool]] = None,
                 dcv_delegation_records: pulumi.Input[Optional[Sequence[pulumi.Input['PackDcvDelegationRecordArgs']]]] = None,
                 hosts: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 primary_certificate: pulumi.Input[Optional[_builtins.str]] = None,
                 status: pulumi.Input[Optional[_builtins.str]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 validation_errors: pulumi.Input[Optional[Sequence[pulumi.Input['PackValidationErrorArgs']]]] = None,
                 validation_method: pulumi.Input[Optional[_builtins.str]] = None,
                 validation_records: pulumi.Input[Optional[Sequence[pulumi.Input['PackValidationRecordArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] certificate_authority: Certificate Authority selected for the order.  For information on any certificate authority specific details or restrictions [see this page for more details](https://developers.cloudflare.com/ssl/reference/certificate-authorities).
               Available values: "google", "lets*encrypt", "ssl*com".
        :param pulumi.Input[Sequence[pulumi.Input['PackCertificateArgs']]] certificates: Array of certificates in this pack.
        :param pulumi.Input[_builtins.bool] cloudflare_branding: Whether or not to add Cloudflare Branding for the order.  This will add a subdomain of sni.cloudflaressl.com as the Common Name if set to true.
        :param pulumi.Input[Sequence[pulumi.Input['PackDcvDelegationRecordArgs']]] dcv_delegation_records: DCV Delegation records for domain validation.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] hosts: Comma separated list of valid host names for the certificate packs. Must contain the zone apex, may not contain more than 50 hosts, and may not be empty.
        ...
        :param pulumi.Input[_builtins.str] type: Type of certificate pack.
               Available values: "advanced".
        :param pulumi.Input[Sequence[pulumi.Input['PackValidationErrorArgs']]] validation_errors: Domain validation errors that have been received by the certificate authority (CA).
        :param pulumi.Input[_builtins.str] validation_method: Validation Method selected for the order.
               Available values: "txt", "http", "email".
        :param pulumi.Input[Sequence[pulumi.Input['PackValidationRecordArgs']]] validation_records: Certificates' validation records.
        :param pulumi.Input[_builtins.int] validity_days: Validity Days selected for the order.
               Available values: 14, 30, 90, 365.
        :param pulumi.Input[_builtins.str] zone_id: Identifier.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def certificates(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PackCertificateArgs']]]]:
        """
    ...
    @certificates.setter
    def certificates(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PackCertificateArgs']]]]):
    ...
    def dcv_delegation_records(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PackDcvDelegationRecordArgs']]]]:
        """
    ...
    def dcv_delegation_records(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PackDcvDelegationRecordArgs']]]]):
    ...
    def primary_certificate(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def primary_certificate(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def validation_errors(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PackValidationErrorArgs']]]]:
        """
    ...
    def validation_errors(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PackValidationErrorArgs']]]]):
    ...
    def validation_records(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PackValidationRecordArgs']]]]:
        """
    ...
    def validation_records(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PackValidationRecordArgs']]]]):
...
@pulumi.type_token("cloudflare:certificate/pack:Pack")
class Pack(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param PackArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PackArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PackArgs.__new__(PackArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/certificatePack:CertificatePack")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Pack, __self__).__init__(
            'cloudflare:certificate/pack:Pack',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            certificate_authority: pulumi.Input[Optional[_builtins.str]] = None,
            certificates: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PackCertificateArgs', 'PackCertificateArgsDict']]]]] = None,
            cloudflare_branding: pulumi.Input[Optional[_builtins.bool]] = None,
            dcv_delegation_records: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PackDcvDelegationRecordArgs', 'PackDcvDelegationRecordArgsDict']]]]] = None,
            hosts: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            primary_certificate: pulumi.Input[Optional[_builtins.str]] = None,
            status: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None,
            validation_errors: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PackValidationErrorArgs', 'PackValidationErrorArgsDict']]]]] = None,
            validation_method: pulumi.Input[Optional[_builtins.str]] = None,
            validation_records: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PackValidationRecordArgs', 'PackValidationRecordArgsDict']]]]] = None,
            validity_days: pulumi.Input[Optional[_builtins.int]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Pack':
        """
        Get an existing Pack resource's state with the given name, id, and optional extra
        ...
        :param pulumi.Input[_builtins.str] certificate_authority: Certificate Authority selected for the order.  For information on any certificate authority specific details or restrictions [see this page for more details](https://developers.cloudflare.com/ssl/reference/certificate-authorities).
               Available values: "google", "lets*encrypt", "ssl*com".
        :param pulumi.Input[Sequence[pulumi.Input[Union['PackCertificateArgs', 'PackCertificateArgsDict']]]] certificates: Array of certificates in this pack.
        :param pulumi.Input[_builtins.bool] cloudflare_branding: Whether or not to add Cloudflare Branding for the order.  This will add a subdomain of sni.cloudflaressl.com as the Common Name if set to true.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PackDcvDelegationRecordArgs', 'PackDcvDelegationRecordArgsDict']]]] dcv_delegation_records: DCV Delegation records for domain validation.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] hosts: Comma separated list of valid host names for the certificate packs. Must contain the zone apex, may not contain more than 50 hosts, and may not be empty.
        :param pulumi.Input[_builtins.str] primary_certificate: Identifier of the primary certificate in a pack.
        :param pulumi.Input[_builtins.str] status: Status of certificate pack.
               Available values: "initializing", "pending*validation", "deleted", "pending*issuance", "pending*deployment", "pending*deletion", "pending*expiration", "expired", "active", "initializing*timed*out", "validation*timed*out", "issuance*timed*out", "deployment*timed*out", "deletion*timed*out", "pending*cleanup", "staging*deployment", "staging*active", "deactivating", "inactive", "backup*issued", "holding*deployment".
        :param pulumi.Input[_builtins.str] type: Type of certificate pack.
               Available values: "advanced".
        :param pulumi.Input[Sequence[pulumi.Input[Union['PackValidationErrorArgs', 'PackValidationErrorArgsDict']]]] validation_errors: Domain validation errors that have been received by the certificate authority (CA).
        :param pulumi.Input[_builtins.str] validation_method: Validation Method selected for the order.
               Available values: "txt", "http", "email".
        :param pulumi.Input[Sequence[pulumi.Input[Union['PackValidationRecordArgs', 'PackValidationRecordArgsDict']]]] validation_records: Certificates' validation records.
        :param pulumi.Input[_builtins.int] validity_days: Validity Days selected for the order.
               Available values: 14, 30, 90, 365.
        :param pulumi.Input[_builtins.str] zone_id: Identifier.
        """
        ...
        __props__ = _PackState.__new__(_PackState)
        ...
        __props__.__dict__["validity_days"] = validity_days
        __props__.__dict__["zone_id"] = zone_id
        return Pack(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def certificates(self) -> pulumi.Output[Sequence['outputs.PackCertificate']]:
        """
        Array of certificates in this pack.
        """
        return pulumi.get(self, "certificates")
    ...
    @_builtins.property
    @pulumi.getter(name="dcvDelegationRecords")
    def dcv_delegation_records(self) -> pulumi.Output[Sequence['outputs.PackDcvDelegationRecord']]:
        """
        DCV Delegation records for domain validation.
        """
        return pulumi.get(self, "dcv_delegation_records")
    ...
    @_builtins.property
    @pulumi.getter(name="validationErrors")
    def validation_errors(self) -> pulumi.Output[Sequence['outputs.PackValidationError']]:
        """
        Domain validation errors that have been received by the certificate authority (CA).
        """
        return pulumi.get(self, "validation_errors")
    ...
    @_builtins.property
    @pulumi.getter(name="validationRecords")
    def validation_records(self) -> pulumi.Output[Sequence['outputs.PackValidationRecord']]:
        """
        Certificates' validation records.
        """
        return pulumi.get(self, "validation_records")
