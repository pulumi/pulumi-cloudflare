...
class PagesProjectArgs:
    def __init__(__self__, *,
                 ...
                 production_branch: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] name: Name of the project.
        :param pulumi.Input[builtins.str] production_branch: The name of the branch that is used for the production environment.
    ...
    def production_branch(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def production_branch(self, value: pulumi.Input[builtins.str]):
...
class _PagesProjectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: The account identifier to target for the resource.
        :param pulumi.Input['PagesProjectBuildConfigArgs'] build_config: Configuration for the project build process. Read more about the build configuration in the [developer documentation](https://developers.cloudflare.com/pages/platform/build-configuration).
        :param pulumi.Input[builtins.str] created_on: When the project was created.
        :param pulumi.Input['PagesProjectDeploymentConfigsArgs'] deployment_configs: Configuration for deployments in a project.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domains: A list of associated custom domains for the project.
        :param pulumi.Input[builtins.str] name: Name of the project.
        :param pulumi.Input[builtins.str] production_branch: The name of the branch that is used for the production environment.
        :param pulumi.Input['PagesProjectSourceArgs'] source: Configuration for the project source. Read more about the source configuration in the [developer documentation](https://developers.cloudflare.com/pages/platform/branch-build-controls/).
        :param pulumi.Input[builtins.str] subdomain: The Cloudflare subdomain associated with the project.
        """
...
class PagesProject(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            production_branch: Optional[pulumi.Input[builtins.str]] = None,
            source: Optional[pulumi.Input[Union['PagesProjectSourceArgs', 'PagesProjectSourceArgsDict']]] = None,
            subdomain: Optional[pulumi.Input[builtins.str]] = None) -> 'PagesProject':
        """
    ...
    @property
    @pulumi.getter(name="productionBranch")
    def production_branch(self) -> pulumi.Output[builtins.str]:
        """
        The name of the branch that is used for the production environment.
        """
        return pulumi.get(self, "production_branch")
