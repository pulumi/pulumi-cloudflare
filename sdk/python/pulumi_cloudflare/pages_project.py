...
class PagesProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] production_branch: Production branch of the project. Used to identify production deployments.
        """
...
class PagesProject(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="productionBranch")
    def production_branch(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Production branch of the project. Used to identify production deployments.
        """
        return pulumi.get(self, "production_branch")
