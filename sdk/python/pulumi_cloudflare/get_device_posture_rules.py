...
def get_device_posture_rules(account_id: Optional[builtins.str] = None,
...
def get_device_posture_rules_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
