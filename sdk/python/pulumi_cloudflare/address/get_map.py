...
class GetMapResult:
    ...
    def address_map_id(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def ips(self) -> Sequence['outputs.GetMapIpResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def memberships(self) -> Sequence['outputs.GetMapMembershipResult']:
        """
...
def get_map(account_id: Optional[_builtins.str] = None,
            address_map_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:address/map:getMap', __args__, opts=opts, typ=GetMapResult).value
...
def get_map_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:address/map:getMap', __args__, opts=opts, typ=GetMapResult)
