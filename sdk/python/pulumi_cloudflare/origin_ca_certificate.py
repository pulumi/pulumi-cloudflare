...
class OriginCaCertificateArgs:
    def __init__(__self__, *,
                 ...
                 min_days_for_renewal: Optional[pulumi.Input[builtins.int]] = None,
                 requested_validity: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a OriginCaCertificate resource.
        :param pulumi.Input[builtins.str] csr: The Certificate Signing Request. Must be newline-encoded. **Modifying this attribute will force creation of a new resource.**
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] hostnames: A list of hostnames or wildcard names bound to the certificate. **Modifying this attribute will force creation of a new resource.**
        :param pulumi.Input[builtins.str] request_type: The signature type desired on the certificate. Available values: `origin-rsa`, `origin-ecc`, `keyless-certificate`. **Modifying this attribute will force creation of a new resource.**
        :param pulumi.Input[builtins.int] requested_validity: The number of days for which the certificate should be valid. Available values: `7`, `30`, `90`, `365`, `730`, `1095`, `5475`. **Modifying this attribute will force creation of a new resource.**
        """
    ...
    def min_days_for_renewal(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "min_days_for_renewal")

    @min_days_for_renewal.setter
    def min_days_for_renewal(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "min_days_for_renewal", value)

    @property
    @pulumi.getter(name="requestedValidity")
    def requested_validity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def requested_validity(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _OriginCaCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate: The Origin CA certificate.
        :param pulumi.Input[builtins.str] csr: The Certificate Signing Request. Must be newline-encoded. **Modifying this attribute will force creation of a new resource.**
        :param pulumi.Input[builtins.str] expires_on: The datetime when the certificate will expire.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] hostnames: A list of hostnames or wildcard names bound to the certificate. **Modifying this attribute will force creation of a new resource.**
        :param pulumi.Input[builtins.str] request_type: The signature type desired on the certificate. Available values: `origin-rsa`, `origin-ecc`, `keyless-certificate`. **Modifying this attribute will force creation of a new resource.**
        :param pulumi.Input[builtins.int] requested_validity: The number of days for which the certificate should be valid. Available values: `7`, `30`, `90`, `365`, `730`, `1095`, `5475`. **Modifying this attribute will force creation of a new resource.**
        """
...
class OriginCaCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            min_days_for_renewal: Optional[pulumi.Input[builtins.int]] = None,
            request_type: Optional[pulumi.Input[builtins.str]] = None,
            requested_validity: Optional[pulumi.Input[builtins.int]] = None) -> 'OriginCaCertificate':
        """
    ...
    @property
    @pulumi.getter(name="minDaysForRenewal")
    def min_days_for_renewal(self) -> pulumi.Output[Optional[builtins.int]]:
        return pulumi.get(self, "min_days_for_renewal")
    ...
    @property
    @pulumi.getter(name="requestedValidity")
    def requested_validity(self) -> pulumi.Output[builtins.int]:
        """
        The number of days for which the certificate should be valid. Available values: `7`, `30`, `90`, `365`, `730`, `1095`, `5475`. **Modifying this attribute will force creation of a new resource.**
        """
        return pulumi.get(self, "requested_validity")
