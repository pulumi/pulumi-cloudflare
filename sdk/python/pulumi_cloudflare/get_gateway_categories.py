...
def get_gateway_categories(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str account_id: The account ID to fetch Gateway Categories from.
    """
    __args__ = dict()
...
def get_gateway_categories_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
