...
class GetRecipientResult:
    ...
    @_builtins.property
    @pulumi.getter
    def resources(self) -> Sequence['outputs.GetRecipientResourceResult']:
...
def get_recipient(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:share/recipient:getRecipient', __args__, opts=opts, typ=GetRecipientResult).value
...
def get_recipient_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
                         ...
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRecipientResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:share/recipient:getRecipient', __args__, opts=opts, typ=GetRecipientResult)
    return __ret__.apply(lambda __response__: GetRecipientResult(
