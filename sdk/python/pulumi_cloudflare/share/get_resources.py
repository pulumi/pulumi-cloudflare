...
class GetResourcesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetResourcesResultResult']:
        """
...
def get_resources(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:share/resources:getResources', __args__, opts=opts, typ=GetResourcesResult).value
...
def get_resources_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:share/resources:getResources', __args__, opts=opts, typ=GetResourcesResult)
