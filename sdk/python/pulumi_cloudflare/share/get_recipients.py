...
class GetRecipientsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetRecipientsResultResult']:
        """
...
def get_recipients(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:share/recipients:getRecipients', __args__, opts=opts, typ=GetRecipientsResult).value
...
def get_recipients_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:share/recipients:getRecipients', __args__, opts=opts, typ=GetRecipientsResult)
