...
def get_share(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:share/share:getShare', __args__, opts=opts, typ=GetShareResult).value
...
def get_share_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:share/share:getShare', __args__, opts=opts, typ=GetShareResult)
