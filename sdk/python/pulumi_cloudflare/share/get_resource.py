...
class GetResourceResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetResourceFilterResult']:
...
def get_resource(account_id: Optional[_builtins.str] = None,
                 filter: Optional[Union['GetResourceFilterArgs', 'GetResourceFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:share/resource:getResource', __args__, opts=opts, typ=GetResourceResult).value
...
def get_resource_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
                        filter: pulumi.Input[Optional[Optional[Union['GetResourceFilterArgs', 'GetResourceFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:share/resource:getResource', __args__, opts=opts, typ=GetResourceResult)
