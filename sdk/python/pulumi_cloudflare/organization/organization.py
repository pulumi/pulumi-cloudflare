...
@pulumi.type_token("cloudflare:organization/organization:Organization")
class Organization(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/organization:Organization")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Organization, __self__).__init__(
            'cloudflare:organization/organization:Organization',
            resource_name,
            __props__,
            opts)
