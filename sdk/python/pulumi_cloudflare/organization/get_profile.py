...
def get_profile(organization_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:organization/profile:getProfile', __args__, opts=opts, typ=GetProfileResult).value
...
def get_profile_output(organization_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:organization/profile:getProfile', __args__, opts=opts, typ=GetProfileResult)
