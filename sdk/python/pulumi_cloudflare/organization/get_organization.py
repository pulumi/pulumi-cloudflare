...
def get_organization(filter: Optional[Union['GetOrganizationFilterArgs', 'GetOrganizationFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:organization/organization:getOrganization', __args__, opts=opts, typ=GetOrganizationResult).value
...
def get_organization_output(filter: pulumi.Input[Optional[Optional[Union['GetOrganizationFilterArgs', 'GetOrganizationFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:organization/organization:getOrganization', __args__, opts=opts, typ=GetOrganizationResult)
