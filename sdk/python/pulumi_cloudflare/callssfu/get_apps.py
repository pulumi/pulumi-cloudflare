...
def get_apps(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:callsSfu/apps:getApps', __args__, opts=opts, typ=GetAppsResult).value
...
def get_apps_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:callsSfu/apps:getApps', __args__, opts=opts, typ=GetAppsResult)
