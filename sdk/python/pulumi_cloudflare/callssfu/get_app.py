...
def get_app(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:callsSfu/app:getApp', __args__, opts=opts, typ=GetAppResult).value
...
def get_app_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:callsSfu/app:getApp', __args__, opts=opts, typ=GetAppResult)
