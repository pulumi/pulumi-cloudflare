...
def get_magic_network_monitoring_rules(account_id: Optional[builtins.str] = None,
...
def get_magic_network_monitoring_rules_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
