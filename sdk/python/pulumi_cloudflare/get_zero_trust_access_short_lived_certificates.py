...
def get_zero_trust_access_short_lived_certificates(account_id: Optional[builtins.str] = None,
...
def get_zero_trust_access_short_lived_certificates_output(account_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
