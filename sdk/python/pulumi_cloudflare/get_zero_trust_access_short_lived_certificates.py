...
def get_zero_trust_access_short_lived_certificates(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustAccessShortLivedCertificates:getZeroTrustAccessShortLivedCertificates', __args__, opts=opts, typ=GetZeroTrustAccessShortLivedCertificatesResult).value
...
def get_zero_trust_access_short_lived_certificates_output(account_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustAccessShortLivedCertificates:getZeroTrustAccessShortLivedCertificates', __args__, opts=opts, typ=GetZeroTrustAccessShortLivedCertificatesResult)
