...
class LoadBalancerRuleOverrideSessionAffinityAttribute(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str samesite: Configures the SameSite attribute on session affinity cookie. Value `Auto` will be translated to `Lax` or `None` depending if Always Use HTTPS is enabled. Note: when using value `None`, then you can not set `secure="Never"`. Available values: `Auto`, `Lax`, `None`, `Strict`.
        :param str secure: Configures the Secure attribute on session affinity cookie. Value `Always` indicates the Secure attribute will be set in the Set-Cookie header, `Never` indicates the Secure attribute will not be set, and `Auto` will set the Secure attribute depending if Always Use HTTPS is enabled. Available values: `Auto`, `Always`, `Never`.
...
class RulesetRuleActionParametersCacheKeyCustomKeyQueryString(dict):
    def __init__(__self__, *,
        ...
        :param Sequence[str] includes: List of query string parameters to include in the custom key.
        """
        if excludes is not None:
            pulumi.set(__self__, "excludes", excludes)
        if includes is not None:
...
class RulesetRuleActionParametersEdgeTtl(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str mode: Mode of the edge TTL. Available values: `override_origin`, `respect_origin`, `bypass_by_default`
...
class RulesetRuleActionParametersFromList(dict):
    def __init__(__self__, *,
        ...
        :param str name: Name of the list.
        """
        if key is not None:
...
class RulesetRuleActionParametersFromValueTargetUrl(dict):
    def __init__(__self__, *,
        ...
        :param str value: Static value to provide as the HTTP request header value.
        """
