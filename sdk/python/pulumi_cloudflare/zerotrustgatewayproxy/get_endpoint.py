...
def get_endpoint(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustGatewayProxy/endpoint:getEndpoint', __args__, opts=opts, typ=GetEndpointResult).value
...
def get_endpoint_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustGatewayProxy/endpoint:getEndpoint', __args__, opts=opts, typ=GetEndpointResult)
