...
class GetApplicationResult:
    ...
    @_builtins.property
    @pulumi.getter
    def dns(self) -> 'outputs.GetApplicationDnsResult':
        """
    ...
    def edge_ips(self) -> 'outputs.GetApplicationEdgeIpsResult':
        """
    ...
    def origin_dns(self) -> 'outputs.GetApplicationOriginDnsResult':
        """
        The name and type of DNS record for the Spectrum application.
        """
...
def get_application(app_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:spectrum/application:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
...
def get_application_output(app_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:spectrum/application:getApplication', __args__, opts=opts, typ=GetApplicationResult)
