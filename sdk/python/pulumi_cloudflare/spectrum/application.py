...
class ApplicationArgs:
    def __init__(__self__, *,
                 dns: pulumi.Input['ApplicationDnsArgs'],
                 protocol: pulumi.Input[_builtins.str],
                 zone_id: pulumi.Input[_builtins.str],
                 argo_smart_routing: pulumi.Input[Optional[_builtins.bool]] = None,
                 edge_ips: pulumi.Input[Optional['ApplicationEdgeIpsArgs']] = None,
                 ...
                 origin_dns: pulumi.Input[Optional['ApplicationOriginDnsArgs']] = None,
        ...
        :param pulumi.Input['ApplicationDnsArgs'] dns: The name and type of DNS record for the Spectrum application.
        ...
        :param pulumi.Input['ApplicationEdgeIpsArgs'] edge_ips: The anycast edge IP configuration for the hostname of this application.
        ...
        :param pulumi.Input['ApplicationOriginDnsArgs'] origin_dns: The name and type of DNS record for the Spectrum application.
    ...
    @_builtins.property
    @pulumi.getter
    def dns(self) -> pulumi.Input['ApplicationDnsArgs']:
        """
    ...
    @dns.setter
    def dns(self, value: pulumi.Input['ApplicationDnsArgs']):
    ...
    def edge_ips(self) -> pulumi.Input[Optional['ApplicationEdgeIpsArgs']]:
        """
    ...
    @edge_ips.setter
    def edge_ips(self, value: pulumi.Input[Optional['ApplicationEdgeIpsArgs']]):
    ...
    def origin_dns(self) -> pulumi.Input[Optional['ApplicationOriginDnsArgs']]:
        """
        The name and type of DNS record for the Spectrum application.
        """
    ...
    @origin_dns.setter
    def origin_dns(self, value: pulumi.Input[Optional['ApplicationOriginDnsArgs']]):
...
class _ApplicationState:
    def __init__(__self__, *,
                 ...
                 dns: pulumi.Input[Optional['ApplicationDnsArgs']] = None,
                 edge_ips: pulumi.Input[Optional['ApplicationEdgeIpsArgs']] = None,
                 ip_firewall: pulumi.Input[Optional[_builtins.bool]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def dns(self) -> pulumi.Input[Optional['ApplicationDnsArgs']]:
        """
        The name and type of DNS record for the Spectrum application.
        """
        return pulumi.get(self, "dns")
    ...
    @dns.setter
    def dns(self, value: pulumi.Input[Optional['ApplicationDnsArgs']]):
        pulumi.set(self, "dns", value)
...
@pulumi.type_token("cloudflare:spectrum/application:Application")
class Application(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 argo_smart_routing: pulumi.Input[Optional[_builtins.bool]] = None,
                 dns: pulumi.Input[Optional[Union['ApplicationDnsArgs', 'ApplicationDnsArgsDict']]] = None,
                 edge_ips: pulumi.Input[Optional[Union['ApplicationEdgeIpsArgs', 'ApplicationEdgeIpsArgsDict']]] = None,
                 ip_firewall: pulumi.Input[Optional[_builtins.bool]] = None,
                 origin_directs: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 origin_dns: pulumi.Input[Optional[Union['ApplicationOriginDnsArgs', 'ApplicationOriginDnsArgsDict']]] = None,
                 origin_port: Optional[Any] = None,
                 protocol: pulumi.Input[Optional[_builtins.str]] = None,
                 proxy_protocol: pulumi.Input[Optional[_builtins.str]] = None,
                 tls: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.bool] argo_smart_routing: Enables Argo Smart Routing for this application.
               Notes: Only available for TCP applications with traffic_type set to "direct".
        :param pulumi.Input[Union['ApplicationDnsArgs', 'ApplicationDnsArgsDict']] dns: The name and type of DNS record for the Spectrum application.
        :param pulumi.Input[Union['ApplicationEdgeIpsArgs', 'ApplicationEdgeIpsArgsDict']] edge_ips: The anycast edge IP configuration for the hostname of this application.
        :param pulumi.Input[_builtins.bool] ip_firewall: Enables IP Access Rules for this application.
               Notes: Only available for TCP applications.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] origin_directs: List of origin IP addresses. Array may contain multiple IP addresses for load balancing.
        :param pulumi.Input[Union['ApplicationOriginDnsArgs', 'ApplicationOriginDnsArgsDict']] origin_dns: The name and type of DNS record for the Spectrum application.
        :param Any origin_port: The destination port at the origin. Only specified in conjunction with origin_dns. May use an integer to specify a single origin port, for example `1000`, or a string to specify a range of origin ports, for example `"1000-2000"`.
               Notes: If specifying a port range, the number of ports in the range must match the number of ports specified in the "protocol" field.
        :param pulumi.Input[_builtins.str] protocol: The port configuration at Cloudflare's edge. May specify a single port, for example `"tcp/1000"`, or a range of ports, for example `"tcp/1000-2000"`.
        :param pulumi.Input[_builtins.str] proxy_protocol: Enables Proxy Protocol to the origin. Refer to [Enable Proxy protocol](https://developers.cloudflare.com/spectrum/getting-started/proxy-protocol/) for implementation details on PROXY Protocol V1, PROXY Protocol V2, and Simple Proxy Protocol.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/spectrumApplication:SpectrumApplication")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Application, __self__).__init__(
            'cloudflare:spectrum/application:Application',
            resource_name,
            __props__,
            opts)
    ...
    @_builtins.property
    @pulumi.getter
    def dns(self) -> pulumi.Output['outputs.ApplicationDns']:
        """
        The name and type of DNS record for the Spectrum application.
        """
        return pulumi.get(self, "dns")
    ...
    @_builtins.property
    @pulumi.getter(name="edgeIps")
    def edge_ips(self) -> pulumi.Output['outputs.ApplicationEdgeIps']:
        """
        The anycast edge IP configuration for the hostname of this application.
        """
        return pulumi.get(self, "edge_ips")
    ...
    @_builtins.property
    @pulumi.getter(name="originDns")
    def origin_dns(self) -> pulumi.Output[Optional['outputs.ApplicationOriginDns']]:
        """
        The name and type of DNS record for the Spectrum application.
        """
        return pulumi.get(self, "origin_dns")
