...
class GetApplicationsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetApplicationsResultResult']:
        """
...
def get_applications(direction: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:spectrum/applications:getApplications', __args__, opts=opts, typ=GetApplicationsResult).value
...
def get_applications_output(direction: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:spectrum/applications:getApplications', __args__, opts=opts, typ=GetApplicationsResult)
