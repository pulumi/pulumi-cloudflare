...
def get_email_routing_addresses(account_id: Optional[_builtins.str] = None,
...
def get_email_routing_addresses_output(account_id: Optional[pulumi.Input[_builtins.str]] = None,
