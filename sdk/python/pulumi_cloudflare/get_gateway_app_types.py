...
def get_gateway_app_types(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str account_id: The account ID to fetch Gateway App Types from.
    """
    __args__ = dict()
...
def get_gateway_app_types_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
