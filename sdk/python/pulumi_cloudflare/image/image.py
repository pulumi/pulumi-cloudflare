...
@pulumi.type_token("cloudflare:image/image:Image")
class Image(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
        $ pulumi import cloudflare:image/image:Image example '<account_id>/<image_id>'
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/image:Image")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Image, __self__).__init__(
            'cloudflare:image/image:Image',
            resource_name,
            __props__,
            opts)
