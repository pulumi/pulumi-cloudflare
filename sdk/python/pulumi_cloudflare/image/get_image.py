...
def get_image(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:image/image:getImage', __args__, opts=opts, typ=GetImageResult).value
...
def get_image_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:image/image:getImage', __args__, opts=opts, typ=GetImageResult)
