...
def get_job(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:logpushDataset/job:getJob', __args__, opts=opts, typ=GetJobResult).value
...
def get_job_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:logpushDataset/job:getJob', __args__, opts=opts, typ=GetJobResult)
