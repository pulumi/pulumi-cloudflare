...
def get_field(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:logpushDataset/field:getField', __args__, opts=opts, typ=GetFieldResult).value

    return AwaitableGetFieldResult(
        account_id=pulumi.get(__ret__, 'account_id'),
        dataset_id=pulumi.get(__ret__, 'dataset_id'),
        zone_id=pulumi.get(__ret__, 'zone_id'))
def get_field_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:logpushDataset/field:getField', __args__, opts=opts, typ=GetFieldResult)
