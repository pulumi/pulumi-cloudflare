...
def get_api_token(filter: Optional[Union['GetApiTokenFilterArgs', 'GetApiTokenFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:apiToken/apiToken:getApiToken', __args__, opts=opts, typ=GetApiTokenResult).value
...
def get_api_token_output(filter: pulumi.Input[Optional[Optional[Union['GetApiTokenFilterArgs', 'GetApiTokenFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:apiToken/apiToken:getApiToken', __args__, opts=opts, typ=GetApiTokenResult)
