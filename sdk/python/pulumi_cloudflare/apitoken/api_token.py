...
@pulumi.type_token("cloudflare:apiToken/apiToken:ApiToken")
class ApiToken(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/apiToken:ApiToken")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["value"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(ApiToken, __self__).__init__(
            'cloudflare:apiToken/apiToken:ApiToken',
            resource_name,
            __props__,
            opts)
