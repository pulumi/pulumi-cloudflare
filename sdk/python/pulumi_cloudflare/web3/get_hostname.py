...
def get_hostname(identifier: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:web3/hostname:getHostname', __args__, opts=opts, typ=GetHostnameResult).value
...
def get_hostname_output(identifier: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:web3/hostname:getHostname', __args__, opts=opts, typ=GetHostnameResult)
