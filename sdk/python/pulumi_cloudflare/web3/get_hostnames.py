...
def get_hostnames(max_items: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:web3/hostnames:getHostnames', __args__, opts=opts, typ=GetHostnamesResult).value
...
def get_hostnames_output(max_items: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:web3/hostnames:getHostnames', __args__, opts=opts, typ=GetHostnamesResult)
