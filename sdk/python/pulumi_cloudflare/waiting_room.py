...
class WaitingRoomArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] host: Host name for which the waiting room will be applied (no wildcards).
        :param pulumi.Input[builtins.str] name: A unique name to identify the waiting room. **Modifying this attribute will force creation of a new resource.**
        ...
        :param pulumi.Input[builtins.str] cookie_suffix: A cookie suffix to be appended to the Cloudflare waiting room cookie name.
        :param pulumi.Input[builtins.str] custom_page_html: This is a templated html file that will be rendered at the edge.
        :param pulumi.Input[builtins.str] default_template_language: The language to use for the default waiting room page. Available values: `de-DE`, `es-ES`, `en-US`, `fr-FR`, `id-ID`, `it-IT`, `ja-JP`, `ko-KR`, `nl-NL`, `pl-PL`, `pt-BR`, `tr-TR`, `zh-CN`, `zh-TW`, `ru-RU`, `fa-IR`, `bg-BG`, `hr-HR`, `cs-CZ`, `da-DK`, `fi-FI`, `lt-LT`, `ms-MY`, `nb-NO`, `ro-RO`, `el-GR`, `he-IL`, `hi-IN`, `hu-HU`, `sr-BA`, `sk-SK`, `sl-SI`, `sv-SE`, `tl-PH`, `th-TH`, `uk-UA`, `vi-VN`. Defaults to `en-US`.
        :param pulumi.Input[builtins.str] description: A description to add more details about the waiting room.
        :param pulumi.Input[builtins.bool] disable_session_renewal: Disables automatic renewal of session cookies.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] enabled_origin_commands: The list of enabled origin commands for the waiting room. Available values: `revoke`.
        :param pulumi.Input[builtins.bool] json_response_enabled: If true, requests to the waiting room with the header `Accept: application/json` will receive a JSON response object.
        :param pulumi.Input[builtins.str] path: The path within the host to enable the waiting room on. Defaults to `/`.
        :param pulumi.Input[builtins.bool] queue_all: If queue_all is true, then all traffic will be sent to the waiting room.
        :param pulumi.Input[builtins.str] queueing_method: The queueing method used by the waiting room. Available values: `fifo`, `random`, `passthrough`, `reject`. Defaults to `fifo`.
        :param pulumi.Input[builtins.int] queueing_status_code: HTTP status code returned to a user while in the queue. Defaults to `200`.
        :param pulumi.Input[builtins.int] session_duration: Lifetime of a cookie (in minutes) set by Cloudflare for users who get access to the origin. Defaults to `5`.
        :param pulumi.Input[builtins.bool] suspended: Suspends the waiting room.
        """
...
class WaitingRoom(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="defaultTemplateLanguage")
    def default_template_language(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The language to use for the default waiting room page. Available values: `de-DE`, `es-ES`, `en-US`, `fr-FR`, `id-ID`, `it-IT`, `ja-JP`, `ko-KR`, `nl-NL`, `pl-PL`, `pt-BR`, `tr-TR`, `zh-CN`, `zh-TW`, `ru-RU`, `fa-IR`, `bg-BG`, `hr-HR`, `cs-CZ`, `da-DK`, `fi-FI`, `lt-LT`, `ms-MY`, `nb-NO`, `ro-RO`, `el-GR`, `he-IL`, `hi-IN`, `hu-HU`, `sr-BA`, `sk-SK`, `sl-SI`, `sv-SE`, `tl-PH`, `th-TH`, `uk-UA`, `vi-VN`. Defaults to `en-US`.
        """
        return pulumi.get(self, "default_template_language")
    ...
    @property
    @pulumi.getter(name="enabledOriginCommands")
    def enabled_origin_commands(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of enabled origin commands for the waiting room. Available values: `revoke`.
        """
        return pulumi.get(self, "enabled_origin_commands")
    ...
    @property
    @pulumi.getter(name="jsonResponseEnabled")
    def json_response_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, requests to the waiting room with the header `Accept: application/json` will receive a JSON response object.
        """
        return pulumi.get(self, "json_response_enabled")
    ...
    @property
    @pulumi.getter(name="queueAll")
    def queue_all(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If queue_all is true, then all traffic will be sent to the waiting room.
        """
        return pulumi.get(self, "queue_all")
    ...
    @property
    @pulumi.getter(name="queueingStatusCode")
    def queueing_status_code(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        HTTP status code returned to a user while in the queue. Defaults to `200`.
        """
        return pulumi.get(self, "queueing_status_code")
