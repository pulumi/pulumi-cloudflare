...
class GetClassResult:
    ...
    def sensitivity_levels(self) -> Sequence['outputs.GetClassSensitivityLevelResult']:
...
class AwaitableGetClassResult(GetClassResult):
...
def get_class(account_id: Optional[_builtins.str] = None,
              data_class_id: Optional[_builtins.str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetClassResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDlpData/class:getClass', __args__, opts=opts, typ=GetClassResult).value

    return AwaitableGetClassResult(
...
def get_class_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
                     data_class_id: pulumi.Input[Optional[_builtins.str]] = None,
                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetClassResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDlpData/class:getClass', __args__, opts=opts, typ=GetClassResult)
    return __ret__.apply(lambda __response__: GetClassResult(
