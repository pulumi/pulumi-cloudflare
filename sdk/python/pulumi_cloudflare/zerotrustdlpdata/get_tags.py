...
class GetTagsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetTagsResultResult']:
        """
...
def get_tags(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDlpData/tags:getTags', __args__, opts=opts, typ=GetTagsResult).value
...
def get_tags_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDlpData/tags:getTags', __args__, opts=opts, typ=GetTagsResult)
