...
class GetSenderResult:
    ...
    """
    def __init__(__self__, account_id=None, comments=None, created_at=None, filter=None, id=None, is_regex=None, last_modified=None, modified_at=None, pattern=None, pattern_id=None, pattern_type=None):
        ...
        if pattern_id and not isinstance(pattern_id, str):
            raise TypeError("Expected argument 'pattern_id' to be a str")
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetSenderFilterResult']:
...
def get_sender(account_id: Optional[_builtins.str] = None,
               filter: Optional[Union['GetSenderFilterArgs', 'GetSenderFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:emailSecurityBlock/sender:getSender', __args__, opts=opts, typ=GetSenderResult).value
...
def get_sender_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                      filter: pulumi.Input[Optional[Optional[Union['GetSenderFilterArgs', 'GetSenderFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:emailSecurityBlock/sender:getSender', __args__, opts=opts, typ=GetSenderResult)
