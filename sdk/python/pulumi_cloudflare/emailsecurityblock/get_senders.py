...
class GetSendersResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetSendersResultResult']:
...
def get_senders(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:emailSecurityBlock/senders:getSenders', __args__, opts=opts, typ=GetSendersResult).value
...
def get_senders_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:emailSecurityBlock/senders:getSenders', __args__, opts=opts, typ=GetSendersResult)
