...
@pulumi.type_token("cloudflare:dnsZoneTransfers/peer:Peer")
class Peer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/dnsZoneTransfersPeer:DnsZoneTransfersPeer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Peer, __self__).__init__(
            'cloudflare:dnsZoneTransfers/peer:Peer',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            port: pulumi.Input[Optional[_builtins.float]] = None,
            tsig_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Peer':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="ixfrEnable")
    def ixfr_enable(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Enable IXFR transfer protocol, default is AXFR. Only applicable to secondary zones.
        """
        return pulumi.get(self, "ixfr_enable")
    ...
    @_builtins.property
    @pulumi.getter(name="tsigId")
    def tsig_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        TSIG authentication will be used for zone transfer if configured.
        """
        return pulumi.get(self, "tsig_id")
