...
@pulumi.type_token("cloudflare:dnsZoneTransfers/acl:Acl")
class Acl(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/dnsZoneTransfersAcl:DnsZoneTransfersAcl")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Acl, __self__).__init__(
            'cloudflare:dnsZoneTransfers/acl:Acl',
            resource_name,
            __props__,
            opts)
