...
def get_peer(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:dnsZoneTransfers/peer:getPeer', __args__, opts=opts, typ=GetPeerResult).value
...
def get_peer_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:dnsZoneTransfers/peer:getPeer', __args__, opts=opts, typ=GetPeerResult)
