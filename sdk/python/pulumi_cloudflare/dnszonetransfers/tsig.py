...
class _TsigState:
    def __init__(__self__, *,
                 ...
                 algo: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def algo(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        TSIG algorithm.
        """
        return pulumi.get(self, "algo")
    ...
    @algo.setter
    def algo(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "algo", value)
...
@pulumi.type_token("cloudflare:dnsZoneTransfers/tsig:Tsig")
class Tsig(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param TsigArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TsigArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TsigArgs.__new__(TsigArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/dnsZoneTransfersTsig:DnsZoneTransfersTsig")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["secret"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(Tsig, __self__).__init__(
            'cloudflare:dnsZoneTransfers/tsig:Tsig',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            algo: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            secret: pulumi.Input[Optional[_builtins.str]] = None) -> 'Tsig':
        """
        ...
        __props__ = _TsigState.__new__(_TsigState)

        __props__.__dict__["account_id"] = account_id
        __props__.__dict__["algo"] = algo
        __props__.__dict__["name"] = name
        __props__.__dict__["secret"] = secret
        return Tsig(resource_name, opts=opts, __props__=__props__)
