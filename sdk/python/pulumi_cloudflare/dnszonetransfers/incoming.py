...
class IncomingArgs:
    def __init__(__self__, *,
                 ...
                 auto_refresh_seconds: pulumi.Input[Optional[_builtins.float]] = None):
        """
    ...
    def auto_refresh_seconds(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def auto_refresh_seconds(self, value: pulumi.Input[Optional[_builtins.float]]):
...
@pulumi.type_token("cloudflare:dnsZoneTransfers/incoming:Incoming")
class Incoming(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param IncomingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IncomingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IncomingArgs.__new__(IncomingArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/dnsZoneTransfersIncoming:DnsZoneTransfersIncoming")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Incoming, __self__).__init__(
            'cloudflare:dnsZoneTransfers/incoming:Incoming',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            peers: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            soa_serial: pulumi.Input[Optional[_builtins.float]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Incoming':
        """
        ...
        __props__ = _IncomingState.__new__(_IncomingState)
        ...
        __props__.__dict__["zone_id"] = zone_id
        return Incoming(resource_name, opts=opts, __props__=__props__)
