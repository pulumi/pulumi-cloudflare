...
__all__ = [
    'GetOutgoingResult',
    'AwaitableGetOutgoingResult',
    'get_outgoing',
    'get_outgoing_output',
]

@pulumi.output_type
class GetOutgoingResult:
    """
    ...
    def last_transferred_time(self) -> _builtins.str:
        """
        The time for a specific event.
        """
...
class AwaitableGetOutgoingResult(GetOutgoingResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOutgoingResult(
...
def get_outgoing(zone_id: Optional[_builtins.str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOutgoingResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:dnsZoneTransfers/outgoing:getOutgoing', __args__, opts=opts, typ=GetOutgoingResult).value

    return AwaitableGetOutgoingResult(
...
def get_outgoing_output(zone_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOutgoingResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:dnsZoneTransfers/outgoing:getOutgoing', __args__, opts=opts, typ=GetOutgoingResult)
    return __ret__.apply(lambda __response__: GetOutgoingResult(
