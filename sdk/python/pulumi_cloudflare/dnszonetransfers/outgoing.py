...
@pulumi.type_token("cloudflare:dnsZoneTransfers/outgoing:Outgoing")
class Outgoing(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param OutgoingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OutgoingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OutgoingArgs.__new__(OutgoingArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/dnsZoneTransfersOutgoing:DnsZoneTransfersOutgoing")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Outgoing, __self__).__init__(
            'cloudflare:dnsZoneTransfers/outgoing:Outgoing',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            peers: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            soa_serial: pulumi.Input[Optional[_builtins.float]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Outgoing':
        """
        ...
        __props__ = _OutgoingState.__new__(_OutgoingState)
        ...
        __props__.__dict__["zone_id"] = zone_id
        return Outgoing(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="lastTransferredTime")
    def last_transferred_time(self) -> pulumi.Output[_builtins.str]:
        """
        The time for a specific event.
        """
        return pulumi.get(self, "last_transferred_time")
