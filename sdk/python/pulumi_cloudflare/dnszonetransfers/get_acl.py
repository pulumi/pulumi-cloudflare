...
def get_acl(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:dnsZoneTransfers/acl:getAcl', __args__, opts=opts, typ=GetAclResult).value
...
def get_acl_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:dnsZoneTransfers/acl:getAcl', __args__, opts=opts, typ=GetAclResult)
