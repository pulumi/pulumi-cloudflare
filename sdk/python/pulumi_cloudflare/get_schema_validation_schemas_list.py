...
def get_schema_validation_schemas_list(max_items: Optional[builtins.int] = None,
    ...
    :param builtins.bool validation_enabled: Filter for enabled schemas
...
def get_schema_validation_schemas_list_output(max_items: Optional[pulumi.Input[Optional[builtins.int]]] = None,
