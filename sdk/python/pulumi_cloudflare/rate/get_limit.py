...
class GetLimitResult:
    ...
    @_builtins.property
    @pulumi.getter
    def action(self) -> 'outputs.GetLimitActionResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def bypasses(self) -> Sequence['outputs.GetLimitBypassResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def match(self) -> 'outputs.GetLimitMatchResult':
        """
...
def get_limit(rate_limit_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:rate/limit:getLimit', __args__, opts=opts, typ=GetLimitResult).value
...
def get_limit_output(rate_limit_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:rate/limit:getLimit', __args__, opts=opts, typ=GetLimitResult)
