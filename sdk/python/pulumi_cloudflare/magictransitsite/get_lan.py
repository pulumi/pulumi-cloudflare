...
class GetLanResult:
    ...
    @_builtins.property
    @pulumi.getter
    def nat(self) -> 'outputs.GetLanNatResult':
    ...
    def routed_subnets(self) -> Sequence['outputs.GetLanRoutedSubnetResult']:
    ...
    def static_addressing(self) -> 'outputs.GetLanStaticAddressingResult':
        """
...
def get_lan(account_id: Optional[_builtins.str] = None,
    ...
    example_magic_transit_site_lan = cloudflare.magictransitsite.get_lan(account_id="023e105f4ecef8ad9ca31a8372d0c353",
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:magicTransitSite/lan:getLan', __args__, opts=opts, typ=GetLanResult).value
...
def get_lan_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:magicTransitSite/lan:getLan', __args__, opts=opts, typ=GetLanResult)
