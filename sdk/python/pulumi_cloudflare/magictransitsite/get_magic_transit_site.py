...
def get_magic_transit_site(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:magicTransitSite/magicTransitSite:getMagicTransitSite', __args__, opts=opts, typ=GetMagicTransitSiteResult).value
...
def get_magic_transit_site_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:magicTransitSite/magicTransitSite:getMagicTransitSite', __args__, opts=opts, typ=GetMagicTransitSiteResult)
