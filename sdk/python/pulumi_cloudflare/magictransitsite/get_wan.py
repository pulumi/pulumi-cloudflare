...
class GetWanResult:
    ...
    def static_addressing(self) -> 'outputs.GetWanStaticAddressingResult':
        """
...
class AwaitableGetWanResult(GetWanResult):
...
def get_wan(account_id: Optional[_builtins.str] = None,
            site_id: Optional[_builtins.str] = None,
            wan_id: Optional[_builtins.str] = None,
            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWanResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:magicTransitSite/wan:getWan', __args__, opts=opts, typ=GetWanResult).value

    return AwaitableGetWanResult(
...
def get_wan_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
                   site_id: pulumi.Input[Optional[_builtins.str]] = None,
                   wan_id: pulumi.Input[Optional[_builtins.str]] = None,
                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWanResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:magicTransitSite/wan:getWan', __args__, opts=opts, typ=GetWanResult)
    return __ret__.apply(lambda __response__: GetWanResult(
