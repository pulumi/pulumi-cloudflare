...
class GetAclResult:
    ...
    @_builtins.property
    @pulumi.getter
    def lan1(self) -> 'outputs.GetAclLan1Result':
        return pulumi.get(self, "lan1")

    @_builtins.property
    @pulumi.getter
    def lan2(self) -> 'outputs.GetAclLan2Result':
...
def get_acl(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:magicTransitSite/acl:getAcl', __args__, opts=opts, typ=GetAclResult).value
...
def get_acl_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:magicTransitSite/acl:getAcl', __args__, opts=opts, typ=GetAclResult)
