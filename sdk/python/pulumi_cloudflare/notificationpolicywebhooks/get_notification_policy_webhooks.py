...
def get_notification_policy_webhooks(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:notificationPolicyWebhooks/notificationPolicyWebhooks:getNotificationPolicyWebhooks', __args__, opts=opts, typ=GetNotificationPolicyWebhooksResult).value
...
def get_notification_policy_webhooks_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:notificationPolicyWebhooks/notificationPolicyWebhooks:getNotificationPolicyWebhooks', __args__, opts=opts, typ=GetNotificationPolicyWebhooksResult)
