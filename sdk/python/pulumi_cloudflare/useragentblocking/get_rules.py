...
def get_rules(description: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:userAgentBlocking/rules:getRules', __args__, opts=opts, typ=GetRulesResult).value
...
def get_rules_output(description: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:userAgentBlocking/rules:getRules', __args__, opts=opts, typ=GetRulesResult)
