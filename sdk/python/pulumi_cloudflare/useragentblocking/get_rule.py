...
def get_rule(filter: Optional[Union['GetRuleFilterArgs', 'GetRuleFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:userAgentBlocking/rule:getRule', __args__, opts=opts, typ=GetRuleResult).value
...
def get_rule_output(filter: pulumi.Input[Optional[Optional[Union['GetRuleFilterArgs', 'GetRuleFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:userAgentBlocking/rule:getRule', __args__, opts=opts, typ=GetRuleResult)
