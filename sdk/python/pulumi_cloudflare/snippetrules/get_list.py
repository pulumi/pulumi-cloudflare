...
def get_list(max_items: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:snippetRules/list:getList', __args__, opts=opts, typ=GetListResult).value
...
def get_list_output(max_items: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:snippetRules/list:getList', __args__, opts=opts, typ=GetListResult)
