...
def get_settings(zone_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:emailRouting/settings:getSettings', __args__, opts=opts, typ=GetSettingsResult).value
...
def get_settings_output(zone_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:emailRouting/settings:getSettings', __args__, opts=opts, typ=GetSettingsResult)
