...
def get_rules(enabled: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:emailRouting/rules:getRules', __args__, opts=opts, typ=GetRulesResult).value
...
def get_rules_output(enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:emailRouting/rules:getRules', __args__, opts=opts, typ=GetRulesResult)
