...
class GetAddressesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetAddressesResultResult']:
        """
...
def get_addresses(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:emailRouting/addresses:getAddresses', __args__, opts=opts, typ=GetAddressesResult).value
...
def get_addresses_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:emailRouting/addresses:getAddresses', __args__, opts=opts, typ=GetAddressesResult)
