...
class _DnsState:
    def __init__(__self__, *,
                 ...
                 errors: pulumi.Input[Optional[Sequence[pulumi.Input['DnsErrorArgs']]]] = None,
                 messages: pulumi.Input[Optional[Sequence[pulumi.Input['DnsMessageArgs']]]] = None,
                 modified: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 result: pulumi.Input[Optional['DnsResultArgs']] = None,
                 result_info: pulumi.Input[Optional['DnsResultInfoArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def errors(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DnsErrorArgs']]]]:
        return pulumi.get(self, "errors")

    @errors.setter
    def errors(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DnsErrorArgs']]]]):
        pulumi.set(self, "errors", value)

    @_builtins.property
    @pulumi.getter
    def messages(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DnsMessageArgs']]]]:
        return pulumi.get(self, "messages")

    @messages.setter
    def messages(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DnsMessageArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def result(self) -> pulumi.Input[Optional['DnsResultArgs']]:
        return pulumi.get(self, "result")

    @result.setter
    def result(self, value: pulumi.Input[Optional['DnsResultArgs']]):
        pulumi.set(self, "result", value)

    @_builtins.property
    @pulumi.getter(name="resultInfo")
    def result_info(self) -> pulumi.Input[Optional['DnsResultInfoArgs']]:
        return pulumi.get(self, "result_info")

    @result_info.setter
    def result_info(self, value: pulumi.Input[Optional['DnsResultInfoArgs']]):
...
@pulumi.type_token("cloudflare:emailRouting/dns:Dns")
class Dns(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/emailRoutingDns:EmailRoutingDns")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Dns, __self__).__init__(
            'cloudflare:emailRouting/dns:Dns',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            created: pulumi.Input[Optional[_builtins.str]] = None,
            enabled: pulumi.Input[Optional[_builtins.bool]] = None,
            errors: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DnsErrorArgs', 'DnsErrorArgsDict']]]]] = None,
            messages: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DnsMessageArgs', 'DnsMessageArgsDict']]]]] = None,
            modified: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            result: pulumi.Input[Optional[Union['DnsResultArgs', 'DnsResultArgsDict']]] = None,
            result_info: pulumi.Input[Optional[Union['DnsResultInfoArgs', 'DnsResultInfoArgsDict']]] = None,
            skip_wizard: pulumi.Input[Optional[_builtins.bool]] = None,
            status: pulumi.Input[Optional[_builtins.str]] = None,
            success: pulumi.Input[Optional[_builtins.bool]] = None,
            tag: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Dns':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def errors(self) -> pulumi.Output[Sequence['outputs.DnsError']]:
        return pulumi.get(self, "errors")

    @_builtins.property
    @pulumi.getter
    def messages(self) -> pulumi.Output[Sequence['outputs.DnsMessage']]:
        return pulumi.get(self, "messages")
    ...
    @_builtins.property
    @pulumi.getter
    def result(self) -> pulumi.Output['outputs.DnsResult']:
        return pulumi.get(self, "result")

    @_builtins.property
    @pulumi.getter(name="resultInfo")
    def result_info(self) -> pulumi.Output['outputs.DnsResultInfo']:
        return pulumi.get(self, "result_info")
