...
class GetAddressResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetAddressFilterResult']:
...
def get_address(account_id: Optional[_builtins.str] = None,
                destination_address_identifier: Optional[_builtins.str] = None,
                filter: Optional[Union['GetAddressFilterArgs', 'GetAddressFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:emailRouting/address:getAddress', __args__, opts=opts, typ=GetAddressResult).value
...
def get_address_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                       destination_address_identifier: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                       filter: pulumi.Input[Optional[Optional[Union['GetAddressFilterArgs', 'GetAddressFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:emailRouting/address:getAddress', __args__, opts=opts, typ=GetAddressResult)
