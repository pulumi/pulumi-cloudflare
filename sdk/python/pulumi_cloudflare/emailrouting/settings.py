...
@pulumi.type_token("cloudflare:emailRouting/settings:Settings")
class Settings(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/emailRoutingSettings:EmailRoutingSettings")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Settings, __self__).__init__(
            'cloudflare:emailRouting/settings:Settings',
            resource_name,
            __props__,
            opts)
