...
class ZeroTrustDeviceProfilesArgs:
    def __init__(__self__, *,
                 ...
                 auto_connect: Optional[pulumi.Input[builtins.int]] = None,
                 captive_portal: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 service_mode_v2_mode: Optional[pulumi.Input[builtins.str]] = None,
                 service_mode_v2_port: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] description: Description of Policy.
        :param pulumi.Input[builtins.str] name: Name of the policy.
        :param pulumi.Input[builtins.bool] allow_mode_switch: Whether to allow mode switch for this policy.
        :param pulumi.Input[builtins.bool] allow_updates: Whether to allow updates under this policy.
        :param pulumi.Input[builtins.bool] allowed_to_leave: Whether to allow devices to leave the organization. Defaults to `true`.
        :param pulumi.Input[builtins.int] auto_connect: The amount of time in seconds to reconnect after having been disabled.
        :param pulumi.Input[builtins.int] captive_portal: The captive portal value for this policy. Defaults to `180`.
        :param pulumi.Input[builtins.bool] default: Whether the policy refers to the default account policy.
        :param pulumi.Input[builtins.bool] disable_auto_fallback: Whether to disable auto fallback for this policy.
        :param pulumi.Input[builtins.bool] enabled: Whether the policy is enabled (cannot be set for default policies). Defaults to `true`.
        :param pulumi.Input[builtins.bool] exclude_office_ips: Whether to add Microsoft IPs to split tunnel exclusions.
        :param pulumi.Input[builtins.str] match: Wirefilter expression to match a device against when evaluating whether this policy should take effect for that device.
        :param pulumi.Input[builtins.int] precedence: The precedence of the policy. Lower values indicate higher precedence.
        :param pulumi.Input[builtins.str] service_mode_v2_mode: The service mode. Available values: `1dot1`, `warp`, `proxy`, `posture_only`, `warp_tunnel_only`. Defaults to `warp`.
        :param pulumi.Input[builtins.int] service_mode_v2_port: The port to use for the proxy service mode. Required when using `service_mode_v2_mode`.
        :param pulumi.Input[builtins.str] support_url: The support URL that will be opened when sending feedback.
        :param pulumi.Input[builtins.bool] switch_locked: Enablement of the ZT client switch lock.
        :param pulumi.Input[builtins.str] tunnel_protocol: Determines which tunnel protocol to use. Available values: `""`, `wireguard`, `masque`. Defaults to `wireguard`.
        """
    ...
    def auto_connect(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @auto_connect.setter
    def auto_connect(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "auto_connect", value)

    @property
    @pulumi.getter(name="captivePortal")
    def captive_portal(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def captive_portal(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def service_mode_v2_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_mode_v2_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_mode_v2_mode", value)

    @property
    @pulumi.getter(name="serviceModeV2Port")
    def service_mode_v2_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def service_mode_v2_port(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ZeroTrustDeviceProfiles(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            support_url: Optional[pulumi.Input[builtins.str]] = None,
            switch_locked: Optional[pulumi.Input[builtins.bool]] = None,
            tunnel_protocol: Optional[pulumi.Input[builtins.str]] = None) -> 'ZeroTrustDeviceProfiles':
        """
    ...
    @property
    @pulumi.getter(name="autoConnect")
    def auto_connect(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The amount of time in seconds to reconnect after having been disabled.
        """
        return pulumi.get(self, "auto_connect")
    ...
    @property
    @pulumi.getter(name="captivePortal")
    def captive_portal(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The captive portal value for this policy. Defaults to `180`.
        """
        return pulumi.get(self, "captive_portal")
    ...
    @property
    @pulumi.getter(name="serviceModeV2Mode")
    def service_mode_v2_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The service mode. Available values: `1dot1`, `warp`, `proxy`, `posture_only`, `warp_tunnel_only`. Defaults to `warp`.
        """
        return pulumi.get(self, "service_mode_v2_mode")
    ...
    @property
    @pulumi.getter(name="serviceModeV2Port")
    def service_mode_v2_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The port to use for the proxy service mode. Required when using `service_mode_v2_mode`.
        """
        return pulumi.get(self, "service_mode_v2_port")
