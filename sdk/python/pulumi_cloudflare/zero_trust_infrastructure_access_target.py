...
class ZeroTrustInfrastructureAccessTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] hostname: A non-unique field that refers to a target.
...
class _ZeroTrustInfrastructureAccessTargetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: The account identifier to target for the resource.
        :param pulumi.Input[builtins.str] created_at: The date and time at which the target was created.
        :param pulumi.Input[builtins.str] hostname: A non-unique field that refers to a target.
        :param pulumi.Input['ZeroTrustInfrastructureAccessTargetIpArgs'] ip: The IPv4/IPv6 address that identifies where to reach a target.
        :param pulumi.Input[builtins.str] modified_at: The date and time at which the target was last modified.
        """
...
class ZeroTrustInfrastructureAccessTarget(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            hostname: Optional[pulumi.Input[builtins.str]] = None,
            ip: Optional[pulumi.Input[Union['ZeroTrustInfrastructureAccessTargetIpArgs', 'ZeroTrustInfrastructureAccessTargetIpArgsDict']]] = None,
            modified_at: Optional[pulumi.Input[builtins.str]] = None) -> 'ZeroTrustInfrastructureAccessTarget':
        """
