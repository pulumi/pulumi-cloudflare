...
@pulumi.type_token("cloudflare:workersKv/namespace:Namespace")
class Namespace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/workersKvNamespace:WorkersKvNamespace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Namespace, __self__).__init__(
            'cloudflare:workersKv/namespace:Namespace',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            account_id: pulumi.Input[Optional[_builtins.str]] = None,
            supports_url_encoding: pulumi.Input[Optional[_builtins.bool]] = None,
            title: pulumi.Input[Optional[_builtins.str]] = None) -> 'Namespace':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="supportsUrlEncoding")
    def supports_url_encoding(self) -> pulumi.Output[_builtins.bool]:
        """
        True if keys written on the URL will be URL-decoded before storing. For example, if set to "true", a key written on the URL as "%3F" will be stored as "?".
        """
        return pulumi.get(self, "supports_url_encoding")
