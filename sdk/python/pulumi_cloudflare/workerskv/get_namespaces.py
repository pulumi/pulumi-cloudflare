...
class GetNamespacesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetNamespacesResultResult']:
        """
...
def get_namespaces(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:workersKv/namespaces:getNamespaces', __args__, opts=opts, typ=GetNamespacesResult).value
...
def get_namespaces_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:workersKv/namespaces:getNamespaces', __args__, opts=opts, typ=GetNamespacesResult)
