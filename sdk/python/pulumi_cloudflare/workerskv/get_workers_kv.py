...
def get_workers_kv(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:workersKv/workersKv:getWorkersKv', __args__, opts=opts, typ=GetWorkersKvResult).value
...
def get_workers_kv_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:workersKv/workersKv:getWorkersKv', __args__, opts=opts, typ=GetWorkersKvResult)
