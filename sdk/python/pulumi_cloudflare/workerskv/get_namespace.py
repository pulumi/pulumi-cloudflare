...
class GetNamespaceResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetNamespaceFilterResult']:
...
def get_namespace(account_id: Optional[_builtins.str] = None,
                  filter: Optional[Union['GetNamespaceFilterArgs', 'GetNamespaceFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:workersKv/namespace:getNamespace', __args__, opts=opts, typ=GetNamespaceResult).value
...
def get_namespace_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                         filter: pulumi.Input[Optional[Optional[Union['GetNamespaceFilterArgs', 'GetNamespaceFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:workersKv/namespace:getNamespace', __args__, opts=opts, typ=GetNamespaceResult)
