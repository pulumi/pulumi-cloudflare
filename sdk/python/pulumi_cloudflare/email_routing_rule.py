...
class EmailRoutingRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: Whether the email routing rule is enabled.
        ...
        :param pulumi.Input[builtins.int] priority: The priority of the email routing rule.
        """
...
class _EmailRoutingRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Routing rule name.
        :param pulumi.Input[builtins.int] priority: The priority of the email routing rule.
        :param pulumi.Input[builtins.str] tag: The tag of the email routing rule.
        :param pulumi.Input[builtins.str] zone_id: The zone identifier to target for the resource.
        """
        if actions is not None:
            pulumi.set(__self__, "actions", actions)
...
class EmailRoutingRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            priority: Optional[pulumi.Input[builtins.int]] = None,
            tag: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'EmailRoutingRule':
        """
