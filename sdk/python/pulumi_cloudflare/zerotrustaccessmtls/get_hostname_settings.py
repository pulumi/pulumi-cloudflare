...
__all__ = [
    'GetHostnameSettingsResult',
    'AwaitableGetHostnameSettingsResult',
    'get_hostname_settings',
    'get_hostname_settings_output',
]

@pulumi.output_type
class GetHostnameSettingsResult:
    """
...
class AwaitableGetHostnameSettingsResult(GetHostnameSettingsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetHostnameSettingsResult(
...
def get_hostname_settings(account_id: Optional[_builtins.str] = None,
                          zone_id: Optional[_builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetHostnameSettingsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustAccessMtls/hostnameSettings:getHostnameSettings', __args__, opts=opts, typ=GetHostnameSettingsResult).value

    return AwaitableGetHostnameSettingsResult(
...
def get_hostname_settings_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                 zone_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetHostnameSettingsResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustAccessMtls/hostnameSettings:getHostnameSettings', __args__, opts=opts, typ=GetHostnameSettingsResult)
    return __ret__.apply(lambda __response__: GetHostnameSettingsResult(
