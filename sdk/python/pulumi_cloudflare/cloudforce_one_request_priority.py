...
class _CloudforceOneRequestPriorityState:
    def __init__(__self__, *,
                 ...
                 message_tokens: Optional[pulumi.Input[int]] = None,
                 ...
                 tokens: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] labels: List of labels
        :param pulumi.Input[int] message_tokens: Tokens for the request messages
        :param pulumi.Input[int] priority: Priority
    ...
    def message_tokens(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def message_tokens(self, value: Optional[pulumi.Input[int]]):
    ...
    @property
    @pulumi.getter
    def tokens(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    @tokens.setter
    def tokens(self, value: Optional[pulumi.Input[int]]):
...
class CloudforceOneRequestPriority(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="messageTokens")
    def message_tokens(self) -> pulumi.Output[int]:
        """
        Tokens for the request messages
        """
        return pulumi.get(self, "message_tokens")
    ...
    @property
    @pulumi.getter
    def tokens(self) -> pulumi.Output[int]:
        """
        Tokens for the request
        """
        return pulumi.get(self, "tokens")
