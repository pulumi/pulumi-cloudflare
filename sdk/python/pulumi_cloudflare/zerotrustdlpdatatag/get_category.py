...
class GetCategoryResult:
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> Sequence['outputs.GetCategoryTagResult']:
...
def get_category(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDlpDataTag/category:getCategory', __args__, opts=opts, typ=GetCategoryResult).value
...
def get_category_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDlpDataTag/category:getCategory', __args__, opts=opts, typ=GetCategoryResult)
