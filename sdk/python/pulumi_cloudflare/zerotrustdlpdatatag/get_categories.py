...
def get_categories(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDlpDataTag/categories:getCategories', __args__, opts=opts, typ=GetCategoriesResult).value
...
def get_categories_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDlpDataTag/categories:getCategories', __args__, opts=opts, typ=GetCategoriesResult)
