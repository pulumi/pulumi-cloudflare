...
def get_asset(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:customPage/asset:getAsset', __args__, opts=opts, typ=GetAssetResult).value
...
def get_asset_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:customPage/asset:getAsset', __args__, opts=opts, typ=GetAssetResult)
