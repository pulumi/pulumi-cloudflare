...
class GetAssetsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetAssetsResultResult']:
        """
...
def get_assets(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:customPage/assets:getAssets', __args__, opts=opts, typ=GetAssetsResult).value
...
def get_assets_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:customPage/assets:getAssets', __args__, opts=opts, typ=GetAssetsResult)
