...
class SplitTunnelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] mode: The mode of the split tunnel policy. Available values: `include`, `exclude`.
        :param pulumi.Input[Sequence[pulumi.Input['SplitTunnelTunnelArgs']]] tunnels: The value of the tunnel attributes.
        :param pulumi.Input[builtins.str] policy_id: The settings policy for which to configure this split tunnel policy.
        """
