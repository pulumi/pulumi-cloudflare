...
def get_token(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustAccessService/token:getToken', __args__, opts=opts, typ=GetTokenResult).value
...
def get_token_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustAccessService/token:getToken', __args__, opts=opts, typ=GetTokenResult)
