...
class _StreamKeyState:
    def __init__(__self__, *,
                 ...
                 jwk: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def jwk(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @jwk.setter
    def jwk(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StreamKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            created: Optional[pulumi.Input[builtins.str]] = None,
            jwk: Optional[pulumi.Input[builtins.str]] = None,
            pem: Optional[pulumi.Input[builtins.str]] = None) -> 'StreamKey':
        """
    ...
    @property
    @pulumi.getter
    def jwk(self) -> pulumi.Output[builtins.str]:
        """
        The signing key in JWK format.
        """
        return pulumi.get(self, "jwk")
    ...
    @property
    @pulumi.getter
    def pem(self) -> pulumi.Output[builtins.str]:
        """
        The signing key in PEM format.
        """
        return pulumi.get(self, "pem")
