...
def get_policies(max_items: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pageShield/policies:getPolicies', __args__, opts=opts, typ=GetPoliciesResult).value

    return AwaitableGetPoliciesResult(
        max_items=pulumi.get(__ret__, 'max_items'),
        results=pulumi.get(__ret__, 'results'),
        zone_id=pulumi.get(__ret__, 'zone_id'))
def get_policies_output(max_items: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pageShield/policies:getPolicies', __args__, opts=opts, typ=GetPoliciesResult)
