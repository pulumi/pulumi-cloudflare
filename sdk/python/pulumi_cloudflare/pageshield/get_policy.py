...
def get_policy(policy_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pageShield/policy:getPolicy', __args__, opts=opts, typ=GetPolicyResult).value
...
def get_policy_output(policy_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pageShield/policy:getPolicy', __args__, opts=opts, typ=GetPolicyResult)
