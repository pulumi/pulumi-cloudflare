...
def get_page_shield_connections(connection_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pageShieldConnections/pageShieldConnections:getPageShieldConnections', __args__, opts=opts, typ=GetPageShieldConnectionsResult).value
...
def get_page_shield_connections_output(connection_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pageShieldConnections/pageShieldConnections:getPageShieldConnections', __args__, opts=opts, typ=GetPageShieldConnectionsResult)
