...
class GetPageShieldCookiesResult:
    ...
    def cookie_id(self) -> _builtins.str:
        """
        Identifier
        """
...
def get_page_shield_cookies(cookie_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pageShieldCookies/pageShieldCookies:getPageShieldCookies', __args__, opts=opts, typ=GetPageShieldCookiesResult).value
...
def get_page_shield_cookies_output(cookie_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pageShieldCookies/pageShieldCookies:getPageShieldCookies', __args__, opts=opts, typ=GetPageShieldCookiesResult)
