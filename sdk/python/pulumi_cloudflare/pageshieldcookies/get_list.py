...
def get_list(direction: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pageShieldCookies/list:getList', __args__, opts=opts, typ=GetListResult).value
...
def get_list_output(direction: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                    ...
                    http_only: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                    ...
                    same_site: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                    secure: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pageShieldCookies/list:getList', __args__, opts=opts, typ=GetListResult)
