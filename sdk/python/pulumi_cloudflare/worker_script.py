...
class WorkerScriptArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] body_part: Name of the part in the multipart request that contains the script (e.g. the file adding a listener to the `fetch` event). Indicates a `service worker syntax` Worker.
        :param pulumi.Input[str] compatibility_date: Date indicating targeted support in the Workers runtime. Backwards incompatible fixes to the runtime following this date will not affect this Worker.
...
class _WorkerScriptState:
    def __init__(__self__, *,
                 ...
                 startup_time_ms: Optional[pulumi.Input[int]] = None,
                 tail_consumers: Optional[pulumi.Input[Sequence[pulumi.Input['WorkerScriptTailConsumerArgs']]]] = None,
                 usage_model: Optional[pulumi.Input[str]] = None):
        """
    ...
    def startup_time_ms(self) -> Optional[pulumi.Input[int]]:
        return pulumi.get(self, "startup_time_ms")

    @startup_time_ms.setter
    def startup_time_ms(self, value: Optional[pulumi.Input[int]]):
...
class WorkerScript(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            startup_time_ms: Optional[pulumi.Input[int]] = None,
            tail_consumers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['WorkerScriptTailConsumerArgs', 'WorkerScriptTailConsumerArgsDict']]]]] = None,
            usage_model: Optional[pulumi.Input[str]] = None) -> 'WorkerScript':
        """
    ...
    @property
    @pulumi.getter(name="startupTimeMs")
    def startup_time_ms(self) -> pulumi.Output[int]:
        return pulumi.get(self, "startup_time_ms")
