...
class WorkersScriptSubdomainArgs:
    ...
    def previews_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def previews_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class WorkersScriptSubdomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enabled: Optional[pulumi.Input[builtins.bool]] = None,
            previews_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            script_name: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkersScriptSubdomain':
        """
    ...
    @property
    @pulumi.getter(name="previewsEnabled")
    def previews_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the Worker's Preview URLs should be available on the workers.dev subdomain.
        """
        return pulumi.get(self, "previews_enabled")
