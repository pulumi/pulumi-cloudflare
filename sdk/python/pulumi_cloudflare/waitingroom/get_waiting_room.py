...
def get_waiting_room(waiting_room_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:waitingRoom/waitingRoom:getWaitingRoom', __args__, opts=opts, typ=GetWaitingRoomResult).value
...
def get_waiting_room_output(waiting_room_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:waitingRoom/waitingRoom:getWaitingRoom', __args__, opts=opts, typ=GetWaitingRoomResult)
