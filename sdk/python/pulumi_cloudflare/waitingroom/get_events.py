...
class GetEventsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetEventsResultResult']:
        """
...
def get_events(max_items: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:waitingRoom/events:getEvents', __args__, opts=opts, typ=GetEventsResult).value
...
def get_events_output(max_items: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:waitingRoom/events:getEvents', __args__, opts=opts, typ=GetEventsResult)
