...
class EventArgs:
    def __init__(__self__, *,
                 event_end_time: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.int] new_users_per_minute: If set, the event will override the waiting room's `new_users_per_minute` property while it is active. If null, the event will inherit it. This can only be set if the event's `total_active_users` property is also set.
        :param pulumi.Input[_builtins.str] prequeue_start_time: An ISO 8601 timestamp that marks when to begin queueing all users before the event starts. The prequeue must start at least five minutes before `event_start_time`.
        :param pulumi.Input[_builtins.str] queueing_method: If set, the event will override the waiting room's `queueing_method` property while it is active. If null, the event will inherit it.
        :param pulumi.Input[_builtins.int] session_duration: If set, the event will override the waiting room's `session_duration` property while it is active. If null, the event will inherit it.
        :param pulumi.Input[_builtins.bool] shuffle_at_event_start: If enabled, users in the prequeue will be shuffled randomly at the `event_start_time`. Requires that `prequeue_start_time` is not null. This is useful for situations when many users will join the event prequeue at the same time and you want to shuffle them to ensure fairness. Naturally, it makes the most sense to enable this feature when the `queueing_method` during the event respects ordering such as **fifo**, or else the shuffling may be unnecessary.
        :param pulumi.Input[_builtins.bool] suspended: Suspends or allows an event. If set to `true`, the event is ignored and traffic will be handled based on the waiting room configuration.
        :param pulumi.Input[_builtins.int] total_active_users: If set, the event will override the waiting room's `total_active_users` property while it is active. If null, the event will inherit it. This can only be set if the event's `new_users_per_minute` property is also set.
        :param pulumi.Input[_builtins.str] turnstile_action: If set, the event will override the waiting room's `turnstile_action` property while it is active. If null, the event will inherit it.
    ...
    def event_end_time(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def event_end_time(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "event_end_time", value)

    @_builtins.property
    @pulumi.getter(name="eventStartTime")
    def event_start_time(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def event_start_time(self, value: pulumi.Input[_builtins.str]):
...
@pulumi.type_token("cloudflare:waitingRoom/event:Event")
class Event(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/waitingRoomEvent:WaitingRoomEvent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Event, __self__).__init__(
            'cloudflare:waitingRoom/event:Event',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            turnstile_mode: pulumi.Input[Optional[_builtins.str]] = None,
            waiting_room_id: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Event':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="disableSessionRenewal")
    def disable_session_renewal(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        If set, the event will override the waiting room's `disable_session_renewal` property while it is active. If null, the event will inherit it.
        """
        return pulumi.get(self, "disable_session_renewal")
    ...
    @_builtins.property
    @pulumi.getter(name="eventEndTime")
    def event_end_time(self) -> pulumi.Output[_builtins.str]:
        """
        An ISO 8601 timestamp that marks the end of the event.
        """
        return pulumi.get(self, "event_end_time")
    ...
    @_builtins.property
    @pulumi.getter(name="eventStartTime")
    def event_start_time(self) -> pulumi.Output[_builtins.str]:
        """
        An ISO 8601 timestamp that marks the start of the event. At this time, queued users will be processed with the event's configuration. The start time must be at least one minute before `event_end_time`.
        """
        return pulumi.get(self, "event_start_time")
    ...
    @_builtins.property
    @pulumi.getter(name="newUsersPerMinute")
    def new_users_per_minute(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        If set, the event will override the waiting room's `new_users_per_minute` property while it is active. If null, the event will inherit it. This can only be set if the event's `total_active_users` property is also set.
        """
        return pulumi.get(self, "new_users_per_minute")
    ...
    @_builtins.property
    @pulumi.getter(name="prequeueStartTime")
    def prequeue_start_time(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        An ISO 8601 timestamp that marks when to begin queueing all users before the event starts. The prequeue must start at least five minutes before `event_start_time`.
        """
        return pulumi.get(self, "prequeue_start_time")
    ...
    @_builtins.property
    @pulumi.getter(name="queueingMethod")
    def queueing_method(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        If set, the event will override the waiting room's `queueing_method` property while it is active. If null, the event will inherit it.
        """
        return pulumi.get(self, "queueing_method")
    ...
    @_builtins.property
    @pulumi.getter(name="sessionDuration")
    def session_duration(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        If set, the event will override the waiting room's `session_duration` property while it is active. If null, the event will inherit it.
        """
        return pulumi.get(self, "session_duration")
    ...
    @_builtins.property
    @pulumi.getter(name="shuffleAtEventStart")
    def shuffle_at_event_start(self) -> pulumi.Output[_builtins.bool]:
        """
        If enabled, users in the prequeue will be shuffled randomly at the `event_start_time`. Requires that `prequeue_start_time` is not null. This is useful for situations when many users will join the event prequeue at the same time and you want to shuffle them to ensure fairness. Naturally, it makes the most sense to enable this feature when the `queueing_method` during the event respects ordering such as **fifo**, or else the shuffling may be unnecessary.
        """
        return pulumi.get(self, "shuffle_at_event_start")
    ...
    @_builtins.property
    @pulumi.getter(name="totalActiveUsers")
    def total_active_users(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        If set, the event will override the waiting room's `total_active_users` property while it is active. If null, the event will inherit it. This can only be set if the event's `new_users_per_minute` property is also set.
        """
        return pulumi.get(self, "total_active_users")
    ...
    @_builtins.property
    @pulumi.getter(name="turnstileAction")
    def turnstile_action(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        If set, the event will override the waiting room's `turnstile_action` property while it is active. If null, the event will inherit it.
        Available values: "log", "infinite_queue".
        """
    ...
    @_builtins.property
    @pulumi.getter(name="turnstileMode")
    def turnstile_mode(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        If set, the event will override the waiting room's `turnstile_mode` property while it is active. If null, the event will inherit it.
        Available values: "off", "invisible", "visible*non*interactive", "visible_managed".
        """
