...
def get_event(event_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:waitingRoom/event:getEvent', __args__, opts=opts, typ=GetEventResult).value
...
def get_event_output(event_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:waitingRoom/event:getEvent', __args__, opts=opts, typ=GetEventResult)
