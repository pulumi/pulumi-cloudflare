...
def get_rules(waiting_room_id: Optional[_builtins.str] = None,
    ...
    example_waiting_room_rules = cloudflare.waitingroom.get_rules(zone_id="023e105f4ecef8ad9ca31a8372d0c353",
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:waitingRoom/rules:getRules', __args__, opts=opts, typ=GetRulesResult).value
...
def get_rules_output(waiting_room_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:waitingRoom/rules:getRules', __args__, opts=opts, typ=GetRulesResult)
