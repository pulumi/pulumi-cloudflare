...
class ZoneArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] plan: The name of the commercial plan to apply to the zone, can be updated once the zone is created; one of `free`, `pro`, `business`, `enterprise`.
