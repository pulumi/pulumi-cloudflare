...
class ZoneArgs:
    def __init__(__self__, *,
                 ...
                 jump_start: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] account_id: Account ID to manage the zone resource in.
        :param pulumi.Input[builtins.str] zone: The DNS zone name which will be added. **Modifying this attribute will force creation of a new resource.**
        :param pulumi.Input[builtins.bool] jump_start: Whether to scan for DNS records on creation. Ignored after zone is created.
        :param pulumi.Input[builtins.bool] paused: Whether this zone is paused (traffic bypasses Cloudflare). Defaults to `false`.
        :param pulumi.Input[builtins.str] plan: The name of the commercial plan to apply to the zone. Available values: `free`, `lite`, `pro`, `pro_plus`, `business`, `enterprise`, `partners_free`, `partners_pro`, `partners_business`, `partners_enterprise`.
        :param pulumi.Input[builtins.str] type: A full zone implies that DNS is hosted with Cloudflare. A partial zone is typically a partner-hosted zone or a CNAME setup. Available values: `full`, `partial`, `secondary`. Defaults to `full`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vanity_name_servers: List of Vanity Nameservers (if set).
        """
    ...
    def jump_start(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @jump_start.setter
    def jump_start(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ZoneState:
    def __init__(__self__, *,
                 ...
                 jump_start: Optional[pulumi.Input[builtins.bool]] = None,
                 meta: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.bool]]]] = None,
        ...
        :param pulumi.Input[builtins.str] account_id: Account ID to manage the zone resource in.
        :param pulumi.Input[builtins.bool] jump_start: Whether to scan for DNS records on creation. Ignored after zone is created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] name_servers: Cloudflare-assigned name servers. This is only populated for zones that use Cloudflare DNS.
        :param pulumi.Input[builtins.bool] paused: Whether this zone is paused (traffic bypasses Cloudflare). Defaults to `false`.
        :param pulumi.Input[builtins.str] plan: The name of the commercial plan to apply to the zone. Available values: `free`, `lite`, `pro`, `pro_plus`, `business`, `enterprise`, `partners_free`, `partners_pro`, `partners_business`, `partners_enterprise`.
        :param pulumi.Input[builtins.str] status: Status of the zone. Available values: `active`, `pending`, `initializing`, `moved`, `deleted`, `deactivated`.
        :param pulumi.Input[builtins.str] type: A full zone implies that DNS is hosted with Cloudflare. A partial zone is typically a partner-hosted zone or a CNAME setup. Available values: `full`, `partial`, `secondary`. Defaults to `full`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vanity_name_servers: List of Vanity Nameservers (if set).
        :param pulumi.Input[builtins.str] verification_key: Contains the TXT record value to validate domain ownership. This is only populated for zones of type `partial`.
        :param pulumi.Input[builtins.str] zone: The DNS zone name which will be added. **Modifying this attribute will force creation of a new resource.**
        """
    ...
    @property
    @pulumi.getter
    def meta(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.bool]]]]:
        return pulumi.get(self, "meta")

    @meta.setter
    def meta(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.bool]]]]):
...
class Zone(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="jumpStart")
    def jump_start(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to scan for DNS records on creation. Ignored after zone is created.
        """
        return pulumi.get(self, "jump_start")
    ...
    @property
    @pulumi.getter
    def meta(self) -> pulumi.Output[Mapping[str, builtins.bool]]:
        return pulumi.get(self, "meta")
