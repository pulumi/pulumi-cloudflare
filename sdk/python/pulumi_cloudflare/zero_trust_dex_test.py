...
class ZeroTrustDexTestArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the Device Dex Test. Must be unique.
        """
...
class _ZeroTrustDexTestState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: The account identifier to target for the resource. **Modifying this attribute will force creation of a new resource.**
        :param pulumi.Input[builtins.str] created: Timestamp of when the Dex Test was created.
        :param pulumi.Input['ZeroTrustDexTestDataArgs'] data: The configuration object which contains the details for the WARP client to conduct the test.
        :param pulumi.Input[builtins.str] description: Additional details about the test.
        :param pulumi.Input[builtins.bool] enabled: Determines whether or not the test is active.
        :param pulumi.Input[builtins.str] interval: How often the test will run.
        :param pulumi.Input[builtins.str] name: The name of the Device Dex Test. Must be unique.
        :param pulumi.Input[builtins.str] updated: Timestamp of when the Dex Test was last updated.
        """
...
class ZeroTrustDexTest(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            interval: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            updated: Optional[pulumi.Input[builtins.str]] = None) -> 'ZeroTrustDexTest':
        """
