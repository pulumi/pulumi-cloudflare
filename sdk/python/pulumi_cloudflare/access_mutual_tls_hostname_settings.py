...
class _AccessMutualTlsHostnameSettingsState:
    def __init__(__self__, *,
                 ...
                 settings: pulumi.Input[Optional[Sequence[pulumi.Input['AccessMutualTlsHostnameSettingsSettingArgs']]]] = None,
                 zone_id: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def settings(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AccessMutualTlsHostnameSettingsSettingArgs']]]]:
        return pulumi.get(self, "settings")

    @settings.setter
    def settings(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AccessMutualTlsHostnameSettingsSettingArgs']]]]):
        pulumi.set(self, "settings", value)
