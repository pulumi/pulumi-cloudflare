...
__all__ = ['ZeroTrustTunnelRouteArgs', 'ZeroTrustTunnelRoute']

@pulumi.input_type
class ZeroTrustTunnelRouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] network: The IPv4 or IPv6 network that should use this tunnel route, in CIDR notation.
        :param pulumi.Input[builtins.str] tunnel_id: The ID of the tunnel that will service the tunnel route.
        :param pulumi.Input[builtins.str] comment: Description of the tunnel route.
        :param pulumi.Input[builtins.str] virtual_network_id: The ID of the virtual network for which this route is being added; uses the default virtual network of the account if none is provided. **Modifying this attribute will force creation of a new resource.**
        """
...
@pulumi.input_type
class _ZeroTrustTunnelRouteState:
    def __init__(__self__, *,
...
class ZeroTrustTunnelRoute(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ZeroTrustTunnelRouteArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ZeroTrustTunnelRouteArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ZeroTrustTunnelRouteArgs.__new__(ZeroTrustTunnelRouteArgs)
        ...
        super(ZeroTrustTunnelRoute, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            network: Optional[pulumi.Input[builtins.str]] = None,
            tunnel_id: Optional[pulumi.Input[builtins.str]] = None,
            virtual_network_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ZeroTrustTunnelRoute':
        """
        ...
        __props__ = _ZeroTrustTunnelRouteState.__new__(_ZeroTrustTunnelRouteState)
        ...
        __props__.__dict__["tunnel_id"] = tunnel_id
        __props__.__dict__["virtual_network_id"] = virtual_network_id
        return ZeroTrustTunnelRoute(resource_name, opts=opts, __props__=__props__)
