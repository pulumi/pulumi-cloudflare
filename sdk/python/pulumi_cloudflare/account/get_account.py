...
def get_account(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:account/account:getAccount', __args__, opts=opts, typ=GetAccountResult).value
...
def get_account_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:account/account:getAccount', __args__, opts=opts, typ=GetAccountResult)
