...
class GetMembersResult:
    ...
    """
    def __init__(__self__, account_id=None, direction=None, max_items=None, order=None, results=None, status=None):
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetMembersResultResult']:
        """
...
def get_members(account_id: Optional[_builtins.str] = None,
    ...
    example_account_members = cloudflare.account.get_members(account_id="023e105f4ecef8ad9ca31a8372d0c353",
        direction="desc",
        order="status",
        status="accepted")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:account/members:getMembers', __args__, opts=opts, typ=GetMembersResult).value
...
def get_members_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:account/members:getMembers', __args__, opts=opts, typ=GetMembersResult)
