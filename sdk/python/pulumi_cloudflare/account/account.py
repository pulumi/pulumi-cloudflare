...
@pulumi.type_token("cloudflare:account/account:Account")
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/account:Account")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Account, __self__).__init__(
            'cloudflare:account/account:Account',
            resource_name,
            __props__,
            opts)
