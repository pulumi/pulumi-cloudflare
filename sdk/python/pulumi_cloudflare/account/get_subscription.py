...
class GetSubscriptionResult:
    ...
    def rate_plan(self) -> 'outputs.GetSubscriptionRatePlanResult':
        """
...
def get_subscription(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:account/subscription:getSubscription', __args__, opts=opts, typ=GetSubscriptionResult).value
...
def get_subscription_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:account/subscription:getSubscription', __args__, opts=opts, typ=GetSubscriptionResult)
