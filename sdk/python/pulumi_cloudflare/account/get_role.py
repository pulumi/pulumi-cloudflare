...
class GetRoleResult:
    ...
    @_builtins.property
    @pulumi.getter
    def permissions(self) -> 'outputs.GetRolePermissionsResult':
...
def get_role(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:account/role:getRole', __args__, opts=opts, typ=GetRoleResult).value
...
def get_role_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:account/role:getRole', __args__, opts=opts, typ=GetRoleResult)
