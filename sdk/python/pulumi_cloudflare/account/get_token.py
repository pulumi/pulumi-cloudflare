...
class GetTokenResult:
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> 'outputs.GetTokenConditionResult':
    ...
    @_builtins.property
    @pulumi.getter
    def policies(self) -> Sequence['outputs.GetTokenPolicyResult']:
        """
...
def get_token(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:account/token:getToken', __args__, opts=opts, typ=GetTokenResult).value
...
def get_token_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:account/token:getToken', __args__, opts=opts, typ=GetTokenResult)
