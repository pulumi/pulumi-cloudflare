...
class ConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ConfigConfigArgs'] config: The tunnel configuration and ingress rules.
...
@pulumi.type_token("cloudflare:zeroTrustTunnelCloudflared/config:Config")
class Config(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] account_id: Identifier.
        :param pulumi.Input[Union['ConfigConfigArgs', 'ConfigConfigArgsDict']] config: The tunnel configuration and ingress rules.
        :param pulumi.Input[_builtins.str] source: Indicates if this is a locally or remotely configured tunnel. If `local`, manage the tunnel using a YAML file on the origin machine. If `cloudflare`, manage the tunnel's configuration on the Zero Trust dashboard.
               Available values: "local", "cloudflare".
        :param pulumi.Input[_builtins.str] tunnel_id: UUID of the tunnel.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zeroTrustTunnelCloudflaredConfig:ZeroTrustTunnelCloudflaredConfig"), pulumi.Alias(type_="cloudflare:index/tunnelConfig:TunnelConfig")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Config, __self__).__init__(
            'cloudflare:zeroTrustTunnelCloudflared/config:Config',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            source: pulumi.Input[Optional[_builtins.str]] = None,
            tunnel_id: pulumi.Input[Optional[_builtins.str]] = None,
            version: pulumi.Input[Optional[_builtins.int]] = None) -> 'Config':
        """
