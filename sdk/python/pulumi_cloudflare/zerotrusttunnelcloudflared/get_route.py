...
class GetRouteResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetRouteFilterResult']:
...
def get_route(account_id: Optional[_builtins.str] = None,
              filter: Optional[Union['GetRouteFilterArgs', 'GetRouteFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustTunnelCloudflared/route:getRoute', __args__, opts=opts, typ=GetRouteResult).value
...
def get_route_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                     filter: pulumi.Input[Optional[Optional[Union['GetRouteFilterArgs', 'GetRouteFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustTunnelCloudflared/route:getRoute', __args__, opts=opts, typ=GetRouteResult)
