...
def get_token(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustTunnelCloudflared/token:getToken', __args__, opts=opts, typ=GetTokenResult).value
...
def get_token_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustTunnelCloudflared/token:getToken', __args__, opts=opts, typ=GetTokenResult)
