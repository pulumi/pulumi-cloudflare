...
class GetRoutesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetRoutesResultResult']:
        """
...
def get_routes(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustTunnelCloudflared/routes:getRoutes', __args__, opts=opts, typ=GetRoutesResult).value
...
def get_routes_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustTunnelCloudflared/routes:getRoutes', __args__, opts=opts, typ=GetRoutesResult)
