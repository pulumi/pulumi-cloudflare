...
@pulumi.type_token("cloudflare:pipeline/pipeline:Pipeline")
class Pipeline(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/pipeline:Pipeline")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Pipeline, __self__).__init__(
            'cloudflare:pipeline/pipeline:Pipeline',
            resource_name,
            __props__,
            opts)
