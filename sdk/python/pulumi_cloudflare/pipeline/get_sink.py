...
class GetSinkResult:
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> 'outputs.GetSinkConfigResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetSinkFilterResult']:
        return pulumi.get(self, "filter")

    @_builtins.property
    @pulumi.getter
    def format(self) -> 'outputs.GetSinkFormatResult':
    ...
    @_builtins.property
    @pulumi.getter
    def schema(self) -> 'outputs.GetSinkSchemaResult':
...
def get_sink(account_id: Optional[_builtins.str] = None,
             filter: Optional[Union['GetSinkFilterArgs', 'GetSinkFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pipeline/sink:getSink', __args__, opts=opts, typ=GetSinkResult).value
...
def get_sink_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                    filter: pulumi.Input[Optional[Optional[Union['GetSinkFilterArgs', 'GetSinkFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pipeline/sink:getSink', __args__, opts=opts, typ=GetSinkResult)
