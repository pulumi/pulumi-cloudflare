...
def get_pipeline(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pipeline/pipeline:getPipeline', __args__, opts=opts, typ=GetPipelineResult).value
...
def get_pipeline_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pipeline/pipeline:getPipeline', __args__, opts=opts, typ=GetPipelineResult)
