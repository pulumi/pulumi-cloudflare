...
class GetStreamResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetStreamFilterResult']:
        return pulumi.get(self, "filter")

    @_builtins.property
    @pulumi.getter
    def format(self) -> 'outputs.GetStreamFormatResult':
        return pulumi.get(self, "format")

    @_builtins.property
    @pulumi.getter
    def http(self) -> 'outputs.GetStreamHttpResult':
    ...
    @_builtins.property
    @pulumi.getter
    def schema(self) -> 'outputs.GetStreamSchemaResult':
    ...
    def worker_binding(self) -> 'outputs.GetStreamWorkerBindingResult':
...
def get_stream(account_id: Optional[_builtins.str] = None,
               filter: Optional[Union['GetStreamFilterArgs', 'GetStreamFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pipeline/stream:getStream', __args__, opts=opts, typ=GetStreamResult).value
...
def get_stream_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                      filter: pulumi.Input[Optional[Optional[Union['GetStreamFilterArgs', 'GetStreamFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pipeline/stream:getStream', __args__, opts=opts, typ=GetStreamResult)
