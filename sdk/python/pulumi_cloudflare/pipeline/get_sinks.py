...
class GetSinksResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetSinksResultResult']:
        """
...
def get_sinks(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pipeline/sinks:getSinks', __args__, opts=opts, typ=GetSinksResult).value
...
def get_sinks_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pipeline/sinks:getSinks', __args__, opts=opts, typ=GetSinksResult)
