...
def get_streams(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pipeline/streams:getStreams', __args__, opts=opts, typ=GetStreamsResult).value
...
def get_streams_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pipeline/streams:getStreams', __args__, opts=opts, typ=GetStreamsResult)
