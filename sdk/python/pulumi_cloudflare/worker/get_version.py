...
class GetVersionResult:
    ...
    @_builtins.property
    @pulumi.getter
    def annotations(self) -> 'outputs.GetVersionAnnotationsResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def assets(self) -> 'outputs.GetVersionAssetsResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def bindings(self) -> Sequence['outputs.GetVersionBindingResult']:
        return pulumi.get(self, "bindings")

    @_builtins.property
    @pulumi.getter(name="cacheOptions")
    def cache_options(self) -> 'outputs.GetVersionCacheOptionsResult':
    ...
    @_builtins.property
    @pulumi.getter
    def containers(self) -> Sequence['outputs.GetVersionContainerResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def exports(self) -> Mapping[str, 'outputs.GetVersionExportsResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def limits(self) -> 'outputs.GetVersionLimitsResult':
    ...
    @_builtins.property
    @pulumi.getter
    def migrations(self) -> 'outputs.GetVersionMigrationsResult':
        return pulumi.get(self, "migrations")

    @_builtins.property
    @pulumi.getter
    def modules(self) -> Sequence['outputs.GetVersionModuleResult']:
    ...
    def package_dependencies(self) -> Sequence['outputs.GetVersionPackageDependencyResult']:
        return pulumi.get(self, "package_dependencies")

    @_builtins.property
    @pulumi.getter
    def placement(self) -> 'outputs.GetVersionPlacementResult':
...
def get_version(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:worker/version:getVersion', __args__, opts=opts, typ=GetVersionResult).value
...
def get_version_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:worker/version:getVersion', __args__, opts=opts, typ=GetVersionResult)
