...
def get_worker(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:worker/worker:getWorker', __args__, opts=opts, typ=GetWorkerResult).value
...
def get_worker_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:worker/worker:getWorker', __args__, opts=opts, typ=GetWorkerResult)
