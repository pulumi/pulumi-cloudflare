...
class GetRuleResult:
    ...
    @_builtins.property
    @pulumi.getter
    def configuration(self) -> 'outputs.GetRuleConfigurationResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetRuleFilterResult']:
...
def get_rule(account_id: Optional[_builtins.str] = None,
             filter: Optional[Union['GetRuleFilterArgs', 'GetRuleFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:access/rule:getRule', __args__, opts=opts, typ=GetRuleResult).value
...
def get_rule_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                    filter: pulumi.Input[Optional[Optional[Union['GetRuleFilterArgs', 'GetRuleFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:access/rule:getRule', __args__, opts=opts, typ=GetRuleResult)
