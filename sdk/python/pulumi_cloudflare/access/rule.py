...
class RuleArgs:
    def __init__(__self__, *,
                 configuration: pulumi.Input['RuleConfigurationArgs'],
        ...
        :param pulumi.Input['RuleConfigurationArgs'] configuration: The rule configuration.
    ...
    @_builtins.property
    @pulumi.getter
    def configuration(self) -> pulumi.Input['RuleConfigurationArgs']:
        """
    ...
    def configuration(self, value: pulumi.Input['RuleConfigurationArgs']):
...
class _RuleState:
    def __init__(__self__, *,
                 ...
                 configuration: pulumi.Input[Optional['RuleConfigurationArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] notes: An informative summary of the rule, typically used as a reminder or explanation.
        :param pulumi.Input['RuleScopeArgs'] scope: All zones owned by the user will have the rule applied.
        :param pulumi.Input[_builtins.str] zone_id: The Zone ID to use for this endpoint. Mutually exclusive with the Account ID.
        """
        if account_id is not None:
            pulumi.set(__self__, "account_id", account_id)
    ...
    def allowed_modes(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def allowed_modes(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "allowed_modes", value)

    @_builtins.property
    @pulumi.getter
    def configuration(self) -> pulumi.Input[Optional['RuleConfigurationArgs']]:
        """
        The rule configuration.
        """
        return pulumi.get(self, "configuration")
    ...
    @configuration.setter
    def configuration(self, value: pulumi.Input[Optional['RuleConfigurationArgs']]):
        pulumi.set(self, "configuration", value)
...
@pulumi.type_token("cloudflare:access/rule:Rule")
class Rule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 account_id: pulumi.Input[Optional[_builtins.str]] = None,
                 configuration: pulumi.Input[Optional[Union['RuleConfigurationArgs', 'RuleConfigurationArgsDict']]] = None,
                 mode: pulumi.Input[Optional[_builtins.str]] = None,
                 notes: pulumi.Input[Optional[_builtins.str]] = None,
                 zone_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[_builtins.str] account_id: The Account ID to use for this endpoint. Mutually exclusive with the Zone ID.
        :param pulumi.Input[Union['RuleConfigurationArgs', 'RuleConfigurationArgsDict']] configuration: The rule configuration.
        :param pulumi.Input[_builtins.str] mode: The action to apply to a matched request.
               Available values: "block", "challenge", "whitelist", "js*challenge", "managed*challenge".
        :param pulumi.Input[_builtins.str] notes: An informative summary of the rule, typically used as a reminder or explanation.
        :param pulumi.Input[_builtins.str] zone_id: The Zone ID to use for this endpoint. Mutually exclusive with the Account ID.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/accessRule:AccessRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Rule, __self__).__init__(
            'cloudflare:access/rule:Rule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[_builtins.str] modified_on: The timestamp of when the rule was last modified.
        :param pulumi.Input[_builtins.str] notes: An informative summary of the rule, typically used as a reminder or explanation.
        :param pulumi.Input[Union['RuleScopeArgs', 'RuleScopeArgsDict']] scope: All zones owned by the user will have the rule applied.
        :param pulumi.Input[_builtins.str] zone_id: The Zone ID to use for this endpoint. Mutually exclusive with the Account ID.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def configuration(self) -> pulumi.Output['outputs.RuleConfiguration']:
        """
        The rule configuration.
        """
        return pulumi.get(self, "configuration")
