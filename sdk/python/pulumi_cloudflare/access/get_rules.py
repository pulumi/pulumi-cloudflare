...
class GetRulesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def configuration(self) -> Optional['outputs.GetRulesConfigurationResult']:
...
def get_rules(account_id: Optional[_builtins.str] = None,
              configuration: Optional[Union['GetRulesConfigurationArgs', 'GetRulesConfigurationArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:access/rules:getRules', __args__, opts=opts, typ=GetRulesResult).value
...
def get_rules_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                     configuration: pulumi.Input[Optional[Optional[Union['GetRulesConfigurationArgs', 'GetRulesConfigurationArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:access/rules:getRules', __args__, opts=opts, typ=GetRulesResult)
