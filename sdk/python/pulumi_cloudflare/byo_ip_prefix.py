...
class ByoIpPrefixArgs:
    def __init__(__self__, *,
                 ...
                 prefix_id: pulumi.Input[builtins.str],
                 advertisement: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] prefix_id: The assigned Bring-Your-Own-IP prefix ID. **Modifying this attribute will force creation of a new resource.**
        :param pulumi.Input[builtins.str] advertisement: Whether or not the prefix shall be announced. A prefix can be activated or deactivated once every 15 minutes (attempting more regular updates will trigger rate limiting). Available values: `on`, `off`.
        :param pulumi.Input[builtins.str] description: Description of the BYO IP prefix.
        """
    ...
    def prefix_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @prefix_id.setter
    def prefix_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "prefix_id", value)

    @property
    @pulumi.getter
    def advertisement(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def advertisement(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ByoIpPrefixState:
    def __init__(__self__, *,
                 ...
                 advertisement: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 prefix_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="prefixId")
    def prefix_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The assigned Bring-Your-Own-IP prefix ID. **Modifying this attribute will force creation of a new resource.**
        """
        return pulumi.get(self, "prefix_id")
    ...
    @prefix_id.setter
    def prefix_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "prefix_id", value)
...
class ByoIpPrefix(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            advertisement: Optional[pulumi.Input[builtins.str]] = None,
            description: Optional[pulumi.Input[builtins.str]] = None,
            prefix_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ByoIpPrefix':
        """
    ...
    @property
    @pulumi.getter
    def advertisement(self) -> pulumi.Output[builtins.str]:
        """
        Whether or not the prefix shall be announced. A prefix can be activated or deactivated once every 15 minutes (attempting more regular updates will trigger rate limiting). Available values: `on`, `off`.
        """
        return pulumi.get(self, "advertisement")
    ...
    @property
    @pulumi.getter(name="prefixId")
    def prefix_id(self) -> pulumi.Output[builtins.str]:
        """
        The assigned Bring-Your-Own-IP prefix ID. **Modifying this attribute will force creation of a new resource.**
        """
        return pulumi.get(self, "prefix_id")
