...
@pulumi.type_token("cloudflare:registrar/domain:Domain")
class Domain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/registrarDomain:RegistrarDomain")])
    ...
    def get(resource_name: str,
            ...
            domain_name: pulumi.Input[Optional[_builtins.str]] = None,
            locked: pulumi.Input[Optional[_builtins.bool]] = None,
            privacy: pulumi.Input[Optional[_builtins.bool]] = None) -> 'Domain':
        """
