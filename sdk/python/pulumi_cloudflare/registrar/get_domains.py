...
def get_domains(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:registrar/domains:getDomains', __args__, opts=opts, typ=GetDomainsResult).value
...
def get_domains_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:registrar/domains:getDomains', __args__, opts=opts, typ=GetDomainsResult)
