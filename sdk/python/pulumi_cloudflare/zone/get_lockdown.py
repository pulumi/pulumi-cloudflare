...
__all__ = [
    'GetLockdownResult',
    'AwaitableGetLockdownResult',
    'get_lockdown',
    'get_lockdown_output',
]

@pulumi.output_type
class GetLockdownResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def configurations(self) -> Sequence['outputs.GetLockdownConfigurationResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetLockdownFilterResult']:
...
class AwaitableGetLockdownResult(GetLockdownResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLockdownResult(
...
def get_lockdown(filter: Optional[Union['GetLockdownFilterArgs', 'GetLockdownFilterArgsDict']] = None,
                 lock_downs_id: Optional[_builtins.str] = None,
                 zone_id: Optional[_builtins.str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLockdownResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zone/lockdown:getLockdown', __args__, opts=opts, typ=GetLockdownResult).value

    return AwaitableGetLockdownResult(
...
def get_lockdown_output(filter: pulumi.Input[Optional[Optional[Union['GetLockdownFilterArgs', 'GetLockdownFilterArgsDict']]]] = None,
                        lock_downs_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                        zone_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLockdownResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zone/lockdown:getLockdown', __args__, opts=opts, typ=GetLockdownResult)
    return __ret__.apply(lambda __response__: GetLockdownResult(
