...
class GetDnsSettingsResult:
    ...
    def internal_dns(self) -> 'outputs.GetDnsSettingsInternalDnsResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def nameservers(self) -> 'outputs.GetDnsSettingsNameserversResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def soa(self) -> 'outputs.GetDnsSettingsSoaResult':
        """
...
def get_dns_settings(zone_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zone/dnsSettings:getDnsSettings', __args__, opts=opts, typ=GetDnsSettingsResult).value
...
def get_dns_settings_output(zone_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zone/dnsSettings:getDnsSettings', __args__, opts=opts, typ=GetDnsSettingsResult)
