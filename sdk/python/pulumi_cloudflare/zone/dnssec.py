...
@pulumi.type_token("cloudflare:zone/dnssec:Dnssec")
class Dnssec(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zoneDnssec:ZoneDnssec")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Dnssec, __self__).__init__(
            'cloudflare:zone/dnssec:Dnssec',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            public_key: pulumi.Input[Optional[_builtins.str]] = None,
            status: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Dnssec':
        """
