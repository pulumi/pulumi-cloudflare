...
@pulumi.type_token("cloudflare:zone/setting:Setting")
class Setting(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
        $ pulumi import cloudflare:zone/setting:Setting example '<zone_id>/<setting_id>'
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zoneSetting:ZoneSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Setting, __self__).__init__(
            'cloudflare:zone/setting:Setting',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            time_remaining: pulumi.Input[Optional[_builtins.float]] = None,
            value: Optional[Any] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Setting':
        """
