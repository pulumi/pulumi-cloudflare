...
__all__ = [
    'GetLockdownsResult',
    'AwaitableGetLockdownsResult',
    'get_lockdowns',
    'get_lockdowns_output',
]

@pulumi.output_type
class GetLockdownsResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetLockdownsResultResult']:
        """
...
class AwaitableGetLockdownsResult(GetLockdownsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLockdownsResult(
...
def get_lockdowns(created_on: Optional[_builtins.str] = None,
                  ...
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLockdownsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zone/lockdowns:getLockdowns', __args__, opts=opts, typ=GetLockdownsResult).value

    return AwaitableGetLockdownsResult(
...
def get_lockdowns_output(created_on: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                         ...
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLockdownsResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zone/lockdowns:getLockdowns', __args__, opts=opts, typ=GetLockdownsResult)
    return __ret__.apply(lambda __response__: GetLockdownsResult(
