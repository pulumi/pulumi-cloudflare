...
def get_subscription(zone_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zone/subscription:getSubscription', __args__, opts=opts, typ=GetSubscriptionResult).value
...
def get_subscription_output(zone_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zone/subscription:getSubscription', __args__, opts=opts, typ=GetSubscriptionResult)
