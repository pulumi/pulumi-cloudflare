...
@pulumi.type_token("cloudflare:zone/zone:Zone")
class Zone(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zone:Zone")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Zone, __self__).__init__(
            'cloudflare:zone/zone:Zone',
            resource_name,
            __props__,
            opts)
