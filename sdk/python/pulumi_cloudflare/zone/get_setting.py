...
def get_setting(setting_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zone/setting:getSetting', __args__, opts=opts, typ=GetSettingResult).value
...
def get_setting_output(setting_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zone/setting:getSetting', __args__, opts=opts, typ=GetSettingResult)
