...
__all__ = ['LockdownArgs', 'Lockdown']

@pulumi.input_type
class LockdownArgs:
    def __init__(__self__, *,
                 configurations: pulumi.Input[Sequence[pulumi.Input['LockdownConfigurationArgs']]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['LockdownConfigurationArgs']]] configurations: A list of IP addresses or CIDR ranges that will be allowed to access the URLs specified in the Zone Lockdown rule. You can include any number of `ip` or `ip_range` configurations.
    ...
    @_builtins.property
    @pulumi.getter
    def configurations(self) -> pulumi.Input[Sequence[pulumi.Input['LockdownConfigurationArgs']]]:
        """
    ...
    def configurations(self, value: pulumi.Input[Sequence[pulumi.Input['LockdownConfigurationArgs']]]):
...
@pulumi.input_type
class _LockdownState:
    def __init__(__self__, *,
                 configurations: pulumi.Input[Optional[Sequence[pulumi.Input['LockdownConfigurationArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def configurations(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['LockdownConfigurationArgs']]]]:
        """
        A list of IP addresses or CIDR ranges that will be allowed to access the URLs specified in the Zone Lockdown rule. You can include any number of `ip` or `ip_range` configurations.
        """
        return pulumi.get(self, "configurations")
    ...
    @configurations.setter
    def configurations(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['LockdownConfigurationArgs']]]]):
        pulumi.set(self, "configurations", value)
...
@pulumi.type_token("cloudflare:zone/lockdown:Lockdown")
class Lockdown(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 configurations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['LockdownConfigurationArgs', 'LockdownConfigurationArgsDict']]]]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 paused: pulumi.Input[Optional[_builtins.bool]] = None,
                 priority: pulumi.Input[Optional[_builtins.float]] = None,
                 urls: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['LockdownConfigurationArgs', 'LockdownConfigurationArgsDict']]]] configurations: A list of IP addresses or CIDR ranges that will be allowed to access the URLs specified in the Zone Lockdown rule. You can include any number of `ip` or `ip_range` configurations.
        :param pulumi.Input[_builtins.str] description: An informative summary of the rule. This value is sanitized and any tags will be removed.
        :param pulumi.Input[_builtins.bool] paused: When true, indicates that the rule is currently paused.
        :param pulumi.Input[_builtins.float] priority: The priority of the rule to control the processing order. A lower number indicates higher priority. If not provided, any rules with a configured priority will be processed before rules without a priority.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] urls: The URLs to include in the current WAF override. You can use wildcards. Each entered URL will be escaped before use, which means you can only use simple wildcard patterns.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param LockdownArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LockdownArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LockdownArgs.__new__(LockdownArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zoneLockdown:ZoneLockdown")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Lockdown, __self__).__init__(
            'cloudflare:zone/lockdown:Lockdown',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            priority: pulumi.Input[Optional[_builtins.float]] = None,
            urls: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Lockdown':
        """
        ...
        __props__ = _LockdownState.__new__(_LockdownState)
        ...
        __props__.__dict__["urls"] = urls
        __props__.__dict__["zone_id"] = zone_id
        return Lockdown(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter
    def configurations(self) -> pulumi.Output[Sequence['outputs.LockdownConfiguration']]:
        """
        A list of IP addresses or CIDR ranges that will be allowed to access the URLs specified in the Zone Lockdown rule. You can include any number of `ip` or `ip_range` configurations.
        """
        return pulumi.get(self, "configurations")
