...
def get_dnssec(zone_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zone/dnssec:getDnssec', __args__, opts=opts, typ=GetDnssecResult).value
...
def get_dnssec_output(zone_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zone/dnssec:getDnssec', __args__, opts=opts, typ=GetDnssecResult)
