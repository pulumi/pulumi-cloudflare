...
def get_zone(filter: Optional[Union['GetZoneFilterArgs', 'GetZoneFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zone/zone:getZone', __args__, opts=opts, typ=GetZoneResult).value
...
def get_zone_output(filter: pulumi.Input[Optional[Optional[Union['GetZoneFilterArgs', 'GetZoneFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zone/zone:getZone', __args__, opts=opts, typ=GetZoneResult)
