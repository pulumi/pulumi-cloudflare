...
def get_snippets(snippet_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:snippets/snippets:getSnippets', __args__, opts=opts, typ=GetSnippetsResult).value
...
def get_snippets_output(snippet_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:snippets/snippets:getSnippets', __args__, opts=opts, typ=GetSnippetsResult)
