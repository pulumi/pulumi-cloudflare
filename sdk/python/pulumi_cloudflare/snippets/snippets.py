...
@pulumi.type_token("cloudflare:snippets/snippets:Snippets")
class Snippets(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/snippets:Snippets")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Snippets, __self__).__init__(
            'cloudflare:snippets/snippets:Snippets',
            resource_name,
            __props__,
            opts)
