...
def get_record(content: Optional[builtins.str] = None,
    ...
    :param builtins.str content: Content to filter record results on.
    :param builtins.str hostname: Hostname to filter DNS record results on.
    :param builtins.int priority: DNS priority to filter record results on.
    :param builtins.str type: DNS record type to filter record results on. Defaults to `A`.
...
def get_record_output(content: Optional[pulumi.Input[Optional[builtins.str]]] = None,
