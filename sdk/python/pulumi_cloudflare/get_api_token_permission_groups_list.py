...
def get_api_token_permission_groups_list(max_items: Optional[int] = None,
...
def get_api_token_permission_groups_list_output(max_items: Optional[pulumi.Input[Optional[int]]] = None,
