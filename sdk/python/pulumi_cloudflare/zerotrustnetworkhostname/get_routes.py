...
def get_routes(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustNetworkHostname/routes:getRoutes', __args__, opts=opts, typ=GetRoutesResult).value
...
def get_routes_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustNetworkHostname/routes:getRoutes', __args__, opts=opts, typ=GetRoutesResult)
