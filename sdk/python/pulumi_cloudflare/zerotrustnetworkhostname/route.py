...
@pulumi.type_token("cloudflare:zeroTrustNetworkHostname/route:Route")
class Route(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zeroTrustNetworkHostnameRoute:ZeroTrustNetworkHostnameRoute")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Route, __self__).__init__(
            'cloudflare:zeroTrustNetworkHostname/route:Route',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            tun_type: pulumi.Input[Optional[_builtins.str]] = None,
            tunnel_id: pulumi.Input[Optional[_builtins.str]] = None,
            tunnel_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'Route':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="tunnelId")
    def tunnel_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        UUID of the tunnel.
        """
        return pulumi.get(self, "tunnel_id")
