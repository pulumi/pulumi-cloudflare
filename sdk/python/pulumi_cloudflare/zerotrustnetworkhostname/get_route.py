...
def get_route(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustNetworkHostname/route:getRoute', __args__, opts=opts, typ=GetRouteResult).value
...
def get_route_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustNetworkHostname/route:getRoute', __args__, opts=opts, typ=GetRouteResult)
