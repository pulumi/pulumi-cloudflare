...
class GetFirewallResult:
    ...
    def attack_mitigation(self) -> 'outputs.GetFirewallAttackMitigationResult':
        """
...
def get_firewall(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:dns/firewall:getFirewall', __args__, opts=opts, typ=GetFirewallResult).value
...
def get_firewall_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                        dns_firewall_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:dns/firewall:getFirewall', __args__, opts=opts, typ=GetFirewallResult)
