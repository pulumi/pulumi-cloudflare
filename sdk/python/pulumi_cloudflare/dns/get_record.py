...
class GetRecordResult:
    ...
    @_builtins.property
    @pulumi.getter
    def data(self) -> 'outputs.GetRecordDataResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetRecordFilterResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def meta(self) -> 'outputs.GetRecordMetaResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def settings(self) -> 'outputs.GetRecordSettingsResult':
        """
...
def get_record(dns_record_id: Optional[_builtins.str] = None,
               filter: Optional[Union['GetRecordFilterArgs', 'GetRecordFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:dns/record:getRecord', __args__, opts=opts, typ=GetRecordResult).value
...
def get_record_output(dns_record_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                      filter: pulumi.Input[Optional[Optional[Union['GetRecordFilterArgs', 'GetRecordFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:dns/record:getRecord', __args__, opts=opts, typ=GetRecordResult)
