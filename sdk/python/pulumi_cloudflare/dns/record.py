...
@pulumi.type_token("cloudflare:dns/record:Record")
class Record(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/record:Record"), pulumi.Alias(type_="cloudflare:index/dnsRecord:DnsRecord")])
