...
class FirewallArgs:
    def __init__(__self__, *,
                 ...
                 attack_mitigation: pulumi.Input[Optional['FirewallAttackMitigationArgs']] = None,
        ...
        :param pulumi.Input['FirewallAttackMitigationArgs'] attack_mitigation: Attack mitigation settings
    ...
    def attack_mitigation(self) -> pulumi.Input[Optional['FirewallAttackMitigationArgs']]:
        """
    ...
    def attack_mitigation(self, value: pulumi.Input[Optional['FirewallAttackMitigationArgs']]):
...
@pulumi.type_token("cloudflare:dns/firewall:Firewall")
class Firewall(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 account_id: pulumi.Input[Optional[_builtins.str]] = None,
                 attack_mitigation: pulumi.Input[Optional[Union['FirewallAttackMitigationArgs', 'FirewallAttackMitigationArgsDict']]] = None,
                 deprecate_any_requests: pulumi.Input[Optional[_builtins.bool]] = None,
                 dns_firewall_ip_count: pulumi.Input[Optional[_builtins.int]] = None,
                 ecs_fallback: pulumi.Input[Optional[_builtins.bool]] = None,
                 maximum_cache_ttl: pulumi.Input[Optional[_builtins.float]] = None,
        ...
        :param pulumi.Input[_builtins.str] account_id: Identifier.
        :param pulumi.Input[Union['FirewallAttackMitigationArgs', 'FirewallAttackMitigationArgsDict']] attack_mitigation: Attack mitigation settings
        :param pulumi.Input[_builtins.bool] deprecate_any_requests: Whether to refuse to answer queries for the ANY type
        :param pulumi.Input[_builtins.int] dns_firewall_ip_count: Number of IPv4 addresses to assign to the DNS Firewall cluster. Only used during cluster creation and cannot be changed later.
        :param pulumi.Input[_builtins.bool] ecs_fallback: Whether to forward client IP (resolver) subnet if no EDNS Client Subnet is sent
        :param pulumi.Input[_builtins.float] maximum_cache_ttl: By default, Cloudflare attempts to cache responses for as long as
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/dnsFirewall:DnsFirewall")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Firewall, __self__).__init__(
            'cloudflare:dns/firewall:Firewall',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            ratelimit: pulumi.Input[Optional[_builtins.float]] = None,
            retries: pulumi.Input[Optional[_builtins.float]] = None,
            upstream_ips: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'Firewall':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="attackMitigation")
    def attack_mitigation(self) -> pulumi.Output['outputs.FirewallAttackMitigation']:
        """
        Attack mitigation settings
        """
        return pulumi.get(self, "attack_mitigation")
