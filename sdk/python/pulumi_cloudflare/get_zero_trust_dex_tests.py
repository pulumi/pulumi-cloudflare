...
def get_zero_trust_dex_tests(account_id: Optional[builtins.str] = None,
...
def get_zero_trust_dex_tests_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
