...
def get_dns_settings_internal_view(account_id: Optional[str] = None,
    ...
    example_dns_settings_internal_view = cloudflare.get_dns_settings_internal_view(account_id="023e105f4ecef8ad9ca31a8372d0c353",
        view_id="023e105f4ecef8ad9ca31a8372d0c353")
    ```


    :param str account_id: Identifier
    :param str view_id: Identifier
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getDnsSettingsInternalView:getDnsSettingsInternalView', __args__, opts=opts, typ=GetDnsSettingsInternalViewResult).value
...
def get_dns_settings_internal_view_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getDnsSettingsInternalView:getDnsSettingsInternalView', __args__, opts=opts, typ=GetDnsSettingsInternalViewResult)
