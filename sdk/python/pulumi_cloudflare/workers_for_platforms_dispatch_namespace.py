...
class WorkersForPlatformsDispatchNamespaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the Workers for Platforms namespace.
        """
...
class WorkersForPlatformsDispatchNamespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            account_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkersForPlatformsDispatchNamespace':
        """
