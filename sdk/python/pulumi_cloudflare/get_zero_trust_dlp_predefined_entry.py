...
__all__ = [
    'GetZeroTrustDlpPredefinedEntryResult',
    'AwaitableGetZeroTrustDlpPredefinedEntryResult',
    'get_zero_trust_dlp_predefined_entry',
    'get_zero_trust_dlp_predefined_entry_output',
]

warnings.warn("""cloudflare:index/getZeroTrustDlpPredefinedEntry:getZeroTrustDlpPredefinedEntry has been deprecated in favor of cloudflare:zeroTrustDlpPredefined/entry:getEntry""", DeprecationWarning)
...
class GetZeroTrustDlpPredefinedEntryResult:
    ...
    @_builtins.property
    @pulumi.getter
    def confidence(self) -> 'outputs.GetZeroTrustDlpPredefinedEntryConfidenceResult':
    ...
    @_builtins.property
    @pulumi.getter
    def pattern(self) -> 'outputs.GetZeroTrustDlpPredefinedEntryPatternResult':
    ...
    @_builtins.property
    @pulumi.getter
    def profiles(self) -> Sequence['outputs.GetZeroTrustDlpPredefinedEntryProfileResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def variant(self) -> 'outputs.GetZeroTrustDlpPredefinedEntryVariantResult':
        """
...
class AwaitableGetZeroTrustDlpPredefinedEntryResult(GetZeroTrustDlpPredefinedEntryResult):
...
def get_zero_trust_dlp_predefined_entry(account_id: Optional[_builtins.str] = None,
                                        entry_id: Optional[_builtins.str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetZeroTrustDlpPredefinedEntryResult:
    """
    ...
    example_zero_trust_dlp_predefined_entry = cloudflare.zerotrustdlppredefined.get_entry(account_id="account_id",
        entry_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ```
    """
    pulumi.log.warn("""get_zero_trust_dlp_predefined_entry is deprecated: cloudflare:index/getZeroTrustDlpPredefinedEntry:getZeroTrustDlpPredefinedEntry has been deprecated in favor of cloudflare:zeroTrustDlpPredefined/entry:getEntry""")
    __args__ = dict()
    __args__['accountId'] = account_id
    __args__['entryId'] = entry_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustDlpPredefinedEntry:getZeroTrustDlpPredefinedEntry', __args__, opts=opts, typ=GetZeroTrustDlpPredefinedEntryResult).value

    return AwaitableGetZeroTrustDlpPredefinedEntryResult(
...
def get_zero_trust_dlp_predefined_entry_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustDlpPredefinedEntry:getZeroTrustDlpPredefinedEntry', __args__, opts=opts, typ=GetZeroTrustDlpPredefinedEntryResult)
    return __ret__.apply(lambda __response__: GetZeroTrustDlpPredefinedEntryResult(
