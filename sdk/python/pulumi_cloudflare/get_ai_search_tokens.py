...
__all__ = [
    ...
    'AwaitableGetAiSearchTokensResult',
    'get_ai_search_tokens',
...
class GetAiSearchTokensResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetAiSearchTokensResultResult']:
        """
...
class AwaitableGetAiSearchTokensResult(GetAiSearchTokensResult):
...
def get_ai_search_tokens(account_id: Optional[_builtins.str] = None,
                         max_items: Optional[_builtins.int] = None,
                         search: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAiSearchTokensResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getAiSearchTokens:getAiSearchTokens', __args__, opts=opts, typ=GetAiSearchTokensResult).value
...
def get_ai_search_tokens_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                max_items: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                search: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAiSearchTokensResult]:
    """
    Use this data source to access information about an existing resource.
