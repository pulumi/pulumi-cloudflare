...
def get_zero_trust_access_groups(account_id: Optional[builtins.str] = None,
...
def get_zero_trust_access_groups_output(account_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
