...
def get_hostname_tls_setting(setting_id: Optional[builtins.str] = None,
...
def get_hostname_tls_setting_output(setting_id: Optional[pulumi.Input[builtins.str]] = None,
