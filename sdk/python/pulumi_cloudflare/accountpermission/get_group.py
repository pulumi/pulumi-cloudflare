...
class GetGroupResult:
    ...
    @_builtins.property
    @pulumi.getter
    def meta(self) -> 'outputs.GetGroupMetaResult':
        """
...
def get_group(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:accountPermission/group:getGroup', __args__, opts=opts, typ=GetGroupResult).value
...
def get_group_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:accountPermission/group:getGroup', __args__, opts=opts, typ=GetGroupResult)
