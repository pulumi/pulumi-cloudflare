...
class ZeroTrustDeviceCertificatesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: `true` if certificate generation is enabled.
...
class ZeroTrustDeviceCertificates(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            enabled: Optional[pulumi.Input[builtins.bool]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ZeroTrustDeviceCertificates':
        """
