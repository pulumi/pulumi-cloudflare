...
class GetProviderResult:
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> 'outputs.GetProviderConfigResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetProviderFilterResult']:
    ...
    def saml_certificate_set(self) -> 'outputs.GetProviderSamlCertificateSetResult':
        """
    ...
    def scim_config(self) -> 'outputs.GetProviderScimConfigResult':
        """
...
def get_provider(account_id: Optional[_builtins.str] = None,
                 filter: Optional[Union['GetProviderFilterArgs', 'GetProviderFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustAccessIdentity/provider:getProvider', __args__, opts=opts, typ=GetProviderResult).value
...
def get_provider_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                        filter: pulumi.Input[Optional[Optional[Union['GetProviderFilterArgs', 'GetProviderFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustAccessIdentity/provider:getProvider', __args__, opts=opts, typ=GetProviderResult)
