...
def get_domain(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pages/domain:getDomain', __args__, opts=opts, typ=GetDomainResult).value
...
def get_domain_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pages/domain:getDomain', __args__, opts=opts, typ=GetDomainResult)
