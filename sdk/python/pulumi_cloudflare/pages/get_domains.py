...
class GetDomainsResult:
    ...
    """
    def __init__(__self__, account_id=None, max_items=None, project_name=None, results=None):
...
def get_domains(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pages/domains:getDomains', __args__, opts=opts, typ=GetDomainsResult).value
...
def get_domains_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pages/domains:getDomains', __args__, opts=opts, typ=GetDomainsResult)
