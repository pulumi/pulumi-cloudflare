...
def get_certificates(limit: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:client/certificates:getCertificates', __args__, opts=opts, typ=GetCertificatesResult).value
...
def get_certificates_output(limit: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:client/certificates:getCertificates', __args__, opts=opts, typ=GetCertificatesResult)
