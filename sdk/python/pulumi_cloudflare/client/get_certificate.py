...
class GetCertificateResult:
    ...
    def certificate_authority(self) -> 'outputs.GetCertificateCertificateAuthorityResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetCertificateFilterResult']:
...
def get_certificate(client_certificate_id: Optional[_builtins.str] = None,
                    filter: Optional[Union['GetCertificateFilterArgs', 'GetCertificateFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:client/certificate:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
...
def get_certificate_output(client_certificate_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                           filter: pulumi.Input[Optional[Optional[Union['GetCertificateFilterArgs', 'GetCertificateFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:client/certificate:getCertificate', __args__, opts=opts, typ=GetCertificateResult)
