...
class _CertificateState:
    def __init__(__self__, *,
                 ...
                 certificate_authority: pulumi.Input[Optional['CertificateCertificateAuthorityArgs']] = None,
        ...
        :param pulumi.Input['CertificateCertificateAuthorityArgs'] certificate_authority: Certificate Authority used to issue the Client Certificate.
    ...
    def certificate_authority(self) -> pulumi.Input[Optional['CertificateCertificateAuthorityArgs']]:
        """
    ...
    def certificate_authority(self, value: pulumi.Input[Optional['CertificateCertificateAuthorityArgs']]):
...
@pulumi.type_token("cloudflare:client/certificate:Certificate")
class Certificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/clientCertificate:ClientCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Certificate, __self__).__init__(
            'cloudflare:client/certificate:Certificate',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            certificate: pulumi.Input[Optional[_builtins.str]] = None,
            certificate_authority: pulumi.Input[Optional[Union['CertificateCertificateAuthorityArgs', 'CertificateCertificateAuthorityArgsDict']]] = None,
            common_name: pulumi.Input[Optional[_builtins.str]] = None,
            country: pulumi.Input[Optional[_builtins.str]] = None,
            csr: pulumi.Input[Optional[_builtins.str]] = None,
            expires_on: pulumi.Input[Optional[_builtins.str]] = None,
            ...
            status: pulumi.Input[Optional[_builtins.str]] = None,
            validity_days: pulumi.Input[Optional[_builtins.int]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Certificate':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.str] certificate: The Client Certificate PEM.
        :param pulumi.Input[Union['CertificateCertificateAuthorityArgs', 'CertificateCertificateAuthorityArgsDict']] certificate_authority: Certificate Authority used to issue the Client Certificate.
        :param pulumi.Input[_builtins.str] common_name: Common Name of the Client Certificate.
        :param pulumi.Input[_builtins.str] country: Country, provided by the CSR.
        :param pulumi.Input[_builtins.str] csr: The Certificate Signing Request (CSR). Must be newline-encoded.
        :param pulumi.Input[_builtins.str] expires_on: Date that the Client Certificate expires.
    ...
    @_builtins.property
    @pulumi.getter(name="certificateAuthority")
    def certificate_authority(self) -> pulumi.Output['outputs.CertificateCertificateAuthority']:
        """
        Certificate Authority used to issue the Client Certificate.
        """
        return pulumi.get(self, "certificate_authority")
