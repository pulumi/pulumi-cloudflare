...
class DnsZoneTransfersIncomingArgs:
    def __init__(__self__, *,
                 auto_refresh_seconds: pulumi.Input[builtins.float],
        ...
        :param pulumi.Input[builtins.float] auto_refresh_seconds: How often should a secondary zone auto refresh regardless of DNS NOTIFY.
    ...
    def auto_refresh_seconds(self) -> pulumi.Input[builtins.float]:
        """
    ...
    def auto_refresh_seconds(self, value: pulumi.Input[builtins.float]):
...
class _DnsZoneTransfersIncomingState:
    def __init__(__self__, *,
                 auto_refresh_seconds: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.str] modified_time: The time for a specific event.
        :param pulumi.Input[builtins.str] name: Zone name.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] peers: A list of peer tags.
    ...
    @property
    @pulumi.getter(name="autoRefreshSeconds")
    def auto_refresh_seconds(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        How often should a secondary zone auto refresh regardless of DNS NOTIFY.
        Not applicable for primary zones.
        """
    ...
    @auto_refresh_seconds.setter
    def auto_refresh_seconds(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "auto_refresh_seconds", value)
...
class DnsZoneTransfersIncoming(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            peers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            soa_serial: Optional[pulumi.Input[builtins.float]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DnsZoneTransfersIncoming':
        """
    ...
    @property
    @pulumi.getter(name="autoRefreshSeconds")
    def auto_refresh_seconds(self) -> pulumi.Output[builtins.float]:
        """
        How often should a secondary zone auto refresh regardless of DNS NOTIFY.
        Not applicable for primary zones.
        """
