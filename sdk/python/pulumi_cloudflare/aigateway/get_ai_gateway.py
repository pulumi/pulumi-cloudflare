...
def get_ai_gateway(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:aiGateway/aiGateway:getAiGateway', __args__, opts=opts, typ=GetAiGatewayResult).value
...
def get_ai_gateway_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:aiGateway/aiGateway:getAiGateway', __args__, opts=opts, typ=GetAiGatewayResult)
