...
def get_api_shield_operation(feature: Optional[Sequence[str]] = None,
    ...
    :param Sequence[str] feature: Add feature(s) to the results. The feature name that is given here corresponds to the resulting feature object. Have a look at the top-level object description for more details on the specific meaning.
