...
@pulumi.type_token("cloudflare:zeroTrustDlp/entry:Entry")
class Entry(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zeroTrustDlpEntry:ZeroTrustDlpEntry")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Entry, __self__).__init__(
            'cloudflare:zeroTrustDlp/entry:Entry',
            resource_name,
            __props__,
            opts)
