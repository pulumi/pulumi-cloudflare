...
class GetDatasetResult:
    ...
    @_builtins.property
    @pulumi.getter
    def columns(self) -> Sequence['outputs.GetDatasetColumnResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def uploads(self) -> Sequence['outputs.GetDatasetUploadResult']:
...
def get_dataset(account_id: Optional[_builtins.str] = None,
    ...
    example_zero_trust_dlp_dataset = cloudflare.zerotrustdlp.get_dataset(account_id="account_id",
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDlp/dataset:getDataset', __args__, opts=opts, typ=GetDatasetResult).value
...
def get_dataset_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDlp/dataset:getDataset', __args__, opts=opts, typ=GetDatasetResult)
