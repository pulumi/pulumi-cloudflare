...
def get_entry(account_id: Optional[_builtins.str] = None,
    ...
    example_zero_trust_dlp_entry = cloudflare.zerotrustdlp.get_entry(account_id="account_id",
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDlp/entry:getEntry', __args__, opts=opts, typ=GetEntryResult).value
...
def get_entry_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDlp/entry:getEntry', __args__, opts=opts, typ=GetEntryResult)
