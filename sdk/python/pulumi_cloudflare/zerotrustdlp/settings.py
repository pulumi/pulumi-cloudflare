...
class SettingsArgs:
    def __init__(__self__, *,
                 ...
                 payload_logging: pulumi.Input[Optional['SettingsPayloadLoggingArgs']] = None):
        """
        ...
        :param pulumi.Input['SettingsPayloadLoggingArgs'] payload_logging: Request model for payload log settings within the DLP settings endpoint.
    ...
    def payload_logging(self) -> pulumi.Input[Optional['SettingsPayloadLoggingArgs']]:
        """
    ...
    def payload_logging(self, value: pulumi.Input[Optional['SettingsPayloadLoggingArgs']]):
...
@pulumi.type_token("cloudflare:zeroTrustDlp/settings:Settings")
class Settings(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ai_context_analysis: pulumi.Input[Optional[_builtins.bool]] = None,
                 ocr: pulumi.Input[Optional[_builtins.bool]] = None,
                 payload_logging: pulumi.Input[Optional[Union['SettingsPayloadLoggingArgs', 'SettingsPayloadLoggingArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.bool] ai_context_analysis: Whether AI context analysis is enabled at the account level.
        :param pulumi.Input[_builtins.bool] ocr: Whether OCR is enabled at the account level.
        :param pulumi.Input[Union['SettingsPayloadLoggingArgs', 'SettingsPayloadLoggingArgsDict']] payload_logging: Request model for payload log settings within the DLP settings endpoint.
               Unlike the legacy endpoint, null and missing are treated identically here
               (both mean "not provided" for PATCH, "reset to default" for PUT).
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zeroTrustDlpSettings:ZeroTrustDlpSettings")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Settings, __self__).__init__(
            'cloudflare:zeroTrustDlp/settings:Settings',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            ai_context_analysis: pulumi.Input[Optional[_builtins.bool]] = None,
            ocr: pulumi.Input[Optional[_builtins.bool]] = None,
            payload_logging: pulumi.Input[Optional[Union['SettingsPayloadLoggingArgs', 'SettingsPayloadLoggingArgsDict']]] = None) -> 'Settings':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="payloadLogging")
    def payload_logging(self) -> pulumi.Output['outputs.SettingsPayloadLogging']:
        """
        Request model for payload log settings within the DLP settings endpoint.
        Unlike the legacy endpoint, null and missing are treated identically here
        (both mean "not provided" for PATCH, "reset to default" for PUT).
