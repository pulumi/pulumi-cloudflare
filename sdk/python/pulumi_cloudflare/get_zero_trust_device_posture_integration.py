...
def get_zero_trust_device_posture_integration(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str integration_id: API UUID.
    """
    __args__ = dict()
...
def get_zero_trust_device_posture_integration_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
