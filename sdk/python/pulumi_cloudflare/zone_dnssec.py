...
class ZoneDnssecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] dnssec_presigned: If true, allows Cloudflare to transfer in a DNSSEC-signed zone including signatures from an external provider, without
               ...
               details.
        :param pulumi.Input[_builtins.bool] dnssec_use_nsec3: If true, enables the use of NSEC3 together with DNSSEC on the zone. Combined with setting dnssec_presigned to true, this
        ...
        :param pulumi.Input[_builtins.str] status: Status of DNSSEC, based on user-desired state and presence of necessary records. Available values: "active", "disabled".
        """
