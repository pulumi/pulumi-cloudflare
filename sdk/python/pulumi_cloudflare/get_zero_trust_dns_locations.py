...
def get_zero_trust_dns_locations(account_id: Optional[builtins.str] = None,
...
def get_zero_trust_dns_locations_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
