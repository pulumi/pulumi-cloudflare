...
class GetViewsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def name(self) -> Optional['outputs.GetViewsNameResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetViewsResultResult']:
        """
...
def get_views(account_id: Optional[_builtins.str] = None,
              direction: Optional[_builtins.str] = None,
              match: Optional[_builtins.str] = None,
              max_items: Optional[_builtins.int] = None,
              name: Optional[Union['GetViewsNameArgs', 'GetViewsNameArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:accountDnsSettingsInternal/views:getViews', __args__, opts=opts, typ=GetViewsResult).value
...
def get_views_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                     ...
                     name: pulumi.Input[Optional[Optional[Union['GetViewsNameArgs', 'GetViewsNameArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:accountDnsSettingsInternal/views:getViews', __args__, opts=opts, typ=GetViewsResult)
