...
class GetViewResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetViewFilterResult']:
...
def get_view(account_id: Optional[_builtins.str] = None,
             filter: Optional[Union['GetViewFilterArgs', 'GetViewFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:accountDnsSettingsInternal/view:getView', __args__, opts=opts, typ=GetViewResult).value
...
def get_view_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                    filter: pulumi.Input[Optional[Optional[Union['GetViewFilterArgs', 'GetViewFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:accountDnsSettingsInternal/view:getView', __args__, opts=opts, typ=GetViewResult)
