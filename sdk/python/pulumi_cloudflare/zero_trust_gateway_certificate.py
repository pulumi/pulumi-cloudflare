...
class ZeroTrustGatewayCertificateArgs:
    def __init__(__self__, *,
                 ...
                 gateway_managed: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] activate: Whether or not to activate a certificate. A certificate must be activated to use in Gateway certificate settings. Defaults to `false`.
        :param pulumi.Input[builtins.bool] custom: The type of certificate (custom or Gateway-managed). Must provide only one of `custom`, `gateway_managed`.
        :param pulumi.Input[builtins.bool] gateway_managed: The type of certificate (custom or Gateway-managed). Must provide only one of `custom`, `gateway_managed`.
        :param pulumi.Input[builtins.int] validity_period_days: Number of days the generated certificate will be valid, minimum 1 day and maximum 30 years. Defaults to 5 years. Defaults to `1826`. Required when using `gateway_managed`. Conflicts with `custom`. **Modifying this attribute will force creation of a new resource.**
        """
    ...
    def gateway_managed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        The type of certificate (custom or Gateway-managed). Must provide only one of `custom`, `gateway_managed`.
        """
    ...
    def gateway_managed(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ZeroTrustGatewayCertificateState:
    def __init__(__self__, *,
                 ...
                 qs_pack_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] account_id: The account identifier to target for the resource.
        :param pulumi.Input[builtins.bool] activate: Whether or not to activate a certificate. A certificate must be activated to use in Gateway certificate settings. Defaults to `false`.
        :param pulumi.Input[builtins.str] binding_status: The deployment status of the certificate on the edge Available values: `IP`, `SERIAL`, `URL`, `DOMAIN`, `EMAIL`.
        :param pulumi.Input[builtins.bool] custom: The type of certificate (custom or Gateway-managed). Must provide only one of `custom`, `gateway_managed`.
        :param pulumi.Input[builtins.bool] gateway_managed: The type of certificate (custom or Gateway-managed). Must provide only one of `custom`, `gateway_managed`.
        :param pulumi.Input[builtins.bool] in_use: Whether the certificate is in use by Gateway for TLS interception and the block page.
        :param pulumi.Input[builtins.int] validity_period_days: Number of days the generated certificate will be valid, minimum 1 day and maximum 30 years. Defaults to 5 years. Defaults to `1826`. Required when using `gateway_managed`. Conflicts with `custom`. **Modifying this attribute will force creation of a new resource.**
        """
    ...
    def qs_pack_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "qs_pack_id")

    @qs_pack_id.setter
    def qs_pack_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ZeroTrustGatewayCertificate(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def custom(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The type of certificate (custom or Gateway-managed). Must provide only one of `custom`, `gateway_managed`.
        """
        return pulumi.get(self, "custom")
    ...
    @property
    @pulumi.getter(name="gatewayManaged")
    def gateway_managed(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The type of certificate (custom or Gateway-managed). Must provide only one of `custom`, `gateway_managed`.
        """
        return pulumi.get(self, "gateway_managed")
    ...
    @property
    @pulumi.getter(name="qsPackId")
    def qs_pack_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "qs_pack_id")
