...
def get_mtls_certificate(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:mtlsCertificate/mtlsCertificate:getMtlsCertificate', __args__, opts=opts, typ=GetMtlsCertificateResult).value
...
def get_mtls_certificate_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:mtlsCertificate/mtlsCertificate:getMtlsCertificate', __args__, opts=opts, typ=GetMtlsCertificateResult)
