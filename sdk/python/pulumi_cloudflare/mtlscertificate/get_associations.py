...
def get_associations(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:mtlsCertificate/associations:getAssociations', __args__, opts=opts, typ=GetAssociationsResult).value
...
def get_associations_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:mtlsCertificate/associations:getAssociations', __args__, opts=opts, typ=GetAssociationsResult)
