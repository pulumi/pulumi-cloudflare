...
class _ZeroTrustDlpDatasetState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 encoding_version: Optional[pulumi.Input[int]] = None,
                 max_cells: Optional[pulumi.Input[int]] = None,
    ...
    def max_cells(self) -> Optional[pulumi.Input[int]]:
        return pulumi.get(self, "max_cells")

    @max_cells.setter
    def max_cells(self, value: Optional[pulumi.Input[int]]):
...
class ZeroTrustDlpDataset(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            version: Optional[pulumi.Input[int]] = None) -> 'ZeroTrustDlpDataset':
        """
    ...
    @property
    @pulumi.getter(name="encodingVersion")
    def encoding_version(self) -> pulumi.Output[Optional[int]]:
        """
        Dataset encoding version
        """
        return pulumi.get(self, "encoding_version")
    ...
    @property
    @pulumi.getter(name="maxCells")
    def max_cells(self) -> pulumi.Output[int]:
        return pulumi.get(self, "max_cells")
    ...
    @property
    @pulumi.getter(name="numCells")
    def num_cells(self) -> pulumi.Output[int]:
        return pulumi.get(self, "num_cells")
