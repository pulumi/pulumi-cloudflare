...
def get_zero_trust_access_service_tokens(account_id: Optional[_builtins.str] = None,
...
def get_zero_trust_access_service_tokens_output(account_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
