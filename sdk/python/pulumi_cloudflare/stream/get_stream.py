...
def get_stream(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:stream/stream:getStream', __args__, opts=opts, typ=GetStreamResult).value
...
def get_stream_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:stream/stream:getStream', __args__, opts=opts, typ=GetStreamResult)
