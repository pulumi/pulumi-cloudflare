...
__all__ = [
    'GetWatermarkResult',
    'AwaitableGetWatermarkResult',
    'get_watermark',
    'get_watermark_output',
]
...
class AwaitableGetWatermarkResult(GetWatermarkResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWatermarkResult(
...
def get_watermark(account_id: Optional[_builtins.str] = None,
                  identifier: Optional[_builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWatermarkResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:stream/watermark:getWatermark', __args__, opts=opts, typ=GetWatermarkResult).value

    return AwaitableGetWatermarkResult(
...
def get_watermark_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
                         identifier: pulumi.Input[Optional[_builtins.str]] = None,
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWatermarkResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:stream/watermark:getWatermark', __args__, opts=opts, typ=GetWatermarkResult)
    return __ret__.apply(lambda __response__: GetWatermarkResult(
