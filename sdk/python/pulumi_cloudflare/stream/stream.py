...
@pulumi.type_token("cloudflare:stream/stream:Stream")
class Stream(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/stream:Stream")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Stream, __self__).__init__(
            'cloudflare:stream/stream:Stream',
            resource_name,
            __props__,
            opts)
