...
@pulumi.type_token("cloudflare:stream/webhook:Webhook")
class Webhook(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/streamWebhook:StreamWebhook")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["secret"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(Webhook, __self__).__init__(
            'cloudflare:stream/webhook:Webhook',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            modified: pulumi.Input[Optional[_builtins.str]] = None,
            notification_url: pulumi.Input[Optional[_builtins.str]] = None,
            secret: pulumi.Input[Optional[_builtins.str]] = None) -> 'Webhook':
        """
