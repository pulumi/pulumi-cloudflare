...
__all__ = [
    'GetCaptionLanguageResult',
    'AwaitableGetCaptionLanguageResult',
    'get_caption_language',
    'get_caption_language_output',
]

@pulumi.output_type
class GetCaptionLanguageResult:
    """
...
class AwaitableGetCaptionLanguageResult(GetCaptionLanguageResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCaptionLanguageResult(
...
def get_caption_language(account_id: Optional[_builtins.str] = None,
                         identifier: Optional[_builtins.str] = None,
                         language: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCaptionLanguageResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:stream/captionLanguage:getCaptionLanguage', __args__, opts=opts, typ=GetCaptionLanguageResult).value

    return AwaitableGetCaptionLanguageResult(
...
def get_caption_language_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
                                identifier: pulumi.Input[Optional[_builtins.str]] = None,
                                language: pulumi.Input[Optional[_builtins.str]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCaptionLanguageResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:stream/captionLanguage:getCaptionLanguage', __args__, opts=opts, typ=GetCaptionLanguageResult)
    return __ret__.apply(lambda __response__: GetCaptionLanguageResult(
