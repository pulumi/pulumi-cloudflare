...
__all__ = ['LiveInputArgs', 'LiveInput']
...
class LiveInputArgs:
    def __init__(__self__, *,
                 ...
                 recording: pulumi.Input[Optional['LiveInputRecordingArgs']] = None):
        """
        ...
        :param pulumi.Input['LiveInputRecordingArgs'] recording: Records the input to a Cloudflare Stream video. Behavior depends on the mode. In most cases, the video will initially be viewable as a live video and transition to on-demand after a condition is satisfied.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def recording(self) -> pulumi.Input[Optional['LiveInputRecordingArgs']]:
        """
    ...
    @recording.setter
    def recording(self, value: pulumi.Input[Optional['LiveInputRecordingArgs']]):
        pulumi.set(self, "recording", value)


@pulumi.input_type
class _LiveInputState:
    def __init__(__self__, *,
                 ...
                 prefer_low_latency: pulumi.Input[Optional[_builtins.bool]] = None,
                 recording: pulumi.Input[Optional['LiveInputRecordingArgs']] = None,
                 rtmps: pulumi.Input[Optional['LiveInputRtmpsArgs']] = None,
                 rtmps_playback: pulumi.Input[Optional['LiveInputRtmpsPlaybackArgs']] = None,
                 srt: pulumi.Input[Optional['LiveInputSrtArgs']] = None,
                 srt_playback: pulumi.Input[Optional['LiveInputSrtPlaybackArgs']] = None,
                 status: pulumi.Input[Optional[_builtins.str]] = None,
                 uid: pulumi.Input[Optional[_builtins.str]] = None,
                 web_rtc: pulumi.Input[Optional['LiveInputWebRtcArgs']] = None,
                 web_rtc_playback: pulumi.Input[Optional['LiveInputWebRtcPlaybackArgs']] = None):
        """
        ...
        :param pulumi.Input[_builtins.bool] prefer_low_latency: When enabled, the live stream is delivered using Low-Latency HLS (LL-HLS), reducing glass-to-glass latency for viewers at the cost of reduced player compatibility.
        :param pulumi.Input['LiveInputRecordingArgs'] recording: Records the input to a Cloudflare Stream video. Behavior depends on the mode. In most cases, the video will initially be viewable as a live video and transition to on-demand after a condition is satisfied.
        :param pulumi.Input['LiveInputRtmpsArgs'] rtmps: Details for streaming to an live input using RTMPS.
        :param pulumi.Input['LiveInputRtmpsPlaybackArgs'] rtmps_playback: Details for playback from an live input using RTMPS.
        :param pulumi.Input['LiveInputSrtArgs'] srt: Details for streaming to a live input using SRT.
        :param pulumi.Input['LiveInputSrtPlaybackArgs'] srt_playback: Details for playback from an live input using SRT.
        ...
        :param pulumi.Input['LiveInputWebRtcArgs'] web_rtc: Details for streaming to a live input using WebRTC.
        :param pulumi.Input['LiveInputWebRtcPlaybackArgs'] web_rtc_playback: Details for playback from a live input using WebRTC.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def rtmps(self) -> pulumi.Input[Optional['LiveInputRtmpsArgs']]:
        """
    ...
    @rtmps.setter
    def rtmps(self, value: pulumi.Input[Optional['LiveInputRtmpsArgs']]):
        pulumi.set(self, "rtmps", value)

    @_builtins.property
    @pulumi.getter(name="rtmpsPlayback")
    def rtmps_playback(self) -> pulumi.Input[Optional['LiveInputRtmpsPlaybackArgs']]:
        """
    ...
    def rtmps_playback(self, value: pulumi.Input[Optional['LiveInputRtmpsPlaybackArgs']]):
        pulumi.set(self, "rtmps_playback", value)

    @_builtins.property
    @pulumi.getter
    def srt(self) -> pulumi.Input[Optional['LiveInputSrtArgs']]:
        """
    ...
    @srt.setter
    def srt(self, value: pulumi.Input[Optional['LiveInputSrtArgs']]):
        pulumi.set(self, "srt", value)

    @_builtins.property
    @pulumi.getter(name="srtPlayback")
    def srt_playback(self) -> pulumi.Input[Optional['LiveInputSrtPlaybackArgs']]:
        """
    ...
    @srt_playback.setter
    def srt_playback(self, value: pulumi.Input[Optional['LiveInputSrtPlaybackArgs']]):
    ...
    def web_rtc(self) -> pulumi.Input[Optional['LiveInputWebRtcArgs']]:
        """
    ...
    @web_rtc.setter
    def web_rtc(self, value: pulumi.Input[Optional['LiveInputWebRtcArgs']]):
        pulumi.set(self, "web_rtc", value)

    @_builtins.property
    @pulumi.getter(name="webRtcPlayback")
    def web_rtc_playback(self) -> pulumi.Input[Optional['LiveInputWebRtcPlaybackArgs']]:
        """
    ...
    def web_rtc_playback(self, value: pulumi.Input[Optional['LiveInputWebRtcPlaybackArgs']]):
        pulumi.set(self, "web_rtc_playback", value)


@pulumi.type_token("cloudflare:stream/liveInput:LiveInput")
class LiveInput(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 meta: pulumi.Input[Optional[_builtins.str]] = None,
                 prefer_low_latency: pulumi.Input[Optional[_builtins.bool]] = None,
                 recording: pulumi.Input[Optional[Union['LiveInputRecordingArgs', 'LiveInputRecordingArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] meta: A user modifiable key-value store used to reference other systems of record for managing live inputs.
        :param pulumi.Input[_builtins.bool] prefer_low_latency: When enabled, the live stream is delivered using Low-Latency HLS (LL-HLS), reducing glass-to-glass latency for viewers at the cost of reduced player compatibility.
        :param pulumi.Input[Union['LiveInputRecordingArgs', 'LiveInputRecordingArgsDict']] recording: Records the input to a Cloudflare Stream video. Behavior depends on the mode. In most cases, the video will initially be viewable as a live video and transition to on-demand after a condition is satisfied.
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param LiveInputArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LiveInputArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LiveInputArgs.__new__(LiveInputArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/streamLiveInput:StreamLiveInput")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LiveInput, __self__).__init__(
            'cloudflare:stream/liveInput:LiveInput',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            prefer_low_latency: pulumi.Input[Optional[_builtins.bool]] = None,
            recording: pulumi.Input[Optional[Union['LiveInputRecordingArgs', 'LiveInputRecordingArgsDict']]] = None,
            rtmps: pulumi.Input[Optional[Union['LiveInputRtmpsArgs', 'LiveInputRtmpsArgsDict']]] = None,
            rtmps_playback: pulumi.Input[Optional[Union['LiveInputRtmpsPlaybackArgs', 'LiveInputRtmpsPlaybackArgsDict']]] = None,
            srt: pulumi.Input[Optional[Union['LiveInputSrtArgs', 'LiveInputSrtArgsDict']]] = None,
            srt_playback: pulumi.Input[Optional[Union['LiveInputSrtPlaybackArgs', 'LiveInputSrtPlaybackArgsDict']]] = None,
            status: pulumi.Input[Optional[_builtins.str]] = None,
            uid: pulumi.Input[Optional[_builtins.str]] = None,
            web_rtc: pulumi.Input[Optional[Union['LiveInputWebRtcArgs', 'LiveInputWebRtcArgsDict']]] = None,
            web_rtc_playback: pulumi.Input[Optional[Union['LiveInputWebRtcPlaybackArgs', 'LiveInputWebRtcPlaybackArgsDict']]] = None) -> 'LiveInput':
        """
        Get an existing LiveInput resource's state with the given name, id, and optional extra
        ...
        :param pulumi.Input[_builtins.bool] prefer_low_latency: When enabled, the live stream is delivered using Low-Latency HLS (LL-HLS), reducing glass-to-glass latency for viewers at the cost of reduced player compatibility.
        :param pulumi.Input[Union['LiveInputRecordingArgs', 'LiveInputRecordingArgsDict']] recording: Records the input to a Cloudflare Stream video. Behavior depends on the mode. In most cases, the video will initially be viewable as a live video and transition to on-demand after a condition is satisfied.
        :param pulumi.Input[Union['LiveInputRtmpsArgs', 'LiveInputRtmpsArgsDict']] rtmps: Details for streaming to an live input using RTMPS.
        :param pulumi.Input[Union['LiveInputRtmpsPlaybackArgs', 'LiveInputRtmpsPlaybackArgsDict']] rtmps_playback: Details for playback from an live input using RTMPS.
        :param pulumi.Input[Union['LiveInputSrtArgs', 'LiveInputSrtArgsDict']] srt: Details for streaming to a live input using SRT.
        :param pulumi.Input[Union['LiveInputSrtPlaybackArgs', 'LiveInputSrtPlaybackArgsDict']] srt_playback: Details for playback from an live input using SRT.
        :param pulumi.Input[_builtins.str] status: The connection status of a live input.
               Available values: "connected", "reconnected", "reconnecting", "client*disconnect", "ttl*exceeded", "failed*to*connect", "failed*to*reconnect", "new*configuration*accepted".
        :param pulumi.Input[_builtins.str] uid: A unique identifier for a live input.
        :param pulumi.Input[Union['LiveInputWebRtcArgs', 'LiveInputWebRtcArgsDict']] web_rtc: Details for streaming to a live input using WebRTC.
        :param pulumi.Input[Union['LiveInputWebRtcPlaybackArgs', 'LiveInputWebRtcPlaybackArgsDict']] web_rtc_playback: Details for playback from a live input using WebRTC.
        """
        opts = pulumi.ResourceOptions.merge(opts, pulumi.ResourceOptions(id=id))

        __props__ = _LiveInputState.__new__(_LiveInputState)
        ...
        return LiveInput(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def recording(self) -> pulumi.Output['outputs.LiveInputRecording']:
        """
        Records the input to a Cloudflare Stream video. Behavior depends on the mode. In most cases, the video will initially be viewable as a live video and transition to on-demand after a condition is satisfied.
        """
        return pulumi.get(self, "recording")
    ...
    @_builtins.property
    @pulumi.getter
    def rtmps(self) -> pulumi.Output['outputs.LiveInputRtmps']:
        """
        Details for streaming to an live input using RTMPS.
        """
        return pulumi.get(self, "rtmps")
    ...
    @_builtins.property
    @pulumi.getter(name="rtmpsPlayback")
    def rtmps_playback(self) -> pulumi.Output['outputs.LiveInputRtmpsPlayback']:
        """
        Details for playback from an live input using RTMPS.
        """
        return pulumi.get(self, "rtmps_playback")
    ...
    @_builtins.property
    @pulumi.getter
    def srt(self) -> pulumi.Output['outputs.LiveInputSrt']:
        """
        Details for streaming to a live input using SRT.
        """
        return pulumi.get(self, "srt")
    ...
    @_builtins.property
    @pulumi.getter(name="srtPlayback")
    def srt_playback(self) -> pulumi.Output['outputs.LiveInputSrtPlayback']:
        """
        Details for playback from an live input using SRT.
        """
        return pulumi.get(self, "srt_playback")
    ...
    @_builtins.property
    @pulumi.getter(name="webRtc")
    def web_rtc(self) -> pulumi.Output['outputs.LiveInputWebRtc']:
        """
        Details for streaming to a live input using WebRTC.
        """
        return pulumi.get(self, "web_rtc")
    ...
    @_builtins.property
    @pulumi.getter(name="webRtcPlayback")
    def web_rtc_playback(self) -> pulumi.Output['outputs.LiveInputWebRtcPlayback']:
        """
        Details for playback from a live input using WebRTC.
        """
        return pulumi.get(self, "web_rtc_playback")
