...
def get_key(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:stream/key:getKey', __args__, opts=opts, typ=GetKeyResult).value
...
def get_key_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:stream/key:getKey', __args__, opts=opts, typ=GetKeyResult)
