...
warnings.warn("""cloudflare:index/user:User has been deprecated in favor of cloudflare:user/user:User""", DeprecationWarning)
...
class User(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_user = cloudflare.user.User("example_user",
            country="US",
            first_name="John",
            last_name="Appleseed",
    ...
    def _internal_init(__self__,
                 ...
                 zipcode: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        pulumi.log.warn("""User is deprecated: cloudflare:index/user:User has been deprecated in favor of cloudflare:user/user:User""")
