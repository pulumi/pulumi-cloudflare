...
class GetRuleResult:
    ...
    def targeted_tests(self) -> Sequence['outputs.GetRuleTargetedTestResult']:
...
def get_rule(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDex/rule:getRule', __args__, opts=opts, typ=GetRuleResult).value
...
def get_rule_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDex/rule:getRule', __args__, opts=opts, typ=GetRuleResult)
