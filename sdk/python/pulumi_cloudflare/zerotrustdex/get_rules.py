...
def get_rules(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDex/rules:getRules', __args__, opts=opts, typ=GetRulesResult).value
...
def get_rules_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDex/rules:getRules', __args__, opts=opts, typ=GetRulesResult)
