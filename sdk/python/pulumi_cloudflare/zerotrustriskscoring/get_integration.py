...
def get_integration(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustRiskScoring/integration:getIntegration', __args__, opts=opts, typ=GetIntegrationResult).value
...
def get_integration_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustRiskScoring/integration:getIntegration', __args__, opts=opts, typ=GetIntegrationResult)
