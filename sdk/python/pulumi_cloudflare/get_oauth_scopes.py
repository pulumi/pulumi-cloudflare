...
class GetOauthScopesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetOauthScopesResultResult']:
        """
...
class AwaitableGetOauthScopesResult(GetOauthScopesResult):
...
def get_oauth_scopes(max_items: Optional[_builtins.int] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOauthScopesResult:
    """
    ## Example Usage
...
def get_oauth_scopes_output(max_items: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOauthScopesResult]:
    """
    ## Example Usage
