...
class LoadBalancerMonitorArgs:
    def __init__(__self__, *,
                 ...
                 expected_body: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 probe_zone: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] description: Object description.
        :param pulumi.Input[_builtins.str] expected_body: A case-insensitive sub-string to look for in the response body. If this string is not found, the origin will be marked as unhealthy. This parameter is only valid for HTTP and HTTPS monitors.
        :param pulumi.Input[_builtins.str] expected_codes: The expected HTTP response code or code range of the health check. This parameter is only valid for HTTP and HTTPS monitors.
        :param pulumi.Input[_builtins.bool] follow_redirects: Follow redirects if returned by the origin. This parameter is only valid for HTTP and HTTPS monitors.
        :param pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]] header: The HTTP request headers to send in the health check. It is recommended you set a Host header by default. The User-Agent header cannot be overridden. This parameter is only valid for HTTP and HTTPS monitors.
        :param pulumi.Input[_builtins.int] interval: The interval between each health check. Shorter intervals may improve failover time, but will increase load on the origins as we check from multiple locations.
        :param pulumi.Input[_builtins.str] method: The method to use for the health check. This defaults to 'GET' for HTTP/HTTPS based checks and 'connection_established' for TCP based health checks.
        :param pulumi.Input[_builtins.str] path: The endpoint path you want to conduct a health check against. This parameter is only valid for HTTP and HTTPS monitors.
        :param pulumi.Input[_builtins.int] port: The port number to connect to for the health check. Required for TCP, UDP, and SMTP checks. HTTP and HTTPS checks should only define the port when using a non-standard port (HTTP: default 80, HTTPS: default 443).
        :param pulumi.Input[_builtins.str] probe_zone: Assign this monitor to emulate the specified zone while probing. This parameter is only valid for HTTP and HTTPS monitors.
    ...
    def expected_body(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def expected_body(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def probe_zone(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @probe_zone.setter
    def probe_zone(self, value: pulumi.Input[Optional[_builtins.str]]):
...
@pulumi.type_token("cloudflare:loadBalancerMonitor/loadBalancerMonitor:LoadBalancerMonitor")
class LoadBalancerMonitor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
        $ pulumi import cloudflare:loadBalancerMonitor/loadBalancerMonitor:LoadBalancerMonitor example '<account_id>/<monitor_id>'
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/loadBalancerMonitor:LoadBalancerMonitor")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LoadBalancerMonitor, __self__).__init__(
            'cloudflare:loadBalancerMonitor/loadBalancerMonitor:LoadBalancerMonitor',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            retries: pulumi.Input[Optional[_builtins.int]] = None,
            timeout: pulumi.Input[Optional[_builtins.int]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None) -> 'LoadBalancerMonitor':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="followRedirects")
    def follow_redirects(self) -> pulumi.Output[_builtins.bool]:
        """
        Follow redirects if returned by the origin. This parameter is only valid for HTTP and HTTPS monitors.
        """
        return pulumi.get(self, "follow_redirects")
    ...
    @_builtins.property
    @pulumi.getter
    def header(self) -> pulumi.Output[Optional[Mapping[str, Sequence[_builtins.str]]]]:
        """
        The HTTP request headers to send in the health check. It is recommended you set a Host header by default. The User-Agent header cannot be overridden. This parameter is only valid for HTTP and HTTPS monitors.
        """
        return pulumi.get(self, "header")
