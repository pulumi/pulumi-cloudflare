...
def get_load_balancer_monitor(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:loadBalancerMonitor/loadBalancerMonitor:getLoadBalancerMonitor', __args__, opts=opts, typ=GetLoadBalancerMonitorResult).value
...
def get_load_balancer_monitor_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:loadBalancerMonitor/loadBalancerMonitor:getLoadBalancerMonitor', __args__, opts=opts, typ=GetLoadBalancerMonitorResult)
