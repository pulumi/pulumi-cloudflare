...
warnings.warn("""cloudflare:index/apiShieldDiscoveryOperation:ApiShieldDiscoveryOperation has been deprecated in favor of cloudflare:apiShieldDiscovery/operation:Operation""", DeprecationWarning)
...
class ApiShieldDiscoveryOperation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            operation_id: pulumi.Input[Optional[_builtins.str]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'ApiShieldDiscoveryOperation':
        """
