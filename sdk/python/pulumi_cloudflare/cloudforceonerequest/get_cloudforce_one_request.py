...
def get_cloudforce_one_request(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:cloudforceOneRequest/cloudforceOneRequest:getCloudforceOneRequest', __args__, opts=opts, typ=GetCloudforceOneRequestResult).value
...
def get_cloudforce_one_request_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:cloudforceOneRequest/cloudforceOneRequest:getCloudforceOneRequest', __args__, opts=opts, typ=GetCloudforceOneRequestResult)
