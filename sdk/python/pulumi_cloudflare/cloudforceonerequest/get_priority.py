...
def get_priority(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:cloudforceOneRequest/priority:getPriority', __args__, opts=opts, typ=GetPriorityResult).value
...
def get_priority_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:cloudforceOneRequest/priority:getPriority', __args__, opts=opts, typ=GetPriorityResult)
