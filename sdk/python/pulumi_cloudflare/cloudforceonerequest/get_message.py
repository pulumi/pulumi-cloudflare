...
def get_message(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:cloudforceOneRequest/message:getMessage', __args__, opts=opts, typ=GetMessageResult).value
...
def get_message_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:cloudforceOneRequest/message:getMessage', __args__, opts=opts, typ=GetMessageResult)
