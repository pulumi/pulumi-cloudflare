...
@pulumi.type_token("cloudflare:cloudforceOneRequest/message:Message")
class Message(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/cloudforceOneRequestMessage:CloudforceOneRequestMessage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Message, __self__).__init__(
            'cloudflare:cloudforceOneRequest/message:Message',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            is_follow_on_request: pulumi.Input[Optional[_builtins.bool]] = None,
            request_id: pulumi.Input[Optional[_builtins.str]] = None,
            updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'Message':
        """
