...
@pulumi.type_token("cloudflare:cloudforceOneRequest/priority:Priority")
class Priority(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param PriorityArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PriorityArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PriorityArgs.__new__(PriorityArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/cloudforceOneRequestPriority:CloudforceOneRequestPriority")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Priority, __self__).__init__(
            'cloudflare:cloudforceOneRequest/priority:Priority',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            tlp: pulumi.Input[Optional[_builtins.str]] = None,
            tokens: pulumi.Input[Optional[_builtins.int]] = None,
            updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'Priority':
        """
        ...
        __props__ = _PriorityState.__new__(_PriorityState)
        ...
        return Priority(resource_name, opts=opts, __props__=__props__)
