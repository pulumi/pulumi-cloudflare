...
class IpsecTunnelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] allow_null_cipher: Specifies if this tunnel may use a null cipher (ENCR_NULL) in Phase 2.
        ...
        :param pulumi.Input[str] health_check_type: Specifies the ICMP echo type for the health check (`request` or `reply`). Available values: `request`, `reply` Default:
               `reply`.
