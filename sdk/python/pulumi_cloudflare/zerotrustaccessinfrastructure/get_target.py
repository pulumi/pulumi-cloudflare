...
class GetTargetResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetTargetFilterResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def ip(self) -> 'outputs.GetTargetIpResult':
        """
...
def get_target(account_id: Optional[_builtins.str] = None,
               filter: Optional[Union['GetTargetFilterArgs', 'GetTargetFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustAccessInfrastructure/target:getTarget', __args__, opts=opts, typ=GetTargetResult).value
...
def get_target_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                      filter: pulumi.Input[Optional[Optional[Union['GetTargetFilterArgs', 'GetTargetFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustAccessInfrastructure/target:getTarget', __args__, opts=opts, typ=GetTargetResult)
