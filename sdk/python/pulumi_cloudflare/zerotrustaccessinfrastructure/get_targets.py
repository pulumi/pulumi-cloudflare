...
class GetTargetsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetTargetsResultResult']:
        """
...
def get_targets(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustAccessInfrastructure/targets:getTargets', __args__, opts=opts, typ=GetTargetsResult).value
...
def get_targets_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                       ...
                       ip_like: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                       ip_v4: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                       ip_v6: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                       ips: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                       ipv4_end: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                       ipv4_start: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                       ipv6_end: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                       ipv6_start: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                       ...
                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTargetsResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustAccessInfrastructure/targets:getTargets', __args__, opts=opts, typ=GetTargetsResult)
    return __ret__.apply(lambda __response__: GetTargetsResult(
