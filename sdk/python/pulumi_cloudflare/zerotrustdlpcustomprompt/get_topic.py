...
def get_topic(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDlpCustomPrompt/topic:getTopic', __args__, opts=opts, typ=GetTopicResult).value
...
def get_topic_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDlpCustomPrompt/topic:getTopic', __args__, opts=opts, typ=GetTopicResult)
