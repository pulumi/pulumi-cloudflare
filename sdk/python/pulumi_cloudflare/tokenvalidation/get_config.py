...
class GetConfigResult:
    ...
    @_builtins.property
    @pulumi.getter
    def credentials(self) -> 'outputs.GetConfigCredentialsResult':
...
def get_config(config_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:tokenValidation/config:getConfig', __args__, opts=opts, typ=GetConfigResult).value
...
def get_config_output(config_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:tokenValidation/config:getConfig', __args__, opts=opts, typ=GetConfigResult)
