...
class GetBindingsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetBindingsResultResult']:
        """
...
def get_bindings(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:dlsPrefix/bindings:getBindings', __args__, opts=opts, typ=GetBindingsResult).value

    return AwaitableGetBindingsResult(
        account_id=pulumi.get(__ret__, 'account_id'),
        max_items=pulumi.get(__ret__, 'max_items'),
        results=pulumi.get(__ret__, 'results'))
def get_bindings_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:dlsPrefix/bindings:getBindings', __args__, opts=opts, typ=GetBindingsResult)
