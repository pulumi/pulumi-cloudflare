...
def get_binding(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:dlsPrefix/binding:getBinding', __args__, opts=opts, typ=GetBindingResult).value
...
def get_binding_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:dlsPrefix/binding:getBinding', __args__, opts=opts, typ=GetBindingResult)
