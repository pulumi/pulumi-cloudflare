...
@pulumi.type_token("cloudflare:authenticatedOriginPulls/certificate:Certificate")
class Certificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/authenticatedOriginPullsCertificate:AuthenticatedOriginPullsCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["privateKey"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(Certificate, __self__).__init__(
            'cloudflare:authenticatedOriginPulls/certificate:Certificate',
            resource_name,
            __props__,
            opts)
