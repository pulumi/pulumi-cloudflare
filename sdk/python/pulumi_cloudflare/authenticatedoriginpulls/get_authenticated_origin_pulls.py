...
def get_authenticated_origin_pulls(hostname: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:authenticatedOriginPulls/authenticatedOriginPulls:getAuthenticatedOriginPulls', __args__, opts=opts, typ=GetAuthenticatedOriginPullsResult).value
...
def get_authenticated_origin_pulls_output(hostname: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:authenticatedOriginPulls/authenticatedOriginPulls:getAuthenticatedOriginPulls', __args__, opts=opts, typ=GetAuthenticatedOriginPullsResult)
