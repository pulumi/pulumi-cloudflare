...
class _AuthenticatedOriginPullsState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cert_updated_at: The time when the certificate was updated.
        :param pulumi.Input[_builtins.str] cert_uploaded_on: The time when the certificate was uploaded.
        :param pulumi.Input[_builtins.str] certificate: The hostname certificate.
        :param pulumi.Input[_builtins.str] created_at: The time when the certificate was created.
        ...
        :param pulumi.Input[_builtins.str] status: Status of the certificate or the association.
               Available values: "initializing", "pending*deployment", "pending*deletion", "active", "deleted", "deployment*timed*out", "deletion*timed*out".
        :param pulumi.Input[_builtins.str] updated_at: The time when the certificate was updated.
        :param pulumi.Input[_builtins.str] zone_id: Identifier.
        """
...
@pulumi.type_token("cloudflare:authenticatedOriginPulls/authenticatedOriginPulls:AuthenticatedOriginPulls")
class AuthenticatedOriginPulls(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
        $ pulumi import cloudflare:authenticatedOriginPulls/authenticatedOriginPulls:AuthenticatedOriginPulls example '<zone_id>/<hostname>'
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/authenticatedOriginPulls:AuthenticatedOriginPulls")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["privateKey"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(AuthenticatedOriginPulls, __self__).__init__(
            'cloudflare:authenticatedOriginPulls/authenticatedOriginPulls:AuthenticatedOriginPulls',
            resource_name,
            __props__,
            opts)
    ...
    @_builtins.property
    @pulumi.getter(name="certStatus")
    def cert_status(self) -> pulumi.Output[_builtins.str]:
        """
        Status of the certificate or the association.
        Available values: "initializing", "pending*deployment", "pending*deletion", "active", "deleted", "deployment*timed*out", "deletion*timed*out".
        """
    ...
    @_builtins.property
    @pulumi.getter(name="certUpdatedAt")
    def cert_updated_at(self) -> pulumi.Output[_builtins.str]:
        """
        The time when the certificate was updated.
        """
        return pulumi.get(self, "cert_updated_at")
    ...
    @_builtins.property
    @pulumi.getter(name="certUploadedOn")
    def cert_uploaded_on(self) -> pulumi.Output[_builtins.str]:
        """
        The time when the certificate was uploaded.
        """
        return pulumi.get(self, "cert_uploaded_on")
