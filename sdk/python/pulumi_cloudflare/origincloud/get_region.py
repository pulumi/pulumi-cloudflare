...
def get_region(origin_ip: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:originCloud/region:getRegion', __args__, opts=opts, typ=GetRegionResult).value
...
def get_region_output(origin_ip: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:originCloud/region:getRegion', __args__, opts=opts, typ=GetRegionResult)
