...
def get_certificate(certificate_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:originCa/certificate:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
...
def get_certificate_output(certificate_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:originCa/certificate:getCertificate', __args__, opts=opts, typ=GetCertificateResult)
