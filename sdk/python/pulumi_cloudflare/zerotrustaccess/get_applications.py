...
def get_applications(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustAccess/applications:getApplications', __args__, opts=opts, typ=GetApplicationsResult).value
...
def get_applications_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustAccess/applications:getApplications', __args__, opts=opts, typ=GetApplicationsResult)
