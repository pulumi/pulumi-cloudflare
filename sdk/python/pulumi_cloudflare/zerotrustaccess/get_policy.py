...
class GetPolicyResult:
    ...
    def approval_groups(self) -> Sequence['outputs.GetPolicyApprovalGroupResult']:
        """
    ...
    def connection_rules(self) -> 'outputs.GetPolicyConnectionRulesResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def excludes(self) -> Sequence['outputs.GetPolicyExcludeResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def includes(self) -> Sequence['outputs.GetPolicyIncludeResult']:
        """
    ...
    def mfa_config(self) -> 'outputs.GetPolicyMfaConfigResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def requires(self) -> Sequence['outputs.GetPolicyRequireResult']:
        """
...
def get_policy(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustAccess/policy:getPolicy', __args__, opts=opts, typ=GetPolicyResult).value
...
def get_policy_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustAccess/policy:getPolicy', __args__, opts=opts, typ=GetPolicyResult)
