...
def get_policies(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustAccess/policies:getPolicies', __args__, opts=opts, typ=GetPoliciesResult).value
...
def get_policies_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustAccess/policies:getPolicies', __args__, opts=opts, typ=GetPoliciesResult)
