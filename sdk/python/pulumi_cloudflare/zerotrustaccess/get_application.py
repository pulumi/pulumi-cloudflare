...
class GetApplicationResult:
    ...
    def cors_headers(self) -> 'outputs.GetApplicationCorsHeadersResult':
    ...
    @_builtins.property
    @pulumi.getter
    def destinations(self) -> Sequence['outputs.GetApplicationDestinationResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetApplicationFilterResult']:
        return pulumi.get(self, "filter")

    @_builtins.property
    @pulumi.getter(name="footerLinks")
    def footer_links(self) -> Sequence['outputs.GetApplicationFooterLinkResult']:
        """
    ...
    def landing_page_design(self) -> 'outputs.GetApplicationLandingPageDesignResult':
        """
    ...
    def mfa_config(self) -> 'outputs.GetApplicationMfaConfigResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def policies(self) -> Sequence['outputs.GetApplicationPolicyResult']:
    ...
    def saas_app(self) -> 'outputs.GetApplicationSaasAppResult':
    ...
    def scim_config(self) -> 'outputs.GetApplicationScimConfigResult':
        """
    ...
    def target_criterias(self) -> Sequence['outputs.GetApplicationTargetCriteriaResult']:
...
def get_application(account_id: Optional[_builtins.str] = None,
                    ...
                    filter: Optional[Union['GetApplicationFilterArgs', 'GetApplicationFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustAccess/application:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
...
def get_application_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                           app_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                           filter: pulumi.Input[Optional[Optional[Union['GetApplicationFilterArgs', 'GetApplicationFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustAccess/application:getApplication', __args__, opts=opts, typ=GetApplicationResult)
