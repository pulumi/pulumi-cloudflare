...
class GetGroupResult:
    ...
    @_builtins.property
    @pulumi.getter
    def excludes(self) -> Sequence['outputs.GetGroupExcludeResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def includes(self) -> Sequence['outputs.GetGroupIncludeResult']:
        """
    ...
    def is_defaults(self) -> Sequence['outputs.GetGroupIsDefaultResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def requires(self) -> Sequence['outputs.GetGroupRequireResult']:
        """
        Rules evaluated with an AND logical operator. To match a policy, a user must meet all of the Require rules.
        """
...
def get_group(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustAccess/group:getGroup', __args__, opts=opts, typ=GetGroupResult).value
...
def get_group_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                     filter: pulumi.Input[Optional[Optional[Union['GetGroupFilterArgs', 'GetGroupFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustAccess/group:getGroup', __args__, opts=opts, typ=GetGroupResult)
