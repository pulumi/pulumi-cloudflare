...
def get_page_shield_scripts(script_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pageShieldScripts/pageShieldScripts:getPageShieldScripts', __args__, opts=opts, typ=GetPageShieldScriptsResult).value
...
def get_page_shield_scripts_output(script_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pageShieldScripts/pageShieldScripts:getPageShieldScripts', __args__, opts=opts, typ=GetPageShieldScriptsResult)
