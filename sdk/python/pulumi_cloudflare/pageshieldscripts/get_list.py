...
def get_list(direction: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pageShieldScripts/list:getList', __args__, opts=opts, typ=GetListResult).value
...
def get_list_output(direction: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pageShieldScripts/list:getList', __args__, opts=opts, typ=GetListResult)
