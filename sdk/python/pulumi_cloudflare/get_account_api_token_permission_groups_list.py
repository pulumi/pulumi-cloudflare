...
def get_account_api_token_permission_groups_list(account_id: Optional[builtins.str] = None,
...
def get_account_api_token_permission_groups_list_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
