...
class _ZoneCacheVariantsState:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[Optional['ZoneCacheVariantsValueArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def value(self) -> pulumi.Input[Optional['ZoneCacheVariantsValueArgs']]:
        """
        Value of the zone setting.
        """
        return pulumi.get(self, "value")
    ...
    @value.setter
    def value(self, value: pulumi.Input[Optional['ZoneCacheVariantsValueArgs']]):
        pulumi.set(self, "value", value)
