...
def get_magic_transit_connectors(account_id: Optional[builtins.str] = None,
...
def get_magic_transit_connectors_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
