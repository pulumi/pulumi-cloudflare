...
__all__ = [
    ...
    'AwaitableGetCustomOriginTrustStoresResult',
    'get_custom_origin_trust_stores',
...
class GetCustomOriginTrustStoresResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetCustomOriginTrustStoresResultResult']:
        """
...
class AwaitableGetCustomOriginTrustStoresResult(GetCustomOriginTrustStoresResult):
...
def get_custom_origin_trust_stores(limit: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getCustomOriginTrustStores:getCustomOriginTrustStores', __args__, opts=opts, typ=GetCustomOriginTrustStoresResult).value

    return AwaitableGetCustomOriginTrustStoresResult(
...
def get_custom_origin_trust_stores_output(limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getCustomOriginTrustStores:getCustomOriginTrustStores', __args__, opts=opts, typ=GetCustomOriginTrustStoresResult)
    return __ret__.apply(lambda __response__: GetCustomOriginTrustStoresResult(
