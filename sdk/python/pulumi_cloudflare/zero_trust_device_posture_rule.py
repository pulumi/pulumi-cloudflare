...
class ZeroTrustDevicePostureRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The device posture rule type. Available values: `serial_number`, `file`, `application`, `gateway`, `warp`, `domain_joined`, `os_version`, `disk_encryption`, `firewall`, `client_certificate`, `client_certificate_v2`, `workspace_one`, `unique_client_id`, `crowdstrike_s2s`, `sentinelone`, `kolide`, `tanium_s2s`, `intune`, `sentinelone_s2s`, `custom_s2s`.
        :param pulumi.Input[builtins.str] expiration: Expire posture results after the specified amount of time. Must be in the format `1h` or `30m`. Valid units are `h` and `m`.
        ...
        :param pulumi.Input[builtins.str] name: Name of the device posture rule.
        :param pulumi.Input[builtins.str] schedule: Tells the client when to run the device posture check. Must be in the format `1h` or `30m`. Valid units are `h` and `m`.
        """
