...
def get_schema_validation_operation_settings(operation_id: Optional[builtins.str] = None,
...
def get_schema_validation_operation_settings_output(operation_id: Optional[pulumi.Input[builtins.str]] = None,
