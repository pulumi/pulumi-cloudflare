...
def get_email_security_trusted_domains(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:emailSecurityTrustedDomains/emailSecurityTrustedDomains:getEmailSecurityTrustedDomains', __args__, opts=opts, typ=GetEmailSecurityTrustedDomainsResult).value
...
def get_email_security_trusted_domains_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:emailSecurityTrustedDomains/emailSecurityTrustedDomains:getEmailSecurityTrustedDomains', __args__, opts=opts, typ=GetEmailSecurityTrustedDomainsResult)
