...
@pulumi.type_token("cloudflare:emailSecurityTrustedDomains/emailSecurityTrustedDomains:EmailSecurityTrustedDomains")
class EmailSecurityTrustedDomains(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/emailSecurityTrustedDomains:EmailSecurityTrustedDomains")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EmailSecurityTrustedDomains, __self__).__init__(
            'cloudflare:emailSecurityTrustedDomains/emailSecurityTrustedDomains:EmailSecurityTrustedDomains',
            resource_name,
            __props__,
            opts)
