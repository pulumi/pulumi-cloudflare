...
class AccessApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_idps: The identity providers selected for the application.
        :param pulumi.Input[builtins.str] app_launcher_logo_url: The logo URL of the app launcher.
        :param pulumi.Input[builtins.bool] app_launcher_visible: Option to show/hide applications in App Launcher. Defaults to `true`.
        :param pulumi.Input[builtins.bool] auto_redirect_to_identity: Option to skip identity provider selection if only one is configured in `allowed_idps`. Defaults to `false`.
        :param pulumi.Input[builtins.str] bg_color: The background color of the app launcher.
        ...
        :param pulumi.Input[builtins.str] custom_deny_message: Option that returns a custom error message when a user is denied access to the application.
        :param pulumi.Input[builtins.str] custom_deny_url: Option that redirects to a custom URL when a user is denied access to the application via identity based rules.
        :param pulumi.Input[builtins.str] custom_non_identity_deny_url: Option that redirects to a custom URL when a user is denied access to the application via non identity rules.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] custom_pages: The custom pages selected for the application.
        ...
        :param pulumi.Input[builtins.str] domain: The primary hostname and path that Access will secure. If the app is visible in the App Launcher dashboard, this is the domain that will be displayed.
        :param pulumi.Input[builtins.str] domain_type: The type of the primary domain. Available values: `public`, `private`.
        :param pulumi.Input[builtins.bool] enable_binding_cookie: Option to provide increased security against compromised authorization tokens and CSRF attacks by requiring an additional "binding" cookie on requests. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] header_bg_color: The background color of the header bar in the app launcher.
        :param pulumi.Input[builtins.bool] http_only_cookie_attribute: Option to add the `HttpOnly` cookie flag to access tokens.
        ...
        :param pulumi.Input[builtins.str] logo_url: Image URL for the logo shown in the app launcher dashboard.
        :param pulumi.Input[builtins.str] name: Friendly name of the Access Application.
        :param pulumi.Input[builtins.bool] options_preflight_bypass: Allows options preflight requests to bypass Access authentication and go directly to the origin. Cannot turn on if cors_headers is set. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] policies: The policies associated with the application, in ascending order of precedence. Warning: Do not use this field while you still have this application ID referenced as `application_id` in any `AccessPolicy` resource, as it can result in an inconsistent state.
        :param pulumi.Input['AccessApplicationSaasAppArgs'] saas_app: SaaS configuration for the Access Application.
        :param pulumi.Input[builtins.str] same_site_cookie_attribute: Defines the same-site cookie setting for access tokens. Available values: `none`, `lax`, `strict`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] self_hosted_domains: List of public domains secured by Access. Only present for self_hosted, vnc, and ssh applications. Always includes the value set as `domain`. Deprecated in favor of `destinations` and will be removed in the next major version. Conflicts with `destinations`.
        :param pulumi.Input[builtins.bool] service_auth401_redirect: Option to return a 401 status code in service authentication rules on failed requests. Defaults to `false`.
        :param pulumi.Input[builtins.str] session_duration: How often a user will be forced to re-authorise. Must be in the format `48h` or `2h45m`. Defaults to `24h`.
        :param pulumi.Input[builtins.bool] skip_app_launcher_login_page: Option to skip the App Launcher landing page. Defaults to `false`.
        :param pulumi.Input[builtins.bool] skip_interstitial: Option to skip the authorization interstitial when using the CLI. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The itags associated with the application.
        ...
        :param pulumi.Input[builtins.str] type: The application type. Available values: `app_launcher`, `bookmark`, `biso`, `dash_sso`, `saas`, `self_hosted`, `ssh`, `vnc`, `warp`, `infrastructure`. Defaults to `self_hosted`.
...
class _AccessApplicationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] app_launcher_logo_url: The logo URL of the app launcher.
        :param pulumi.Input[builtins.bool] app_launcher_visible: Option to show/hide applications in App Launcher. Defaults to `true`.
        :param pulumi.Input[builtins.str] aud: Application Audience (AUD) Tag of the application.
        :param pulumi.Input[builtins.bool] auto_redirect_to_identity: Option to skip identity provider selection if only one is configured in `allowed_idps`. Defaults to `false`.
        :param pulumi.Input[builtins.str] bg_color: The background color of the app launcher.
        :param pulumi.Input[Sequence[pulumi.Input['AccessApplicationCorsHeaderArgs']]] cors_headers: CORS configuration for the Access Application. See below for reference structure.
        :param pulumi.Input[builtins.str] custom_deny_message: Option that returns a custom error message when a user is denied access to the application.
...
class AccessApplication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_criterias: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AccessApplicationTargetCriteriaArgs', 'AccessApplicationTargetCriteriaArgsDict']]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AccessApplication':
        """
    ...
    @property
    @pulumi.getter(name="appLauncherVisible")
    def app_launcher_visible(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Option to show/hide applications in App Launcher. Defaults to `true`.
        """
        return pulumi.get(self, "app_launcher_visible")
    ...
    @property
    @pulumi.getter(name="autoRedirectToIdentity")
    def auto_redirect_to_identity(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Option to skip identity provider selection if only one is configured in `allowed_idps`. Defaults to `false`.
        """
        return pulumi.get(self, "auto_redirect_to_identity")
    ...
    @property
    @pulumi.getter(name="enableBindingCookie")
    def enable_binding_cookie(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Option to provide increased security against compromised authorization tokens and CSRF attacks by requiring an additional "binding" cookie on requests. Defaults to `false`.
        """
        return pulumi.get(self, "enable_binding_cookie")
    ...
    @property
    @pulumi.getter(name="httpOnlyCookieAttribute")
    def http_only_cookie_attribute(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Option to add the `HttpOnly` cookie flag to access tokens.
        """
        return pulumi.get(self, "http_only_cookie_attribute")
    ...
    @property
    @pulumi.getter(name="skipAppLauncherLoginPage")
    def skip_app_launcher_login_page(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Option to skip the App Launcher landing page. Defaults to `false`.
        """
        return pulumi.get(self, "skip_app_launcher_login_page")
