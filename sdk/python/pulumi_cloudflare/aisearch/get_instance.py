...
class GetInstanceResult:
    ...
    def custom_metadatas(self) -> Sequence['outputs.GetInstanceCustomMetadataResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetInstanceFilterResult']:
    ...
    def index_method(self) -> 'outputs.GetInstanceIndexMethodResult':
        """
    ...
    def indexing_options(self) -> 'outputs.GetInstanceIndexingOptionsResult':
    ...
    @_builtins.property
    @pulumi.getter
    def metadata(self) -> 'outputs.GetInstanceMetadataResult':
    ...
    def public_endpoint_params(self) -> 'outputs.GetInstancePublicEndpointParamsResult':
    ...
    def retrieval_options(self) -> 'outputs.GetInstanceRetrievalOptionsResult':
    ...
    def source_params(self) -> 'outputs.GetInstanceSourceParamsResult':
...
def get_instance(account_id: Optional[_builtins.str] = None,
                 filter: Optional[Union['GetInstanceFilterArgs', 'GetInstanceFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:aiSearch/instance:getInstance', __args__, opts=opts, typ=GetInstanceResult).value
...
def get_instance_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                        filter: pulumi.Input[Optional[Optional[Union['GetInstanceFilterArgs', 'GetInstanceFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:aiSearch/instance:getInstance', __args__, opts=opts, typ=GetInstanceResult)
