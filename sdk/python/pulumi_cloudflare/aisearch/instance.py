...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 custom_metadatas: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceCustomMetadataArgs']]]] = None,
                 ...
                 index_method: pulumi.Input[Optional['InstanceIndexMethodArgs']] = None,
                 indexing_options: pulumi.Input[Optional['InstanceIndexingOptionsArgs']] = None,
                 max_num_results: pulumi.Input[Optional[_builtins.int]] = None,
                 metadata: pulumi.Input[Optional['InstanceMetadataArgs']] = None,
                 paused: pulumi.Input[Optional[_builtins.bool]] = None,
                 public_endpoint_params: pulumi.Input[Optional['InstancePublicEndpointParamsArgs']] = None,
                 reranking: pulumi.Input[Optional[_builtins.bool]] = None,
                 reranking_model: pulumi.Input[Optional[_builtins.str]] = None,
                 retrieval_options: pulumi.Input[Optional['InstanceRetrievalOptionsArgs']] = None,
                 ...
                 source_params: pulumi.Input[Optional['InstanceSourceParamsArgs']] = None,
        ...
        :param pulumi.Input['InstanceIndexMethodArgs'] index_method: Controls which storage backends are used during indexing. Defaults to vector-only.
    ...
    def custom_metadatas(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['InstanceCustomMetadataArgs']]]]:
        return pulumi.get(self, "custom_metadatas")

    @custom_metadatas.setter
    def custom_metadatas(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceCustomMetadataArgs']]]]):
    ...
    def index_method(self) -> pulumi.Input[Optional['InstanceIndexMethodArgs']]:
        """
    ...
    @index_method.setter
    def index_method(self, value: pulumi.Input[Optional['InstanceIndexMethodArgs']]):
        pulumi.set(self, "index_method", value)

    @_builtins.property
    @pulumi.getter(name="indexingOptions")
    def indexing_options(self) -> pulumi.Input[Optional['InstanceIndexingOptionsArgs']]:
        return pulumi.get(self, "indexing_options")

    @indexing_options.setter
    def indexing_options(self, value: pulumi.Input[Optional['InstanceIndexingOptionsArgs']]):
    ...
    @_builtins.property
    @pulumi.getter
    def metadata(self) -> pulumi.Input[Optional['InstanceMetadataArgs']]:
        return pulumi.get(self, "metadata")

    @metadata.setter
    def metadata(self, value: pulumi.Input[Optional['InstanceMetadataArgs']]):
    ...
    def public_endpoint_params(self) -> pulumi.Input[Optional['InstancePublicEndpointParamsArgs']]:
        return pulumi.get(self, "public_endpoint_params")

    @public_endpoint_params.setter
    def public_endpoint_params(self, value: pulumi.Input[Optional['InstancePublicEndpointParamsArgs']]):
    ...
    def retrieval_options(self) -> pulumi.Input[Optional['InstanceRetrievalOptionsArgs']]:
        return pulumi.get(self, "retrieval_options")

    @retrieval_options.setter
    def retrieval_options(self, value: pulumi.Input[Optional['InstanceRetrievalOptionsArgs']]):
    ...
    def source_params(self) -> pulumi.Input[Optional['InstanceSourceParamsArgs']]:
        return pulumi.get(self, "source_params")

    @source_params.setter
    def source_params(self, value: pulumi.Input[Optional['InstanceSourceParamsArgs']]):
...
@pulumi.type_token("cloudflare:aiSearch/instance:Instance")
class Instance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 chunk_overlap: pulumi.Input[Optional[_builtins.int]] = None,
                 chunk_size: pulumi.Input[Optional[_builtins.int]] = None,
                 custom_metadatas: pulumi.Input[Optional[Sequence[pulumi.Input[Union['InstanceCustomMetadataArgs', 'InstanceCustomMetadataArgsDict']]]]] = None,
                 embedding_model: pulumi.Input[Optional[_builtins.str]] = None,
                 fusion_method: pulumi.Input[Optional[_builtins.str]] = None,
                 hybrid_search_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 index_method: pulumi.Input[Optional[Union['InstanceIndexMethodArgs', 'InstanceIndexMethodArgsDict']]] = None,
                 indexing_options: pulumi.Input[Optional[Union['InstanceIndexingOptionsArgs', 'InstanceIndexingOptionsArgsDict']]] = None,
                 max_num_results: pulumi.Input[Optional[_builtins.int]] = None,
                 metadata: pulumi.Input[Optional[Union['InstanceMetadataArgs', 'InstanceMetadataArgsDict']]] = None,
                 paused: pulumi.Input[Optional[_builtins.bool]] = None,
                 public_endpoint_params: pulumi.Input[Optional[Union['InstancePublicEndpointParamsArgs', 'InstancePublicEndpointParamsArgsDict']]] = None,
                 reranking: pulumi.Input[Optional[_builtins.bool]] = None,
                 reranking_model: pulumi.Input[Optional[_builtins.str]] = None,
                 retrieval_options: pulumi.Input[Optional[Union['InstanceRetrievalOptionsArgs', 'InstanceRetrievalOptionsArgsDict']]] = None,
                 rewrite_model: pulumi.Input[Optional[_builtins.str]] = None,
                 rewrite_query: pulumi.Input[Optional[_builtins.bool]] = None,
                 score_threshold: pulumi.Input[Optional[_builtins.float]] = None,
                 source: pulumi.Input[Optional[_builtins.str]] = None,
                 source_params: pulumi.Input[Optional[Union['InstanceSourceParamsArgs', 'InstanceSourceParamsArgsDict']]] = None,
                 summarization: pulumi.Input[Optional[_builtins.bool]] = None,
                 summarization_model: pulumi.Input[Optional[_builtins.str]] = None,
                 sync_interval: pulumi.Input[Optional[_builtins.float]] = None,
                 system_prompt_aisearch: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] fusion_method: Available values: "max", "rrf".
        :param pulumi.Input[_builtins.bool] hybrid_search_enabled: Deprecated — use index_method instead.
        :param pulumi.Input[Union['InstanceIndexMethodArgs', 'InstanceIndexMethodArgsDict']] index_method: Controls which storage backends are used during indexing. Defaults to vector-only.
        :param pulumi.Input[_builtins.str] reranking_model: Available values: "@cf/baai/bge-reranker-base", "".
        :param pulumi.Input[_builtins.str] rewrite_model: Available values: "@cf/meta/llama-3.3-70b-instruct-fp8-fast", "@cf/zai-org/glm-4.7-flash", "@cf/meta/llama-3.1-8b-instruct-fast", "@cf/meta/llama-3.1-8b-instruct-fp8", "@cf/meta/llama-4-scout-17b-16e-instruct", "@cf/qwen/qwen3-30b-a3b-fp8", "@cf/deepseek-ai/deepseek-r1-distill-qwen-32b", "@cf/moonshotai/kimi-k2-instruct", "@cf/google/gemma-3-12b-it", "@cf/google/gemma-4-26b-a4b-it", "@cf/moonshotai/kimi-k2.5", "anthropic/claude-3-7-sonnet", "anthropic/claude-sonnet-4", "anthropic/claude-opus-4", "anthropic/claude-3-5-haiku", "cerebras/qwen-3-235b-a22b-instruct", "cerebras/qwen-3-235b-a22b-thinking", "cerebras/llama-3.3-70b", "cerebras/llama-4-maverick-17b-128e-instruct", "cerebras/llama-4-scout-17b-16e-instruct", "cerebras/gpt-oss-120b", "google-ai-studio/gemini-2.5-flash", "google-ai-studio/gemini-2.5-pro", "grok/grok-4", "groq/llama-3.3-70b-versatile", "groq/llama-3.1-8b-instant", "openai/gpt-5", "openai/gpt-5-mini", "openai/gpt-5-nano", "".
        :param pulumi.Input[_builtins.str] summarization_model: Available values: "@cf/meta/llama-3.3-70b-instruct-fp8-fast", "@cf/zai-org/glm-4.7-flash", "@cf/meta/llama-3.1-8b-instruct-fast", "@cf/meta/llama-3.1-8b-instruct-fp8", "@cf/meta/llama-4-scout-17b-16e-instruct", "@cf/qwen/qwen3-30b-a3b-fp8", "@cf/deepseek-ai/deepseek-r1-distill-qwen-32b", "@cf/moonshotai/kimi-k2-instruct", "@cf/google/gemma-3-12b-it", "@cf/google/gemma-4-26b-a4b-it", "@cf/moonshotai/kimi-k2.5", "anthropic/claude-3-7-sonnet", "anthropic/claude-sonnet-4", "anthropic/claude-opus-4", "anthropic/claude-3-5-haiku", "cerebras/qwen-3-235b-a22b-instruct", "cerebras/qwen-3-235b-a22b-thinking", "cerebras/llama-3.3-70b", "cerebras/llama-4-maverick-17b-128e-instruct", "cerebras/llama-4-scout-17b-16e-instruct", "cerebras/gpt-oss-120b", "google-ai-studio/gemini-2.5-flash", "google-ai-studio/gemini-2.5-pro", "grok/grok-4", "groq/llama-3.3-70b-versatile", "groq/llama-3.1-8b-instant", "openai/gpt-5", "openai/gpt-5-mini", "openai/gpt-5-nano", "".
        :param pulumi.Input[_builtins.float] sync_interval: Interval between automatic syncs, in seconds. Allowed values: 900 (15min), 1800 (30min), 3600 (1h), 7200 (2h), 14400 (4h), 21600 (6h), 43200 (12h), 86400 (24h).
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/aiSearchInstance:AiSearchInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Instance, __self__).__init__(
            'cloudflare:aiSearch/instance:Instance',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            token_id: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None,
            vectorize_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'Instance':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="customMetadatas")
    def custom_metadatas(self) -> pulumi.Output[Optional[Sequence['outputs.InstanceCustomMetadata']]]:
        return pulumi.get(self, "custom_metadatas")
    ...
    @_builtins.property
    @pulumi.getter(name="indexMethod")
    def index_method(self) -> pulumi.Output['outputs.InstanceIndexMethod']:
        """
        Controls which storage backends are used during indexing. Defaults to vector-only.
        """
        return pulumi.get(self, "index_method")
    ...
    @_builtins.property
    @pulumi.getter(name="indexingOptions")
    def indexing_options(self) -> pulumi.Output['outputs.InstanceIndexingOptions']:
        return pulumi.get(self, "indexing_options")
    ...
    @_builtins.property
    @pulumi.getter(name="publicEndpointParams")
    def public_endpoint_params(self) -> pulumi.Output['outputs.InstancePublicEndpointParams']:
        return pulumi.get(self, "public_endpoint_params")
    ...
    @_builtins.property
    @pulumi.getter(name="retrievalOptions")
    def retrieval_options(self) -> pulumi.Output[Optional['outputs.InstanceRetrievalOptions']]:
        return pulumi.get(self, "retrieval_options")
    ...
    @_builtins.property
    @pulumi.getter(name="sourceParams")
    def source_params(self) -> pulumi.Output['outputs.InstanceSourceParams']:
        return pulumi.get(self, "source_params")
