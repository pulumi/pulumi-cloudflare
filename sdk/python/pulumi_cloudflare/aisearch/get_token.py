...
class GetTokenResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetTokenFilterResult']:
...
def get_token(account_id: Optional[_builtins.str] = None,
              filter: Optional[Union['GetTokenFilterArgs', 'GetTokenFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:aiSearch/token:getToken', __args__, opts=opts, typ=GetTokenResult).value
...
def get_token_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                     filter: pulumi.Input[Optional[Optional[Union['GetTokenFilterArgs', 'GetTokenFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:aiSearch/token:getToken', __args__, opts=opts, typ=GetTokenResult)
