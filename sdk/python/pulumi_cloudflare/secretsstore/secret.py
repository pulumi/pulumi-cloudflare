...
@pulumi.type_token("cloudflare:secretsStore/secret:Secret")
class Secret(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/secretsStoreSecret:SecretsStoreSecret")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["value"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(Secret, __self__).__init__(
            'cloudflare:secretsStore/secret:Secret',
            resource_name,
            __props__,
            opts)
