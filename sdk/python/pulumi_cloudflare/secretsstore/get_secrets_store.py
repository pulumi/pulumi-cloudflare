...
def get_secrets_store(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:secretsStore/secretsStore:getSecretsStore', __args__, opts=opts, typ=GetSecretsStoreResult).value
...
def get_secrets_store_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:secretsStore/secretsStore:getSecretsStore', __args__, opts=opts, typ=GetSecretsStoreResult)
