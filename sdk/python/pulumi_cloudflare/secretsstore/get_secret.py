...
class GetSecretResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetSecretFilterResult']:
...
def get_secret(account_id: Optional[_builtins.str] = None,
               filter: Optional[Union['GetSecretFilterArgs', 'GetSecretFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:secretsStore/secret:getSecret', __args__, opts=opts, typ=GetSecretResult).value
...
def get_secret_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
                      filter: pulumi.Input[Optional[Optional[Union['GetSecretFilterArgs', 'GetSecretFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:secretsStore/secret:getSecret', __args__, opts=opts, typ=GetSecretResult)
