...
class GetSecretsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetSecretsResultResult']:
        """
...
def get_secrets(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:secretsStore/secrets:getSecrets', __args__, opts=opts, typ=GetSecretsResult).value
...
def get_secrets_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:secretsStore/secrets:getSecrets', __args__, opts=opts, typ=GetSecretsResult)
