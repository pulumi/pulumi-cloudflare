...
@pulumi.type_token("cloudflare:secretsStore/secretsStore:SecretsStore")
class SecretsStore(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/secretsStore:SecretsStore")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SecretsStore, __self__).__init__(
            'cloudflare:secretsStore/secretsStore:SecretsStore',
            resource_name,
            __props__,
            opts)
