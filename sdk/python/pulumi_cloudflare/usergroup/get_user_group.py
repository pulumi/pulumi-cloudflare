...
def get_user_group(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:userGroup/userGroup:getUserGroup', __args__, opts=opts, typ=GetUserGroupResult).value
...
def get_user_group_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:userGroup/userGroup:getUserGroup', __args__, opts=opts, typ=GetUserGroupResult)
