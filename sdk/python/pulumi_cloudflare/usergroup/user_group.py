...
@pulumi.type_token("cloudflare:userGroup/userGroup:UserGroup")
class UserGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/userGroup:UserGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(UserGroup, __self__).__init__(
            'cloudflare:userGroup/userGroup:UserGroup',
            resource_name,
            __props__,
            opts)
