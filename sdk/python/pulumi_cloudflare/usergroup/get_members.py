...
def get_members(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:userGroup/members:getMembers', __args__, opts=opts, typ=GetMembersResult).value
...
def get_members_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:userGroup/members:getMembers', __args__, opts=opts, typ=GetMembersResult)
