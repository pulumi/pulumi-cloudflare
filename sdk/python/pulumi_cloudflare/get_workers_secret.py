...
def get_workers_secret(account_id: Optional[str] = None,
    ...
    :param str dispatch_namespace: Name of the Workers for Platforms dispatch namespace.
    :param str script_name: Name of the script, used in URLs and route configuration.
    :param str secret_name: A JavaScript variable name for the secret binding.
    """
    __args__ = dict()
