...
class GetApiTokenPermissionGroupsResult:
    ...
    @property
    @pulumi.getter
    def account(self) -> Mapping[str, builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def r2(self) -> Mapping[str, builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def user(self) -> Mapping[str, builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def zone(self) -> Mapping[str, builtins.str]:
        """
