...
def get_zone(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the zone. Must provide only one of `zone_id`, `name`.
    :param builtins.str zone_id: The zone identifier to target for the resource. Must provide only one of `zone_id`, `name`.
    """
    __args__ = dict()
...
def get_zone_output(account_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
