...
class GetItemResult:
    ...
    @_builtins.property
    @pulumi.getter
    def hostname(self) -> 'outputs.GetItemHostnameResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def redirect(self) -> 'outputs.GetItemRedirectResult':
        """
...
def get_item(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:list/item:getItem', __args__, opts=opts, typ=GetItemResult).value
...
def get_item_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:list/item:getItem', __args__, opts=opts, typ=GetItemResult)
