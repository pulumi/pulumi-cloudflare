...
class GetItemsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetItemsResultResult']:
        """
...
def get_items(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:list/items:getItems', __args__, opts=opts, typ=GetItemsResult).value
...
def get_items_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:list/items:getItems', __args__, opts=opts, typ=GetItemsResult)
