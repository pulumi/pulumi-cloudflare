...
class NotificationPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] alert_type: Refers to which event will trigger a Notification dispatch. You can use the endpoint to get available alert types which then will give you a list of possible values.
