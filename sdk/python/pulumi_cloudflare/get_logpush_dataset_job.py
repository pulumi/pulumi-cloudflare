...
def get_logpush_dataset_job(account_id: Optional[str] = None,
    ...
    :param str dataset_id: Name of the dataset. A list of supported datasets can be found on the [Developer Docs](https://developers.cloudflare.com/logs/reference/log-fields/).
