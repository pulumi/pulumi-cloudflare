...
class GetJobResult:
    ...
    def output_options(self) -> 'outputs.GetJobOutputOptionsResult':
        """
...
def get_job(account_id: Optional[_builtins.str] = None,
    ...
    example_logpush_job = cloudflare.logpush.get_job(job_id=1,
    ...
    :param _builtins.int job_id: Unique id of the job.
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:logpush/job:getJob', __args__, opts=opts, typ=GetJobResult).value
...
def get_job_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:logpush/job:getJob', __args__, opts=opts, typ=GetJobResult)
