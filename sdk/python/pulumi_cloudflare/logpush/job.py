...
class JobArgs:
    def __init__(__self__, *,
                 ...
                 output_options: pulumi.Input[Optional['JobOutputOptionsArgs']] = None,
        ...
        :param pulumi.Input['JobOutputOptionsArgs'] output_options: The structured replacement for `logpull_options`. When including this field, the `logpull_option` field will be ignored.
    ...
    def output_options(self) -> pulumi.Input[Optional['JobOutputOptionsArgs']]:
        """
    ...
    def output_options(self, value: pulumi.Input[Optional['JobOutputOptionsArgs']]):
...
@pulumi.type_token("cloudflare:logpush/job:Job")
class Job(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 max_upload_records: pulumi.Input[Optional[_builtins.int]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 output_options: pulumi.Input[Optional[Union['JobOutputOptionsArgs', 'JobOutputOptionsArgsDict']]] = None,
                 ownership_challenge: pulumi.Input[Optional[_builtins.str]] = None,
                 zone_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.int] max_upload_records: The maximum number of log lines per batch. This setting must be between 1000 and 1,000,000 lines, or `0` to disable it. Note that you cannot specify a minimum number of log lines per batch; this means that log files may contain many fewer lines than this.
        :param pulumi.Input[_builtins.str] name: Optional human readable job name. Not unique. Cloudflare suggests. that you set this to a meaningful string, like the domain name, to make it easier to identify your job.
        :param pulumi.Input[Union['JobOutputOptionsArgs', 'JobOutputOptionsArgsDict']] output_options: The structured replacement for `logpull_options`. When including this field, the `logpull_option` field will be ignored.
        :param pulumi.Input[_builtins.str] ownership_challenge: Ownership challenge token to prove destination ownership.
        :param pulumi.Input[_builtins.str] zone_id: The Zone ID to use for this endpoint. Mutually exclusive with the Account ID.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/logpushJob:LogpushJob")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["destinationConf", "ownershipChallenge"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(Job, __self__).__init__(
            'cloudflare:logpush/job:Job',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            output_options: pulumi.Input[Optional[Union['JobOutputOptionsArgs', 'JobOutputOptionsArgsDict']]] = None,
            ownership_challenge: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Job':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="outputOptions")
    def output_options(self) -> pulumi.Output[Optional['outputs.JobOutputOptions']]:
        """
        The structured replacement for `logpull_options`. When including this field, the `logpull_option` field will be ignored.
        """
        return pulumi.get(self, "output_options")
