...
class GetJobsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetJobsResultResult']:
        """
...
def get_jobs(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:logpush/jobs:getJobs', __args__, opts=opts, typ=GetJobsResult).value
...
def get_jobs_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:logpush/jobs:getJobs', __args__, opts=opts, typ=GetJobsResult)
