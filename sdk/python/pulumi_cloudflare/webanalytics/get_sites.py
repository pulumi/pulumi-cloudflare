...
class GetSitesResult:
    ...
    """
    def __init__(__self__, account_id=None, max_items=None, order_by=None, results=None):
...
def get_sites(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:webAnalytics/sites:getSites', __args__, opts=opts, typ=GetSitesResult).value
...
def get_sites_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:webAnalytics/sites:getSites', __args__, opts=opts, typ=GetSitesResult)
