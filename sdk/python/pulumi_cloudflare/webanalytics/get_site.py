...
class GetSiteResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetSiteFilterResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> Sequence['outputs.GetSiteRuleResult']:
        """
        A list of rules.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def ruleset(self) -> 'outputs.GetSiteRulesetResult':
...
def get_site(account_id: Optional[_builtins.str] = None,
             filter: Optional[Union['GetSiteFilterArgs', 'GetSiteFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:webAnalytics/site:getSite', __args__, opts=opts, typ=GetSiteResult).value
...
def get_site_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                    filter: pulumi.Input[Optional[Optional[Union['GetSiteFilterArgs', 'GetSiteFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:webAnalytics/site:getSite', __args__, opts=opts, typ=GetSiteResult)
