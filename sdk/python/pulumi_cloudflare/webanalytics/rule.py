...
@pulumi.type_token("cloudflare:webAnalytics/rule:Rule")
class Rule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/webAnalyticsRule:WebAnalyticsRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Rule, __self__).__init__(
            'cloudflare:webAnalytics/rule:Rule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            paths: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            priority: pulumi.Input[Optional[_builtins.float]] = None,
            ruleset_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Rule':
        """
