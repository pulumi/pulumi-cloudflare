...
class _SiteState:
    def __init__(__self__, *,
                 ...
                 host: pulumi.Input[Optional[_builtins.str]] = None,
                 lite: pulumi.Input[Optional[_builtins.bool]] = None,
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input['SiteRuleArgs']]]] = None,
                 ruleset: pulumi.Input[Optional['SiteRulesetArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] host: The hostname to use for gray-clouded sites.
        :param pulumi.Input[_builtins.bool] lite: If enabled, the JavaScript snippet will not be injected for visitors from the EU.
        :param pulumi.Input[Sequence[pulumi.Input['SiteRuleArgs']]] rules: A list of rules.
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['SiteRuleArgs']]]]:
        """
        A list of rules.
        """
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['SiteRuleArgs']]]]):
        pulumi.set(self, "rules", value)

    @_builtins.property
    @pulumi.getter
    def ruleset(self) -> pulumi.Input[Optional['SiteRulesetArgs']]:
        return pulumi.get(self, "ruleset")

    @ruleset.setter
    def ruleset(self, value: pulumi.Input[Optional['SiteRulesetArgs']]):
...
@pulumi.type_token("cloudflare:webAnalytics/site:Site")
class Site(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/webAnalyticsSite:WebAnalyticsSite")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Site, __self__).__init__(
            'cloudflare:webAnalytics/site:Site',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            host: pulumi.Input[Optional[_builtins.str]] = None,
            lite: pulumi.Input[Optional[_builtins.bool]] = None,
            rules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['SiteRuleArgs', 'SiteRuleArgsDict']]]]] = None,
            ruleset: pulumi.Input[Optional[Union['SiteRulesetArgs', 'SiteRulesetArgsDict']]] = None,
            site_tag: pulumi.Input[Optional[_builtins.str]] = None,
            site_token: pulumi.Input[Optional[_builtins.str]] = None,
            snippet: pulumi.Input[Optional[_builtins.str]] = None,
            zone_tag: pulumi.Input[Optional[_builtins.str]] = None) -> 'Site':
        """
        ...
        :param pulumi.Input[_builtins.str] host: The hostname to use for gray-clouded sites.
        :param pulumi.Input[_builtins.bool] lite: If enabled, the JavaScript snippet will not be injected for visitors from the EU.
        :param pulumi.Input[Sequence[pulumi.Input[Union['SiteRuleArgs', 'SiteRuleArgsDict']]]] rules: A list of rules.
        :param pulumi.Input[_builtins.str] site_tag: The Web Analytics site identifier.
        :param pulumi.Input[_builtins.str] site_token: The Web Analytics site token.
        :param pulumi.Input[_builtins.str] snippet: Encoded JavaScript snippet.
        :param pulumi.Input[_builtins.str] zone_tag: The zone identifier.
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Output[Sequence['outputs.SiteRule']]:
        """
        A list of rules.
        """
        return pulumi.get(self, "rules")
    ...
    @_builtins.property
    @pulumi.getter
    def ruleset(self) -> pulumi.Output['outputs.SiteRuleset']:
        return pulumi.get(self, "ruleset")
