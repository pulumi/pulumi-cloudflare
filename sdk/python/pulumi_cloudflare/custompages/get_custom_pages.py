...
def get_custom_pages(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:customPages/customPages:getCustomPages', __args__, opts=opts, typ=GetCustomPagesResult).value
...
def get_custom_pages_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:customPages/customPages:getCustomPages', __args__, opts=opts, typ=GetCustomPagesResult)
