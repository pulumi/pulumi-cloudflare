...
def get_settings(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDevice/settings:getSettings', __args__, opts=opts, typ=GetSettingsResult).value
...
def get_settings_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDevice/settings:getSettings', __args__, opts=opts, typ=GetSettingsResult)
