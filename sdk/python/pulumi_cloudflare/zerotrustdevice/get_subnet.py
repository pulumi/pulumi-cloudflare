...
class GetSubnetResult:
    ...
    @_builtins.property
    @pulumi.getter
    def capacity(self) -> 'outputs.GetSubnetCapacityResult':
        """
...
def get_subnet(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDevice/subnet:getSubnet', __args__, opts=opts, typ=GetSubnetResult).value
...
def get_subnet_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDevice/subnet:getSubnet', __args__, opts=opts, typ=GetSubnetResult)
