...
@pulumi.type_token("cloudflare:zeroTrustDevice/settings:Settings")
class Settings(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zeroTrustDeviceSettings:ZeroTrustDeviceSettings")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Settings, __self__).__init__(
            'cloudflare:zeroTrustDevice/settings:Settings',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            gateway_udp_proxy_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
            root_certificate_installation_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
            use_zt_virtual_ip: pulumi.Input[Optional[_builtins.bool]] = None) -> 'Settings':
        """
