...
class GetEmailSecurityTrustedDomainsResult:
    ...
    def trusted_domain_id(self) -> Optional[int]:
        """
        The unique identifier for the trusted domain.
        """
...
def get_email_security_trusted_domains(account_id: Optional[str] = None,
    ...
    :param int trusted_domain_id: The unique identifier for the trusted domain.
    """
    __args__ = dict()
...
def get_email_security_trusted_domains_output(account_id: Optional[pulumi.Input[str]] = None,
                                              ...
                                              trusted_domain_id: Optional[pulumi.Input[Optional[int]]] = None,
