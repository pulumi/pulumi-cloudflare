...
def get_authenticated_origin_pulls_settings(zone_id: Optional[str] = None,
...
def get_authenticated_origin_pulls_settings_output(zone_id: Optional[pulumi.Input[str]] = None,
