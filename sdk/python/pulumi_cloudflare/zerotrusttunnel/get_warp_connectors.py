...
__all__ = [
    'GetWarpConnectorsResult',
    'AwaitableGetWarpConnectorsResult',
    'get_warp_connectors',
    'get_warp_connectors_output',
]

@pulumi.output_type
class GetWarpConnectorsResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetWarpConnectorsResultResult']:
        """
...
class AwaitableGetWarpConnectorsResult(GetWarpConnectorsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWarpConnectorsResult(
...
def get_warp_connectors(account_id: Optional[_builtins.str] = None,
                        ...
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWarpConnectorsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustTunnel/warpConnectors:getWarpConnectors', __args__, opts=opts, typ=GetWarpConnectorsResult).value

    return AwaitableGetWarpConnectorsResult(
...
def get_warp_connectors_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                               exclude_prefix: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                               existed_at: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                               include_prefix: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                               ...
                               was_active_at: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                               was_inactive_at: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWarpConnectorsResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustTunnel/warpConnectors:getWarpConnectors', __args__, opts=opts, typ=GetWarpConnectorsResult)
    return __ret__.apply(lambda __response__: GetWarpConnectorsResult(
