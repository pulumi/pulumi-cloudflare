...
__all__ = [
    'GetCloudflaredsResult',
    'AwaitableGetCloudflaredsResult',
    'get_cloudflareds',
    'get_cloudflareds_output',
]

@pulumi.output_type
class GetCloudflaredsResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetCloudflaredsResultResult']:
        """
...
class AwaitableGetCloudflaredsResult(GetCloudflaredsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudflaredsResult(
...
def get_cloudflareds(account_id: Optional[_builtins.str] = None,
                     ...
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudflaredsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustTunnel/cloudflareds:getCloudflareds', __args__, opts=opts, typ=GetCloudflaredsResult).value

    return AwaitableGetCloudflaredsResult(
...
def get_cloudflareds_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                            ...
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCloudflaredsResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustTunnel/cloudflareds:getCloudflareds', __args__, opts=opts, typ=GetCloudflaredsResult)
    return __ret__.apply(lambda __response__: GetCloudflaredsResult(
