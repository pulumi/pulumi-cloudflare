...
class GetCertificateResult:
    ...
    @_builtins.property
    @pulumi.getter
    def tunnel(self) -> 'outputs.GetCertificateTunnelResult':
        """
...
def get_certificate(keyless_certificate_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:keyless/certificate:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
...
def get_certificate_output(keyless_certificate_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:keyless/certificate:getCertificate', __args__, opts=opts, typ=GetCertificateResult)
