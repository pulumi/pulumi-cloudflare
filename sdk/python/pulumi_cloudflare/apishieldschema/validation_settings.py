...
__all__ = ['ValidationSettingsArgs', 'ValidationSettings']

@pulumi.input_type
class ValidationSettingsArgs:
...
@pulumi.input_type
class _ValidationSettingsState:
    def __init__(__self__, *,
...
@pulumi.type_token("cloudflare:apiShieldSchema/validationSettings:ValidationSettings")
class ValidationSettings(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ValidationSettingsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ValidationSettingsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ValidationSettingsArgs.__new__(ValidationSettingsArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/apiShieldSchemaValidationSettings:ApiShieldSchemaValidationSettings")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ValidationSettings, __self__).__init__(
            'cloudflare:apiShieldSchema/validationSettings:ValidationSettings',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            validation_default_mitigation_action: pulumi.Input[Optional[_builtins.str]] = None,
            validation_override_mitigation_action: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'ValidationSettings':
        """
        ...
        __props__ = _ValidationSettingsState.__new__(_ValidationSettingsState)

        __props__.__dict__["validation_default_mitigation_action"] = validation_default_mitigation_action
        __props__.__dict__["validation_override_mitigation_action"] = validation_override_mitigation_action
        __props__.__dict__["zone_id"] = zone_id
        return ValidationSettings(resource_name, opts=opts, __props__=__props__)
