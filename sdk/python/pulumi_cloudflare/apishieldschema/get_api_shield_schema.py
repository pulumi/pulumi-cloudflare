...
def get_api_shield_schema(omit_source: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:apiShieldSchema/apiShieldSchema:getApiShieldSchema', __args__, opts=opts, typ=GetApiShieldSchemaResult).value
...
def get_api_shield_schema_output(omit_source: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:apiShieldSchema/apiShieldSchema:getApiShieldSchema', __args__, opts=opts, typ=GetApiShieldSchemaResult)
