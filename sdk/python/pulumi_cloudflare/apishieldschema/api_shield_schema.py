...
@pulumi.type_token("cloudflare:apiShieldSchema/apiShieldSchema:ApiShieldSchema")
class ApiShieldSchema(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/apiShieldSchema:ApiShieldSchema")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiShieldSchema, __self__).__init__(
            'cloudflare:apiShieldSchema/apiShieldSchema:ApiShieldSchema',
            resource_name,
            __props__,
            opts)
