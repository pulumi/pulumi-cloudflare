...
class GetPoolResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetPoolFilterResult']:
    ...
    def load_shedding(self) -> 'outputs.GetPoolLoadSheddingResult':
        """
    ...
    def notification_filter(self) -> 'outputs.GetPoolNotificationFilterResult':
        """
    ...
    def origin_steering(self) -> 'outputs.GetPoolOriginSteeringResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def origins(self) -> Sequence['outputs.GetPoolOriginResult']:
        """
...
def get_pool(account_id: Optional[_builtins.str] = None,
             filter: Optional[Union['GetPoolFilterArgs', 'GetPoolFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:loadBalancer/pool:getPool', __args__, opts=opts, typ=GetPoolResult).value
...
def get_pool_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                    filter: pulumi.Input[Optional[Optional[Union['GetPoolFilterArgs', 'GetPoolFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:loadBalancer/pool:getPool', __args__, opts=opts, typ=GetPoolResult)
