...
class PoolArgs:
    def __init__(__self__, *,
                 ...
                 origins: pulumi.Input[Sequence[pulumi.Input['PoolOriginArgs']]],
                 ...
                 load_shedding: pulumi.Input[Optional['PoolLoadSheddingArgs']] = None,
                 ...
                 notification_filter: pulumi.Input[Optional['PoolNotificationFilterArgs']] = None,
                 origin_steering: pulumi.Input[Optional['PoolOriginSteeringArgs']] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PoolOriginArgs']]] origins: The list of origins within this pool. Traffic directed at this pool is balanced across all currently healthy origins, provided the pool itself is healthy.
        ...
        :param pulumi.Input['PoolLoadSheddingArgs'] load_shedding: Configures load shedding policies and percentages for the pool.
        ...
        :param pulumi.Input['PoolNotificationFilterArgs'] notification_filter: Filter pool and origin health notifications by resource type or health status. Use null to reset.
        :param pulumi.Input['PoolOriginSteeringArgs'] origin_steering: Configures origin steering for the pool. Controls how origins are selected for new sessions and traffic without session affinity.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def origins(self) -> pulumi.Input[Sequence[pulumi.Input['PoolOriginArgs']]]:
        """
    ...
    @origins.setter
    def origins(self, value: pulumi.Input[Sequence[pulumi.Input['PoolOriginArgs']]]):
    ...
    def load_shedding(self) -> pulumi.Input[Optional['PoolLoadSheddingArgs']]:
        """
    ...
    def load_shedding(self, value: pulumi.Input[Optional['PoolLoadSheddingArgs']]):
    ...
    def notification_filter(self) -> pulumi.Input[Optional['PoolNotificationFilterArgs']]:
        """
    ...
    def notification_filter(self, value: pulumi.Input[Optional['PoolNotificationFilterArgs']]):
        pulumi.set(self, "notification_filter", value)

    @_builtins.property
    @pulumi.getter(name="originSteering")
    def origin_steering(self) -> pulumi.Input[Optional['PoolOriginSteeringArgs']]:
        """
    ...
    def origin_steering(self, value: pulumi.Input[Optional['PoolOriginSteeringArgs']]):
...
class _PoolState:
    def __init__(__self__, *,
                 ...
                 notification_filter: pulumi.Input[Optional['PoolNotificationFilterArgs']] = None,
                 origin_steering: pulumi.Input[Optional['PoolOriginSteeringArgs']] = None,
                 origins: pulumi.Input[Optional[Sequence[pulumi.Input['PoolOriginArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def origins(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PoolOriginArgs']]]]:
        """
        The list of origins within this pool. Traffic directed at this pool is balanced across all currently healthy origins, provided the pool itself is healthy.
        """
        return pulumi.get(self, "origins")
    ...
    @origins.setter
    def origins(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PoolOriginArgs']]]]):
        pulumi.set(self, "origins", value)


@pulumi.type_token("cloudflare:loadBalancer/pool:Pool")
class Pool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 latitude: pulumi.Input[Optional[_builtins.float]] = None,
                 load_shedding: pulumi.Input[Optional[Union['PoolLoadSheddingArgs', 'PoolLoadSheddingArgsDict']]] = None,
                 longitude: pulumi.Input[Optional[_builtins.float]] = None,
                 minimum_origins: pulumi.Input[Optional[_builtins.int]] = None,
                 monitor: pulumi.Input[Optional[_builtins.str]] = None,
                 monitor_group: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 notification_email: pulumi.Input[Optional[_builtins.str]] = None,
                 notification_filter: pulumi.Input[Optional[Union['PoolNotificationFilterArgs', 'PoolNotificationFilterArgsDict']]] = None,
                 origin_steering: pulumi.Input[Optional[Union['PoolOriginSteeringArgs', 'PoolOriginSteeringArgsDict']]] = None,
                 origins: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PoolOriginArgs', 'PoolOriginArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.bool] enabled: Whether to enable (the default) or disable this pool. Disabled pools will not receive traffic and are excluded from health checks. Disabling a pool will cause any load balancers using it to failover to the next pool (if any).
        :param pulumi.Input[_builtins.float] latitude: The latitude of the data center containing the origins used in this pool in decimal degrees. If this is set, longitude must also be set.
        :param pulumi.Input[Union['PoolLoadSheddingArgs', 'PoolLoadSheddingArgsDict']] load_shedding: Configures load shedding policies and percentages for the pool.
        :param pulumi.Input[_builtins.float] longitude: The longitude of the data center containing the origins used in this pool in decimal degrees. If this is set, latitude must also be set.
        :param pulumi.Input[_builtins.int] minimum_origins: The minimum number of origins that must be healthy for this pool to serve traffic. If the number of healthy origins falls below this number, the pool will be marked unhealthy and will failover to the next available pool.
        :param pulumi.Input[_builtins.str] monitor: The ID of the Monitor to use for checking the health of origins within this pool.
        :param pulumi.Input[_builtins.str] monitor_group: The ID of the Monitor Group to use for checking the health of origins within this pool.
        :param pulumi.Input[_builtins.str] name: A short name (tag) for the pool. Only alphanumeric characters, hyphens, and underscores are allowed.
        :param pulumi.Input[_builtins.str] notification_email: This field is now deprecated. It has been moved to Cloudflare's Centralized Notification service https://developers.cloudflare.com/fundamentals/notifications/. The email address to send health status notifications to. This can be an individual mailbox or a mailing list. Multiple emails can be supplied as a comma delimited list.
        :param pulumi.Input[Union['PoolNotificationFilterArgs', 'PoolNotificationFilterArgsDict']] notification_filter: Filter pool and origin health notifications by resource type or health status. Use null to reset.
        :param pulumi.Input[Union['PoolOriginSteeringArgs', 'PoolOriginSteeringArgsDict']] origin_steering: Configures origin steering for the pool. Controls how origins are selected for new sessions and traffic without session affinity.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PoolOriginArgs', 'PoolOriginArgsDict']]]] origins: The list of origins within this pool. Traffic directed at this pool is balanced across all currently healthy origins, provided the pool itself is healthy.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/loadBalancerPool:LoadBalancerPool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Pool, __self__).__init__(
            'cloudflare:loadBalancer/pool:Pool',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            notification_filter: pulumi.Input[Optional[Union['PoolNotificationFilterArgs', 'PoolNotificationFilterArgsDict']]] = None,
            origin_steering: pulumi.Input[Optional[Union['PoolOriginSteeringArgs', 'PoolOriginSteeringArgsDict']]] = None,
            origins: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PoolOriginArgs', 'PoolOriginArgsDict']]]]] = None) -> 'Pool':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="loadShedding")
    def load_shedding(self) -> pulumi.Output['outputs.PoolLoadShedding']:
        """
        Configures load shedding policies and percentages for the pool.
        """
        return pulumi.get(self, "load_shedding")
    ...
    @_builtins.property
    @pulumi.getter(name="notificationFilter")
    def notification_filter(self) -> pulumi.Output['outputs.PoolNotificationFilter']:
        """
        Filter pool and origin health notifications by resource type or health status. Use null to reset.
        """
        return pulumi.get(self, "notification_filter")
    ...
    @_builtins.property
    @pulumi.getter(name="originSteering")
    def origin_steering(self) -> pulumi.Output['outputs.PoolOriginSteering']:
        """
        Configures origin steering for the pool. Controls how origins are selected for new sessions and traffic without session affinity.
        """
        return pulumi.get(self, "origin_steering")
    ...
    @_builtins.property
    @pulumi.getter
    def origins(self) -> pulumi.Output[Sequence['outputs.PoolOrigin']]:
        """
        The list of origins within this pool. Traffic directed at this pool is balanced across all currently healthy origins, provided the pool itself is healthy.
        """
        return pulumi.get(self, "origins")
