...
def get_load_balancer(load_balancer_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:loadBalancer/loadBalancer:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult).value
...
def get_load_balancer_output(load_balancer_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:loadBalancer/loadBalancer:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult)
