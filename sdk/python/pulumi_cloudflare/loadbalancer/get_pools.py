...
class GetPoolsResult:
    ...
    """
    def __init__(__self__, account_id=None, max_items=None, monitor=None, results=None):
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetPoolsResultResult']:
        """
...
def get_pools(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:loadBalancer/pools:getPools', __args__, opts=opts, typ=GetPoolsResult).value
...
def get_pools_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                     max_items: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                     monitor: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:loadBalancer/pools:getPools', __args__, opts=opts, typ=GetPoolsResult)
