...
@pulumi.type_token("cloudflare:loadBalancer/loadBalancer:LoadBalancer")
class LoadBalancer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/loadBalancer:LoadBalancer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LoadBalancer, __self__).__init__(
            'cloudflare:loadBalancer/loadBalancer:LoadBalancer',
            resource_name,
            __props__,
            opts)
