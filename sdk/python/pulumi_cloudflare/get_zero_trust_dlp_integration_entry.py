...
__all__ = [
    'GetZeroTrustDlpIntegrationEntryResult',
    'AwaitableGetZeroTrustDlpIntegrationEntryResult',
    'get_zero_trust_dlp_integration_entry',
...
class GetZeroTrustDlpIntegrationEntryResult:
    ...
    """
    def __init__(__self__, account_id=None, case_sensitive=None, confidence=None, created_at=None, deprecated=None, description=None, enabled=None, entry_id=None, id=None, name=None, pattern=None, profile_id=None, profiles=None, secret=None, type=None, updated_at=None, upload_status=None, variant=None, word_list=None):
    ...
    @_builtins.property
    @pulumi.getter
    def confidence(self) -> 'outputs.GetZeroTrustDlpIntegrationEntryConfidenceResult':
    ...
    @_builtins.property
    @pulumi.getter
    def pattern(self) -> 'outputs.GetZeroTrustDlpIntegrationEntryPatternResult':
    ...
    @_builtins.property
    @pulumi.getter
    def profiles(self) -> Sequence['outputs.GetZeroTrustDlpIntegrationEntryProfileResult']:
...
class AwaitableGetZeroTrustDlpIntegrationEntryResult(GetZeroTrustDlpIntegrationEntryResult):
...
def get_zero_trust_dlp_integration_entry(account_id: Optional[_builtins.str] = None,
                                         entry_id: Optional[_builtins.str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetZeroTrustDlpIntegrationEntryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustDlpIntegrationEntry:getZeroTrustDlpIntegrationEntry', __args__, opts=opts, typ=GetZeroTrustDlpIntegrationEntryResult).value

    return AwaitableGetZeroTrustDlpIntegrationEntryResult(
...
def get_zero_trust_dlp_integration_entry_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                                entry_id: pulumi.Input[Optional[_builtins.str]] = None,
                                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetZeroTrustDlpIntegrationEntryResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustDlpIntegrationEntry:getZeroTrustDlpIntegrationEntry', __args__, opts=opts, typ=GetZeroTrustDlpIntegrationEntryResult)
    return __ret__.apply(lambda __response__: GetZeroTrustDlpIntegrationEntryResult(
