...
def get_rule(rule_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:firewall/rule:getRule', __args__, opts=opts, typ=GetRuleResult).value
...
def get_rule_output(rule_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:firewall/rule:getRule', __args__, opts=opts, typ=GetRuleResult)
