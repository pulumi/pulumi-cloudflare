...
class GetRulesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetRulesResultResult']:
        """
...
def get_rules(action: Optional[_builtins.str] = None,
    ...
    example_firewall_rules = cloudflare.firewall.get_rules(zone_id="023e105f4ecef8ad9ca31a8372d0c353",
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:firewall/rules:getRules', __args__, opts=opts, typ=GetRulesResult).value
...
def get_rules_output(action: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:firewall/rules:getRules', __args__, opts=opts, typ=GetRulesResult)
