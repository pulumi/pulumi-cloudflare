...
@pulumi.type_token("cloudflare:zeroTrustDeviceIp/profile:Profile")
class Profile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zeroTrustDeviceIpProfile:ZeroTrustDeviceIpProfile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Profile, __self__).__init__(
            'cloudflare:zeroTrustDeviceIp/profile:Profile',
            resource_name,
            __props__,
            opts)
