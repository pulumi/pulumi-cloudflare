...
class GetProfileResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetProfileFilterResult']:
...
def get_profile(account_id: Optional[_builtins.str] = None,
                filter: Optional[Union['GetProfileFilterArgs', 'GetProfileFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDeviceIp/profile:getProfile', __args__, opts=opts, typ=GetProfileResult).value
...
def get_profile_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                       filter: pulumi.Input[Optional[Optional[Union['GetProfileFilterArgs', 'GetProfileFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDeviceIp/profile:getProfile', __args__, opts=opts, typ=GetProfileResult)
