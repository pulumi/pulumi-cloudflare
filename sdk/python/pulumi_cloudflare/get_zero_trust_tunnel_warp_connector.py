...
def get_zero_trust_tunnel_warp_connector(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustTunnelWarpConnector:getZeroTrustTunnelWarpConnector', __args__, opts=opts, typ=GetZeroTrustTunnelWarpConnectorResult).value
...
def get_zero_trust_tunnel_warp_connector_output(account_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustTunnelWarpConnector:getZeroTrustTunnelWarpConnector', __args__, opts=opts, typ=GetZeroTrustTunnelWarpConnectorResult)
