...
class SchemaValidationOperationSettingsArgs:
    def __init__(__self__, *,
                 mitigation_action: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] mitigation_action: When set, this applies a mitigation action to this operation - `"log"` - log request when request does not conform to
    ...
    def mitigation_action(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def mitigation_action(self, value: pulumi.Input[builtins.str]):
...
class SchemaValidationOperationSettings(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            mitigation_action: Optional[pulumi.Input[builtins.str]] = None,
            operation_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SchemaValidationOperationSettings':
        """
    ...
    @property
    @pulumi.getter(name="mitigationAction")
    def mitigation_action(self) -> pulumi.Output[builtins.str]:
        """
        When set, this applies a mitigation action to this operation - `"log"` - log request when request does not conform to
        schema for this operation - `"block"` - deny access to the site when request does not conform to schema for this
        operation - `"none"` - will skip mitigation for this operation - `null` - clears any mitigation action Available values:
