...
__all__ = [
    'GetZeroTrustTunnelWarpConnectorsResult',
    'AwaitableGetZeroTrustTunnelWarpConnectorsResult',
    'get_zero_trust_tunnel_warp_connectors',
...
class GetZeroTrustTunnelWarpConnectorsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetZeroTrustTunnelWarpConnectorsResultResult']:
        """
...
class AwaitableGetZeroTrustTunnelWarpConnectorsResult(GetZeroTrustTunnelWarpConnectorsResult):
...
def get_zero_trust_tunnel_warp_connectors(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustTunnelWarpConnectors:getZeroTrustTunnelWarpConnectors', __args__, opts=opts, typ=GetZeroTrustTunnelWarpConnectorsResult).value

    return AwaitableGetZeroTrustTunnelWarpConnectorsResult(
...
def get_zero_trust_tunnel_warp_connectors_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustTunnelWarpConnectors:getZeroTrustTunnelWarpConnectors', __args__, opts=opts, typ=GetZeroTrustTunnelWarpConnectorsResult)
    return __ret__.apply(lambda __response__: GetZeroTrustTunnelWarpConnectorsResult(
