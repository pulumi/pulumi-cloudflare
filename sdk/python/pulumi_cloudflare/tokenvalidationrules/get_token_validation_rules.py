...
def get_token_validation_rules(filter: Optional[Union['GetTokenValidationRulesFilterArgs', 'GetTokenValidationRulesFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:tokenValidationRules/tokenValidationRules:getTokenValidationRules', __args__, opts=opts, typ=GetTokenValidationRulesResult).value
...
def get_token_validation_rules_output(filter: pulumi.Input[Optional[Optional[Union['GetTokenValidationRulesFilterArgs', 'GetTokenValidationRulesFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:tokenValidationRules/tokenValidationRules:getTokenValidationRules', __args__, opts=opts, typ=GetTokenValidationRulesResult)
