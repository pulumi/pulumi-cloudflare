...
class ZeroTrustRiskScoreIntegrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] integration_type: The type of integration, e.g. 'Okta'. Full list of allowed values can be found here: https://developers.cloudflare.com/api/operations/dlp-zt-risk-score-integration-create#request-body
        :param pulumi.Input[builtins.str] tenant_url: The base url of the tenant, e.g. 'https://tenant.okta.com'. Must be your Okta Tenant URL and not your custom domain.
        ...
        :param pulumi.Input[builtins.str] reference_id: A reference id that can be supplied by the client. Currently this should be set to the Access-Okta IDP ID (a UUIDv4). If omitted, a random UUIDv4 is used. https://developers.cloudflare.com/api/operations/access-identity-providers-get-an-access-identity-provider
        """
...
class ZeroTrustRiskScoreIntegration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reference_id: Optional[pulumi.Input[builtins.str]] = None,
            tenant_url: Optional[pulumi.Input[builtins.str]] = None,
            well_known_url: Optional[pulumi.Input[builtins.str]] = None) -> 'ZeroTrustRiskScoreIntegration':
        """
    ...
    @property
    @pulumi.getter(name="referenceId")
    def reference_id(self) -> pulumi.Output[builtins.str]:
        """
        A reference id that can be supplied by the client. Currently this should be set to the Access-Okta IDP ID (a UUIDv4). If omitted, a random UUIDv4 is used. https://developers.cloudflare.com/api/operations/access-identity-providers-get-an-access-identity-provider
        """
        return pulumi.get(self, "reference_id")
