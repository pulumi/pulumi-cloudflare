...
def get_address_maps(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getAddressMaps:getAddressMaps', __args__, opts=opts, typ=GetAddressMapsResult).value
...
def get_address_maps_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getAddressMaps:getAddressMaps', __args__, opts=opts, typ=GetAddressMapsResult)
