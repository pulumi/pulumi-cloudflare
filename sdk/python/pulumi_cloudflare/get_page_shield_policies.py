...
def get_page_shield_policies(max_items: Optional[builtins.int] = None,
...
def get_page_shield_policies_output(max_items: Optional[pulumi.Input[Optional[builtins.int]]] = None,
