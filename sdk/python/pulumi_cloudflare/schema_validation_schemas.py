...
class SchemaValidationSchemasArgs:
    def __init__(__self__, *,
                 ...
                 validation_enabled: pulumi.Input[builtins.bool],
                 zone_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a SchemaValidationSchemas resource.
        :param pulumi.Input[builtins.str] kind: The kind of the schema
               Available values: "openapi_v3".
        :param pulumi.Input[builtins.str] name: A human-readable name for the schema
        :param pulumi.Input[builtins.str] source: The raw schema, e.g., the OpenAPI schema, either as JSON or YAML
        :param pulumi.Input[builtins.bool] validation_enabled: An indicator if this schema is enabled
    ...
    def validation_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def validation_enabled(self, value: pulumi.Input[builtins.bool]):
...
class _SchemaValidationSchemasState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kind: The kind of the schema
               Available values: "openapi_v3".
        :param pulumi.Input[builtins.str] name: A human-readable name for the schema
        :param pulumi.Input[builtins.str] schema_id: A unique identifier of this schema
        :param pulumi.Input[builtins.str] source: The raw schema, e.g., the OpenAPI schema, either as JSON or YAML
        :param pulumi.Input[builtins.bool] validation_enabled: An indicator if this schema is enabled
        :param pulumi.Input[builtins.str] zone_id: Identifier.
        """
...
class SchemaValidationSchemas(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source: Optional[pulumi.Input[builtins.str]] = None,
            validation_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SchemaValidationSchemas':
        """
    ...
    @property
    @pulumi.getter(name="validationEnabled")
    def validation_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        An indicator if this schema is enabled
        """
        return pulumi.get(self, "validation_enabled")
