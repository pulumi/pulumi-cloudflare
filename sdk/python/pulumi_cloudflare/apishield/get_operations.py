...
def get_operations(direction: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:apiShield/operations:getOperations', __args__, opts=opts, typ=GetOperationsResult).value
...
def get_operations_output(direction: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:apiShield/operations:getOperations', __args__, opts=opts, typ=GetOperationsResult)
