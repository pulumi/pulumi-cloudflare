...
class GetSchemasResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetSchemasResultResult']:
        """
...
def get_schemas(max_items: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:apiShield/schemas:getSchemas', __args__, opts=opts, typ=GetSchemasResult).value
...
def get_schemas_output(max_items: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:apiShield/schemas:getSchemas', __args__, opts=opts, typ=GetSchemasResult)
