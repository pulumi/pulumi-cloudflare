...
@pulumi.type_token("cloudflare:apiShield/apiShield:ApiShield")
class ApiShield(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/apiShield:ApiShield")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiShield, __self__).__init__(
            'cloudflare:apiShield/apiShield:ApiShield',
            resource_name,
            __props__,
            opts)
