...
def get_api_shield(normalize: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:apiShield/apiShield:getApiShield', __args__, opts=opts, typ=GetApiShieldResult).value
...
def get_api_shield_output(normalize: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:apiShield/apiShield:getApiShield', __args__, opts=opts, typ=GetApiShieldResult)
