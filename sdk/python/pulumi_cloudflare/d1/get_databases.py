...
class GetDatabasesResult:
    ...
    """
    def __init__(__self__, account_id=None, max_items=None, name=None, results=None):
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetDatabasesResultResult']:
        """
...
def get_databases(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:d1/databases:getDatabases', __args__, opts=opts, typ=GetDatabasesResult).value
...
def get_databases_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:d1/databases:getDatabases', __args__, opts=opts, typ=GetDatabasesResult)
