...
class GetDatabaseResult:
    ...
    def read_replication(self) -> 'outputs.GetDatabaseReadReplicationResult':
        """
...
def get_database(account_id: Optional[_builtins.str] = None,
                 database_id: Optional[_builtins.str] = None,
                 fields: Optional[Sequence[_builtins.str]] = None,
                 filter: Optional[Union['GetDatabaseFilterArgs', 'GetDatabaseFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:d1/database:getDatabase', __args__, opts=opts, typ=GetDatabaseResult).value
...
def get_database_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                        ...
                        filter: pulumi.Input[Optional[Optional[Union['GetDatabaseFilterArgs', 'GetDatabaseFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:d1/database:getDatabase', __args__, opts=opts, typ=GetDatabaseResult)
