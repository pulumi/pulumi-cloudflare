...
class DatabaseArgs:
    def __init__(__self__, *,
                 ...
                 read_replication: pulumi.Input[Optional['DatabaseReadReplicationArgs']] = None):
        """
        ...
        :param pulumi.Input['DatabaseReadReplicationArgs'] read_replication: Configuration for D1 read replication.
        """
    ...
    def read_replication(self) -> pulumi.Input[Optional['DatabaseReadReplicationArgs']]:
        """
    ...
    def read_replication(self, value: pulumi.Input[Optional['DatabaseReadReplicationArgs']]):
...
@pulumi.type_token("cloudflare:d1/database:Database")
class Database(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 primary_location_hint: pulumi.Input[Optional[_builtins.str]] = None,
                 read_replication: pulumi.Input[Optional[Union['DatabaseReadReplicationArgs', 'DatabaseReadReplicationArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] primary_location_hint: Specify the region to create the D1 primary, if available. If this option is omitted, the D1 will be created as close as possible to the current user.
               Available values: "wnam", "enam", "weur", "eeur", "apac", "oc".
        :param pulumi.Input[Union['DatabaseReadReplicationArgs', 'DatabaseReadReplicationArgsDict']] read_replication: Configuration for D1 read replication.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/d1Database:D1Database")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Database, __self__).__init__(
            'cloudflare:d1/database:Database',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            read_replication: pulumi.Input[Optional[Union['DatabaseReadReplicationArgs', 'DatabaseReadReplicationArgsDict']]] = None,
            uuid: pulumi.Input[Optional[_builtins.str]] = None,
            version: pulumi.Input[Optional[_builtins.str]] = None) -> 'Database':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="readReplication")
    def read_replication(self) -> pulumi.Output[Optional['outputs.DatabaseReadReplication']]:
        """
        Configuration for D1 read replication.
        """
        return pulumi.get(self, "read_replication")
