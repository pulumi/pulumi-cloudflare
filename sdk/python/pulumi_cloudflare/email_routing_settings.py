...
class EmailRoutingSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: State of the zone settings for Email Routing. **Modifying this attribute will force creation of a new resource.**
...
class _EmailRoutingSettingsState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] tag: Email Routing settings identifier.
        :param pulumi.Input[builtins.str] zone_id: The zone identifier to target for the resource. **Modifying this attribute will force creation of a new resource.**
        """
