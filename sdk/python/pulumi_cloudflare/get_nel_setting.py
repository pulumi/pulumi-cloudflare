...
__all__ = [
    'GetNelSettingResult',
    'AwaitableGetNelSettingResult',
    'get_nel_setting',
    'get_nel_setting_output',
]
...
class GetNelSettingResult:
    ...
    @_builtins.property
    @pulumi.getter
    def value(self) -> 'outputs.GetNelSettingValueResult':
        """
...
class AwaitableGetNelSettingResult(GetNelSettingResult):
...
def get_nel_setting(zone_id: Optional[_builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNelSettingResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getNelSetting:getNelSetting', __args__, opts=opts, typ=GetNelSettingResult).value

    return AwaitableGetNelSettingResult(
        editable=pulumi.get(__ret__, 'editable'),
        id=pulumi.get(__ret__, 'id'),
        modified_on=pulumi.get(__ret__, 'modified_on'),
        value=pulumi.get(__ret__, 'value'),
        zone_id=pulumi.get(__ret__, 'zone_id'))
def get_nel_setting_output(zone_id: pulumi.Input[Optional[_builtins.str]] = None,
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetNelSettingResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getNelSetting:getNelSetting', __args__, opts=opts, typ=GetNelSettingResult)
    return __ret__.apply(lambda __response__: GetNelSettingResult(
