...
def get_profile(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDlpPredefined/profile:getProfile', __args__, opts=opts, typ=GetProfileResult).value
...
def get_profile_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDlpPredefined/profile:getProfile', __args__, opts=opts, typ=GetProfileResult)
