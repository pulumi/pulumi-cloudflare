...
class GetEntryResult:
    ...
    @_builtins.property
    @pulumi.getter
    def confidence(self) -> 'outputs.GetEntryConfidenceResult':
    ...
    @_builtins.property
    @pulumi.getter
    def pattern(self) -> 'outputs.GetEntryPatternResult':
    ...
    @_builtins.property
    @pulumi.getter
    def profiles(self) -> Sequence['outputs.GetEntryProfileResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def variant(self) -> 'outputs.GetEntryVariantResult':
        """
...
def get_entry(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDlpPredefined/entry:getEntry', __args__, opts=opts, typ=GetEntryResult).value
...
def get_entry_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                     entry_id: pulumi.Input[Optional[_builtins.str]] = None,
                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEntryResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDlpPredefined/entry:getEntry', __args__, opts=opts, typ=GetEntryResult)
    return __ret__.apply(lambda __response__: GetEntryResult(
