...
class _EntryState:
    def __init__(__self__, *,
                 ...
                 confidence: pulumi.Input[Optional['EntryConfidenceArgs']] = None,
                 created_at: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 entry_id: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 pattern: pulumi.Input[Optional['EntryPatternArgs']] = None,
                 profile_id: pulumi.Input[Optional[_builtins.str]] = None,
                 profiles: pulumi.Input[Optional[Sequence[pulumi.Input['EntryProfileArgs']]]] = None,
                 ...
                 variant: pulumi.Input[Optional['EntryVariantArgs']] = None,
        ...
        :param pulumi.Input['EntryVariantArgs'] variant: A Predefined AI prompt classification topic entry.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def confidence(self) -> pulumi.Input[Optional['EntryConfidenceArgs']]:
        return pulumi.get(self, "confidence")

    @confidence.setter
    def confidence(self, value: pulumi.Input[Optional['EntryConfidenceArgs']]):
    ...
    @_builtins.property
    @pulumi.getter
    def pattern(self) -> pulumi.Input[Optional['EntryPatternArgs']]:
        return pulumi.get(self, "pattern")

    @pattern.setter
    def pattern(self, value: pulumi.Input[Optional['EntryPatternArgs']]):
    ...
    @_builtins.property
    @pulumi.getter
    def profiles(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['EntryProfileArgs']]]]:
        return pulumi.get(self, "profiles")

    @profiles.setter
    def profiles(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['EntryProfileArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def variant(self) -> pulumi.Input[Optional['EntryVariantArgs']]:
        """
    ...
    @variant.setter
    def variant(self, value: pulumi.Input[Optional['EntryVariantArgs']]):
...
@pulumi.type_token("cloudflare:zeroTrustDlpPredefined/entry:Entry")
class Entry(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_zero_trust_dlp_predefined_entry = cloudflare.zerotrustdlppredefined.Entry("example_zero_trust_dlp_predefined_entry",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zeroTrustDlpPredefinedEntry:ZeroTrustDlpPredefinedEntry")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Entry, __self__).__init__(
            'cloudflare:zeroTrustDlpPredefined/entry:Entry',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            account_id: pulumi.Input[Optional[_builtins.str]] = None,
            case_sensitive: pulumi.Input[Optional[_builtins.bool]] = None,
            confidence: pulumi.Input[Optional[Union['EntryConfidenceArgs', 'EntryConfidenceArgsDict']]] = None,
            created_at: pulumi.Input[Optional[_builtins.str]] = None,
            description: pulumi.Input[Optional[_builtins.str]] = None,
            enabled: pulumi.Input[Optional[_builtins.bool]] = None,
            entry_id: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            pattern: pulumi.Input[Optional[Union['EntryPatternArgs', 'EntryPatternArgsDict']]] = None,
            profile_id: pulumi.Input[Optional[_builtins.str]] = None,
            profiles: pulumi.Input[Optional[Sequence[pulumi.Input[Union['EntryProfileArgs', 'EntryProfileArgsDict']]]]] = None,
            secret: pulumi.Input[Optional[_builtins.bool]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None,
            updated_at: pulumi.Input[Optional[_builtins.str]] = None,
            upload_status: pulumi.Input[Optional[_builtins.str]] = None,
            variant: pulumi.Input[Optional[Union['EntryVariantArgs', 'EntryVariantArgsDict']]] = None,
            word_list: pulumi.Input[Optional[_builtins.str]] = None) -> 'Entry':
        """
        ...
        :param pulumi.Input[_builtins.str] type: Available values: "custom", "custom*prompt*topic", "predefined", "integration", "exact*data", "document*fingerprint", "word_list".
        :param pulumi.Input[_builtins.str] upload_status: Available values: "empty", "uploading", "pending", "processing", "failed", "complete".
        :param pulumi.Input[Union['EntryVariantArgs', 'EntryVariantArgsDict']] variant: A Predefined AI prompt classification topic entry.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def confidence(self) -> pulumi.Output['outputs.EntryConfidence']:
        return pulumi.get(self, "confidence")
    ...
    @_builtins.property
    @pulumi.getter
    def pattern(self) -> pulumi.Output['outputs.EntryPattern']:
        return pulumi.get(self, "pattern")
    ...
    @_builtins.property
    @pulumi.getter
    def profiles(self) -> pulumi.Output[Sequence['outputs.EntryProfile']]:
        return pulumi.get(self, "profiles")
    ...
    @_builtins.property
    @pulumi.getter
    def variant(self) -> pulumi.Output['outputs.EntryVariant']:
        """
        A Predefined AI prompt classification topic entry.
        """
        return pulumi.get(self, "variant")
