...
class WorkersSecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the Worker secret. **Modifying this attribute will force creation of a new resource.**
        :param pulumi.Input[builtins.str] script_name: The name of the Worker script to associate the secret with. **Modifying this attribute will force creation of a new resource.**
        :param pulumi.Input[builtins.str] secret_text: The text of the Worker secret. **Modifying this attribute will force creation of a new resource.**
        """
...
class WorkersSecret(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            script_name: Optional[pulumi.Input[builtins.str]] = None,
            secret_text: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkersSecret':
        """
