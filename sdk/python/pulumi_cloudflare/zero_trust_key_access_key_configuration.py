...
__all__ = ['ZeroTrustKeyAccessKeyConfigurationArgs', 'ZeroTrustKeyAccessKeyConfiguration']

@pulumi.input_type
class ZeroTrustKeyAccessKeyConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] key_rotation_interval_days: Number of days to trigger a rotation of the keys.
        """
...
@pulumi.input_type
class _ZeroTrustKeyAccessKeyConfigurationState:
    def __init__(__self__, *,
...
class ZeroTrustKeyAccessKeyConfiguration(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ZeroTrustKeyAccessKeyConfigurationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ZeroTrustKeyAccessKeyConfigurationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ZeroTrustKeyAccessKeyConfigurationArgs.__new__(ZeroTrustKeyAccessKeyConfigurationArgs)

            if account_id is None and not opts.urn:
                raise TypeError("Missing required property 'account_id'")
            __props__.__dict__["account_id"] = account_id
            __props__.__dict__["key_rotation_interval_days"] = key_rotation_interval_days
        super(ZeroTrustKeyAccessKeyConfiguration, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            account_id: Optional[pulumi.Input[builtins.str]] = None,
            key_rotation_interval_days: Optional[pulumi.Input[builtins.int]] = None) -> 'ZeroTrustKeyAccessKeyConfiguration':
        """
        ...
        __props__ = _ZeroTrustKeyAccessKeyConfigurationState.__new__(_ZeroTrustKeyAccessKeyConfigurationState)

        __props__.__dict__["account_id"] = account_id
        __props__.__dict__["key_rotation_interval_days"] = key_rotation_interval_days
        return ZeroTrustKeyAccessKeyConfiguration(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="keyRotationIntervalDays")
    def key_rotation_interval_days(self) -> pulumi.Output[builtins.int]:
        """
        Number of days to trigger a rotation of the keys.
        """
        return pulumi.get(self, "key_rotation_interval_days")
