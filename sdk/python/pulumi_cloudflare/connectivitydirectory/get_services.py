...
class GetServicesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetServicesResultResult']:
        """
...
def get_services(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:connectivityDirectory/services:getServices', __args__, opts=opts, typ=GetServicesResult).value
...
def get_services_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:connectivityDirectory/services:getServices', __args__, opts=opts, typ=GetServicesResult)
