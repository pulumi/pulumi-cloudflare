...
class ZeroTrustDeviceManagedNetworksArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the Device Managed Network. Must be unique.
        :param pulumi.Input[builtins.str] type: The type of Device Managed Network. Available values: `tls`.
        """
