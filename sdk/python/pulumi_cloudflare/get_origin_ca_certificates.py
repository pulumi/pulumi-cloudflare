...
def get_origin_ca_certificates(max_items: Optional[builtins.int] = None,
...
def get_origin_ca_certificates_output(max_items: Optional[pulumi.Input[Optional[builtins.int]]] = None,
