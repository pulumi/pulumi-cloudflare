...
def get_origin_ca_certificates(limit: Optional[_builtins.int] = None,
...
def get_origin_ca_certificates_output(limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
