...
def get_zero_trust_device_custom_profiles(account_id: Optional[builtins.str] = None,
...
def get_zero_trust_device_custom_profiles_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
