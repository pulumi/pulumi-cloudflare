...
def get_category(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustResourceLibrary/category:getCategory', __args__, opts=opts, typ=GetCategoryResult).value
...
def get_category_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustResourceLibrary/category:getCategory', __args__, opts=opts, typ=GetCategoryResult)
