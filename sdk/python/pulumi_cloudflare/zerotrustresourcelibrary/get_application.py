...
def get_application(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustResourceLibrary/application:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
...
def get_application_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustResourceLibrary/application:getApplication', __args__, opts=opts, typ=GetApplicationResult)
