...
class GetCategoriesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetCategoriesResultResult']:
        """
...
def get_categories(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustResourceLibrary/categories:getCategories', __args__, opts=opts, typ=GetCategoriesResult).value
...
def get_categories_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustResourceLibrary/categories:getCategories', __args__, opts=opts, typ=GetCategoriesResult)
