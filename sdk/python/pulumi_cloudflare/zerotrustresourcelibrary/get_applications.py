...
def get_applications(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustResourceLibrary/applications:getApplications', __args__, opts=opts, typ=GetApplicationsResult).value
...
def get_applications_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustResourceLibrary/applications:getApplications', __args__, opts=opts, typ=GetApplicationsResult)
