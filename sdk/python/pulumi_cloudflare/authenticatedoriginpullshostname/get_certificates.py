...
def get_certificates(max_items: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:authenticatedOriginPullsHostname/certificates:getCertificates', __args__, opts=opts, typ=GetCertificatesResult).value
...
def get_certificates_output(max_items: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:authenticatedOriginPullsHostname/certificates:getCertificates', __args__, opts=opts, typ=GetCertificatesResult)
