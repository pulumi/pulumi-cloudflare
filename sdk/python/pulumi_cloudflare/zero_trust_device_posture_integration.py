...
class _ZeroTrustDevicePostureIntegrationState:
    def __init__(__self__, *,
                 ...
                 config: pulumi.Input[Optional['ZeroTrustDevicePostureIntegrationConfigArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> pulumi.Input[Optional['ZeroTrustDevicePostureIntegrationConfigArgs']]:
        """
        The configuration object containing third-party integration information.
        """
        return pulumi.get(self, "config")
    ...
    @config.setter
    def config(self, value: pulumi.Input[Optional['ZeroTrustDevicePostureIntegrationConfigArgs']]):
        pulumi.set(self, "config", value)
