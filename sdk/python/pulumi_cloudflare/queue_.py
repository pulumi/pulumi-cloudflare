...
warnings.warn("""cloudflare:index/queue:Queue has been deprecated in favor of cloudflare:queue/queue:Queue""", DeprecationWarning)
...
class Queue(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_queue = cloudflare.queue.Queue("example_queue",
    ...
    def _internal_init(__self__,
                 ...
                 settings: pulumi.Input[Optional[Union['QueueSettingsArgs', 'QueueSettingsArgsDict']]] = None,
                 __props__=None):
        pulumi.log.warn("""Queue is deprecated: cloudflare:index/queue:Queue has been deprecated in favor of cloudflare:queue/queue:Queue""")
