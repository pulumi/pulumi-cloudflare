...
def get_zero_trust_device_default_profile(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:getZeroTrustDeviceDefaultProfile', __args__, opts=opts, typ=GetZeroTrustDeviceDefaultProfileResult).value
...
def get_zero_trust_device_default_profile_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:getZeroTrustDeviceDefaultProfile', __args__, opts=opts, typ=GetZeroTrustDeviceDefaultProfileResult)
