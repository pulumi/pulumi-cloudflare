...
def get_certificates(zone_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDeviceDefaultProfile/certificates:getCertificates', __args__, opts=opts, typ=GetCertificatesResult).value

    return AwaitableGetCertificatesResult(
        enabled=pulumi.get(__ret__, 'enabled'),
        zone_id=pulumi.get(__ret__, 'zone_id'))
def get_certificates_output(zone_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDeviceDefaultProfile/certificates:getCertificates', __args__, opts=opts, typ=GetCertificatesResult)
