...
class ZeroTrustDeviceDefaultProfileArgs:
    def __init__(__self__, *,
                 ...
                 global_acceleration: pulumi.Input[Optional['ZeroTrustDeviceDefaultProfileGlobalAccelerationArgs']] = None,
    ...
    def global_acceleration(self) -> pulumi.Input[Optional['ZeroTrustDeviceDefaultProfileGlobalAccelerationArgs']]:
        """
    ...
    def global_acceleration(self, value: pulumi.Input[Optional['ZeroTrustDeviceDefaultProfileGlobalAccelerationArgs']]):
...
@pulumi.type_token("cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile")
class ZeroTrustDeviceDefaultProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_zero_trust_device_default_profile = cloudflare.zerotrustdevicedefaultprofile.ZeroTrustDeviceDefaultProfile("example_zero_trust_device_default_profile",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ZeroTrustDeviceDefaultProfile, __self__).__init__(
            'cloudflare:zeroTrustDeviceDefaultProfile/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile',
            resource_name,
            __props__,
            opts)
    ...
    @_builtins.property
    @pulumi.getter(name="globalAcceleration")
    def global_acceleration(self) -> pulumi.Output[Optional['outputs.ZeroTrustDeviceDefaultProfileGlobalAcceleration']]:
        """
        Global Acceleration settings for China. When configured, WARP clients connect to the Global Accelerator addresses instead of the default ones. Please contact your account representative to enable this feature on your account. See https://developers.cloudflare.com/china-network/concepts/global-acceleration/.
        """
        return pulumi.get(self, "global_acceleration")
