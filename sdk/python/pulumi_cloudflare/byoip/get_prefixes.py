...
class GetPrefixesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetPrefixesResultResult']:
        """
...
def get_prefixes(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:byoIp/prefixes:getPrefixes', __args__, opts=opts, typ=GetPrefixesResult).value

    return AwaitableGetPrefixesResult(
        account_id=pulumi.get(__ret__, 'account_id'),
        max_items=pulumi.get(__ret__, 'max_items'),
        results=pulumi.get(__ret__, 'results'))
def get_prefixes_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:byoIp/prefixes:getPrefixes', __args__, opts=opts, typ=GetPrefixesResult)
