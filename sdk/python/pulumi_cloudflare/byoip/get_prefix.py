...
def get_prefix(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:byoIp/prefix:getPrefix', __args__, opts=opts, typ=GetPrefixResult).value
...
def get_prefix_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:byoIp/prefix:getPrefix', __args__, opts=opts, typ=GetPrefixResult)
