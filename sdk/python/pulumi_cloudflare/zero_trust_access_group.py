...
class ZeroTrustAccessGroupArgs:
    def __init__(__self__, *,
                 ...
                 excludes: pulumi.Input[Optional[Sequence[pulumi.Input['ZeroTrustAccessGroupExcludeArgs']]]] = None,
                 is_default: pulumi.Input[Optional[_builtins.bool]] = None,
                 requires: pulumi.Input[Optional[Sequence[pulumi.Input['ZeroTrustAccessGroupRequireArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def excludes(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ZeroTrustAccessGroupExcludeArgs']]]]:
        """
    ...
    @excludes.setter
    def excludes(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ZeroTrustAccessGroupExcludeArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def requires(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ZeroTrustAccessGroupRequireArgs']]]]:
        """
    ...
    @requires.setter
    def requires(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ZeroTrustAccessGroupRequireArgs']]]]):
...
class _ZeroTrustAccessGroupState:
    def __init__(__self__, *,
                 account_id: pulumi.Input[Optional[_builtins.str]] = None,
                 excludes: pulumi.Input[Optional[Sequence[pulumi.Input['ZeroTrustAccessGroupExcludeArgs']]]] = None,
                 includes: pulumi.Input[Optional[Sequence[pulumi.Input['ZeroTrustAccessGroupIncludeArgs']]]] = None,
                 is_default: pulumi.Input[Optional[_builtins.bool]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def includes(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ZeroTrustAccessGroupIncludeArgs']]]]:
        """
        Rules evaluated with an OR logical operator. A user needs to meet only one of the Include rules.
        """
        return pulumi.get(self, "includes")
    ...
    @includes.setter
    def includes(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ZeroTrustAccessGroupIncludeArgs']]]]):
        pulumi.set(self, "includes", value)
...
class ZeroTrustAccessGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 account_id: pulumi.Input[Optional[_builtins.str]] = None,
                 excludes: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ZeroTrustAccessGroupExcludeArgs', 'ZeroTrustAccessGroupExcludeArgsDict', 'outputs.ZeroTrustAccessGroupExclude']]]]] = None,
                 includes: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ZeroTrustAccessGroupIncludeArgs', 'ZeroTrustAccessGroupIncludeArgsDict', 'outputs.ZeroTrustAccessGroupInclude']]]]] = None,
                 is_default: pulumi.Input[Optional[_builtins.bool]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 requires: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ZeroTrustAccessGroupRequireArgs', 'ZeroTrustAccessGroupRequireArgsDict', 'outputs.ZeroTrustAccessGroupRequire']]]]] = None,
                 zone_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] account_id: The Account ID to use for this endpoint. Mutually exclusive with the Zone ID.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ZeroTrustAccessGroupExcludeArgs', 'ZeroTrustAccessGroupExcludeArgsDict', 'outputs.ZeroTrustAccessGroupExclude']]]] excludes: Rules evaluated with a NOT logical operator. To match a policy, a user cannot meet any of the Exclude rules.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ZeroTrustAccessGroupIncludeArgs', 'ZeroTrustAccessGroupIncludeArgsDict', 'outputs.ZeroTrustAccessGroupInclude']]]] includes: Rules evaluated with an OR logical operator. A user needs to meet only one of the Include rules.
        :param pulumi.Input[_builtins.bool] is_default: Whether this is the default group
        :param pulumi.Input[_builtins.str] name: The name of the Access group.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ZeroTrustAccessGroupRequireArgs', 'ZeroTrustAccessGroupRequireArgsDict', 'outputs.ZeroTrustAccessGroupRequire']]]] requires: Rules evaluated with an AND logical operator. To match a policy, a user must meet all of the Require rules.
        :param pulumi.Input[_builtins.str] zone_id: The Zone ID to use for this endpoint. Mutually exclusive with the Account ID.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            requires: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ZeroTrustAccessGroupRequireArgs', 'ZeroTrustAccessGroupRequireArgsDict', 'outputs.ZeroTrustAccessGroupRequire']]]]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'ZeroTrustAccessGroup':
        """
