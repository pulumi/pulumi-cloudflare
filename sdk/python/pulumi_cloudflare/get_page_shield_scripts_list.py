...
warnings.warn("""cloudflare:index/getPageShieldScriptsList:getPageShieldScriptsList has been deprecated in favor of cloudflare:pageShieldScripts/list:getList""", DeprecationWarning)
...
class GetPageShieldScriptsListResult:
    ...
    """
    def __init__(__self__, direction=None, exclude_cdn_cgi=None, exclude_duplicates=None, exclude_urls=None, export=None, hosts=None, max_items=None, order_by=None, page=None, page_url=None, per_page=None, prioritize_malicious=None, results=None, status=None, urls=None, zone_id=None):
...
def get_page_shield_scripts_list(direction: Optional[_builtins.str] = None,
    ...
    example_page_shield_scripts_list = cloudflare.pageshieldscripts.get_list(zone_id="023e105f4ecef8ad9ca31a8372d0c353",
        direction="asc",
    ...
    """
    pulumi.log.warn("""get_page_shield_scripts_list is deprecated: cloudflare:index/getPageShieldScriptsList:getPageShieldScriptsList has been deprecated in favor of cloudflare:pageShieldScripts/list:getList""")
    __args__ = dict()
...
def get_page_shield_scripts_list_output(direction: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        exclude_cdn_cgi: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                        exclude_duplicates: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                        exclude_urls: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        export: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        hosts: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        ...
                                        page_url: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        per_page: pulumi.Input[Optional[Optional[_builtins.float]]] = None,
                                        prioritize_malicious: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                        status: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        urls: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
