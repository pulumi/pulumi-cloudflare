...
class StaticRouteArgs:
    def __init__(__self__, *,
                 ...
                 scope: pulumi.Input[Optional['StaticRouteScopeArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def scope(self) -> pulumi.Input[Optional['StaticRouteScopeArgs']]:
        """
    ...
    @scope.setter
    def scope(self, value: pulumi.Input[Optional['StaticRouteScopeArgs']]):
...
@pulumi.type_token("cloudflare:magicWan/staticRoute:StaticRoute")
class StaticRoute(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/staticRoute:StaticRoute"), pulumi.Alias(type_="cloudflare:index/magicWanStaticRoute:MagicWanStaticRoute")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StaticRoute, __self__).__init__(
            'cloudflare:magicWan/staticRoute:StaticRoute',
            resource_name,
            __props__,
            opts)
