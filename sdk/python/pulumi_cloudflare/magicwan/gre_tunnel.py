...
class GreTunnelArgs:
    def __init__(__self__, *,
                 ...
                 bgp: pulumi.Input[Optional['GreTunnelBgpArgs']] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 health_check: pulumi.Input[Optional['GreTunnelHealthCheckArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def bgp(self) -> pulumi.Input[Optional['GreTunnelBgpArgs']]:
        return pulumi.get(self, "bgp")

    @bgp.setter
    def bgp(self, value: pulumi.Input[Optional['GreTunnelBgpArgs']]):
    ...
    def health_check(self) -> pulumi.Input[Optional['GreTunnelHealthCheckArgs']]:
        return pulumi.get(self, "health_check")

    @health_check.setter
    def health_check(self, value: pulumi.Input[Optional['GreTunnelHealthCheckArgs']]):
...
class _GreTunnelState:
    def __init__(__self__, *,
                 ...
                 automatic_return_routing: pulumi.Input[Optional[_builtins.bool]] = None,
                 bgp: pulumi.Input[Optional['GreTunnelBgpArgs']] = None,
                 bgp_status: pulumi.Input[Optional['GreTunnelBgpStatusArgs']] = None,
    ...
    def bgp_status(self) -> pulumi.Input[Optional['GreTunnelBgpStatusArgs']]:
        return pulumi.get(self, "bgp_status")

    @bgp_status.setter
    def bgp_status(self, value: pulumi.Input[Optional['GreTunnelBgpStatusArgs']]):
...
@pulumi.type_token("cloudflare:magicWan/greTunnel:GreTunnel")
class GreTunnel(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 account_id: pulumi.Input[Optional[_builtins.str]] = None,
                 automatic_return_routing: pulumi.Input[Optional[_builtins.bool]] = None,
                 bgp: pulumi.Input[Optional[Union['GreTunnelBgpArgs', 'GreTunnelBgpArgsDict']]] = None,
                 cloudflare_gre_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
                 customer_gre_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 health_check: pulumi.Input[Optional[Union['GreTunnelHealthCheckArgs', 'GreTunnelHealthCheckArgsDict']]] = None,
                 interface_address: pulumi.Input[Optional[_builtins.str]] = None,
                 interface_address6: pulumi.Input[Optional[_builtins.str]] = None,
                 mtu: pulumi.Input[Optional[_builtins.int]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/magicWanGreTunnel:MagicWanGreTunnel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GreTunnel, __self__).__init__(
            'cloudflare:magicWan/greTunnel:GreTunnel',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            automatic_return_routing: pulumi.Input[Optional[_builtins.bool]] = None,
            bgp: pulumi.Input[Optional[Union['GreTunnelBgpArgs', 'GreTunnelBgpArgsDict']]] = None,
            bgp_status: pulumi.Input[Optional[Union['GreTunnelBgpStatusArgs', 'GreTunnelBgpStatusArgsDict']]] = None,
            cloudflare_gre_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
            created_on: pulumi.Input[Optional[_builtins.str]] = None,
            customer_gre_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
            description: pulumi.Input[Optional[_builtins.str]] = None,
            ...
            mtu: pulumi.Input[Optional[_builtins.int]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            ttl: pulumi.Input[Optional[_builtins.int]] = None) -> 'GreTunnel':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def bgp(self) -> pulumi.Output[Optional['outputs.GreTunnelBgp']]:
        return pulumi.get(self, "bgp")

    @_builtins.property
    @pulumi.getter(name="bgpStatus")
    def bgp_status(self) -> pulumi.Output['outputs.GreTunnelBgpStatus']:
        return pulumi.get(self, "bgp_status")
    ...
    @_builtins.property
    @pulumi.getter(name="healthCheck")
    def health_check(self) -> pulumi.Output['outputs.GreTunnelHealthCheck']:
        return pulumi.get(self, "health_check")
