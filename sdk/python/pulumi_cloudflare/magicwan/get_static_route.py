...
class GetStaticRouteResult:
    ...
    @_builtins.property
    @pulumi.getter
    def route(self) -> 'outputs.GetStaticRouteRouteResult':
...
def get_static_route(account_id: Optional[_builtins.str] = None,
    ...
    example_magic_wan_static_route = cloudflare.magicwan.get_static_route(account_id="023e105f4ecef8ad9ca31a8372d0c353",
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:magicWan/staticRoute:getStaticRoute', __args__, opts=opts, typ=GetStaticRouteResult).value
...
def get_static_route_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                            route_id: pulumi.Input[Optional[_builtins.str]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetStaticRouteResult]:
    """
    Accepted Permissions
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:magicWan/staticRoute:getStaticRoute', __args__, opts=opts, typ=GetStaticRouteResult)
    return __ret__.apply(lambda __response__: GetStaticRouteResult(
