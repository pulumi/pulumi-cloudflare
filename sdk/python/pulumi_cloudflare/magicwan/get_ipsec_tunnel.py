...
class GetIpsecTunnelResult:
    ...
    def ipsec_tunnel(self) -> 'outputs.GetIpsecTunnelIpsecTunnelResult':
...
def get_ipsec_tunnel(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:magicWan/ipsecTunnel:getIpsecTunnel', __args__, opts=opts, typ=GetIpsecTunnelResult).value
...
def get_ipsec_tunnel_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:magicWan/ipsecTunnel:getIpsecTunnel', __args__, opts=opts, typ=GetIpsecTunnelResult)
