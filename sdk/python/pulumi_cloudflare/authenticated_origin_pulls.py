...
class AuthenticatedOriginPullsArgs:
    def __init__(__self__, *,
                 ...
                 authenticated_origin_pulls_certificate: Optional[pulumi.Input[builtins.str]] = None,
                 hostname: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a AuthenticatedOriginPulls resource.
        :param pulumi.Input[builtins.bool] enabled: Whether to enable Authenticated Origin Pulls on the given zone or hostname.
        ...
        :param pulumi.Input[builtins.str] authenticated_origin_pulls_certificate: The ID of an uploaded Authenticated Origin Pulls certificate. If no hostname is provided, this certificate will be used zone wide as Per-Zone Authenticated Origin Pulls.
        :param pulumi.Input[builtins.str] hostname: Specify a hostname to enable Per-Hostname Authenticated Origin Pulls on, using the provided certificate.
        """
    ...
    def authenticated_origin_pulls_certificate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def authenticated_origin_pulls_certificate(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AuthenticatedOriginPulls(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="authenticatedOriginPullsCertificate")
    def authenticated_origin_pulls_certificate(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of an uploaded Authenticated Origin Pulls certificate. If no hostname is provided, this certificate will be used zone wide as Per-Zone Authenticated Origin Pulls.
        """
        return pulumi.get(self, "authenticated_origin_pulls_certificate")
