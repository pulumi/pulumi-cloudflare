...
def get_magic_transit_sites(account_id: Optional[builtins.str] = None,
...
def get_magic_transit_sites_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
                                   connectorid: Optional[pulumi.Input[Optional[builtins.str]]] = None,
