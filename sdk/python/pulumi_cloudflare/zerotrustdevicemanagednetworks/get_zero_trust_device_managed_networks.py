...
def get_zero_trust_device_managed_networks(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDeviceManagedNetworks/zeroTrustDeviceManagedNetworks:getZeroTrustDeviceManagedNetworks', __args__, opts=opts, typ=GetZeroTrustDeviceManagedNetworksResult).value
...
def get_zero_trust_device_managed_networks_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDeviceManagedNetworks/zeroTrustDeviceManagedNetworks:getZeroTrustDeviceManagedNetworks', __args__, opts=opts, typ=GetZeroTrustDeviceManagedNetworksResult)
