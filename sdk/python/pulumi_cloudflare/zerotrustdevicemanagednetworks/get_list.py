...
def get_list(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDeviceManagedNetworks/list:getList', __args__, opts=opts, typ=GetListResult).value
...
def get_list_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDeviceManagedNetworks/list:getList', __args__, opts=opts, typ=GetListResult)
