...
class MagicWanStaticRouteArgs:
    def __init__(__self__, *,
                 ...
                 scope: pulumi.Input[Optional['MagicWanStaticRouteScopeArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def scope(self) -> pulumi.Input[Optional['MagicWanStaticRouteScopeArgs']]:
        """
    ...
    @scope.setter
    def scope(self, value: pulumi.Input[Optional['MagicWanStaticRouteScopeArgs']]):
