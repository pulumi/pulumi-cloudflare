...
class SslArgs:
    def __init__(__self__, *,
                 ...
                 geo_restrictions: pulumi.Input[Optional['SslGeoRestrictionsArgs']] = None,
    ...
    def geo_restrictions(self) -> pulumi.Input[Optional['SslGeoRestrictionsArgs']]:
        """
        Specify the region where your private key can be held locally for optimal TLS performance. HTTPS connections to any excluded data center will still be fully encrypted, but will incur some latency while Keyless SSL is used to complete the handshake with the nearest allowed data center. Options allow distribution to only to U.S. data centers, only to E.U. data centers, or only to highest security data centers. Default distribution is to all Cloudflare datacenters, for optimal performance.
        """
    ...
    def geo_restrictions(self, value: pulumi.Input[Optional['SslGeoRestrictionsArgs']]):
...
class _SslState:
    def __init__(__self__, *,
                 ...
                 keyless_server: pulumi.Input[Optional['SslKeylessServerArgs']] = None,
    ...
    def keyless_server(self) -> pulumi.Input[Optional['SslKeylessServerArgs']]:
        return pulumi.get(self, "keyless_server")

    @keyless_server.setter
    def keyless_server(self, value: pulumi.Input[Optional['SslKeylessServerArgs']]):
...
@pulumi.type_token("cloudflare:custom/ssl:Ssl")
class Ssl(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 custom_csr_id: pulumi.Input[Optional[_builtins.str]] = None,
                 deploy: pulumi.Input[Optional[_builtins.str]] = None,
                 geo_restrictions: pulumi.Input[Optional[Union['SslGeoRestrictionsArgs', 'SslGeoRestrictionsArgsDict']]] = None,
                 policy: pulumi.Input[Optional[_builtins.str]] = None,
                 private_key: pulumi.Input[Optional[_builtins.str]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 zone_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] deploy: The environment to deploy the certificate to.
               Available values: "staging", "production".
        :param pulumi.Input[Union['SslGeoRestrictionsArgs', 'SslGeoRestrictionsArgsDict']] geo_restrictions: Specify the region where your private key can be held locally for optimal TLS performance. HTTPS connections to any excluded data center will still be fully encrypted, but will incur some latency while Keyless SSL is used to complete the handshake with the nearest allowed data center. Options allow distribution to only to U.S. data centers, only to E.U. data centers, or only to highest security data centers. Default distribution is to all Cloudflare datacenters, for optimal performance.
        :param pulumi.Input[_builtins.str] policy: Specify the policy that determines the region where your private key will be held locally. HTTPS connections to any excluded data center will still be fully encrypted, but will incur some latency while Keyless SSL is used to complete the handshake with the nearest allowed data center. Any combination of countries, specified by their two letter country code (https://en.wikipedia.org/wiki/ISO*3166-1*alpha-2#Officially*assigned*code*elements) can be chosen, such as 'country: IN', as well as 'region: EU' which refers to the EU region. If there are too few data centers satisfying the policy, it will be rejected.
               Note: The API accepts this field as either "policy" or "policy*restrictions" in requests. Responses return this field as "policy_restrictions".
        :param pulumi.Input[_builtins.str] private_key: The zone's private key.
        :param pulumi.Input[_builtins.str] type: The type 'legacy*custom' enables support for legacy clients which do not include SNI in the TLS handshake.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/customSsl:CustomSsl")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["privateKey"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(Ssl, __self__).__init__(
            'cloudflare:custom/ssl:Ssl',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            hosts: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            issuer: pulumi.Input[Optional[_builtins.str]] = None,
            keyless_server: pulumi.Input[Optional[Union['SslKeylessServerArgs', 'SslKeylessServerArgsDict']]] = None,
            modified_on: pulumi.Input[Optional[_builtins.str]] = None,
            policy: pulumi.Input[Optional[_builtins.str]] = None,
            policy_restrictions: pulumi.Input[Optional[_builtins.str]] = None,
            priority: pulumi.Input[Optional[_builtins.float]] = None,
            ...
            type: pulumi.Input[Optional[_builtins.str]] = None,
            uploaded_on: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Ssl':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="geoRestrictions")
    def geo_restrictions(self) -> pulumi.Output[Optional['outputs.SslGeoRestrictions']]:
        """
        Specify the region where your private key can be held locally for optimal TLS performance. HTTPS connections to any excluded data center will still be fully encrypted, but will incur some latency while Keyless SSL is used to complete the handshake with the nearest allowed data center. Options allow distribution to only to U.S. data centers, only to E.U. data centers, or only to highest security data centers. Default distribution is to all Cloudflare datacenters, for optimal performance.
        """
        return pulumi.get(self, "geo_restrictions")
    ...
    @_builtins.property
    @pulumi.getter(name="keylessServer")
    def keyless_server(self) -> pulumi.Output['outputs.SslKeylessServer']:
        return pulumi.get(self, "keyless_server")
