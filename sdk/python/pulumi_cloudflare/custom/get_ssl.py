...
class GetSslResult:
    ...
    def custom_certificate_id(self) -> Optional[_builtins.str]:
        """
        Identifier.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetSslFilterResult']:
        return pulumi.get(self, "filter")

    @_builtins.property
    @pulumi.getter(name="geoRestrictions")
    def geo_restrictions(self) -> 'outputs.GetSslGeoRestrictionsResult':
        """
    ...
    def keyless_server(self) -> 'outputs.GetSslKeylessServerResult':
...
def get_ssl(custom_certificate_id: Optional[_builtins.str] = None,
            filter: Optional[Union['GetSslFilterArgs', 'GetSslFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:custom/ssl:getSsl', __args__, opts=opts, typ=GetSslResult).value
...
def get_ssl_output(custom_certificate_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                   filter: pulumi.Input[Optional[Optional[Union['GetSslFilterArgs', 'GetSslFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:custom/ssl:getSsl', __args__, opts=opts, typ=GetSslResult)
