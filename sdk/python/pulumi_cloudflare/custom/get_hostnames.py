...
class GetHostnamesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def hostname(self) -> Optional['outputs.GetHostnamesHostnameResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetHostnamesResultResult']:
        """
...
def get_hostnames(certificate_authority: Optional[_builtins.str] = None,
                  custom_origin_server: Optional[_builtins.str] = None,
                  direction: Optional[_builtins.str] = None,
                  hostname: Optional[Union['GetHostnamesHostnameArgs', 'GetHostnamesHostnameArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:custom/hostnames:getHostnames', __args__, opts=opts, typ=GetHostnamesResult).value
...
def get_hostnames_output(certificate_authority: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                         ...
                         hostname: pulumi.Input[Optional[Optional[Union['GetHostnamesHostnameArgs', 'GetHostnamesHostnameArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:custom/hostnames:getHostnames', __args__, opts=opts, typ=GetHostnamesResult)
