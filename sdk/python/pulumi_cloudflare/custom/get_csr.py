...
class GetCsrResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetCsrFilterResult']:
...
def get_csr(account_id: Optional[_builtins.str] = None,
            custom_csr_id: Optional[_builtins.str] = None,
            filter: Optional[Union['GetCsrFilterArgs', 'GetCsrFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:custom/csr:getCsr', __args__, opts=opts, typ=GetCsrResult).value
...
def get_csr_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                   custom_csr_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                   filter: pulumi.Input[Optional[Optional[Union['GetCsrFilterArgs', 'GetCsrFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:custom/csr:getCsr', __args__, opts=opts, typ=GetCsrResult)
