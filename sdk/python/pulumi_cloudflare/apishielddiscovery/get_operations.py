...
class GetOperationsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetOperationsResultResult']:
...
def get_operations(diff: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:apiShieldDiscovery/operations:getOperations', __args__, opts=opts, typ=GetOperationsResult).value
...
def get_operations_output(diff: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:apiShieldDiscovery/operations:getOperations', __args__, opts=opts, typ=GetOperationsResult)
