...
__all__ = [
    ...
    'AwaitableGetAuthenticatedOriginPullsHostnameCertificatesResult',
    'get_authenticated_origin_pulls_hostname_certificates',
...
class GetAuthenticatedOriginPullsHostnameCertificatesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetAuthenticatedOriginPullsHostnameCertificatesResultResult']:
        """
...
class AwaitableGetAuthenticatedOriginPullsHostnameCertificatesResult(GetAuthenticatedOriginPullsHostnameCertificatesResult):
...
def get_authenticated_origin_pulls_hostname_certificates(max_items: Optional[_builtins.int] = None,
                                                         zone_id: Optional[_builtins.str] = None,
                                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAuthenticatedOriginPullsHostnameCertificatesResult:
    """
    ## Example Usage
...
def get_authenticated_origin_pulls_hostname_certificates_output(max_items: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                                                zone_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAuthenticatedOriginPullsHostnameCertificatesResult]:
    """
    ## Example Usage
