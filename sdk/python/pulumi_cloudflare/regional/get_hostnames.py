...
def get_hostnames(max_items: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:regional/hostnames:getHostnames', __args__, opts=opts, typ=GetHostnamesResult).value

    return AwaitableGetHostnamesResult(
        max_items=pulumi.get(__ret__, 'max_items'),
        results=pulumi.get(__ret__, 'results'),
        zone_id=pulumi.get(__ret__, 'zone_id'))
def get_hostnames_output(max_items: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:regional/hostnames:getHostnames', __args__, opts=opts, typ=GetHostnamesResult)
