...
@pulumi.type_token("cloudflare:regional/tieredCache:TieredCache")
class TieredCache(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_regional_tiered_cache = cloudflare.regional.TieredCache("example_regional_tiered_cache",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/regionalTieredCache:RegionalTieredCache")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TieredCache, __self__).__init__(
            'cloudflare:regional/tieredCache:TieredCache',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            modified_on: pulumi.Input[Optional[_builtins.str]] = None,
            value: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'TieredCache':
        """
