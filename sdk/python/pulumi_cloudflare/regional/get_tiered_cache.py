...
def get_tiered_cache(zone_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:regional/tieredCache:getTieredCache', __args__, opts=opts, typ=GetTieredCacheResult).value
...
def get_tiered_cache_output(zone_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:regional/tieredCache:getTieredCache', __args__, opts=opts, typ=GetTieredCacheResult)
