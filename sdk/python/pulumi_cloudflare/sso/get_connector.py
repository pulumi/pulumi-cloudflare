...
class GetConnectorResult:
    ...
    @_builtins.property
    @pulumi.getter
    def verification(self) -> 'outputs.GetConnectorVerificationResult':
...
def get_connector(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:sso/connector:getConnector', __args__, opts=opts, typ=GetConnectorResult).value
...
def get_connector_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:sso/connector:getConnector', __args__, opts=opts, typ=GetConnectorResult)
