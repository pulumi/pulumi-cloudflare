...
def get_connectors(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:sso/connectors:getConnectors', __args__, opts=opts, typ=GetConnectorsResult).value
...
def get_connectors_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:sso/connectors:getConnectors', __args__, opts=opts, typ=GetConnectorsResult)
