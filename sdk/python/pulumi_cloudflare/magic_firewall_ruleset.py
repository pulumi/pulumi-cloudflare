...
class MagicFirewallRulesetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: The ID of the account where the ruleset is being created.
        :param pulumi.Input[builtins.str] name: The name of the ruleset.
        :param pulumi.Input[builtins.str] description: A note that can be used to annotate the rule.
        """
...
class MagicFirewallRuleset(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]]] = None) -> 'MagicFirewallRuleset':
        """
    ...
    @property
    @pulumi.getter
    def rules(self) -> pulumi.Output[Optional[Sequence[Mapping[str, builtins.str]]]]:
        return pulumi.get(self, "rules")
