...
def get_r2_bucket(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:r2Bucket/r2Bucket:getR2Bucket', __args__, opts=opts, typ=GetR2BucketResult).value
...
def get_r2_bucket_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:r2Bucket/r2Bucket:getR2Bucket', __args__, opts=opts, typ=GetR2BucketResult)
