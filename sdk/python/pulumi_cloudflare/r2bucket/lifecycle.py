...
class LifecycleArgs:
    def __init__(__self__, *,
                 ...
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input['LifecycleRuleArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['LifecycleRuleArgs']]]]:
        return pulumi.get(self, "rules")

    @rules.setter
    def rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['LifecycleRuleArgs']]]]):
...
@pulumi.type_token("cloudflare:r2Bucket/lifecycle:Lifecycle")
class Lifecycle(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bucket_name: pulumi.Input[Optional[_builtins.str]] = None,
                 jurisdiction: pulumi.Input[Optional[_builtins.str]] = None,
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['LifecycleRuleArgs', 'LifecycleRuleArgsDict']]]]] = None,
                 __props__=None):
        """
        ## Example Usage
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/r2BucketLifecycle:R2BucketLifecycle")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Lifecycle, __self__).__init__(
            'cloudflare:r2Bucket/lifecycle:Lifecycle',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            bucket_name: pulumi.Input[Optional[_builtins.str]] = None,
            jurisdiction: pulumi.Input[Optional[_builtins.str]] = None,
            rules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['LifecycleRuleArgs', 'LifecycleRuleArgsDict']]]]] = None) -> 'Lifecycle':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Output[Optional[Sequence['outputs.LifecycleRule']]]:
        return pulumi.get(self, "rules")
