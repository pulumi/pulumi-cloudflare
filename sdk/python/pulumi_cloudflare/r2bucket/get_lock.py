...
class GetLockResult:
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> Sequence['outputs.GetLockRuleResult']:
...
def get_lock(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:r2Bucket/lock:getLock', __args__, opts=opts, typ=GetLockResult).value

    return AwaitableGetLockResult(
        account_id=pulumi.get(__ret__, 'account_id'),
        bucket_name=pulumi.get(__ret__, 'bucket_name'),
        rules=pulumi.get(__ret__, 'rules'))
def get_lock_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:r2Bucket/lock:getLock', __args__, opts=opts, typ=GetLockResult)
