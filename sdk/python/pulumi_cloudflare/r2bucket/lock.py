...
class LockArgs:
    def __init__(__self__, *,
                 ...
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input['LockRuleArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['LockRuleArgs']]]]:
        return pulumi.get(self, "rules")

    @rules.setter
    def rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['LockRuleArgs']]]]):
...
@pulumi.type_token("cloudflare:r2Bucket/lock:Lock")
class Lock(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bucket_name: pulumi.Input[Optional[_builtins.str]] = None,
                 jurisdiction: pulumi.Input[Optional[_builtins.str]] = None,
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['LockRuleArgs', 'LockRuleArgsDict']]]]] = None,
                 __props__=None):
        """
        ## Example Usage
        ...
        example_r2_bucket_lock = cloudflare.r2bucket.Lock("example_r2_bucket_lock",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/r2BucketLock:R2BucketLock")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Lock, __self__).__init__(
            'cloudflare:r2Bucket/lock:Lock',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            bucket_name: pulumi.Input[Optional[_builtins.str]] = None,
            jurisdiction: pulumi.Input[Optional[_builtins.str]] = None,
            rules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['LockRuleArgs', 'LockRuleArgsDict']]]]] = None) -> 'Lock':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Output[Optional[Sequence['outputs.LockRule']]]:
        return pulumi.get(self, "rules")
