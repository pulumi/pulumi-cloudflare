...
warnings.warn("""cloudflare:index/zone:Zone has been deprecated in favor of cloudflare:zone/zone:Zone""", DeprecationWarning)
...
class Zone(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_zone = cloudflare.zone.Zone("example_zone",
            account={
    ...
    def _internal_init(__self__,
                 ...
                 vanity_name_servers: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Zone is deprecated: cloudflare:index/zone:Zone has been deprecated in favor of cloudflare:zone/zone:Zone""")
