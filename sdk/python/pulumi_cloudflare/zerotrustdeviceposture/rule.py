...
class RuleArgs:
    def __init__(__self__, *,
                 ...
                 input: pulumi.Input[Optional['RuleInputArgs']] = None,
                 matches: pulumi.Input[Optional[Sequence[pulumi.Input['RuleMatchArgs']]]] = None,
        ...
        :param pulumi.Input['RuleInputArgs'] input: The value to be checked against.
        :param pulumi.Input[Sequence[pulumi.Input['RuleMatchArgs']]] matches: The conditions that the client must match to run the rule.
    ...
    @_builtins.property
    @pulumi.getter
    def input(self) -> pulumi.Input[Optional['RuleInputArgs']]:
        """
    ...
    @input.setter
    def input(self, value: pulumi.Input[Optional['RuleInputArgs']]):
        pulumi.set(self, "input", value)

    @_builtins.property
    @pulumi.getter
    def matches(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RuleMatchArgs']]]]:
        """
    ...
    @matches.setter
    def matches(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RuleMatchArgs']]]]):
...
@pulumi.type_token("cloudflare:zeroTrustDevicePosture/rule:Rule")
class Rule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 expiration: pulumi.Input[Optional[_builtins.str]] = None,
                 input: pulumi.Input[Optional[Union['RuleInputArgs', 'RuleInputArgsDict']]] = None,
                 matches: pulumi.Input[Optional[Sequence[pulumi.Input[Union['RuleMatchArgs', 'RuleMatchArgsDict']]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 schedule: pulumi.Input[Optional[_builtins.str]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[_builtins.str] description: The description of the device posture rule.
        :param pulumi.Input[_builtins.str] expiration: Sets the expiration time for a posture check result. If empty, the result remains valid until it is overwritten by new data from the WARP client.
        :param pulumi.Input[Union['RuleInputArgs', 'RuleInputArgsDict']] input: The value to be checked against.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RuleMatchArgs', 'RuleMatchArgsDict']]]] matches: The conditions that the client must match to run the rule.
        :param pulumi.Input[_builtins.str] name: The name of the device posture rule.
        :param pulumi.Input[_builtins.str] schedule: Polling frequency for the WARP client posture check. Default: `5m` (poll every five minutes). Minimum: `1m`.
        :param pulumi.Input[_builtins.str] type: The type of device posture rule.
               Available values: "file", "application", "tanium", "gateway", "warp", "disk*encryption", "serial*number", "sentinelone", "carbonblack", "firewall", "os*version", "domain*joined", "client*certificate", "client*certificate*v2", "antivirus", "unique*client*id", "kolide", "tanium*s2s", "crowdstrike*s2s", "intune", "workspace*one", "sentinelone*s2s", "custom*s2s".
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zeroTrustDevicePostureRule:ZeroTrustDevicePostureRule"), pulumi.Alias(type_="cloudflare:index/devicePostureRule:DevicePostureRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Rule, __self__).__init__(
            'cloudflare:zeroTrustDevicePosture/rule:Rule',
            resource_name,
            __props__,
            opts)
    ...
    @_builtins.property
    @pulumi.getter
    def input(self) -> pulumi.Output[Optional['outputs.RuleInput']]:
        """
        The value to be checked against.
        """
        return pulumi.get(self, "input")
    ...
    @_builtins.property
    @pulumi.getter
    def matches(self) -> pulumi.Output[Optional[Sequence['outputs.RuleMatch']]]:
        """
        The conditions that the client must match to run the rule.
        """
        return pulumi.get(self, "matches")
