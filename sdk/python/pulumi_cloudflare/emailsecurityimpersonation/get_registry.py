...
class GetRegistryResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetRegistryFilterResult']:
...
def get_registry(account_id: Optional[_builtins.str] = None,
                 filter: Optional[Union['GetRegistryFilterArgs', 'GetRegistryFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:emailSecurityImpersonation/registry:getRegistry', __args__, opts=opts, typ=GetRegistryResult).value
...
def get_registry_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                        filter: pulumi.Input[Optional[Optional[Union['GetRegistryFilterArgs', 'GetRegistryFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:emailSecurityImpersonation/registry:getRegistry', __args__, opts=opts, typ=GetRegistryResult)
