...
class GetServersResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetServersResultResult']:
        """
...
def get_servers(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustAccessAiControlsMcp/servers:getServers', __args__, opts=opts, typ=GetServersResult).value
...
def get_servers_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustAccessAiControlsMcp/servers:getServers', __args__, opts=opts, typ=GetServersResult)
