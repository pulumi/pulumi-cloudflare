...
class GetServerResult:
    ...
    def auth_config_summary(self) -> 'outputs.GetServerAuthConfigSummaryResult':
        """
    ...
    def error_details(self) -> 'outputs.GetServerErrorDetailsResult':
    ...
    def updated_prompts(self) -> Sequence['outputs.GetServerUpdatedPromptResult']:
        return pulumi.get(self, "updated_prompts")

    @_builtins.property
    @pulumi.getter(name="updatedTools")
    def updated_tools(self) -> Sequence['outputs.GetServerUpdatedToolResult']:
...
def get_server(account_id: Optional[_builtins.str] = None,
               filter: Optional[Union['GetServerFilterArgs', 'GetServerFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustAccessAiControlsMcp/server:getServer', __args__, opts=opts, typ=GetServerResult).value
...
def get_server_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                      filter: pulumi.Input[Optional[Optional[Union['GetServerFilterArgs', 'GetServerFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustAccessAiControlsMcp/server:getServer', __args__, opts=opts, typ=GetServerResult)
