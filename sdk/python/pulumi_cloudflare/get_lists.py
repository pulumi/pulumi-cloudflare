...
def get_lists_output(account_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getLists:getLists', __args__, opts=opts, typ=GetListsResult)
