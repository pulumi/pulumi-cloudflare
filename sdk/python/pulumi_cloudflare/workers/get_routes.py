...
def get_routes(max_items: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:workers/routes:getRoutes', __args__, opts=opts, typ=GetRoutesResult).value

    return AwaitableGetRoutesResult(
        max_items=pulumi.get(__ret__, 'max_items'),
        results=pulumi.get(__ret__, 'results'),
        zone_id=pulumi.get(__ret__, 'zone_id'))
def get_routes_output(max_items: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:workers/routes:getRoutes', __args__, opts=opts, typ=GetRoutesResult)
