...
class GetDeploymentResult:
    ...
    @_builtins.property
    @pulumi.getter
    def annotations(self) -> 'outputs.GetDeploymentAnnotationsResult':
    ...
    @_builtins.property
    @pulumi.getter
    def versions(self) -> Sequence['outputs.GetDeploymentVersionResult']:
...
def get_deployment(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:workers/deployment:getDeployment', __args__, opts=opts, typ=GetDeploymentResult).value
...
def get_deployment_output(account_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:workers/deployment:getDeployment', __args__, opts=opts, typ=GetDeploymentResult)
