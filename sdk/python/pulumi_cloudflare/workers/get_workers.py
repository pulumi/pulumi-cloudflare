...
def get_workers(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:workers/workers:getWorkers', __args__, opts=opts, typ=GetWorkersResult).value
...
def get_workers_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:workers/workers:getWorkers', __args__, opts=opts, typ=GetWorkersResult)
