...
class GetScriptsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetScriptsResultResult']:
        """
...
def get_scripts(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:workers/scripts:getScripts', __args__, opts=opts, typ=GetScriptsResult).value
...
def get_scripts_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:workers/scripts:getScripts', __args__, opts=opts, typ=GetScriptsResult)
