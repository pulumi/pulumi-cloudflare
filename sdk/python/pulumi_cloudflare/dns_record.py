...
class DnsRecordArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def data(self) -> pulumi.Input[Optional['DnsRecordDataArgs']]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def settings(self) -> pulumi.Input[Optional['DnsRecordSettingsArgs']]:
        """
    ...
    @settings.setter
    def settings(self, value: pulumi.Input[Optional['DnsRecordSettingsArgs']]):
