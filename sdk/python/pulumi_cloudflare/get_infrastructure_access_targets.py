...
def get_infrastructure_access_targets(account_id: Optional[builtins.str] = None,
...
def get_infrastructure_access_targets_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
