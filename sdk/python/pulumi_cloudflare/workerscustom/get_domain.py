...
class GetDomainResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetDomainFilterResult']:
...
def get_domain(account_id: Optional[_builtins.str] = None,
               ...
               filter: Optional[Union['GetDomainFilterArgs', 'GetDomainFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:workersCustom/domain:getDomain', __args__, opts=opts, typ=GetDomainResult).value
...
def get_domain_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                      domain_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                      filter: pulumi.Input[Optional[Optional[Union['GetDomainFilterArgs', 'GetDomainFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:workersCustom/domain:getDomain', __args__, opts=opts, typ=GetDomainResult)
