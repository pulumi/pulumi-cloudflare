...
def get_zero_trust_device_custom_profile(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDeviceCustomProfile/zeroTrustDeviceCustomProfile:getZeroTrustDeviceCustomProfile', __args__, opts=opts, typ=GetZeroTrustDeviceCustomProfileResult).value
...
def get_zero_trust_device_custom_profile_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDeviceCustomProfile/zeroTrustDeviceCustomProfile:getZeroTrustDeviceCustomProfile', __args__, opts=opts, typ=GetZeroTrustDeviceCustomProfileResult)
