...
__all__ = [
    ...
    'ZeroTrustDeviceCustomProfileGlobalAccelerationArgsDict',
    ...
    'ZeroTrustDeviceCustomProfileVirtualNetworksArgsDict',
]
...
@pulumi.input_type
class ZeroTrustDeviceCustomProfileDnsSearchSuffixArgs:
    def __init__(__self__, *,
                 suffix: pulumi.Input[_builtins.str],
                 description: pulumi.Input[Optional[_builtins.str]] = None):
        """
...
class ZeroTrustDeviceCustomProfileGlobalAccelerationArgsDict(TypedDict):
...
@pulumi.input_type
class ZeroTrustDeviceCustomProfileGlobalAccelerationArgs:
    def __init__(__self__, *,
                 api_endpoints: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 enabled: pulumi.Input[_builtins.bool],
                 masque_endpoints: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
...
class ZeroTrustDeviceCustomProfileVirtualNetworksArgsDict(TypedDict):
...
@pulumi.input_type
class ZeroTrustDeviceCustomProfileVirtualNetworksArgs:
    def __init__(__self__, *,
                 alloweds: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 default: pulumi.Input[_builtins.str]):
        """
