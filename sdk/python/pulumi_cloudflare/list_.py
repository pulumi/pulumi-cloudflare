...
class ListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ListItemArgs']]] items: The items in the list. If set, this overwrites all items in the list. Do not use with `list.Item`.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ListItemArgs']]]]:
        """
    ...
    @items.setter
    def items(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ListItemArgs']]]]):
...
class _ListState:
    def __init__(__self__, *,
                 ...
                 num_items: pulumi.Input[Optional[_builtins.float]] = None,
                 num_referencing_filters: pulumi.Input[Optional[_builtins.float]] = None):
        """
    ...
    def num_items(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    @num_items.setter
    def num_items(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "num_items", value)

    @_builtins.property
    @pulumi.getter(name="numReferencingFilters")
    def num_referencing_filters(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def num_referencing_filters(self, value: pulumi.Input[Optional[_builtins.float]]):
...
class List(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        > The `List` resource supports defining list items in line with the
          ...
          _and_ `list_get_items` on the same list is not supported and will cause
        ...
        :param pulumi.Input[_builtins.str] account_id: The Account ID for this resource.
        :param pulumi.Input[_builtins.str] description: An informative summary of the list.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ListItemArgs', 'ListItemArgsDict']]]] items: The items in the list. If set, this overwrites all items in the list. Do not use with `list.Item`.
        :param pulumi.Input[_builtins.str] kind: The type of the list. Each type supports specific list items (IP addresses, ASNs, hostnames or redirects).
               Available values: "ip", "redirect", "hostname", "asn".
        :param pulumi.Input[_builtins.str] name: An informative name for the list. Use this name in filter and rule expressions.
        """
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            num_items: pulumi.Input[Optional[_builtins.float]] = None,
            num_referencing_filters: pulumi.Input[Optional[_builtins.float]] = None) -> 'List':
        """
