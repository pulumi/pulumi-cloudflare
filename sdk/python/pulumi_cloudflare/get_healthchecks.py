...
def get_healthchecks(max_items: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getHealthchecks:getHealthchecks', __args__, opts=opts, typ=GetHealthchecksResult).value
...
def get_healthchecks_output(max_items: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getHealthchecks:getHealthchecks', __args__, opts=opts, typ=GetHealthchecksResult)
