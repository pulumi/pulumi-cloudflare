...
class _WorkersKvNamespaceState:
    def __init__(__self__, *,
                 ...
                 beta: Optional[pulumi.Input[_builtins.bool]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def beta(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    @beta.setter
    def beta(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class WorkersKvNamespace(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def beta(self) -> pulumi.Output[_builtins.bool]:
        """
        True if new beta namespace, with additional preview features.
        """
        return pulumi.get(self, "beta")
