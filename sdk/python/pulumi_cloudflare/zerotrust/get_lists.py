...
def get_lists(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrust/lists:getLists', __args__, opts=opts, typ=GetListsResult).value
...
def get_lists_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrust/lists:getLists', __args__, opts=opts, typ=GetListsResult)
