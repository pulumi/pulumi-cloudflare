...
class GetOrganizationResult:
    ...
    def custom_pages(self) -> 'outputs.GetOrganizationCustomPagesResult':
    ...
    def login_design(self) -> 'outputs.GetOrganizationLoginDesignResult':
        return pulumi.get(self, "login_design")

    @_builtins.property
    @pulumi.getter(name="mfaConfig")
    def mfa_config(self) -> 'outputs.GetOrganizationMfaConfigResult':
        """
    ...
    def mfa_ssh_piv_key_requirements(self) -> 'outputs.GetOrganizationMfaSshPivKeyRequirementsResult':
        """
...
def get_organization(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrust/organization:getOrganization', __args__, opts=opts, typ=GetOrganizationResult).value
...
def get_organization_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrust/organization:getOrganization', __args__, opts=opts, typ=GetOrganizationResult)
