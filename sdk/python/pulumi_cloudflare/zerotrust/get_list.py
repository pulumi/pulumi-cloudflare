...
class GetListResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetListFilterResult']:
...
def get_list(account_id: Optional[_builtins.str] = None,
             filter: Optional[Union['GetListFilterArgs', 'GetListFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrust/list:getList', __args__, opts=opts, typ=GetListResult).value
...
def get_list_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                    filter: pulumi.Input[Optional[Optional[Union['GetListFilterArgs', 'GetListFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrust/list:getList', __args__, opts=opts, typ=GetListResult)
