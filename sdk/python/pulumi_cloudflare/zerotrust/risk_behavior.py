...
@pulumi.type_token("cloudflare:zeroTrust/riskBehavior:RiskBehavior")
class RiskBehavior(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zeroTrustRiskBehavior:ZeroTrustRiskBehavior"), pulumi.Alias(type_="cloudflare:index/riskBehavior:RiskBehavior")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RiskBehavior, __self__).__init__(
            'cloudflare:zeroTrust/riskBehavior:RiskBehavior',
            resource_name,
            __props__,
            opts)
