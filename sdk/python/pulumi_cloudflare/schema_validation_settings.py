...
class SchemaValidationSettingsArgs:
    def __init__(__self__, *,
                 validation_default_mitigation_action: pulumi.Input[builtins.str],
                 zone_id: pulumi.Input[builtins.str],
                 validation_override_mitigation_action: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SchemaValidationSettings resource.
        :param pulumi.Input[builtins.str] validation_default_mitigation_action: The default mitigation action used Mitigation actions are as follows: - `"log"` - log request when request does not
        ...
        :param pulumi.Input[builtins.str] validation_override_mitigation_action: When set, this overrides both zone level and operation level mitigation actions. - `"none"` - skip running schema
    ...
    def validation_default_mitigation_action(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def validation_default_mitigation_action(self, value: pulumi.Input[builtins.str]):
    ...
    def validation_override_mitigation_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def validation_override_mitigation_action(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SchemaValidationSettingsState:
    def __init__(__self__, *,
                 validation_default_mitigation_action: Optional[pulumi.Input[builtins.str]] = None,
                 validation_override_mitigation_action: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="validationDefaultMitigationAction")
    def validation_default_mitigation_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The default mitigation action used Mitigation actions are as follows: - `"log"` - log request when request does not
        conform to schema - `"block"` - deny access to the site when request does not conform to schema - `"none"` - skip
        running schema validation Available values: "none", "log", "block".
    ...
    @validation_default_mitigation_action.setter
    def validation_default_mitigation_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "validation_default_mitigation_action", value)
...
class SchemaValidationSettings(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            validation_default_mitigation_action: Optional[pulumi.Input[builtins.str]] = None,
            validation_override_mitigation_action: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SchemaValidationSettings':
        """
    ...
    @property
    @pulumi.getter(name="validationDefaultMitigationAction")
    def validation_default_mitigation_action(self) -> pulumi.Output[builtins.str]:
        """
        The default mitigation action used Mitigation actions are as follows: - `"log"` - log request when request does not
        conform to schema - `"block"` - deny access to the site when request does not conform to schema - `"none"` - skip
        running schema validation Available values: "none", "log", "block".
    ...
    @property
    @pulumi.getter(name="validationOverrideMitigationAction")
    def validation_override_mitigation_action(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        When set, this overrides both zone level and operation level mitigation actions. - `"none"` - skip running schema
        validation entirely for the request - `null` - clears any existing override Available values: "none".
        """
