...
class GetNetworkResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetNetworkFilterResult']:
...
def get_network(account_id: Optional[_builtins.str] = None,
                filter: Optional[Union['GetNetworkFilterArgs', 'GetNetworkFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustTunnelCloudflaredVirtual/network:getNetwork', __args__, opts=opts, typ=GetNetworkResult).value
...
def get_network_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                       filter: pulumi.Input[Optional[Optional[Union['GetNetworkFilterArgs', 'GetNetworkFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustTunnelCloudflaredVirtual/network:getNetwork', __args__, opts=opts, typ=GetNetworkResult)
