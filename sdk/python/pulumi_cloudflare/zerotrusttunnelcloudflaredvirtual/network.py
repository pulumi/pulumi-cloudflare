...
@pulumi.type_token("cloudflare:zeroTrustTunnelCloudflaredVirtual/network:Network")
class Network(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/zeroTrustTunnelCloudflaredVirtualNetwork:ZeroTrustTunnelCloudflaredVirtualNetwork"), pulumi.Alias(type_="cloudflare:index/tunnelVirtualNetwork:TunnelVirtualNetwork")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Network, __self__).__init__(
            'cloudflare:zeroTrustTunnelCloudflaredVirtual/network:Network',
            resource_name,
            __props__,
            opts)
