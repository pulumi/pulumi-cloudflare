...
class GetNetworksResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetNetworksResultResult']:
        """
...
def get_networks(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustTunnelCloudflaredVirtual/networks:getNetworks', __args__, opts=opts, typ=GetNetworksResult).value
...
def get_networks_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustTunnelCloudflaredVirtual/networks:getNetworks', __args__, opts=opts, typ=GetNetworksResult)
