...
def get_entry(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDlpCustom/entry:getEntry', __args__, opts=opts, typ=GetEntryResult).value
...
def get_entry_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDlpCustom/entry:getEntry', __args__, opts=opts, typ=GetEntryResult)
