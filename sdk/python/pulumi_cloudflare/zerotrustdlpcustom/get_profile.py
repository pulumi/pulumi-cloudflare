...
class GetProfileResult:
    ...
    def context_awareness(self) -> 'outputs.GetProfileContextAwarenessResult':
        """
    ...
    @pulumi.getter
    @_utilities.deprecated("""This attribute is deprecated.""")
    def entries(self) -> Sequence['outputs.GetProfileEntryResult']:
    ...
    def sensitivity_levels(self) -> Sequence['outputs.GetProfileSensitivityLevelResult']:
        """
    ...
    def shared_entries(self) -> Sequence['outputs.GetProfileSharedEntryResult']:
...
def get_profile(account_id: Optional[_builtins.str] = None,
    ...
    example_zero_trust_dlp_custom_profile = cloudflare.zerotrustdlpcustom.get_profile(account_id="account_id",
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:zeroTrustDlpCustom/profile:getProfile', __args__, opts=opts, typ=GetProfileResult).value
...
def get_profile_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:zeroTrustDlpCustom/profile:getProfile', __args__, opts=opts, typ=GetProfileResult)
