...
def get_access_application(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str domain: The primary hostname and path that Access will secure. Must provide only one of `name`, `domain`.
    :param builtins.str name: Friendly name of the Access Application. Must provide only one of `name`, `domain`.
...
def get_access_application_output(account_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
