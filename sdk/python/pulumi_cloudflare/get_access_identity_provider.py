...
def get_access_identity_provider(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Access Identity Provider name to search for.
...
def get_access_identity_provider_output(account_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
