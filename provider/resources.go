...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"cloudflare_access_service_token":        {Tok: tfbridge.MakeResource(mainPkg, mainMod, "AccessServiceToken")},
			...
			"cloudflare_workers_kv_namespace":        {Tok: tfbridge.MakeResource(mainPkg, mainMod, "WorkersKvNamespace")},
			"cloudflare_origin_ca_certificate":       {Tok: tfbridge.MakeResource(mainPkg, mainMod, "OriginCaCertificate")},
			"cloudflare_access_identity_provider":    {Tok: tfbridge.MakeResource(mainPkg, mainMod, "AccessIdentityProvider")},
			...
			"cloudflare_logpush_ownership_challenge": {Tok: tfbridge.MakeResource(mainPkg, mainMod, "LogPushOwnershipChallenge")},
			"cloudflare_waf_override":                {Tok: tfbridge.MakeResource(mainPkg, mainMod, "WafOverride")},
			"cloudflare_authenticated_origin_pulls":  {Tok: tfbridge.MakeResource(mainPkg, mainMod, "AuthenticatedOriginPulls")},
			...
			"cloudflare_magic_firewall_ruleset":        {Tok: tfbridge.MakeResource(mainPkg, mainMod, "MagicFirewallRuleset")},
			"cloudflare_access_mutual_tls_certificate": {Tok: tfbridge.MakeResource(mainPkg, mainMod, "AccessMutualTlsCertificate")},
			"cloudflare_access_ca_certificate":         {Tok: tfbridge.MakeResource(mainPkg, mainMod, "AccessCaCertificate")},
			...
			"cloudflare_notification_policy_webhooks":  {Tok: tfbridge.MakeResource(mainPkg, mainMod, "NotificationPolicyWebhooks")},
			...
			"cloudflare_device_posture_integration": {Tok: tfbridge.MakeResource(mainPkg, mainMod, "DevicePostureIntegration")},
			"cloudflare_device_policy_certificates": {Tok: tfbridge.MakeResource(mainPkg, mainMod, "DevicePolicyCertificates")},
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"cloudflare_api_token_permission_groups": {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getApiTokenPermissionGroups")},
			"cloudflare_zone_dnssec":                 {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getZoneDnssec")},
			"cloudflare_origin_ca_root_certificate":  {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getOriginCaRootCertificate")},
			"cloudflare_access_identity_provider":    {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getAccessIdentityProvider")},
