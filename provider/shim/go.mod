...
require (
	github.com/cloudflare/terraform-provider-cloudflare v3.34.0+incompatible
	github.com/hashicorp/terraform-plugin-sdk/v2 v2.24.1
)

replace github.com/cloudflare/terraform-provider-cloudflare => github.com/pulumi/terraform-provider-cloudflare 9402f2e9b170280dfef42de290cc74da73c0ac1a
